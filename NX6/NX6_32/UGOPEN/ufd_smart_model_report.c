...
)
{
    ...
    char *title, msg[MAX_LINE_SIZE + 1];
...
)
{
    int part_type = 2;
    int status;
    char dir[MAX_FSPEC_SIZE + 1];
    char full_name[MAX_FSPEC_SIZE + 1];
...
static char * ask_display_in_views(tag_t pd)
{
    ...
    char view_name[UF_OBJ_NAME_LEN + 1];
    int view_dep;
    char *delimiter = NULL;
    char *str = NULL;
                            ...
                            int smrt, int attr)
{
    ...
    if (!is_gdt)
    {
        ...
        int k, num_types = 0, applied_geom_type[100], geom_type;
...
{
    int error = UF_SMSP_NO_ERROR;
    char *tmp, tmp_title[MAX_LINE_SIZE + 1];
...
)
{
    ...
    {
        char face_index_str[MAX_LINE_SIZE + 1];
...
{
    char *delimiter = NULL;
    char str_instance[MAX_LINE_SIZE + 1];
...
{
    char *frame_suffix;
    char tol_index_str[MAX_LINE_SIZE + 1];
...
{
    char nominal_str[MAX_LINE_SIZE + 1];
    char *str = NULL;
