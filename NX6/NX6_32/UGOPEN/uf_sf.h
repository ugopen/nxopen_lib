...
char* name_str ,/* <I>
                ...
                */
double property_values[] ,/* <I,len:11>
...
char* material_name ,/* <I>
                     ...
                     characters is 30.
                     Material name needs to be all upper case.
                     */
...
*********************************************************************/
extern UFUNEXPORT int UF_SF_create_fem_with_geom_opts
(
    const char*          fem_name,           /* <I> Name of FEM part file to create.                     */
    tag_t                cad_part_tag,       /* <I> Tag of the CAD part to associate the FEM to.
                                                    Pass NULL_TAG to create a stand-alone FEM part       */
    ...
    const char*          analysis_type_name, /* <I> The name of the analysis type.
                                                    ...
                                                    For "NX NASTRAN DESIGN":
                                                         ...
                                                         "Thermal"                                       */
    int                  num_desc_lines,     /* <I> Number of lines in the FEM description.              */
    const char**         description,        /* <I> Description of this FEM part.                        */
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_all_polygon_bodies (  int        *num_polygon_bodies,/*<O> Number of polygon bodies in the fem*/
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_polygon_body_ask_type (  tag_t    polygon_body,/*<I> Polygon body tag*/
