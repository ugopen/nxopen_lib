...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT DirectionCollection : public TaggedObjectCollection
    {
        ...
        /** Creates a @link Direction Direction@endlink  using the normal of an @link IBasePlane IBasePlane@endlink .  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  on a @link ICurve ICurve@endlink  
               at a @link Point Point@endlink .  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::Direction * CreateDirection
        (
            NXOpen::IBaseCurve * icurve /** icurve */ ,
