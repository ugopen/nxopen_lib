...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT OrientGeomBuilder : public CAM::ParamBuilder
        {
            ...
            /** the CSYS purpose  @return  the CSYS purpose mode  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /** the Special Output  @return  the special output mode  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /** the tool axis mode  @return  the integer value   <br> License requirements : cam_base ("CAM BASE") */
