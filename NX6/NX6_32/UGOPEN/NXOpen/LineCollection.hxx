...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT LineCollection : public TaggedObjectCollection
    {
        ...
        (
            const NXString & journalIdentifier /** Journal identifier of the line   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        ...
        /** Create a Axis line base on a Cylider, Cone, Torus or Revolve face. If the parent (source) part is
             not the same part that the axis is created in, the parent part is not fully loaded during the creation.  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
