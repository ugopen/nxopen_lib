...
#include <NXOpen/CAE_ElemSetMethod.hxx>
...
#include <NXOpen/CAE_NodeSetMethod.hxx>
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT SmartSelectionManager
        {
            ...
            public: explicit SmartSelectionManager(NXOpen::CAE::CaePart *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates a element set method  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ElemSetMethod * CreateElemSetMethod
            (
                NXOpen::CAE::FEElementSet * seed /** seed element set*/
            );
            ...
            /** Creates a node set method  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::NodeSetMethod * CreateNodeSetMethod
            (
                NXOpen::CAE::FENodeSet * seed /** seed node set*/
            );
