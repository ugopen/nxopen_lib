...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT FacePlaneSelectionBuilderCollection : public TaggedObjectCollection
        {
            private: NXOpen::Part* m_owner;
            public: explicit FacePlaneSelectionBuilderCollection(NXOpen::Part *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates an FacePlaneSelectionBuilder.  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
