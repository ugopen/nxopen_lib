    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            struct SheetmetalBendParameters
            {
                ...
                public: SheetmetalBendParameters(double INIT_innerRadius /**Inner Bend Radius. This works only for cylidrical bend faces. Other faces return 0.0 */, 
                        double INIT_neutralFactor /**Neutral factor value. If the flange is controlled by bend tables, then this is table value converted to neutral factor.*/, 
                        double INIT_bendAngle /**Bend Angle*/, 
                        NXOpen::Features::SheetMetal::SheetmetalBendState INIT_bendState /**Bend Face is flat or bent*/) :
                    InnerRadius(INIT_innerRadius),
                    NeutralFactor(INIT_neutralFactor),
                    BendAngle(INIT_bendAngle),
                    BendState(INIT_bendState)
                {
                }
            };
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT SheetmetalManager
            {
                ...
                /** Creates a @link Features::SheetMetal::BridgeTransitionBuilder Features::SheetMetal::BridgeTransitionBuilder@endlink   @return Bridge Transition Builder <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /** Creates a @link Features::SheetMetal::FlexibleCableBuilder Features::SheetMetal::FlexibleCableBuilder@endlink   @return Flexible Cable Builder object <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::FlexibleCableBuilder * CreateFlexibleCableBuilder
                (
                    NXOpen::Features::Feature * flexCable /**The Flexible Cable feature for which builder needs to be constructed. NULL for creating a new Flexible Cable. */
                );
