...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Default values:
        BaseDiameter.RightHandSide: 50 (millimeters part), 50 (inches part)
        HalfAngle.RightHandSide: 45
        Height.RightHandSide: 25 (millimeters part), 25 (inches part)
        TopDiameter.RightHandSide: 0 (millimeters part), 0 (inches part)
