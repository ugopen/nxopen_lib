    ...
    class NXOPENCPPEXPORT ModelingView : public View
    {
        ...
        */
        ...
        struct OtherSectionAttrT
        {
            ...
            public: OtherSectionAttrT(bool INIT_lock /** If true, all enabled planes are moved as a group */, 
                    NXOpen::ModelingView::SectionCap INIT_cap_type /** Enable or disable capping */, 
                    int INIT_cap_color /** capping color index from UG's color table */, 
                    int INIT_total_planes_active /** Either 1/2/6 planes can be active at a time */, 
                    NXOpen::ModelingView::SectionPlane INIT_active_plane /** To select the 'active' plane (of the 2 set) */) :
                Lock(INIT_lock),
        ...
        /** Returns if the specified dynamic section object is visible
                ...
                are shown in the view.
                 <br> 
              @return  Visibility flag  <br> License requirements : None */
