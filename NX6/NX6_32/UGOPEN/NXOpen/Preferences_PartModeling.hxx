...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT PartModeling
        {
            ...
            /** Returns whether the part is in history or History-Free mode   @return    <br> License requirements : None */
            public: bool GetHistoryMode
            (
            );
            /** Changes the modeling mode to History Modeling. This will remove Local feature from the model. <br> License requirements : None */
            public: void SetHistoryMode
            (
            );
            /** Changes the modeling mode to History-Free Modeling. This will remove parameters from features in the model. Feature edit will not be available and the model will not update. <br> License requirements : None */
