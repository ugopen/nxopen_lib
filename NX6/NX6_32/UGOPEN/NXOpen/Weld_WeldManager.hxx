...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        class NXOPENCPPEXPORT WeldManager
        {
            ...
            (
                NXOpen::Features::Feature * weldSheet /** @link WeldSheetBuilder WeldSheetBuilder@endlink 
                                                                             to be edited, if NULL then create a new one */
            );
            ...
            (
                NXOpen::Features::Feature * weldPoint /** @link WeldPointBodyBuilder WeldPointBodyBuilder@endlink 
                                                                             to be edited, if NULL then create a new one */
            );
