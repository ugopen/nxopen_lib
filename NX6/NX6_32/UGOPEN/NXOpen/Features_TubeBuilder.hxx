...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        InnerDiameter.RightHandSide: 0 (millimeters part), 0 (inches part)
        OuterDiameter.RightHandSide: 1 (millimeters part), 0.04 (inches part)
        OutputOption: MultipleSegments
        */
