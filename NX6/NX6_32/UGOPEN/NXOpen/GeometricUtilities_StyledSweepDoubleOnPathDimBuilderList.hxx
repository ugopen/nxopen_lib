...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT StyledSweepDoubleOnPathDimBuilderList : public TaggedObject
        {
            ...
            /** Returns the list of entities stored.  This list may contain NULL entities.
             ...
             <br> License requirements : None */
            public: std::vector<NXOpen::GeometricUtilities::StyledSweepDoubleOnPathDimBuilder *> Vector
            (
            );
