...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT LayupGrowthCollection : public TaggedObjectCollection
        {
            private: NXOpen::CAE::LaminateGlobalLayupMgr* m_owner;
            public: explicit LayupGrowthCollection(NXOpen::CAE::LaminateGlobalLayupMgr *owner): m_owner(owner)
            {
            }
            public: 
