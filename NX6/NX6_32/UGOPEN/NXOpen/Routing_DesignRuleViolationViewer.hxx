    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPPEXPORT DesignRuleViolationViewer : public Builder
        {
            ...
            /**Returns  the dialog design rule violation Id  <br> License requirements : None */
            public: int DialogViolationId
            (
            );
            /**Sets  the dialog design rule violation Id  <br> License requirements : routing_combined ("Routing Combined") */
            ...
            /**Returns  the state of Violation Location toggle option, 
                        ...
                        if false: Navigate Violations.   <br> License requirements : None */
            public: bool NavigateViolationLocationOption
            (
            );
            /**Sets  the state of Violation Location toggle option, 
                        if true: Navigate Violation Locations of current violation
                        if false: Navigate Violations.   <br> License requirements : routing_combined ("Routing Combined") */
            public: void SetNavigateViolationLocationOption
            (
                bool navigateViolationLocationOption /** navigateviolationlocationoption */ 
            );
            /**Returns  the value for filter option of route Design Rule Violation   <br> License requirements : None */
            public: NXOpen::Routing::DesignRuleViolationViewer::FilterOption FilterOptionValue
            (
            );
            /**Sets  the value for filter option of route Design Rule Violation   <br> License requirements : routing_combined ("Routing Combined") */
            ...
            /**Returns  the value for design Rule Violation override option
                        ...
                        if No:  violation is not overridden  <br> License requirements : None */
            ...
            /**Sets  the value for design Rule Violation override option
                        if Yes: violation is overridden
                        if No:  violation is not overridden  <br> License requirements : routing_combined ("Routing Combined") */
            ...
            /**Returns  the username who has overridden design Rule violation  <br> License requirements : None */
            public: NXString Username
            (
            );
            /**Sets  the username who has overridden design Rule violation  <br> License requirements : routing_combined ("Routing Combined") */
            public: void SetUsername
            (
                const NXString & username /** username */ 
            );
            /** Returns the text written as a reason for overriding the violation  @return   <br> License requirements : None */
            public: std::vector<NXString> GetOverrideText
            (
            );
            /** Sets the text for reason of overriding the violation  <br> License requirements : routing_combined ("Routing Combined") */
