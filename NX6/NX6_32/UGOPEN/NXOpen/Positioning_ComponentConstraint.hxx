        ...
        */
        class NXOPENCPPEXPORT ComponentConstraint : public Positioning::Constraint
        {
            ...
            /**Returns 
                    ...
                    @link Positioning::ComponentPositioner::PrimaryArrangement Positioning::ComponentPositioner::PrimaryArrangement @endlink and @link Positioning::ComponentPositioner::SetPrimaryArrangement Positioning::ComponentPositioner::SetPrimaryArrangement @endlink .
                 <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
