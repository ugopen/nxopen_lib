...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Default values:
        AngleLaw.EndValue.RightHandSide: 1
        AngleLaw.Function: ft
        AngleLaw.LawType: Constant
        AngleLaw.Parameter: t
        AngleLaw.StartValue.RightHandSide: 1
        AngleLaw.Value.RightHandSide: 0.0
        EndContinuity.ContinuityType: G1
        RadiusLaw.EndValue.RightHandSide: 1.0 (millimeters part), 0.05 (inches part)
        RadiusLaw.StartValue.RightHandSide: 1.0 (millimeters part), 0.05 (inches part)
        RadiusLaw.Value.RightHandSide: 1.0 (millimeters part), 0.05 (inches part)
        RhoLaw.EndValue.RightHandSide: 0.5
        RhoLaw.StartValue.RightHandSide: 0.5
        RhoLaw.Value.RightHandSide: 0.5
        ...
        */
        class NXOPENCPPEXPORT SectionSurfaceBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the interior guide1.         
                        ...
                        @link TypesFourPointSlope TypesFourPointSlope@endlink , 
                        @link TypesFivePoint TypesFivePoint@endlink , and 
                        @link TypesThreePointArc TypesThreePointArc@endlink   <br> License requirements : None */
            public: NXOpen::Section * InteriorGuide1
            (
            );
            /**Returns  the interior guide2 
                        Only applies to the follow section surface types:
                        @link TypesFourPointSlope TypesFourPointSlope@endlink  and
                        @link TypesFivePoint TypesFivePoint@endlink   <br> License requirements : None */
            ...
            /**Returns  the orientation guide.
                        Only applies to the follow section surface types:
                        @link TypesCircle TypesCircle@endlink   <br> License requirements : None */
            public: NXOpen::Section * OrientationGuide
            (
            );
            /**Returns  the apex curve. 
                        Only applies to the follow section surface types:
                        @link TypesEndsApexShoulder TypesEndsApexShoulder@endlink , 
                        @link TypesEndsApexRho TypesEndsApexRho@endlink , and 
                        @link TypesEndsApexHilite TypesEndsApexHilite@endlink   <br> License requirements : None */
            public: NXOpen::Section * ApexCurve
            (
            );
            /**Returns  the start slope.
                        Only applies to the follow section surface types:
                        @link TypesEndsSlopeShoulder TypesEndsSlopeShoulder@endlink ,
                        @link TypesEndsSlopeRho TypesEndsSlopeRho@endlink ,
                        @link TypesEndsSlopeHilite TypesEndsSlopeHilite@endlink ,
                        @link TypesEndsSlopeCubic TypesEndsSlopeCubic@endlink  and
                        @link TypesFourPointSlope TypesFourPointSlope@endlink   <br> License requirements : None */
            ...
            /**Returns  the start surface.
                        Only applies to the follow section surface types:
                        @link TypesFilletShoulder TypesFilletShoulder@endlink ,
                        @link TypesFilletRho TypesFilletRho@endlink ,
                        @link TypesFilletHilite TypesFilletHilite@endlink  and
                        @link TypesFilletBridge TypesFilletBridge@endlink   <br> License requirements : None */
            public: NXOpen::ScCollector * StartSurface
            (
            );
            /**Returns  the reverse start direction.
                        Only applies to the follow section surface types:
                        @link TypesPointRadiusAngleArc TypesPointRadiusAngleArc@endlink  and
                        @link TypesFilletBridge TypesFilletBridge@endlink   <br> License requirements : None */
            ...
            /**Sets  the reverse start direction.
                        Only applies to the follow section surface types:
                        @link TypesPointRadiusAngleArc TypesPointRadiusAngleArc@endlink  and
                        @link TypesFilletBridge TypesFilletBridge@endlink   <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the shoulder.
                        Only applies to the follow section surface types:
                        @link TypesEndsApexShoulder TypesEndsApexShoulder@endlink ,
                        @link TypesEndsSlopeShoulder TypesEndsSlopeShoulder@endlink  and
                        @link TypesFilletShoulder TypesFilletShoulder@endlink   <br> License requirements : None */
            public: NXOpen::Section * Shoulder
            (
            );
            /**Returns  the start highlight section. 
                        Only applies to the follow section surface types:
                        @link TypesEndsApexHilite TypesEndsApexHilite@endlink ,
                        @link TypesEndsSlopeHilite TypesEndsSlopeHilite@endlink  and
                        @link TypesFilletHilite TypesFilletHilite@endlink   <br> License requirements : None */
