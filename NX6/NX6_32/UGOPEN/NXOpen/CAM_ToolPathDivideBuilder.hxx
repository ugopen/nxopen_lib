...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT ToolPathDivideBuilder : public Builder
        {
            ...
            /**Returns  the Start of Path command tag  <br> License requirements : None */
            public: NXOpen::NXObject * UdeStartOfPath
            (
            );
            /**Sets  the Start of Path command tag  <br> License requirements : None */
            public: void SetUdeStartOfPath
            (
                NXOpen::NXObject * udeStartOfPath /** the ude_start_of_path tag */
            );
            /**Returns  the End of Path command tag  <br> License requirements : None */
            public: NXOpen::NXObject * UdeEndOfPath
            (
            );
            /**Sets  the End of Path command tag  <br> License requirements : None */
            public: void SetUdeEndOfPath
            (
                NXOpen::NXObject * udeEndOfPath /** the ude_end_of_path tag */
            );
            /**Returns  the Clearance Plane tag  <br> License requirements : None */
            public: NXOpen::NXObject * ClearancePlane
            (
            );
            /**Sets  the Clearance Plane tag  <br> License requirements : None */
            public: void SetClearancePlane
            (
                NXOpen::NXObject * clearancePlane /** the clearance plane tag */
            );
            /**  all events where to of divide the tool path  @return  array with the divide event indices  <br> License requirements : None */
