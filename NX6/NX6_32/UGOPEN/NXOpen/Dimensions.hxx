...
namespace NXOpen
{
    namespace Annotations
    {
        ...
        struct NarrowDimensionData
        {
            ...
            public: NarrowDimensionData(NXOpen::Annotations::NarrowDisplayOption INIT_display_type /** display type */ , 
                    NXOpen::Annotations::NarrowTextOrientation INIT_text_orientation /** text orientation */ , 
                    double INIT_leader_angle /** leader angle */ , 
                    double INIT_text_offset /** text offset */ ) :
