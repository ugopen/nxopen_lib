...
these APIs one must be aware about the Block, its associated properties and its datatypes. 
...
1. ColoredBlock.cpp
2. ColoredBlock.hpp
3. ColoredBlock.dlx (This file is located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/.NET/
   BlockStyler/ColoredBlock).
...
-------------------------
   ...
   2. Add the ColoredBlock.cpp, ColoredBlock.hpp to Source Files and Header Files respectively 
...
Once you have successfully finished with "How to Build C++ example" steps, follow the steps below:
    ...
    6. ColoredBlock example dialog will be displayed on the screen. Pick any point on the screen and 
       color from the dialog and hit Ok/Apply. A block will be created on the screen in the color 
       you have chosed from the ColorPicker block. 
