...
public class CreateASketch
{
  public static void main(String [] args) throws NXException, java.rmi.RemoteException
  {
    ...
    Sketch sketch1;
    sketch1 = theSession.parts().work().sketches().createSketch("SKETCH_000", datumPlane1, datumAxis2, vector3d1, AxisOrientation.HORIZONTAL, Sense.FORWARD, PlaneNormalOrientation.OUTWARD);
