...
public class CreateNoteExample implements Runnable
{
    ...
    public void run() 
    {
        ...
        try 
        {
            ...
            // If UGII_ROOT_DIR property is not set, set it to the value
            // of the UGII_ROOT_DIR environment variable
            if ( System.getProperty("UGII_ROOT_DIR") == null )
                System.setProperty("UGII_ROOT_DIR", ((RemoteUtilities)SessionFactory.get("RemoteUtilities")).getEnvironmentVariable("UGII_ROOT_DIR"));
