 ...
 * File description:
 *
 *    This file contains functions for the UG/Routing interactive routines
 *    callable from Internal UG/Open programs. 
 *
 ******************************************************************************/
...
/*****************************************************************************
Select Routing objects using the standard UG/Routing selection tool
