...
enum UF_PLOT_colors_e
{
    ...
    UF_PLOT_COLOR_BY_WIDTH         /* Use the first three entries(representing
...
{
    UF_PLOT_STANDARD_WIDTHS,      /* Use 3 fixed line widths. */
...
#define UF_PLOT_MAX_STRING_SIZE 1000
...
{
    char                group_dir[UF_CFI_MAX_PATH_NAME_SIZE];
    char                jobs_dir[UF_CFI_MAX_PATH_NAME_SIZE];
    char                home_dir[UF_CFI_MAX_PATH_NAME_SIZE];
    char                label[UF_PLOT_MAX_STRING_SIZE];
};
