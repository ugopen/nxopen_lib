...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        class NXOPENCPPEXPORT StockSizeCollection : public TaggedObjectCollection
        {
            ...
            public: explicit StockSizeCollection(NXOpen::Tooling::ToolingManager *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates a StockSize builder  @return @link  StockSize   StockSize @endlink  object object  <br> License requirements : None */
