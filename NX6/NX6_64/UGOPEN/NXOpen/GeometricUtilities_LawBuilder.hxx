...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT LawBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the constant value. This will be used only when the law type is constant  <br> License requirements : None */
            public: NXOpen::Expression * Value
            (
            );
            /**Returns  the start value. This will be used only when the law type is linear/cubic  <br> License requirements : None */
            public: NXOpen::Expression * StartValue
            (
            );
            /**Returns  the end value. This will be used only when the law type is linear/cubic  <br> License requirements : None */
            public: NXOpen::Expression * EndValue
            (
            );
            /**Returns  the option to retain law curve.  This will be used only during the edit of Pre NX3 feature Parms  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::LawBuilder::RetainLawCurveOption LawCurveOption
            (
            );
            /**Sets  the option to retain law curve.  This will be used only during the edit of Pre NX3 feature Parms  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
            public: void SetLawCurveOption
            (
                NXOpen::GeometricUtilities::LawBuilder::RetainLawCurveOption lawCurveOption /** lawcurveoption */ 
            );
            /**Returns  the linear or cubic along spine law. This will be used only when the law type is linear along spine/cubic along spine  <br> License requirements : None */
            ...
            /**Returns  the law curve. This will be used only when the law type is by law curve  <br> License requirements : None */
            public: NXOpen::Section * LawCurve
            (
            );
            /**Returns  the base line. This will be used only when the law type is by law curve  <br> License requirements : None */
            public: NXOpen::SelectLine * BaseLine
            (
            );
            /**Returns  the reverse direction. This will be used only when the law type is by law curve  <br> License requirements : None */
            public: bool ReverseDirection
            (
            );
            /**Sets  the reverse direction. This will be used only when the law type is by law curve  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
            ...
            /**Returns  the multi transition law. This will be used only when the law type is multi transition law  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::MultiTransitionLawBuilder * MultiTransitionLaw
            (
            );
            /**Returns  the non inflecting law. This will be used only when the law type is non inflecting law  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::NonInflectingLawBuilder * NonInflectingLaw
            (
            );
            /**Returns  the s-shaped law. This will be used only when the law type is s-shaped law  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::SShapedLawBuilder * SShapedLaw
            (
            );
            /**Returns  a value indicating if @link LawBuilder::TypeCubicAlongSpine LawBuilder::TypeCubicAlongSpine@endlink  is using simple cubic interpolation.
                        ...
                        when @link LawBuilder::Type LawBuilder::Type@endlink  is @link LawBuilder::TypeCubicAlongSpine LawBuilder::TypeCubicAlongSpine@endlink   <br> License requirements : None */
            public: bool IsSimpleCubicAlongSpine
            (
            );
            /**Sets  a value indicating if @link LawBuilder::TypeCubicAlongSpine LawBuilder::TypeCubicAlongSpine@endlink  is using simple cubic interpolation.
                        Simple cubic interpolation minimizes enforcement of automatic tangent constraints at the defining points. This option is valid only
                        when @link LawBuilder::Type LawBuilder::Type@endlink  is @link LawBuilder::TypeCubicAlongSpine LawBuilder::TypeCubicAlongSpine@endlink   <br> License requirements : None */
