...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Gap.RightHandSide: 5 (millimeters part), 0.2 (inches part)
        ...
        */
        class NXOPENCPPEXPORT SilhouetteFlangeBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the parent feature. Parent feature must be a Silhouette
                    Flange feature. A @link SilhouetteFlangeBuilder::TypesVisualGap SilhouetteFlangeBuilder::TypesVisualGap@endlink 
            ...
            /**Returns  the reference faces. If any reference face is selected for
                    @link SilhouetteFlangeBuilder::ReferenceDirectionOptionsFaceNormal SilhouetteFlangeBuilder::ReferenceDirectionOptionsFaceNormal@endlink 
