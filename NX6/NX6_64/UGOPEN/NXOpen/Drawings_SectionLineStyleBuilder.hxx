...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT SectionLineStyleBuilder : public Builder
        {
            ...
            /**Returns  this indicates whether or not to create a view for the section line  <br> License requirements : None */
            public: NXOpen::Drawings::SectionLineStyleBuilder::CreateSectionLineType CreateSectionLine
            (
            );
            /**Sets  this indicates whether or not to create a view for the section line  <br> License requirements : drafting ("DRAFTING") */
