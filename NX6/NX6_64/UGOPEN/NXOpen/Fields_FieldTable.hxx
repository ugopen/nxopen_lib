...
namespace NXOpen
{
    ...
    namespace Fields
    {
        ...
        /**  @brief  Represents the Field Table class. 
            ...
            @link Fields::FieldVariable Fields::FieldVariable@endlink ) which depend on the look-up columns. <br>   <br> Not a KF builder; see Fields.FieldManager methods to create a Fields.FieldTable. <br> */
