...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT CenterlineDrillTurningBuilder : public CAM::TurningOperationBuilder
        {
            ...
            /**Returns  the cross hole cycle  <br> License requirements : None */
            public: NXOpen::NXObject * CrossHoleCycle
            (
            );
            /**Sets  the cross hole cycle  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCrossHoleCycle
            (
                NXOpen::NXObject * crossHoleCycle /** the cross hole cycle */
            );
