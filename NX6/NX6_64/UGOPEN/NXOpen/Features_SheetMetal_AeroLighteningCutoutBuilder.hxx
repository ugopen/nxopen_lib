...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            Default values:
            Angle.RightHandSide: 45
            CheckClearance: true
            Clearance.RightHandSide: 5 (millimeters part), 0.12 (inches part)
            Diameter.RightHandSide: 102 (millimeters part), 2.6 (inches part)
            DieRadius.RightHandSide: 8 (millimeters part), 0.2 (inches part)
            Length.RightHandSide: 8 (millimeters part), 0.2 (inches part)
            Type: UserDefined
            */
            class NXOPENCPPEXPORT AeroLighteningCutoutBuilder : public Features::FeatureBuilder
            {
                ...
                /** the standard names  @return   <br> License requirements : None */
