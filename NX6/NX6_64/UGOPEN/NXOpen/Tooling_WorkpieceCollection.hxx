...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        class NXOPENCPPEXPORT WorkpieceCollection : public TaggedObjectCollection
        {
            private: NXOpen::Tooling::ToolingManager* m_owner;
            public: explicit WorkpieceCollection(NXOpen::Tooling::ToolingManager *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates Workpiece builder  @return @link  Workpiece   Workpiece @endlink  object object  <br> License requirements : None */
