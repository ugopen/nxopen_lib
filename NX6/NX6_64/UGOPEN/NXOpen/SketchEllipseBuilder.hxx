...
namespace NXOpen
{
    ...
    Default values:
    Closed: true
    EndAngle.RightHandSide: 360
    MajorRadius.RightHandSide: 50 (millimeters part), 2 (inches part)
    MinorRadius.RightHandSide: 25 (millimeters part), 1 (inches part)
    RotationAngle.RightHandSide: 0
    StartAngle.RightHandSide: 0
    */
