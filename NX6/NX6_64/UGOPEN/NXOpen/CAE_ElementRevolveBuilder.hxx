...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT ElementRevolveBuilder : public Builder
        {
            ...
            /**Returns  the elem dimension option  <br> License requirements : None */
            public: NXOpen::CAE::ElementRevolveBuilder::ElemDimType ElementDimensionOption
            (
            );
            /**Sets  the elem dimension option  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  the selected elements to be revolved  <br> License requirements : None */
            ...
            /**Returns  the axis of revolution  <br> License requirements : None */
            public: NXOpen::Axis * Axis
            (
            );
            /**Sets  the axis of revolution  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetAxis
            (
                NXOpen::Axis * axis /** axis */ 
            );
            /**Returns  the angle option  <br> License requirements : None */
            public: NXOpen::CAE::ElementRevolveBuilder::AngleType AngleOption
            (
            );
            /**Sets  the angle option  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
