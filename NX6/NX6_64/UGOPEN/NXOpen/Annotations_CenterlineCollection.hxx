...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT CenterlineCollection : public TaggedObjectCollection
        {
            ...
            public: explicit CenterlineCollection(NXOpen::Annotations::AnnotationManager *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates the Symmetrical Centerline builder  @return  SymmetricalCenterlineBuilder object  <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates the BoltCircleCenterline builder  @return  BoltCircleCenterlineBuilder object  <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates the CircularCenterline builder  @return  CircularCenterlineBuilder object  <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates the CenterMark Builder  @return  CenterMarkBuilder Object  <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates the 2D Centerline builder  @return  Centerline2dBuilder object  <br> License requirements : drafting ("DRAFTING") */
            ...
            (
                const NXString & journalIdentifier /** Identifier of the centerline to be found   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Creates the AutomaticCenterlineBuilder  @return  AutomaticCenterlineBuilder object  <br> License requirements : drafting ("DRAFTING") */
            public: NXOpen::Annotations::AutomaticCenterlineBuilder * CreateAutomaticCenterlineBuilder
            (
            );
            /** Creates the 3D Centerline builder  @return  Centerline3dBuilder object  <br> License requirements : drafting ("DRAFTING") */
