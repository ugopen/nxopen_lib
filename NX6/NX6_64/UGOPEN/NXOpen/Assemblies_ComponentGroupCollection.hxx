...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        class NXOPENCPPEXPORT ComponentGroupCollection : public TaggedObjectCollection
        {
            ...
            (
                const NXString & journalIdentifier /** Identifier of the ComponentGroup you want   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
