...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a Dynamic Section Builder used for creating sections. 
              ...
              <br> To create a new instance of this class, use @link Display::DynamicSectionCollection::CreateSectionBuilder Display::DynamicSectionCollection::CreateSectionBuilder@endlink  <br> 
        Default values:
        CapColorOption: Any
        ClipType: Section
        ...
        */
        class NXOPENCPPEXPORT DynamicSectionBuilder : public Builder
        {
            ...
            /** Sets the section origin. 
                         <br> 
                        The section is moved to new location as if it is locked regardless
                        of @link Display::DynamicSectionBuilder::LockPlanes Display::DynamicSectionBuilder::LockPlanes @endlink and @link Display::DynamicSectionBuilder::SetLockPlanes Display::DynamicSectionBuilder::SetLockPlanes @endlink .
                         <br> 
            ...
            /** Creates curves by intersecting section plane with all visible bodies
                        ...
                        The group is displayed in the part navigator.
                      <br> License requirements : None */
