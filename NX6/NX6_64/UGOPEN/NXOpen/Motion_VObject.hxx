...
namespace NXOpen
{
    ...
    {
        /**
            Represents a @link Motion::VObject Motion::VObject@endlink 
            */
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT VObject : public TaggedObject
        {
            ...
            /**Returns  value type  <br> License requirements : None */
            public: NXOpen::Motion::ForceValueTypes ValueType
            (
            );
            /**Sets  value type  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetValueType
            (
                NXOpen::Motion::ForceValueTypes valueType /** valuetype */ 
            );
            /**Returns  the x component function tag  <br> License requirements : None */
            public: NXOpen::CAE::Function * XFunction
            (
            );
            /**Sets  the x component function tag  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetXFunction
            (
                NXOpen::CAE::Function * function /** function */ 
            );
            /**Returns  the y component function tag  <br> License requirements : None */
            public: NXOpen::CAE::Function * YFunction
            (
            );
            /**Sets  the y component function tag  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetYFunction
            (
                NXOpen::CAE::Function * function /** function */ 
            );
            /**Returns  the z component function tag  <br> License requirements : None */
            public: NXOpen::CAE::Function * ZFunction
            (
            );
            /**Sets  the z component function tag  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetZFunction
            (
                NXOpen::CAE::Function * function /** function */ 
            );
            /**Returns  the magnitude function tag  <br> License requirements : None */
            public: NXOpen::CAE::Function * MagFunction
            (
            );
            /**Sets  the magnitude function tag  <br> License requirements : mechanisms ("MECHANISMS") */
