    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT WorkpieceBuilder : public Builder
        {
            ...
            /**Returns  the sketch selected for creating workpiece  <br> License requirements : None */
            public: NXOpen::Section * Sketch
            (
            );
            /**Sets  the sketch selected for creating workpiece  <br> License requirements : None */
            public: void SetSketch
            (
                NXOpen::Section * selectSketch /** The New section */
            );
            ...
            /**Returns  the sketch selected for creating combined workpiece  <br> License requirements : None */
            public: NXOpen::Section * CombinedSketch
            (
            );
            /**Sets  the sketch selected for creating combined workpiece  <br> License requirements : None */
            public: void SetCombinedSketch
            (
                NXOpen::Section * selectSketch /** The New section */
            );
        };
