...
namespace NXOpen
{
    ...
    namespace BodyDes
    {
        ...
        class NXOPENCPPEXPORT OnestepUnformBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the constraint type for intermediate unform or complete unform.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the first match point for spring back calculation.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the second match point for spring back calculation.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the third match point for spring back calculation.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the constraint point used to define point to point constraint for complete unform. 
             @deprecated Deprecated in NX6 <br> 
             <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the draw direction used to define the normal of unform base plane.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the surface type used to determine offset direction.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to infer thickness.
                    If it is true, the thickness will be auto-detected. If it is false, thickness will be required to input. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the thickness of sheet metal model.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            public: void SetThickness
            (
                double thickness /** thickness */ 
            );
            /** Create FEM 2-D meshes based on the unform region surfaces and the target region surfaces. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            public: void Mesh
            (
            );
            ...
            /**Sets  the material property elasticity(E) which enables a material to return to its original shape and dimension.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the density of material.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the material Poisson's ratio between the contraction at right angles to a stress and the direct extension.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the yield stress of material.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the  material n(Hardening Exponent) to represent the constant index used in calculations for stress-strain behaviour.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the material initial strain to represent in a material upon achieving the given loading conditions in a relaxation or creep test.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the friction of material.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the K(Strength Coefficient) of material.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the r0(Anisotropy Coefficient) of material.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the r45(Anisotropy Coefficient) of material.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the r90(Anisotropy Coefficient) of material.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the 2-D mesh element type, either triangle or quadrate element. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to infer 2-D element size. 
                    If it is true, the element size will be auto-detected. If it is false, the element size will be required as input.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the 2-D element size for mesh.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to split quadrate element to triangle element when creating meshes.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the maximum warp for meshing.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the maximum Jacobian for mesh elements. It is used to control the element shape and quality.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to attemp mapping for mesh elements. 
                    If it is true, mesh element nodes will be mapped to the orginal surface to ensure the accuracy. if it is false, it will not do mapping.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the variation of mesh element size.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to process fillet for mesh element.
                    If it is true, the small fillet area will be specially processed when generate mesh element. If it is false, it will be not specially processed.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the value of small feature for mesh setting <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            public: void SetMeshSmallFeature
            (
                double meshSmallFeature /** meshsmallfeature */ 
            );
            /**Returns  the holding force while forming.  <br> License requirements : None */
            public: double SolverHoldingForce
            (
            );
            /**Sets  the holding force while forming.  <br> License requirements : None */
            public: void SetSolverHoldingForce
            (
            ...
            /**Sets  the convergency level of onestep solver.  <br> License requirements : None */
            ...
            /**Sets the maximum number of iteration steps in onestep solver.  <br> License requirements : None */
            ...
            /**Sets  the option to display thickness information in report.
                    If it is true, the thickness information will be displayed in report. If it is false, the report will not display thickness information. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to display stress in report.
                    If it is true, the stress information will be displayed in report. If it is false, the report will not display stress information. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to display strain in report.
                    If it is true, the report will display strain information. If it is false, the report will not display strain information. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to display springback result in report.
                    If it is true, the report will display springback result. If it is false, the springback will not be displayed. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to display result flatten shape in report.
                    If it is true, the report will display the flatten shape result. If it is false, the flatten shape will not be displayed in report. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the option to control view while creating screen image in report.
                    If it is true, customer can control the view when capturing the screen image. If it is false, default view will be used in report. <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the onestep unfold mode.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
