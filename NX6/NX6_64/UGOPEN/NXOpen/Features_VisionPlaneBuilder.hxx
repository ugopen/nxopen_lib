...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Default values:
        AssoToggle: 1
        BaseDim.RightHandSide: 2000 (millimeters part), 0 (inches part)
        DriverPlane.RightHandSide: 4
        EyeType: EyeFeature
        FrontDim.RightHandSide: 1000 (millimeters part), 0 (inches part)
        FrontPlane.RightHandSide: 4
        LowerPlane: 1
        MidPlane.RightHandSide: 1
        MiddlePlane: 1
        PassengerPlane.RightHandSide: 4
        UpperPlane: 1
        VisionType: Standard
        */
        class NXOPENCPPEXPORT VisionPlaneBuilder : public Features::FeatureBuilder
        {
            /** eye definition type */
            ...
            /**Returns  the upper plane; toggle on to create upper plane  <br> License requirements : None */
            public: bool UpperPlane
            (
            );
            /**Sets  the upper plane; toggle on to create upper plane  <br> License requirements : nx_general_packaging ("NX General Packaging") */
            public: void SetUpperPlane
            (
                bool upperPlane /** upperplane */ 
            );
            /**Returns  the middle plane; toggle on to create middle plane  <br> License requirements : None */
            public: bool MiddlePlane
            (
            );
            /**Sets  the middle plane; toggle on to create middle plane  <br> License requirements : nx_general_packaging ("NX General Packaging") */
            public: void SetMiddlePlane
            (
                bool middlePlane /** middleplane */ 
            );
            /**Returns  the lower plane; toggle on to create lower plane  <br> License requirements : None */
            public: bool LowerPlane
            (
            );
            /**Sets  the lower plane; toggle on to create lower plane  <br> License requirements : nx_general_packaging ("NX General Packaging") */
            public: void SetLowerPlane
            (
                bool lowerPlane /** lowerplane */ 
            );
            /**Returns  the base dim; dimension from left to right  <br> License requirements : None */
            public: NXOpen::Expression * BaseDim
            (
            );
            /**Returns  the front dim; dimension here to front  <br> License requirements : None */
            ...
            /**Returns  the front plane inclined angle  <br> License requirements : None */
            public: NXOpen::Expression * FrontPlane
            (
            );
            /**Returns  the driver side plane inclined angle  <br> License requirements : None */
            public: NXOpen::Expression * DriverPlane
            (
            );
            /**Returns  the passenger side plane inclined angle  <br> License requirements : None */
            public: NXOpen::Expression * PassengerPlane
            (
            );
            /**Returns  the middle plane inclined angle; means front side,passenger side and driver side are the same  <br> License requirements : None */
