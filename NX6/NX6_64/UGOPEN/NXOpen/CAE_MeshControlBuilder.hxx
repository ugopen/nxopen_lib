    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT MeshControlBuilder : public Builder
        {
            ...
            /**Returns  the number of elements defined on edge. Valid for following types:
                        ...
                        @link CAE::MeshControlBuilder::TypesEdgeDensityProgression CAE::MeshControlBuilder::TypesEdgeDensityProgression@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  the value stored in Size field. This field represents:
                        ...
                        Size  for @link CAE::MeshControlBuilder::TypesFaceDensitySize CAE::MeshControlBuilder::TypesFaceDensitySize@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::Expression * OverallSize
            (
            );
            /**Returns  the value stored in start size field. This field represents:
                        Size  for @link CAE::MeshControlBuilder::TypesEdgeDensitySize CAE::MeshControlBuilder::TypesEdgeDensitySize@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  the value stored in chordal tolerance field. This field represents:
                        Tolerance for @link CAE::MeshControlBuilder::TypesEdgeDensityChordal CAE::MeshControlBuilder::TypesEdgeDensityChordal@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::Expression * ChordalTolerance
            (
            );
            /**Returns  the value stored in geometric ratio field. This field represents:
                        Ratio for @link CAE::MeshControlBuilder::TypesEdgeDensityProgression CAE::MeshControlBuilder::TypesEdgeDensityProgression@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::Expression * GeometricRatio
            (
            );
            /**Returns  the value stored in edge fraction field. This field represents:
                        Fraction for @link CAE::MeshControlBuilder::TypesEdgeDensityProgression CAE::MeshControlBuilder::TypesEdgeDensityProgression@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
