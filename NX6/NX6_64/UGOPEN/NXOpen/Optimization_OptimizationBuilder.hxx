...
namespace NXOpen
{
    ...
    namespace Optimization
    {
        ...
        class NXOPENCPPEXPORT OptimizationBuilder : public Builder
        {
            /** Optimization type for objective */
            public: enum OptimizationTargetType
            {
                OptimizationTargetTypeMinimum/** Minimum type */,
                OptimizationTargetTypeMaximum/** Maximum type */,
                OptimizationTargetTypeTarget/** Target type */
            };

            /** Attribute type */
            public: enum OptimizationAttributeType
            {
                OptimizationAttributeTypeExpression/** Expression type */,
                OptimizationAttributeTypeKFAttribute/** KF attribute type */,
                OptimizationAttributeTypeGeometryParameter/** Geometry parameter type */
            };

            /** Constraint limit type */
            public: enum OptimizationConstraintLimitType
            {
                OptimizationConstraintLimitTypeUpper/** Upper limit type */,
                OptimizationConstraintLimitTypeLower/** Lower limit type */
            };

            /** Algorithm type */
            public: enum OptimizationAlgorithmType
            {
                OptimizationAlgorithmTypeSimulatedAnnealing/** Simulated annealing type */,
                OptimizationAlgorithmTypeGlobalSimplex/** Global simplex type */,
                OptimizationAlgorithmTypePowell/** Powell type */,
                OptimizationAlgorithmTypeConjugateGradient/** Conjugate gradient type */,
                OptimizationAlgorithmTypeLexicographic/** Lexicographic type */,
                OptimizationAlgorithmTypePatternSwarm/** Pattern swarm type */
            };

            /** Convergence speed type */
            public: enum OptimizationConvergenceSpeedType
            {
                OptimizationConvergenceSpeedTypeSlow/** Slow type */,
                OptimizationConvergenceSpeedTypeMedium/** Medium type */,
                OptimizationConvergenceSpeedTypeFast/** Fast type */,
                OptimizationConvergenceSpeedTypeInfinite/** Infinite type */
            };
            ...
            struct OptimizationObjective
            {
                ...
                public: /** Object which the attribute bllongs to, it makes sense with geometry design variable type*/NXOpen::NXObject * AttributeObject;
                ...
                public: OptimizationObjective(NXString INIT_attributeName /** Attribute name */, 
                        NXOpen::NXObject * INIT_attributeObject /** Object which the attribute bllongs to, it makes sense with geometry design variable type*/, 
                        NXOpen::Optimization::OptimizationBuilder::OptimizationAttributeType INIT_objectiveType /** Objectibe type */, 
                        double INIT_objectiveTargetValue /** Value of objective target */) :
                    AttributeName(INIT_attributeName),
                    AttributeObject(INIT_attributeObject),
                    ObjectiveType(INIT_objectiveType),
                    ObjectiveTargetValue(INIT_objectiveTargetValue)
                {
                }
            };
            ...
            struct OptimizationVariable
            {
                ...
                public: OptimizationVariable(NXString INIT_attributeName /** Attribute name */, 
                        NXOpen::NXObject * INIT_attributeObject /** Object which the attribute bllongs to, it makes sense with geometry design variable type*/, 
                        NXOpen::Optimization::OptimizationBuilder::OptimizationAttributeType INIT_variableType /** Variable type */, 
            ...
            struct OptimizationConstraint
            {
                ...
                public: OptimizationConstraint(NXString INIT_attributeName /** Attribute name */, 
                        NXOpen::NXObject * INIT_attributeObject /** Object which the attribute bllongs to, it makes sense with geometry design variable type*/, 
                        NXOpen::Optimization::OptimizationBuilder::OptimizationAttributeType INIT_constraintType /** Constraint type */, 
                        double INIT_constraintLowerLimitValue /** Lower limit value */, 
                        double INIT_constraintUpperLimitValue /** Upper limit value */, 
                        NXOpen::Optimization::OptimizationBuilder::OptimizationConstraintLimitType INIT_constraintLimitType /** constraint limit type, lower type or upper type*/) :
                    AttributeName(INIT_attributeName),
                    AttributeObject(INIT_attributeObject),
                    ConstraintType(INIT_constraintType),
                    ConstraintLowerLimitValue(INIT_constraintLowerLimitValue),
                    ConstraintUpperLimitValue(INIT_constraintUpperLimitValue),
                    ConstraintLimitType(INIT_constraintLimitType)
                {
                }
            };
            ...
            /**Returns  the study name which is uniqual in one part  <br> License requirements : None */
            public: NXString StudyName
            (
            );
            /**Sets  the study name which is uniqual in one part  <br> License requirements : None */
            public: void SetStudyName
            (
                const NXString & studyName /** studyname */ 
            );
            /**Returns  the optimization type  <br> License requirements : None */
            public: NXOpen::Optimization::OptimizationBuilder::OptimizationTargetType OptimizationType
            (
            );
            /**Sets  the optimization type  <br> License requirements : None */
            ...
            /**Returns  the algorithm type  <br> License requirements : None */
            public: NXOpen::Optimization::OptimizationBuilder::OptimizationAlgorithmType AlgorithmType
            (
            );
            /**Sets  the algorithm type  <br> License requirements : None */
            ...
            /** Run optimization process  <br> License requirements : None */
            public: void RunOptimization
            (
            );
            /**Returns  the convergence speed type  <br> License requirements : None */
            public: NXOpen::Optimization::OptimizationBuilder::OptimizationConvergenceSpeedType ConvergenceSpeedType
            (
            );
            /**Sets  the convergence speed type  <br> License requirements : None */
            ...
            /**Returns  the maximum iterations time  <br> License requirements : None */
            public: int MaxNumberIteration
            (
            );
            /**Sets  the maximum iterations time  <br> License requirements : None */
            public: void SetMaxNumberIteration
            (
                int maxNumberIteration /** maxnumberiteration */ 
            );
            /**Returns  the maximum time consuming of optimization process  <br> License requirements : None */
            public: int MaxTime
            (
            );
            /**Sets  the maximum time consuming of optimization process  <br> License requirements : None */
            public: void SetMaxTime
            (
                int maxTime /** maxtime */ 
            );
            /**Returns  the abstract convergence criteria  <br> License requirements : None */
            public: double AbsoluteConvergenceCriteria
            (
            );
            /**Sets  the abstract convergence criteria  <br> License requirements : None */
            public: void SetAbsoluteConvergenceCriteria
            (
                double absoluteConvergenceCriteria /** absoluteconvergencecriteria */ 
            );
            /**Returns  the relative convergence criteria  <br> License requirements : None */
            public: double RelativeConvergenceCriteria
            (
            );
            /**Sets  the relative convergence criteria  <br> License requirements : None */
            ...
            /** Returns the constraints  @return  Constraints  <br> License requirements : None */
            public: std::vector<NXOpen::Optimization::OptimizationBuilder::OptimizationConstraint> GetOptimizationConstraints
            (
            );
            /** Sets the constraints  <br> License requirements : None */
            ...
            /** Build all the constraints  <br> License requirements : None */
            public: void BuildAllConstraints
            (
            );
            /** Remove all the constraints  <br> License requirements : None */
