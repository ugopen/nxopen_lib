...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents the builder for adding a grid @link Display::Grid Display::Grid@endlink 
             <br> This is an abstract class, and cannot be instantiated. <br> */
        class NXOPENCPPEXPORT GridBuilder : public Builder
        {
            ...
            /**Returns  the major line spacing  <br> License requirements : None */
            public: double MajorLineSpacing
            (
            );
            /**Sets  the major line spacing  <br> License requirements : None */
            public: void SetMajorLineSpacing
            (
                double majorLineSpacing /** majorlinespacing */ 
            );
            /**Returns  the minor lines per major  <br> License requirements : None */
            public: int MinorLinesPerMajor
            (
            );
            /**Sets  the minor lines per major  <br> License requirements : None */
            public: void SetMinorLinesPerMajor
            (
                int minorLinesPerMajor /** minorlinespermajor */ 
            );
            /**Returns  the snap points per minor  <br> License requirements : None */
            public: int SnapPointsPerMinor
            (
            );
            /**Sets  the snap points per minor  <br> License requirements : None */
            public: void SetSnapPointsPerMinor
            (
                int snapPointsPerMinor /** snappointsperminor */ 
            );
            /**Returns  the line color  <br> License requirements : None */
            public: NXOpen::NXColor * LineColor
            (
            );
            /**Sets  the line color  <br> License requirements : None */
            public: void SetLineColor
            (
                NXOpen::NXColor * lineColor /** linecolor */ 
            );
            /**Returns  the major line style  <br> License requirements : None */
            public: NXOpen::Display::GridBuilder::LineStyleType MajorLineStyle
            (
            );
            /**Sets  the major line style  <br> License requirements : None */
            public: void SetMajorLineStyle
            (
                NXOpen::Display::GridBuilder::LineStyleType majorLineStyle /** majorlinestyle */ 
            );
            /**Returns  the major line weight  <br> License requirements : None */
            public: NXOpen::Display::GridBuilder::LineWeightType MajorLineWeight
            (
            );
            /**Sets  the major line weight  <br> License requirements : None */
            public: void SetMajorLineWeight
            (
                NXOpen::Display::GridBuilder::LineWeightType majorLineWeight /** majorlineweight */ 
            );
            /**Returns  the minor line style  <br> License requirements : None */
            public: NXOpen::Display::GridBuilder::LineStyleType MinorLineStyle
            (
            );
            /**Sets  the minor line style  <br> License requirements : None */
            public: void SetMinorLineStyle
            (
                NXOpen::Display::GridBuilder::LineStyleType minorLineStyle /** minorlinestyle */ 
            );
            /**Returns  the minor line weight  <br> License requirements : None */
            public: NXOpen::Display::GridBuilder::LineWeightType MinorLineWeight
            (
            );
            /**Sets  the minor line weight  <br> License requirements : None */
            public: void SetMinorLineWeight
            (
                NXOpen::Display::GridBuilder::LineWeightType minorLineWeight /** minorlineweight */ 
            );
            /**Returns  the show  <br> License requirements : None */
            public: bool Show
            (
            );
            /**Sets  the show  <br> License requirements : None */
            public: void SetShow
            (
                bool show /** show */ 
            );
            /**Returns  the show on top  <br> License requirements : None */
            public: bool ShowOnTop
            (
            );
            /**Sets  the show on top  <br> License requirements : None */
            public: void SetShowOnTop
            (
                bool showOnTop /** showontop */ 
            );
            /**Returns  the show major lines  <br> License requirements : None */
            public: bool ShowMajorLines
            (
            );
            /**Sets  the show major lines  <br> License requirements : None */
            public: void SetShowMajorLines
            (
                bool showMajorLines /** showmajorlines */ 
            );
            /**Returns  the snap to grid  <br> License requirements : None */
            public: bool SnapToGrid
            (
            );
            /**Sets  the snap to grid  <br> License requirements : None */
