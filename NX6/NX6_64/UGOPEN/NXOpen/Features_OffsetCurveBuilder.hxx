...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        DraftAngle.RightHandSide: 0.0
        DraftHeight.RightHandSide: 5.0 (millimeters part), 0.25 (inches part)
        ExtendFactor: 1.0
        GroupObjects: false
        InputCurvesOptions.Associative: true
        LawControl.EndValue.RightHandSide: 5.0 (millimeters part), 0.25 (inches part)
        LawControl.Function: ft
        LawControl.LawType: Constant
        LawControl.Parameter: t
        LawControl.StartValue.RightHandSide: 5.0 (millimeters part), 0.25 (inches part)
        LawControl.Value.RightHandSide: 5.0 (millimeters part), 0.25 (inches part)
        NumberOfCopies: 1
        Offset3dDistance.RightHandSide: 5.0 (millimeters part), 0.25 (inches part)
        OffsetDistance.RightHandSide: 5.0 (millimeters part), 0.25 (inches part)
        RoughOffset: false
