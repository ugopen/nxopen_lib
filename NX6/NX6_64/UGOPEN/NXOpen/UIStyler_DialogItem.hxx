    ...
    namespace UIStyler
    {
        ...
        class NXOPENUICPPEXPORT DialogItem : public UIStyler::StylerItem
        {
            ...
            public: /**Called when the dialog displays. You can use the Constructor callback to set up dialog item attributes 
                such as populating a list or setting the sensitivity of a dialog item.  <br> License requirements : None */
            typedef NXOpen::Callback1<NXOpen::UIStyler::DialogState, NXOpen::UIStyler::StylerEvent *> Construct;
            public: /**Called when the dialog closes. Use the Destructor callback to perform cleanup.  <br> License requirements : None */
            ...
            public: /**Called when a dialog user clicks Apply or \<Ctrl\>MB2 anywhere in NX or presses the Apply's 
                ...
                the dialog and always return UF_UI_CB_CONTINUE_DIALOG.  <br> License requirements : None */
            ...
            public: /**Called when a dialog user clicks Back \<Shift\>MB2 anywhere in NX or presses Back's keyboard accelerator 
                ...
                UF_UI_CB_EXIT_DIALOG.  <br> License requirements : None */
            ...
            public: /**Called when a dialog user clicks Cancel or \<Alt\>MB2 anywhere in NX or presses Cancel's keyboard accelerator 
                as defined in the resource file.Cancel callbacks should terminate the dialog and always return UF_UI_CB_EXIT_DIALOG.  <br> License requirements : None */
            ...
            public: /**Called just before a dialog user selects a file operation, such as in File?New, and again after a file
                ...
                the File menu options.  <br> License requirements : None */
            ...
            /**Registers construct callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
            ...
            /**Registers destruct callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
            public: void AddDestructHandler
            (
                const NXOpen::UIStyler::DialogItem::Destruct&  destructevent /** destructevent */ ,
                bool isDialogLaunchingEvent /** is dialog launching event */ 
            );
            /**Registers ok callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
            public: void AddOkayHandler
            (
                const NXOpen::UIStyler::DialogItem::Okay&  okayevent /** okayevent */ ,
                bool isDialogLaunchingEvent /** is dialog launching event */ 
            );
            /**Registers apply callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
            public: void AddApplyHandler
            (
                const NXOpen::UIStyler::DialogItem::Apply&  applyevent /** applyevent */ ,
                bool isDialogLaunchingEvent /** is dialog launching event */ 
            );
            /**Registers back callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
            public: void AddBackHandler
            (
                const NXOpen::UIStyler::DialogItem::Back&  backevent /** backevent */ ,
                bool isDialogLaunchingEvent /** is dialog launching event */ 
            );
            /**Registers cancel callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
            public: void AddCancelHandler
            (
                const NXOpen::UIStyler::DialogItem::Cancel&  cancelevent /** cancelevent */ ,
                bool isDialogLaunchingEvent /** is dialog launching event */ 
            );
            /**Registers file operation callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
