...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT FeedsTurnBuilder : public TaggedObject
        {
            ...
            /**Returns  the spindle direction builder (inheritable Int)  <br> License requirements : cam_base ("CAM BASE") */
