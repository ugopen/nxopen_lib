...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT Mesh3dTetBuilder : public Builder
        {
            private: friend class  _Mesh3dTetBuilderBuilder;
            protected: Mesh3dTetBuilder();
            /**Returns  the fillet selection  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::SelectCAEFaceList * SelectionFillet
            (
            );
            /**Returns  the cylinder selection  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool AutoSizeOption
            (
            );
            /**Sets  the cylinder selection  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
