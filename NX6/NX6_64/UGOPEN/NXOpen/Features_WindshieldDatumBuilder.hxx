...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Default values:
        AssoToggle: 1
        BottomAngle.RightHandSide: 5
        EyeType: EyeFeature
        HorizontalAngle.RightHandSide: 17
        RayLength.RightHandSide: 3000 (millimeters part), 0 (inches part)
        ShowPoints: 1
        ShowRays: 1
        TopAngle.RightHandSide: 7
        VisionType: Standard
        */
        class NXOPENCPPEXPORT WindshieldDatumBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  show points to determine whether to create points or not  <br> License requirements : None */
            public: bool ShowPoints
            (
            );
            /**Sets  show points to determine whether to create points or not  <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /**Returns  show rays to determine whether to create ray lines or not  <br> License requirements : None */
            public: bool ShowRays
            (
            );
            /**Sets  show rays to determine whether to create ray lines or not  <br> License requirements : nx_general_packaging ("NX General Packaging") */
