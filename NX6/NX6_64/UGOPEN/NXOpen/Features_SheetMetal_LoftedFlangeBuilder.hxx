...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            Default values:
            IndexMarkLength.RightHandSide: 5 (millimeters part), 0.5 (inches part)
            ...
            */
            class NXOPENCPPEXPORT LoftedFlangeBuilder : public Features::FeatureBuilder
            {
                ...
                /** Returns the application context of Lofted Flange  @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Features::SheetMetal::ApplicationContext GetApplicationContext
                (
                );
                /** Sets the application context  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /**Returns   the use multi segment bends 
                        ...
                        If use multi segment bends is set to true then lofted flange bend face is gets divided as per the number bend segments mentioned by the user <br> License requirements : None */
                public: bool UseSegmentedBends
                (
                );
                /**Sets   the use multi segment bends 
                        Set use_segmented_bends to true or false and get the same 
                        If use multi segment bends is set to true then lofted flange bend face is gets divided as per the number bend segments mentioned by the user <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the number of bend segments 
                        ...
                        If use segmented bends is set to true then only the number of bend segments value is used for dividing the bend even though a value is set <br> License requirements : None */
                public: int NumberOfBendSegments
                (
                );
                /**Sets  the number of bend segments 
                         Get and set the number of bend segments
                        If use segmented bends is set to true then only the number of bend segments value is used for dividing the bend even though a value is set <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the index mark length 
                        ...
                        Index mark length value only gets reflected in flat pattern view <br> License requirements : None */
