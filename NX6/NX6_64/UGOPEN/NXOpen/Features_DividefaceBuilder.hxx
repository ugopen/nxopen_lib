...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT DividefaceBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the Dividing Objects. This is pre NX6 do not use it, instead use dividing_objects_list API.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetDividingObjects
            (
                NXOpen::ScCollector * dividingObjects /** Smart collector for dividing objects */
            );
            /**Returns  the Dividing Objects. This is pre NX6 do not use it, instead use dividing_objects_list API.  <br> License requirements : None */
            ...
            /**Sets  the Dividing Objects section. This is pre NX6 do not use it, instead use dividing_objects_list API. <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetDividingObjectsSection
            (
                NXOpen::Section * dividingObjectsSection /** section for dividing objects */
            );
            /**Returns  the Dividing Objects section. This is pre NX6 do not use it, instead use dividing_objects_list API. <br> License requirements : None */
