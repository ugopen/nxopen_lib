...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT CutParameters : public TaggedObject
        {
            ...
            /**Returns  use tool holder  <br> License requirements : None */
            public: bool UseToolHolder
            (
            );
            /**Sets  use tool holder  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetUseToolHolder
            (
                bool propValue /** the use tool holder usage value */
            );
            /**Returns   Check for Ipw Collsions  <br> License requirements : None */
            public: bool CheckIpwCollisions
            (
            );
            /**Sets   Check for Ipw Collsions  <br> License requirements : cam_base ("CAM BASE") */
