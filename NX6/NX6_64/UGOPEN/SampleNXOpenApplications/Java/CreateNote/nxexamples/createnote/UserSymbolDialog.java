...
public class UserSymbolDialog extends JDialog
{
    ...
    public NoteCreationData getNoteCreationData() throws Exception
    {
        ...
        if ( this.m_copyExistingRadioButton.isSelected() )
        {
            ...
            Selection.SelectObjectData selection = 
                m_ui.selectionManager().selectObject("Select note to clone", "Select note to clone", Selection.SelectionScope.WORK_PART,
    ...
    private void updateAfterCopyExistingRadioButtonChanged()
    {
        ...
        // try to initialize m_sbfFileNameTextField with $UGII_ROOT_DIR/ug_default.sbf.
        ...
        {
            String ugii_root_dir = System.getProperty("UGII_ROOT_DIR");
            if ( ugii_root_dir == null ) { ugii_root_dir = "."; }
            m_sbfFileNameTextField.setText(
                    ugii_root_dir + java.io.File.separator + "ug_default.sbf"
                    );
