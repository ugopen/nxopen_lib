...
public class Program
{
    ...
    public static NXOpen.MenuBar.MenuBarManager.CallbackStatus PrintButtonIdCB(NXOpen.MenuBar.MenuButtonEvent buttonEvent)
    {
        ...
        buttonName = Microsoft.VisualBasic.Interaction.InputBox( "Enter name of button you wish to query", "Print Button Id", buttonName, 100, 100 );
    ...
    public static NXOpen.MenuBar.MenuBarManager.CallbackStatus TestCallbackReturnsCB(NXOpen.MenuBar.MenuButtonEvent buttonEvent)
    {
        ...
        String returnString = Microsoft.VisualBasic.Interaction.InputBox("Enter a number between 0 and 4", "Test Callback Returns", "0", 100, 100);
        if( returnString == "0" )
        {
