...
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_list_of_feature_names
(
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_set_feature_name
(
   tag_t         fbm_geom_tag,    /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   Return the name of the feature in the FBM_GEOM group
    ...
    History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int  UF_FBM_GEOM_ask_feature_name
(
  tag_t      fbm_geom_tag,          /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   Return the feature objects of FBM_GEOM group
    ...
    History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int  UF_FBM_GEOM_ask_features
(
    tag_t         fbm_geom_tag,        /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_remove_feature
(
   tag_t         fbm_geom_tag,    /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_representative_features
(
   tag_t        fbm_geom_tag,               /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_available_criteria
(
   tag_t          fbm_geom_tag,       /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_used_criteria
(
   tag_t    fbm_geom_tag,          /*<I> The tag of the fbm_geom group of interest */
   int      *count,                /*<O> The number of criteria */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_type_of_criterion
(
   tag_t                             fbm_geom_tag,     /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_logical_of_criteria
(
   tag_t          fbm_geom_tag,         /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_double_of_criteria
(
   tag_t            fbm_geom_tag,     /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_integer_of_criteria
(
   tag_t           fbm_geom_tag,   /*<I> The tag of the fbm_geom group of interest */
   UF_NCFEAT_t     ncfeat_obj,     /*<I> The ncfeat_obj object for which the criteria value has to be evaluated*/
   char            *criterion,     /*<I> The criterion for which the value is requested */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_string_of_criteria
(
   tag_t            fbm_geom_tag,    /*<I> The tag of the fbm_geom group of interest */
   UF_NCFEAT_t      ncfeat_obj,      /*<I> The ncfeat_obj object for which the criteria value has to be evaluated*/
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_classify_by_criteria
(
   tag_t                            fbm_geom_tag,              /*<I> The tag of the fbm_geom group of interest */
   ...
   UF_FBM_GEOM_classified_crit_t     *classified_set_list      /*<OF,len:num_of_classified_sets>
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_set_classified_features
(
   tag_t                              fbm_geom_tag,            /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_int_value_of_classified_crit
(
   tag_t                               fbm_geom_tag,         /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_double_value_of_classified_crit
(
   tag_t                              fbm_geom_tag,             /*<I> The tag of the fbm_geom group of interest */
   char                               *criterion,               /*<I> The criteria for which the value is asked for */
   UF_FBM_GEOM_classified_crit_t      classified_set_list, /*<I> The result of the classification */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_string_value_of_classified_crit
(
   tag_t                             fbm_geom_tag,              /*<I> The tag of the fbm_geom group of interest */
   char                              *criterion,                /*<I> The criteria for which the value is asked for */
   UF_FBM_GEOM_classified_crit_t     classified_set_list,  /* <I> The result of the classification */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_logical_value_of_classified_crit
(
   tag_t                            fbm_geom_tag,               /*<I> The tag of the fbm_geom group of interest */
   char                             *criterion,                 /*<I> The criteria for which the value is asked for */
   UF_FBM_GEOM_classified_crit_t    classified_set_list,   /*<I> The result of the classification */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_free_classified_set_list
(
   tag_t                              fbm_geom_tag,        /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_feature_entities
(
   tag_t           fbm_geom_tag,             /*<I> The tag of the fbm_geom group of interest */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_ask_accessibility_vectors
(
   tag_t          fbm_geom_tag,              /*<I> The tag of the fbm_geom group of interest */
   UF_NCFEAT_t    representative_feature,    /*<I> A representative feature object of the group */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_set_accessibility_vectors
(
   tag_t          fbm_geom_tag,            /*<I> The tag of the fbm_geom group of interest */
   UF_NCFEAT_t    representative_feature,  /*<I> A representative feature object of the group */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_remove_accessibility_vectors
(
   tag_t          fbm_geom_tag,             /*<I> The tag of the fbm_geom group of interest */
   UF_NCFEAT_t    representative_feature    /*<I> A representative feature object of the group */
);
...
*******************************************************************************/
extern UFUNEXPORT int UF_FBM_GEOM_create
(
