...
This will create an shared library TreeListDemo.dll in the Release or Debug  directory as per selected configuration.
...
-----------------------
    ...
    9.	Drag and Drop:
        ...
        Note: The drag and drop of nodes in this example is just for visual representation that drop is 
              ...
              dropType argument to the OnDropCallback indicates whether the nodes are dropped On target node, Before target node or
              After target node.
