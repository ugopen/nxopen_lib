...
1.Run this program in Gateway Enviroment
- Use 'Tools > Journal > Play' to run BeamModeling.vb

2.The program will print the beam properties to the information window
