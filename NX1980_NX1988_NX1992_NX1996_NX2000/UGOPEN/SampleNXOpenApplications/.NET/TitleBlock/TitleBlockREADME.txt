...
------------
   ...
   7. This will create an executable called TitleBlock.dll in the Release or Debug  directory as per selected configuration.
...
----------------------- 
    ...
    3. Browse and select the TitleBlock.dll and execute.

    4. Follow point no.4 onwards mentioned above in 'Journal execution'.
