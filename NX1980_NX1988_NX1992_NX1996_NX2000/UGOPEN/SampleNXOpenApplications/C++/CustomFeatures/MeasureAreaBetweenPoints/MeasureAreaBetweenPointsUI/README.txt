...
-------------------------------------------------------------------------------
        Demonstration example for custom feature Measure Area Between Points UI code.
-------------------------------------------------------------------------------
...
Files required
--------------
    1. MeasureAreaBetweenPointsUI.hpp
	2. MeasureAreaBetweenPointsUI.cpp
	3. MeasureAreaBetweenPointsUI.dlx	
    4. MeasureAreaBetweenPointsUI_CPP_ReadMe.txt
	
 The above files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/CustomFeatures/MeasureAreaBetweenPoints/MeasureAreaBetweenPointsUI.
...
------------
  ...
  Windows
  -------
   1. Using Visual Studio - create a new project with name "MeasureAreaBetweenPointsUI" using the NX Open C++ Wizard.
   ...
   3. Add the MeasureAreaBetweenPointsUI.cpp and MeasureAreaBetweenPointsUI.hpp to Source Files by selecting the Project pull down and select "Add Existing Item...". Select the file 
      using the popup window.

   4. Build the internal image by going to the Build menu and selecting either 
      "Build Solution" or "Rebuild Solution".
 
   This will create an executable called MeasureAreaBetweenPointsUI.dll in the Debug directory.
   ...
   The uflink tool can also be used to create the executable by following these steps:
    ...
    ufcomp MeasureAreaBetweenPointsUI.cpp
      uflink UFDLL=MeasureAreaBetweenPointsUI.dll MeasureAreaBetweenPointsUI.obj

   This will create MeasureAreaBetweenPointsUI.dll in the current directory.
  ...
  -----
   ...
   This will create MeasureAreaBetweenPointsUI.so in the current directory.
   
----------------------------
Settings before Launching NX
---------------------------- 
The executable (MeasureAreaBetweenPointsUI.dll for Windows or MeasureAreaBetweenPointsUI.so for Linux) and MeasureAreaBetweenPointsUI.dlx must be placed in any one of the following locations mentioned below:
...
-----------------------
    ...
    4. This will launch the "Measure Area Between Points" dialog.

    5. Provide inputs as indicated in dialog.

    6. Dialog OK/Apply creates the Measure Area Between Points feature.
	
	7. Newly created Measure Area Between Points feature can be edited by RMB on Part Navigator feature node and choosing Edit with Rollback
