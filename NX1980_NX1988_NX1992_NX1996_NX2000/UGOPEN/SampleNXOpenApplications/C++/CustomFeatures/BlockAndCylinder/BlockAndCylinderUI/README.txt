...
-------------------------------------------------------------------------------
        Demonstration example for custom feature Block and Cylinder UI code.
-------------------------------------------------------------------------------
...
Files required
--------------
    1. BlockAndCylinderUI.hpp
	2. BlockAndCylinderUI.cpp
	3. BlockAndCylinderUI.dlx	
    4. BlockAndCylinderUI_CPP_ReadMe.txt
	
 The above files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/CustomFeatures/BlockAndCylinder/BlockAndCylinderUI.
...
------------
  ...
  Windows
  -------
   1. Using Visual Studio - create a new project with name "BlockAndCylinderUI" using the NX Open C++ Wizard.
   ...
   3. Add the BlockAndCylinderUI.cpp and BlockAndCylinderUI.hpp to Source Files by selecting the Project pull down and select "Add Existing Item...". Select the file 
      using the popup window.

   4. Build the internal image by going to the Build menu and selecting either 
      "Build Solution" or "Rebuild Solution".
 
   This will create an executable called BlockAndCylinderUI.dll in the Debug directory.
   ...
   The uflink tool can also be used to create the executable by following these steps:
    ...
    ufcomp BlockAndCylinderUI.cpp
      uflink UFDLL=BlockAndCylinderUI.dll BlockAndCylinderUI.obj

   This will create BlockAndCylinderUI.dll in the current directory.
  ...
  -----
   ...
   This will create BlockAndCylinderUI.so in the current directory.
   
----------------------------
Settings before Launching NX
---------------------------- 
The executable (BlockAndCylinderUI.dll for Windows or BlockAndCylinderUI.so for Linux) and BlockAndCylinderUI.dlx must be placed in any one of the following locations mentioned below:
...
-----------------------
    ...
    4. This will launch the "Block and Cylinder" dialog.

    5. Provide inputs as indicated in dialog.

    6. Dialog OK/Apply creates the Block and Cylinder.
	
	7. Newly created Block and Cylinder feature can be edited by RMB on Part Navigator feature node and choosing Edit with Rollback
