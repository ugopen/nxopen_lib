    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  Utils
        {
            ...
            /// \cond NX_NO_DOC 
            /** Get the object to be compared merge and the properties to be set
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get the file names for merge output 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get the file name for merge report 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
