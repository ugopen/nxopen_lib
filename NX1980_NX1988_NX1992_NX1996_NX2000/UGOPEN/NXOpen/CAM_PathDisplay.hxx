    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  PathDisplay
        {
            ...
            /// \cond NX_NO_DOC 
            /** Jumps to the end of the selected operation's tool path display when input parameter is true, otherwise to the start.
