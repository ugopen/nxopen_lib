        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RouteManager
        {
            ...
            /** Creates an HVAC Duct Reinforcement Builder. See the documentation in the
             ...
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link NXOpen::Routing::RouteManager::CreateDuctReinforcementBuilderForStock NXOpen::Routing::RouteManager::CreateDuctReinforcementBuilderForStock@endlink  instead. <br>  

             <br>  Created in NX8.5.2.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::Routing::RouteManager::CreateDuctReinforcementBuilderForStock instead.") NXOpen::Routing::DuctReinforcementBuilder * CreateDuctReinforcementBuilder
            (
            ...
            /// \cond NX_NO_DOC 
            /** Creates a @link NXOpen::Routing::CablewayNetworkBuilder NXOpen::Routing::CablewayNetworkBuilder@endlink  that is used to qualify Cableway Networks. 
