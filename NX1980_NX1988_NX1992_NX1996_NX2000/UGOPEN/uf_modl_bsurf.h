...
/****************************************************************************
Returns the B-surface data associated with the input face or the body
(with a single face) tag.  The data is in the context of the owning part of the input 
object prototype. The underlying data in this structure should be freed by calling 
UF_MODL_free_bsurf_data.
