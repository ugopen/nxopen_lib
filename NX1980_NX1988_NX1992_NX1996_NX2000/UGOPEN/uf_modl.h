...
UF_MODL_create_symb_thread function is now retired in NX1926. 
...
Retired function UF_MODL_create_symb_thread() will continue to use thread standards from .dat files to preserve 
