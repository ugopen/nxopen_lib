...
------------
   ...
   4. Add the following reference,
        ...
        Pick Add Reference->.NET Tab->under component name,select System.Windows.Forms. Repeat the process and select System.Drawing.
   		
   5. Go to, Build Menu -> Build Solution or Ctrl + Shift + B or go to Solution Explorer, 
      right click on project name and select Build.

   6. This will create an executable called SnagImage.dll in the Release or Debug  directory as per selected configuration.
