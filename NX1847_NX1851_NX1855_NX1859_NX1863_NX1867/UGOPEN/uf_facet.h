...
#define UF_FACET_err_stl_corrupt_file       UF_FACET_ERROR_BASE+37
#define UF_FACET_err_minimum_body           UF_FACET_ERROR_BASE+38
...
struct UF_FACET_parameters_s
  {
    ...
    double  curve_angular_tolerance;   /* This is the maximum angular variation
                                       ...
                                       */
    double  curve_max_length;          /* This is to be specified in part units */
    ...
    double  silh_chord_tolerance;      /* If use_view_direction is specified
                                       ...
                                       by the view direction. The tolerance is to 
                                       be specified in part units.
                                       */
...
/*******************************************************************************
Enquire the prototype solid face tag of a facet or a facet occurrence.  Output is a pointer to NULL_TAG if the
...
will be number of facets/triangles, since there would be no faces.
