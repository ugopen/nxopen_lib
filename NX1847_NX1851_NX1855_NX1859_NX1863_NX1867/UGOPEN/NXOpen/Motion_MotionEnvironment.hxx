        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionEnvironment
        {
            ...
            public: enum Solver
            {
                ...
                SolverLms/** Simcenter Motion solver (legacy name, deprecated in SC12) */ = 2,
            ...
            /** Enable the mechatronics 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Removed without replacement.") void EnableMechatronics
            (
            ...
            /** Enable the LMS flexible body dynamics 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Removed without replacement.") void EnableLmsflexbody
            (
            ...
            /** Enable the standard tire 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Removed without replacement.") void EnableStdtire
            (
            ...
            /** Enable the TNO tire 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Removed without replacement.") void EnableTnotire
            (
            ...
            /** Enable the Swift tire 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Removed without replacement.") void EnableSwifttire
            (
            ...
            /** Enable the CD tire 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Removed without replacement.") void EnableCdtire
            (
