        ...
        */
        class AMEOPENCPPEXPORT  AddPlaceholderBuilder : public NXOpen::Builder
        {
            ...
            public: enum Category
            {
                ...
                CategoryObjectPorts/** object ports */ ,
            ...
            {
                PropertyLibraryItem/** library item */ ,
            ...
            /**Returns  the select library object
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::Tooling::SelectReuseLibraryItemBuilder * SelectLibraryObject
            (
            );
            /**Sets  the select library object
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetSelectLibraryObject
            (
                NXOpen::Tooling::SelectReuseLibraryItemBuilder * libraryObjectType /** libraryobjecttype */ 
            );
        };
    }
}
