        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  OPCUAClientBuilder : public NXOpen::Builder
        {
            ...
            /**  @brief  Gets OPC UA instance Tags  
             ...
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Mechatronics::OPCUAClientBuilder::GetServerTagsV2 Mechatronics::OPCUAClientBuilder::GetServerTagsV2@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Mechatronics::OPCUAClientBuilder::GetServerTagsV2 instead.") std::vector<NXOpen::Mechatronics::OPCUAClientBuilder::TagInfo> GetServerTags
            (
            ...
            /**  @brief  Sets OPC UA instance Tags  
             ...
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Mechatronics::OPCUAClientBuilder::SetServerTagsV2 Mechatronics::OPCUAClientBuilder::SetServerTagsV2@endlink  instead. <br>  

             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Mechatronics::OPCUAClientBuilder::SetServerTagsV2 instead.") void SetServerTags
            (
                const NXString & serverName /** servername */ ,
