        ...
        */
        class NXOPENCPP_PDMEXPORT  FileManagement : public NXOpen::TransientObject
        {
            ...
            (
                ...
                std::vector<NXString> & namedReferenceNames /** NX dataset named reference names. */,
                std::vector<NXString> & importFileNames /** Import file names which contain the file names with extension only to import per dataset. This should not contain full directory path. */,
                std::vector<NXString> & importFileDirectoryNames /** Import file directory names which contain the files to import. */
            );
            ...
            (
                ...
                const NXString & exportDirectoryName /** Where to export files to */,
                std::vector<NXString> & namedReferences /** NamedReferences */
            );
            /** Export Named Reference From Teamcenter.
                    The Dataset Relation Type Names are the names of the Teamcenter relationships used to find the Datasets
                    to the correponding Item Revisions.
            ...
            (
                ...
                const char * exportDirectoryName /** Where to export files to */,
                std::vector<NXString> & namedReferences /** NamedReferences */
            );
