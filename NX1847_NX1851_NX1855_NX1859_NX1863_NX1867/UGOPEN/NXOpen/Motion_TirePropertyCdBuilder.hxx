        ...
        */
        class NXOPENCPP_MOTIONEXPORT  TirePropertyCdBuilder : public NXOpen::Motion::TirePropertyBuilder, public virtual NXOpen::IExternalFileReferencer
        {
            ...
            /**Returns  the primary parameter file.The tire parameter file describes the properties of the tire.
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") NXString PrimaryParamFile
            (
            );
            /**Sets  the primary parameter file.The tire parameter file describes the properties of the tire.
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::ExternalFileReferenceAdapter::EstablishReference") void SetPrimaryParamFile
            (
            ...
            /**Returns  the tire control file. The Tire Control File contains integrator control, adaptivity control and monitor control parameter. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter@endlink  <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") NXString TireControlFile
            (
            );
            /**Sets  the tire control file. The Tire Control File contains integrator control, adaptivity control and monitor control parameter. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::ExternalFileReferenceAdapter::EstablishReference NXOpen::ExternalFileReferenceAdapter::EstablishReference@endlink  <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::ExternalFileReferenceAdapter::EstablishReference") void SetTireControlFile
            (
                const NXString & filename /** filename */ 
            );
            /**Sets  the tire control file. The Tire Control File contains integrator control, adaptivity control and monitor control parameter. 
            ...
            /**Returns  the static radius. Approximate radius of the tire. Used only for the purpose of 
                        ...
                        @link TirePropertyCdBuilder::StaticHold TirePropertyCdBuilder::StaticHold @endlink and @link TirePropertyCdBuilder::SetStaticHold TirePropertyCdBuilder::SetStaticHold @endlink  is true.  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the static vertical stiffness. Specifies the vertical stiffness only used in static equilibrating force calculations.
                        ...
                        if @link TirePropertyCdBuilder::StaticHold TirePropertyCdBuilder::StaticHold @endlink and @link TirePropertyCdBuilder::SetStaticHold TirePropertyCdBuilder::SetStaticHold @endlink  is true. 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the wear indicator. 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link TirePropertyCdBuilder::WearIndicatorPerSegment TirePropertyCdBuilder::WearIndicatorPerSegment@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use TirePropertyCdBuilder::WearIndicatorPerSegment instead.") bool EnergyLoss
            (
            );
            /**Sets  the wear indicator. 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use TirePropertyCdBuilder::WearIndicatorPerSegment instead.") void SetEnergyLoss
            (
