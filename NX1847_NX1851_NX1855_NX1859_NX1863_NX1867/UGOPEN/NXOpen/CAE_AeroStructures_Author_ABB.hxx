                    ...
                    */
                    ...
                    /**
                                        ...
                                        * eta is obtained from the MetallicPanelCompressivePlasticityCurveBC1 charts if material is considered as elastic-plastic (Material behaviour = Elastic-Plastic):
                                            * SigmaAllowablePlastic/Sigma0.7 = f(SigmaAllowableElastic/Sigma0.7)
                                            * Sigma0.7 is the stress for secant modulus equal to 70% of Young's modulus
                    ...
                    (
                        NXOpen::CAE::AeroStructures::Author::AbbContext * abbContext /** The ABB context */,
                        double b /** Longest edge length */,
                        double a /** Shortest edge length */,
                        NXOpen::CAE::AeroStructures::Author::ABB::EdgeSupportType bc /** Support along the edges */,
                        double t /** Panel's thickness */,
                        double r /** Panel's curvature radius*/,
                        NXOpen::CAE::AeroStructures::Author::ABB::MaterialBehaviour behaviour /** Material behaviour */,
                        ...
                        double n /** Ramberg-Osgood parameter */,
                        double iFy /** Yield stress Allowable */,
                        const std::vector<double> & sigma /** Shear stress */,
                        std::vector<double> & ms /** Margin of safety */,
                        double* sigmaAllowable /** Stress allowable */
                    );
                    /**
                    ...
                    /**
                                        ...
                                        * eta is obtain from following charts if material is considered as elastic-plastic (Material behaviour = Elastic-Plastic):
                                        ...
                                        MetallicPanelCompressivePlasticityCurveBC2 with Sigma0.7 is the stress for secant modulus equal to 70% of Young's modulus
                                        Input
                                            b                       Loaded edge length
                                            a                       Unloaded edge length
                                            t                       Panel thickness
                    ...
                    /**
                                        ...
                                        * 'nu' is the elastic Poisson's ratio
                                        * 't' is the panel thickness
                                        * 'a' is the panel's loaded edge length
                                        * 'b' is panel's unloaded edge length
                                        * 'eta' is the plasticity reduction factor: SigmaAllowablePlastic = eta*SigmaAllowableElastic
                                        * eta = 1 if material is considered as elastic (Material behaviour = Elastic)
                                        * eta is obtain from following charts if material is considered as elastic-plastic (Material behaviour = Elastic-Plastic):
