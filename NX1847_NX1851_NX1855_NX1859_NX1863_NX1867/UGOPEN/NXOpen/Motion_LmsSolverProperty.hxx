        ...
        */
        class NXOPENCPP_MOTIONEXPORT  LmsSolverProperty : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the dynamic solver acceleration method 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::LmsSolverProperty::DynamicAccelerationMethods DynamicSolverAccelerationMethod
            (
            );
            ...
            /**Returns  the dynamic initial velocity method 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::LmsSolverProperty::DynamicInitialVelocityMethods DynamicInitialVelocityMethod
            (
            );
            ...
            /**Returns  the static jacobian type 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::LmsSolverProperty::StaticJacobianTypes StaticJacobianType
            (
            );
