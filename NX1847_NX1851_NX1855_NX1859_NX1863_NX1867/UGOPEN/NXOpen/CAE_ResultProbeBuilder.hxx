        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultProbeBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the output result type value 
             <br>  @deprecated Deprecated in NX1847.0.0.  You Don't need to set Result type anymore just setting the correct unit will work. <br>  

             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  You Don't need to set Result type anymore just setting the correct unit will work.") NXOpen::CAE::Result::Quantity ResultType
            (
            );
            /**Sets  the output result type value 
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  You Don't need to set Result type anymore just setting the correct unit will work.") void SetResultType
            (
