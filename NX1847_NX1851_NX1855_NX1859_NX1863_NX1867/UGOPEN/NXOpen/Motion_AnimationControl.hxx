    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  AnimationControl : public NXOpen::Motion::PostControl
        {
            ...
            /** Get animation motion body transformation matrix  @return  The motion body transformation matrix within current step 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Motion::AnimationControl::GetLinkTransformation Motion::AnimationControl::GetLinkTransformation@endlink instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Motion::AnimationControl::GetLinkTransformationinstead.") double GetLinkTransformatioinMatrix
            (
                NXOpen::Motion::Link * linkTag /** The special motion body object */,
