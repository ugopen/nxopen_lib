        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  PlcSimAdvClientBuilder : public NXOpen::Builder
        {
            ...
            /**  @brief  Gets PLCSIMAdv instance information  
             ...
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Mechatronics::PlcSimAdvClientBuilder::GetInstanceInformationV2 Mechatronics::PlcSimAdvClientBuilder::GetInstanceInformationV2@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Mechatronics::PlcSimAdvClientBuilder::GetInstanceInformationV2 instead.") void GetInstanceInformation
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
            ...
            /**  @brief  Sets PLCSIMAdv instance information  
             ...
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Mechatronics::PlcSimAdvClientBuilder::SetInstanceInformationV2 Mechatronics::PlcSimAdvClientBuilder::SetInstanceInformationV2@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Mechatronics::PlcSimAdvClientBuilder::SetInstanceInformationV2 instead.") void SetInstanceInformation
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
