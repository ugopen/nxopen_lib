     ...
     =========================
           ...
           ufx_batchmeshing  -?  -h or -H 
            ...
            -solver=<Solver name>           : Solver name values are
                                                  ...
                                                  "LS-DYNA"
                                                  "Ideas Unv"
                                              Default is Simcenter Nastran (if param opt. not 
                                              specified)
      ...
      =========================
         ...
         are the name strings build:
            ...
            <extn> values for language settings:
                ...
                ANSYS       : ".inp" 
                ABAQUS      : ".inp"
                NX Design Simulation : ".dat"
                LS-DYNA : ".k"
                Ideas Unv : ".unv"
                Simcenter Samcef : ".dat"
...
static const char *scHelpText[] = {
    ...
    "                                    \"Ideas Unv\" ",
    "                                    \"Simcenter Samcef\" ",
    "                                Default is Simcenter Nastran (if param opt.", 
    "                                not specified)", 
    "             ",
    "             ",
    "   -no_idealize               : Do not create idealized part.",
...
typedef struct UF_UG_BatchMesh_Parms_s
{
    ...
    int       aspect_ratio_toggle;           /* Aspect Ratio Toggle state */

    double    aspect_ratio_value;             /* Aspect Ratio Value */
...
#define   UF_UG__BatchMesh_INITBatchParams(pzParams) \
    ...
    strcpy((pzParams)->Solver_Name, "Simcenter Nastran");   \
...
#define   UF_UG__BatchMesh_MESHParams(pzParams)     \
    ...
    (pzParams)->aspect_ratio_toggle = false; \
    (pzParams)->aspect_ratio_value = 8; \
...
extern int main( int argc, char *argv[] )
{
    ...
    fprintf(stdout,"   \n");
    fprintf(stdout, "##############IMPORTANT NOTE##############\n");
    fprintf(stdout, "  BatchMesher Version 2.0 is deprecated and will not be published from next release \n");
    fprintf(stdout, "  Please start using Version 3.0 \n");
    fprintf(stdout, "##########################################\n");
    fprintf(stdout, "   \n");
                                             ...
                                             UF_UG_BatchMesh_CommandLineOpts_t *pzBatchRunParams)
{
    ...
    /* Rename the solver deck file to what our naming convention 
       ...
       */
    build_name_string ( 4, cad_part_tag,pzBatchRunParams, 
...
static int do_Batch_Meshing__main ( UF_UG_BatchMesh_CommandLineOpts_t *pzBatchRunParams )
{
    ...
    try
    {
        ...
        while (meshcontrol != NULL_TAG)
        {
            ...
            if (subType == UF_caemisc_selection_recipe_subtype)
            {
                report_msg("Error : Template Fem has selection recipes defined. This version doesn't support seleciton recipes.\n Please use Version 3.0\n");
                write_info_fprintf(true, UF_UG__BatchMesh_LOG, "Error : Template Fem has selection recipes defined. This version doesn't support seleciton recipes.\n Please use Version 3.0\n");
                return 9999;
            }
            else
            {
        ...
        {
            strcpy(pzBatchRunParams->Solver_Name, scCommandLineSolverName);
        }
        ...
        ========================================== */
        if (isSolverSupported(scSolverName.GetUTF8Text()))
        {
            if (pzBatchRunParams->fOutputDAT == (int)true)
                             ...
                             tag_t* mesh_tag )
{
    ...
    mesh2dBuilder1->PropertyTable()->SetBooleanPropertyValue("target element aspect ratio bool", (zMesh_params.aspect_ratio_toggle != 0));

    mesh2dBuilder1->PropertyTable()->SetBaseScalarWithDataPropertyValue("element aspect ratio", (zMesh_params.aspect_ratio_value), unit1);
...
void get_solver_and_template ( UF_UG_BatchMesh_CommandLineOpts_t *pzBatchRunParams, int partunits, char* scSolverName, char* scAnalysisType, char* scSolverTemplate )
{
    ...
    /* Solver name string */
     ...
     else if ( !strcmp(pzBatchRunParams->Solver_Name,"MSC Nastran" ) ||
     ...
     else if ( !strcmp(pzBatchRunParams->Solver_Name,"Simcenter Nastran" ) ||
     ...
     else if ( !strcmp(pzBatchRunParams->Solver_Name,"NX Design Simulation" ) ||
     ...
     else if ( !strcmp(pzBatchRunParams->Solver_Name,"Ideas Unv" ) ||
     ...
     else if (!strcmp(pzBatchRunParams->Solver_Name, "Simcenter Samcef") ||
    ...
    if ( pzBatchRunParams->fParamFile==(int)true)
    {
        ...
        if ( pzBatchRunParams->fParamFile==(int)true)
        {
            ...
            else
            {
                ...
                meshParamReader.Get_aspect_ratio_toggle(&pzMesh_params->aspect_ratio_toggle);
                meshParamReader.Get_aspect_ratio_value(&pzMesh_params->aspect_ratio_value);
    ...
    if ( fUse_2D_params==TRUE )
    {
       ...
       /* write_info_fprintf(true, UF_UG__BatchMesh_LOG, "   Edge match Tol = %f\n", 
        ...
        //{
            ...
            if (zMesh_params.aspect_ratio_toggle == (int)true)
            {
                write_info_fprintf(true, UF_UG__BatchMesh_LOG, "   Aspect Ratio Toggle :  ON\n");
                write_info_fprintf(true, UF_UG__BatchMesh_LOG, "   Aspect Ratio :  %f\n",
                    zMesh_params.aspect_ratio_value);
            }
            else
                write_info_fprintf(true, UF_UG__BatchMesh_LOG, "   Aspect Ratio Toggle :  OFF\n");
