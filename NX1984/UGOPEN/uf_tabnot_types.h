...
struct UF_TABNOT_cell_prefs_s
{
    ...
    logical showLeadingZeroes;            /* A flag which will determine whether leading zeroes should be displayed or not */
    logical showTrailingZeroes;           /* A flag which will determine whether trailing zeroes should be displayed or not */
};
...
#define UF_TABNOT_negative_resize_value_not_allowed   (ERROR_UF_TABNOT_base + 25)
#define UF_TABNOT_err_cant_execute_for_lock_table_format  (ERROR_UF_TABNOT_base + 26)
#define UF_TABNOT_invalid_input                  (ERROR_UF_TABNOT_base + 27)
#define UF_TABNOT_invalid_object_for_save_as_template (ERROR_UF_TABNOT_base + 28)
...
#define UF_HOLETABLE_part_not_loaded             (UF_TABNOT_ERROR_BASE + 309)

/* error 501-700 reserved for bend table */
#define UF_BENDTABLE_zero_columns_error          (UF_TABNOT_ERROR_BASE + 501)


/* error 1001-1500 reserved for parts list */
#define UF_PARTS_LIST_No_Errors                  (UF_TABNOT_NO_ERRORS)
#define UF_PARTS_LIST_broken_view_selected       (UF_TABNOT_ERROR_BASE + 1001)
#define UF_PARTS_LIST_invalid_member             (UF_TABNOT_ERROR_BASE + 1002)
