        ...
        class NXOPENCPP_ANNOTATIONSEXPORT  IdSymbolBuilder : public NXOpen::Builder
        {
            ...
            */
            ...
            /**Returns  the symbol type 
             <br>  @deprecated Deprecated in NX12.0.2.  Use @link NXOpen::Annotations::IdSymbolBuilder::BalloonType NXOpen::Annotations::IdSymbolBuilder::BalloonType@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.2.  Use NXOpen::Annotations::IdSymbolBuilder::BalloonType instead.") NXOpen::Annotations::IdSymbolBuilder::SymbolTypes Type
            (
            );
            /**Sets  the symbol type 
             <br>  @deprecated Deprecated in NX12.0.2.  Use @link NXOpen::Annotations::IdSymbolBuilder::SetBalloonType NXOpen::Annotations::IdSymbolBuilder::SetBalloonType@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX12.0.2.  Use NXOpen::Annotations::IdSymbolBuilder::SetBalloonType instead.") void SetType
            (
