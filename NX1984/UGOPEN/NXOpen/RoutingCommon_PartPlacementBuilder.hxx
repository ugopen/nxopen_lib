        ...
        class NXOPENCPP_ROUTINGCOMMONEXPORT  PartPlacementBuilder : public NXOpen::Builder
        {
            ...
            */
            ...
            /** Pre commits the current placement operation to prepare data (ex. split stock, post placement, etc) for final commit. This method must be followed 
                        by a call to final commit method @link RoutingCommon::PartPlacementBuilder::CommitThisPlacement RoutingCommon::PartPlacementBuilder::CommitThisPlacement@endlink  to complete the placement operation
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link RoutingCommon::PartPlacementBuilder::ProcessPlacedPart RoutingCommon::PartPlacementBuilder::ProcessPlacedPart@endlink . <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use RoutingCommon::PartPlacementBuilder::ProcessPlacedPart.") void PreCommitThisPlacement
            (
            );
            ...
            /** Sets the port for filtration from the part being placed. 
             <br>  @deprecated Deprecated in NX1926.0.0.  No replacement method will be provided. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  No replacement method will be provided.") void SetPortOfPlaceableObject
            (
            ...
            /** Designates the component to be used for placement solution computation.
                    When relocating a flage-valve-flange unit, typically the intent is to relocate the valve. Flanges just follow the valve to its new location.
            ...
            /** Sets a flag which tells the builder whether the PTS part being dragged and dropped or not. 
             <br>  Created in NX1984.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetIsPTSDragDropOperation
            (
                bool isPTSDragDropOperation /** isptsdragdropoperation */ 
            );
        };
    }
}
