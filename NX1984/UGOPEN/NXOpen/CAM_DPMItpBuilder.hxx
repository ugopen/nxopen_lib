    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  DPMItpBuilder : public NXOpen::CAM::ParamBuilder
        {
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the side to be preserved when cross curve normal to flow is generated 
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the side to be preserved when cross curve normal to flow is generated 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
