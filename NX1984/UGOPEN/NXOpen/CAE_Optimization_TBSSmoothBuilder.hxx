            ...
            */
            class NXOPENCPP_CAEEXPORT  TBSSmoothBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the target volume that is to be achieved iteratively by varying the isovalue. If set to 0,
                        the given @link NXOpen::CAE::Optimization::TBSSmoothBuilder::IsoValue NXOpen::CAE::Optimization::TBSSmoothBuilder::IsoValue@endlink  is usedfor the generation of the isosurface 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
