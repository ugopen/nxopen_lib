        ...
        */
        class NXOPENCPP_CAEEXPORT  SimPart : public NXOpen::CAE::CaePart
        {
            ...
            /** Relabels the csys, physical, and group labels by the specified offset value
             ...
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::CAE::SimPart::RelabelEntitiesByOffsets NXOpen::CAE::SimPart::RelabelEntitiesByOffsets@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::CAE::SimPart::RelabelEntitiesByOffsets instead.") void RelabelByOffsets
            (
            ...
            /** Compress the labels of csys, physical, and groups 
             ...
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::CAE::SimPart::CompressEntityLabels NXOpen::CAE::SimPart::CompressEntityLabels@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::CAE::SimPart::CompressEntityLabels instead.") void CompressLabels
            (
