    ...
    namespace CloudDM
    {
        ...
        */
        class NXOPENCPP_CLOUDDMEXPORT  NewPartBuilder : public NXOpen::Builder
        {
            ...
            /// \cond NX_NO_DOC 
             /** Represents the context information for template part */
            public:
            ...
            /// \cond NX_NO_DOC 
            /** Auto-assigns new values to Design Number and Design Revision.
                    Note: In case, values are already assigned to Design Number or Design Revision ID,
                    then those are not replaced.
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Sets template part context for creating new part in cloud database  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
