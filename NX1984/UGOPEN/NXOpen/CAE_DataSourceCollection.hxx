    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DataSourceCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /// \cond NX_NO_DOC 
            /** Create a data source containing demonstration data. 
                      If the dataDefinitions parameter is empty, then all available data definitions will be provided.
                      Otherwise, only the selected ones will be available.
            ...
            /// \cond NX_NO_DOC 
            /** Create a misbehaving data source which crashes the system. For internal testing purposes.
