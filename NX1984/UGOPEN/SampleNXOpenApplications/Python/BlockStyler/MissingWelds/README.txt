...
--------------
    ...
    6. Plate_7.prt
    7. Plate_8.prt
    (These files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/BlockStyler/MissingWelds)
...
-----------------------
    ...
    5. You will now be on the 'Results' step.
        ...
        5.2 A sub node will be created for each missing weld. You can select the sub node by clicking on its name
            ...
            5.2.1 When you select a sub node, the display will change to show the missing weld. If 'Blank' is selected in
            ...
            5.2.2 The objects involved in the missing weld will be listed in the list box.

            5.2.3 If you check the check box corresponding to the sub node, the missing weld for the sub node will be
            ...
            5.2.4 To export an image of the missing weld to a pdf file, right click on the corresponding sub node to open the
