...
This method should only be called for parts that are fully loaded.
To find out the load state of an individual part, the following 2 methods can be used
    UF_ask_load_state_for_part_file
    UF_ask_load_state_of_part
...
extern UFUNEXPORT void uf5025(int *ia1, int *ia2,
                        int *ia3, int *ia4);

/* uf5026 temporarily modify object defaults -- replaced by default creation
                         routines above */
extern UFUNEXPORT void uf5026(const int *ip1, const int *ip2,
