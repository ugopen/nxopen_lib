 ...
 *    the invocation of UF_DRAW_ask_half_sxline.  It is placed
...
void ufusr(char *param, int *retcod, int param_len)
{
    ...
    if( !ifail )
    {
        ...
        ifail = UF_DRAW_ask_half_sxline( 
            sxline1_tag, step_dir, arrow_dir, &pview_tag,
    ...
    printf( "UF_DRAW_ask_half_sxline sample " );
    if( ifail )
    {
