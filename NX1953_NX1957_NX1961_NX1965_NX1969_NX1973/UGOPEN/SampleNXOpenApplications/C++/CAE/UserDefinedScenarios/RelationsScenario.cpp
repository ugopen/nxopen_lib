...
public:
    ...
    NXOpen::CAE::DataMatchOverrideResult Override(CaePart* part, PostScenarioDataMatchesInput* input, PostScenarioMessageCollector* mc, PostScenarioDataMatchOutput* output)
    {
        try
        {
    ...
    void RelationFRFNodeDofAggregation(CaePart* part, PostScenarioAggregationInput* input, PostScenarioMessageCollector* mc, PostScenarioAggregationOutput* output, std::map<const char*, const char*> relationVariables)
    {
        try
        {
    ...
    void RelationExcitationFRFNodeDofAggregation(CaePart* part, PostScenarioAggregationInput* input, PostScenarioMessageCollector* mc, PostScenarioAggregationOutput* output)
    {
    ...
    void RelationResponseFRFNodeDofAggregation(CaePart* part, PostScenarioAggregationInput* input, PostScenarioMessageCollector* mc, PostScenarioAggregationOutput* output)
    {
    ...
    void RelationExcitationResponseSubcaseAggregation(CaePart* part, PostScenarioAggregationInput* input, PostScenarioMessageCollector* mc, PostScenarioAggregationOutput* output)
    {
        try
        {
            PostScenarioVariableDomain* outputDomain = part->PostScenarioMgr()->NewVariableDomain();
    ...
    void PartOpenedOrCreated(BasePart* part)
    {
        ...
        try
        {
            ...
            builder = dynamic_cast<CaePart*>(part)->PostScenarioMgr()->PostScenarioDescriptors()->NewPostScenarioDescriptorBuilder();
