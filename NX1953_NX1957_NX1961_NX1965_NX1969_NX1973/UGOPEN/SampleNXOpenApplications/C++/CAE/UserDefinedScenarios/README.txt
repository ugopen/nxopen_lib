...
Files required:
    Scenario:  RelationsScenario.cpp
...
-----------
    ...
    2. Create new project as:
		...
		2.4. Select to activate the application automatically(ufsta) and to unload the application when NX session terminates. 
			 Click Finish.

    3. Remove the initial cpp file from the project. Highlight it in the Solution Explorer and use the 3rd mouse button
    ...
    4. In the Solution Explorer highlight the project name and use the 3rd mouse 
       button and drag to Add.  Choose 'Add Existing Item'. Select the file .cpp example files mentioned above and add it.

    5. Go to, Build Menu -> Build Solution or Ctrl + Shift + B (F7 in some cases) or go to Solution Explorer, right click on the
       project name and select Build.
