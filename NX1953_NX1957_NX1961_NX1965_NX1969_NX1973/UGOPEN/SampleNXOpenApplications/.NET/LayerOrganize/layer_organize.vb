...
EndOfLoop:
        ...
        Private Sub ParseLayerSpec(ByVal line As String, ByVal currentLayer As Object)
            ...
            If Not match.Success Then ThrowException("Expecting specification of which classes are in the layer" & Chr(10) &
    ...
    Function FindLayerToMoveObjectTo(ByVal obj As NXObject, ByVal nxopenSession As NXOpen.UF.UFSession, ByVal layerToClassMap As LayerToClassMap) As Integer
        Dim currentLayerId As Integer
        If obj.GetType.GetMember("Layer") IsNot Nothing And obj.GetType.GetMember("Layer").length > 0 Then
            currentLayerId = CType(obj, Object).Layer
        Else
            Return -1
        End If
