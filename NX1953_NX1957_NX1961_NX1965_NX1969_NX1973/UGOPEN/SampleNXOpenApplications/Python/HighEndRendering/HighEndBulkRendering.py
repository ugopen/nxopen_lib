...
def defineImageSettings(theSession, iRayPlusStudioEditorBuilder):
    ...
    iRayPlusStudioEditorBuilder.IRayPlusStudioStaticImagePixelWidth = pixel_width_720p
    iRayPlusStudioEditorBuilder.IRayPlusStudioStaticImagePixelHeight = pixel_height_720p
    ...
    nXObject6 = iRayPlusStudioEditorBuilder.Commit()
