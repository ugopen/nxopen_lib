...
enum UF_WEIGHT_exception_reason_e
{
    ...
    // <qiuliang 18-Aug-2020> PR9859625 extend exceptions for support legacy ufun
    ...
    UF_WEIGHT_rollup_attr_out_of_date    = 25,  /* Root part has one or more mass rolled-up attribute  which is out-of date */
    UF_WEIGHT_rollup_exp_out_of_date     = 26,  /* Root part has one or more mass rolled-up expression which is out-of date */
