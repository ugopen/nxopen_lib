        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SignalAdapterBuilder : public NXOpen::Builder
        {
            ...
            struct ParameterData
            {
             ...
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::Mechatronics::SignalAdapterBuilder::SignalDataV2 NXOpen::Mechatronics::SignalAdapterBuilder::SignalDataV2@endlink  instead. <br>  
            */
            public:
            struct NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Mechatronics::SignalAdapterBuilder::SignalDataV2 instead.") SignalData
            {
             ...
             /** Defines the signal data version 2. */
            public:
            struct SignalDataV2
            {
                public: /** Name                */NXString Name;
            ...
            /** Gets all signal data.  @return  Array of signal data 
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link Mechatronics::SignalAdapterBuilder::GetSignalDataV2 Mechatronics::SignalAdapterBuilder::GetSignalDataV2@endlink  instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use Mechatronics::SignalAdapterBuilder::GetSignalDataV2 instead.") std::vector<NXOpen::Mechatronics::SignalAdapterBuilder::SignalData> GetSignalData
            (
            );
            /** Gets all signal data.  @return  Array of signal data 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: std::vector<NXOpen::Mechatronics::SignalAdapterBuilder::SignalDataV2> GetSignalDataV2
            (
            );
