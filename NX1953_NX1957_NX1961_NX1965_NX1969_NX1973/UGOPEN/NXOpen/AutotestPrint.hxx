    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  AutotestPrint
    {
        ...
        /**Returns  an override that allows applications to ignore the custom option set
                ...
                the PrintTestData method will behave based on the @link Autotest::PrintLevelOption Autotest::PrintLevelOption@endlink . 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        ...
        /**Returns  the level of output for the PrintTestData method when
                the @link Autotest::CustomOptionOverride Autotest::CustomOptionOverride@endlink  is true 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
