    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  AutoFlexPropertyBuilder : public NXOpen::Builder
        {
            ...
            {
                SolverTypeNXNastran/** Simcenter Nastran solver (legacy name, deprecated in 2020.2) */,
                SolverTypeSimcenterNastran/** Simcenter Nastran solver */ = 0,
