...
#include <NXOpen/Fields_FieldDrawHelper.hxx>
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  Field : public NXOpen::DisplayableObject
        {
            ...
            /** Returns a field drawhelper which can be used to get display attributes of this field.
                     @return  Field DrawHelper 
             <br>  @deprecated Deprecated in NX1938.0.0.  This method was introduced for testing field display and does nothing for the end user and should not be used.  It will no-op if called.  There is no replacement. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1938.0.0.  This method was introduced for testing field display and does nothing for the end user and should not be used.  It will no-op if called.  There is no replacement.") NXOpen::Fields::FieldDrawHelper * GetFieldDrawhelper
            (
            );
            /** Set part context.
            ...
            /** Creates a field drawhelper which can be used to get display attributes of this field.
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1938.0.0.  This method was introduced for testing field display and does nothing for the end user and should not be used.  It will no-op if called.  There is no replacement.") NXOpen::Fields::FieldDrawHelper * CreateDrawHelper
            (
            );
