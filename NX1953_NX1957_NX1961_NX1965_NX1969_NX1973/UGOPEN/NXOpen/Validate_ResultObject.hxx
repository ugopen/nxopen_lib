        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  ResultObject : public NXOpen::NXObject
        {
            ...
            /**Returns  the name of check result 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::NXObject::Name NXOpen::NXObject::Name@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::NXObject::Name instead.") NXString Name
            (
            );
            /**Sets  the name of check result 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::NXObject::SetName NXOpen::NXObject::SetName@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::NXObject::SetName instead.") void SetName
            (
