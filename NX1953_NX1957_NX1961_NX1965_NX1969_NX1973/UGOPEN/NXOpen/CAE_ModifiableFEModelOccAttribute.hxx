        ...
        */
        class NXOPENCPP_CAEEXPORT  ModifiableFEModelOccAttribute : public NXOpen::CAE::FEModelOccAttribute
        {
            ...
            /** Set the representation type to super element
             ...
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::ModifiableFEModelOccAttribute::SetAltRepType NXOpen::CAE::ModifiableFEModelOccAttribute::SetAltRepType@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::ModifiableFEModelOccAttribute::SetAltRepType instead.") void SetRepToSuperElement
            (
