        ...
        */
        class NXOPENCPP_CAEEXPORT  PostScenarioDescriptorBuilder : public NXOpen::Builder
        {
            ...
            public: /**  @brief Called to allow the scenario to perform transformations on deformations of the query data. 
             ...
             <br> License requirements : None */
            typedef NXOpen::Callback5<void, NXOpen::CAE::CaePart *, NXOpen::CAE::PostScenarioQueryResults *, NXOpen::CAE::PostScenarioQueryResults *, NXOpen::CAE::PostScenarioQueryContext *, NXOpen::CAE::PostScenarioQueryResults *> DeformationTransformationCallback;
            public: /**  @brief Called to allow the scenario to perform transformations on the result coordinate systems of the queried data. 
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            typedef NXOpen::Callback5<void, NXOpen::CAE::CaePart *, NXOpen::CAE::PostScenarioQueryResults *, NXOpen::CAE::PostScenarioQueryResults *, NXOpen::CAE::PostScenarioQueryContext *, NXOpen::CAE::PostScenarioQueryResults *> OrientationTransformationCallback;
            public: /**  @brief This callback is used to retrieve values for choice-type configuration variables 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            typedef NXOpen::Callback3<void, NXOpen::CAE::CaePart *, NXOpen::CAE::PostScenarioConfigurationVariableCallbackContext *, NXOpen::CAE::PostScenarioValueCollector *> ChoiceProviderCallback;
            public: /**  @brief This callback is used disable variables (c.f. @link CAE::PostScenarioSelectionParameters CAE::PostScenarioSelectionParameters@endlink ) based on the value of configuration variables. 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            typedef NXOpen::Callback3<bool, NXOpen::CAE::CaePart *, NXOpen::CAE::PostScenarioConfigurationVariableCallbackContext *, NXOpen::CAE::PostScenarioValueCollector *> SensitivityCallback;
            public: /**  @brief  
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            typedef NXOpen::Callback4<NXOpen::CAE::DataMatchOverrideResult, NXOpen::CAE::CaePart *, NXOpen::CAE::PostScenarioDataMatchesInput *, NXOpen::CAE::PostScenarioMessageCollector *, NXOpen::CAE::PostScenarioDataMatchOutput *> OverrideMatchCallback;
            public: /**  @brief 
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            typedef NXOpen::Callback4<void, NXOpen::CAE::CaePart *, NXOpen::CAE::PostScenarioAggregationInput *, NXOpen::CAE::PostScenarioMessageCollector *, NXOpen::CAE::PostScenarioAggregationOutput *> AggregationCallback;
            public: /**  @brief 
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            typedef NXOpen::Callback4<void, NXOpen::CAE::CaePart *, NXOpen::CAE::PostScenarioValueCollector *, NXOpen::CAE::PostScenarioSelectionCallbackContext *, NXOpen::CAE::PostScenarioValueCollector *> OverrideDefaultSelectionCallback;
