    ...
    namespace PcbExchange
    {
        ...
        */
        class NXOPENCPP_PCBEXCHANGEEXPORT  PreferencesBuilder : public NXOpen::Builder
        {
            ...
            public: enum ComponentsModelTypeName
            {
            ...
            /**Returns  the component model for thermal analysis. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PcbExchange::PreferencesBuilder::ComponentsModelTypeName ComponentsModel
            (
            );
            /**Sets  the component model for thermal analysis. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetComponentsModel
            (
            ...
            /**Returns  the junction capacity for thermal analysis. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ComponentsJunctionCapacity
            (
            );
