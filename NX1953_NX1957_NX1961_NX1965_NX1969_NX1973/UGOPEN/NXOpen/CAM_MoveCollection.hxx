    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  MoveCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /// \cond NX_NO_DOC 
            /** Creates a contact move.   @return  Builder 
            ...
            /// \cond NX_NO_DOC 
            /** Creates a tool center point on builder.   @return  tool center point move builder 
            ...
            /// \cond NX_NO_DOC 
            /** Creates a tool center point off builder.   @return  tool center point move builder 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /** Create a output for MCS.   @return  the output for mcs builder 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
