    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  Lattice2Builder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  @brief  The output type enum determines how the voronoi lattice will be created. It will either be created on the Surface, within the Volume or both on the Surface and within the Volume.  
            ...
            /**Sets  @brief  The output type enum determines how the voronoi lattice will be created. It will either be created on the Surface, within the Volume or both on the Surface and within the Volume.  
