...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Sketch : public NXOpen::DisplayableObject, public virtual NXOpen::IProfile
    {
        ...
        /// \cond NX_NO_DOC 
        /** Remove the constraints in the active sketch immediately.
                The constraints passed in will be gone and should not be used anymore.
                The function should not be called in the middle of another operation. 
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: void DeleteConstraintsImmediately
        (
            const std::vector<NXOpen::SketchConstraint *> & constraints /** The constraints in the active sketch need to be deleted immediately*/
        );
