    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostScenarioMetadata : public NXOpen::TransientObject
        {
            ...
            /**Returns  the energy correction factor specific to the windowing function apllied on the signal, if any 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: double EnergyCorrectionFactor
            (
            );
            /**Sets  the energy correction factor specific to the windowing function apllied on the signal, if any 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the amplitude correction factor specific to the windowing function apllied on the signal, if any 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: double AmplitudeCorrectionFactor
            (
            );
            /**Sets  the amplitude correction factor specific to the windowing function apllied on the signal, if any 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the flag which indicates the existance of duplicate functions for the same set of selection variables. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool Duplicate
            (
            );
            /**Sets  the flag which indicates the existance of duplicate functions for the same set of selection variables. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                NXString* username /** The username of the data source provided by the @link NXOpen::CAE::PostScenarioResultGroup NXOpen::CAE::PostScenarioResultGroup@endlink . */,
            ...
            (
                const NXString & username /** The username of the data source provided by the @link NXOpen::CAE::PostScenarioResultGroup NXOpen::CAE::PostScenarioResultGroup@endlink . */,
            ...
            void SetOrigin
            (
                const char * username /** The username of the data source provided by the @link NXOpen::CAE::PostScenarioResultGroup NXOpen::CAE::PostScenarioResultGroup@endlink . */,
            ...
            /**Returns  the first independent name that is used by the file column headers of exported csv files of composed funtion plots. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXString CustomizedFirstIndependentColumnName
            (
            );
            /**Sets  the first independent name that is used by the file column headers of exported csv files of composed funtion plots. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the second independent name that is used by the file column headers of exported csv files of composed funtion plots. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXString CustomizedSecondIndependentColumnName
            (
            );
            /**Sets  the second independent name that is used by the file column headers of exported csv files of composed funtion plots. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the dependent name that is used by the file column headers of exported csv files of composed funtion plots. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXString CustomizedDependentColumnName
            (
            );
            /**Sets  the dependent name that is used by the file column headers of exported csv files of composed funtion plots. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the Alias metadatum is set in the context of Split Alias or Independent Alias relation (see scenario descriptor xml),
            ...
            /**Sets  the Alias metadatum is set in the context of Split Alias or Independent Alias relation (see scenario descriptor xml),
                        and the value will be the name of the alias of the selection variable that determined this plot to be selected.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
