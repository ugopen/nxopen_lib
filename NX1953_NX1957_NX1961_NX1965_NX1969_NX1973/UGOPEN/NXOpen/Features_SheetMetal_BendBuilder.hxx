            ...
            */
            class NXOPENCPP_FEATURESEXPORT  BendBuilder : public NXOpen::Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                */
                ...
                /// \cond NX_NO_DOC 
                /**Returns  the state of unbend toggle. If true, bend will be created in flattened state. 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: bool UnbendToggle
                (
                );
                ...
                /// \cond NX_NO_DOC 
                /**Sets  the state of unbend toggle. If true, bend will be created in flattened state. 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetUnbendToggle
                (
                    bool unbendToggle /** the toggle for flattening the bend */
                );
