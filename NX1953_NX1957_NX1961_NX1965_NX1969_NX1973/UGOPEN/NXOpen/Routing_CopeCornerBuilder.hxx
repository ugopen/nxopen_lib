...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::Routing::AssignCornerBuilder instead.") NXOPENCPP_ROUTINGEXPORT  CopeCornerBuilder : public NXOpen::Builder
        {
