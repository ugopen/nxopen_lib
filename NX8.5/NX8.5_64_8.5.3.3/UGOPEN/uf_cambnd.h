 ...
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_append_bnd_from_face
(
 ...
 * History: Released in V18.0
 ***************************************************************************/
extern UFUNEXPORT int UF_CAMBND_delete_boundaries
(
    tag_t               object_tag,                 /* <I> the parent object of the
                                                           boundary */
    UF_CAM_geom_type_t  type                        /* <I> the type of the boundary */
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_boundaries
(
    tag_t                      object_tag,          /* <I>  the parent object of the
                                                            boundary */
    UF_CAM_geom_type_t         type,                /* <I>  the type of the boundary */
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_delete_boundary
(
    tag_t                       object_tag,         /* <I> the parent object of the
                                                           boundary */
    UF_CAM_geom_type_t          type,               /* <I> the type of the boundary */
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_boundary_data
(
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_boundary_app_data
(
    UF_CAMBND_boundary_t      boundary,             /* <I> the boundary item */
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_set_boundary_app_data
(
    tag_t                      object_tag,          /* <I> the parent object of the
                                                           boundary */
    UF_CAM_geom_type_t         type,                /* <I> the type of the boundary */
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_boundary_items
(
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_item_entity
(
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_item_app_data
(
    UF_CAMBND_item_t             item,              /* <I> the boundary member */
 ...
 * History: Released in V18.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_set_item_app_data
(
    tag_t                      object_tag,          /* <I> the parent object of the
                                                           boundary */
    UF_CAM_geom_type_t         type,                /* <I> the type of the boundary */
 ...
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_boundary_group_data
(
    UF_CAMBND_boundary_t      boundary,             /* <I> the boundary item */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_set_boundary_group_data
(
    tag_t                      object_tag,          /* <I> the parent object of the
                                                           boundary */
    UF_CAM_geom_type_t         type,                /* <I> the type of the boundary */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_item_group_data
(
    UF_CAMBND_item_t             item,              /* <I> the boundary member */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_set_item_group_data
(
    tag_t                      object_tag,          /* <I> the parent object of the
                                                           boundary */
    UF_CAM_geom_type_t         type,                /* <I> the type of the boundary */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_is_inherited
(
    tag_t                       object_tag,  /* <I> the parent object of the
                                                           boundary */
    UF_CAM_geom_type_t          type,        /* <I> the type of the boundary */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_ask_item_udes
(
   UF_CAMBND_item_t            item,        /* <I> the boundary member */
 ...
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_WEDM_ask_item_udes
(
   UF_CAMBND_item_t            item,        /* <I> the boundary member */
   UF_CAMBND_UDE_set_type_t    set_type,    /* <I> the type of the user
                                                   defined events.
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_delete_all_item_udes
(
   UF_CAMBND_item_t            item,        /* <I> the boundary member */
   UF_CAMBND_UDE_set_type_t    set_type     /* <I> the type of the user
                                                   defined events.
 ...
 * History: Released in NX6.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_WEDM_delete_all_item_udes
(
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_append_item_ude
(
   UF_CAMBND_item_t            item,        /* <I> the boundary member */
   UF_CAMBND_UDE_set_type_t    set_type,    /* <I> the type of the user
                                                   defined events. */
 ...
 * History: Released in NX6.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_WEDM_append_item_ude
(
   UF_CAMBND_item_t            item,        /* <I> the boundary member */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_delete_item_ude
(
   UF_CAMBND_item_t            item,        /* <I> the boundary member */
   UF_CAMBND_UDE_set_type_t    set_type,    /* <I> the type of the user
                                                   defined events. */
 ...
 * History: Released in NX6.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_WEDM_delete_item_ude
(
   UF_CAMBND_item_t            item,        /* <I> the boundary member */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_can_accept_item_ude
(
   UF_CAMBND_item_t            item,       /* <I> the boundary member */
   UF_CAMBND_UDE_set_type_t    set_type,   /* <I> the type of the user
                                                   defined events. */
 ...
 ********************************************************************** */
extern UFUNEXPORT int UF_CAMBND_set_boundary_plane
(
    UF_CAMBND_boundary_t boundary,        /* <I> the boundary item */
