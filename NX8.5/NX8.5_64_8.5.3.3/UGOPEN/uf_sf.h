...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_mesh_2d_loops
(
...
tag_t language_tag ,/* <I>
                    ...
                    language name.
                    */
char language_name[UF_SF_LANG_MAX_NAME_LENGTH] ,/* <O>
...
tag_t  solution ,/* <I>
                 Tag of the solution.
                 */
char solution_name[UF_SF_MAX_STRING_LEN]  /* <O>
...
tag_t  step ,    /* <I>
                 Step tag.
                 */
char step_name[UF_SF_MAX_STRING_LEN]  /* <O>
                  Name of the step.
                  The maximum number of allowable
                  characters is UF_SF_MAX_STRING_LEN.
                  */
...
(
    ...
    double             delta_a[3]     /*<O> Node displacement values
...
/*******************************************************************************
Calculates the current extreme results set upon pre-processing meshes.  It
is not a solver results post-processing function. This function works in
conjunction with:
     UF_SF_ask_node_delta
     UF_SF_set_nodes_delta_by_id
     UF_SF_ask_elem_node_results
...
This function runs through all meshes and finds the maximum and minimums
...
(
      ...
      char text_str[UF_SF_LEGEND_REAL_STR_SZ+1]  /*<O> Formated text string.  No memory is allocated.
...
tag_t             dursol_tag,              /* <I>
                                           Durability Solution tag.
                                           */
char              dursol_name[UF_SF_MAX_STRING_LEN],             /* <O>
...
tag_t                    lv_tag,            /* <I>
                                            Load Variation tag
                                            */
char                     lv_name[UF_SF_MAX_STRING_LEN],           /* <O>
                                            Name
