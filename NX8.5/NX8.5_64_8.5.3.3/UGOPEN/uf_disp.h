...
/*  */
#define     UF_SH_MAX_MAT_NAME_SIZE      133
...
extern UFUNEXPORT int UF_DISP_set_highlights(
          int       object_count, /* <I> 
                                  The number of objects in object_list
                                  */
          tag_p_t   object_list,  /* <I> 
                                  The tags of the objects to set highlights 
                                  */
          int action_switch       /* <I>
                                  Action Switch
                                  0 = Turn Highlight Off
...
extern UFUNEXPORT int UF_DISP_ask_material(
    ...
    char material_name[UF_SH_MAX_MAT_NAME_SIZE]           /* <O> The name of the material */
...
extern UFUNEXPORT int UF_DISP_ask_currently_selected_material(
    ...
    char  material_full_archive_name[UF_CFI_MAX_PATH_NAME_SIZE]          /* <O> The full_arachive_name of the material currently selected in the Materials in part 
...
extern UFUNEXPORT int UF_DISP_copy_material(
    ...
    char new_material_name[UF_CFI_MAX_PATH_NAME_SIZE ]       /* <O> The name of the newly copied material*/
);
...
/******************************************************************************
 * This function applies "None" material to a geometry identified by the input object tag arugment. 
