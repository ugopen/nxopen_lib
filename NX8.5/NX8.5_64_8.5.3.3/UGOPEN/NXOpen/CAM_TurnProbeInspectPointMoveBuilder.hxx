...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents the Turn Probe Inspect Point Move Builder  <br> To create a new instance of this class, use @link CAM::MoveCollection::CreateTurnProbeInspectPointMoveBuilder  CAM::MoveCollection::CreateTurnProbeInspectPointMoveBuilder @endlink  <br> 
         <br>  Created in NX8.5.1.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  TurnProbeInspectPointMoveBuilder : public CAM::MoveBuilder
        {
