...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class SolutionImpl;
            /** Represents a meta solution providing response analysis functionalities in the .sim file   <br> To create or edit an instance of this class, use @link CAE::ResponseSimulation::SolutionBuilder  CAE::ResponseSimulation::SolutionBuilder @endlink  <br> 
             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  Solution : public NXObject
            {
                ...
                /** Performs evaluation for FRF. The evaluation results will be stored in an AFU file,
                        which name could be returned by @link CAE::ResponseSimulation::Solution::GetResultFileName CAE::ResponseSimulation::Solution::GetResultFileName@endlink  
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
