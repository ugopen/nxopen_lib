...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PackagingInterferenceBuilder : public Motion::PackagingBuilder
        {
            ...
            /** Sets the geometry list 2 of @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  object. 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  action type defined
                    at @link  Motion::PackagingInterferenceBuilder::Action   Motion::PackagingInterferenceBuilder::Action @endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  mode type defined
                    at @link  Motion::PackagingInterferenceBuilder::Mode   Motion::PackagingInterferenceBuilder::Mode @endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  frame type
                    defined at @link  Motion::PackagingInterferenceBuilder::Frame   Motion::PackagingInterferenceBuilder::Frame @endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  clearance value 
             <br>  @deprecated Deprecated in NX8.5.0.  Obtion the exression using @link Motion::PackagingInterferenceBuilder::ClearanceExpression Motion::PackagingInterferenceBuilder::ClearanceExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::PackagingInterferenceBuilder::ClearanceExpression to query or edit it.") double Clearance
            (
            );
            /**Sets  the @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  clearance value 
             <br>  @deprecated Deprecated in NX8.5.0.  Obtion the exression using @link Motion::PackagingInterferenceBuilder::ClearanceExpression Motion::PackagingInterferenceBuilder::ClearanceExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::PackagingInterferenceBuilder::ClearanceExpression to query or edit it.") void SetClearance
            (
                double clearance /** clearance */ 
            );
            /**Returns  the Stop_On_Event flag of @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  object 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool StopOnEvent
            (
            );
            /**Sets  the Stop_On_Event flag of @link  Motion::PackagingInterference   Motion::PackagingInterference @endlink  object 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
