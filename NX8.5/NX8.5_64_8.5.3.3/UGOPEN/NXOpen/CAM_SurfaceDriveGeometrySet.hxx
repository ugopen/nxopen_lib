...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a geometry set for a CAM object. Multiple sets define the actual geometry of a specific type.  <br> To create a new instance of this class, use @link CAM::SurfaceDriveGeometry::CreateEmptyGeometrySet  CAM::SurfaceDriveGeometry::CreateEmptyGeometrySet @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  SurfaceDriveGeometrySet : public TaggedObject
        {
