...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                    Represents a @link Features::ShipDesign::TransFrameListItemBuilder Features::ShipDesign::TransFrameListItemBuilder@endlink 
                    
             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  TransFrameListItemBuilder : public NXObject
            {
