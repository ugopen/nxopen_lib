...
namespace NXOpen
{
    ...
    namespace Positioning
    {
        ...
        */
        class NXOPENCPP_POSITIONINGEXPORT  Constraint : public NXObject
        {
            ...
            void SetExpression
            (
                const char * expression /** Name of expression used in distance or angle constraint   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /**Returns  
            ...
            /**Returns  the type of the spline.  Only valid if the type of the constraint is
                  set to @link Positioning::Constraint::TypeSplineData Positioning::Constraint::TypeSplineData@endlink . 
