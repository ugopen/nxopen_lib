    ...
    */
    class NXOPENCPPEXPORT  FontCollection
    {
        ...
        /** Adds a font to the part.  This will only add NX fonts.  To add Standard fonts,
                use the overloaded @link FontCollection::AddFont FontCollection::AddFont@endlink  routine that accepts the font type.  @return  Integer ID that the method assigns to the font 
         <br>  Created in NX3.0.0.  <br>  
        ...
        /** Adds a font to the part.  This can be used to create both NX and Standard fonts.  @return  Integer ID that the method assigns to the font 
