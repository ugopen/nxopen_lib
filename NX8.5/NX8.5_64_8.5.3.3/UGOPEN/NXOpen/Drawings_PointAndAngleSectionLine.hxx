...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Point and Angle Section Line lets you create a view with multiple
                ...
                set of rotation points and angles.  <br> To create or edit an instance of this class, use @link Drawings::SectionLineBuilder  Drawings::SectionLineBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  PointAndAngleSectionLine : public Drawings::SectionLine
        {
