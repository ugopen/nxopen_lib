...
namespace NXOpen
{
    ...
    namespace Validate
    {
        ...
        /**
             Represents an NX @link Validate::RequirementCheck Validate::RequirementCheck@endlink  object.
        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  RequirementCheck : public Validation
        {
            ...
            /**Returns  the parent @link Validate::Requirement Validate::Requirement@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Validate::Requirement * ParentRequirement
            (
            );
            /**Sets  the parent @link Validate::Requirement Validate::Requirement@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
