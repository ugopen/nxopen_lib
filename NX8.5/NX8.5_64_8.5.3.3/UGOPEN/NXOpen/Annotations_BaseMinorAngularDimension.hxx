#ifndef NXOpen_ANNOTATIONS_BASEMINORANGULARDIMENSION_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_BASEMINORANGULARDIMENSION_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Annotations_BaseMinorAngularDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseMinorAngularDimensionBuilder;
        class BaseMinorAngularDimensionImpl;
        /** Represents a minor angular dimension  <br> This is an abstract class and cannot be directly instantiated  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseMinorAngularDimension : public Annotations::AngularDimension, public virtual Annotations::IPmi
        {
            private: BaseMinorAngularDimensionImpl * m_baseminorangulardimension_impl;
            private: friend class  _BaseMinorAngularDimensionBuilder;
            protected: BaseMinorAngularDimension();
            public: ~BaseMinorAngularDimension();
