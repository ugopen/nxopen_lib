...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a drafting arbitrary datum target.  <br> To create or edit an instance of this class, use @link Annotations::DraftingDatumTargetBuilder  Annotations::DraftingDatumTargetBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DraftingArbitraryTarget : public Annotations::DraftingDatumTarget, public virtual Annotations::IArbitraryTarget
        {
