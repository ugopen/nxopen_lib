...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _DatumBuilder;
        class DatumImpl;
        /** Represents a datum  <br> To create or edit an instance of this class, use @link Annotations::PmiDatumFeatureSymbolBuilder  Annotations::PmiDatumFeatureSymbolBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  Datum : public Annotations::DraftingDatum, public virtual Annotations::IPmi
        {
