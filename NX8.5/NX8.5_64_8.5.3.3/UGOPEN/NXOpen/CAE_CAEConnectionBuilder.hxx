...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CAEConnectionBuilder : public Builder
        {
            ...
            /**
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.1.  Use Builder::Commit instead.") NXOpen::CAE::CAEConnection * CommitConnection
            (
            );
        };
    }
