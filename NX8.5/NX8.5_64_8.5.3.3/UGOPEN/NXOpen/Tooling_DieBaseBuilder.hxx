...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents Progressive Die Wizard and Engineering Die Wizard builder to manage die base.  <br> To create a new instance of this class, use @link Tooling::DieBaseCollection::CreateDieBaseBuilder  Tooling::DieBaseCollection::CreateDieBaseBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DieBaseBuilder : public Builder
        {
            /** die base types. */
            public: enum Types
            {
