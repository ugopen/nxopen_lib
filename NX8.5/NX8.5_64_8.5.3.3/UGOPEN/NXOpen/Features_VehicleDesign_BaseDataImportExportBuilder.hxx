    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::BaseDataImportExportBuilder Features::VehicleDesign::BaseDataImportExportBuilder@endlink  
                        builder used to import and export expressions from and to a spreadsheet. <br> To create a new instance of this class, use @link Features::AutomotiveCollection::CreateBaseDataImportExportBuilder  Features::AutomotiveCollection::CreateBaseDataImportExportBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
