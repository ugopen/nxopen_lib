...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects a region of faces that are tangent connected. 
    ...
    */
    class NXOPENCPPEXPORT  FaceRegionBoundaryRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the face region boundary rule: @link  FaceRegionBoundaryRule   FaceRegionBoundaryRule @endlink  
         <br>  Created in NX7.0.0.  <br>  
