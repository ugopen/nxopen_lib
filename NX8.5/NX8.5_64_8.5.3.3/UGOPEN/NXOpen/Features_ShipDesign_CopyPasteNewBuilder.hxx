...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**  Represents a @link Features::ShipDesign::CopyPasteNewBuilder Features::ShipDesign::CopyPasteNewBuilder@endlink   
                    ...
                    <br> To create a new instance of this class, use @link Features::ShipCollection::CreateCopyPasteNewBuilder  Features::ShipCollection::CreateCopyPasteNewBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  CopyPasteNewBuilder : public Features::FeatureBuilder, public virtual IAttributeSourceObjectBuilder
            {
