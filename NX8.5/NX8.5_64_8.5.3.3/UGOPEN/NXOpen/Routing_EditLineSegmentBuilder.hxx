...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  EditLineSegmentBuilder : public Builder
        {
            ...
            /**Returns  the reverse direction flag.  Flips the direction that the extends towards (or
                        shirinks along).  This flips the origin of the line as well as the direction. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Stop the drag operation if it has begun. This will commit the drag and update the assembly.
                        ...
                        @link Routing::EditLineSegmentBuilder::RestartDrag Routing::EditLineSegmentBuilder::RestartDrag@endlink . 
            ...
            /** Determines the active RCP for the line selected by the user.
                        ...
                        This RCP could dragged along the segment. @return  End point other
