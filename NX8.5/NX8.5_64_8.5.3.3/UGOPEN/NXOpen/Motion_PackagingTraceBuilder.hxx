...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PackagingTraceBuilder : public Motion::PackagingBuilder
        {
            ...
            /**Returns  the @link  Motion::PackagingTrace   Motion::PackagingTrace @endlink  target layer 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: int TargetLayer
            (
            );
            /**Sets  the @link  Motion::PackagingTrace   Motion::PackagingTrace @endlink  target layer 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
