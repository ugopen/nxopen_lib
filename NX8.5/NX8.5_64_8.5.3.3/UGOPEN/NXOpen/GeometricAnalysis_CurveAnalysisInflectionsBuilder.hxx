...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  NX_DEPRECATED("Deprecated in NX8.5.0.  Use GeometricAnalysis::CurveCurvatureAnalysis.")  CurveAnalysisInflectionsBuilder : public Builder
        {
