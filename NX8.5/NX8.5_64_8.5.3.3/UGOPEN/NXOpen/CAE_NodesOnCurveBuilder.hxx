...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  NodesOnCurveBuilder : public Builder
        {
            ...
            /**Returns  the edge 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAE::NodesOnCurveBuilder::Geom CAE::NodesOnCurveBuilder::Geom@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAE::NodesOnCurveBuilder::Geom instead.") NXOpen::CAE::SelectCAEEdge * Edge
            (
            );
            /**Returns  the selected geometry, on which nodes will be created. 
                       Valid selection types are edges, point and curves @link CAE::CAEEdge CAE::CAEEdge@endlink , @link Point Point@endlink , 
                       @link Line Line@endlink , @link Edge Edge@endlink , @link Spline Spline@endlink  
