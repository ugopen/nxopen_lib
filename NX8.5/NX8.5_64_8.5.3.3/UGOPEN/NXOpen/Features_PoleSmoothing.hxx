...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a pole smoothing feature  <br> To create or edit an instance of this class, use @link Features::PoleSmoothingBuilder  Features::PoleSmoothingBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  PoleSmoothing : public Features::BodyFeature
        {
