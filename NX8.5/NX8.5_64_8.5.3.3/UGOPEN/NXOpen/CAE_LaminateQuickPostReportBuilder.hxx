...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  LaminateQuickPostReportBuilder : public Builder
        {
            ...
            (
                const char * csvFilename /** forces and plies results will be written-out to this file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            /** A method to set selected solution name 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void SetSelectedResultName
            (
                int iselsol /** selected solution */,
                const char * solname /** ...   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
