...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseDiameterDimension : public Annotations::Dimension, public virtual Annotations::ILinearTolerance, public virtual Annotations::IPmi
        {
