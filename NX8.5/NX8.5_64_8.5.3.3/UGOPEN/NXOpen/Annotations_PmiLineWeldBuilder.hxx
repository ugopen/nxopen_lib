...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiLineWeldBuilder : public Annotations::LineWeldBuilder
        {
            ...
            /**Returns  the @link Annotations::AssociatedObjectsBuilder Annotations::AssociatedObjectsBuilder@endlink   for weld symbol 
             <br>  Created in NX6.0.0.  <br>  
