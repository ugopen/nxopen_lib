...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::SignalMappingBuilder Mechatronics::SignalMappingBuilder@endlink   <br> To create a new instance of this class, use @link Mechatronics::PhysicsManager::CreateSignalMappingBuilder  Mechatronics::PhysicsManager::CreateSignalMappingBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SignalMappingBuilder : public Builder
        {
