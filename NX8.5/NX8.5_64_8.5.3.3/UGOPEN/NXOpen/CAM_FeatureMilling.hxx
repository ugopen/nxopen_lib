...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Feature Milling Operation  <br> To create or edit an instance of this class, use @link CAM::FeatureMillingBuilder  CAM::FeatureMillingBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  FeatureMilling : public CAM::PlanarOperation
        {
