...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects all curves created by a feature. 
    ...
    */
    class NXOPENCPPEXPORT  CurveFeatureRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the curve feature rule: @link  CurveFeatureRule   CurveFeatureRule @endlink  
         <br>  Created in NX3.0.0.  <br>  
