...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Cavity Milling Operation  <br> To create or edit an instance of this class, use @link CAM::CavityMillingBuilder  CAM::CavityMillingBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  CavityMilling : public CAM::PlanarOperation
        {
