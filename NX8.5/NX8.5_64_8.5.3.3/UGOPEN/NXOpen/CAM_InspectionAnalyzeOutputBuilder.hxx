...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Inspection Analyze Output options dialog builder  <br> To create a new instance of this class, use @link CAM::InspectionOperationCollection::CreateInspectionAnalyzeOutputBuilder  CAM::InspectionOperationCollection::CreateInspectionAnalyzeOutputBuilder @endlink  <br> 
         <br>  Created in NX8.5.1.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  InspectionAnalyzeOutputBuilder : public Builder
        {
