...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PreTestDofSetBuilder : public Builder
        {
            ...
            /**Returns  the referrenced @link CAE::CaeDOFSet CAE::CaeDOFSet@endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: NXOpen::CAE::CaeDOFSet * DofSetSelect
            (
            );
            /**Sets  the referrenced @link CAE::CaeDOFSet CAE::CaeDOFSet@endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
