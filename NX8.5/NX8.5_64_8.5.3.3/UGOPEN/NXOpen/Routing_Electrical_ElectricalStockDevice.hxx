...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ElectricalStockDevice : public Routing::StockDevice
            {
                ...
                /** Get nearest @link Routing::Electrical::HarnessDefinition Routing::Electrical::HarnessDefinition@endlink  encountered up the parent-child hierarchy.  @return  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                public: NXOpen::Routing::Electrical::HarnessDefinition * FindNearestHarnessDefinition
                (
                );
                /** Get topmost @link Routing::Electrical::CableDefinition Routing::Electrical::CableDefinition@endlink  encountered up the parent-child hierarchy.  @return  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                ...
                /** Find the nearest @link Routing::Electrical::HarnessDevice Routing::Electrical::HarnessDevice@endlink  encountered up the parent-child hierarchy.  @return  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                public: NXOpen::Routing::Electrical::HarnessDevice * FindNearestHarnessDevice
                (
                );
                /** Find the @link Routing::Electrical::Connection Routing::Electrical::Connection@endlink  implemented by this device.  @return  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                ...
                /** Manually routes a @link Routing::Electrical::ElectricalStockDevice Routing::Electrical::ElectricalStockDevice@endlink . 
                                ...
                                path between two @link Routing::Electrical::ConnectorDevice Routing::Electrical::ConnectorDevice@endlink  objects. 
