...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents the builder which is used to create flow analysis.  <br> To create a new instance of this class, use @link Tooling::MoldDesignCollection::CreateFlowAnalysisBuilder  Tooling::MoldDesignCollection::CreateFlowAnalysisBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  FlowAnalysisBuilder : public Builder
        {
