...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  GeneralConicBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the plane constrained toggle. Used by point types. Enables @link ConstrainedPlaneCSYS ConstrainedPlaneCSYS @endlink and @link SetConstrainedPlaneCSYS SetConstrainedPlaneCSYS @endlink . Disables @link DrawingPlaneOption DrawingPlaneOption @endlink and @link SetDrawingPlaneOption SetDrawingPlaneOption @endlink  and @link GeneralDrawingPlane GeneralDrawingPlane @endlink and @link SetGeneralDrawingPlane SetGeneralDrawingPlane @endlink . 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the conic creation type. See @link Type Type@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::GeneralConicBuilder::Types Type
            (
            );
            /**Sets  the conic creation type. See @link Type Type@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
            public: void SetType
            (
