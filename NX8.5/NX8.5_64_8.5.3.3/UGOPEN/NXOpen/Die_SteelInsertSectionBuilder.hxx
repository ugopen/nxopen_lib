...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  SteelInsertSectionBuilder : public Features::FeatureBuilder
        {
            ...
            (
                const char * backSideReliefDistance /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * productContactWidth /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * productContactRelief /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * planarOffsetHeight /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * offsetProfileToTop /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
