...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  FunctionBuilder : public Builder
        {
            ...
            /** Sets definition strings of a math function. Only used when function type
                        is @link CAE::Function::TypeMath CAE::Function::TypeMath@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            ...
            /** Returns definition strings of a math function. Only used when function type
                        is @link CAE::Function::TypeMath CAE::Function::TypeMath@endlink   @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            ...
            /** Sets data for a table function. Only used when function type
                        is @link CAE::Function::TypeTable CAE::Function::TypeTable@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
