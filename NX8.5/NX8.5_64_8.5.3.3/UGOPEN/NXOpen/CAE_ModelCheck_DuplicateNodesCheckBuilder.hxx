...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ModelCheck
        {
            ...
            /** Represents a @link CAE::ModelCheck::DuplicateNodesCheckBuilder CAE::ModelCheck::DuplicateNodesCheckBuilder@endlink 
                        ...
                        @link CAE::ModelCheck::DuplicateNodesCheckBuilder::MergeDuplicateNodes CAE::ModelCheck::DuplicateNodesCheckBuilder::MergeDuplicateNodes@endlink .
                        Commits the builder to merge duplicate nodes and update the mesh in graphic window.
                    
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  DuplicateNodesCheckBuilder : public Builder
            {
                ...
                public: enum MergePreference
                {
                    ...
                    MergePreferenceKeepSelected/** Keep the nodes specified in the node list
                                                                                                             @link CAE::ModelCheck::DuplicateNodesCheckBuilder::SelectPreferenceNodesList CAE::ModelCheck::DuplicateNodesCheckBuilder::SelectPreferenceNodesList@endlink  */,
                ...
                /**Returns  the selected objects for checking. The objects must be @link CAE::Mesh CAE::Mesh@endlink  or
                                @link CAE::FENode CAE::FENode@endlink  
                 <br>  Created in NX8.5.0.  <br>  
                ...
                /** Calculates to find the duplicate nodes and display them in
                                ...
                                @link CAE::ModelCheck::DuplicateNodesCheckBuilder::DuplicateNodeGroupsCount CAE::ModelCheck::DuplicateNodesCheckBuilder::DuplicateNodeGroupsCount@endlink  and
                                @link CAE::ModelCheck::DuplicateNodesCheckBuilder::GetDuplicateNodes CAE::ModelCheck::DuplicateNodesCheckBuilder::GetDuplicateNodes@endlink . The previous
                ...
                /** Merges the duplicate nodes and clear all cached duplicate nodes in this builder.
                                ...
                                can only be merged when the context part of this builder is a @link CAE::BaseFemPart CAE::BaseFemPart@endlink . 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
