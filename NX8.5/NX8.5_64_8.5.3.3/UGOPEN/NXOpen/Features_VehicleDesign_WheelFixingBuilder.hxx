    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::WheelFixing Features::VehicleDesign::WheelFixing@endlink  builder used to
                    create or edit a vehicle design wheel fixing. <br> To create a new instance of this class, use @link Features::AutomotiveCollection::CreateWheelFixingBuilder  Features::AutomotiveCollection::CreateWheelFixingBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
