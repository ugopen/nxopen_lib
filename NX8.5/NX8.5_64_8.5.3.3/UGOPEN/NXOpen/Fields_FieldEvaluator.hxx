...
namespace NXOpen
{
    ...
    namespace Fields
    {
        ...
        /**  @brief  Represents a Field Evaluator which can be used to evaluate a @link Fields::Field Fields::Field@endlink . 
           ...
           <br> Use @link Fields::Field::GetFieldEvaluator Fields::Field::GetFieldEvaluator@endlink  to obtain an instance of this class  <br> 
         <br>  Created in NX7.5.2.  <br>  
        */
        class NXOPENCPP_FIELDSEXPORT  FieldEvaluator : public TaggedObject
        {
            /**  Interpolation type */
