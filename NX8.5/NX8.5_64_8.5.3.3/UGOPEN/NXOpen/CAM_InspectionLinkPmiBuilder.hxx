...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  InspectionLinkPmiBuilder : public Builder
        {
            ...
            (
                ...
                const NXString & fileName /** Name of the file.  Used only if the device type is file or both.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Output results report from Link PMI. 
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            (
                NXOpen::ListingWindow::DeviceType deviceType /** The type of device (file, Information window, or both) */,
                const char * fileName /** Name of the file.  Used only if the device type is file or both.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
        };
    }
}
