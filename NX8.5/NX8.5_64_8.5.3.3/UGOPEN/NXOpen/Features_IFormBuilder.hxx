...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  IFormBuilder : public Features::FeatureBuilder
        {
            ...
            public: ~IFormBuilder();
            /**Returns  the face to deform. Please refer @link Features::FaceRecognitionBuilder Features::FaceRecognitionBuilder@endlink  for details. 
             <br>  Created in NX7.5.0.  <br>  
