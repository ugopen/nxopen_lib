...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  CustomLoops : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            public: NXOpen::CAM::CustomLoopSetList * LoopList
            (
            );
            /** Create a custom loop set @return  the loop set object 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::CustomLoopSet * CreateLoopSet
            (
            );
