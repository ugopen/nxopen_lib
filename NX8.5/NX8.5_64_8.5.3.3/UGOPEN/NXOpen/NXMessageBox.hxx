...
namespace NXOpen
{
    ...
    Note: The number of lines displayed in the message box can vary based on Operating System and
          Screen Resolution  <br> To obtain an instance of this class, refer to @link UI  UI @endlink  <br> 
    ...
    */
    class NXOPENUICPPEXPORT  NXMessageBox
    {
        ...
        /** Show message box.  @return  Return value from Message Box.  If of type @link NXMessageBox::DialogTypeQuestion NXMessageBox::DialogTypeQuestion@endlink  
            then the value will be 1 or 2.  Otherwise the returned value will be -2.  
         <br>  Created in NX5.0.0.  <br>  
        ...
        int Show
        (
            const char * title /** Title   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::NXMessageBox::DialogType msgboxType /** Message box type */,
            const char * message /** Message   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Show message box.  @return   Return value from Message Box.  If of type @link NXMessageBox::DialogTypeQuestion NXMessageBox::DialogTypeQuestion@endlink  
            then the value will be 1 or 2.  Otherwise the returned value will be -2.  
         <br>  Created in NX5.0.0.  <br>  
