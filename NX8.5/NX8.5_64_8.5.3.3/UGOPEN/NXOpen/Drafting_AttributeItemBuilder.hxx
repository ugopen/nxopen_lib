...
namespace NXOpen
{
    ...
    namespace Drafting
    {
        ...
        /**
            Represents a @link Drafting::AttributeItemBuilder Drafting::AttributeItemBuilder@endlink .  This class is
            used to specify information about a single NX attribute.
             <br> To create a new instance of this class, use @link Drafting::AutomationManager::CreateAttributeItemBuilder  Drafting::AutomationManager::CreateAttributeItemBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAFTINGEXPORT  AttributeItemBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
