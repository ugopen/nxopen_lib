    ...
    namespace UIStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  IntegerItem : public UIStyler::StylerItem
        {
            ...
            void SetLabel
            (
                const char * strLabel /** String to display on the left side of the text field.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
