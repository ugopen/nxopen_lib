...
namespace NXOpen
{
    ...
    namespace Drafting
    {
        ...
        /** This class is used to specify knowledge fusion rule for a note object in a drawing template. 
                The rule is stored on the note and is executed when the template is instantiated.  <br> To create a new instance of this class, use @link Drafting::AutomationManager::CreateSpecifyRuleBuilder  Drafting::AutomationManager::CreateSpecifyRuleBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAFTINGEXPORT  SpecifyRuleBuilder : public Builder
        {
