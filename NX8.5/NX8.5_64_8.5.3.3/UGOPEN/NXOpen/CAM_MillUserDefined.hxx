...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Mill User Defined operation  <br> To create or edit an instance of this class, use @link CAM::MillUserDefinedBuilder  CAM::MillUserDefinedBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  MillUserDefined : public CAM::UserDefinedOpr
        {
