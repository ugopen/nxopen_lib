    ...
    namespace Validate
    {
        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  XmlComparator
        {
            ...
            (
                const char * workXmlFile /** The first xml file to be compared   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * masterXmlFile /** The second xml file to be compared against   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXOpen::Validate::XmlComparator::Options & compareOptions /** comparison options */
            );
