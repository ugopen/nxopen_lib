...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  PatternIncrementsBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the increments @link GeometricUtilities::PatternIncrementsList GeometricUtilities::PatternIncrementsList@endlink  in Direction1. 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::PatternIncrementsList * IncrementsListInDirection1
            (
            );
            /**Returns  the increments @link GeometricUtilities::PatternIncrementsList GeometricUtilities::PatternIncrementsList@endlink  in Direction2. 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
