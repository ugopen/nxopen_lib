...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  SimpleInterference : public Builder
        {
            ...
            /** Frees up resources/results associated with
                         ...
                         @link GeometricAnalysis::SimpleInterference::GetInterferenceResults GeometricAnalysis::SimpleInterference::GetInterferenceResults@endlink  and the
                         @link GeometricAnalysis::SimpleInterference::Reset GeometricAnalysis::SimpleInterference::Reset@endlink . 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: void Reset
            (
