...
namespace NXOpen
{
    ...
    /**
        Represents an @link AttributePropertiesBaseBuilder AttributePropertiesBaseBuilder@endlink  to be used for creating attributes.
        ...
        are created using @link AttributeTemplatesBuilder AttributeTemplatesBuilder@endlink .  
        
        The attribute will be distributed to all objects supplied in the selected object list.
         <br> This is an abstract class, and cannot be instantiated.  <br> 
     <br>  Created in NX8.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  AttributePropertiesBaseBuilder : public Builder
    {
        /** Specifies which object will be used when applying attributes.  The options available
                    ...
                    passed in is a part. 
         <br>  @deprecated Deprecated in NX8.5.0.  Use @link AttributePropertiesBaseBuilder::SetAttributeObjects AttributePropertiesBaseBuilder::SetAttributeObjects@endlink  instead. <br>  
        */
        public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use AttributePropertiesBaseBuilder::SetAttributeObjects instead.") enum ObjectOptions
        {
        ...
        /**Returns  the object picker.  This determines what objects the attribute will be applied to.  If 
         ...
         <br>  Created in NX8.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::AttributePropertiesBaseBuilder::ObjectOptions ObjectPicker
        (
        );
