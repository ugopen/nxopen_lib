...
namespace NXOpen
{
    ...
    namespace Fields
    {
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  SpatialMapBuilder : public Builder
        {
            ...
            /**Returns  the const uobjects 
             <br>  @deprecated Deprecated in NX6.0.1.  Use @link Fields::SpatialMapBuilder::ConstUObjects Fields::SpatialMapBuilder::ConstUObjects@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.1.  Use Fields::SpatialMapBuilder::ConstUObjects instead.") NXOpen::SelectNXObjectList * ConstantUObjects
            (
            );
            /**Returns  the const vobjects 
             <br>  @deprecated Deprecated in NX6.0.1.  Use @link Fields::SpatialMapBuilder::ConstVObjects Fields::SpatialMapBuilder::ConstVObjects@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.1.  Use Fields::SpatialMapBuilder::ConstVObjects instead.") NXOpen::SelectNXObjectList * ConstantVObjects
            (
            );
            /**Returns  the list of @link Fields::PathObjects Fields::PathObjects@endlink  objects that define sections of constant u 
             <br>  Created in NX6.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Fields::PathObjectsList * ConstUObjects
            (
            );
            /**Returns  the list of @link Fields::PathObjects Fields::PathObjects@endlink  objects that define sections of constant v 
             <br>  Created in NX6.0.1.  <br>  
             <br> License requirements : None */
