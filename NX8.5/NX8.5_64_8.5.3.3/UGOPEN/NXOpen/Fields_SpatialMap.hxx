...
namespace NXOpen
{
    ...
    namespace Fields
    {
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  SpatialMap : public NXObject
        {
            /** Type of Spatial Map */
            public: enum TypeEnum
            {
                ...
                TypeEnumParametricSpace/** Map to parametric space - see @link Fields::SpatialMap::BoundingBoxMapEnum Fields::SpatialMap::BoundingBoxMapEnum@endlink  */,
                TypeEnumParametricPlane/** Map to parametric plane - see @link Fields::SpatialMap::ParametricPlaneMapEnum Fields::SpatialMap::ParametricPlaneMapEnum@endlink  */,
