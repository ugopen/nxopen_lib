...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Represents a @link Features::ShipDesign::QualifySketchBuilder Features::ShipDesign::QualifySketchBuilder@endlink  builder.
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  QualifySketchBuilder : public Builder
            {
