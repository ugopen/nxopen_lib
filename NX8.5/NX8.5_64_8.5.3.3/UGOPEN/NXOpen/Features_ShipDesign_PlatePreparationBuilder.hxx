...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Used to create or edit a @link Features::ShipDesign::PlatePreparation Features::ShipDesign::PlatePreparation@endlink  feature.
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PlatePreparationBuilder : public Features::FeatureBuilder
            {
