...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents motion 2-3 joint coupler  <br> To create or edit an instance of this class, use @link Motion::GeneralCouplerBuilder  Motion::GeneralCouplerBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  GeneralCoupler : public Motion::MotionObject
        {
