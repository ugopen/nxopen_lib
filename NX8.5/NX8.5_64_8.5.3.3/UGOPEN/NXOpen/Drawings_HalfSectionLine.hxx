...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Half Section Line is used to create a view with half of the part
                ...
                only one arrow, one bend, and one cut segment.  <br> To create or edit an instance of this class, use @link Drawings::SectionLineBuilder  Drawings::SectionLineBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  HalfSectionLine : public Drawings::SectionLine
        {
