...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewCreationWizardBuilder : public Builder
        {
            ...
            /**Returns  the @link Drawings::CustomViewSettingsBuilder Drawings::CustomViewSettingsBuilder@endlink  object 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
