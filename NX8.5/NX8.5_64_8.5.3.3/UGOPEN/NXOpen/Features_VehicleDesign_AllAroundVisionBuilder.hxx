        ...
        namespace VehicleDesign
        {
            ...
            /**
                    ...
                    a vehicle design @link Features::VehicleDesign::AllAroundVision Features::VehicleDesign::AllAroundVision@endlink  feature.
                     <br> To create a new instance of this class, use @link Features::AutomotiveCollection::CreateAllAroundVisionBuilder  Features::AutomotiveCollection::CreateAllAroundVisionBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  AllAroundVisionBuilder : public Features::FeatureBuilder
            {
