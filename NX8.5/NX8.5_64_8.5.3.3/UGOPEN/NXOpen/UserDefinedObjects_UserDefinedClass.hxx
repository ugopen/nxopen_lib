...
namespace NXOpen
{
    ...
    namespace UserDefinedObjects
    {
        ...
        */
        class NXOPENCPP_USERDEFINEDOBJECTSEXPORT  UserDefinedClass : public TransientObject
        {
            ...
            /**Returns  the class name of the @link UserDefinedClass UserDefinedClass@endlink . 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXString ClassName
            (
            );
            /**Returns  the friendly name of the @link UserDefinedClass UserDefinedClass@endlink . 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXString FriendlyName
            (
            );
            /**Returns  the allow query class from name flag. Specifies whether or not you are allowed to query the @link UserDefinedObject UserDefinedObject@endlink  from the class name. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::UserDefinedObjects::UserDefinedClass::AllowQueryClass AllowQueryClassFromName
            (
            );
            /**Sets  the allow query class from name flag. Specifies whether or not you are allowed to query the @link UserDefinedObject UserDefinedObject@endlink  from the class name. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the allow owned object selection flag. Specifies whether or not you have permission to select objects owned by @link UserDefinedObjects::UserDefinedObject UserDefinedObjects::UserDefinedObject@endlink 's of this class. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::UserDefinedObjects::UserDefinedClass::AllowOwnedObjectSelection AllowOwnedObjectSelectionOption
            (
            );
            /**Sets  the allow owned object selection flag. Specifies whether or not you have permission to select objects owned by @link UserDefinedObjects::UserDefinedObject UserDefinedObjects::UserDefinedObject@endlink 's of this class. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Gets the is occurrenceable flag for this class. 
                    ...
                    method because we will automatically pass NULL in as the reference UDO to the legacy is occurrenceable callback. @return  Specifies whether or not to populate occurrences for @link UserDefinedObjects::UserDefinedObject UserDefinedObjects::UserDefinedObject@endlink 's of this class. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the warn user flag. 
                    Specifies the behavior of warning the user if a @link UserDefinedObjects::
            		UserDefinedObject UserDefinedObjects::
            		UserDefinedObject@endlink  of the given @link UserDefinedObjects::UserDefinedClass UserDefinedObjects::UserDefinedClass@endlink  
            ...
            /** Registers the screen size fit callback.  The screen size fit callback is called when
                        ...
                        call @link UserDefinedObjects::UserDefinedClass::AddScreenSizeFitHandler UserDefinedObjects::UserDefinedClass::AddScreenSizeFitHandler@endlink  because to do
