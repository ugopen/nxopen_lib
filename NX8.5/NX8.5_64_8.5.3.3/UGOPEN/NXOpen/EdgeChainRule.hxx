...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects end-to-end connected edges from the body of the seed edge. 
    ...
    */
    class NXOPENCPPEXPORT  EdgeChainRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the edge chain rule: @link  EdgeChainRule   EdgeChainRule @endlink  
         <br>  Created in NX3.0.0.  <br>  
