...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** This builder allows you to define one parameter for a symbol  <br> To create a new instance of this class, use @link Annotations::SymbolCatalogBuilder::NewParameter  Annotations::SymbolCatalogBuilder::NewParameter @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SymbolCatalogParameterBuilder : public Builder
        {
