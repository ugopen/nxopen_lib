...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Builder used to modify the ply maximum accepted thickness variation for laminate fill  <br> To create a new instance of this class, use @link CAE::LaminatePly::CreateLaminatePlyMaxThicknessVarBuilder  CAE::LaminatePly::CreateLaminatePlyMaxThicknessVarBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  LaminatePlyMaxThicknessVarBuilder : public Builder
        {
