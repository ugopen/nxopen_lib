...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents the Motion Marker class.  A Marker defines a point with
            ...
            with a Motion Link.  <br> To create or edit an instance of this class, use @link Motion::MarkerBuilder  Motion::MarkerBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  Marker : public DisplayableObject
        {
            /** Marker subtype */
