...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::OPCClientBuilder Mechatronics::OPCClientBuilder@endlink   <br> To create a new instance of this class, use @link Mechatronics::PhysicsManager::CreateOpcclientBuilder  Mechatronics::PhysicsManager::CreateOpcclientBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  OPCClientBuilder : public Builder
        {
            /** the server option. */
