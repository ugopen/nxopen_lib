...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Progressive Die Wizard  builder to management clearances.  <br> To create a new instance of this class, use @link Tooling::ClearanceManagementCollection::CreateClearanceManagementBuilder  Tooling::ClearanceManagementCollection::CreateClearanceManagementBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ClearanceManagementBuilder : public Builder
        {
