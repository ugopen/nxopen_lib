...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents the restrictions for the design variable in an optimization  <br> To create or edit an instance of this class, use @link CAE::Optimization::TBSRestrictAreaBuilder  CAE::Optimization::TBSRestrictAreaBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  TBSRestrictArea : public NXObject
            {
