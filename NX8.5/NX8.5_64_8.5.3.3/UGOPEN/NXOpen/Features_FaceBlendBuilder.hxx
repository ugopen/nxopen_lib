...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FaceBlendBuilder : public Features::FeatureBuilder
        {
            ...
            public: enum CrossSectionOption
            {
                ...
                CrossSectionOptionConic/** this means asymmetric conic type */,
                CrossSectionOptionConicSymmetric/** this means symmetric conic type */
            };
