...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI custom symbol  <br> To create or edit an instance of this class, use @link Annotations::PmiCustomSymbolBuilder  Annotations::PmiCustomSymbolBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiCustomSymbol : public Annotations::BaseCustomSymbol, public virtual Annotations::IPmi
        {
