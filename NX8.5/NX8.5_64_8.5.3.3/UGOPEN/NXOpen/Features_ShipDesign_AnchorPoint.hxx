...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Represents a @link Features::ShipDesign::AnchorPoint Features::ShipDesign::AnchorPoint@endlink  builder.
                 <br> To create a new instance of this class, use @link Features::ShipDesign::QualifySketchBuilder::CreateNewAnchorPoint  Features::ShipDesign::QualifySketchBuilder::CreateNewAnchorPoint @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  AnchorPoint : public Builder
            {
