...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a rectangular datum target  <br> To create or edit an instance of this class, use @link Annotations::PmiDatumTargetBuilder  Annotations::PmiDatumTargetBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  RectangularTarget : public Annotations::AreaTarget, public virtual Annotations::IRectangularTarget
        {
