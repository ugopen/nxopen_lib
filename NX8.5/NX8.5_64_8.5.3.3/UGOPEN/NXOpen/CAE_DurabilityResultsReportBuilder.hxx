...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents the builder for reporting the durability results.  <br> To create a new instance of this class, use @link CAE::DurabilityManager::CreateDurabilityResultsReportBuilder  CAE::DurabilityManager::CreateDurabilityResultsReportBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurabilityResultsReportBuilder : public Builder
        {
            ...
            (
                const NXString & csvFilename /** durability report will be written-out to this file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Export durability results to a csv file. 
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            ...
            (
                const char * csvFilename /** durability report will be written-out to this file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
        };
    }
}
