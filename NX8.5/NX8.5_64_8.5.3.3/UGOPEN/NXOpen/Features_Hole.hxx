...
namespace NXOpen
{
    ...
    namespace Features
    {
        class _HoleBuilder;
        class HoleImpl;
        /** Represents a Hole feature  <br> To create or edit an instance of this class, use @link Features::HoleFeatureBuilder  Features::HoleFeatureBuilder @endlink  <br> 
         <br>  Created in NX3.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  Hole : public Features::RPO
        {
