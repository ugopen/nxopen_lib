...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ConeBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the type represented by @link Features::ConeBuilder::Types Features::ConeBuilder::Types@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ConeBuilder::Types Type
            (
            );
            /**Sets  the type represented by @link Features::ConeBuilder::Types Features::ConeBuilder::Types@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetType
            (
