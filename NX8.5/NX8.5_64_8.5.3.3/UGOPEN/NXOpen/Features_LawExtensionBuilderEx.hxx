...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  LawExtensionBuilderEx : public Features::FeatureBuilder
        {
            ...
            /**Returns  the faces. Faces are used only when @link Features::LawExtensionBuilderEx::Types Features::LawExtensionBuilderEx::Types@endlink  is  
                        @link Features::LawExtensionBuilderEx::TypesFaces Features::LawExtensionBuilderEx::TypesFaces@endlink . The faces must be
            ...
            /**Returns  a value indicating whether to reverse the reference face normal. When @link Features::LawExtensionBuilderEx::Types Features::LawExtensionBuilderEx::Types@endlink  is  
                        @link Features::LawExtensionBuilderEx::TypesFaces Features::LawExtensionBuilderEx::TypesFaces@endlink , the input faces are sewed to
            ...
            /**Sets  a value indicating whether to reverse the reference face normal. When @link Features::LawExtensionBuilderEx::Types Features::LawExtensionBuilderEx::Types@endlink  is  
                        @link Features::LawExtensionBuilderEx::TypesFaces Features::LawExtensionBuilderEx::TypesFaces@endlink , the input faces are sewed to
                        form a single sheet body. The normal of the sheet body is decided based on the face which
                        is nearest to the parametric mid point of the base profile and acts as the reference face normal. 
             <br>  Created in NX8.5.0.  <br>  
            ...
            /**Returns  the vector. Vector is used only when @link Features::LawExtensionBuilderEx::Types Features::LawExtensionBuilderEx::Types@endlink  is  
                        @link Features::LawExtensionBuilderEx::TypesVector Features::LawExtensionBuilderEx::TypesVector@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * Vector
            (
            );
            /**Sets  the vector. Vector is used only when @link Features::LawExtensionBuilderEx::Types Features::LawExtensionBuilderEx::Types@endlink  is  
                        @link Features::LawExtensionBuilderEx::TypesVector Features::LawExtensionBuilderEx::TypesVector@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") */
            ...
            /**Returns  the opposite side length law. Opposite side extension law is required only when
                        @link Features::LawExtensionBuilderEx::OppositeSideExtensionOptions Features::LawExtensionBuilderEx::OppositeSideExtensionOptions@endlink  is  
                        @link Features::LawExtensionBuilderEx::OppositeSideExtensionOptionsAsymmetric Features::LawExtensionBuilderEx::OppositeSideExtensionOptionsAsymmetric@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
