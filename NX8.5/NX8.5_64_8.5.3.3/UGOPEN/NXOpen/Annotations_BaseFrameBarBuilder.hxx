...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link Annotations::BaseFrameBarBuilder Annotations::BaseFrameBarBuilder@endlink .
            This class allows to create frame bar annotation
             <br> This is an abstract class, and cannot be instantiated.  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseFrameBarBuilder : public Builder
        {
            /** Enum for Ship Axis This is used by @link Annotations::BaseFrameBarBuilder::Axis Annotations::BaseFrameBarBuilder::Axis@endlink  
                    and @link Annotations::BaseFrameBarBuilder::SetAxis Annotations::BaseFrameBarBuilder::SetAxis@endlink  to get/set the axis for a frame bar*/
