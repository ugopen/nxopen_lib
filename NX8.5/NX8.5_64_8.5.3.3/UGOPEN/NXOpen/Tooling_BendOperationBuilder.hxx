...
#include <NXOpen/Tooling_BendOperationBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**Represents a @link Tooling::BendOperationBuilder Tooling::BendOperationBuilder@endlink  builder.  <br> To create a new instance of this class, use @link Tooling::BendOperationCollection::CreateBendOperationBuilder  Tooling::BendOperationCollection::CreateBendOperationBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  BendOperationBuilder : public Builder
        {
            /** unbend operations. */
            public: enum Types
            {
