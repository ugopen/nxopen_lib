...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a spline segment.  <br> To obtain an instance of this class use @link Routing::SplineSegmentCollection Routing::SplineSegmentCollection@endlink   <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  SplineSegment : public Spline, public virtual Routing::ISegment
        {
