...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  FittingOverstockBuilder : public Builder
        {
            ...
            /**Returns  the @link Routing::FittingOverstockBuilder::TrimMethod Routing::FittingOverstockBuilder::TrimMethod@endlink 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NXOpen::Routing::FittingOverstockBuilder::TrimMethod FaceTrimMethod
            (
            );
            /**Sets  the @link Routing::FittingOverstockBuilder::TrimMethod Routing::FittingOverstockBuilder::TrimMethod@endlink 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
