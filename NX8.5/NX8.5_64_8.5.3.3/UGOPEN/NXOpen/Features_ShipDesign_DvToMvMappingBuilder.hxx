...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                    Represents a @link Features::ShipDesign::DvToMvMapping Features::ShipDesign::DvToMvMapping@endlink  builder. This builder is used to
                    ...
                    changes from design body to manufacturing body automatically.
                     <br> To create a new instance of this class, use @link Features::ShipCollection::CreateDvToMvMappingBuilder  Features::ShipCollection::CreateDvToMvMappingBuilder @endlink  <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  DvToMvMappingBuilder : public Features::FeatureBuilder
            {
