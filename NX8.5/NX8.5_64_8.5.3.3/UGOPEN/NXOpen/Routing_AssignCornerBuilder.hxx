...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        RouteAssignCornerCornerBlock.RouteCornerBendOptions (deprecated) </td> <td> 
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  AssignCornerBuilder : public Builder
        {
            ...
            /**Returns  the route assign corner start objects.  Valid start objects are @link Routing::ControlPoint Routing::ControlPoint@endlink 
                        and @link Routing::ISegment Routing::ISegment@endlink 
             <br>  Created in NX6.0.0.  <br>  
