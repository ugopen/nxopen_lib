...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  MirrorBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the @link GeometricUtilities::PatternDefinition GeometricUtilities::PatternDefinition@endlink  object 
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : None */
