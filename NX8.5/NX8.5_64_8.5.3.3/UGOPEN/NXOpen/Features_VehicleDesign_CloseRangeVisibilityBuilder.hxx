        ...
        namespace VehicleDesign
        {
            ...
            /**
                The builder to create close range visibility feature.
                 <br> To create a new instance of this class, use @link Features::AutomotiveCollection::CreateCloseRangeVisibilityBuilder  Features::AutomotiveCollection::CreateCloseRangeVisibilityBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  CloseRangeVisibilityBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the list of @link Features::VehicleDesign::CloseRangeCameraListItemBuilder Features::VehicleDesign::CloseRangeCameraListItemBuilder@endlink  defining the camera parameters. 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the list of @link Features::VehicleDesign::CloseRangeDemoCylinderListItemBuilder Features::VehicleDesign::CloseRangeDemoCylinderListItemBuilder@endlink  defining the demo cylinder parameters. 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
                ...
                /** Creates a @link Features::VehicleDesign::CloseRangeCameraListItemBuilder Features::VehicleDesign::CloseRangeCameraListItemBuilder@endlink   @return  
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: NXOpen::Features::VehicleDesign::CloseRangeCameraListItemBuilder * CreateCameraListItemBuilder
                (
                );
                /** Creates a @link Features::VehicleDesign::CloseRangeDemoCylinderListItemBuilder Features::VehicleDesign::CloseRangeDemoCylinderListItemBuilder@endlink   @return  
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
