...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::CorrelSolution CAE::CorrelSolution@endlink , which is a meta-solution used to compare results from two structural dynamics solutions  <br> To create or edit an instance of this class, use @link CAE::CorrelSolutionBuilder  CAE::CorrelSolutionBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  CorrelSolution : public NXObject
        {
            ...
            /** Returns the correlation solution name  @return  the @link CAE::CorrelSolution CAE::CorrelSolution@endlink   name 
