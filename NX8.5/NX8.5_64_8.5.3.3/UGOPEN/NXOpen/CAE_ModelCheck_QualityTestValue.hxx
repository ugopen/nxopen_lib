...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ModelCheck
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  QualityTestValue : public NXObject, public virtual CAE::ModelCheck::ITestValue
            {
                ...
                /**Returns  the count of @link CAE::ModelCheck::ElementSpecificTestValue CAE::ModelCheck::ElementSpecificTestValue@endlink  in this test setting 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
                public: int ElementSpecificTestCount
                (
                );
                /** Returns @link CAE::ModelCheck::ElementSpecificTestValue CAE::ModelCheck::ElementSpecificTestValue@endlink  of specified index in this test setting  @return  
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
