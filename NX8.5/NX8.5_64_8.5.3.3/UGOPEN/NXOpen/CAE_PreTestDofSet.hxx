...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents Dof Set within a pre-test setup  <br> To create or edit an instance of this class, use @link CAE::PreTestDofSetBuilder  CAE::PreTestDofSetBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  PreTestDofSet : public NXObject
        {
            ...
            /** Setting the @link CAE::CaeDOFSet CAE::CaeDOFSet@endlink  reference 
             <br>  Created in NX7.5.0.  <br>  
