...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ChangeMaterialBuilder : public Mechatronics::PhysicsConstraintBuilder
        {
            ...
            /**Returns  the first body of collision pair. This can be @link RigidBody RigidBody@endlink ,
                    @link CollisionBody CollisionBody@endlink  or @link TransportSurface TransportSurface@endlink . 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            public: NXOpen::SelectDisplayableObject * FirstBody
            (
            );
            /** Sets the first object.  This can be @link RigidBody RigidBody@endlink ,
                    @link CollisionBody CollisionBody@endlink  or @link TransportSurface TransportSurface@endlink .
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            /**Returns  the material. This can be @link CollisionMaterial CollisionMaterial@endlink . 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            public: NXOpen::Mechatronics::CollisionMaterial * CollisionMaterial
            (
            );
            /**Sets  the material. This can be @link CollisionMaterial CollisionMaterial@endlink . 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            /** Sets the second object.  This can be @link RigidBody RigidBody@endlink ,
                    @link CollisionBody CollisionBody@endlink  or @link TransportSurface TransportSurface@endlink .
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
