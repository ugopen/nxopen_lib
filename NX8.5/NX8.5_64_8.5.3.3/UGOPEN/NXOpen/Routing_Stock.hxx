...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  Stock : public NXObject, public virtual Routing::ICharacteristic
        {
            ...
            /** Sets the @link Routing::StockData Routing::StockData@endlink . After setting the StockData, the
                        ...
                        object only references objects associated with this @link Routing::StockData Routing::StockData@endlink  object.
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Sets the @link Routing::Anchor Routing::Anchor@endlink . The given object must be one of the 
                        ...
                        object that defines this @link Routing::Stock Routing::Stock@endlink  object. 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Gets the @link Routing::StockStyle Routing::StockStyle@endlink  of the @link Routing::Stock Routing::Stock@endlink .  @return  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Gets the segments that the @link Routing::Stock Routing::Stock@endlink  object is placed on top of.  @return   
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Returns the @link Routing::StockPort Routing::StockPort@endlink  at each end of the stock. 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Set the characteristics of the given stock's
                        component so that it has the same characteristics as the @link Routing::Stock Routing::Stock@endlink  and its stock data. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /**Returns  the negate offsets flag of this @link Routing::Stock Routing::Stock@endlink . 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: bool NegateOffsetsFlag
            (
            );
            /**Sets  the negate offsets flag of this @link Routing::Stock Routing::Stock@endlink . 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Makes the stock "featurable" by generating a sweep feature over every segment of the stock, 
                        ...
                        This will help features to survive stock splitting and merging as this ensures that no sweep feature is deleted during a merge. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            (
                const NXString & partName /** Part name to be set   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Renames the stock component part with given name
             <br>  Created in NX7.5.4.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            (
                const char * partName /** Part name to be set   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
