...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class TopologyImpl;
        /** Represents a CAM topology builder  <br> Use the @link CAM::Geometry CAM::Geometry@endlink  class to get a topology builder  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  Topology : public Builder
        {
