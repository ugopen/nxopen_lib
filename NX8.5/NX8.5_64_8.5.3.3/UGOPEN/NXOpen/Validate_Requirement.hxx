...
namespace NXOpen
{
    ...
    namespace Validate
    {
        ...
        /**
             Represents a @link Validate::Requirement Validate::Requirement@endlink  object.
             <br> To create or edit an instance of this class, use @link Validate::RequirementBuilder  Validate::RequirementBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_VALIDATEEXPORT  Requirement : public NXObject
        {
            private: RequirementImpl * m_requirement_impl;
            private: friend class  _RequirementBuilder;
            protected: Requirement();
            public: ~Requirement();
            /** Creates a @link Validate::RequirementCheck Validate::RequirementCheck@endlink  for a requirement @return  
             <br>  Created in NX8.5.0.  <br>  
            ...
            /** Deletes a user requirement and child @link Validate::RequirementCheck Validate::RequirementCheck@endlink  or removes a external requirement. 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void Delete
            (
