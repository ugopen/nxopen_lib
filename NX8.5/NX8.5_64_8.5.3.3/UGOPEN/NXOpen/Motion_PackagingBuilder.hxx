...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PackagingBuilder : public Builder
        {
            ...
            /**Returns  the name of @link  Packaging   Packaging @endlink  object. 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXString Name
            (
            );
            /**Sets  the name of @link  Packaging   Packaging @endlink  object. 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetName
            (
            ...
            void SetName
            (
                const char * name /** The Name of @link  Packaging   Packaging @endlink  object. */
            );
