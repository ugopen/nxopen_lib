...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSolutionBuilder : public Builder
        {
            /** Solution type */
            ...
            /**Returns  the time 
             <br>  @deprecated Deprecated in NX8.5.0.  Obtion the exression using @link Motion::MotionSolutionBuilder::TimeExpression Motion::MotionSolutionBuilder::TimeExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::MotionSolutionBuilder::TimeExpression to query or edit it.") double Time
            (
            );
            /**Sets  the time 
             <br>  @deprecated Deprecated in NX8.5.0.  Obtion the exression using @link Motion::MotionSolutionBuilder::TimeExpression Motion::MotionSolutionBuilder::TimeExpression@endlink  to query or edit it. <br>  
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::MotionSolutionBuilder::TimeExpression to query or edit it.") void SetTime
            (
                double time /** time */ 
            );
            /**Returns  the step 
            ...
            /**Returns  the gravity value 
             <br>  @deprecated Deprecated in NX8.5.0.  Obtion the exression using @link Motion::MotionSolutionBuilder::GravityValueExpression Motion::MotionSolutionBuilder::GravityValueExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::MotionSolutionBuilder::GravityValueExpression to query or edit it.") double GravityValue
            (
            );
            /**Sets  the gravity value 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::MotionSolutionBuilder::GravityValueExpression to query or edit it.") void SetGravityValue
            (
