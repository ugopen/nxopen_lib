...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents the Motion ScalarForce class.  <br> To create or edit an instance of this class, use @link Motion::ScalarForceBuilder  Motion::ScalarForceBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  ScalarForce : public Motion::MotionObject
        {
