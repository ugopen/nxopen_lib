...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a quick binder feature  <br> To create or edit an instance of this class, use @link Die::QuickBinderBuilder  Die::QuickBinderBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  QuickBinder : public Features::BodyFeature
        {
