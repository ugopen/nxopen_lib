...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  IMeshManager : public TaggedObject
        {
            ...
            /** Returns the IMeshCollectors @link CAE::IMeshCollector CAE::IMeshCollector@endlink  for this manager  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: std::vector<NXOpen::CAE::IMeshCollector *> GetMeshCollectors
            (
            );
            /** Returns the Meshes @link CAE::Mesh CAE::Mesh@endlink  for this manager  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
