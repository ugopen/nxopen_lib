...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Represents a @link Weld::WeldObjectBuilder Weld::WeldObjectBuilder@endlink  class used to collect welding objects created or edited from a command. 
         <br>  Created in NX8.0.1.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  WeldObjectBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
