...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ScaleBuilder : public Features::FeatureBuilder
        {
            /** Scale type */
            public: enum Types
            {
            ...
            public: ~ScaleBuilder();
            /**Returns  the scale type @link Features::ScaleBuilder::Types Features::ScaleBuilder::Types@endlink 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ScaleBuilder::Types Type
            (
            );
            /**Sets  the scale type @link Features::ScaleBuilder::Types Features::ScaleBuilder::Types@endlink 
             <br>  Created in NX5.0.0.  <br>  
            ...
            /**Returns  the point as @link Point Point@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point * Point
            (
            );
            /**Sets  the point as @link Point Point@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the vector as @link Direction Direction@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * Vector
            (
            );
            /**Sets  the vector as @link Direction Direction@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the csys as @link CoordinateSystem CoordinateSystem@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CoordinateSystem * Csys
            (
            );
            /**Sets  the csys as @link CoordinateSystem CoordinateSystem@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCsys
            (
