    ...
    class NXOPENCPPEXPORT  DisplayableObject : public NXObject, public virtual IFitTo
    {
        ...
        */
        ...
        /**Returns  the layer that the object is in.  After setting the layer, you must call
                @link RedisplayObject RedisplayObject@endlink  in order for the change to take effect,
                except see the comments for @link DisplayableObject::Color DisplayableObject::Color @endlink and @link DisplayableObject::SetColor DisplayableObject::SetColor @endlink .
