        ...
        namespace VehicleDesign
        {
            ...
            /**
                    Represents a @link Features::VehicleDesign::DynamicCurb Features::VehicleDesign::DynamicCurb@endlink  builder
                     <br> To create a new instance of this class, use @link Features::AutomotiveCollection::CreateDynamicCurbBuilder  Features::AutomotiveCollection::CreateDynamicCurbBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
