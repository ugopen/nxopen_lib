...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FitCurveBuilder : public Features::FeatureBuilder
        {
            /** Fitting types */
            public: enum Types
            {
            ...
            /** Chains all the points in work part based on one selected point and evaluates the curve.
                        Operation is valid for @link Features::FitCurveBuilder::TargetSourceTypesInfer Features::FitCurveBuilder::TargetSourceTypesInfer@endlink  only. 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : features_modeling ("FEATURES MODELING") */
