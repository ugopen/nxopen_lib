...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a DrawnCutout feature  <br> To create or edit an instance of this class, use @link Features::SheetMetal::DrawnCutoutBuilder  Features::SheetMetal::DrawnCutoutBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  DrawnCutout : public Features::Feature
        {
