...
namespace NXOpen
{
    ...
    /**
        ...
        NULL object will be returned from Commit()  <br> To create a new instance of this class, use @link DexManager::CreateCatiav4Importer  DexManager::CreateCatiav4Importer @endlink  <br> 
    Default values.
    <table border="1"> 
