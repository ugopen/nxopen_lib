...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a @link Display::PlanarShipGrid Display::PlanarShipGrid@endlink  builder.  <br> To create a new instance of this class, use @link Display::GridCollection::CreatePlanarShipGridBuilder  Display::GridCollection::CreatePlanarShipGridBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  PlanarShipGridBuilder : public Builder
        {
