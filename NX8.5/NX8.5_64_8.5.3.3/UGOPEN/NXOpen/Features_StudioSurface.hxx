...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a studio surface feature  <br> To create or edit an instance of this class, use @link Features::StudioSurfaceBuilder  Features::StudioSurfaceBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  StudioSurface : public Features::BodyFeature
        {
