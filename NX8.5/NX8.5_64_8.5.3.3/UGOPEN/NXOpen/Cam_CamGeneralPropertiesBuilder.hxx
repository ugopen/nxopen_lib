...
namespace NXOpen
{
    ...
    namespace Cam
    {
        ...
        /**
            Represents a @link Cam::CamGeneralPropertiesBuilder Cam::CamGeneralPropertiesBuilder@endlink  to be used for setting the name
            of a specified CAM object.
             <br> To create a new instance of this class, use @link PropertiesManager::CreateCamGeneralPropertiesBuilder  PropertiesManager::CreateCamGeneralPropertiesBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  CamGeneralPropertiesBuilder : public Builder
        {
