...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a @link Display::CgfxMattex  Display::CgfxMattex @endlink  builder 
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  CgfxMattexBuilder : public Builder
        {
            ...
            /** The texture space type indicates the texture space type to use for CgFX shader.
             ...
             <br>  @deprecated Deprecated in NX7.5.2.  Use @link Display::CgfxMattexBuilder::TextureSpaceShader Display::CgfxMattexBuilder::TextureSpaceShader@endlink  instead. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX7.5.2.  Use Display::CgfxMattexBuilder::TextureSpaceShader instead.") enum TextureSpace
            {
