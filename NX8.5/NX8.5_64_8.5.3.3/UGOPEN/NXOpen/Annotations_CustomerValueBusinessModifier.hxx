...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents business modifier that applies customer values such as CTQ (Critical To Quality), 
                KC (Key Characteristic) to a PMI. Please see ug_customer_value_bus_mod.dfa for attribute details.   <br> To create or edit an instance of this class, use @link Annotations::CustomerValueBusinessModifierBuilder  Annotations::CustomerValueBusinessModifierBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  CustomerValueBusinessModifier : public Annotations::ListBusinessModifier
        {
