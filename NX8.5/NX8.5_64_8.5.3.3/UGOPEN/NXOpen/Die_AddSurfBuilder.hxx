...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  AddSurfBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the first end point to limit the extent of the surface along the tangency curve. 
             ...
             <br>  @deprecated Deprecated in NX7.5.0.  Use @link Die::AddSurfBuilder::Limits Die::AddSurfBuilder::Limits@endlink   to access limit points. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0.  Use Die::AddSurfBuilder::Limits  to access limit points.") NXOpen::Point * LimitPoint1
            (
            );
            /**Sets  the first end point to limit the extent of the surface along the tangency curve. 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0.  Use Die::AddSurfBuilder::Limits  to access limit points.") void SetLimitPoint1
            (
            ...
            /**Returns  the second end point to limit the extent of the surface along the tangency curve. 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0.  Use Die::AddSurfBuilder::Limits  to access limit points.") NXOpen::Point * LimitPoint2
            (
            );
            /**Sets  the second end point to limit the extent of the surface along the tangency curve. 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0.  Use Die::AddSurfBuilder::Limits  to access limit points.") void SetLimitPoint2
            (
                NXOpen::Point * point /** point */ 
            );
