...
namespace NXOpen
{
    ...
    /**
        Represents a @link Step214Importer Step214Importer@endlink  to be used when importing the STEP214 Data
        This class is created using @link DexManager DexManager@endlink .
        NULL object will be returned from Commit()  <br> To create a new instance of this class, use @link DexManager::CreateStep214Importer  DexManager::CreateStep214Importer @endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  Step214Importer : public DexBuilder
    {
        /** Create the builder */
