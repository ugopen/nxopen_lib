...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _UdeBuilder;
        class UdeImpl;
        /** Represets a User Defined Event  <br> To create a new instance of this class, use @link CAM::UdeSet::CreateUde  CAM::UdeSet::CreateUde @endlink  <br> 
         <br>  Created in NX7.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  Ude : public TaggedObject
        {
