...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  OnPathDimWithValueBuilder : public TaggedObject, public virtual INXObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /** Inherits location data of a @link GeometricUtilities::OnPathDimWithValueBuilder GeometricUtilities::OnPathDimWithValueBuilder@endlink  object 
            ...
            /** Inherits value of a @link GeometricUtilities::OnPathDimWithValueBuilder GeometricUtilities::OnPathDimWithValueBuilder@endlink  object 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") OR studio_free_form ("STUDIO FREE FORM") */
