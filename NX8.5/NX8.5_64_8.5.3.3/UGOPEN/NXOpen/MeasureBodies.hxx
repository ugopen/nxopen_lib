...
namespace NXOpen
{
    ...
    /** Represents the measurement specific mass properties for a set of bodies  <br> To create or edit an instance of this class, use @link MeasureFaceBuilder  MeasureFaceBuilder @endlink  <br> 
    ...
    */
    class NXOPENCPPEXPORT  MeasureBodies : public GenericMeasure
    {
        ...
        /** Creates and returns an embedded measurement expression. 
         ...
         <br>  @deprecated Deprecated in NX5.0.1.  Use @link MeasureBodies::CreateEmbeddedObject MeasureBodies::CreateEmbeddedObject@endlink  instead. <br>  

         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.1.  Use MeasureBodies::CreateEmbeddedObject instead.") NXString CreateEmbedded
        (
