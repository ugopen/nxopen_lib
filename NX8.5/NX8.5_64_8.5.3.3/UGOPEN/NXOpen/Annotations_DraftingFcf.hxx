...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents an FCF  <br> To create or edit an instance of this class, use @link Annotations::DraftingFeatureControlFrameBuilder  Annotations::DraftingFeatureControlFrameBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DraftingFcf : public Annotations::BaseFcf
        {
