...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  InstanceFeatureBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the instance clocking @link GeometricUtilities::PatternClockingBuilder GeometricUtilities::PatternClockingBuilder@endlink . 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::PatternClockingBuilder * InstanceClocking
            (
            );
            /** Removes clocking from (unclocks) a @link Features::InstanceFeature Features::InstanceFeature@endlink . 
             <br>  Created in NX8.0.0.  <br>  
