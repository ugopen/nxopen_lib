...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  CouplerBuilder : public Motion::MotionBuilder
        {
            ...
            /**Returns  the ratio 
             <br>  @deprecated Deprecated in NX8.5.0.  Obtion the exression using @link Motion::CouplerBuilder::RatioExpression Motion::CouplerBuilder::RatioExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::CouplerBuilder::RatioExpression to query or edit it.") double Ratio
            (
            );
            /**Sets  the ratio 
             <br>  @deprecated Deprecated in NX8.5.0.  Obtion the exression using @link Motion::CouplerBuilder::RatioExpression Motion::CouplerBuilder::RatioExpression@endlink  to query or edit it. <br>  
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Obtion the exression using Motion::CouplerBuilder::RatioExpression to query or edit it.") void SetRatio
            (
                double ratio /** ratio */ 
            );
