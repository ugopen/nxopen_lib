...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class PmiWaveImpl;
        /** Represents a Wave  <br> To create or edit an instance of this class, use @link Annotations::PmiWaveLinkBuilder  Annotations::PmiWaveLinkBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiWave : public Annotations::Annotation, public virtual Annotations::IPmi
        {
