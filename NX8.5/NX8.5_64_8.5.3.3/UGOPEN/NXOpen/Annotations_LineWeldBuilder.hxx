...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LineWeldBuilder : public Builder
        {
            ...
            /**Returns  the @link Annotations::LeaderBuilder Annotations::LeaderBuilder@endlink  for weld symbol 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::LeaderBuilder * Leader
            (
            );
            /**Returns  the @link Annotations::OriginBuilder Annotations::OriginBuilder@endlink  for the weld symbol 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::OriginBuilder * Origin
            (
            );
            /**Returns  the @link Annotations::LineWeldDataBuilder Annotations::LineWeldDataBuilder@endlink  for the other side of the weld symbol 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the @link Annotations::LineWeldDataBuilder Annotations::LineWeldDataBuilder@endlink  for the arrow side of the weld symbol 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the @link Annotations::StyleBuilder Annotations::StyleBuilder@endlink  for the weld symbol 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
