...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaePart : public BasePart
        {
            ...
            void ExportJt
            (
                const char * fileName /** the JT file name to be created   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * solverName /** the name of the solver export   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::CAE::CaeDataContainer * propertyList /** the export parameters. See @link CAE::CaeSession::GetDataContainer  CAE::CaeSession::GetDataContainer @endlink .
                 */
            );
            ...
            (
                const char * solverName /** the name of the solver import   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::CAE::CaeDataContainer * propertyList /** the import parameters. See @link CAE::CaeSession::GetDataContainer  CAE::CaeSession::GetDataContainer @endlink .
                 */
            );
