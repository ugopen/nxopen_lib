...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  PartDefinitionShadow : public Routing::ItemDefinition
        {
            ...
            /** Returns the
                     ...
                     @return  The @link Routing::InterfaceTerminalShadow Routing::InterfaceTerminalShadow@endlink s
                                                                for this @link Routing::PartDefinitionShadow Routing::PartDefinitionShadow@endlink  
             <br>  Created in NX4.0.2.  <br>  
