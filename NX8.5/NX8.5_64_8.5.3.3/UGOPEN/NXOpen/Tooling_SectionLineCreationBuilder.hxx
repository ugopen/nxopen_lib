...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**
              Represents a @link Tooling::SectionLineCreationBuilder Tooling::SectionLineCreationBuilder@endlink  which is 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  SectionLineCreationBuilder : public Builder
        {
