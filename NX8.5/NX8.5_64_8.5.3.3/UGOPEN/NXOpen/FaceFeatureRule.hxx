...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects all faces created or modified by a feature. 
    ...
    */
    class NXOPENCPPEXPORT  FaceFeatureRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the face feature rule: @link  FaceFeatureRule   FaceFeatureRule @endlink  
         <br>  Created in NX4.0.0.  <br>  
