...
namespace NXOpen
{
    ...
    /**
        ...
        NULL object will be returned from Commit()  <br> To create a new instance of this class, use @link DexManager::CreateStep214Creator  DexManager::CreateStep214Creator @endlink  <br> 
    Default values.
    <table border="1"> 
