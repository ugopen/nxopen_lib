...
namespace NXOpen
{
    ...
    namespace Issue
    {
        ...
        */
        class NXOPENCPP_ISSUEEXPORT  IssueContentBuilder : public Builder
        {
            ...
            /** Returns the editable user defined @link Issue::IssueProperty Issue::IssueProperty@endlink s  @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_issue_mgmt ("NX Issue Tracking") */
