...
namespace NXOpen
{
    ...
    /**
        Represents a @link Step203Importer Step203Importer@endlink  to be used when importing the STEP203 Data
    ...
    */
    class NXOPENCPPEXPORT  Step203Importer : public DexBuilder
    {
        /** Create the builder */
