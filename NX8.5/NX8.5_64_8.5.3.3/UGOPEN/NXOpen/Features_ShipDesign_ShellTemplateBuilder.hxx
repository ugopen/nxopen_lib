...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Used to edit or create a @link Features::ShipDesign::ShellTemplate Features::ShipDesign::ShellTemplate@endlink  feature. The shell templates are defined on a surface by specifying a primary orientation coordinate system.
                ...
                with a minimal of predefined input data.
                 <br> To create a new instance of this class, use @link Features::ShipCollection::CreateShellTemplateBuilder  Features::ShipCollection::CreateShellTemplateBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ShellTemplateBuilder : public Features::FeatureBuilder
            {
                /**
                ...
                /**Returns  the value identifying how the planes (used for sections) will be specified (See @link Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypes Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypes@endlink  for the plane methods). 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypes PlaneMethod
                (
                );
                /**Sets  the value identifying how the planes (used for sections) will be specified (See @link Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypes Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypes@endlink  for the plane methods). 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                ...
                /**Returns  the planes specifying both the X and Y orientations of the templates. They will automatically be separated, or grouped, for X and Y as needed.
                        This is only valid when @link Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypes Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypes@endlink  is  @link Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypesExisting Features::ShipDesign::ShellTemplateBuilder::PlaneLocationTypesExisting@endlink . 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the value defining how the coordinate system will be defined. See @link Features::ShipDesign::ShellTemplateBuilder::Types Features::ShipDesign::ShellTemplateBuilder::Types@endlink . 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::ShellTemplateBuilder::Types Type
                (
                );
                /**Sets  the value defining how the coordinate system will be defined. See @link Features::ShipDesign::ShellTemplateBuilder::Types Features::ShipDesign::ShellTemplateBuilder::Types@endlink . 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetType
                (
