...
namespace NXOpen
{
    ...
    namespace Features
    {
        /** Represents a container feature on a part. A container feature contains and maintains other features
         ...
         such as @link Features::PatternFeature Features::PatternFeature@endlink  and @link Features::FeatureGroup Features::FeatureGroup@endlink  are examples of container features. 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  IContainerFeature : public virtual INXObject
        {
