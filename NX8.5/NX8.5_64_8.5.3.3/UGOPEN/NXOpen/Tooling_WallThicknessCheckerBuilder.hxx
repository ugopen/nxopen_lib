...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a builder to be used to perform wall thickness analysis. The method @link Tooling::WallThicknessCheckerBuilder::Calculate Tooling::WallThicknessCheckerBuilder::Calculate@endlink  should be called before calling commit.  <br> To create a new instance of this class, use @link Tooling::WallThicknessCheckerManager::CreateBuilder  Tooling::WallThicknessCheckerManager::CreateBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  WallThicknessCheckerBuilder : public Builder
        {
            ...
            /** Saves the Results after calling the @link Tooling::WallThicknessCheckerBuilder::Calculate Tooling::WallThicknessCheckerBuilder::Calculate@endlink  to save the thickness calculation results. 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
