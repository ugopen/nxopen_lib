...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents the Transport Surface class. Transport Surface causes a face on a geometric object to 
            behave like it is moving even if the object it is attached to is not.  <br> To create or edit an instance of this class, use @link Mechatronics::TransportSurfaceBuilder  Mechatronics::TransportSurfaceBuilder @endlink  <br> 
         <br>  Created in NX7.5.1.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  TransportSurface : public DisplayableObject
        {
