...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Used to create or edit a @link Weld::DatumSurface Weld::DatumSurface@endlink  feature.  <br> To create a new instance of this class, use @link Weld::WeldManager::CreateDatumSurfaceBuilder  Weld::WeldManager::CreateDatumSurfaceBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  DatumSurfaceBuilder : public Weld::DatumCommonBuilder
        {
