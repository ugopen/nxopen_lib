...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  CouplerCollection : public TaggedObjectCollection
        {
            ...
            /** Creates the builder object of @link  Motion::CouplerGear   Motion::CouplerGear @endlink  object   @return   
             <br>  Created in NX6.0.0.  <br>  
            ...
            /** Creates the builder object of @link  Motion::CouplerRckpn   Motion::CouplerRckpn @endlink  object   @return   
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /** Creates the builder object of @link  Motion::CouplerCable   Motion::CouplerCable @endlink  object   @return   
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
