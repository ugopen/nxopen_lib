...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Hole Making operation  <br> To create or edit an instance of this class, use @link CAM::HoleMakingBuilder  CAM::HoleMakingBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  HoleMaking : public CAM::Operation
        {
