...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a @link Tooling::ConcurrentDesignManagementBuilder Tooling::ConcurrentDesignManagementBuilder@endlink  to support concurrent design workflow management.  <br> To create a new instance of this class, use @link Tooling::WorkflowManagementCollection::CreateConcurrentDesignManagementBuilder  Tooling::WorkflowManagementCollection::CreateConcurrentDesignManagementBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ConcurrentDesignManagementBuilder : public Builder
        {
