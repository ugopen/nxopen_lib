...
namespace NXOpen
{
    ...
    class ViewImpl;
    /**
     Represents a view. View can be obtained either from @link ViewCollection ViewCollection@endlink  or from @link ModelingViewCollection ModelingViewCollection@endlink .
    ...
    */
    class NXOPENCPPEXPORT  View : public NXObject
    {
        ...
        /** Adjusts the bounds of a given view conditionally so that it fully encompasses 
            ...
            @link Preferences::SessionVisualizationScreen::DoFitOnHideOrShow Preferences::SessionVisualizationScreen::DoFitOnHideOrShow@endlink ,
        ...
        /**Returns  the view origin.  This is the negation of the position in "untranslated view space",
            ...
            from @link View::Matrix View::Matrix @endlink and @link View::SetMatrix View::SetMatrix @endlink .  Note that the origin in this method is not in
            the same space as the origin passed to @link View::Origin View::Origin @endlink and @link View::SetOrigin View::SetOrigin @endlink , where
            the input origin is in absolute space.
             <br> 
            The position given to this property is the same as the translation used in
            @link View::Concatenate View::Concatenate@endlink  and in the other similar concatenate methods.
             <br> 
             <br> 
            If you want to get the view origin in absolute space, use 
            @link View::AbsoluteOrigin View::AbsoluteOrigin @endlink and @link View::SetAbsoluteOrigin View::SetAbsoluteOrigin @endlink 
             <br> 
        ...
        public: void Orient
        (
            const NXString & viewName /** Custom view name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::View::ScaleAdjustment viewScale /** Desired view scale*/
        );
        /** Changes the view orientation to a specified view.
            If enabled, the change in orientation of the view is animated.
        ...
        void Orient
        (
            const char * viewName /** Custom view name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::View::ScaleAdjustment viewScale /** Desired view scale*/
        );
        ...
        /** Similar to @link View::SnapToClosestCannedOrientation View::SnapToClosestCannedOrientation@endlink  except it 
        ...
        /** Scales the specified view to a desired relative scale. The "reduce" and 
            ...
            @link View::ScaleFactor View::ScaleFactor@endlink  have an internal limiting factor. This scale can't be 
