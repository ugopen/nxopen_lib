    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  BranchPathNumberingBuilder : public Builder
        {
            ...
            /**Returns  formula specified in the UI to compute the first branch ID for the labeling sequence
            ...
            /**Sets  formula specified in the UI to compute the first branch ID for the labeling sequence
                        in order to be valid, the formula must be blank OR contain the phrase "PARENT_BRANCH_ID" 
            ...
            /**Returns   formula specified in the UI to compute the next branch ID for the labeling sequence
                         in order to be valid, the formula must be blank OR contain the phrase "PREVIOUS_SEGMENT_ID" 
            ...
            /**Sets   formula specified in the UI to compute the next branch ID for the labeling sequence
                         in order to be valid, the formula must be blank OR contain the phrase "PREVIOUS_SEGMENT_ID" 
            ...
            /**Returns   toggle specified in the UI on whether to display the labels 
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public: bool DisplayOnSegments
            (
            );
            /**Sets   toggle specified in the UI on whether to display the labels 
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            ...
            /**Returns  toggle specified in the UI on whether to reassign the labels  
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public: bool ReassignOnSegments
            (
            );
            /**Sets  toggle specified in the UI on whether to reassign the labels  
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            ...
            /**Returns  start value for numbers.  The default value is "1" if the customer does not call this method. 
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public: NXString StartValueForNumbers
            (
            );
            /**Sets  start value for numbers.  The default value is "1" if the customer does not call this method. 
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            ...
            /**Returns  start value for upper case alphabet. The default value is "A" if the customer does not call this method. 
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public: NXString StartValueForUpperCase
            (
            );
            /**Sets  start value for upper case alphabet. The default value is "A" if the customer does not call this method. 
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            ...
            /**Returns  start value for lower case alphabet. The default value is "a" if the customer does not call this method.  
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public: NXString StartValueForLowerCase
            (
            );
            /**Sets  start value for lower case alphabet. The default value is "a" if the customer does not call this method.  
             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
