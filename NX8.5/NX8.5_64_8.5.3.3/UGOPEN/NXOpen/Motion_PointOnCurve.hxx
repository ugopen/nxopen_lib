...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a point on curve  <br> To create or edit an instance of this class, use @link Motion::PointOnCurveBuilder  Motion::PointOnCurveBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  PointOnCurve : public Motion::MotionObject
        {
