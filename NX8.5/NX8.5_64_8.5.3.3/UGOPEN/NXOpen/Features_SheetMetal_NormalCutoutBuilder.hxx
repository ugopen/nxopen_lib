...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  NormalCutoutBuilder : public Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                /**Returns  the depth of the cutout. Only applies when the depth type is @link Features::SheetMetal::NormalCutoutBuilder::DepthTypeOptionsFinite Features::SheetMetal::NormalCutoutBuilder::DepthTypeOptionsFinite@endlink .
                 <br>  Created in NX4.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /**Returns  the face or datum plane from which the cutout begins. This is only applicable if the depth type
                            is @link Features::SheetMetal::NormalCutoutBuilder::DepthTypeOptionsFromTo Features::SheetMetal::NormalCutoutBuilder::DepthTypeOptionsFromTo@endlink  
                 <br>  Created in NX4.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
