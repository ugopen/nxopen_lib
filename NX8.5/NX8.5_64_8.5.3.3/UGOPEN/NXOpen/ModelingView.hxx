...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ModelingView : public View
    {
        ...
        */
        public:  NX_DEPRECATED("Deprecated in NX5.0.0") enum SectionCap
        {
        ...
        /** This arbitrarily defines an initaial reference point. If the 'primary' plane,
         ...
         <br>  @deprecated Deprecated in NX5.0.0.  <br>  
        */
        public:  NX_DEPRECATED("Deprecated in NX5.0.0") enum SectionPlane
        {
        ...
        */
        public:
        struct  NX_DEPRECATED("Deprecated in NX5.0.0")  OtherSectionAttrT
        {
