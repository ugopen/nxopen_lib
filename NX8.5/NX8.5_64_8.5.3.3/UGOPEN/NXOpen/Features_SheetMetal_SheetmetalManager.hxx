        ...
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SheetmetalManager
            {
                ...
                /** Creates a @link Features::SheetMetal::SolidPunchBuilder Features::SheetMetal::SolidPunchBuilder@endlink   @return  
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /** Creates a @link Features::SheetMetal::BridgeTransitionBuilder Features::SheetMetal::BridgeTransitionBuilder@endlink   @return Bridge Transition Builder
                ...
                /** Creates a @link Features::SheetMetal::SheetMetalFromSolidBuilder Features::SheetMetal::SheetMetalFromSolidBuilder@endlink   @return  Sheet Metal from Solid Builder object
                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /** Creates a @link Features::SheetMetal::FlexibleCableBuilder Features::SheetMetal::FlexibleCableBuilder@endlink   @return Flexible Cable Builder object
                 <br>  Created in NX6.0.0.  <br>  
                ...
                /** Creates a @link Features::SheetMetal::GussetBuilder Features::SheetMetal::GussetBuilder@endlink   @return  Gusset Builder object
                ...
                /** Creates a @link Features::SheetMetal::EditBendBuilder Features::SheetMetal::EditBendBuilder@endlink   @return  
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /** Creates a @link Features::SheetMetal::ExportTrumpfBuilder Features::SheetMetal::ExportTrumpfBuilder@endlink   @return  
                 <br>  @deprecated Deprecated in NX8.0.0.  Use @link Features::SheetMetal::SheetmetalManager::CreateExportFlatPatternBuilder Features::SheetMetal::SheetmetalManager::CreateExportFlatPatternBuilder@endlink  instead. <br>  

                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Features::SheetMetal::SheetmetalManager::CreateExportFlatPatternBuilder instead.") NXOpen::Features::SheetMetal::ExportTrumpfBuilder * CreateExportTrumpfBuilder
                (
                );
                /** Creates a @link Features::SheetMetal::CleanUpUtilityBuilder Features::SheetMetal::CleanUpUtilityBuilder@endlink   @return  Clean-Up Utility Builder object
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::CleanUpUtilityBuilder * CreateCleanUpUtilityBuilder
                (
                );
                /** Creates a @link Features::SheetMetal::MetaformBuilder Features::SheetMetal::MetaformBuilder@endlink   @return  
                 <br>  Created in NX7.5.0.  <br>  
                ...
                /** Creates a @link Features::SheetMetal::EditCornerBuilder Features::SheetMetal::EditCornerBuilder@endlink   @return  
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::EditCornerBuilder * CreateEditCornerBuilder
                (
                );
                /** Creates a @link Features::SheetMetal::ExportFlatPatternBuilder Features::SheetMetal::ExportFlatPatternBuilder@endlink   @return  
