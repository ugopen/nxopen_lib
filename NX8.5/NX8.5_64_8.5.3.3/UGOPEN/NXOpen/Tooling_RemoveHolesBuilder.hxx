...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**Remove Hole is used to patch holes for a solid body. It returns a delete face 
            feature tag when success and NULL_TAG when fail.  <br> To create a new instance of this class, use @link Tooling::ProgressiveDieManager::CreateRemoveHolesBuilder  Tooling::ProgressiveDieManager::CreateRemoveHolesBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  RemoveHolesBuilder : public Builder
        {
