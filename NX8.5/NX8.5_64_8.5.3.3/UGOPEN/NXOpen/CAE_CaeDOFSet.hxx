...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeDOFSet : public DisplayableObject
        {
            ...
            /** Get the nodes in the DOFSet  @return  Array of nodes in the DOFSet @link CAE::FENode CAE::FENode@endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: std::vector<NXOpen::CAE::FENode *> GetNodes
            (
            );
            /** Get the nodes with the given dof value in the DOFSet  @return  Array of nodes @link CAE::FENode CAE::FENode@endlink  in the DOFSet with the dof value 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
