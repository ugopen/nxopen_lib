...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a isoparametric curves feature  <br> To create or edit an instance of this class, use @link Features::IsoparametricCurvesBuilder  Features::IsoparametricCurvesBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  IsoparametricCurves : public Features::CurveFeature
        {
