...
(
   ...
   double            duration,         /* <I> - time in seconds to complete
                                                this mount on the machine tool */
   char              tool_name[UF_SV_KIM_MAX_NAME_LEN+1]         /* <O> - name of the tool              */
);
...
(
   ...
   char              comp_name[UF_SV_KIM_MAX_NAME_LEN+1]     /* <O> - name of the component             */
);
...
(
   UF_SIM_engine_p_t engine,  /* <I> - simulation engine object               */
   char             jct_name[UF_SV_KIM_MAX_NAME_LEN+1] /* <O> - the name of the queried junction       */
);
...
(
   UF_SIM_engine_p_t            engine,   /* <I> - simulation engine object  */
   const char*                  axis,     /* <I> - the name of the axis      */
   char                         jct_name[2*(UF_SV_KIM_MAX_NAME_LEN+1)], /* <O> - the name of the
...
(
   ...
   char              comp_name[UF_SV_KIM_MAX_NAME_LEN+1]   /* <O> - the name of the component           */
);
