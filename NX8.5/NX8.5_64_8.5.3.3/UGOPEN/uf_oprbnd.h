 ...
 ***********************************************************************/
extern UFUNEXPORT int UF_OPRBND_ask_boundary_app_data
(
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_OPRBND_set_boundary_app_data
(
    tag_t                      object_tag,          /* <I> the parent object of the boundary */
    UF_CAM_geom_type_t         type,                /* <I> the type of the boundary */
    UF_OPRBND_boundary_t       boundary,            /* <I> the boundary */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_OPRBND_ask_item_app_data
(
    tag_t                        object_tag,        /* <I> the parent object of the boundary */
    UF_CAM_geom_type_t           type,              /* <I> the type of the boundary */
    UF_OPRBND_boundary_t         boundary,          /* <I> the boundary */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_OPRBND_set_item_app_data
(
    tag_t                      object_tag,          /* <I> the parent object of the boundary */
    UF_CAM_geom_type_t         type,                /* <I> the type of the boundary */
    UF_OPRBND_boundary_t       boundary,            /* <I> the boundary */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_OPRBND_ask_item_udes
(
   tag_t                       object_tag,          /* <I> the parent object of the boundary */
   UF_CAM_geom_type_t          type,                /* <I> the type of the boundary */
   UF_OPRBND_boundary_t        boundary,            /* <I> the boundary */
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_OPRBND_delete_all_item_udes
(
   tag_t                       object_tag,          /* <I> the parent object of the boundary */
   UF_CAM_geom_type_t          type,                /* <I> the type of the boundary */
   UF_OPRBND_boundary_t        boundary,            /* <I> the boundary */
 ...
 * History: Released in V19.0
 ***********************************************************************/
extern UFUNEXPORT int UF_OPRBND_append_item_ude
(
   tag_t                       object_tag,          /* <I> the parent object of the boundary */
   UF_CAM_geom_type_t          type,                /* <I> the type of the boundary */
   UF_OPRBND_boundary_t        boundary,            /* <I> the boundary */
 ...
 * History: Released in V19.0
 ***********************************************************************/
extern UFUNEXPORT int UF_OPRBND_delete_item_ude
(
   tag_t                       object_tag,          /* <I> the parent object of the boundary */
   UF_CAM_geom_type_t          type,                /* <I> the type of the boundary */
   UF_OPRBND_boundary_t        boundary,            /* <I> the boundary */
 ...
 * History: Released in V19.0
 ***********************************************************************/
extern UFUNEXPORT int UF_OPRBND_can_accept_item_ude
(
   tag_t                       object_tag,          /* <I> the parent object of the boundary */
   UF_CAM_geom_type_t          type,                /* <I> the type of the boundary */
   UF_OPRBND_boundary_t        boundary,            /* <I> the boundary */
