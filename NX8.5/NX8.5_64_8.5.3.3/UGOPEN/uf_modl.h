...
Note: This API will judge the thread type on the basis of type of cylindrical face provided.
If user wants to keep the thread type as Internal Thread always, he/she should use API
UF_MODL_create_symb_thread_2.
...
This API will judge the thread type on the basis of type of cylindrical face provided.
If user wants to keep the thread type as Internal Thread always, he/she should use API
UF_MODL_edit_symb_thread_2.
...
(
    ...
    double** data               /* <OF, len: num_intersections>
