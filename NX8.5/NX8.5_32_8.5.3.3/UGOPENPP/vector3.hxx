...
class VMATHPPEXPORT Vector3
{
    ...
    public:
        ...
        ); //lint !e1931 <fang.bo> The code was developed back in the late 90¡¯s for UG/Open++, 
           //so it was some of the first C++ code written. Adding an explicit to the constructor
           //will probably generate more QAZ errors. Suppressed it to avoid adding of more 
           //explicit keywords until we end up with a huge bunch of changes. 
