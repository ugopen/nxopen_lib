...
#ifndef UF_ATTR_DATATYPES_INCLUDED
#define UF_ATTR_DATATYPES_INCLUDED
...
{
    char      title[UF_ATTR_MAX_TITLE_LEN+1];  /* <len:UF_ATTR_MAX_TITLE_LEN+1>
