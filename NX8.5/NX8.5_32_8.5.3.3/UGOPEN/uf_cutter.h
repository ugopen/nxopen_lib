...
#define UF_CUTTER_SUBTYPE_LASER             0
...
struct UF_CUTTER_tracking_point_data_s
{
    ...
    char name[UF_OBJ_NAME_LEN + 1];  /* The name of the tracking point */
};
 ...
 ****************************************************************************/
extern UFUNEXPORT int UF_CUTTER_retrieve
(
 ...
 ****************************************************************************/
extern UFUNEXPORT int UF_CUTTER_update_from_lib
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CUTTER_create
(
...
extern UFUNEXPORT int UF_CUTTER_ask_type_and_subtype(
tag_t object_id ,/* <I>
 ...
 *************************************************************/
 extern UFUNEXPORT int UF_CUTTER_create_tracking_point
(
 ...
 *************************************************************/
 extern UFUNEXPORT int UF_CUTTER_create_turn_tracking_point
(
    tag_t      object_tag,                  /* <I> the parent of the point */
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_ask_tracking_point_count
(
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_ask_tracking_point_data
(
    tag_t  object_tag,              /*  <I> the parent of the point */
 ...
 * History: Released in NX5.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_ask_turn_tracking_point_data
(
    tag_t  object_tag,              /*  <I> the parent of the point */
    int  *count,                    /*  <O> number of tracking points  */
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_set_tracking_point_data
(
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_set_turn_tracking_point_data
(
    tag_t  object_tag,          /* <I> the parent object of the point */
    int  index,                 /* <I> index of tracking point in parent (from 0 to
                                        the number of tracking points - 1)  */
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_delete_tracking_point
(
 ...
 * History: Released in NX2.0
 *************************************************************/
 extern UFUNEXPORT int UF_CUTTER_create_holder_section
(
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_ask_section_count
(
    tag_t  object_tag,  /* <I> the tag of the cutter  */
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_ask_holder_data
(
    tag_t  object_tag,    /*  <I> the tag of the cutter  */
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_edit_holder_section
(
    tag_t  object_tag,  /*  <I> the tag of the cutter  */
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_CUTTER_delete_holder_section
(
    tag_t  object_tag,  /*  <I> the tag of the cutter  */
