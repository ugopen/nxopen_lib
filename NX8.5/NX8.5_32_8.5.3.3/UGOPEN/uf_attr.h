...
(
    ...
    int type,                       /* <I> The attribute type 
                                    ...
                                    */
    int index,                      /* <I> The array index (set to UF_ATTR_NOT_ARRAY if not an array) */
    UF_ATTR_info_t *info,           /* <I/O> The attribute information for the first attribute (or unset template) found, if any.
                                             This struct must be freed using UF_ATTR_free_user_attribute_info() after use. */
...
(
    ...
    const char *title,                               /* <I>  The attribute title */
    int index,                                       /* <I>  The array index (set to UF_ATTR_NOT_ARRAY if not an array) */
    char **string_value,                             /* <OF> String attribute value (caller must free this string after use) */
    logical *has_attribute                           /* <O>  An attribute has been found */
);
...
(
    ...
    const char *title,                               /* <I>  The attribute title */
    int index,                                       /* <I>  The array index (set to UF_ATTR_NOT_ARRAY if not an array) */
    char **reference_string,                         /* <OF> Reference string (caller must free this string after use) */
...
(
    ...
    const char *title,                          /* <I>  The attribute title */
    int index,                                  /* <I>  The array index (set to UF_ATTR_NOT_ARRAY if not an array) */
    char **time_string,                         /* <OF> Time/Date value formatted as a string (caller must free this string after use) */
    logical *has_attribute                      /* <O>  An attribute has been found */
);
 ...
 *         If not, it must be reset with 'UF_ATTR_reset_user_attribute_iterator()', or the iterator will leak memory.
...
(
    ...
    const UF_ATTR_iterator_t *iter, /* <I> Iterator describing the attributes being counted.
                                           The iterator is automatically reset. */
    int *count                      /* <I> The count of attributes (and/or unset templates) found */
);
...
(
    ...
    const UF_ATTR_iterator_t *iter, /* <I> Iterator describing the attributes being queried.
                                           The iterator is automatically reset. */
    int *num_attributes,            /* <I> The number of attributes returned */
    UF_ATTR_info_t **info           /* <I> The information for the attributes (and/or unset templates) found */
);
...
/****************************************************************************
 *
 *  THE FOLLOWING FUNCTIONS ARE NOT RECOMMENDED FOR USE IN NEW APPLICATIONS
 *
 ****************************************************************************/
...
int type ,/* <I>
          Attribute Type to Cycle:
             ...
             UF_ATTR_reference
          */
char  title[UF_ATTR_MAX_TITLE_LEN+1] ,/* <O>
                 Attribute Title (maximum character length is
                 UF_ATTR_MAX_TITLE_LEN+1)
              */
