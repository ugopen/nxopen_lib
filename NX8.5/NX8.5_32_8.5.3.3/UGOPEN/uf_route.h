...
#include <libufun_exports.h> /* Must be included last */
...
#define UF_ROUTE_err_max                                      ERROR_ROUTE_base + 215
...
#define UF_ROUTE_DR_REASON_IMPORT               27
#define UF_ROUTE_DR_REASON_SPACE_RESERVATION    28
#define UF_ROUTE_DR_REASON_PARTIAL_AUTO_ROUTE   29
#define UF_ROUTE_DR_REASON_PARTIAL_MANUAL_ROUTE 30
#define UF_ROUTE_DR_REASON_WIND_CATCHER         31
#define UF_ROUTE_DR_REASON_CREATE_PLATFORM      32
...
#define UF_ROUTE_CB_REASON_CREATE_PORT_CONNECTION 23
#define UF_ROUTE_CB_REASON_WIRE_COMP_PROXY        24
#define UF_ROUTE_CB_REASON_REPLACE_PART           25
#define UF_ROUTE_CB_REASON_BROKEN_CONNECTION      26
...
#define UG_ROUTE_THICKNESS_STR                          "THICKNESS"
#define UG_ROUTE_DEFAULT_PLATFORM_GRATE_SYMBOL_NAME_STR "DEFAULT_PLATFORM_GRATE_SYMBOL"
...
/* Structure passed to the SPECIFY_ITEM_FILTER plugin.
 *
 * The SPECIFY_ITEM_FILTER allows additional filtering of matching item
 * nodes by setting any matching index in match_rows to -1.
 */
struct UF_ROUTE_specify_item_filter_plugin_s
{
    UF_EPLIB_part_table_p_t ptb;
    /*  Input: Part table
     */

    int *                match_rows;
    /*  Input/output: Array containing indices of the matching rows in the part table.
        If an index < 0,  it will be ignored.  Use this method to filter out matching
        rows without resizing the array.
     */

    int                  num_match_rows;
    /*  Input: Size of matching indices array
     */
};

typedef struct UF_ROUTE_specify_item_filter_plugin_s
    UF_ROUTE_specify_item_filter_plugin_t, *UF_ROUTE_specify_item_filter_plugin_p_t;
...
/* The duct reinforcement plugins use this enumeration to tell the duct reinforcement
 dialog about any errors that may occur in a plugin.*/
enum UF_ROUTE_duct_reinforcement_errors_e
{
    UF_ROUTE_DUCT_REINFORCEMENT_ERROR_OK = 0,     /* No errors.*/
    UF_ROUTE_DUCT_REINFORCEMENT_NO_PLUGIN_FOUND,  /* Cannot find the plugin. Verify the plugin configuration in the application view file.*/
    UF_ROUTE_DUCT_REINFORCEMENT_PARENT_DUCT_INVALID /* Invalid parent duct*/
};

typedef enum UF_ROUTE_duct_reinforcement_errors_e UF_ROUTE_duct_reinforcement_errors_t,
            *UF_ROUTE_duct_reinforcement_errors_p_t;
