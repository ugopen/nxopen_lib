...
/* DRF80859: Extended enum and validation condition to support new line widths */
...
typedef UF_DRF_render_text_status_t (*UF_DRF_draw_standard_font_string_fn_t)(
    ...
    double fontSize,                    /* <I> Character height to use for standard font */
