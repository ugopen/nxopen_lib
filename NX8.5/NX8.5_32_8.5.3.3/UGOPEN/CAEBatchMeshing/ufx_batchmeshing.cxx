                                   ...
                                   UF_UG_BatchMesh_CommandLineOpts_t *pzBatchRunParams)
{
     ...
     for ( i=0; i<nCAEBodies; i++)
     {
        ...
        else
        {
            ...
            /* ==================================================
               ...
               ================================================== */
            write_mesh_quality_report ( scSolverName, scMeshType, mesh_tag, pzBatchRunParams );
        }
     ...
     if ( pzBatchRunParams->fOutputJT==(int)true )
     {
        ...
        iExpectedStrLen = (int)(strlen(JT_MESH_file_Name)+20);
        jt_file_path_name = (char*)UF_allocate_memory((iExpectedStrLen)*sizeof(char), &mem_error);
        if (mem_error != 0)
        {
            iRc = mem_error;
            return iRc;
