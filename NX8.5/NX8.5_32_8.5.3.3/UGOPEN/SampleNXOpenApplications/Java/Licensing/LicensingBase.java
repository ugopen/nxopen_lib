...
public class LicensingBase 
{
    ...
    */
    public static void doWork(Session theSession) throws Exception
    {
        ...
        datumCsysBuilder1.setComponentsCreation(true);
        
        datumCsysBuilder1.setFixedSizeDatum(true);
        ...
        SelectISurface selectISurface1;
        ...
        selectISurface1.setValue(datumPlane1);
        
        SelectIReferenceAxis selectIReferenceAxis1;
        ...
        selectIReferenceAxis1.setValue(datumAxis1);
        ...
        sketchInPlaceBuilder1.setPlaneOption(nxopen.Sketch.PlaneOption.INFERRED);
        
        sketchInPlaceBuilder1.setCreateIntermediateDatumCsys(false);
        
        sketchInPlaceBuilder1.setMakeOriginAssociative(true);
        
        sketchInPlaceBuilder1.setProjectWorkPartOrigin(false);
