...
public class UIStylerSelectionExample implements DialogItem.Apply, DialogItem.Construct, DialogItem.Okay, RealItem.Activate, StringItem.Activate, Toggle.ValueChanged,Selection.FilterTaggedObjectCallback,Selection.TaggedObjectSelectionCallback
{
    ...
    public int taggedObjectSelectionCallback(TaggedObject[] selectedObjects, TaggedObject[] deSelectedObjects, SelectionHandle selectH) throws NXException, RemoteException
    {
        try{
            ...
            {	
                ...
                {
					NXObject selObjects = (NXObject)selectedObjects[i];
                    htEdges.put(selObjects.journalIdentifier(),selectedObjects[i]);
                }
            ...
            if(deSelectedObjects!=null)
            {
                ...
                {
			    	NXObject selObjects = (NXObject)deSelectedObjects[j];
                    htEdges.remove(selObjects.journalIdentifier());
                }
    ...
    {
	    NXObject selObj = (NXObject) selectedObject;
        if(selObj.journalIdentifier().compareTo("EDGE * 6 * 1")==0)
        {
