...
typedef enum UF_WELD_feature_types_e{
                ...
                /*2011-02-15 Add type for Ship Basic Design feature types*/
                UF_WELD_SHIP_BASICDESIGN_HULL_TYPE,
                UF_WELD_SHIP_BASICDESIGN_DECK_TYPE,
                UF_WELD_SHIP_BASICDESIGN_TRNSBKHD_TYPE,
                UF_WELD_SHIP_BASICDESIGN_LONGBKHD_TYPE,
                UF_WELD_SHIP_BASICDESIGN_GENERIC_TYPE,
                UF_WELD_SHIP_BASICDESIGN_STIFFENERSYSTEM_TYPE,
                UF_WELD_SHIP_BASICDESIGN_EDGEREINFORCEMENTSYSTEM_TYPE,
                UF_WELD_SHIP_BASICDESIGN_SEAM_TYPE,
