...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Represents a @link Weld::AutoWeldSymbolsBuilder Weld::AutoWeldSymbolsBuilder@endlink  builder  <br> To create a new instance of this class, use @link Weld::WeldManager::CreateAutoWeldSymbolsBuilder  Weld::WeldManager::CreateAutoWeldSymbolsBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  AutoWeldSymbolsBuilder : public Builder
        {
            ...
            /**Returns  the weld objects used to create the weld symbols in the drafting views 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::SelectFeatureList * Welds
            (
            );
        };
    }
