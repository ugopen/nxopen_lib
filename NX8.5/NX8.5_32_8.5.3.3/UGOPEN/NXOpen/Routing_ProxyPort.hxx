...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class ProxyPortImpl;
        /** A @link Routing::ProxyPort Routing::ProxyPort@endlink  is a port that represents a connector in 
             another design zone, but not present in this design zone. @link Routing::ProxyPort Routing::ProxyPort@endlink 
             can be assigned to a connector using the @link Routing::Electrical::ConnectorDevice Routing::Electrical::ConnectorDevice@endlink 
             class method @link Routing::Electrical::ConnectorDevice::ProxyAssignConnector Routing::Electrical::ConnectorDevice::ProxyAssignConnector@endlink   <br> To obtain an instace of this class use @link Routing::ProxyPortCollection::CreateProxyPort Routing::ProxyPortCollection::CreateProxyPort@endlink   <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  ProxyPort : public Routing::Port, public virtual Routing::IAxisPort
        {
            private: ProxyPortImpl * m_proxyport_impl;
            private: friend class  _ProxyPortBuilder;
            protected: ProxyPort();
            public: ~ProxyPort();
            /**Returns  the backward extension of @link Routing::ProxyPort Routing::ProxyPort@endlink ,
                        i.e. the minimum length that a segment must remain straight
                        before entering a @link Routing::ProxyPort Routing::ProxyPort@endlink 
            ...
            /**Sets  the backward extension of @link Routing::ProxyPort Routing::ProxyPort@endlink ,
                        i.e. the minimum length that a segment must remain straight
                        before entering a @link Routing::ProxyPort Routing::ProxyPort@endlink 
