...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects all bodies of a group. 
    ...
    */
    class NXOPENCPPEXPORT  BodyGroupRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the body group rule: @link  BodyGroupRule   BodyGroupRule @endlink  
         <br>  Created in NX7.5.0.  <br>  
