...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a @link Tooling::ReusableObjectPasteBuilder Tooling::ReusableObjectPasteBuilder@endlink   <br> Use the @link ReusableObjectManager ReusableObjectManager@endlink  class to create a ReusableObjectPasteBuilder.  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  ReusableObjectPasteBuilder : public Builder
        {
