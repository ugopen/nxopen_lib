    ...
    namespace Tooling
    {
        ...
        /**
            Represents a Form Task builder
             <br> To create a new instance of this class, use @link Tooling::AutoDieCollection::CreateDieEngFormTaskBuilder  Tooling::AutoDieCollection::CreateDieEngFormTaskBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DieEngFormTaskBuilder : public Features::FeatureBuilder
        {
