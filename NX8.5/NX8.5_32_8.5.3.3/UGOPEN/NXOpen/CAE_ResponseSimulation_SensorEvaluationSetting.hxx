    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            /** Represents the parameters setting for sensor evaluation.  For more information, see the 
                Response Simulation section of the Gateway Help  <br> To create or edit an instance of this class, use @link CAE::ResponseSimulation::SensorEvaluationSettingBuilder  CAE::ResponseSimulation::SensorEvaluationSettingBuilder @endlink  <br> 
             <br>  Created in NX6.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  SensorEvaluationSetting : public CAE::ResponseSimulation::DynamicResultEvaluationSetting
            {
