...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a parallel dimension  <br> This is an abstract class and cannot be directly instantiated  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseParallelDimension : public Annotations::Dimension, public virtual Annotations::ILinearTolerance, public virtual Annotations::IPmi
        {
