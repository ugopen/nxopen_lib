...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a CAM Feature Group  <br> To obtain an instance of this class use @link CAM::FeatureRecognitionBuilder CAM::FeatureRecognitionBuilder@endlink   <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  FeatureGeometryGroup : public CAM::FeatureGeometry
        {
