...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Point to Point Section Line lets you create a view with multiple
                ...
                a set of rotation points.  <br> To create or edit an instance of this class, use @link Drawings::SectionLineBuilder  Drawings::SectionLineBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  PointToPointSectionLine : public Drawings::SectionLine
        {
