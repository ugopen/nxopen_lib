...
#include <NXOpen/Features_VehicleDesign_CrashBarrierBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                Represents a @link Features::VehicleDesign::CrashBarrier Features::VehicleDesign::CrashBarrier@endlink  builder
                to create and edit a vehicle design crash barrier. 
                 <br> To create a new instance of this class, use @link Features::AutomotiveCollection::CreateCrashBarrierBuilder  Features::AutomotiveCollection::CreateCrashBarrierBuilder @endlink  <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  CrashBarrierBuilder : public Features::FeatureBuilder
            {
