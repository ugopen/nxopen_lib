...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a gap arc segment.  <br> To obtain an instance of this class use @link Routing::SegmentManager Routing::SegmentManager@endlink   <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  GapArcSegment : public Arc, public virtual Routing::ISegment
        {
