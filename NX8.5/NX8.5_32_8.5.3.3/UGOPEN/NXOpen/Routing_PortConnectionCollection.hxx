...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  PortConnectionCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link PortConnection PortConnection@endlink  object.  @return  
             <br>  Created in NX4.0.0.  <br>  
