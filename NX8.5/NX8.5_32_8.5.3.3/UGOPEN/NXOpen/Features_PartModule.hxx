    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PartModule : public Features::Feature
        {
            ...
            /** Creates part module output builder @return  Returns a @link GeometricUtilities::PartModuleOutputBuilder GeometricUtilities::PartModuleOutputBuilder@endlink  builder 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::GeometricUtilities::PartModuleOutputBuilder * CreatePartModuleOutputBuilder
            (
            );
