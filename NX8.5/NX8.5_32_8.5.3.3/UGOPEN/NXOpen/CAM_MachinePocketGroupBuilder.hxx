...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  MachinePocketGroupBuilder : public CAM::NCGroupBuilder
        {
            /** the register type 
             <br>  @deprecated Deprecated in NX8.5.0.  This @link CAM::MachinePocketGroupBuilder::RegisterType CAM::MachinePocketGroupBuilder::RegisterType@endlink  is no longer supported. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This CAM::MachinePocketGroupBuilder::RegisterType is no longer supported.") enum RegisterType
            {
