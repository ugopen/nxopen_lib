...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  AnalysisObjectCollection : public TaggedObjectCollection
        {
            ...
            public:
                ...
                NXOPENCPP_GEOMETRICANALYSISEXPORT  value_type operator * ();
            ...
            /** Creates a curve analysis combs builder  @return  Curve analysis Combs Builder
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use GeometricAnalysis::CurveCurvatureAnalysis.") NXOpen::GeometricAnalysis::CurveAnalysisCombsBuilder * CreateCurveAnalysisCombsBuilder
            (
            );
            /** Creates a curve analysis inflections builder  @return  Curve analysis Inflections Builder 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use GeometricAnalysis::CurveCurvatureAnalysis.") NXOpen::GeometricAnalysis::CurveAnalysisInflectionsBuilder * CreateCurveAnalysisInflectionsBuilder
            (
            );
            /** Creates a curve analysis peaks builder  @return  Curve analysis Peaks Builder 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use GeometricAnalysis::CurveCurvatureAnalysis.") NXOpen::GeometricAnalysis::CurveAnalysisPeaksBuilder * CreateCurveAnalysisPeaksBuilder
            (
            );
            ...
            /** Creates a @link GeometricAnalysis::LocalRadiusAnalysisBuilder GeometricAnalysis::LocalRadiusAnalysisBuilder@endlink   @return  
