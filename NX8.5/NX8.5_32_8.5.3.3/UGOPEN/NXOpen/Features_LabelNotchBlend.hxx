...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a label notch blend feature  <br> To create or edit an instance of this class, use @link Features::LabelNotchBlendBuilder  Features::LabelNotchBlendBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  LabelNotchBlend : public Features::BodyFeature
        {
