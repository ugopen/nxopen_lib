...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents business modifier that applies a revision (in the string format such as -A1) to 
                a PMI. Plese see ug_revision_busmod.dfa for attribute details.  <br> To create or edit an instance of this class, use @link Annotations::RevisionBusinessModifierBuilder  Annotations::RevisionBusinessModifierBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  RevisionBusinessModifier : public Annotations::BusinessModifier
        {
