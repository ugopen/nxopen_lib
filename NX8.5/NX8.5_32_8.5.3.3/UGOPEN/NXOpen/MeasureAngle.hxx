...
namespace NXOpen
{
    ...
    /** Represents a single valued Angle measurement  <br> To create or edit an instance of this class, use @link MeasureAngleBuilder  MeasureAngleBuilder @endlink  <br> 
    ...
    */
    class NXOPENCPPEXPORT  MeasureAngle : public SingleMeasure
    {
        ...
        /** Creates and returns an embedded measurement expression. 
         ...
         <br>  @deprecated Deprecated in NX5.0.1.  Use @link MeasureAngle::CreateEmbeddedObject MeasureAngle::CreateEmbeddedObject@endlink  instead. <br>  

         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.1.  Use MeasureAngle::CreateEmbeddedObject instead.") NXString CreateEmbedded
        (
        );
