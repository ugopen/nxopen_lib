...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::ModelUpdateSolution CAE::ModelUpdateSolution@endlink , which is a meta-solution used to update finite element models to match real life test data  <br> To create or edit an instance of this class, use @link CAE::ModelUpdateSolutionBuilder  CAE::ModelUpdateSolutionBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ModelUpdateSolution : public CAE::CorrelSolution
        {
