...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class GeomcopyImpl;
        /** Represents a geomcopy feature  <br> To create or edit an instance of this class, use @link Features::GeomcopyBuilder  Features::GeomcopyBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  Geomcopy : public Features::Feature
        {
