...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** 
             ...
             <br> To create a new instance of this class, use @link Routing::AnchorCollection::CreateAnchor  Routing::AnchorCollection::CreateAnchor @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  Anchor : public SmartObject, public virtual Routing::IRoutePosition
        {
