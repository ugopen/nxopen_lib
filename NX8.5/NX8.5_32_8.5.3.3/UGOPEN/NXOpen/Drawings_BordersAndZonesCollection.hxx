...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Represents a collection of @link Drawings::BordersAndZones Drawings::BordersAndZones@endlink  objects  <br> To obtain an instance of this class, refer to @link DraftingManager  DraftingManager @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  BordersAndZonesCollection : public TaggedObjectCollection
        {
            ...
            public:
                ...
                typedef Drawings::BordersAndZones * value_type;
                /** Default constructor */
            ...
            /**  Finds the @link  Drawings::BordersAndZones   Drawings::BordersAndZones @endlink  with the given name. 
            ...
            (
                NXOpen::Drawings::BordersAndZones * bordersAndZones /** @link Drawings::BordersAndZones Drawings::BordersAndZones@endlink  to be redefined, if NULL then creates a new one */
            );
