...
namespace NXOpen
{
    ...
    namespace Drafting
    {
        ...
        /** This class is used to specify knowledge fusion rules in a drawing template. The rules are 
                executed when the template is instantiated.  <br> To create a new instance of this class, use @link Drafting::AutomationManager::CreateRulesBuilder  Drafting::AutomationManager::CreateRulesBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAFTINGEXPORT  RulesBuilder : public Builder
        {
