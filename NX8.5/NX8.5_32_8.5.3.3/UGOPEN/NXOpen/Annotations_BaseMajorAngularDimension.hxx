#ifndef NXOpen_ANNOTATIONS_BASEMAJORANGULARDIMENSION_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_BASEMAJORANGULARDIMENSION_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Annotations_BaseMajorAngularDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseMajorAngularDimensionBuilder;
        class BaseMajorAngularDimensionImpl;
        /** Represents a major angular dimension  <br> This is an abstract class and cannot be directly instantiated  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseMajorAngularDimension : public Annotations::AngularDimension, public virtual Annotations::IPmi
        {
            private: BaseMajorAngularDimensionImpl * m_basemajorangulardimension_impl;
            private: friend class  _BaseMajorAngularDimensionBuilder;
            protected: BaseMajorAngularDimension();
            public: ~BaseMajorAngularDimension();
