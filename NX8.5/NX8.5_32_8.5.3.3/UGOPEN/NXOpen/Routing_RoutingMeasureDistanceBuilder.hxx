...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RoutingMeasureDistanceBuilder : public MeasureDistanceBuilder
        {
            ...
            /**Returns  the @link Routing::RouteObjectCollector Routing::RouteObjectCollector@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Routing::RouteObjectCollector * RoutingSelection
            (
            );
            /**Sets  the @link Routing::RouteObjectCollector Routing::RouteObjectCollector@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
