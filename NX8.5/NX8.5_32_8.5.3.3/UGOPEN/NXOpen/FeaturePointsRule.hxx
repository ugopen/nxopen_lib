...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects all points created by a feature. 
    ...
    */
    class NXOPENCPPEXPORT  FeaturePointsRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the feature points rule: @link  FeaturePointsRule   FeaturePointsRule @endlink  
         <br>  Created in NX5.0.2.  <br>  
