...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  InstanceEditedExpressionsList : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the list of @link GeometricUtilities::InstanceEditedExpressionItem GeometricUtilities::InstanceEditedExpressionItem@endlink  objects. 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::InstanceEditedExpressionItemList * List
            (
            );
            /** This is the default creator for @link GeometricUtilities::InstanceEditedExpressionItem GeometricUtilities::InstanceEditedExpressionItem@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::InstanceEditedExpressionItem * EditInstanceExpression
            (
            );
            /** This is the creator for @link GeometricUtilities::InstanceEditedExpressionItem GeometricUtilities::InstanceEditedExpressionItem@endlink  which should be used.  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::InstanceEditedExpressionItem * EditInstanceExpression
            (
