...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a CAM Feature Attribute  <br> To obtain an instance of this class use @link CAM::CAMFeature CAM::CAMFeature@endlink   <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  CAMAttribute : public NXObject
        {
            /** Attribute types */
