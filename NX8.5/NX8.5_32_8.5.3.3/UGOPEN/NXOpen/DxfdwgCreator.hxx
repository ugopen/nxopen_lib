...
namespace NXOpen
{
    ...
    /**
        ...
        NULL object will be returned from Commit()  <br> To create a new instance of this class, use @link DexManager::CreateDxfdwgCreator  DexManager::CreateDxfdwgCreator @endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  DxfdwgCreator : public DexBuilder
    {
        /** Exprot From option */
        ...
        /**Returns  the layerMask list - This is list of enabled layers. for e.g. "1, 3-7, 9-256" 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: NXString LayerMask
        (
        );
        /**Sets  the layerMask list - This is list of enabled layers. for e.g. "1, 3-7, 9-256" 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
