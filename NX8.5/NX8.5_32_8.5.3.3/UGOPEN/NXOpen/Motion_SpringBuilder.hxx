...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  SpringBuilder : public Motion::ConnectorBuilder
        {
            ...
            /**Returns  the free angle expression 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * FreeAngleExpression
            (
            );
            ...
            /**Returns  the preload expression 
             ...
             <br> License requirements : None */
            public: NXOpen::Expression * PreloadExpression
            (
            );
            /**Returns  the preload expression 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * PreloadAngleExpression
            (
            );
