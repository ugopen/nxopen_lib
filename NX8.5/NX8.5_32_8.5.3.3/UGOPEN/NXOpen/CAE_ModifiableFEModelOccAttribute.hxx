...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ModifiableFEModelOccAttribute : public CAE::FEModelOccAttribute
        {
            ...
            (
                const NXString & pcFileName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Set the representation type to super element
            ...
            (
                const char * pcFileName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
