...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Surface Regions Builder  <br> To create a new instance of this class, use @link CAM::CAMSetup::CreateSurfaceRegions  CAM::CAMSetup::CreateSurfaceRegions @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  SurfaceRegions : public Features::FeatureBuilder
        {
