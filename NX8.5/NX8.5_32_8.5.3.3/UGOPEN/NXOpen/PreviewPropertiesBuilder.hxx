...
namespace NXOpen
{
    ...
    /**
        Represents a @link PreviewPropertiesBuilder PreviewPropertiesBuilder@endlink  to be used for creating and storing
        previews.  Both part previews and model view previews are supported.  
         <br> To create a new instance of this class, use @link PropertiesManager::CreatePreviewPropertiesBuilder  PropertiesManager::CreatePreviewPropertiesBuilder @endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  PreviewPropertiesBuilder : public Builder
    {
