...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PartCollection : public TaggedObjectCollection
    {
        ...
        public: /** User defined method that is called whenever a new part is created 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        typedef NXOpen::Callback1<void, NXOpen::BasePart *> PartCreatedHandler;
        public: /** User defined method that is called whenever a part is opened 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        typedef NXOpen::Callback1<void, NXOpen::BasePart *> PartOpenedHandler;
        public: /** User defined method that is called whenever a part is saved 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        typedef NXOpen::Callback1<void, NXOpen::BasePart *> PartSavedHandler;
        public: /** User defined method that is called whenever a part is saved as a specified name 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        typedef NXOpen::Callback1<void, NXOpen::BasePart *> PartSavedAsHandler;
        public: /** User defined method that is called whenever a part is in the process of being closed 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        ...
        (
            const char * name /** The name of the @link  BasePart   BasePart @endlink . This may either be the full pathname of the leaf name. */
        );
        ...
        /** Creates a @link FileNew FileNew@endlink   @return  
        ...
        /** Creates a @link LinkedMirrorPartBuilder LinkedMirrorPartBuilder@endlink   @return  the LinkedMirrorPartBuilder object
