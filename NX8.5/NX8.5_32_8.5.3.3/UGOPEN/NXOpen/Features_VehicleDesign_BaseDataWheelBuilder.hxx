...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::BaseDataWheelBuilder Features::VehicleDesign::BaseDataWheelBuilder@endlink .  <br> This class can only be used in base data, thus cannot be created directly by user.  <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  BaseDataWheelBuilder : public Builder
            {
                ...
                /**Returns  the rim offset. Rim offset is the shift between the mounting point of the wheel and the wheel center.
                                It is used only when @link PositionDefinition PositionDefinition @endlink and @link SetPositionDefinition SetPositionDefinition @endlink  is @link Features::VehicleDesign::BaseDataWheelBuilder::PositionDefinitionOptionsAttachmentPointRimOffset Features::VehicleDesign::BaseDataWheelBuilder::PositionDefinitionOptionsAttachmentPointRimOffset@endlink . 
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
