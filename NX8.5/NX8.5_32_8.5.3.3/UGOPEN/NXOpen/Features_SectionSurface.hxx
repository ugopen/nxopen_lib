...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a section surface feature  <br> To create or edit an instance of this class, use @link Features::SectionSurfaceBuilder  Features::SectionSurfaceBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SectionSurface : public Features::BodyFeature
        {
