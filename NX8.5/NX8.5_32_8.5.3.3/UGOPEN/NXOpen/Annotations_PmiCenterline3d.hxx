...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a Pmi 3D centerline  <br> To create or edit an instance of this class, use @link Annotations::PmiCenterline3dBuilder  Annotations::PmiCenterline3dBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiCenterline3d : public Annotations::BaseCenterline3d, public virtual Annotations::IPmi
        {
