...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents a @link CAE::Optimization::DAOSolutionBuilder CAE::Optimization::DAOSolutionBuilder@endlink .  <br> To create a new instance of this class, use @link CAE::Optimization::DAOSolutionCollection::CreateOptimizationBuilder  CAE::Optimization::DAOSolutionCollection::CreateOptimizationBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  DAOSolutionBuilder : public Builder
            {
