    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Features::SeatBeltAnchorageBuilder Features::SeatBeltAnchorageBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /** Creates a @link Features::ReflectionDataBuilder Features::ReflectionDataBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Creates a @link Features::WindshieldDatumBuilder Features::WindshieldDatumBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Creates a @link Features::VisionPlaneBuilder Features::VisionPlaneBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Creates a @link Features::HoodVisibilityBuilder Features::HoodVisibilityBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Creates a @link Features::PedestrianProtectionBuilder Features::PedestrianProtectionBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Creates a @link Features::VehicleCoordinateSystemBuilder Features::VehicleCoordinateSystemBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
