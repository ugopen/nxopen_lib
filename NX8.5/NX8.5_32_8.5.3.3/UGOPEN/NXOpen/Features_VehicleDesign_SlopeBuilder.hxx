...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** The builder to create slope feature.  <br> To create a new instance of this class, use @link Features::AutomotiveCollection::CreateSlopeBuilder  Features::AutomotiveCollection::CreateSlopeBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
