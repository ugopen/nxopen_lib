...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SimBCBuilder;
        class SimBCImpl;
        /** Represents BC class which is a superclass to @link CAE::SimLoad CAE::SimLoad@endlink  and @link CAE::SimConstraint CAE::SimConstraint@endlink 
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimBC : public DisplayableObject, public virtual CAE::IExportableFEEntity
        {
