...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  MoveCollection : public TaggedObjectCollection
        {
            ...
            (
                NXOpen::CAM::Move * param /** Move object */,
                const NXString & typeName /** Type of the User Defined Move to create. When editing the move this will not be used   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Create User Defined Move.   @return  Builder 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            (
                NXOpen::CAM::Move * param /** Move object */,
                const char * typeName /** Type of the User Defined Move to create. When editing the move this will not be used   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
