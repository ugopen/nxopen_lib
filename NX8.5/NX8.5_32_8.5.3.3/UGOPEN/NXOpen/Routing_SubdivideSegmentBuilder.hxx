...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  SubdivideSegmentBuilder : public Builder
        {
            ...
            /**Returns  the equal segments option as @link Routing::SubdivideSegmentBuilder::EqualSegmentsMethod Routing::SubdivideSegmentBuilder::EqualSegmentsMethod@endlink 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::SubdivideSegmentBuilder::EqualSegmentsMethod EqualSegmentsOption
            (
            );
            /**Sets  the equal segments option as @link Routing::SubdivideSegmentBuilder::EqualSegmentsMethod Routing::SubdivideSegmentBuilder::EqualSegmentsMethod@endlink 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /**Returns  the spacing method as @link Routing::SubdivideSegmentBuilder::Types Routing::SubdivideSegmentBuilder::Types@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::SubdivideSegmentBuilder::Types Type
            (
            );
            /**Sets  the spacing method as @link Routing::SubdivideSegmentBuilder::Types Routing::SubdivideSegmentBuilder::Types@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetType
            (
