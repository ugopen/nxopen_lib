...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PlateStockBuilder : public Builder
            {
                /** Settings to indicate how to apply the thickness to the mold face or offset mold face . 
                            The front side of the offset mold face is defined by the client class using  @link PlateStockBuilder PlateStockBuilder@endlink . */
