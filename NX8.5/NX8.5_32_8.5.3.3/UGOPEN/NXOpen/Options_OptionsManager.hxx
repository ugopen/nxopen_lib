        ...
        */
        class NXOPENCPP_OPTIONSEXPORT  OptionsManager
        {
            ...
            /** Creates an instance of @link  Options::ChangeList   Options::ChangeList @endlink  class, in order to edit a set of options. 
                    ...
                    or for a level that is not defined or is not writeable.   @return  An instanse of @link  Options::ChangeList   Options::ChangeList @endlink  class 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates an instance of @link  Options::DraftingStandardChangeList   Options::DraftingStandardChangeList @endlink  class, in order to edit a set of options. 
                    ...
                    or for a level that is not defined or is not writeable.   @return  An instanse of @link  Options::DraftingStandardChangeList   Options::DraftingStandardChangeList @endlink  class 
            ...
            (
                NXOpen::Options::LevelType level /** Options level.  */,
                const char * filename /** Specifies the filename to save/save as.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
