...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents the trim body feature builder. This class is to be used only for editing pre-NX7.5.0 trim body features.
            Use @link Features::TrimBody2Builder Features::TrimBody2Builder@endlink  to create and edit trim body features.  <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateTrimBodyBuilder  Features::FeatureCollection::CreateTrimBodyBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  TrimBodyBuilder : public Features::FeatureBuilder
        {
