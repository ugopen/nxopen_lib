...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  LaminateImportedLayupBuilder : public Builder
        {
            ...
            /**Returns  the selected faces on which the layup information will be imported. 
             <br>  @deprecated Deprecated in NX8.0.1.  Use @link CAE::LaminateImportedLayupBuilder::Selection CAE::LaminateImportedLayupBuilder::Selection@endlink  instead. <br>  

             <br>  Created in NX6.0.4.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.1.  Use CAE::LaminateImportedLayupBuilder::Selection instead.") NXOpen::SelectTaggedObjectList * FaceSelection
            (
            );
            ...
            (
                const NXString & laminate /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Selects a laminate for import 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void SelectLaminate
            (
                const char * laminate /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
