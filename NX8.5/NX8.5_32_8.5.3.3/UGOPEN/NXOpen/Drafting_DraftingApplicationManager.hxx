    ...
    namespace Drafting
    {
        ...
        */
        class NXOPENCPP_DRAFTINGEXPORT  DraftingApplicationManager
        {
            ...
            /** Creates a @link Drafting::MoveToDrawingViewBuilder Drafting::MoveToDrawingViewBuilder@endlink   @return  
            ...
            /** Creates a @link Drafting::SmashDrawingViewBuilder Drafting::SmashDrawingViewBuilder@endlink   @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_drafting_plus ("DraftingPlus") */
