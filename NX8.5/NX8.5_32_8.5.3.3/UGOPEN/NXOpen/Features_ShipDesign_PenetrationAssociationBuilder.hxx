...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /** Represents a @link Features::ShipDesign::PenetrationAssociationBuilder Features::ShipDesign::PenetrationAssociationBuilder@endlink  builder   <br> To create a new instance of this class, use @link Features::ShipDesign::PenetrationRequestCollection::CreatePenetrationAssociationBuilder  Features::ShipDesign::PenetrationRequestCollection::CreatePenetrationAssociationBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  PenetrationAssociationBuilder : public Builder
            {
