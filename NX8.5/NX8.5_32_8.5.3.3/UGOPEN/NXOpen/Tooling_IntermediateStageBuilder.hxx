...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**Represents a @link Tooling::IntermediateStageBuilder Tooling::IntermediateStageBuilder@endlink  builder.  <br> To create a new instance of this class, use @link Tooling::IntermediateStageCollection::CreateIntermediateStageBuilder  Tooling::IntermediateStageCollection::CreateIntermediateStageBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  IntermediateStageBuilder : public Builder
        {
