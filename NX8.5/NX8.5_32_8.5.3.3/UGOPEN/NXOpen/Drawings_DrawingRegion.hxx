...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Represents a Drawing Region  <br> To create or edit an instance of this class, use @link Drawings::DrawingRegionBuilder  Drawings::DrawingRegionBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  DrawingRegion : public DisplayableObject
        {
