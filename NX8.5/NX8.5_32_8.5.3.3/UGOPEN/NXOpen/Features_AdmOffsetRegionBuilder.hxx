...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  AdmOffsetRegionBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the region faces to offset. See @link Features::FaceRecognitionBuilder Features::FaceRecognitionBuilder@endlink  for details. 
             <br>  Created in NX6.0.0.  <br>  
