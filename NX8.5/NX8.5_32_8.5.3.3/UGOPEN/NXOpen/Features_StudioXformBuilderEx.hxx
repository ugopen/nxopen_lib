...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  StudioXformBuilderEx : public Features::FeatureBuilder
        {
            ...
            /** Represents the advanced method type 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Features::StudioXformBuilderEx::AdvancedMethodOptionType Features::StudioXformBuilderEx::AdvancedMethodOptionType@endlink  instead. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Features::StudioXformBuilderEx::AdvancedMethodOptionType instead.") enum AdvancedMethodType
            {
            ...
            /**Returns  the advanced method 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Features::StudioXformBuilderEx::AdvancedMethodOption Features::StudioXformBuilderEx::AdvancedMethodOption@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Features::StudioXformBuilderEx::AdvancedMethodOption instead.") NXOpen::Features::StudioXformBuilderEx::AdvancedMethodType AdvancedMethod
            (
            );
            /**Sets  the advanced method 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Features::StudioXformBuilderEx::SetAdvancedMethodOption Features::StudioXformBuilderEx::SetAdvancedMethodOption@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Features::StudioXformBuilderEx::SetAdvancedMethodOption instead.") void SetAdvancedMethod
            (
            ...
            /**Returns  the proportional fall off scale 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Features::StudioXformBuilderEx::FallOffScale Features::StudioXformBuilderEx::FallOffScale@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Features::StudioXformBuilderEx::FallOffScale instead.") double ProportionalFallOffScale
            (
            );
            /**Sets  the proportional fall off scale 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Features::StudioXformBuilderEx::SetFallOffScale Features::StudioXformBuilderEx::SetFallOffScale@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Features::StudioXformBuilderEx::SetFallOffScale instead.") void SetProportionalFallOffScale
            (
                double proportionalFallOffScale /** proportionalfalloffscale */ 
            );
            /** Reset the proportional scale 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Features::StudioXformBuilderEx::FallOffReset Features::StudioXformBuilderEx::FallOffReset@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Features::StudioXformBuilderEx::FallOffReset instead.") void ProportionalReset
            (
            );
            ...
            /** Changes degree of the selected xform object 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Features::StudioXformBuilderEx::ChangeDegreeWithParameters Features::StudioXformBuilderEx::ChangeDegreeWithParameters@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Features::StudioXformBuilderEx::ChangeDegreeWithParameters instead.") void ChangeDegree
            (
