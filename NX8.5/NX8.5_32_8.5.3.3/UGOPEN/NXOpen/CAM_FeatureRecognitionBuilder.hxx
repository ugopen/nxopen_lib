...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  FeatureRecognitionBuilder : public Builder
        {
            ...
            (
                const char * featureName /** name of new feature   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<NXOpen::Face *> & faces /** floor faces of new feature */,
                const std::vector<NXOpen::Face *> & wallFaces /** wall faces of new feature */,
                bool deleteFeatures /** Deletes previous found features */
            );
