...
#include <NXOpen/Weld_EdgePrepValuesBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  EdgePrepValuesBuilder : public Builder
        {
            ...
            /**Returns  the apply values option which indicates whether the all the values of each selected joint should be updated or just the values that were changed in the @link Weld::JointExitBuilder Weld::JointExitBuilder@endlink . 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Weld::EdgePrepValuesBuilder::Apply ValuesApplyOption
            (
            );
            /**Sets  the apply values option which indicates whether the all the values of each selected joint should be updated or just the values that were changed in the @link Weld::JointExitBuilder Weld::JointExitBuilder@endlink . 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : structure_weld ("STRUCTURE WELD") */
            ...
            /** Deletes the @link Weld::JointExitBuilder Weld::JointExitBuilder@endlink . 
            ...
            /**Returns  the @link Weld::JointExitBuilder Weld::JointExitBuilder@endlink . 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : structure_weld ("STRUCTURE WELD") */
