...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a windshield datum feature  <br> To create or edit an instance of this class, use @link Features::WindshieldDatumBuilder  Features::WindshieldDatumBuilder @endlink  <br> 
