...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  FlexibleCableBuilder : public Features::FeatureBuilder
            {
                ...
                (
                    const char * length /** Length.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    int segmentIndex /** Index. */
                );
                ...
                (
                    const char * bendAngle /** Bend angle.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    const char * bendRadius /** Bend radius.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    const char * pathAdjustmentAngle /** Path adjustment angle.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    NXOpen::Features::SheetMetal::FlexibleCableBuilder::BendAngleDirectionOptions bendAngleDirection /** @link Features::SheetMetal::FlexibleCableBuilder::BendAngleDirectionOptions Features::SheetMetal::FlexibleCableBuilder::BendAngleDirectionOptions@endlink  */,
                    NXOpen::Features::SheetMetal::FlexibleCableBuilder::PathAdjustmentAngleDirectionOptions pathAdjustmentAngleDirection /** @link Features::SheetMetal::FlexibleCableBuilder::PathAdjustmentAngleDirectionOptions Features::SheetMetal::FlexibleCableBuilder::PathAdjustmentAngleDirectionOptions@endlink  */,
                    int segmentIndex /** Index. */
                );
