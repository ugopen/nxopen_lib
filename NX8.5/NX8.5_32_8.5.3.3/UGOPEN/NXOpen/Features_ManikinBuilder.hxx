        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ManikinBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the percentile limit that the manikin represents. 
                        ...
                        @link Features::ManikinBuilder::SAEPercentileTypeJ833SmallHuman5thFemale Features::ManikinBuilder::SAEPercentileTypeJ833SmallHuman5thFemale@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the current manikin size string. It is only used when the vehicle standard type is set to 
                        @link Features::ManikinBuilder::StandardTypeUserDefined Features::ManikinBuilder::StandardTypeUserDefined@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
