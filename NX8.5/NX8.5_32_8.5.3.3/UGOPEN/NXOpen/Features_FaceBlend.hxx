...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class FaceBlendImpl;
        /** Represents a Face Blend feature.  <br> To create or edit an instance of this class, use @link Features::FaceBlendBuilder  Features::FaceBlendBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  FaceBlend : public Features::BodyFeature, public virtual Features::IIsolateToolBodyOperation
        {
