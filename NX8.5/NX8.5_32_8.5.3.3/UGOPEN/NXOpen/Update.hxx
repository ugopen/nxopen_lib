    ...
    class NXOPENCPPEXPORT  Update
    {
        ...
        */
        ...
        /** Adds objects to the global delete list.
            ...
            should be used instead.  
             ...
             @return  The number of errors in the update module's
                                       ...
                                       use @link Update::ErrorList Update::ErrorList@endlink  
         <br>  Created in NX3.0.0.  <br>  
        ...
        /**Returns  the list of all the errors that the Update module has encountered
            ...
            use @link Update::ClearErrorList Update::ClearErrorList@endlink . 
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ErrorList * ErrorList
        (
        );
        /** Clears the error list. See @link Update::ErrorList Update::ErrorList@endlink  
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Clear the update mark.See@link Update::StartLocalUpdate Update::StartLocalUpdate@endlink . 
         <br>  Created in NX7.5.1.  <br>  
         <br> License requirements : None */
        ...
        /** Lock and unlock updates. Locking updates will lock model updates until updates are unlocked. Note that updates 
                ...
                restored after your operation. See @link Update::GetUpdateLock Update::GetUpdateLock@endlink  to get the lock status. 
                Additionally, a call to @link Update::DoUpdate Update::DoUpdate@endlink  has to be made after restoring the 
        ...
        /** Get the current update lock status. Also see @link Update::SetUpdateLock Update::SetUpdateLock@endlink   @return  The lock state 
         <br>  Created in NX7.5.5.  <br>  
         <br> License requirements : None */
