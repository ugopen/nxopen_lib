...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Used to create a @link Features::ShipDesign::CuttingSideFacesBuilder Features::ShipDesign::CuttingSideFacesBuilder@endlink  which
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  CuttingSideFacesBuilder : public Features::FeatureBuilder
            {
                /**
