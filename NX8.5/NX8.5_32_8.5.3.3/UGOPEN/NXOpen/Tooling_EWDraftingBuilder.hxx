...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents the drafting builder which is used to create electrode drafting.  <br> To create a new instance of this class, use @link Tooling::ElectrodeDesignCollection::CreateEwdraftingBuilder  Tooling::ElectrodeDesignCollection::CreateEwdraftingBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  EWDraftingBuilder : public Builder
        {
