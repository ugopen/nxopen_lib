...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /** Represents a @link GeometricUtilities::SelectionList GeometricUtilities::SelectionList@endlink   <br> To create a new instance of this class, use @link Part::CreateSelectionList  Part::CreateSelectionList @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  SelectionList : public NXObject
        {
