...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents the Ball Joint. Objects are connected at a shared point and
            can move all ways rotationally.  <br> To create or edit an instance of this class, use @link Mechatronics::BallJointBuilder  Mechatronics::BallJointBuilder @endlink  <br> 
         <br>  Created in NX7.5.1.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  BallJoint : public Mechatronics::PhysicsJoint
        {
