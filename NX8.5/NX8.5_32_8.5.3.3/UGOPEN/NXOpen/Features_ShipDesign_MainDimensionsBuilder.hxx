...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                    Represents a @link Features::ShipDesign::MainDimensions Features::ShipDesign::MainDimensions@endlink  builder.
                     <br> To create a new instance of this class, use @link Features::ShipCollection::CreateMainDimensionsBuilder  Features::ShipCollection::CreateMainDimensionsBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  MainDimensionsBuilder : public Features::FeatureBuilder
            {
