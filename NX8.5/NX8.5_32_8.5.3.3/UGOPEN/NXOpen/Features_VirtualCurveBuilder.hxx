...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  VirtualCurveBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the revolved face.  This is only used if the 
                    @link Features::VirtualCurveBuilder::TypesRotationAxis Features::VirtualCurveBuilder::TypesRotationAxis@endlink  is set. 
             <br>  Created in NX7.5.0.  <br>  
            ...
            /**Returns  the blend face.  This is only used if the 
                    ...
                    or @link Features::VirtualCurveBuilder::TypesVirtualIntersection Features::VirtualCurveBuilder::TypesVirtualIntersection@endlink  is set. 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
