...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** @link Routing::StockOffsetPort Routing::StockOffsetPort@endlink  class handles the relationship
                ...
                the stock diameter.  <br> Use @link Routing::StockOffsetPortCollection::CreateStockOffsetPort Routing::StockOffsetPortCollection::CreateStockOffsetPort@endlink  to create an instance of this class.  <br> 
         <br>  Created in NX7.5.4.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  StockOffsetPort : public Routing::Port
        {
            ...
            /** Returns the @link Routing::StockOffsetPort Routing::StockOffsetPort@endlink  in the work part that was created from the original port occurrence.  @return  
             <br>  Created in NX7.5.4.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::Port * GetOffsetPort
            (
            );
            /** Returns the diameter of all the stock on the path at this @link Routing::StockOffsetPort Routing::StockOffsetPort@endlink .
