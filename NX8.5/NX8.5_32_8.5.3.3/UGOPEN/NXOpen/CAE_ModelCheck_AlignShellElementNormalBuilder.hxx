...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ModelCheck
        {
            ...
            /**
                    Represents a @link CAE::ModelCheck::AlignShellElementNormalBuilder CAE::ModelCheck::AlignShellElementNormalBuilder@endlink  builder used to align the normals of
                    connected shell elements with a seed shell element. You can align the normals by executing either 
                    @link Builder::Commit Builder::Commit@endlink  or @link CAE::ModelCheck::AlignShellElementNormalBuilder::AlignNormals CAE::ModelCheck::AlignShellElementNormalBuilder::AlignNormals@endlink .
                    ...
                    @link CAE::ModelCheck::AlignShellElementNormalBuilder::AlignNormals CAE::ModelCheck::AlignShellElementNormalBuilder::AlignNormals@endlink  aligns the normals
                    and returns the elements that have changed normals. Both of the methods are only available in fem context.
                    
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  AlignShellElementNormalBuilder : public Builder
            {
                ...
                public: enum ConnectedElementScope
                {
                    ...
                    ConnectedElementScopeUserSpecified/** Limits check to only those shell elements specified in @link CAE::ModelCheck::AlignShellElementNormalBuilder::UserSpecifiedConnectElements CAE::ModelCheck::AlignShellElementNormalBuilder::UserSpecifiedConnectElements@endlink  */
                };
