...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /** This class @link GeometricUtilities::ModlAlongCurveAngle GeometricUtilities::ModlAlongCurveAngle@endlink  represents motion type in ModlMotion 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  ModlAlongCurveAngle : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
