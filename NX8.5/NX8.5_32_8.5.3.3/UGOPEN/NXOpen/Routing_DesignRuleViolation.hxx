...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  DesignRuleViolation : public NXObject
        {
            ...
            (
                const char * user /**    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * reason /**    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int timestamp /** timestamp */ 
            );
            ...
            /** This will give all violation location objects stored in calling violation object.  @return  Array of @link Routing::DesignRuleViolationLocation Routing::DesignRuleViolationLocation@endlink  object. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            ...
            /** This will return violation location object stored at given postion of array.
             ...
             <br>  @deprecated Deprecated in NX8.0.3.  Use @link Routing::DesignRuleViolation::GetLocations Routing::DesignRuleViolation::GetLocations@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.3.  Use Routing::DesignRuleViolation::GetLocations instead.") NXOpen::Routing::DesignRuleViolationLocation * GetViolationLocation
            (
            ...
            /** This will set violation location object at given postion of array.
             ...
             <br>  @deprecated Deprecated in NX8.0.3.  Use @link Routing::DesignRuleViolation::AddViolationLocations Routing::DesignRuleViolation::AddViolationLocations@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.3.  Use Routing::DesignRuleViolation::AddViolationLocations instead.") void SetViolationLocation
            (
                int arrayPosition /** array position */ ,
