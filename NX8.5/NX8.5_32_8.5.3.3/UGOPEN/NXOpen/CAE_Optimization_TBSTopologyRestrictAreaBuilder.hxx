...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents the builder of @link CAE::Optimization::TBSTopologyRestrictArea CAE::Optimization::TBSTopologyRestrictArea@endlink  <br> To create a new instance of this class, use @link CAE::Optimization::TBSOptimizationManager::CreateTopologyRestrictAreaBuilder  CAE::Optimization::TBSOptimizationManager::CreateTopologyRestrictAreaBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  TBSTopologyRestrictAreaBuilder : public CAE::Optimization::TBSRestrictAreaBuilder
            {
