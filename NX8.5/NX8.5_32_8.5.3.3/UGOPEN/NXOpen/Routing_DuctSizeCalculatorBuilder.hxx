...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Builder to perform calculations of the duct which is to be used in the HVAC applications. The duct has some flow attributes and has dimentions. <br> To create a new instance of this class, use @link Routing::RouteManager::CreateDuctSizeCalculatorBuilder  Routing::RouteManager::CreateDuctSizeCalculatorBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  DuctSizeCalculatorBuilder : public Builder
        {
