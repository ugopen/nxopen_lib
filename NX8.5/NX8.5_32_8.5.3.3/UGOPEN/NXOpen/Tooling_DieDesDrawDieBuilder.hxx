...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents the Die Design draw die management builder, which is to create a draw die by selected 
            sheet body, curve and base plane. <br> To create a new instance of this class, use @link Tooling::AutoDieCollection::CreateDieDesDrawDieBuilder  Tooling::AutoDieCollection::CreateDieDesDrawDieBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  DieDesDrawDieBuilder : public Builder
        {
