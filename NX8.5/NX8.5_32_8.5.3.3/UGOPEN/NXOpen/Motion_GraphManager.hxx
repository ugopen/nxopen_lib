...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  GraphManager : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Motion::GraphBuilder Motion::GraphBuilder@endlink   @return  GraphBuilder object 
             <br>  Created in NX5.0.0.  <br>  
