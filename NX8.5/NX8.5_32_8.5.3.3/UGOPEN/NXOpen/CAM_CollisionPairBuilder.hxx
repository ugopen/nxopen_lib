    ...
    namespace CAM
    {
        ...
        /**
            Represents a @link CAM::CollisionPairBuilder CAM::CollisionPairBuilder@endlink 
             <br> To create a new instance of this class, use @link SIM::KinematicConfigurator::CreateCollisionPairBuilder  SIM::KinematicConfigurator::CreateCollisionPairBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  CollisionPairBuilder : public Builder
        {
