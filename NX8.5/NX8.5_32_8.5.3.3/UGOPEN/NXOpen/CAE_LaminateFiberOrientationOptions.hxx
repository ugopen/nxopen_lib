...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Laminate Fiber Orientation Options  <br> To create or edit an instance of this class, use @link CAE::LaminateFiberOrientationOptionsBuilder  CAE::LaminateFiberOrientationOptionsBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  LaminateFiberOrientationOptions : public NXObject
        {
