...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  SpecifyCSYS : public BlockStyler::UIBlock
        {
            ...
            /**Returns  the SmartUpdateOption as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXString SmartUpdteOptionAsString
            (
            );
            /**Sets  the SmartUpdateOption as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void SetSmartUpdteOptionAsString
            (
                const NXString & enumString /** enumstring */ 
            );
            /**Sets  the SmartUpdateOption as string
            ...
            /** Gets the SmartUpdateOption members @return Value to get from the property
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetSmartUpdteOptionMembers
            (
            );
        };
    }
