...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::EditTitleBlockBuilder Annotations::EditTitleBlockBuilder@endlink  builder  <br> To create a new instance of this class, use @link Annotations::TitleBlockCollection::CreateEditTitleBlockBuilder  Annotations::TitleBlockCollection::CreateEditTitleBlockBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  EditTitleBlockBuilder : public Annotations::BaseTitleBlockBuilder
        {
