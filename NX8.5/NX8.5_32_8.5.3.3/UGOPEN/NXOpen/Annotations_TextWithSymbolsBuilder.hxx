...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  TextWithSymbolsBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the scale of the embedded user-defined symbols if the symbol size method is
                        @link Annotations::TextWithSymbolsBuilder::SymbolSizingMethodScaleAndAspectRatio Annotations::TextWithSymbolsBuilder::SymbolSizingMethodScaleAndAspectRatio@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the length of the embedded user-defined symbols if the symbol size method is
                        @link Annotations::TextWithSymbolsBuilder::SymbolSizingMethodLengthAndHeight Annotations::TextWithSymbolsBuilder::SymbolSizingMethodLengthAndHeight@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
