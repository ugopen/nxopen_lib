...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  CircularBlendCurveBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the cylinder direction option as @link Features::CircularBlendCurveBuilder::CylinderDirectionOption Features::CircularBlendCurveBuilder::CylinderDirectionOption@endlink 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::CircularBlendCurveBuilder::CylinderDirectionOption DirectionOption
            (
            );
            /**Sets  the cylinder direction option as @link Features::CircularBlendCurveBuilder::CylinderDirectionOption Features::CircularBlendCurveBuilder::CylinderDirectionOption@endlink 
             <br>  Created in NX5.0.0.  <br>  
            ...
            /**Returns  the cylinder radius option as @link Features::CircularBlendCurveBuilder::CylinderRadiusOption Features::CircularBlendCurveBuilder::CylinderRadiusOption@endlink 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::CircularBlendCurveBuilder::CylinderRadiusOption RadiusOption
            (
            );
            /**Sets  the cylinder radius option as @link Features::CircularBlendCurveBuilder::CylinderRadiusOption Features::CircularBlendCurveBuilder::CylinderRadiusOption@endlink 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the location of the point on curve as arclength or %arclength, if  @link Features::CircularBlendCurveBuilder::CylinderRadiusOption Features::CircularBlendCurveBuilder::CylinderRadiusOption@endlink  
                        is @link Features::CircularBlendCurveBuilder::CylinderRadiusOptionPointOnFirstCurve Features::CircularBlendCurveBuilder::CylinderRadiusOptionPointOnFirstCurve@endlink  or @link Features::
                        CircularBlendCurveBuilder::CylinderRadiusOptionPointOnSecondCurve Features::
                        CircularBlendCurveBuilder::CylinderRadiusOptionPointOnSecondCurve@endlink 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the curve fit method as @link GeometricUtilities::CurveFitOptions GeometricUtilities::CurveFitOptions@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
