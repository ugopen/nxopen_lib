...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class RegionImpl;
        /** Represents a Region  <br> To create or edit an instance of this class, use @link Annotations::RegionBuilder  Annotations::RegionBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  Region : public Annotations::Annotation, public virtual Annotations::IPmi
        {
