    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSession
        {
            ...
            /** Creates a @link Motion::PhysicsConversionBuilder Motion::PhysicsConversionBuilder@endlink   @return  
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /** Returns the @link Motion::MotionEnvironment  Motion::MotionEnvironment @endlink  belonging to this part 
             <br>  Created in NX7.5.0.  <br>  
            */
            public: NXOpen::Motion::MotionEnvironment *Environments();
            /** Returns the @link Motion::PostProcess  Motion::PostProcess @endlink  belonging to this part 
             <br>  Created in NX7.5.0.  <br>  
            */
            public: NXOpen::Motion::PostProcess *PostProcess();
            /** Returns the @link Motion::MotionMethods  Motion::MotionMethods @endlink belonging to this part 
             <br>  Created in NX8.0.0.  <br>  
            */
