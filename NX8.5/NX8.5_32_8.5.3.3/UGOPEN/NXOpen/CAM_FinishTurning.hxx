...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Turn Finishing operation  <br> To create or edit an instance of this class, use @link CAM::FinishTurningBuilder  CAM::FinishTurningBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  FinishTurning : public CAM::RoughFinishTurning
        {
