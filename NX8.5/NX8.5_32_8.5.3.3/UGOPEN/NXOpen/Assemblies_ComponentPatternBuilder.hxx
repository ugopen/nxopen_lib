...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /// \cond NX_NO_DOC 
        /** Represents a @link Assemblies::ComponentPatternBuilder Assemblies::ComponentPatternBuilder@endlink  builder  <br> To create a new instance of this class, use @link Assemblies::ComponentAssembly::CreateComponentPatternBuilder  Assemblies::ComponentAssembly::CreateComponentPatternBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ComponentPatternBuilder : public Builder
        {
            ...
            /**Returns  the copy constraint toggle is used for creating copy constraint type of pattern 
                        when it is turned ON and Pure reference type of pattern when it is turned OFF.
            ...
            /**Sets  the copy constraint toggle is used for creating copy constraint type of pattern 
                        when it is turned ON and Pure reference type of pattern when it is turned OFF.
            ...
            (
                bool isCopyConstraintPattern /** iscopyconstraintpattern */ 
            );
            /** The dynamic positioning toggle is used for dynamic update of component pattern and in turn pattern
                        instance constraints. It will enable or disable the dynamic preview of the components.  
                        When toggle is disabled, only the dots provided by the pattern service will be previewed.  @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            ...
            /** An associative toggle is used to switch between associative and unassociative type of 
                        component pattern. By default, it will be ON.  @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: bool GetAssociative
            (
            );
            /** The associative toggle value which determines if the component pattern will be associative or not. By default, the value will be TRUE.
            ...
            /**Returns  the component pattern name.
                    
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXString PatternName
            (
            );
            /**Returns  the supressed status of the component pattern. 
                    
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: bool PatternSupressedStatus
            (
            );
            /**Returns   the deferred status of the component pattern. 
                    
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: bool PatternDeferredStatus
            (
            );
        };
