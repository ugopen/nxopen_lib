...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects all the faces of a body. 
    ...
    */
    class NXOPENCPPEXPORT  FaceBodyRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the face body rule: @link  FaceBodyRule   FaceBodyRule @endlink   @return  Body which creates this rule
