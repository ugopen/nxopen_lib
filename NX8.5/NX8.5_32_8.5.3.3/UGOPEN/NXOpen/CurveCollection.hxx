...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  CurveCollection : public TaggedObjectCollection
    {
        ...
        /** Creates a @link Line Line@endlink .  @return  
         <br>  Created in NX3.0.0.  <br>  
        ...
        /** Creates a @link Line Line@endlink  joining given start @link Point Point@endlink  and
                End @link Point Point@endlink .  @return  
        ...
        /** Creates a @link InfiniteLine InfiniteLine@endlink  that passes through the two specified points.  @return  
        ...
        /** Creates a paired @link InfiniteLine InfiniteLine@endlink  that is paired to the specified line.  @return  
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : nx_drafting_plus ("DraftingPlus") */
        ...
        /** Creates an @link Arc Arc@endlink  that passes through the three specified points.  @return  
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        ...
        /** Creates a @link Curve Curve@endlink . The smart composite curve will be
        ...
        /** Creates a @link Curve Curve@endlink .  The extracted curve will be
