...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  Associativity : public TransientObject
        {
            ...
            /**Returns  the first definition point. Required for following line options -
                        @link Annotations::AssociativityLineOptionPointVector Annotations::AssociativityLineOptionPointVector@endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the angle. Required for following line option -
                        @link Annotations::AssociativityLineOptionAngle Annotations::AssociativityLineOptionAngle@endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: double Angle
            (
