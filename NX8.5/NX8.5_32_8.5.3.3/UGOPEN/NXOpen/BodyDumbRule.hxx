...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects bodies without any intent i.e. as if collected with Single Body rule. 
    ...
    */
    class NXOPENCPPEXPORT  BodyDumbRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the body dumb rule: @link  BodyDumbRule   BodyDumbRule @endlink  
         <br>  Created in NX7.5.0.  <br>  
