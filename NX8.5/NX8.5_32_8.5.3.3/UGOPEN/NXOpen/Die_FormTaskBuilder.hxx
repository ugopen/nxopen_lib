...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        /** Represents a Form Task feature builder.  <br> To create a new instance of this class, use @link Die::DieCollection::FormTask  Die::DieCollection::FormTask @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_DIEEXPORT  FormTaskBuilder : public Features::FeatureBuilder
        {
