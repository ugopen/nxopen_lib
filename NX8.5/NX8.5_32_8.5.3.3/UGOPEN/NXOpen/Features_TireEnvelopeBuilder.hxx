...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  TireEnvelopeBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the expression containing the offset value of the front section(at 0 degrees). 
                        Only used when the offset method is @link Features::TireEnvelopeBuilder::EnvelopeOffsetMethodFixedSections Features::TireEnvelopeBuilder::EnvelopeOffsetMethodFixedSections@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            ...
            /** Set the sketch containing the tire profiles by the given part name and sketch name. 
                        Only used when the tire profile option is @link Features::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart Features::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /**Returns  the name of the tire profile in the tire file.
                        Only used when the tire profile option is @link Features::TireEnvelopeBuilder::TireDefinitionOptionProfilePointFile Features::TireEnvelopeBuilder::TireDefinitionOptionProfilePointFile@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Read the spindle data and write the data into the motion file. 
                        Only used when the motion method option is @link Features::TireEnvelopeBuilder::MotionMethodFromSpindleLines Features::TireEnvelopeBuilder::MotionMethodFromSpindleLines@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Read the file containing the suspension template points.
                        Only used when the motion method option is @link Features::TireEnvelopeBuilder::MotionMethodSuspensionTemplate Features::TireEnvelopeBuilder::MotionMethodSuspensionTemplate@endlink .  @return  the missing point name 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Change the location of a joint in the suspension template.
                        Only used when the motion method option is @link Features::TireEnvelopeBuilder::MotionMethodSuspensionTemplate Features::TireEnvelopeBuilder::MotionMethodSuspensionTemplate@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Run the motion articulation, output the motion file and then exit the motion simulation.
                        Only used when the motion method option is @link Features::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel Features::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel@endlink  
                        or @link Features::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel Features::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel@endlink .                      
                        It must be paired with a call to @link Features::TireEnvelopeBuilder::BuildMotionTemplate Features::TireEnvelopeBuilder::BuildMotionTemplate@endlink .
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Indicate the sections that should be offset. 
                        Only used when the motion method option is @link Features::TireEnvelopeBuilder::EnvelopeOffsetMethodCustomerDefinedData Features::TireEnvelopeBuilder::EnvelopeOffsetMethodCustomerDefinedData@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Update the tire body feature in the tire body output part file.
                        ...
                        Only used when the tire profile option is @link Features::TireEnvelopeBuilder::TireDefinitionOptionProfileCurves Features::TireEnvelopeBuilder::TireDefinitionOptionProfileCurves@endlink  
                         or @link Features::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart Features::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
            ...
            /** Re-assemble the part containing the tire body defining tire profile to work part as the moving component
                         ...
                         Only used when the tire profile option is @link Features::TireEnvelopeBuilder::TireDefinitionOptionSolidBody Features::TireEnvelopeBuilder::TireDefinitionOptionSolidBody@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_general_packaging ("NX General Packaging") */
