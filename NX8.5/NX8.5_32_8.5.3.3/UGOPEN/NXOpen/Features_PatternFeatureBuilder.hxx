...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        UseInferredReferencePoint </td> <td> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PatternFeatureBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  a flag to indicate whether to use reference point inferred from selected feature(s) or not.
             ...
             <br> License requirements : None */
            public: bool UseInferredReferencePoint
            (
            );
            /**Sets  a flag to indicate whether to use reference point inferred from selected feature(s) or not.
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetUseInferredReferencePoint
            (
            ...
            /** Removes clocking from (unclocks) all instances of the @link Features::PatternFeature Features::PatternFeature@endlink . 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
