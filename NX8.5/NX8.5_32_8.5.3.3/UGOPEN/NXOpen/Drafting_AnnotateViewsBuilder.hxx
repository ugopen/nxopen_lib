...
namespace NXOpen
{
    ...
    namespace Drafting
    {
        ...
        /** This class is used to annotate views based on the knowledge fusion rules.  <br> To create a new instance of this class, use @link Drafting::AutomationManager::CreateAnnotateViewsBuilder  Drafting::AutomationManager::CreateAnnotateViewsBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAFTINGEXPORT  AnnotateViewsBuilder : public Builder
        {
