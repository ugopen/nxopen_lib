...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  GlobalShapingBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the orientation of the target curve to the limit curves. Only used when 
                        deformation_type is @link Features::GlobalShapingBuilder::DeformationTypeValuesWallDeformation Features::GlobalShapingBuilder::DeformationTypeValuesWallDeformation@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
