...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ListingWindow
    {
        ...
        void WriteLine
        (
            const char * msg /** Line to write   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Writes a full line to the listing window.
            ...
            is different from @link ListingWindow::WriteLine ListingWindow::WriteLine@endlink 
        ...
        /**Returns  a flag indicating whether the listing window is open.
            To open the window, use @link Open Open@endlink .
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : None */
        public: bool IsOpen
        (
        ...
        (
            NXOpen::ListingWindow::DeviceType deviceType /** The type of device (file, Information window, or both) */,
            const char * fileName /** Name of the file.  Used only if the device type is file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
