...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /** Represents the standard part framework builder to add or edit ship standard part.  <br> To create a new instance of this class, use @link Features::ShipCollection::CreateStandardPartFrameworkBuilder  Features::ShipCollection::CreateStandardPartFrameworkBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  StandardPartFrameworkBuilder : public Builder
            {
                ...
                /**Sets  the option whether to reverse direction. 
                 <br>  @deprecated Deprecated in NX8.0.3.  Use @link Features::ShipDesign::StandardPartFrameworkBuilder Features::ShipDesign::StandardPartFrameworkBuilder@endlink .ModifySpreadSheetData() instead. <br>  

                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") OR nx_ship_basic ("Ship Basic Design") */
                public:  NX_DEPRECATED("Deprecated in NX8.0.3.  Use Features::ShipDesign::StandardPartFrameworkBuilder.ModifySpreadSheetData() instead.") void SetReverseDirection
                (
                ...
                /** 
                 ...
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") OR nx_ship_basic ("Ship Basic Design") */
                public:  NX_DEPRECATED("Deprecated in NX8.0.3.  Use Features::ShipDesign::StandardPartFrameworkBuilder.ModifySpreadSheetData() instead.") void FlipThicknessDirection
                (
                ...
                /** 
                 ...
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") OR nx_ship_basic ("Ship Basic Design") */
                public:  NX_DEPRECATED("Deprecated in NX8.0.3.  Use Features::ShipDesign::StandardPartFrameworkBuilder.ModifySpreadSheetData() instead.") void UpdateThickness
                (
                    bool bUpdateModel /** bupdatemodel */ 
                );
                /** 
