...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Used to create a @link Features::ShipDesign::EditWeldingBuilder Features::ShipDesign::EditWeldingBuilder@endlink  which
                is used to change the welding characteristics on the seams in the plate systems.
                 <br> To create a new instance of this class, use @link Features::ShipCollection::CreateEditWeldingBuilder  Features::ShipCollection::CreateEditWeldingBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  EditWeldingBuilder : public Features::FeatureBuilder
            {
