...
namespace NXOpen
{
    ...
    /**
        ...
        are in a valid format.  The minimum year is 1900 and the maximum year is 4499.
        
        NOTE: The class does NOT verify that the combination of day, month, year and time is valid.
        
         <br> To create a new instance of this class, use @link DateBuilder::CreateDateItemBuilder  DateBuilder::CreateDateItemBuilder @endlink  <br> 
     <br>  Created in NX8.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  DateItemBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
    {
        /** Days of the month */
