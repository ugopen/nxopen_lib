...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /** Contains various penetration utility methods  <br> To obtain an instance of this class, refer to @link Features::ShipDesign::PenetrationManager  Features::ShipDesign::PenetrationManager @endlink  <br> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PenetrationUtils
            {
                ...
                /** Creates a @link Features::ShipDesign::PenetrationSite Features::ShipDesign::PenetrationSite@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                ...
                /** Creates a @link Features::ShipDesign::PenetrationList Features::ShipDesign::PenetrationList@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Creates a @link Features::ShipDesign::PenetrationFolder Features::ShipDesign::PenetrationFolder@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Creates a @link Features::ShipDesign::PenetrationAttachment Features::ShipDesign::PenetrationAttachment@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Ask current @link Features::ShipDesign::PenetrationSite Features::ShipDesign::PenetrationSite@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                public: NXOpen::Features::ShipDesign::PenetrationSite * AskCurrentSite
                (
                );
                /** Set current @link Features::ShipDesign::PenetrationSite Features::ShipDesign::PenetrationSite@endlink  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Ask current @link Features::ShipDesign::PenetrationList Features::ShipDesign::PenetrationList@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                public: NXOpen::Features::ShipDesign::PenetrationList * AskWorkingList
                (
                );
                /** Set current @link Features::ShipDesign::PenetrationList Features::ShipDesign::PenetrationList@endlink  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Ask current @link Features::ShipDesign::PenetrationList Features::ShipDesign::PenetrationList@endlink  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Get the reference folder @link Features::ShipDesign::PenetrationFolder Features::ShipDesign::PenetrationFolder@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
