...
namespace NXOpen
{
    ...
    /**
        Represents an @link AttributeTemplatesBuilder AttributeTemplatesBuilder@endlink  to be used when creating attribute
        ...
        depository, then the data from the imported template will overwrite the data in the depository.
         <br> To create a new instance of this class, use @link PropertiesManager::CreateAttributeTemplatesBuilder  PropertiesManager::CreateAttributeTemplatesBuilder @endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  AttributeTemplatesBuilder : public Builder
    {
