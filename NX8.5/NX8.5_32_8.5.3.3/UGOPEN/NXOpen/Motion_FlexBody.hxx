...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents the Motion FlexBody class.It must be associated
            with a Motion Link.  <br> To create or edit an instance of this class, use @link Motion::FlexBodyBuilder  Motion::FlexBodyBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  FlexBody : public Motion::MotionObject
        {
