...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  Connection : public Routing::LogicalConnection
            {
                /** Routing level. */
                ...
                /** Get the intermediate terminals associated with this connection. Intermediate Terminals are
                                optional and need not exist for a @link Routing::Electrical::Connection Routing::Electrical::Connection@endlink  to be valid in NX. @return  Collection of intermediate @link Routing::LogicalTerminal Routing::LogicalTerminal@endlink  - May be NULL
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                ...
                /** Add an intermediate terminal to this connection @return  Was the @link Routing::LogicalTerminal Routing::LogicalTerminal@endlink  added successfully?  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                ...
                /** Remove an intermediate terminal from this connection @return  Was the @link Routing::LogicalTerminal Routing::LogicalTerminal@endlink  removed successfully?  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                ...
                /** Similar to @link Routing::Electrical::Connection::GetRoutedLevel Routing::Electrical::Connection::GetRoutedLevel@endlink ,
                                but returns the @link Routing::Electrical::Connection::RouteLevel Routing::Electrical::Connection::RouteLevel@endlink  enumeration instead of a string.  @return  Route level. 
                ...
                /** Assigns the given path to this connection and routes the connection on the path using the given routing level.
                                Use @link Routing::Electrical::Connection::FindPaths Routing::Electrical::Connection::FindPaths@endlink  to find all available paths for this connection.
