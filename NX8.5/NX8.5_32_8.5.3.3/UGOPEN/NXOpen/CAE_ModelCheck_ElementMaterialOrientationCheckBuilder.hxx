...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ModelCheck
        {
            ...
            /** Represents a @link CAE::ModelCheck::ElementMaterialOrientationCheckBuilder CAE::ModelCheck::ElementMaterialOrientationCheckBuilder@endlink  
                        ...
                        Use @link CAE::ModelCheck::ElementMaterialOrientationCheckBuilder::DoCheck CAE::ModelCheck::ElementMaterialOrientationCheckBuilder::DoCheck@endlink 
                     ...
                     <br> To create a new instance of this class, use @link CAE::ModelCheckManager::CreateElementMaterialOrientationCheckBuilder  CAE::ModelCheckManager::CreateElementMaterialOrientationCheckBuilder @endlink  <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  ElementMaterialOrientationCheckBuilder : public Builder
            {
