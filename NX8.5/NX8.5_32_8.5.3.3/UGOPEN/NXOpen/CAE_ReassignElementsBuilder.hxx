    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link CAE::ReassignElementsBuilder CAE::ReassignElementsBuilder@endlink 
             <br> To create a new instance of this class, use @link CAE::MeshManager::CreateReassignElementsBuilder  CAE::MeshManager::CreateReassignElementsBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ReassignElementsBuilder : public Builder
        {
