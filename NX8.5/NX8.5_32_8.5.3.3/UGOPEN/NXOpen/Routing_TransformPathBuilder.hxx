...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  TransformPathBuilder : public Builder
        {
            ...
            /** Deprecated. as this builder attribute no longer required hence removed  @return The characteristics .
             <br>  @deprecated Deprecated in NX8.5.0.  This builder attribute is no longer required. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This builder attribute is no longer required.") NXOpen::Routing::CharacteristicList * GetRequiredCharacteristics
            (
            );
            /** Deprecated. as this builder attribute no longer required hence removed  @return The characteristics 
             <br>  @deprecated Deprecated in NX8.5.0.  This builder attribute is no longer required. <br>  
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This builder attribute is no longer required.") NXOpen::Routing::CharacteristicList * GetOptionalCharacteristics
            (
            );
