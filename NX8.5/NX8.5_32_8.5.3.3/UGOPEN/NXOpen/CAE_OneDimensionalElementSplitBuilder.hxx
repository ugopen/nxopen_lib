...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link CAE::OneDimensionalElementSplitBuilder CAE::OneDimensionalElementSplitBuilder@endlink 
             <br> To create a new instance of this class, use @link CAE::NodeElementManager::CreateOneDimensionalElementSplitBuilder  CAE::NodeElementManager::CreateOneDimensionalElementSplitBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  OneDimensionalElementSplitBuilder : public Builder
        {
