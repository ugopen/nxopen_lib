...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Create weld labels for multiple welds and BIW locators, this builder's Commit can produce more than one object, 
                the GetCommittedObjects can be used to get the objects and the order of GetCommittedObject's output array is stable.  <br> To create a new instance of this class, use @link Weld::WeldManager::CreateWeldLabelBuilder  Weld::WeldManager::CreateWeldLabelBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  WeldLabelBuilder : public Builder
        {
            ...
            public: NXOpen::Features::SelectFeatureList * Objects
            (
            );
            /**Returns  the @link Annotations::TextWithEditControlsBuilder Annotations::TextWithEditControlsBuilder@endlink  for the annotation 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
