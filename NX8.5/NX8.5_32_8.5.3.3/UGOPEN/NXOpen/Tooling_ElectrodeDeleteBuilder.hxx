...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Electrode delete component builder to remove blank, pallet and holder from assembly.  <br> To create a new instance of this class, use @link Tooling::ElectrodeDesignCollection::CreateDeleteComponentBuilder  Tooling::ElectrodeDesignCollection::CreateDeleteComponentBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ElectrodeDeleteBuilder : public Builder
        {
