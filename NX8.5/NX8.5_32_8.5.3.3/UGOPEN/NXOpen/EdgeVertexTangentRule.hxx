...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects the vertex edge and the edges adjacent and tangent to it. 
    ...
    */
    class NXOPENCPPEXPORT  EdgeVertexTangentRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the edge vertex tangent rule: @link  EdgeVertexTangentRule   EdgeVertexTangentRule @endlink  
         <br>  Created in NX4.0.0.  <br>  
