...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents the External Connection class.  External Connection objects are
                able to connect physics runtime properties to OPC signals.  <br> To create or edit an instance of this class, use @link Mechatronics::ExternalConnectionBuilder  Mechatronics::ExternalConnectionBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ExternalConnection : public DisplayableObject
        {
