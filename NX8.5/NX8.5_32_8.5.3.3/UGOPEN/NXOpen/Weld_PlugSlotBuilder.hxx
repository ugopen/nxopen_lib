...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Represents a @link Weld::PlugSlot Weld::PlugSlot@endlink  builder  <br> To create a new instance of this class, use @link Weld::WeldManager::CreatePlugSlotBuilder  Weld::WeldManager::CreatePlugSlotBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  PlugSlotBuilder : public Features::FeatureBuilder
        {
            /** contour type */
