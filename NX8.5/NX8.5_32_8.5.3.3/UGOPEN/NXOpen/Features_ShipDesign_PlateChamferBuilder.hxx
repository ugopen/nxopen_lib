...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Represents a @link Features::ShipDesign::PlateChamfer Features::ShipDesign::PlateChamfer@endlink  builder. It is used to create and edit a plate chamfer feature.
                 <br> To create a new instance of this class, use @link Features::ShipCollection::CreatePlateChamferBuilder  Features::ShipCollection::CreatePlateChamferBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PlateChamferBuilder : public Features::FeatureBuilder
            {
                /**
