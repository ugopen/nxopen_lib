    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            /** Represents parameters setting for strength results evaluation. Available to all kinds of 
                event type  <br> To create or edit an instance of this class, use @link CAE::ResponseSimulation::StrengthResultsEvaluationSettingBuilder  CAE::ResponseSimulation::StrengthResultsEvaluationSettingBuilder @endlink  <br> 
             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  StrengthResultsEvaluationSetting : public CAE::ResponseSimulation::DynamicResultEvaluationSetting
            {
