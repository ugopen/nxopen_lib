...
namespace NXOpen
{
    ...
    namespace Layer
    {
        ...
        */
        class NXOPENCPP_LAYEREXPORT  CategoryCollection : public TaggedObjectCollection
        {
            ...
            public:
                ...
                NXOPENCPP_LAYEREXPORT  value_type operator * ();
            ...
            (
                const char * name /** The name must not NULL and 
                                            must not already be used by another layer category. */,
                const char * description /** Optional   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<int> & memberLayers /** Layers to be placed into the category */
            );
            ...
            (
                const NXString & name /** The name of the @link Category Category@endlink  */
            );
            /** Finds the @link Category Category@endlink  with the given name. 
            ...
            (
                const char * name /** The name of the @link Category Category@endlink  */
            );
