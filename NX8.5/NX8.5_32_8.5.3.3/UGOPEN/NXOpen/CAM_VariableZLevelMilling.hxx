...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Variable Z Level Milling Operation  <br> To create or edit an instance of this class, use @link CAM::VazlMillingBuilder  CAM::VazlMillingBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  VariableZLevelMilling : public CAM::PlanarOperation
        {
