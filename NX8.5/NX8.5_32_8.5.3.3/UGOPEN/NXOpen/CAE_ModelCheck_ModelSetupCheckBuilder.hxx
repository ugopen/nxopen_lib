...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ModelCheck
        {
            ...
            /**Represents a @link CAE::ModelCheck::ModelSetupCheckBuilder CAE::ModelCheck::ModelSetupCheckBuilder@endlink  which can be
                used to check if the active @link CAE::SimSolution CAE::SimSolution@endlink  contains all the necessary 
                ...
                file or listed in a seperate information window, along with an error summary for each topic  
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  ModelSetupCheckBuilder : public Builder
            {
