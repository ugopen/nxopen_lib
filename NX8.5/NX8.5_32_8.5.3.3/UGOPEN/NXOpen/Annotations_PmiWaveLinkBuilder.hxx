...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::Pmi Annotations::Pmi@endlink  builder  <br> To create a new instance of this class, use @link Annotations::PmiWaveCollection::CreatePmiWaveLinkBuilder  Annotations::PmiWaveCollection::CreatePmiWaveLinkBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiWaveLinkBuilder : public Builder
        {
