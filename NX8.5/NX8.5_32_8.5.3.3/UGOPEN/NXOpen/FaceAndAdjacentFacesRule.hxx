...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects both the seed face and all its adjacent faces. 
    ...
    */
    class NXOPENCPPEXPORT  FaceAndAdjacentFacesRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the face and adjacent faces rule: @link  FaceAndAdjacentFacesRule   FaceAndAdjacentFacesRule @endlink  
         <br>  Created in NX7.0.0.  <br>  
