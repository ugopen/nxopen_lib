...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a builder to be used to create manufacturing geometry. <br> To create a new instance of this class, use @link Tooling::ManufacturingGeometryCollection::CreateBuilder  Tooling::ManufacturingGeometryCollection::CreateBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ManufacturingGeometryBuilder : public Builder
        {
