...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Contour Flange feature  <br> To create or edit an instance of this class, use @link Features::SheetMetal::ContourFlangeBuilder  Features::SheetMetal::ContourFlangeBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  ContourFlange : public Features::Feature
        {
