...
namespace NXOpen
{
    ...
    namespace Positioning
    {
        ...
        */
        class NXOPENCPP_POSITIONINGEXPORT  Positioner : public NXObject
        {
            ...
            /** 
                 ...
                 @return  The new @link Constraint Constraint@endlink  
            ...
            /** 
                 ...
                 @return  The new @link Network Network@endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
