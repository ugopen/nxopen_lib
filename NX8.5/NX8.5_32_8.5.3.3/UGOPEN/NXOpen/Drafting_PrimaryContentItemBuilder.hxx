...
namespace NXOpen
{
    ...
    namespace Drafting
    {
        ...
        /**
            Represents a @link Drafting::PrimaryContentItemBuilder Drafting::PrimaryContentItemBuilder@endlink .  This class is
            ...
            Each instance represents a single drawing in a booklet.
             <br> To create a new instance of this class, use @link Drafting::AutomationManager::CreatePrimaryContentItemBuilder  Drafting::AutomationManager::CreatePrimaryContentItemBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAFTINGEXPORT  PrimaryContentItemBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
