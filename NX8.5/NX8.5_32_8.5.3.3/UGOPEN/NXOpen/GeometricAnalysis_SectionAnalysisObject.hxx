...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        /** Represents a Section Analysis object. Section Analysis
            ...
            changes of the sectioned faces and faceted bodies.  <br> To create or edit an instance of this class, use @link GeometricAnalysis::SectionAnalysis::SectionAnalysisBuilder  GeometricAnalysis::SectionAnalysis::SectionAnalysisBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  SectionAnalysisObject : public GeometricAnalysis::AnalysisObject
        {
