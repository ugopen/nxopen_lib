...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link Annotations::TitleBlockCellBuilder Annotations::TitleBlockCellBuilder@endlink 
             <br> To create a new instance of this class, use @link Annotations::TitleBlockCollection::CreateCellBuilder  Annotations::TitleBlockCollection::CreateCellBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  TitleBlockCellBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
