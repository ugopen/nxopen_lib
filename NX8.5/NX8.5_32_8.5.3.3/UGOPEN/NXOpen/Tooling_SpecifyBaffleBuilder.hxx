...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a builder to be used to create specify baffle.  <br> To create a new instance of this class, use @link Tooling::SpecifyBaffleCollection::CreateBuilder  Tooling::SpecifyBaffleCollection::CreateBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  SpecifyBaffleBuilder : public Builder
        {
