...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  GridCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Display::PlanarShipGridBuilder Display::PlanarShipGridBuilder@endlink  object
