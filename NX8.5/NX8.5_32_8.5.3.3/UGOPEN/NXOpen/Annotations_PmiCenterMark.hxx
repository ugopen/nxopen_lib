...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI Center Mark class  <br> To create or edit an instance of this class, use @link Annotations::PmiCenterMarkBuilder  Annotations::PmiCenterMarkBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiCenterMark : public Annotations::BaseCenterMark, public virtual Annotations::IPmi
        {
