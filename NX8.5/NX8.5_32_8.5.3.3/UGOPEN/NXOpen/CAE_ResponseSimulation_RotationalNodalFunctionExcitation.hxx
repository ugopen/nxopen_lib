...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            /** Represents a rotational nodal function excitation  <br> To create or edit an instance of this class, use @link CAE::ResponseSimulation::RotationalNodalFunctionExcitationBuilder  CAE::ResponseSimulation::RotationalNodalFunctionExcitationBuilder @endlink  <br> 
             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  RotationalNodalFunctionExcitation : public CAE::ResponseSimulation::NodalFunctionExcitation
            {
