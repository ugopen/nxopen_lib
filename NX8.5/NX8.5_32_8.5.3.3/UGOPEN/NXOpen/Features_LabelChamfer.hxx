...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a label chamfer feature  <br> To create or edit an instance of this class, use @link Features::LabelChamferBuilder  Features::LabelChamferBuilder @endlink  <br> 
         <br>  Created in NX7.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  LabelChamfer : public Features::BodyFeature
        {
