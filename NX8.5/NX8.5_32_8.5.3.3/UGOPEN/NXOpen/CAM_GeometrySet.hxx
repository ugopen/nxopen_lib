...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a geometry set for a CAM object. Multiple sets define the actual geometry of a specific type.  <br> To create a new instance of this class, use @link CAM::Geometry::CreateGeometrySet  CAM::Geometry::CreateGeometrySet @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  GeometrySet : public TaggedObject
        {
            /** Available types for Ignore Loops 
             <br>  Created in NX8.0.0.  <br>  
            */
            public: enum LoopsIgnoreTypes
            {
            ...
            */
            ...
            /**Returns  the ignore loops status 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::GeometrySet::LoopsIgnoreTypes IgnoreLoopsStatus
            (
            );
            /**Sets  the ignore loops status 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetIgnoreLoopsStatus
            (
            ...
            /**Returns  the ignore holes builder 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CustomLoops * HoleList
            (
            );
