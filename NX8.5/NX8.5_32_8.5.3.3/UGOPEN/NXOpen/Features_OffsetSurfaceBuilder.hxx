...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  OffsetSurfaceBuilder : public Features::FeatureBuilder
        {
            ...
            /** Gets the list of face sets. This list is a simple variable length array of any JA object.
             ...
             <br>  @deprecated Deprecated in NX5.0.0.  Use @link FaceSets FaceSets@endlink  instead. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0.  Use FaceSets instead.") NXOpen::ObjectList * GetFaceSetList
            (
            );
            /** Gets the face sets. A face set is a combination of a face collector and an offset
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0.  Use FaceSets instead.") std::vector<NXOpen::GeometricUtilities::FaceSetOffset *> GetFaceSets
            (
            );
            /** Deletes a face set at the specified index from the face set list
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0.  Use FaceSets instead.") void DeleteFaceSet
            (
            ...
            /** Finds and returns a face set at the specified index from the face set list
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0.  Use FaceSets instead.") NXOpen::GeometricUtilities::FaceSetOffset * FindFaceSet
            (
            ...
            /** Adds face sets to the face set list
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0.  Use FaceSets instead.") void AddFaceSets
            (
