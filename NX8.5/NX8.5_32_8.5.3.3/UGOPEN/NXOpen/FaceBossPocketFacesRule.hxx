...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects all faces of a boss or pocket. 
    ...
    */
    class NXOPENCPPEXPORT  FaceBossPocketFacesRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the boss pocket faces rule: @link  FaceBossPocketFacesRule   FaceBossPocketFacesRule @endlink   @return  Faces which creates this rule
         <br>  Created in NX5.0.0.  <br>  
