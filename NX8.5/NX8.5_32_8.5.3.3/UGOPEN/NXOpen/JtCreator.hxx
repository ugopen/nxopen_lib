...
namespace NXOpen
{
    ...
    class JtCreatorImpl;
    /**
        Represents a @link JtCreator JtCreator@endlink  to be used when exporting the JT Data
        This class is created using @link PvtransManager PvtransManager@endlink .
        NULL object will be returned from Commit()
         <br> To create a new instance of this class, use @link PvtransManager::CreateJtCreator  PvtransManager::CreateJtCreator @endlink  <br> 
     <br>  Created in NX8.5.0.  <br>  
    */
    class NXOPENCPPEXPORT  JtCreator : public Builder
    {
        /** Chordal Option */
        ...
        /** Creates a @link ListCreator ListCreator@endlink  object.  @return  
         <br>  Created in NX8.5.0.  <br>  
         <br> License requirements : None */
