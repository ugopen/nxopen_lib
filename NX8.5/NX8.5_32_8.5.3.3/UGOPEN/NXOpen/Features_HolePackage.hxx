...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a hole package and hole series feature  <br> To create or edit an instance of this class, use @link Features::HolePackageBuilder  Features::HolePackageBuilder @endlink  <br> 
         <br>  Created in NX5.0.2.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  HolePackage : public Features::BodyFeature
        {
