...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  EditSymbolDisplayBuilder : public Builder
        {
            /** The Enum represent font types. @link Annotations::EditSymbolDisplayBuilder::Font Annotations::EditSymbolDisplayBuilder::Font@endlink  and 
                    @link Annotations::EditSymbolDisplayBuilder::SetFont Annotations::EditSymbolDisplayBuilder::SetFont@endlink  will set this font type at builder side and
            ...
            /** The Enum represent width types @link Annotations::EditSymbolDisplayBuilder::Width Annotations::EditSymbolDisplayBuilder::Width@endlink  and 
                    @link Annotations::EditSymbolDisplayBuilder::SetWidth Annotations::EditSymbolDisplayBuilder::SetWidth@endlink  will set this width type at builder side and
                    will be used to apply the same on the selected contents after commit*/
            ...
            (
                const char * sid /** sid of selected component  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
