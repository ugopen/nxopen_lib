...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimPart : public CAE::CaePart
        {
            ...
            protected: SimPart();
            public: ~SimPart();
            /**Returns  the @link CAE::SimSimulation CAE::SimSimulation@endlink  object
             <br>  Created in NX4.0.0.  <br>  
            ...
            (
                const char * fileName /** name of the source simulation file   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * prependString /** string to prepend imported simulation entity names, can be NULL or empty    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXOpen::CAE::SimPart::ImportOptions & selOptions /** options indicating the types of entities to be imported */,
                const std::vector<NXOpen::CAE::FEModelOccurrence *> & selectedFemoccs /** Array of FeModelOccurrences to import onto @link CAE::FEModelOccurrence CAE::FEModelOccurrence@endlink  */
            );
        };
