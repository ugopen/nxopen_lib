...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a point feature  <br> To create or edit an instance of this class, use @link Features::PointFeatureBuilder  Features::PointFeatureBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  PointFeature : public Features::Feature
        {
