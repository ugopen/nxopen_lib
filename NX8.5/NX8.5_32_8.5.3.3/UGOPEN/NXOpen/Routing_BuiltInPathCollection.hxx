...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a collection of @link BuiltInPath BuiltInPath@endlink  objects.  <br> To obtain an instance of this class, refer to @link Routing::RouteManager  Routing::RouteManager @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  BuiltInPathCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Routing::BuiltInPath Routing::BuiltInPath@endlink  object.  @return  
             <br>  Created in NX4.0.0.  <br>  
