...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiAttributeBuilder : public Builder
        {
            ...
            /**Returns  the @link Annotations::AssociatedObjectsBuilder Annotations::AssociatedObjectsBuilder@endlink  for the annotation 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the @link Annotations::Pmi Annotations::Pmi@endlink  for this annotation 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::Pmi * Attribute
            (
            );
            /**Sets  the @link Annotations::Pmi Annotations::Pmi@endlink  for this annotation 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
