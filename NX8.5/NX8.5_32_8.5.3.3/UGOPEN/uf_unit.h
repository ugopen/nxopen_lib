...
This the Open API interface to units specifications used by f.ex. expressions and user attributes.
...
(
    ...
    char ** name           /* <O/F> The unit name of the units (see uf_unit_types.h) */
);
