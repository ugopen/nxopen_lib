...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_oper(
...
pointed at "op_name". This memory must be the same as UF_OPER_OPNAME_LEN+1 bytes.

Environment: Internal  and  External
See Also:
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_name(
UF_OPER_id_t oper_id ,/* <I>
                      Operation identifier
                      */
char  op_name[UF_OPER_OPNAME_LEN+1]  /* <O>
                Pointer to at least UF_OPER_OPNAME_LEN bytes
                */
);
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_path(
UF_OPER_id_t oper_id ,/* <I>
                      Operation identifier
                      */
