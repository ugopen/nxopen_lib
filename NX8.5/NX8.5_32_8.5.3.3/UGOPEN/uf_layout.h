...
int layout_style ,/* <I>
                  ...
                  5 = Six Views
                  */
const char view_names[][UF_OBJ_NAME_LEN+1] ,/* <I>
                             View Names (128 char max)
                             "" = Default Views
                             */
int scale_option ,/* <I>
                  Scale Option
...
const char * new_name  /* <I>
                       Name To Save Layout (30 char max)
                       "" = Use Current Name
                       */
);
...
const char * old_name ,/* <I>
                       Old Layout Name (30 char max)
                       "" = Current Layout
                       */
const char * new_name  /* <I>
                       New Layout Name (30 char max)
                       */
);
