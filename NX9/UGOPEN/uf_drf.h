...
char sbf_name[ UF_CFI_MAX_FILE_NAME_BUFSIZE]  /* <I>
                                        file to be set
                                        */
);
...
char symbol_name[ UF_CFI_MAX_FILE_NAME_BUFSIZE] ,/* <I>
                                           symbol name
                                           */
...
extern UFUNEXPORT void uc5530(int ip1, tag_t np2, int ip3, int ip4, tag_t np5, int ip6,
                   int ip7, char *cp8, int ip9, char cp10[][133]/* <I,len:ip9>*/, double *rp11,
                   tag_t *nr12);
...
extern UFUNEXPORT void uc5531(tag_t np1, tag_t np2, int ip3, int ip4, char *cp5, int ip6,
                   char cp7[][133]/* <I,len:ip6>*/, double *rp8, tag_t *nr9);

/* uc5532 create angular dimension */
extern UFUNEXPORT void uc5532(int ip1, tag_t np2, int ip3, tag_t np4, int ip5, char *cp6,
                   int ip7, char cp8[][133]/* <I,len:ip7>*/, double *rp9, tag_t *nr10);

/* uc5533 create an arc length, radius, diameter, or hole */
extern UFUNEXPORT void uc5533(int ip1, tag_t np2, char *cp3, int ip4, char cp5[][133]/* <I,len:ip4>*/,
                   double *rp6, tag_t *nr7);

/* uc5534 create a concentric circle dimension */
extern UFUNEXPORT void uc5534(tag_t np1, tag_t np2, char *cp3, int ip4, char cp5[][133]/* <I,len:ip4>*/,
                   double *rp6, tag_t *nr7);
...
extern UFUNEXPORT void uc5541(int ip1, char cp2[][133]/* <I,len:ip1>*/, double *rp3, int ip4, tag_t np5,
                   double *rp6, tag_t *nr7);
...
extern UFUNEXPORT void uc5543(int ip1, char cp2[][133]/* <I,len:ip1>*/, double *rp3, int ip4, int ip5,
