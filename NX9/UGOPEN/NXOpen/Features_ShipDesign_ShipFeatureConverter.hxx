        ...
        namespace ShipDesign
        {
            ...
            /**
                    ...
                    conversion of KF Steel Features into non-KF Steel features.
                     <br> To create a new instance of this class, use @link Features::ShipCollection::CreateShipFeatureConverter  Features::ShipCollection::CreateShipFeatureConverter @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ShipFeatureConverter : public Builder
            {
