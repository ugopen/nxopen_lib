...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::HeadImpactAPillarBuilder Features::VehicleDesign::HeadImpactAPillarBuilder@endlink .  <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateHeadImpactApillarBuilder  Features::VehicleDesignCollection::CreateHeadImpactApillarBuilder @endlink  <br> 
             <br>  Created in NX9.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  HeadImpactAPillarBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the A Pillar Geometry builder, which represents a @link Features::VehicleDesign::HeadImpactAPillarWizardBuilder Features::VehicleDesign::HeadImpactAPillarWizardBuilder@endlink . 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::VehicleDesign::HeadImpactAPillarWizardBuilder * Geometry
                (
                );
                /**Returns  the A Pillar Parameters builder, which represents a @link Features::VehicleDesign::HeadImpactAPillarDetailBuilder Features::VehicleDesign::HeadImpactAPillarDetailBuilder@endlink . 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
