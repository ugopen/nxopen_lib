...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::CamProfile Mechatronics::CamProfile@endlink  builder.  <br> To create a new instance of this class, use @link Mechatronics::CamProfileCollection::CreateCamProfileBuilder  Mechatronics::CamProfileCollection::CreateCamProfileBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  CamProfileBuilder : public Builder
        {
