            ...
            */
            class NXOPENCPP_CAEEXPORT  OptionSetting
            {
                ...
                /** Get the options data for an AFU Data Record 
                 <br>  @deprecated Deprecated in NX9.0.0.  Use @link OptionSetting::GetRecordOptionData OptionSetting::GetRecordOptionData@endlink  with Denominator. <br>  

                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : nx_ftk ("NX Advanced Graphing") */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use OptionSetting::GetRecordOptionData with Denominator.") void GetOptionData
                (
                ...
                /** Set the options data for an AFU Data Record 
                 <br>  @deprecated Deprecated in NX9.0.0.  Use @link OptionSetting::SetRecordOptionData OptionSetting::SetRecordOptionData@endlink  with Denominator. <br>  

                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : nx_ftk ("NX Advanced Graphing") */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use OptionSetting::SetRecordOptionData with Denominator.") void SetOptionData
                (
