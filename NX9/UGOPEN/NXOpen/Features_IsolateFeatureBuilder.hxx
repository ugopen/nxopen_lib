...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link Features::IsolateFeature Features::IsolateFeature@endlink  builder  <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateIsolateFeatureBuilder  Features::FeatureCollection::CreateIsolateFeatureBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  IsolateFeatureBuilder : public Features::FeatureBuilder
        {
