...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            class CornerCutImpl;
            /** Represents a corner cut feature  <br> To create or edit an instance of this class, use @link Features::ShipDesign::CornerCutBuilder  Features::ShipDesign::CornerCutBuilder @endlink  <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  CornerCut : public Features::BodyFeature
            {
