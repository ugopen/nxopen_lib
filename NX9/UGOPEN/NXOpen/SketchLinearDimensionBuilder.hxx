...
namespace NXOpen
{
    ...
    /** Represents a @link SketchLinearDimensionBuilder SketchLinearDimensionBuilder@endlink   <br> To create a new instance of this class, use @link SketchCollection::CreateLinearDimensionBuilder  SketchCollection::CreateLinearDimensionBuilder @endlink  <br> 
     <br>  Created in NX9.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SketchLinearDimensionBuilder : public Annotations::BaseLinearDimensionBuilder
    {
