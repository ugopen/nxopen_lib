...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI major angular dimension  <br> To create or edit an instance of this class, use @link Annotations::PmiMajorAngularDimensionBuilder  Annotations::PmiMajorAngularDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiMajorAngularDimension : public Annotations::PmiAngularDimension, public virtual Annotations::IPmi
        {
