...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                Used to create a @link Features::ShipDesign::EditStockBuilder Features::ShipDesign::EditStockBuilder@endlink  which
                is used to change the stock information on the basic design features.
                 <br> To create a new instance of this class, use @link Features::ShipCollection::CreateEditStockBuilder  Features::ShipCollection::CreateEditStockBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  EditStockBuilder : public Features::FeatureBuilder
            {
