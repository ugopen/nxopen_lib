...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  LawExtensionBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the vector. Vector is used only when @link Features::LawExtensionBuilder::Types Features::LawExtensionBuilder::Types@endlink  is  
                        @link Features::LawExtensionBuilder::TypesVector Features::LawExtensionBuilder::TypesVector@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") */
            ...
            /**Returns  the opposite side length law. Opposite side extension law is required only when
                        ...
                        @link Features::LawExtensionBuilder::OppositeSideExtensionOptionsAsymmetric Features::LawExtensionBuilder::OppositeSideExtensionOptionsAsymmetric@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") */
