...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateBridgeCurveBuilderEx  Features::FeatureCollection::CreateBridgeCurveBuilderEx @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  BridgeCurveBuilderEx : public Features::FeatureBuilder
        {
            /** Start object type */
