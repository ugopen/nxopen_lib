...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Orient Group <br> To create or edit an instance of this class, use @link CAM::OrientGeomBuilder  CAM::OrientGeomBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  OrientGeometry : public CAM::NCGroup
        {
