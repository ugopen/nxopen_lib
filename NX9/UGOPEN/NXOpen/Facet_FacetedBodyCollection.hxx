...
namespace NXOpen
{
    ...
    namespace Facet
    {
        ...
        */
        class NXOPENCPP_FACETEXPORT  FacetedBodyCollection : public TaggedObjectCollection
        {
            ...
            /** Create a @link Facet::CurvatureBuilder Facet::CurvatureBuilder@endlink  object.  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Facet::CurvatureBuilder * CreateFacetCurvatureBuilder
            (
            );
            /** Create a @link Facet::FeatureExtractionBuilder Facet::FeatureExtractionBuilder@endlink  object.  @return  
             <br>  Created in NX5.0.0.  <br>  
            ...
            /** Creates a @link Facet::BestFitAlignBuilder Facet::BestFitAlignBuilder@endlink   @return  
            ...
            /** Creates a @link Facet::FillHoleBuilder Facet::FillHoleBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Facet::FillHoleBuilder * CreateFillHoleBuilder
            (
            );
            /** Creates a @link Facet::STLImportBuilder Facet::STLImportBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Facet::STLImportBuilder * CreateSTLImportBuilder
            (
            );
            /** Creates a @link Facet::DecimateFacetBodyBuilder Facet::DecimateFacetBodyBuilder@endlink   @return  
            ...
            /** Creates a @link Facet::MultiPatchAlignmentBuilder Facet::MultiPatchAlignmentBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
            ...
            /** Creates a @link Facet::SubdivideFacetBodyBuilder Facet::SubdivideFacetBodyBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Facet::SubdivideFacetBodyBuilder * CreateSubdivideFacetBodyBuilder
            (
            );
            /** Creates a @link Facet::SmoothFacetBodyBuilder Facet::SmoothFacetBodyBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Facet::SmoothFacetBodyBuilder * CreateSmoothFacetBodyBuilder
            (
            );
            /** Creates a @link Facet::SnipFacetBodyBuilder Facet::SnipFacetBodyBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Facet::SnipFacetBodyBuilder * CreateSnipFacetBodyBuilder
            (
            );
            /** Creates a JT @link Facet::FacetedBody Facet::FacetedBody@endlink  using the default faceting tolerances. 
                        ...
                        See @link Body::GetFacetedBody Body::GetFacetedBody@endlink  for ways to check for this situation.
            ...
            /** Creates a @link Facet::ExtrudeFacetBodyBuilder Facet::ExtrudeFacetBodyBuilder@endlink   @return  
            ...
            /** Creates a @link Facet::ExtrudeProfileBuilder Facet::ExtrudeProfileBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Facet::ExtrudeProfileBuilder * CreateExtrudeProfileBuilder
            (
            );
            /** Creates a @link Facet::MergeFacetBodyBuilder Facet::MergeFacetBodyBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Facet::MergeFacetBodyBuilder * CreateMergeFacetBodyBuilder
            (
            );
            /** Creates a @link Facet::BridgeFacetBodyBuilder Facet::BridgeFacetBodyBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Facet::BridgeFacetBodyBuilder * CreateBridgeFacetBodyBuilder
            (
            );
            /** Creates a @link Facet::SewFacetBodyBuilder Facet::SewFacetBodyBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING") */
