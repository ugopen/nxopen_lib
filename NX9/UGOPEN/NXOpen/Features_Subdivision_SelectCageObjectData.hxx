...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Subdivision
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SelectCageObjectData : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
            {
                ...
                /**Returns  the flag indicating if previously selected objects can be de-selected during selection of new objects. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: bool CanDeselectObjectsAutomatically
                (
                );
                ...
                public: void SetCanDeselectObjectsAutomatically
                (
