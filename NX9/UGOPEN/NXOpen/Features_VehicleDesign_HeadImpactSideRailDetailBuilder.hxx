...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::HeadImpactSideRailDetailBuilder Features::VehicleDesign::HeadImpactSideRailDetailBuilder@endlink .  <br> This is an abstract class and cannot be instantiated.  <br> 
             <br>  Created in NX9.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  HeadImpactSideRailDetailBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
            {
                ...
                /**Returns  the left SR2 alternative point flag. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: bool SR2LeftFlag
                (
                );
                /**Sets  the left SR2 alternative point flag. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetSR2LeftFlag
                (
                ...
                /**Returns  the left SR2 alternative point. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Point * SR2Left
                (
                );
                /**Sets  the left SR2 alternative point. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetSR2Left
                (
                ...
                /**Returns  the right SR2 alternative point flag. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: bool SR2RightFlag
                (
                );
                /**Sets  the right SR2 alternative point flag. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetSR2RightFlag
                (
                ...
                /**Returns  the right SR2 alternative point. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Point * SR2Right
                (
                );
                /**Sets  the right SR2 alternative point. 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetSR2Right
                (
