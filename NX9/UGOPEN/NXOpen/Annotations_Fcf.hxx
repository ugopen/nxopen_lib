...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _FcfBuilder;
        class FcfImpl;
        /** Represents an FCF  <br> To create or edit an instance of this class, use @link Annotations::PmiFeatureControlFrameBuilder  Annotations::PmiFeatureControlFrameBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  Fcf : public Annotations::BaseFcf, public virtual Annotations::IPmi, public virtual Annotations::IAppendedText
        {
