...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DraftingNoteBuilder : public Builder
        {
            ...
            /**Sets  the vertical text for text 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") OR cam_base ("CAM BASE") */
