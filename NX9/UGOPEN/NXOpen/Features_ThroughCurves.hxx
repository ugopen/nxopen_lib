...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Through Curves feature.  <br> To create or edit an instance of this class, use @link Features::ThroughCurvesBuilder  Features::ThroughCurvesBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  ThroughCurves : public Features::BodyFeature
        {
