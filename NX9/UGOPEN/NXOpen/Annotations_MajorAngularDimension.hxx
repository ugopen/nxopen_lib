...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a major angular dimension  <br> To create or edit an instance of this class, use @link Annotations::MajorAngularDimensionBuilder  Annotations::MajorAngularDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  MajorAngularDimension : public Annotations::AngularDimension, public virtual Annotations::IPmi
        {
