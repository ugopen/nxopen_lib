...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        namespace ProductInterface
        {
            ...
            */
            class NXOPENCPP_ASSEMBLIESEXPORT  InterfaceObject : public NXObject
            {
                ...
                (
                    const char * userComments /** user comments to be set on the product interface object   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    const NXString & name /** user defined name to be set on the product interface object */
                );
                /** Renames an object from the product interface set 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                ...
                (
                    const char * name /** user defined name to be set on the product interface object */
                );
            };
        }
    }
