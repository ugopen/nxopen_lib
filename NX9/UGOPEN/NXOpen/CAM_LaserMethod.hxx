...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Laser Method  <br> To create a new instance of this class, use @link CAM::NCGroupCollection::CreateLaserMethod  CAM::NCGroupCollection::CreateLaserMethod @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  LaserMethod : public CAM::MethodBuilder
        {
