...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Stamping Die LS-Dyna integration draw geometry preprare builder. <br> To create a new instance of this class, use @link Tooling::AutoDieCollection::CreateLsdynaGeometryPreparationBuilder  Tooling::AutoDieCollection::CreateLsdynaGeometryPreparationBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  LsdynaGeometryPreparationBuilder : public Builder
        {
