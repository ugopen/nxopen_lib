...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SketchAlongPathBuilder : public Builder
    {
        ...
        /**Returns  the sketch orientation method as @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::SketchAlongPathBuilder::SketchOrientationType SketchOrient
        (
        );
        /**Sets  the sketch orientation method as @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /**Returns  the flag to create all datum axes for path having shared edge. This option is applicable only when 
                @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink  is @link SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace@endlink 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
