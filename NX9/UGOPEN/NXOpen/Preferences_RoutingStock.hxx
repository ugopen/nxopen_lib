    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  RoutingStock
        {
            ...
            /**Returns  the @link Routing::Anchor Routing::Anchor@endlink  name associated with the stock preferences. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXString StockAnchor
            (
            );
            /**Sets  the @link Routing::Anchor Routing::Anchor@endlink  name associated with the stock preferences. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
