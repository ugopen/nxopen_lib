...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI line weld  <br> To create or edit an instance of this class, use @link Annotations::PmiLineWeldBuilder  Annotations::PmiLineWeldBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiLineWeld : public Annotations::LineWeld, public virtual Annotations::IPmi
        {
