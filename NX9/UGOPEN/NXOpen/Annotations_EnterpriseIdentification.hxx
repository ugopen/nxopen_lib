...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a Enterprise Identification  <br> To create or edit an instance of this class, use @link Annotations::EnterpriseIdentificationBuilder  Annotations::EnterpriseIdentificationBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  EnterpriseIdentification : public Annotations::PmiAttribute
        {
