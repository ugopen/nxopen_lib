...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                    Represents a @link Features::VehicleDesign::StaticCurb Features::VehicleDesign::StaticCurb@endlink  builder
                    used to create or edit static curb feature
                     <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateStaticCurbBuilder  Features::VehicleDesignCollection::CreateStaticCurbBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  StaticCurbBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  
                            ...
                            See @link Features::VehicleDesign::StaticCurbBuilder::VisualizationType Features::VehicleDesign::StaticCurbBuilder::VisualizationType@endlink  for valid values. 
