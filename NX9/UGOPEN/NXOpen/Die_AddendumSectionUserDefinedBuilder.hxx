...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  AddendumSectionUserDefinedBuilder : public Builder
        {
            ...
            /** Creates user defined addendum section based upon input to @link Die::AddendumSectionUserDefinedBuilder::Section Die::AddendumSectionUserDefinedBuilder::Section@endlink .  @return  user defined section curve 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
