...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /** 
             ...
             <br> To create a new instance of this class, use @link Part::CreateEmptyTransitionCurveBuilder  Part::CreateEmptyTransitionCurveBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  TransitionCurveBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
