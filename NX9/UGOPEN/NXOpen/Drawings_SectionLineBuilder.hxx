...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  SectionLineBuilder : public Builder
        {
            /**  Section Line type */
            public: enum Types
            {
            ...
            /**Returns  the arrow direction.  The arrow direction defines the direction of
                        ...
                        @link Drawings::SectionLineBuilder::TypesOriented Drawings::SectionLineBuilder::TypesOriented@endlink  section lines 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
