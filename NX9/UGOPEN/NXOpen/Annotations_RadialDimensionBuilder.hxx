...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::Dimension Annotations::Dimension@endlink  builder  <br> To create a new instance of this class, use @link Annotations::DimensionCollection::CreateRadialDimensionBuilder  Annotations::DimensionCollection::CreateRadialDimensionBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  RadialDimensionBuilder : public Annotations::BaseRadialDimensionBuilder
        {
