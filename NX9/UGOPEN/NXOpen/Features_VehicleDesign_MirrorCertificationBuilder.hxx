...
#include <NXOpen/Features_VehicleDesign_MirrorCertificationBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                     A @link Features::VehicleDesign::MirrorCertificationBuilder Features::VehicleDesign::MirrorCertificationBuilder@endlink  used to create or edit
                    a vehicle design @link Features::VehicleDesign::MirrorCertification Features::VehicleDesign::MirrorCertification@endlink  feature.
                     <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateMirrorCertificationBuilder  Features::VehicleDesignCollection::CreateMirrorCertificationBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  MirrorCertificationBuilder : public Features::FeatureBuilder
            {
