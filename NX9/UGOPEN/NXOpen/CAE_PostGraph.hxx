...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostGraph : public NXObject
        {
            private: PostGraphImpl * m_postgraph_impl;
            private: friend class  _PostGraphBuilder;
            protected: PostGraph();
            public: ~PostGraph();
            /** Plot the graph in as XY plot in given view port  @return  @link CAE::Xyplot::Plot CAE::Xyplot::Plot@endlink  object 
             <br>  Created in NX9.0.0.  <br>  
            ...
            (
                const NXString & filename /** Afu file name with full Path   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Copy the graph's records to AFU file 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            void Copyrecords
            (
                const char * filename /** Afu file name with full Path   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Edit the @link CAE::PostGraph CAE::PostGraph@endlink  objet parameters 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
