...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ProjectCurveBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the curve fit join method 
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link Features::ProjectCurveBuilder::CurveFitData Features::ProjectCurveBuilder::CurveFitData@endlink  instead <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Features::ProjectCurveBuilder::CurveFitData instead") NXOpen::GeometricUtilities::CurveFitJoin * CurveFitJoinData
            (
            );
