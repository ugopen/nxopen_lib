...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link Features::PartGeometryCopySelectBuilder Features::PartGeometryCopySelectBuilder@endlink  builder 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  PartGeometryCopySelectBuilder : public TaggedObject
        {
