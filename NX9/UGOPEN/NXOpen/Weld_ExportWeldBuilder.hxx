...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  ExportWeldBuilder : public Builder
        {
            ...
            /**Returns  the option defining where to write the output data. Data will be written to either a comma seperated value file or the output window. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Weld::ExportWeldBuilder::OutputType Output
            (
            );
            /**Sets  the option defining where to write the output data. Data will be written to either a comma seperated value file or the output window. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
