...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  NX_DEPRECATED("Deprecated in NX9.0.0.  Use PartFamily::InstanceDefinition and PartFamily::TemplateManager instead.")  PartFamilyMemberData : public TransientObject
    {
