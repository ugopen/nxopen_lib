...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::SCOUTExportBuilder Mechatronics::SCOUTExportBuilder@endlink   <br> To create a new instance of this class, use @link Mechatronics::PhysicsManager::CreateSCOUTExportBuilder  Mechatronics::PhysicsManager::CreateSCOUTExportBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SCOUTExportBuilder : public Builder
        {
