...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ElectricalNavigatorFilterCollection : public TaggedObjectCollection
            {
                ...
                /** Creates a @link Routing::Electrical::ElectricalNavigatorFilter Routing::Electrical::ElectricalNavigatorFilter@endlink  object.  @return  
                 <br>  Created in NX5.0.1.  <br>  
                ...
                (
                    const char * name /** Name of the filter   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    const char * clause /** Clause of the filter   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
