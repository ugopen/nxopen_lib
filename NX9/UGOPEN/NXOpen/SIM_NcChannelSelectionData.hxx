...
namespace NXOpen
{
    ...
    namespace SIM
    {
        ...
        /**  @brief  Represents the NcChannelSelectionData class object  
            ...
            <br> Use the @link NcChannelSelectionData NcChannelSelectionData@endlink  class to create a NcChannelSelectionData object.  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_SIMEXPORT  NcChannelSelectionData : public NXObject
        {
            ...
            (
                ...
                const NXString & file /** The file to be assigned   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Assign a file to a channel using the channel number. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            (
                int channel /** The channel number */,
                const char * file /** The file to be assigned   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            public: void AssignFile
            (
                const NXString & channel /** The channel name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & file /** The file to be assigned   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Assign a file to a channel using the channel name. 
             <br>  Created in NX9.0.0.  <br>  
            ...
            void AssignFile
            (
                const char * channel /** The channel name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * file /** The file to be assigned   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
        };
    }
