    ...
    namespace CAE
    {
        namespace Xyplot
        {
            ...
            /** Manages the separate graphic windows. The value of device index is greater than 0.
                        ...
                        If run from a non-interactive session it will return NULL.  <br> To obtain an instance of this class use @link CAE::Xyplot::XYPlotManager::WindowManager CAE::Xyplot::XYPlotManager::WindowManager@endlink .  <br> 
