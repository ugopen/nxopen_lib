...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a @link CompareRunsBuilder CompareRunsBuilder@endlink , used to compare runs in the work 
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  CompareRunsBuilder : public Builder
        {
