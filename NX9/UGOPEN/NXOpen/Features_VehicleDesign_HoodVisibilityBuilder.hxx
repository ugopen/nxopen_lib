...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                    Represents a @link Features::VehicleDesign::HoodVisibility Features::VehicleDesign::HoodVisibility@endlink  builder
                     <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateHoodVisibilityBuilder  Features::VehicleDesignCollection::CreateHoodVisibilityBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  HoodVisibilityBuilder : public Features::FeatureBuilder
            {
