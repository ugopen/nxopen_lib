...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PackagingMeasureBuilder : public Motion::PackagingBuilder
        {
            /** Measure type */
            ...
            /**Returns  the Measure type defined at @link  Motion::PackagingMeasureBuilder::MeasureType   Motion::PackagingMeasureBuilder::MeasureType @endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::PackagingMeasureBuilder::MeasureType MsType
            (
            );
            /**Sets  the Measure type defined at @link  Motion::PackagingMeasureBuilder::MeasureType   Motion::PackagingMeasureBuilder::MeasureType @endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the measure condition defined at @link  Motion::PackagingMeasureBuilder::MeasureCondition   Motion::PackagingMeasureBuilder::MeasureCondition @endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::PackagingMeasureBuilder::MeasureCondition Condition
            (
            );
            /**Sets  the measure condition defined at @link  Motion::PackagingMeasureBuilder::MeasureCondition   Motion::PackagingMeasureBuilder::MeasureCondition @endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the Measure threshold value 
             <br>  @deprecated Deprecated in NX8.0.0.  Obtain the expression using @link Motion::PackagingMeasureBuilder::ThresholdExpression Motion::PackagingMeasureBuilder::ThresholdExpression@endlink  or @link Motion::PackagingMeasureBuilder::ThresholdAngleExpression Motion::PackagingMeasureBuilder::ThresholdAngleExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Obtain the expression using Motion::PackagingMeasureBuilder::ThresholdExpression or Motion::PackagingMeasureBuilder::ThresholdAngleExpression to query or edit it.") double Threshold
            (
            );
            /**Sets  the Measure threshold value 
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Obtain the expression using Motion::PackagingMeasureBuilder::ThresholdExpression or Motion::PackagingMeasureBuilder::ThresholdAngleExpression to query or edit it.") void SetThreshold
            (
                double threshold /** threshold */ 
            );
            /**Returns  the Measure tolerance value 
             <br>  @deprecated Deprecated in NX8.0.0.  Obtain the expression using @link Motion::PackagingMeasureBuilder::ToleranceExpression Motion::PackagingMeasureBuilder::ToleranceExpression@endlink  or @link Motion::PackagingMeasureBuilder::ToleranceAngleExpression Motion::PackagingMeasureBuilder::ToleranceAngleExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Obtain the expression using Motion::PackagingMeasureBuilder::ToleranceExpression or Motion::PackagingMeasureBuilder::ToleranceAngleExpression to query or edit it.") double Tolerance
            (
            );
            /**Sets  the Measure tolerance value 
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Obtain the expression using Motion::PackagingMeasureBuilder::ToleranceExpression or Motion::PackagingMeasureBuilder::ToleranceAngleExpression to query or edit it.") void SetTolerance
            (
                double tolerance /** tolerance */ 
            );
            /**Returns  the Stop_On_Event flag of @link  Motion::PackagingMeasure   Motion::PackagingMeasure @endlink  object 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool StopOnEvent
            (
            );
            /**Sets  the Stop_On_Event flag of @link  Motion::PackagingMeasure   Motion::PackagingMeasure @endlink  object 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
