...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Revolved Section Line is used to create section views which are
                ...
                are revolved into a common plane for the Revolved Section View.  <br> To create or edit an instance of this class, use @link Drawings::SectionLineBuilder  Drawings::SectionLineBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  RevolvedSectionLine : public Drawings::SectionLine
        {
