...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::HeadImpactOPillarBuilder Features::VehicleDesign::HeadImpactOPillarBuilder@endlink .  <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateHeadImpactOpillarBuilder  Features::VehicleDesignCollection::CreateHeadImpactOpillarBuilder @endlink  <br> 
             <br>  Created in NX9.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  HeadImpactOPillarBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the Additional Pillar Geometry builder, which represents a @link Features::VehicleDesign::HeadImpactOPillarWizardBuilder Features::VehicleDesign::HeadImpactOPillarWizardBuilder@endlink . 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::VehicleDesign::HeadImpactOPillarWizardBuilder * Geometry
                (
                );
                /**Returns  the Additional Pillar Parameters builder, which represents a @link Features::VehicleDesign::HeadImpactOPillarDetailBuilder Features::VehicleDesign::HeadImpactOPillarDetailBuilder@endlink . 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
