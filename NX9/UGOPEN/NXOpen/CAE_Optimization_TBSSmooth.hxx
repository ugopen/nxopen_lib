...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            class TBSSmoothImpl;
            /** Represents the parameters that control the generation of surfaces by optimization  <br> To create or edit an instance of this class, use @link CAE::Optimization::TBSSmoothBuilder  CAE::Optimization::TBSSmoothBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  TBSSmooth : public NXObject
            {
