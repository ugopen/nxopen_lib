...
namespace NXOpen
{
    ...
    namespace Facet
    {
        ...
        /**
            Represents a @link Facet::ExtrudeProfileBuilder Facet::ExtrudeProfileBuilder@endlink 
            ...
            by direction and distance. It returns the extruded NX Facet Body.
             <br> To create a new instance of this class, use @link Facet::FacetedBodyCollection::CreateExtrudeProfileBuilder  Facet::FacetedBodyCollection::CreateExtrudeProfileBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_FACETEXPORT  ExtrudeProfileBuilder : public Builder
        {
