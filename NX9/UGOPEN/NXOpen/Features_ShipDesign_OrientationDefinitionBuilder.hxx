    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /** This class defines the top level object for use in definining the orientation
                    ...
                    for each region.  <br> To create a new instance of this class, use @link Features::ShipCollection::CreateOrientationDefinitionBuilder  Features::ShipCollection::CreateOrientationDefinitionBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  OrientationDefinitionBuilder : public Builder
            {
