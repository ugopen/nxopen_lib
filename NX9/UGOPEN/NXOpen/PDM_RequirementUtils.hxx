    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  RequirementUtils
        {
            ...
            /** Creates Trace Links from @link Validate::Requirement Validate::Requirement@endlink s to @link Part Part@endlink s 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void CreateTraceLinks
            (
                std::vector<NXString> & requirementItemNumbers /** requirement item numbers */,
            ...
            /** Removes Trace Links between @link Validate::Requirement Validate::Requirement@endlink s and @link Part Part@endlink s 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
