...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DraftingSurfaceFinishBuilder : public Annotations::BaseSurfaceFinishBuilder
        {
            ...
            /**Returns  the parantheses. This method is deprecated. 
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link Annotations::DraftingSurfaceFinishBuilder::Parentheses Annotations::DraftingSurfaceFinishBuilder::Parentheses @endlink and @link Annotations::DraftingSurfaceFinishBuilder::SetParentheses Annotations::DraftingSurfaceFinishBuilder::SetParentheses @endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Annotations::DraftingSurfaceFinishBuilder::Parentheses Annotations::DraftingSurfaceFinishBuilder::Parentheses @endlink and @link Annotations::DraftingSurfaceFinishBuilder::SetParentheses Annotations::DraftingSurfaceFinishBuilder::SetParentheses @endlink  instead.") NXOpen::Annotations::BaseSurfaceFinishBuilder::ParanthesesType Parantheses
            (
            );
