...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Represents a drawing sheet.
            ...
            as these are not required when creating a sheet with a template.  <br> To create or edit an instance of this class, use @link Drawings::DrawingSheetBuilder  Drawings::DrawingSheetBuilder @endlink  <br> 
         <br>  Created in NX3.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  DrawingSheet : public NXObject
        {
            ...
            /** Returns the @link Drawings::DraftingView Drawings::DraftingView@endlink s on a sheet.  @return  
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Drawings::DraftingView *> GetDraftingViews
            (
            );
            /**Returns  the @link View View@endlink  that represents this drawing sheet. 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::View * View
            (
            );
            /**Returns  the status on whether this @link Drawings::DrawingSheet Drawings::DrawingSheet@endlink  is out of date. 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the units of the drawing sheet. To change the units of drawing sheet, use 
                        @link Drawings::DrawingSheet::SetParameters Drawings::DrawingSheet::SetParameters@endlink  
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
