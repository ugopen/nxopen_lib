...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a offset surface feature.  <br> To create or edit an instance of this class, use @link Features::OffsetSurfaceBuilder  Features::OffsetSurfaceBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  OffsetSurface : public Features::BodyFeature
        {
