...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  EdgeSticherBuilder : public Builder
        {
            ...
            /**Returns  the target edge selection for stitch edge when type is @link CAE::EdgeSticherBuilder::TypesManualEdgeToEdge CAE::EdgeSticherBuilder::TypesManualEdgeToEdge@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::SelectCAEEdgeList * TargetEdgeSelection
            (
            );
            /**Returns  the target face selection for stitch edge when type is @link CAE::EdgeSticherBuilder::TypesManualEdgeToFace CAE::EdgeSticherBuilder::TypesManualEdgeToFace@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
