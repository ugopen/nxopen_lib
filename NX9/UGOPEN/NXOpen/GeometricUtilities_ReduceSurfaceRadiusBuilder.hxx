...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /** Reduce Surface Radius Builder of Geometric Utilities. This builder's Commit can produce more than one object, 
                the GetCommittedObjects can be used to get the objects.  <br> To create a new instance of this class, use @link GeometricUtilities::CAMDataPrepManager::CreateReduceSurfaceRadiusBuilder  GeometricUtilities::CAMDataPrepManager::CreateReduceSurfaceRadiusBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  ReduceSurfaceRadiusBuilder : public Builder
        {
