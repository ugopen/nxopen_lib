...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::Dimension Annotations::Dimension@endlink  builder  <br> To create a new instance of this class, use @link Annotations::DimensionCollection::CreateLinearDimensionBuilder  Annotations::DimensionCollection::CreateLinearDimensionBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LinearDimensionBuilder : public Annotations::BaseLinearDimensionBuilder
        {
