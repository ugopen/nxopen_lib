...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a pattern geometry feature  <br> To create or edit an instance of this class, use @link Features::PatternGeometryBuilder  Features::PatternGeometryBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  PatternGeometry : public Features::Feature, public virtual Features::IContainerFeature
        {
