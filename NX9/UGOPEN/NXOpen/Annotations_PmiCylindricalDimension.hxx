...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI cylindrical dimension  <br> To create or edit an instance of this class, use @link Annotations::PmiLinearDimensionBuilder  Annotations::PmiLinearDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiCylindricalDimension : public Annotations::BaseCylindricalDimension
        {
