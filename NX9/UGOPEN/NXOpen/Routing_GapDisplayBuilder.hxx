...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Builder for creating a gap arc object on a line segment.  <br> To create a new instance of this class, use @link Routing::RouteManager::CreateGapDisplayBuilder  Routing::RouteManager::CreateGapDisplayBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  GapDisplayBuilder : public Builder
        {
