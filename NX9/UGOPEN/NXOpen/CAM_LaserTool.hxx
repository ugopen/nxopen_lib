...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class LaserToolImpl;
        /** Represents a Laser Tool  <br> To create a new instance of this class, use @link CAM::NCGroupCollection::CreateLaserTool  CAM::NCGroupCollection::CreateLaserTool @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  LaserTool : public CAM::SoftTool
        {
