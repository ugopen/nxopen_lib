...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /**Represents a @link Features::ColorFeatureBuilder Features::ColorFeatureBuilder@endlink 
            Represents a color feature builder. The color feature does not
            create a feature, but assists user to assign color to selected features. <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateColorFeatureBuilder  Features::FeatureCollection::CreateColorFeatureBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ColorFeatureBuilder : public Builder
        {
            ...
            /**Returns  the specified color option. If the option is @link Features::ColorFeatureBuilder::OperationTypeSpecifyColor Features::ColorFeatureBuilder::OperationTypeSpecifyColor@endlink ,
                      assign valid color to feature. If the returned value is @link Features::ColorFeatureBuilder::OperationTypeNoColor Features::ColorFeatureBuilder::OperationTypeNoColor@endlink , remove color from feature
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ColorFeatureBuilder::OperationType SpecifyColor
            (
            );
            /**Sets  the specified color option. If the option is @link Features::ColorFeatureBuilder::OperationTypeSpecifyColor Features::ColorFeatureBuilder::OperationTypeSpecifyColor@endlink ,
                      assign valid color to feature. If the returned value is @link Features::ColorFeatureBuilder::OperationTypeNoColor Features::ColorFeatureBuilder::OperationTypeNoColor@endlink , remove color from feature
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
