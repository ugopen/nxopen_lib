        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  Partition : public NXObject
        {
            ...
            /** 
                        ...
                        loaded children. If immediate child partitions are not loaded then call @link JA_PARTITION_LoadImmediateChildPartitions JA_PARTITION_LoadImmediateChildPartitions@endlink 
                        to load them.
