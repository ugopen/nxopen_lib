...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  EffectivityTableBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /** Creates new effectivity row in @link PDM::EffectivityTableBuilder PDM::EffectivityTableBuilder@endlink  object  @return  newly created empty effectivity row 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
            public: NXOpen::PDM::EffectivityTableRow * CreateNewEffectivityRow
            (
            );
            /** Adds the given effectivity row to @link PDM::EffectivityTableBuilder PDM::EffectivityTableBuilder@endlink  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
            ...
            /** Removes the given effectivity rows from @link PDM::EffectivityTableBuilder PDM::EffectivityTableBuilder@endlink  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
            ...
            /** Updates this builder with new @link CollaborativeDesign CollaborativeDesign@endlink , validation basis formula and effectivity formulae to edit.
