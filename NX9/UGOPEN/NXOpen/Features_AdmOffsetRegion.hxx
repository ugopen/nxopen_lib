...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a linear dimension feature  <br> To create or edit an instance of this class, use @link Features::AdmOffsetRegionBuilder  Features::AdmOffsetRegionBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  AdmOffsetRegion : public Features::BodyFeature
        {
