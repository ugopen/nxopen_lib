...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::ExternalConnectionElementBuilder Mechatronics::ExternalConnectionElementBuilder@endlink  builder  <br> To create a new instance of this class, use @link Mechatronics::ExternalConnectionCollection::CreateExternalConnectionElementBuilder  Mechatronics::ExternalConnectionCollection::CreateExternalConnectionElementBuilder @endlink  <br> 
         <br>  Created in NX8.0.1.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ExternalConnectionElementBuilder : public Builder
        {
            /** the data type. */
