    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  LaminateGlobalLayupMgr
        {
            ...
            /** Creates a @link CAE::GlobalLayupImportFromPptBuilder CAE::GlobalLayupImportFromPptBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /** Creates a @link CAE::LaminateLayupOffsetBuilder CAE::LaminateLayupOffsetBuilder@endlink   @return  
            ...
            /** Creates a @link CAE::LaminateMatOrientationBuilder CAE::LaminateMatOrientationBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates a @link CAE::ViewLaminateBuilder CAE::ViewLaminateBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates a @link CAE::FlatPatternsBuilder CAE::FlatPatternsBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates a @link CAE::LaminateExtrudeSetupBuilder CAE::LaminateExtrudeSetupBuilder@endlink   @return  created builder 
            ...
            /** Creates a @link CAE::LaminateFillSetupBuilder CAE::LaminateFillSetupBuilder@endlink   @return  created builder 
            ...
            /** Creates a @link CAE::LaminateImportedLayupBuilder CAE::LaminateImportedLayupBuilder@endlink   @return  created builder 
             <br>  Created in NX6.0.4.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates a @link CAE::LaminateSelectEntitiesBuilder CAE::LaminateSelectEntitiesBuilder@endlink   @return  created builder 
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateSelectEntitiesBuilder * CreateLaminateSelectEntitiesBuilder
            (
            );
            /** For each zone of each @link CAE::Laminate CAE::Laminate@endlink  in the model, create an element group 
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void ExportZonesAsGroups
            (
            );
            /** For each zone of each @link CAE::Laminate CAE::Laminate@endlink  in the model, create an equivalent laminate physical property 
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void ExportZonesAsLaminates
            (
            );
            /** For each @link CAE::LaminateGlobalLayup CAE::LaminateGlobalLayup@endlink  in the model, create a group with the draping domain entities 
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
