...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  DraftingManager
    {
        ...
        /** Creates a @link Drawings::MarkAsTemplateBuilder Drawings::MarkAsTemplateBuilder@endlink  @return  
        ...
        */
        ...
        /** Returns the @link Drafting::AutomationManager Drafting::AutomationManager@endlink  belonging to this session 
         <br>  Created in NX8.0.0.  <br>  
        */
