...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /**
            Represents a @link Drawings::ViewLabelBuilder Drawings::ViewLabelBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewLabelBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
