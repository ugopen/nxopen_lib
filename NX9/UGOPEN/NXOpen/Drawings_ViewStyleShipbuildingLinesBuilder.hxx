...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Represents the Shipbuilding LINES tab on the View Style Dialog (Drawings.ViewStyleShipbuildingLinesBuilder)
             <br> To create a new instance of this class, use @link Drawings::DraftingViewCollection::CreateShipbuildingLineBuilder  Drawings::DraftingViewCollection::CreateShipbuildingLineBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewStyleShipbuildingLinesBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
