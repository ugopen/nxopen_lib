...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                Represents a builder that is used to edit or create a @link Features::VehicleDesign::TireEnvelope Features::VehicleDesign::TireEnvelope@endlink .
                 <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateTireEnvelopeBuilder  Features::VehicleDesignCollection::CreateTireEnvelopeBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  TireEnvelopeBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the expression containing the offset value of the front section(at 0 degrees). 
                            Only used when the offset method is @link Features::VehicleDesign::TireEnvelopeBuilder::EnvelopeOffsetMethodFixedSections Features::VehicleDesign::TireEnvelopeBuilder::EnvelopeOffsetMethodFixedSections@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : None */
                ...
                /** Set the sketch containing the tire profiles by the given part name and sketch name. 
                            Only used when the tire profile option is @link Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /**Returns  the name of the tire profile in the tire file.
                            Only used when the tire profile option is @link Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionProfilePointFile Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionProfilePointFile@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /**Returns  the name of the scenario model containing the suspension template. 
                            Only used when the motion method option is @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Read the spindle data and write the data into the motion file. 
                            Only used when the motion method option is @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodFromSpindleLines Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodFromSpindleLines@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Read the file containing the suspension template points.
                            Only used when the motion method option is @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodSuspensionTemplate Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodSuspensionTemplate@endlink .  @return  the missing point name 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Change the location of a joint in the suspension template.
                            Only used when the motion method option is @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodSuspensionTemplate Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodSuspensionTemplate@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Open the motion simulation and build the motion template. 
                            Only used when the motion method option is  is @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel@endlink  
                            or @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Run the motion articulation, output the motion file and then exit the motion simulation.
                            Only used when the motion method option is @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel@endlink  
                            or @link Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel Features::VehicleDesign::TireEnvelopeBuilder::MotionMethodExistingScenarioMotionModel@endlink .                      
                            It must be paired with a call to @link Features::VehicleDesign::TireEnvelopeBuilder::BuildMotionTemplate Features::VehicleDesign::TireEnvelopeBuilder::BuildMotionTemplate@endlink .
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Indicate the sections that should be offset. 
                            Only used when the motion method option is @link Features::VehicleDesign::TireEnvelopeBuilder::EnvelopeOffsetMethodCustomerDefinedData Features::VehicleDesign::TireEnvelopeBuilder::EnvelopeOffsetMethodCustomerDefinedData@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Update the tire body feature in the tire body output part file.
                            ...
                            Only used when the tire profile option is @link Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionProfileCurves Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionProfileCurves@endlink  
                             or @link Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionSketchfromOtherPart@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /** Re-assemble the part containing the tire body defining tire profile to work part as the moving component
                             ...
                             Only used when the tire profile option is @link Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionSolidBody Features::VehicleDesign::TireEnvelopeBuilder::TireDefinitionOptionSolidBody@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
