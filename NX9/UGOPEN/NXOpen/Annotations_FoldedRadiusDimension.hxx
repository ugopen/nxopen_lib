...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a folded radius dimension  <br> To create or edit an instance of this class, use @link Annotations::RadialDimensionBuilder  Annotations::RadialDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  FoldedRadiusDimension : public Annotations::BaseFoldedRadiusDimension
        {
