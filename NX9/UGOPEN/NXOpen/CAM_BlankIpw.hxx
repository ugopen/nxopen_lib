...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class BlankIpwImpl;
        /** Represents the blank ipw builder for blank definition  <br> To obtain an instance of this class use the @link CAM::GeometryGroup CAM::GeometryGroup@endlink   <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  BlankIpw : public TaggedObject
        {
            ...
            (
                const NXString & sourcePartName /** the part name where the blank IPW source exists   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & sourceName /** the name of the blank IPW source   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Set the blank ipw source 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetSource
            (
                const char * sourcePartName /** the part name where the blank IPW source exists   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * sourceName /** the name of the blank IPW source   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
