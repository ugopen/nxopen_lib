...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** 
             Represents a @link Drawings::ViewSectionLineBuilder Drawings::ViewSectionLineBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewSectionLineBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
