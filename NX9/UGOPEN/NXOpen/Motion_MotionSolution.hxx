    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSolution : public NXObject
        {
            ...
            /** Get @link Motion::AnimationControl Motion::AnimationControl@endlink  object, must be called before any other animation control operation, and 
                    the finish API must be call if not use anymore  @return  The @link Motion::AnimationControl Motion::AnimationControl@endlink  object 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::AnimationControl * GetAnimationControl
            (
            );
            /** Get @link Motion::ArticulationControl Motion::ArticulationControl@endlink  object, must be called before any other articulation control operation, and 
                    the finish API must be call if not use anymore  @return  The @link Motion::ArticulationControl Motion::ArticulationControl@endlink  object 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::ArticulationControl * GetArticulationControl
            (
            );
            /** Get @link Motion::SpreadsheetRunControl Motion::SpreadsheetRunControl@endlink  object, must be called before any other spreadsheet run control operation, and 
                    the finish API must be call if not use anymore  @return  The @link Motion::SpreadsheetRunControl Motion::SpreadsheetRunControl@endlink  object 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /** Get @link Motion::LoadTransferControl Motion::LoadTransferControl@endlink  object, must be called before any other load transfer control operation.
                    @link Motion::LoadTransferControl::Finish Motion::LoadTransferControl::Finish@endlink  must be called after use is over.  @return  The @link Motion::LoadTransferControl Motion::LoadTransferControl@endlink  object 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
