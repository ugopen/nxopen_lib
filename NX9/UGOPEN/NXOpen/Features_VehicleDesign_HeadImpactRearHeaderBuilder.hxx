...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::HeadImpactRearHeaderBuilder Features::VehicleDesign::HeadImpactRearHeaderBuilder@endlink .  <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateHeadImpactRearHeaderBuilder  Features::VehicleDesignCollection::CreateHeadImpactRearHeaderBuilder @endlink  <br> 
             <br>  Created in NX9.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  HeadImpactRearHeaderBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the Rear Header Geometry builder, which represents a @link Features::VehicleDesign::HeadImpactRearHeaderWizardBuilder Features::VehicleDesign::HeadImpactRearHeaderWizardBuilder@endlink . 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::VehicleDesign::HeadImpactRearHeaderWizardBuilder * Geometry
                (
                );
                /**Returns  the Rear Header Parameters builder, which represents a @link Features::VehicleDesign::HeadImpactRearHeaderDetailBuilder Features::VehicleDesign::HeadImpactRearHeaderDetailBuilder@endlink . 
                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
