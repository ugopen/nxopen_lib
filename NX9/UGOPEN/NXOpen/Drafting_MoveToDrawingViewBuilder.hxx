...
namespace NXOpen
{
    ...
    namespace Drafting
    {
        ...
        /** This builder allows the user to extract contents from a sheet and transfer them to a new Drawing
              ...
              <br> To create a new instance of this class, use @link Drafting::DraftingApplicationManager::CreateMoveToDrawingViewBuilder  Drafting::DraftingApplicationManager::CreateMoveToDrawingViewBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_DRAFTINGEXPORT  MoveToDrawingViewBuilder : public Builder
        {
