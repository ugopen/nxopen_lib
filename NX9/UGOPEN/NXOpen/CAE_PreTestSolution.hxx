...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a pre-test setup  <br> To create or edit an instance of this class, use @link CAE::PreTestSolutionBuilder  CAE::PreTestSolutionBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  PreTestSolution : public NXObject
        {
