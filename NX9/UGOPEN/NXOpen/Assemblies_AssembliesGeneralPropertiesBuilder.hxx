...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /**
            Represents an @link Assemblies::AssembliesGeneralPropertiesBuilder Assemblies::AssembliesGeneralPropertiesBuilder@endlink  to be used for changing the
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  AssembliesGeneralPropertiesBuilder : public Builder
        {
