...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        enum ToolingClonemethod
        {
            ...
            ToolingClonemethodRename = 2/** Use part rename method */
        };
    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  CloneObject : public TransientObject
        {
            ...
            /** Find the part item to be cloned by giving part name  @return  The returned @link Tooling::ClonePart Tooling::ClonePart@endlink  instance 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
