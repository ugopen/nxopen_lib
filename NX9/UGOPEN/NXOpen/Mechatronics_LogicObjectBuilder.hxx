...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::LogicObject Mechatronics::LogicObject@endlink  builder  <br> To create a new instance of this class, use @link Mechatronics::LogicObjectCollection::CreateLogicObjectBuilder  Mechatronics::LogicObjectCollection::CreateLogicObjectBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  LogicObjectBuilder : public Mechatronics::SystemObjectBuilder
        {
