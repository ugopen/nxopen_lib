...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Progressive Die Wizard  builder to create quick quotation.  <br> To create a new instance of this class, use @link Tooling::QuickQuotationCollection::CreateQuickQuotationBuilder  Tooling::QuickQuotationCollection::CreateQuickQuotationBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  QuickQuotationBuilder : public Builder
        {
