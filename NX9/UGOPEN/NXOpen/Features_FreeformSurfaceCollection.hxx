...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Collection of freeform surface based features.  <br> To obtain an instance of this class, refer to @link Features::FeatureCollection  Features::FeatureCollection @endlink  <br> 
