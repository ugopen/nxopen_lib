...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents the Angular Spring Joint. Angular spring joint causes objects to behave as though 
            there is a spring-like force between them that grows as the object become farther apart or closer together.  <br> To create or edit an instance of this class, use @link Mechatronics::AngularSpringJointBuilder  Mechatronics::AngularSpringJointBuilder @endlink  <br> 
         <br>  Created in NX7.5.1.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  AngularSpringJoint : public Mechatronics::PhysicsJoint
        {
