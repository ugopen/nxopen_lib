...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** The builder to create slope feature.  <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateSlopeBuilder  Features::VehicleDesignCollection::CreateSlopeBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SlopeBuilder : public Builder
            {
