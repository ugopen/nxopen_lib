...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeGroupCollection : public TaggedObjectCollection
        {
            /** Entity type */
            ...
            (
                const char * setName /**  Name of a Set   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<NXOpen::TaggedObject *> & objects /** objects */ 
            );
