...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Mill Tool Probing Builder  <br> To create a new instance of this class, use @link CAM::OperationCollection::CreateMillToolProbingBuilder  CAM::OperationCollection::CreateMillToolProbingBuilder @endlink  <br> 
         <br>  Created in NX8.5.1.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  MillToolProbingBuilder : public CAM::OperationBuilder
        {
