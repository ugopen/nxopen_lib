...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents the @link Motion::SpreadsheetRunControl Motion::SpreadsheetRunControl@endlink   <br> An instance of this class can not be obtained  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SpreadsheetRunControl : public TaggedObject
        {
