...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::ElectricalPartCollection Mechatronics::ElectricalPartCollection@endlink   <br> To obtain an instance of this class, refer to @link Mechatronics::MechatronicsManager  Mechatronics::MechatronicsManager @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ElectricalPartCollection : public TaggedObjectCollection
        {
            ...
            public:
                ...
                typedef Mechatronics::ElectricalPartBuilder * value_type;
                /** Default constructor */
            ...
            /** Create builder for ElectricalPart class  @return @link  ElectricalPart   ElectricalPart @endlink  object 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            public: NXOpen::Mechatronics::ElectricalPartBuilder * CreateElectricalPartBuilder
            (
                NXOpen::Mechatronics::ElectricalPart * object /** @link Mechatronics::ElectricalPart Mechatronics::ElectricalPart@endlink  to be edited, if NULL then create a new one */
            );
            /** Finds the @link Mechatronics::ElectricalPart Mechatronics::ElectricalPart@endlink  object with the given name.  @return  @link Mechatronics::ElectricalPart Mechatronics::ElectricalPart@endlink  object with this name. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
