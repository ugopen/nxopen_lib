...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a builder to be used to create face attribute. <br> To create a new instance of this class, use @link Tooling::ManufacturingGeometryCollection::CreateFaceAttributeBuilder  Tooling::ManufacturingGeometryCollection::CreateFaceAttributeBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  FaceAttributeBuilder : public Builder
        {
