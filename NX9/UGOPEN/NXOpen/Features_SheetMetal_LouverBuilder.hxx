...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  LouverBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the width of the louver. The side of the section that the width is measured from depends on the 
                             value of the section side (see @link Features::SheetMetal::LouverBuilder::SectionSide Features::SheetMetal::LouverBuilder::SectionSide@endlink ). 
                 <br>  Created in NX4.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the die radius. Not used if @link Features::SheetMetal::LouverBuilder::IncludeRounding Features::SheetMetal::LouverBuilder::IncludeRounding@endlink  is false. 
                 <br>  Created in NX4.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
