...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  DraftingViewCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Drawings::DetailViewBuilder Drawings::DetailViewBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Drawings::ViewCopyTo3dBuilder Drawings::ViewCopyTo3dBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Drawings::ViewProjectionBuilder Drawings::ViewProjectionBuilder@endlink   @return  
             <br>  Created in NX6.0.2.  <br>  
             <br> License requirements : nx_drafting_plus ("DraftingPlus") */
            public: NXOpen::Drawings::ViewProjectionBuilder * CreateViewProjectionBuilder
            (
            );
            /** Creates a @link Drawings::BrokenViewBuilder Drawings::BrokenViewBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Drawings::RefineDisplayBuilder Drawings::RefineDisplayBuilder@endlink   @return  
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NXOpen::Drawings::RefineDisplayBuilder * CreateRefineDisplayBuilder
            (
            );
            /** Creates a @link Drawings::AddRemoveBoxViewBuilder Drawings::AddRemoveBoxViewBuilder@endlink   @return  
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Drawings::ViewCreationWizardBuilder Drawings::ViewCreationWizardBuilder@endlink   @return  
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NXOpen::Drawings::ViewCreationWizardBuilder * CreateViewCreationWizardBuilder
            (
            );
            /** Creates a @link Drawings::ViewStyleShipbuildingLinesBuilder Drawings::ViewStyleShipbuildingLinesBuilder@endlink   @return  Returns the empty Shipbuilding Lines sub-builder on View Style 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NXOpen::Drawings::ViewStyleShipbuildingLinesBuilder * CreateShipbuildingLineBuilder
            (
            );
            /** Creates a @link Drawings::CustomViewSettingsBuilder Drawings::CustomViewSettingsBuilder@endlink   @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
