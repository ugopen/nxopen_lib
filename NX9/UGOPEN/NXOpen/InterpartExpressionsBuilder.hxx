...
namespace NXOpen
{
    ...
    /**
     ...
     <br> To create a new instance of this class, use @link ExpressionCollection::CreateInterpartExpressionsBuilder  ExpressionCollection::CreateInterpartExpressionsBuilder @endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  InterpartExpressionsBuilder : public Builder
    {
        /**
