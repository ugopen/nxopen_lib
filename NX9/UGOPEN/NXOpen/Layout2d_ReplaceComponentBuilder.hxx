    ...
    namespace Layout2d
    {
        ...
        /** Represents a Builder for Replace 2D component functionality which will replaces
            *   the selected 2D Component contents from another 2D Component definition.
             <br> To create a new instance of this class, use @link Layout2d::ComponentCollection::CreateReplaceComponentBuilder  Layout2d::ComponentCollection::CreateReplaceComponentBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_LAYOUT2DEXPORT  ReplaceComponentBuilder : public Builder
        {
            ...
            /**Returns  the select objects to replace the definitions 
             <br>  Created in NX9.0.0.  <br>  
            ...
            /**Returns  the path of the component definition to replace 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXString Path
            (
            );
            /**Sets  the path of the component definition to replace 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_drafting_plus ("DraftingPlus") */
            public: void SetPath
            (
            ...
            /**Returns  the location type of the component definition to replace 
            ...
            /**Sets  the location type of the component definition to replace 
                    *   indicating local, native or team center
