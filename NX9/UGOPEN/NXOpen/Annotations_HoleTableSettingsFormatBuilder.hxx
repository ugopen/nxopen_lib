...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::HoleTableSettingsFormatBuilder Annotations::HoleTableSettingsFormatBuilder@endlink  
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  HoleTableSettingsFormatBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
