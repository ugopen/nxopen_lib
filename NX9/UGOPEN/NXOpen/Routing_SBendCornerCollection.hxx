...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  SBendCornerCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a S-Bend corner between the start rcp and end rcp using a 
                        @link SplineSegment SplineSegment@endlink  and a bend radius.  @return  The newly created S-Bend corner object. 
             <br>  Created in NX4.0.0.  <br>  
            ...
            /** Creates a S-Bend corner between the start rcp and end rcp using a 
                        @link SplineSegment SplineSegment@endlink  and a bend ratio.  @return  The newly created S-Bend corner object. 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
