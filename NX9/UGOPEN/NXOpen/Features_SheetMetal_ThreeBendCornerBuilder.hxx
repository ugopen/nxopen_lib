            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ThreeBendCornerBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the miter root radius used for three bend corner miter treatment. This only applies when the treatment type is set to 
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsClosed Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsClosed@endlink .
                ...
                /**Returns  the blend miter radius used for three bend corner miter treatment. This only applies when the treatment type is set to 
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsClosed Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsClosed@endlink  or
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsCircularCutout Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsCircularCutout@endlink  or 
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsUCutout Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsUCutout@endlink  or
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsVCutout Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsVCutout@endlink .  
                ...
                /**Returns  the flange clearance used for three bend corner miter treatment. This only applies when the treatment type is set to 
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsOpen Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsOpen@endlink  or
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsClosed Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsClosed@endlink  or
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsCircularCutout Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsCircularCutout@endlink  or 
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsUCutout Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsUCutout@endlink  or
                            @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsVCutout Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeOptionsVCutout@endlink .  
