...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link Annotations::DimensionSetBuilder Annotations::DimensionSetBuilder@endlink 
             <br> This is a sub-builder class and cannot be directly instantiated  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionSetBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
