...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /**
            Represents a @link Drawings::ViewSectionLabelBuilder Drawings::ViewSectionLabelBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewSectionLabelBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
