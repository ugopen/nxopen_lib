...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /**
            Represents a @link Mechatronics::SignalAdapterBuilder Mechatronics::SignalAdapterBuilder@endlink .
             <br> To create a new instance of this class, use @link Mechatronics::SignalAdapterCollection::CreateSignalAdapterBuilder  Mechatronics::SignalAdapterCollection::CreateSignalAdapterBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SignalAdapterBuilder : public Builder
        {
