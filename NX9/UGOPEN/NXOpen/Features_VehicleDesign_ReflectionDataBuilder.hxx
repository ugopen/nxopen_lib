...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                Represents a @link Features::VehicleDesign::ReflectionData Features::VehicleDesign::ReflectionData@endlink  builder
                 <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateReflectionDataBuilder  Features::VehicleDesignCollection::CreateReflectionDataBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ReflectionDataBuilder : public Features::FeatureBuilder
            {
                /** the resolution type */
