...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /** Represents a @link Mechatronics::FunctionObjectCollection Mechatronics::FunctionObjectCollection@endlink   <br> To obtain an instance of this class, refer to @link Features::ShipDesign::PenetrationManager  Features::ShipDesign::PenetrationManager @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  PenetrationRequestCollection : public TaggedObjectCollection
            {
                ...
                public:
                    ...
                    typedef Features::ShipDesign::PenetrationRequestBuilder * value_type;
                    /** Default constructor */
                ...
                /** Creates a @link Features::ShipDesign::PenetrationRequestBuilder Features::ShipDesign::PenetrationRequestBuilder@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                ...
                /** Creates a @link Features::ShipDesign::PenetrationCutoutBuilder Features::ShipDesign::PenetrationCutoutBuilder@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Creates a @link Features::ShipDesign::PenetrationAssociationBuilder Features::ShipDesign::PenetrationAssociationBuilder@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Creates a @link Features::ShipDesign::PenetrationReviewRequestBuilder Features::ShipDesign::PenetrationReviewRequestBuilder@endlink   @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                ...
                /** Creates a @link Features::ShipDesign::VerifyPenetrationBuilder Features::ShipDesign::VerifyPenetrationBuilder@endlink   @return  
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                public: NXOpen::Features::ShipDesign::VerifyPenetrationBuilder * CreateVerifyPenetrationBuilder
                (
                );
                /** Creates a @link Features::ShipDesign::PenetrationRequestForCutoutBuilder Features::ShipDesign::PenetrationRequestForCutoutBuilder@endlink   @return  
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
                public: NXOpen::Features::ShipDesign::PenetrationRequestForCutoutBuilder * CreatePenetrationRequestForCutoutBuilder
                (
                );
                /** Finds the @link  NXObject   NXObject @endlink  with the given name.
                                An exception will be thrown if no object can be found with given name.  @return  @link  NXObject   NXObject @endlink  with this name. 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_penetration_mgmt ("Penetration Management") */
