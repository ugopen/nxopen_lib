...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents the builder for the CMM Inspection sub-operation Scan Helix.  <br> To create a new instance of this class, use @link CAM::InspectionMoveCollection::CreateInspectionScanHelixBuilder  CAM::InspectionMoveCollection::CreateInspectionScanHelixBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  InspectionScanHelixBuilder : public CAM::InspectionMoveBuilder
        {
