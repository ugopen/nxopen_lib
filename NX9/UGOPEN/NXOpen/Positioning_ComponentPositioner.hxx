...
namespace NXOpen
{
    ...
    namespace Positioning
    {
        ...
        */
        class NXOPENCPP_POSITIONINGEXPORT  ComponentPositioner : public Positioning::Positioner
        {
            ...
            /**Returns  the flag that enables the positioner to reposition dumb geometry.  Dumb geometry
                    ...
                    @link Features::Feature Features::Feature@endlink  object.  This flag has no effect
            ...
            /**
                    ...
                    their solve. This could lead to updating the model if required. 
