...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  LsdynaFormAnalysisResultDisplayBuilder : public Builder
        {
            ...
            (
                std::vector<NXString> & resultFileNames /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
