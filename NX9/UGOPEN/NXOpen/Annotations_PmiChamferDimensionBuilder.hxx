...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::PmiChamferDimension Annotations::PmiChamferDimension@endlink  builder  <br> To create a new instance of this class, use @link Annotations::DimensionCollection::CreatePmiChamferDimensionBuilder  Annotations::DimensionCollection::CreatePmiChamferDimensionBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiChamferDimensionBuilder : public Annotations::BaseChamferDimensionBuilder
        {
