...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**  @brief  This is the manager for Condition Sequences. Each Simulation has one manager. 
           ...
           <br> To obtain an instance of this class, use @link CAE::SimSimulation::ConditionSeqManager  CAE::SimSimulation::ConditionSeqManager @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SimConditionSeqMgr : public TaggedObject
        {
