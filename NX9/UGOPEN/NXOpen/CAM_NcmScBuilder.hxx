        ...
        */
        class NXOPENCPP_CAMEXPORT  NcmScBuilder : public CAM::NcmSubopBuilder
        {
            ...
            /**Returns  the smoothing option 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAM::NcmScBuilder::SmoothingBuilder CAM::NcmScBuilder::SmoothingBuilder@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAM::NcmScBuilder::SmoothingBuilder instead.") NXOpen::CAM::NcmScBuilder::SmoothingOptions SmoothingOption
            (
            );
            ...
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAM::NcmScBuilder::SmoothingBuilder instead.") void SetSmoothingOption
            (
            ...
            /**Returns  the max tool axis change 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAM::NcmScBuilder::SmoothingBuilder instead.") double MaxToolAxisChange
            (
            );
            /**Sets  the max tool axis change 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAM::NcmScBuilder::SmoothingBuilder instead.") void SetMaxToolAxisChange
            (
            ...
            /**Returns  the smoothing radius settings 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAM::NcmScBuilder::SmoothingBuilder instead.") NXOpen::CAM::InheritableToolDepBuilder * SmoothingRadiusBuilder
            (
            );
