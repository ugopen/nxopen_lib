...
namespace NXOpen
{
    ...
    /** Represents a @link  SelectionIntentRule   SelectionIntentRule @endlink  that collects tangent connected curves from the seed curve. 
     <br>  Created in NX9.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  CurveTangentRule : public SelectionIntentRule
    {
        ...
        /** Gets the data for the curve tangent rule: @link  CurveTangentRule   CurveTangentRule @endlink  
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: void GetData
        (
