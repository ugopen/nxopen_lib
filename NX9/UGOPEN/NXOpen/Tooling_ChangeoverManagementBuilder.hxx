...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a @link Tooling::ChangeoverManagementBuilder Tooling::ChangeoverManagementBuilder@endlink  to support changeover workflow management.  <br> To create a new instance of this class, use @link Tooling::WorkflowManagementCollection::CreateChangeoverManagementBuilder  Tooling::WorkflowManagementCollection::CreateChangeoverManagementBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ChangeoverManagementBuilder : public Builder
        {
