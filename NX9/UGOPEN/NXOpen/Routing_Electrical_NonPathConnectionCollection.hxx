...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  NonPathConnectionCollection : public TaggedObjectCollection
            {
                ...
                /** Creates a @link Routing::Electrical::NonPathConnection Routing::Electrical::NonPathConnection@endlink  object.  @return  A @link Routing::Electrical::NonPathConnection Routing::Electrical::NonPathConnection@endlink   
                 <br>  Created in NX4.0.2.  <br>  
