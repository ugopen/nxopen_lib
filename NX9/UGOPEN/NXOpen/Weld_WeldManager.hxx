...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  WeldManager : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Weld::GrooveBuilder Weld::GrooveBuilder@endlink  object.  @return  WeldGroove feature builder
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link Weld::WeldGrooveBuilder Weld::WeldGrooveBuilder@endlink instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Weld::WeldGrooveBuilderinstead.") NXOpen::Weld::GrooveBuilder * CreateWeldGrooveBuilder
            (
            ...
            /** Creates a @link Weld::WeldGrooveBuilder Weld::WeldGrooveBuilder@endlink  object.  @return      
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            ...
            /** Creates a @link Weld::JointmarkBuilder Weld::JointmarkBuilder@endlink  object.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            ...
            /** Creates a @link Weld::JointmarkBuilder Weld::JointmarkBuilder@endlink  object from a single element feature.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            ...
            /** Creates a @link Weld::SurfaceWeldBuilder Weld::SurfaceWeldBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : structure_weld ("STRUCTURE WELD") */
            public: NXOpen::Weld::SurfaceWeldBuilder * CreateSurfaceWeldBuilder
            (
                NXOpen::Weld::SurfaceWeld * surfaceWeld /** @link Weld::SurfaceWeld Weld::SurfaceWeld@endlink  to be edited. NULL to create a new surface weld. */
            );
            ...
            /// \endcond 
            /** Creates a @link Weld::CompoundWeldBuilder Weld::CompoundWeldBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Weld::CompoundWeldBuilder * CreateCompoundWeldBuilder
            (
                NXOpen::Weld::CompoundWeld * compoundWeld /** @link Weld::CompoundWeld Weld::CompoundWeld@endlink  to be edited */
            );
            /** Creates a @link Weld::InformationBuilder Weld::InformationBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") OR structure_weld ("STRUCTURE WELD") */
            public: NXOpen::Weld::InformationBuilder * CreateInformationBuilder
            (
            );
            /** Creates a @link Weld::WeldPmiBuilder Weld::WeldPmiBuilder@endlink  object. @return  weld PMI builder
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") OR structure_weld ("STRUCTURE WELD") */
