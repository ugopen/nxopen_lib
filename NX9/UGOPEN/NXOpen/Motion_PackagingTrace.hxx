...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** This class represents a Packaging Trace object.  A Trace object
            ...
            mechanism during motion animation.  <br> To create or edit an instance of this class, use @link Motion::PackagingTraceBuilder  Motion::PackagingTraceBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  PackagingTrace : public Motion::Packaging
        {
