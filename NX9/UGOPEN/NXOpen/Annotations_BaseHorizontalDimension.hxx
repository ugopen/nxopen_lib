...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseHorizontalDimension : public Annotations::Dimension, public virtual Annotations::ILinearTolerance, public virtual Annotations::IPmi, public virtual Annotations::ISlotDimension
        {
