...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Features.Newapp.TestFeature builder.  <br> To create a new instance of this class, use @link Newapp::ApplicationManager::CreateTestFeatureBuilder  Newapp::ApplicationManager::CreateTestFeatureBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NEWAPPOPENCPPEXPORT  TestFeatureBuilder : public Features::FeatureBuilder
        {
