...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link Annotations::CuttingPlaneSymbolBuilder Annotations::CuttingPlaneSymbolBuilder@endlink 
             <br> This is a sub-builder class and cannot be directly instantiated  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  CuttingPlaneSymbolBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
