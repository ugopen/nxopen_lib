...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseSurfaceFinishBuilder : public Annotations::PmiAttributeBuilder
        {
            ...
            /** the valid parantheses types. This enum is deprecated. 
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link JA_BASE_SURFACE_FINISH_BUILDER_parentheses_type JA_BASE_SURFACE_FINISH_BUILDER_parentheses_type@endlink  instead. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use JA_BASE_SURFACE_FINISH_BUILDER_parentheses_type instead.") enum ParanthesesType
            {
