    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  Component : public DisplayableObject, public virtual Routing::ICharacteristic
        {
            ...
            /** Creates an empty @link PartFamily::InstanceSelectionCriteria PartFamily::InstanceSelectionCriteria@endlink   @return  
            ...
            /** Obtains the@link PartFamily::InstanceSelectionCriteria PartFamily::InstanceSelectionCriteria@endlink , if it exists. @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::PartFamily::InstanceSelectionCriteria * GetPartFamilyInstanceSelectionCriteria
            (
            );
            /** Hooks @link PartFamily::InstanceSelectionCriteria PartFamily::InstanceSelectionCriteria@endlink  to this component 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** Deletes @link PartFamily::InstanceSelectionCriteria PartFamily::InstanceSelectionCriteria@endlink  associated with this component 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
