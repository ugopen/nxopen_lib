...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a Trim Post builder  <br> To create a new instance of this class, use @link Tooling::AutoDieCollection::CreateDieDesignTrimPostBuilder  Tooling::AutoDieCollection::CreateDieDesignTrimPostBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  DieDesignTrimPostBuilder : public Builder
        {
