    ...
    namespace Annotations
    {
        ...
        /**
            ...
            It provides an interface for editing Table Section settings.
             <br> To create a new instance of this class, use @link Drafting::SettingsManager::CreateTableEditSettingsBuilder  Drafting::SettingsManager::CreateTableEditSettingsBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  TableEditSettingsBuilder : public Drafting::BaseEditSettingsBuilder
        {
