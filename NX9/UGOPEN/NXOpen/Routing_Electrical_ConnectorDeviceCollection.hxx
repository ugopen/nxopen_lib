...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ConnectorDeviceCollection : public TaggedObjectCollection
            {
                ...
                /** Creates a @link Routing::Electrical::ConnectorDevice Routing::Electrical::ConnectorDevice@endlink .  @return  
                 <br>  Created in NX4.0.2.  <br>  
                ...
                (
                    NXOpen::Routing::Electrical::ConnectorDevice::ComponentType connectorType /** connector type */ ,
                    const char * componentName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    NXOpen::Routing::Electrical::HarnessDevice * harnessDevice /** can be NULL */,
                    const char * equipmentName /** can be NULL if connectorName is not NULL   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    const char * connectorName /** can be NULL if equipmentName is not NULL   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    NXOpen::Routing::Electrical::ConnectorDevice::ComponentType connectorType /** connector type */ 
                );
