...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  AddendumSectionBuilder : public Features::FeatureBuilder
        {
            ...
            /** Deletes the @link Section Section@endlink  used for extended constraint curve.  @return  @link Section Section@endlink  to delete. 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /** Creates a @link Section Section@endlink  object containing the extended constraint curve.  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            (
                const char * fileName /** name of reuse library containing addendum section information   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            /** Mirror sections using plane from @link Die::AddendumSectionBuilder::MirrorPlane Die::AddendumSectionBuilder::MirrorPlane@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void MirrorSections
            (
            );
            /** Delete addendum sections from @link Die::AddendumSectionBuilder::Sections Die::AddendumSectionBuilder::Sections@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the smoothing radius for the constraint curve used by @link Die::AddendumSectionBuilder::SmoothCurve Die::AddendumSectionBuilder::SmoothCurve@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            ...
            /** Smooth the constraint curve using the radius supplied by @link Die::AddendumSectionBuilder::SmoothRadius Die::AddendumSectionBuilder::SmoothRadius@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SmoothCurve
            (
            );
            /**Returns  the translate distance used by @link Die::AddendumSectionBuilder::TranslateWall Die::AddendumSectionBuilder::TranslateWall@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
