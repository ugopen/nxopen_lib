...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::Requirement Mechatronics::Requirement@endlink  builder  <br> To create a new instance of this class, use @link Mechatronics::RequirementCollection::CreateRequirementBuilder  Mechatronics::RequirementCollection::CreateRequirementBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  RequirementBuilder : public Mechatronics::SystemObjectBuilder
        {
