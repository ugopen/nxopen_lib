...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::BaseDataBuilder Features::VehicleDesign::BaseDataBuilder@endlink .  <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateBaseDataBuilder  Features::VehicleDesignCollection::CreateBaseDataBuilder @endlink  <br> 
