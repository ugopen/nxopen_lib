...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Used to create or edit a @link Weld::DatumPin Weld::DatumPin@endlink  feature.  <br> To create a new instance of this class, use @link Weld::WeldManager::CreateDatumPinBuilder  Weld::WeldManager::CreateDatumPinBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  DatumPinBuilder : public Weld::DatumCommonBuilder
        {
