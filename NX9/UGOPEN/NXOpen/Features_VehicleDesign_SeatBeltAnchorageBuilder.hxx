        ...
        namespace VehicleDesign
        {
            ...
            /**
                Represents a @link Features::VehicleDesign::SeatBeltAnchorage Features::VehicleDesign::SeatBeltAnchorage@endlink  builder
                 <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateSeatBeltAnchorageBuilder  Features::VehicleDesignCollection::CreateSeatBeltAnchorageBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SeatBeltAnchorageBuilder : public Features::FeatureBuilder
            {
                /** the standard type */
