...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /**
            Represents a @link Drawings::GeneralWorkFlowBuilder Drawings::GeneralWorkFlowBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  GeneralWorkFlowBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
