...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DeformationParameters : public TaggedObject
        {
            ...
            /**Returns  the complexity criterion. If the result type is complex @link CAE::BaseResultType::Complex CAE::BaseResultType::Complex@endlink  the complexity criterion
                        defines which value is used for deformation(like @link CAE::Result::ComplexReal CAE::Result::ComplexReal@endlink  or @link CAE::Result::ComplexImaginary CAE::Result::ComplexImaginary@endlink ) 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::Result::Complex ComplexCriterion
            (
            );
            /**Sets  the complexity criterion. If the result type is complex @link CAE::BaseResultType::Complex CAE::BaseResultType::Complex@endlink  the complexity criterion
                        defines which value is used for deformation(like @link CAE::Result::ComplexReal CAE::Result::ComplexReal@endlink  or @link CAE::Result::ComplexImaginary CAE::Result::ComplexImaginary@endlink ) 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /**Returns  the phase angle at which result will be evaluated and used for deformation.
                      If the result type is complex @link CAE::BaseResultType::Complex CAE::BaseResultType::Complex@endlink 
                       and the @link CAE::DeformationParameters::ComplexCriterion CAE::DeformationParameters::ComplexCriterion @endlink and @link CAE::DeformationParameters::SetComplexCriterion CAE::DeformationParameters::SetComplexCriterion @endlink  is set to 
                       @link CAE::Result::ComplexPhaseAngle CAE::Result::ComplexPhaseAngle@endlink  , 
            ...
            /**Returns  the node label which identifies the reference node used when deforming the model if 
                    @link  CAE::DeformationParameters::IsReferenceNode   CAE::DeformationParameters::IsReferenceNode @endlink  is set to  true 
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
