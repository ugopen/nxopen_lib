...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /** Represents a @link Features::PartModule Features::PartModule@endlink  builder  <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateRenameLinkedPartModulePartBuilder  Features::FeatureCollection::CreateRenameLinkedPartModulePartBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  RenameLinkedPartModulePartBuilder : public Builder
        {
            ...
            (
                ...
                const NXString & fileName /** new linked part file name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Add linked part module part tag and its new name to perform "Save As" along with its main part. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                NXOpen::Part * linkedPartTag /** the linked part*/,
                const char * fileName /** new linked part file name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                ...
                std::vector<NXString> & fileName /** new linked part file name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
