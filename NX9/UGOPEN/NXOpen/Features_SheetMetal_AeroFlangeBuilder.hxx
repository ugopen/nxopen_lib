...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  AeroFlangeBuilder : public Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                void SetAngle
                (
                    const char * angleExpression /** value of angle expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    NXOpen::Features::SheetMetal::AeroFlangeBuilder::LengthType type /** length type input Value/Infer */,
                    const char * valueExpression /** value of length expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    NXOpen::Features::SheetMetal::AeroFlangeBuilder::EndType endType /** end1/end2 */,
                    NXOpen::Features::SheetMetal::AeroFlangeBuilder::CompType compType /** Automatic/Angle/Distance/None */,
                    const char * valueExpression /** value of compensation expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
