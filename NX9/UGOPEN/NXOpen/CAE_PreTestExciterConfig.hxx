...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represent a exciter selection configuration  <br> To create or edit an instance of this class, use @link CAE::PreTestExciterConfigBuilder  CAE::PreTestExciterConfigBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  PreTestExciterConfig : public NXObject
        {
            ...
            /**Returns  the exciter selection configuration name 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAE::PreTestExciterConfig::ConfigName CAE::PreTestExciterConfig::ConfigName@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAE::PreTestExciterConfig::ConfigName instead.") NXString Name
            (
            );
            ...
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAE::PreTestExciterConfig::ConfigName instead.") void SetName
            (
