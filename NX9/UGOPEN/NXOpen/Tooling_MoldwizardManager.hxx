...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Provides create builder methods for Moldwizard.   <br> To obtain an instance of this class, refer to @link Tooling::ToolingManager  Tooling::ToolingManager @endlink  <br> 
