...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  OverstockBuilder : public Builder
        {
            ...
            /**Returns  the gap from the end of one piece of overstock to the start of the next piece
                        of overstock for @link Routing::OverstockBuilder::ApplicationTypeInterval Routing::OverstockBuilder::ApplicationTypeInterval@endlink  method. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the defining point for @link  Routing::OverstockBuilder::ApplicationTypePointAndLength   Routing::OverstockBuilder::ApplicationTypePointAndLength @endlink  method.
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the defining point location which can be any of @link Routing::OverstockBuilder::PointType Routing::OverstockBuilder::PointType@endlink 
                        for @link  Routing::OverstockBuilder::ApplicationTypePointAndLength   Routing::OverstockBuilder::ApplicationTypePointAndLength @endlink  method.
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the length over which overstock piece to be assigned for 
                        @link Routing::OverstockBuilder::ApplicationTypePointAndLength Routing::OverstockBuilder::ApplicationTypePointAndLength@endlink  method.
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the @link Routing::OverstockBuilder::WrapType Routing::OverstockBuilder::WrapType@endlink  for Wrapped overstock. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            public: NXOpen::Routing::OverstockBuilder::WrapType WrapMethod
            (
            );
            /**Sets  the @link Routing::OverstockBuilder::WrapType Routing::OverstockBuilder::WrapType@endlink  for Wrapped overstock. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the percentage overlap if the @link Routing::OverstockBuilder::WrapType Routing::OverstockBuilder::WrapType@endlink 
                        is @link Routing::OverstockBuilder::WrapTypeOverlapSpiral Routing::OverstockBuilder::WrapTypeOverlapSpiral@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the number of wraps if the @link Routing::OverstockBuilder::WrapType Routing::OverstockBuilder::WrapType@endlink 
                        is @link Routing::OverstockBuilder::WrapTypeSpot Routing::OverstockBuilder::WrapTypeSpot@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the gap distance if the @link Routing::OverstockBuilder::WrapType Routing::OverstockBuilder::WrapType@endlink 
                        is @link Routing::OverstockBuilder::WrapTypeStripedSpiral Routing::OverstockBuilder::WrapTypeStripedSpiral@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            ...
            /**Returns  the @link Routing::Anchor Routing::Anchor@endlink  name associated with the overstock. 
             <br>  Created in NX6.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
            public: NXString StockAnchor
            (
            );
            /**Sets  the @link Routing::Anchor Routing::Anchor@endlink  name associated with the overstock. 
             <br>  Created in NX6.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") OR routing_harness ("Routing Harness") OR routing_cabling ("Routing Cabling") OR routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") OR routing_platform ("Routing Platform") OR routing_pid ("Routing PID") */
