...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link Annotations::RetainedAnnotationsBuilder Annotations::RetainedAnnotationsBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  RetainedAnnotationsBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
