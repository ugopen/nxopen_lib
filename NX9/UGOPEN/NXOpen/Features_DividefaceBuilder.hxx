        ...
        */
        class NXOPENCPP_FEATURESEXPORT  DividefaceBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the Dividing Objects 
             <br>  @deprecated Deprecated in NX9.0.0.  This is for pre NX9 usage, do not use this method.  Instead use @link SelectDividingObject SelectDividingObject@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  This is for pre NX9 usage, do not use this method.  Instead use SelectDividingObject instead.") NXOpen::SelectDisplayableObjectList * DividingObjectsList
            (
            );
