...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Sheet Metal from Solid feature  <br> To create or edit an instance of this class, use @link Features::SheetMetal::SheetMetalFromSolidBuilder  Features::SheetMetal::SheetMetalFromSolidBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SheetMetalFromSolid : public Features::BodyFeature
        {
