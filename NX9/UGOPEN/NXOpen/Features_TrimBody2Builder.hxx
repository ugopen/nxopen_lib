...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  TrimBody2Builder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the tool bodies to trim the target body(s). The tool bodies are
                      ...
                      * be set on @link Features::TrimBody2Builder::BooleanTool Features::TrimBody2Builder::BooleanTool@endlink  are
