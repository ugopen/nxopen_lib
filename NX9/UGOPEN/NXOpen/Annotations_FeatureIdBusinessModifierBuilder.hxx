...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::FeatureIdBusinessModifier Annotations::FeatureIdBusinessModifier@endlink  builder  <br> To create a new instance of this class, use @link Annotations::BusinessModifierCollection::CreateFeatureIdBusinessModifierBuilder  Annotations::BusinessModifierCollection::CreateFeatureIdBusinessModifierBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  FeatureIdBusinessModifierBuilder : public Builder
        {
