...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a CircularCenterline centerline  <br> To create or edit an instance of this class, use @link Annotations::CircularCenterlineBuilder  Annotations::CircularCenterlineBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  CircularCenterline : public Annotations::CircleCenterline
        {
