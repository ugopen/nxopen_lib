...
namespace NXOpen
{
    ...
    namespace Gateway
    {
        ...
        /** This is the @link Gateway::BaseExplicitOrderBuilder Gateway::BaseExplicitOrderBuilder@endlink  for the explicit order <br> This is an abstract class, and cannot be instantiated.  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_GATEWAYEXPORT  BaseExplicitOrderBuilder : public Builder
        {
            ...
            (
                const NXString & savedOrderName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & saveFileName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            void SaveAsTextFile
            (
                const char * savedOrderName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * saveFileName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                bool overwriteFile /** overwritefile */ 
            );
        };
    }
