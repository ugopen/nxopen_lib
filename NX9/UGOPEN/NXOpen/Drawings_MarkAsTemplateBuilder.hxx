...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /**
            Represents a @link Drawings::MarkAsTemplateBuilder Drawings::MarkAsTemplateBuilder@endlink 
             <br> To create a new instance of this class, use @link DraftingManager::CreateMarkAsTemplateBuilder  DraftingManager::CreateMarkAsTemplateBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  MarkAsTemplateBuilder : public Builder
        {
