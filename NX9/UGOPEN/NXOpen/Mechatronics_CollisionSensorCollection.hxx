...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  CollisionSensorCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Mechatronics::CollisionSensorBuilder Mechatronics::CollisionSensorBuilder@endlink .  @return  
             <br>  Created in NX7.5.1.  <br>  
            ...
            /** Finds the @link  Mechatronics::CollisionSensor   Mechatronics::CollisionSensor @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  Mechatronics::CollisionSensor   Mechatronics::CollisionSensor @endlink  with this name. 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            (
                const char * name /** The name of the @link  Mechatronics::CollisionSensor   Mechatronics::CollisionSensor @endlink . */
            );
