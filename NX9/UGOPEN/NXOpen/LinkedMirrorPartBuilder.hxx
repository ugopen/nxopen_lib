...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  LinkedMirrorPartBuilder : public Builder
    {
        ...
        (
            std::vector<NXString> & refSetNames /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
