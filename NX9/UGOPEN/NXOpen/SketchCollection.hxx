...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SketchCollection : public TaggedObjectCollection
    {
        ...
        /** Creates a @link SketchAngularDimensionBuilder SketchAngularDimensionBuilder@endlink   @return  the angular dimension builder 
        ...
        /** Creates a @link SketchLinearDimensionBuilder SketchLinearDimensionBuilder@endlink   @return  the linear dimension builder 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates a @link SketchRapidDimensionBuilder SketchRapidDimensionBuilder@endlink   @return  the rapid dimension builder 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: NXOpen::SketchRapidDimensionBuilder * CreateRapidDimensionBuilder
        (
        );
        /** Creates a @link SketchRadialDimensionBuilder SketchRadialDimensionBuilder@endlink   @return  the radial dimension builder 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
