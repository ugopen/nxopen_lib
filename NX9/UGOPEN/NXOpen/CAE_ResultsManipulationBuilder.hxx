...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        ...
        {
            /** Action options 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAE::ResultsManipulationBuilder::JA_RESULTS_MANIPULATION_BUILDER_OutputResultType CAE::ResultsManipulationBuilder::JA_RESULTS_MANIPULATION_BUILDER_OutputResultType@endlink  instead. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::ResultsManipulationBuilder::JA_RESULTS_MANIPULATION_BUILDER_OutputResultType instead.") enum Action
            {
                ActionExport/** export */ ,
            ...
            /** The action 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAE::ResultsManipulationBuilder::SetOutputResultType CAE::ResultsManipulationBuilder::SetOutputResultType@endlink  instead. <br>  

             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::ResultsManipulationBuilder::SetOutputResultType instead.") void SetAction
            (
