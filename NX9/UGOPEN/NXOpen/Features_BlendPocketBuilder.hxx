...
#include <NXOpen/Features_BlendPocketBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link Features::BlendPocket Features::BlendPocket@endlink  builder for Blend Pocket feature.  <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateBlendPocketBuilder  Features::FeatureCollection::CreateBlendPocketBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        AngledWallSolution </td> <td> 
         
        CutFloorAndSwarfCutWall </td> </tr> 

        <tr><td> 
         
        CornerClearance.Value </td> <td> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  BlendPocketBuilder : public Features::FeatureBuilder
        {
