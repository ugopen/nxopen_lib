...
namespace NXOpen
{
    ...
    /**
        Represents a @link NXTo2dCreator NXTo2dCreator@endlink  to be used when exporting the 2D Data
        This class is created using @link DexManager DexManager@endlink .
        NULL object will be returned from Commit().
    	The workpart should be present in the session before calling commit().  <br> To create a new instance of this class, use @link DexManager::CreateNxto2dCreator  DexManager::CreateNxto2dCreator @endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  NXTo2dCreator : public DexBuilder
    {
        /** Export From Option */
