...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a ClosedCorner feature  <br> To create or edit an instance of this class, use @link Features::SheetMetal::ClosedCornerBuilder  Features::SheetMetal::ClosedCornerBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  ClosedCorner : public Features::Feature
        {
