...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  SelectObject : public BlockStyler::UIBlock
        {
            /**Indicates the general filter type for selection. */
            public: enum FilterType
            {
                FilterTypeFeatures = 1/** Filter to select all feature types */,
                FilterTypeFaces/** Filter to select all face types */,
                FilterTypeEdges = 4/** Filter to select all edge types */,
                FilterTypeCurvesAndEdges = 8/** Filter to select all curve and edge types */,
                FilterTypeComponents = 16/** Filter to select all components */,
                FilterTypeSolidBodies = 32/** Filter to select all solid bodies */,
                FilterTypeSheetBodies = 64/** Filter to select all sheet bodies */
            };
            ...
            (
                ...
                int subType /** Object subtype. This can either be 0 (UF_all_subtype) for any subtype, or a
