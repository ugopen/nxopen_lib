    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultsReductionBuilder : public CAE::ResultsManipulationBuilder
        {
            ...
            (
                const NXString & resultTypeName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Set result type name that will be displayed in postview 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            (
                const char * resultTypeName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & fieldName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Set field Name to be created
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            void SetFieldName
            (
                const char * fieldName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & domainName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Set Independent Domain Name
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            (
                const char * domainName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
