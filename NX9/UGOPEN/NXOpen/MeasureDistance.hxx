...
namespace NXOpen
{
    ...
    /** Represents a single valued distance measurement  <br> To create or edit an instance of this class, use @link MeasureDistanceBuilder  MeasureDistanceBuilder @endlink  <br> 
    ...
    */
    class NXOPENCPPEXPORT  MeasureDistance : public SingleMeasure
    {
        ...
        /** Creates and returns an embedded measurement expression.
         ...
         <br>  @deprecated Deprecated in NX5.0.1.  Use @link MeasureDistance::CreateEmbeddedObject MeasureDistance::CreateEmbeddedObject@endlink  instead. <br>  

         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.1.  Use MeasureDistance::CreateEmbeddedObject instead.") NXString CreateEmbedded
        (
        );
