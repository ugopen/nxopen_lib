...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI horizontal ordinate dimension  <br> To create or edit an instance of this class, use @link Annotations::PmiOrdinateDimensionBuilder  Annotations::PmiOrdinateDimensionBuilder @endlink  <br> 
