...
namespace NXOpen
{
    ...
    namespace ShapeSearch
    {
        ...
        */
        class NXOPENCPP_SHAPESEARCHEXPORT  ShapeSearchBuilder : public Builder
        {
            ...
            (
                bool isNew /** True is executing new search, False is executing saved search */,
                const char * searchName /** Search name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int* nTotalResults /** Search result total number */,
                NXString* errorMessage /** Search error message */
            );
