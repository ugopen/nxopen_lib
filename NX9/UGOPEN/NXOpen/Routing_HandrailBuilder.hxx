...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link Routing::RouteManager::CreateHandrailBuilder  Routing::RouteManager::CreateHandrailBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  HandrailBuilder : public Builder
        {
            /**
