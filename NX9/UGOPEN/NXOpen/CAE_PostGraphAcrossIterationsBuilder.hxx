...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**
                Represents a @link CAE::PostGraphAcrossIterationsBuilder CAE::PostGraphAcrossIterationsBuilder@endlink 
             <br> This is an abstract class and cannot be instantiated  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  PostGraphAcrossIterationsBuilder : public CAE::PostGraphBuilder
        {
            ...
            /**Returns  the combine across entities method to be used if  @link CAE::PostGraphAcrossIterationsBuilder::CombineAcrossEntities CAE::PostGraphAcrossIterationsBuilder::CombineAcrossEntities @endlink and @link CAE::PostGraphAcrossIterationsBuilder::SetCombineAcrossEntities CAE::PostGraphAcrossIterationsBuilder::SetCombineAcrossEntities @endlink  is True 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: bool CombineAcrossEntities
            (
            );
            /**Sets  the combine across entities method to be used if  @link CAE::PostGraphAcrossIterationsBuilder::CombineAcrossEntities CAE::PostGraphAcrossIterationsBuilder::CombineAcrossEntities @endlink and @link CAE::PostGraphAcrossIterationsBuilder::SetCombineAcrossEntities CAE::PostGraphAcrossIterationsBuilder::SetCombineAcrossEntities @endlink  is True 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
