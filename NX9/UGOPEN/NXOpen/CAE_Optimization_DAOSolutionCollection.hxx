            ...
            */
            class NXOPENCPP_CAEEXPORT  DAOSolutionCollection : public TaggedObjectCollection
            {
                ...
                /** Creates the builder object of optimization solution design constraint  @return  Design constraint builder 
                 <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAE::Optimization::DAOSolution::CreateConstraintBuilder CAE::Optimization::DAOSolution::CreateConstraintBuilder@endlink  instead. <br>  

                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_design_sim ("NX Design Simulation") */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::Optimization::DAOSolution::CreateConstraintBuilder instead.") NXOpen::CAE::Optimization::DAOConstraintBuilder * CreateConstraintBuilder
                (
                ...
                /** Creates the builder object of optimization solution design variable  @return  Design variable builder 
                 <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAE::Optimization::DAOSolution::CreateDesignVariableBuilder CAE::Optimization::DAOSolution::CreateDesignVariableBuilder@endlink  instead. <br>  

                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_design_sim ("NX Design Simulation") */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::Optimization::DAOSolution::CreateDesignVariableBuilder instead.") NXOpen::CAE::Optimization::DAODesignVariableBuilder * CreateDesignVariableBuilder
                (
