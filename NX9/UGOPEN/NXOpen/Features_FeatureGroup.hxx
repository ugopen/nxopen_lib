        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureGroup : public Features::Feature
        {
            ...
            /** Adds given features into feature group. 
             <br>  @deprecated Deprecated in NX8.5.1.  Use @link Features::FeatureGroup::AddMembersWithRelocation Features::FeatureGroup::AddMembersWithRelocation@endlink  instead. <br>  

             <br>  Created in NX7.5.3.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.1.  Use Features::FeatureGroup::AddMembersWithRelocation instead.") void NewAddMembers
            (
                const std::vector<NXOpen::Features::Feature *> & members /** Features array */,
            ...
            /**Try to make timestamps of members of feature group consecutive. 
             <br>  @deprecated Deprecated in NX8.5.1.  Use @link Features::FeatureGroup::MakeTimestampsSequential Features::FeatureGroup::MakeTimestampsSequential@endlink  instead. <br>  

             <br>  Created in NX7.5.3.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.1.  Use Features::FeatureGroup::MakeTimestampsSequential instead.") void MakeTimestampsConsecutive
            (
            );
