...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class BushingImpl;
        /** Represents a bushing  <br> To create or edit an instance of this class, use @link Motion::BushingBuilder  Motion::BushingBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  Bushing : public Motion::MotionObject
        {
