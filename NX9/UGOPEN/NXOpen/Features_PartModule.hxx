...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a part module  <br> To create or edit an instance of this class, use @link Features::PartModuleBuilder  Features::PartModuleBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  PartModule : public Features::Feature
        {
            ...
            /** Creates part module output builder
                     ...
                     Please use @link Features::PartModule::CreatePartModuleOutputBuilder1 Features::PartModule::CreatePartModuleOutputBuilder1@endlink  instead.
                      <br> 
                     @return  Returns a @link GeometricUtilities::PartModuleOutputBuilder GeometricUtilities::PartModuleOutputBuilder@endlink  builder 
             <br>  @deprecated Deprecated in NX9.0.0.  Please use @link Features::PartModule::CreatePartModuleOutputBuilder1 Features::PartModule::CreatePartModuleOutputBuilder1@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Please use Features::PartModule::CreatePartModuleOutputBuilder1 instead.") NXOpen::GeometricUtilities::PartModuleOutputBuilder * CreatePartModuleOutputBuilder
            (
            );
            ...
            /** Creates part module input builder @return  Returns a @link GeometricUtilities::PartModuleInputBuilder GeometricUtilities::PartModuleInputBuilder@endlink  builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::GeometricUtilities::PartModuleInputBuilder * CreatePartModuleInputBuilder
            (
            );
            /** Creates new part module output builder @return  Returns a @link GeometricUtilities::PartModuleOutputBuilder1 GeometricUtilities::PartModuleOutputBuilder1@endlink  builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
