...
namespace NXOpen
{
    ...
    namespace Layout2d
    {
        ...
        /**
            Represents a @link Layout2d::ComponentSettingsBuilder Layout2d::ComponentSettingsBuilder@endlink 
            This builder stores the information of the 2d component settings
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_LAYOUT2DEXPORT  ComponentSettingsBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
