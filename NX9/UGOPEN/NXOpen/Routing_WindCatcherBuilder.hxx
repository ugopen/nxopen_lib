...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Builder class for Wind Catcher feature. See @link Routing::WindCatcher Routing::WindCatcher@endlink 
                for the Wind Catcher class documentation.
             <br> To create a new instance of this class, use @link Routing::RouteManager::CreateWindCatcherBuilder  Routing::RouteManager::CreateWindCatcherBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  WindCatcherBuilder : public Builder
        {
