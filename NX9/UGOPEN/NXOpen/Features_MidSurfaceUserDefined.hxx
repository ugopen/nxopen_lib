...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a midsurface user defined feature  <br> To create or edit an instance of this class, use @link Features::MidSurfaceUserDefinedBuilder  Features::MidSurfaceUserDefinedBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  MidSurfaceUserDefined : public Features::BodyFeature
        {
