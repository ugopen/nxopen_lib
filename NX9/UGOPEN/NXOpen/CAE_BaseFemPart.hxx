    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  BaseFemPart : public CAE::CaePart
        {
            ...
            public: ~BaseFemPart();
            /**Returns  the femodel @link  CAE::BaseFEModel   CAE::BaseFEModel @endlink  associated with the part
            ...
            /** Sets solver and analysis type assoicated with the BaseFem part.
             ...
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAE::BaseFemPart::SetSolverAndAnalysisTypeAndAbstraction CAE::BaseFemPart::SetSolverAndAnalysisTypeAndAbstraction@endlink  instead. <br>  

             <br>  Created in NX6.0.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::BaseFemPart::SetSolverAndAnalysisTypeAndAbstraction instead.") void SetSolverAndAnalysisType
            (
