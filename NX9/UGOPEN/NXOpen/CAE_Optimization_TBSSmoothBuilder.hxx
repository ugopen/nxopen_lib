...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents the builder of @link CAE::Optimization::TBSSmooth CAE::Optimization::TBSSmooth@endlink .   <br> To create a new instance of this class, use @link CAE::Optimization::TBSOptimizationManager::CreateSmoothBuilder  CAE::Optimization::TBSOptimizationManager::CreateSmoothBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  TBSSmoothBuilder : public Builder
            {
                ...
                /**Returns  the target volume that is to be achieved iteratively by varying the isovalue. If set to 0,
                        the given @link CAE::Optimization::TBSSmoothBuilder::IsoValue CAE::Optimization::TBSSmoothBuilder::IsoValue @endlink and @link CAE::Optimization::TBSSmoothBuilder::SetIsoValue CAE::Optimization::TBSSmoothBuilder::SetIsoValue @endlink  is usedfor the generation of the isosurface 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
