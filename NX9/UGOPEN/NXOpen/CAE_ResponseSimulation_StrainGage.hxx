    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            /** Represents a @link CAE::ResponseSimulation::StrainGage CAE::ResponseSimulation::StrainGage@endlink 
                     <br> To create or edit an instance of this class, use @link CAE::ResponseSimulation::StrainGageBuilder  CAE::ResponseSimulation::StrainGageBuilder @endlink  <br> 
             <br>  Created in NX6.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  StrainGage : public DisplayableObject
            {
