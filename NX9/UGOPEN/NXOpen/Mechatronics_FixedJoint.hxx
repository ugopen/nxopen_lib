...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents the Fixed Joint. Fixed joint is that objects are glued to one
            another completely.  <br> To create or edit an instance of this class, use @link Mechatronics::FixedJointBuilder  Mechatronics::FixedJointBuilder @endlink  <br> 
         <br>  Created in NX7.5.1.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  FixedJoint : public Mechatronics::PhysicsJoint
        {
