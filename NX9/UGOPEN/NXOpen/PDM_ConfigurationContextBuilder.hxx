...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        /** Represents a @link PDM::ConfigurationContextBuilder PDM::ConfigurationContextBuilder@endlink  builder  <br> To create a new instance of this class, use @link PDM::ConfigurationManager::CreateConfigurationContextBuilder  PDM::ConfigurationManager::CreateConfigurationContextBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_PDMEXPORT  ConfigurationContextBuilder : public Builder
        {
            /** configuration mode */
            ...
            /**Returns  the @link PDM::EffectivityTableBuilder PDM::EffectivityTableBuilder@endlink  builder used to edit the effectivity 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
            public: NXOpen::PDM::EffectivityTableBuilder * EffectivityTable
            (
            );
            /**Returns  the @link PDM::VariantConfigurationBuilder PDM::VariantConfigurationBuilder@endlink  builder used to edit variant rule configuration 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
