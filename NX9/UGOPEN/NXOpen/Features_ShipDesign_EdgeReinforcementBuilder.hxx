...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                      Represents a @link Features::ShipDesign::EdgeReinforcement Features::ShipDesign::EdgeReinforcement@endlink  builder which is used to create or edit a edge reinforcement system feature.
                      <br> To create a new instance of this class, use @link Features::ShipCollection::CreateEdgeReinforcementBuilder  Features::ShipCollection::CreateEdgeReinforcementBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  EdgeReinforcementBuilder : public Features::ShipDesign::ProfileSystemBuilder
            {
                ...
                /**Returns  the orientation vector when the orientation method is 
                              @link Features::ShipDesign::EdgeReinforcementBuilder::OrientationMethodsVector Features::ShipDesign::EdgeReinforcementBuilder::OrientationMethodsVector@endlink . 
