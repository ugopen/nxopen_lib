...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  MirrorFaceBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the face to mirror. Please refer @link Features::FaceRecognitionBuilder Features::FaceRecognitionBuilder@endlink  for details. 
             <br>  Created in NX6.0.0.  <br>  
