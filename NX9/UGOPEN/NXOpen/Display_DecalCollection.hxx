...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  DecalCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Display::DecalBuilder Display::DecalBuilder@endlink  object if decal is NULL.  Otherwise, a Decal object will be edited  @return  return decal builder 
             <br>  Created in NX6.0.0.  <br>  
            ...
            /** Creates a @link Display::DecalBuilder Display::DecalBuilder@endlink  object with image referenced object if decal is NULL.  Otherwise, a Decal object will be edited  @return  return decal builder 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
