...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  CurveCurvatureAnalysisBuilder : public Builder
        {
            ...
            /** Returns the @link GeometricUtilities::CurveRangeBuilder GeometricUtilities::CurveRangeBuilder@endlink  object at a given index from the list  @return  
            ...
            /** Get the number of @link GeometricUtilities::CurveRangeBuilder GeometricUtilities::CurveRangeBuilder@endlink  objects in the list @return  
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : None */
