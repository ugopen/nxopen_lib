...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Extrude Setup  <br> To create or edit an instance of this class, use @link CAE::LaminateExtrudeSetupBuilder  CAE::LaminateExtrudeSetupBuilder @endlink  <br> 
         <br>  Created in NX6.0.4.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  LaminateExtrudeSetup : public NXObject
        {
