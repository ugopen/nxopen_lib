    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  DebugSession : public TaggedObject
    {
        ...
        */
        ...
        /** Creates a @link Display::ImageTestBuilder Display::ImageTestBuilder@endlink    @return  Display.ImageTestBuilder object 
        ...
        (
            NXOpen::Part * part /** the part that will own the feature */,
            NXOpen::TaggedObject * sectionTest /** @link SmartContainer SmartContainer@endlink  to be edited */
        );
        /** Creates a @link Features::CollectorTestBuilder Features::CollectorTestBuilder@endlink    @return  Features.CollectorTestBuilder object 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        */
        ...
        /** Returns the @link SheetMetalAutotestPrint SheetMetalAutotestPrint@endlink  belonging to this debug session 
         <br>  Created in NX9.0.0.  <br>  
        */
        ...
        */
        ...
        /** Returns the @link OptimizerAutotest OptimizerAutotest@endlink  belonging to this debug session 
         <br>  Created in NX9.0.0.  <br>  
        */
