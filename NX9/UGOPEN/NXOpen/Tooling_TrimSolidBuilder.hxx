...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Mold Wizard trim solid management builder, trims bounding box body with region, subtract 
                bounding box with workpiece or keep region and box.  <br> To create a new instance of this class, use @link Tooling::TrimSolidCollection::CreateTrimSolidBuilder  Tooling::TrimSolidCollection::CreateTrimSolidBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  TrimSolidBuilder : public Builder
        {
