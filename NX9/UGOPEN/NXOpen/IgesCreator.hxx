...
namespace NXOpen
{
    ...
    /**
    	...
    	The workpart should be present in the session before calling commit().  <br> To create a new instance of this class, use @link DexManager::CreateIgesCreator  DexManager::CreateIgesCreator @endlink  <br> 
    Default values.
    <table border="1"> 
