...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a boundary set.   <br> To create a new instance of this class, use @link CAM::Boundary::CreateBoundarySet  CAM::Boundary::CreateBoundarySet @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  BoundarySet : public TaggedObject
        {
            /** the boundary types 
             <br>  Created in NX9.0.0.  <br>  
            */
