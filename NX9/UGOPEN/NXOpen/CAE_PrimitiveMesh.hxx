...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents Primitive Mesh  <br> To create or edit an instance of this class, use @link CAE::PrimitiveMeshBuilder  CAE::PrimitiveMeshBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  PrimitiveMesh : public CAE::Mesh
        {
