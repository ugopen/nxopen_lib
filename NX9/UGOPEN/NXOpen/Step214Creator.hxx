...
namespace NXOpen
{
    ...
    /**
    	...
    	The workpart should be present in the session before calling commit().  <br> To create a new instance of this class, use @link DexManager::CreateStep214Creator  DexManager::CreateStep214Creator @endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  Step214Creator : public DexBuilder
    {
        /** Export From Option */
