...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a point on surface motion object <br> To create or edit an instance of this class, use @link Motion::PointOnSurfaceBuilder  Motion::PointOnSurfaceBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  PointOnSurface : public Motion::MotionObject
        {
