...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateSectionSurfaceBuilderEx  Features::FeatureCollection::CreateSectionSurfaceBuilderEx @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  SectionSurfaceBuilderEx : public Features::FeatureBuilder
        {
