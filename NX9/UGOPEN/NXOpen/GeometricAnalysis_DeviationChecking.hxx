...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  DeviationChecking : public Builder
        {
            ...
            /**Returns  the first curve or edge - required for the deviation checking when
                      @link GeometricAnalysis::DeviationChecking::Type GeometricAnalysis::DeviationChecking::Type @endlink and @link GeometricAnalysis::DeviationChecking::SetType GeometricAnalysis::DeviationChecking::SetType @endlink  is set to
            ...
            /**Returns  the second face - required for the deviation checking when
                      @link GeometricAnalysis::DeviationChecking::Type GeometricAnalysis::DeviationChecking::Type @endlink and @link GeometricAnalysis::DeviationChecking::SetType GeometricAnalysis::DeviationChecking::SetType @endlink  is set to
                      @link GeometricAnalysis::DeviationChecking::TypesFaceToFace GeometricAnalysis::DeviationChecking::TypesFaceToFace@endlink 
                      or the face  - required for the deviation checking when @link GeometricAnalysis::DeviationChecking::Type GeometricAnalysis::DeviationChecking::Type @endlink and @link GeometricAnalysis::DeviationChecking::SetType GeometricAnalysis::DeviationChecking::SetType @endlink  is set to
                      @link GeometricAnalysis::DeviationChecking::TypesCurveToFace GeometricAnalysis::DeviationChecking::TypesCurveToFace@endlink 
                      or
            ...
            /** Performs deviation checking.  Before calling this method, set
                        property @link GeometricAnalysis::DeviationChecking::Type GeometricAnalysis::DeviationChecking::Type @endlink and @link GeometricAnalysis::DeviationChecking::SetType GeometricAnalysis::DeviationChecking::SetType @endlink  to specify the type of 
                        deviation checking, and the two objects (curve/face/edge) to be used the deviation
                        checking. The type of the objects required
                        depends on @link GeometricAnalysis::DeviationChecking::Type GeometricAnalysis::DeviationChecking::Type @endlink and @link GeometricAnalysis::DeviationChecking::SetType GeometricAnalysis::DeviationChecking::SetType @endlink  set above. Also set the
                        ...
                        method @link GeometricAnalysis::DeviationChecking::Check GeometricAnalysis::DeviationChecking::Check@endlink . 
                        @link GeometricAnalysis::DeviationChecking::Check GeometricAnalysis::DeviationChecking::Check@endlink  displays the
