...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  AttributeGroup : public NXObject
        {
            ...
            /** Returns a list of @link PDM::IAttributeGroupOwner PDM::IAttributeGroupOwner@endlink  objects referencing this attribute group.  @return   
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
