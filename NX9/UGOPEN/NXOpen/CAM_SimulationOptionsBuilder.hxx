    ...
    namespace CAM
    {
        ...
        /**
            Represents a @link CAM::SimulationOptionsBuilder CAM::SimulationOptionsBuilder@endlink 
             <br> To create a new instance of this class, use @link SIM::KinematicConfigurator::CreateSimulationOptionsBuilder  SIM::KinematicConfigurator::CreateSimulationOptionsBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  SimulationOptionsBuilder : public Builder
        {
            /** the dialog type */
