...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Subdivision
        {
            ...
            /** Represents a @link Features::Subdivision::SubdivisionExtrudeCageBuilder Features::Subdivision::SubdivisionExtrudeCageBuilder@endlink  builder.   <br> To create a new instance of this class, use @link Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionExtrudeCageBuilder  Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionExtrudeCageBuilder @endlink  <br> 
             <br>  Created in NX9.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  SubdivisionExtrudeCageBuilder : public Builder
            {
