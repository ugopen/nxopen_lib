...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                    Represents a @link Features::VehicleDesign::Manikin Features::VehicleDesign::Manikin@endlink  builder
                     <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateManikinBuilder  Features::VehicleDesignCollection::CreateManikinBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ManikinBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the percentile limit that the manikin represents. 
                                If the Standard is set to @link Features::VehicleDesign::ManikinBuilder::StandardTypeSAEJ826Jul1995 Features::VehicleDesign::ManikinBuilder::StandardTypeSAEJ826Jul1995@endlink ,
                                then the valid settings are: @link Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ826Type95thPercentile Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ826Type95thPercentile@endlink ,
                                @link Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ826Type50thPercentile Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ826Type50thPercentile@endlink  and 
                                @link Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ826Type10thPercentile Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ826Type10thPercentile@endlink .
                                If the standard is set to @link Features::VehicleDesign::ManikinBuilder::StandardTypeSaej833 Features::VehicleDesign::ManikinBuilder::StandardTypeSaej833@endlink ,
                                then the valid settings are: @link Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ833LargeHuman95thMale Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ833LargeHuman95thMale@endlink ,
                                @link Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ833MediumHumanHalfwayPosition Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ833MediumHumanHalfwayPosition@endlink  and
                                @link Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ833SmallHuman5thFemale Features::VehicleDesign::ManikinBuilder::SAEPercentileTypeJ833SmallHuman5thFemale@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the current manikin size string. It is only used when the vehicle standard type is set to 
                                @link Features::VehicleDesign::ManikinBuilder::StandardTypeUserDefined Features::VehicleDesign::ManikinBuilder::StandardTypeUserDefined@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the AHP to Steering Wheel Center length. It is only used when the vehicle style type is set to 
                                @link Features::VehicleDesign::ManikinBuilder::PositionTypeDriver Features::VehicleDesign::ManikinBuilder::PositionTypeDriver@endlink . 
                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : None */
