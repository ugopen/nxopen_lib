...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents the defining data for a physical @link Routing::Port Routing::Port@endlink .
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  InterfaceTerminalShadow : public Routing::InterfaceTerminalBase
        {
