...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Represents a @link Drawings::EditViewLabelSettingsBuilder Drawings::EditViewLabelSettingsBuilder@endlink  builder.
                ...
                This can be used to change one specific view label or all view labels.  <br> To create a new instance of this class, use @link Drafting::SettingsManager::CreateDrawingEditViewLabelSettingsBuilder  Drafting::SettingsManager::CreateDrawingEditViewLabelSettingsBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  EditViewLabelSettingsBuilder : public Drafting::BaseEditSettingsBuilder
        {
