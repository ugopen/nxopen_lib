...
namespace NXOpen
{
    ...
    /** 
     ...
     <br>  @deprecated Deprecated in NX9.0.0.  Use @link JA_FILE_NEW_get_application_names JA_FILE_NEW_get_application_names@endlink  that returns all application names. <br>  
    */
     NX_DEPRECATED("Deprecated in NX9.0.0.  Use JA_FILE_NEW_get_application_names that returns all application names.") enum FileNewApplication
    {
    ...
    */
    class NXOPENCPPEXPORT  FileNew : public Builder
    {
        ...
        /**Returns  the application type for the new file being created 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link ApplicationName ApplicationName@endlink  that takes a string name instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use ApplicationName that takes a string name instead.") NXOpen::FileNewApplication Application
        (
        );
        /**Sets  the application type for the new file being created 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link SetApplicationName SetApplicationName@endlink  that takes a string name instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use SetApplicationName that takes a string name instead.") void SetApplication
        (
            NXOpen::FileNewApplication application /** application */ 
        );
        /**Returns  the application type for the new file being created 
                     Use @link JA_FILE_NEW_get_application_names JA_FILE_NEW_get_application_names@endlink  to get valid application names.
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
