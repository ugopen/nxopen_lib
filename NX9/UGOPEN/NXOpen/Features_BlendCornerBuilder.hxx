...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /**
                Represents a @link Features::BlendCorner Features::BlendCorner@endlink  builder.
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  BlendCornerBuilder : public Features::FeatureBuilder
        {
            /** Continuity options */
