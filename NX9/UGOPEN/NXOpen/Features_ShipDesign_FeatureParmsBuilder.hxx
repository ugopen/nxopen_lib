...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  FeatureParmsBuilder : public Features::FeatureBuilder
            {
                ...
                /** Create a @link Features::ShipDesign::PlaneListBuilder Features::ShipDesign::PlaneListBuilder@endlink  to add a defined
