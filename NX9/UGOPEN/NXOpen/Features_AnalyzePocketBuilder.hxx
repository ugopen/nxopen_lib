...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link Features::AnalyzePocket Features::AnalyzePocket@endlink  builder for Analyze Pocket feature.  <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateAnalyzePocketBuilder  Features::FeatureCollection::CreateAnalyzePocketBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  AnalyzePocketBuilder : public Features::FeatureBuilder
        {
