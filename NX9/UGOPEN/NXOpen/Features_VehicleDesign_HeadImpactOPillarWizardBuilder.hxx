...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::HeadImpactOPillarWizardBuilder Features::VehicleDesign::HeadImpactOPillarWizardBuilder@endlink .  <br> This is an abstract class and cannot be instantiated.  <br> 
             <br>  Created in NX9.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  HeadImpactOPillarWizardBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
            {
