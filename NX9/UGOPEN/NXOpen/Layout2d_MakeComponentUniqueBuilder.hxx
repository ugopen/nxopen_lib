...
namespace NXOpen
{
    ...
    namespace Layout2d
    {
        ...
        /** Represents a Builder for Make 2D component unique functionality which will create a
             *  new definition of the selected 2D Component instance  <br> To create a new instance of this class, use @link Layout2d::ComponentCollection::CreateMakeComponentUniqueBuilder  Layout2d::ComponentCollection::CreateMakeComponentUniqueBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_LAYOUT2DEXPORT  MakeComponentUniqueBuilder : public Builder
        {
