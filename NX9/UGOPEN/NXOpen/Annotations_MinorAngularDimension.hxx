...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a minor angular dimension  <br> To create or edit an instance of this class, use @link Annotations::MinorAngularDimensionBuilder  Annotations::MinorAngularDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  MinorAngularDimension : public Annotations::AngularDimension, public virtual Annotations::IPmi
        {
