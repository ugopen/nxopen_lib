...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ComponentGroupCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Assemblies::ComponentGroup Assemblies::ComponentGroup@endlink  with the given name  @return  the ComponentGroup created 
