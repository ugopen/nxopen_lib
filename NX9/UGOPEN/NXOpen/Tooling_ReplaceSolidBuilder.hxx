...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a replace solid operation. <br> To create a new instance of this class, use @link Tooling::ReplaceSolidCollection::CreateReplaceSolidBuilder  Tooling::ReplaceSolidCollection::CreateReplaceSolidBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        BoundingBoxBuilder.Clearance.Value </td> <td> 
         
        1.0 (millimeters part), 0.1 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.OffsetNegativeX.Value </td> <td> 
         
        1.0 (millimeters part), 0.1 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.OffsetNegativeY.Value </td> <td> 
         
        1.0 (millimeters part), 0.1 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.OffsetNegativeZ.Value </td> <td> 
         
        1.0 (millimeters part), 0.1 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.OffsetPositiveX.Value </td> <td> 
         
        1.0 (millimeters part), 0.1 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.OffsetPositiveY.Value </td> <td> 
         
        1.0 (millimeters part), 0.1 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.OffsetPositiveZ.Value </td> <td> 
         
        1.0 (millimeters part), 0.1 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.XValue.Value </td> <td> 
         
        10 (millimeters part), 1.0 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.YValue.Value </td> <td> 
         
        10 (millimeters part), 1.0 (inches part) </td> </tr> 

        <tr><td> 
         
        BoundingBoxBuilder.ZValue.Value </td> <td> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ReplaceSolidBuilder : public Builder
        {
            ...
            /**Returns  the bounding box feature builder. 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Tooling::CreateBoxBuilder * BoundingBoxBuilder
            (
            );
            /**Sets  the bounding box feature builder. 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetBoundingBoxBuilder
            (
