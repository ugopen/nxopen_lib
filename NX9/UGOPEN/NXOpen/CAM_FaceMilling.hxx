...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Face Milling Operation  <br> To create or edit an instance of this class, use @link CAM::FaceMillingBuilder  CAM::FaceMillingBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  FaceMilling : public CAM::PlanarOperation
        {
