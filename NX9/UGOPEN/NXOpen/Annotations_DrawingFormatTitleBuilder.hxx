...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::DrawingFormatTitleBuilder Annotations::DrawingFormatTitleBuilder@endlink 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DrawingFormatTitleBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
