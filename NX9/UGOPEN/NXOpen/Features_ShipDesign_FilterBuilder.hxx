    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /** A builder that allows the user to define common properties of ship objects and then
                    add objects of similar properties to the select object list.  <br> To create a new instance of this class, use @link Features::ShipCollection::CreateFilterBuilder  Features::ShipCollection::CreateFilterBuilder @endlink  <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  FilterBuilder : public Builder
            {
