...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            ...
            /// \cond NX_NO_DOC 
            /** Represents the surface display style. Call @link CAE::Xyplot::IDisplayStyle::CommitChange CAE::Xyplot::IDisplayStyle::CommitChange@endlink 
                        to apply style changes to corresponding plot after it's modified.
                     <br> Not support KF.  <br> 
             <br>  Created in NX9.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  SurfaceStyleSetting : public CAE::Xyplot::BaseSymbolStyleSetting
            {
