...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  MirrorBodyBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the mirror body list. For KF, only one parent body should be selected for this attribute. 
             ...
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link Features::MirrorBodyBuilder::MirrorBodyCollector Features::MirrorBodyBuilder::MirrorBodyCollector@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Features::MirrorBodyBuilder::MirrorBodyCollector instead.") NXOpen::SelectBodyList * MirrorBodyList
            (
            );
