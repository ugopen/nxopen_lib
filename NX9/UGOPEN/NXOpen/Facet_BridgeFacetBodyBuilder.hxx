...
namespace NXOpen
{
    ...
    namespace Facet
    {
        ...
        /**
            Represents a @link Facet::BridgeFacetBodyBuilder Facet::BridgeFacetBodyBuilder@endlink 
            ...
            It returns a new megered NX facet Body. The two input bodies can be kept, deleted or hidden.
             <br> To create a new instance of this class, use @link Facet::FacetedBodyCollection::CreateBridgeFacetBodyBuilder  Facet::FacetedBodyCollection::CreateBridgeFacetBodyBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_FACETEXPORT  BridgeFacetBodyBuilder : public Builder
        {
