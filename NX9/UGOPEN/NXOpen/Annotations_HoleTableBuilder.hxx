...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** 
             ...
             editing hole table.
             <br> To create a new instance of this class, use @link Annotations::HoleTableCollection::CreateHoleTableBuilder  Annotations::HoleTableCollection::CreateHoleTableBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  HoleTableBuilder : public Builder
        {
