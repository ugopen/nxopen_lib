    ...
    namespace Fields
    {
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  FieldManager : public NXObject
        {
            ...
            /** Get the next available ID for @link Fields::Field Fields::Field@endlink  object  @return  valid id 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: int GetValidFieldId
            (
            );
            /** Creates a @link Fields::FieldLinksTable Fields::FieldLinksTable@endlink  object with dependent and independent variables 
                        @link Fields::FieldVariable Fields::FieldVariable@endlink .
