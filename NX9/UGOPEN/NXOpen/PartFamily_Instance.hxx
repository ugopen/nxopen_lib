...
namespace NXOpen
{
    ...
    namespace PartFamily
    {
        ...
        /**
             ...
             <br> Use @link Part::GetFamilyInstance Part::GetFamilyInstance@endlink  to get the instance of this class.  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_PARTFAMILYEXPORT  Instance : public TaggedObject
        {
            private: InstanceImpl * m_instance_impl;
            private: friend class  _InstanceBuilder;
            protected: Instance();
            public: ~Instance();
            /**Returns  the @link PartFamily::Template PartFamily::Template@endlink  of instance. 
             <br>  Created in NX9.0.0.  <br>  
