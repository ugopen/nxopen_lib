...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  LinkCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Motion::LinkBuilder Motion::LinkBuilder@endlink   @return  
             <br>  Created in NX5.0.0.  <br>  
            ...
            /** Creates a @link Motion::Joint Motion::Joint@endlink   @return  
            ...
            (
                const NXString & name /** The name of the @link  Motion::Link   Motion::Link @endlink . */
            );
            /** Finds the @link  Motion::Link   Motion::Link @endlink  with the given name.
                    An exception will be thrown if no object can be found with given name.  @return  @link  Motion::Link   Motion::Link @endlink  with this name. 
             <br>  Created in NX5.0.0.  <br>  
            ...
            (
                const char * name /** The name of the @link  Motion::Link   Motion::Link @endlink . */
            );
