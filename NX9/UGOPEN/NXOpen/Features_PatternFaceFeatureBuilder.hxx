...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        PatternDefinition.PatternOrientation.OrientationOption (deprecated) </td> <td> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PatternFaceFeatureBuilder : public Features::FeatureBuilder
        {
