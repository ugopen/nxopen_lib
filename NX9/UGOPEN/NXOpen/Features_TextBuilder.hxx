...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  TextBuilder : public Features::FeatureBuilder
        {
            /** Text placement type */
            public: enum Types
            {
            ...
            public: ~TextBuilder();
            /**Returns  the placement profile for @link Features::TextBuilder::TypesOnCurve Features::TextBuilder::TypesOnCurve@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Section * OnCurvePlacementProfile
            (
            );
            /**Returns  the placement faces for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * PlacementFaces
            (
            );
            /**Returns  the placement method for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::TextBuilder::OnFacePlacementMethodOptions OnFacePlacementMethod
            (
            );
            /**Sets  the placement method for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
            ...
            /**Returns  the placement profile for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Section * OnFacePlacementProfile
            (
            );
            /**Returns  the section plane for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Plane * SectionPlane
            (
            );
            /**Sets  the section plane for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the orientation method for @link Features::TextBuilder::TypesOnCurve Features::TextBuilder::TypesOnCurve@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::TextBuilder::OrientationMethodOptions OrientationMethod
            (
            );
            /**Sets  the orientation method for @link Features::TextBuilder::TypesOnCurve Features::TextBuilder::TypesOnCurve@endlink  type 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
