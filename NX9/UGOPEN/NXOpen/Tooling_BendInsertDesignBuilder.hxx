...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**  Represents a @link Tooling::BendInsertDesignBuilder Tooling::BendInsertDesignBuilder@endlink 
                  Bend Insert Design is to create inset puch or die for bend .  <br> To create a new instance of this class, use @link Tooling::BendInsertDesignCollection::CreateBendInsertDesignBuilder  Tooling::BendInsertDesignCollection::CreateBendInsertDesignBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  BendInsertDesignBuilder : public Builder
        {
