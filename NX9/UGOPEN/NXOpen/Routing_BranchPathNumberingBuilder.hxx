...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  BranchPathNumberingBuilder : public Builder
        {
            /** Specifies the sequence method */
            public: enum Sequence
            {
                SequenceNumbers/** 1, 2, 3,..... */,
                SequenceUpperCase/** A, B, C,..... */,
                SequenceLowerCase/** a, b, c,..... */
            };
            ...
            /**Sets   the start value specified in the UI for the labeling sequence 
             <br>  @deprecated Deprecated in NX8.5.2.  Use @link Routing::BranchPathNumberingBuilder::SetSetStartValueForNumbers Routing::BranchPathNumberingBuilder::SetSetStartValueForNumbers@endlink , @link Routing::BranchPathNumberingBuilder::SetSetStartValueForUpperCase Routing::BranchPathNumberingBuilder::SetSetStartValueForUpperCase@endlink , or  @link Routing::BranchPathNumberingBuilder::SetSetStartValueForLowerCase Routing::BranchPathNumberingBuilder::SetSetStartValueForLowerCase@endlink  instead. <br>  

             <br>  Created in NX8.5.1.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.2.  Use Routing::BranchPathNumberingBuilder::SetSetStartValueForNumbers, Routing::BranchPathNumberingBuilder::SetSetStartValueForUpperCase, or  Routing::BranchPathNumberingBuilder::SetSetStartValueForLowerCase instead.") void SetStartValue
            (
