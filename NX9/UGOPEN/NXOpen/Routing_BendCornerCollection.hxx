...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  BendCornerCollection : public TaggedObjectCollection
        {
            ...
            (
                ...
                double bendRatio /** Bend ratio is used only if bend method is set to
                                                                                    @link Routing::CornerTypeBuilder::BendMethodsRatioToDiameter Routing::CornerTypeBuilder::BendMethodsRatioToDiameter@endlink .
                                                                                    Must be greater than 0.5. */,
                double bendRadius /** Radius of bend corner arc, used only if bend method is set to
                                                                                    @link Routing::CornerTypeBuilder::BendMethodsRadius Routing::CornerTypeBuilder::BendMethodsRadius@endlink .
