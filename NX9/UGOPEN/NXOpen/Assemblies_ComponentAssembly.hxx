...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ComponentAssembly : public NXObject
        {
            ...
            /** Option controls whether reordered @link Assemblies::Component Assemblies::Component@endlink s are placed 
                    before or after the target @link Assemblies::Component Assemblies::Component@endlink */
            public: enum OrderTargetLocation
            {
                OrderTargetLocationPlaceBefore/** Move reordered @link Assemblies::Component Assemblies::Component@endlink s before the target @link Assemblies::Component Assemblies::Component@endlink  */,
                OrderTargetLocationPlaceAfter/** Move reordered @link Assemblies::Component Assemblies::Component@endlink s after the target @link Assemblies::Component Assemblies::Component@endlink  */
            };
            ...
            (
                const char * partToAdd /** The part that defines the new component   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * referenceSetName /** The name of the reference set used to represent the new component   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * componentName /** The name of the new component   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXOpen::Point3d & basePoint /** Location of the new component */,
                const NXOpen::Matrix3x3 & orientation /** Orientation matrix for the new component, in column order.  */,
                int layer /**  The layer to place the new component on 
                                                              -1 means use the original layers defined in the component.
            ...
            (
                NXOpen::Assemblies::Component * component /** The old component to be substituted. */,
                NXOpen::BasePart * part /** The new part */,
                const char * newName /** The name for the new component   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * referenceSet /** The name of the reference set for the new component   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int layer /** The layer for the new component 
                                                                    -1 means use the original layers defined in the component.
                                                                    0 means use the work layer
                                                                    1-256 means use the specified layer.
            ...
            /** Changes the current @link Arrangement Arrangement@endlink  of the given @link Component Component@endlink s to the
                @link Arrangement Arrangement@endlink  with the given name.
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void ChangeByName
            (
                const NXString & name /** The name of arrangement to change to   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<NXOpen::Assemblies::Component *> & partOccs /** The @link Component Component@endlink s to be modified */
            );
            /** Changes the current @link Arrangement Arrangement@endlink  of the given @link Component Component@endlink s to the
                @link Arrangement Arrangement@endlink  with the given name.
             <br>  Created in NX7.5.2.  <br>  
            ...
            void ChangeByName
            (
                const char * name /** The name of arrangement to change to   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<NXOpen::Assemblies::Component *> & partOccs /** The @link Component Component@endlink s to be modified */
            );
            /** Set the default @link Arrangement Arrangement@endlink  for the given @link ComponentAssembly ComponentAssembly@endlink . 
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetDefault
            (
                NXOpen::Assemblies::Arrangement * arrangement /** The new default @link Arrangement Arrangement@endlink . */
            );
            /**
            ...
            (
                const std::vector<NXOpen::Assemblies::Component *> & components /** @link Assemblies::Component Assemblies::Component@endlink s to be suppressed */,
                const std::vector<NXOpen::Assemblies::Arrangement *> & arrangements /** Arrangements in which components should be unsuppressed */,
                const char * expression /** Suppress components if expression evalutes zero else unsuppress components   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /**
            ...
            /** 
                    ...
                    obtained from @link Assemblies::Component::EmptyPartRefsetName Assemblies::Component::EmptyPartRefsetName@endlink  or
                    @link Assemblies::Component::EntirePartRefsetName Assemblies::Component::EntirePartRefsetName@endlink .
            ...
            (
                const char * newReferenceSet /** The name of the new reference set   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<NXOpen::Assemblies::Component *> & components /** Components to be edited. Each component 
                                                                                                    will have its reference set updated in its
                                                                                                    owning assembly. */
            );
            ...
            (
                NXOpen::Assemblies::Component * component /** The component to edit. Must be directly owned by this assembly.*/,
                double realQuantity /** Real quantity value */,
                const char * quantityUnits /** Units   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /**
            ...
            /**        
                    Creates a @link Assemblies::ComponentPatternBuilder Assemblies::ComponentPatternBuilder@endlink  object 
            ...
            /**        
                    Add a pending @link Assemblies::Component Assemblies::Component@endlink  in this assembly.
            ...
            /**        
                    Creates a @link Positioning::ComponentConstraintGroupBuilder Positioning::ComponentConstraintGroupBuilder@endlink  object.
            ...
            /**        
                    Checks in array of components as per the option @link Assemblies::ComponentAssembly::CheckinCheckoutOption Assemblies::ComponentAssembly::CheckinCheckoutOption@endlink .
            ...
            /**        
                    Checks out array of components as per the option @link Assemblies::ComponentAssembly::CheckinCheckoutOption Assemblies::ComponentAssembly::CheckinCheckoutOption@endlink .
            ...
            /**
                    Checks out all modified objects in the current session. checkedOutObjects collection will be type of @link BasePart BasePart@endlink  or @link  PDM::DesignElementRevision  PDM::DesignElementRevision@endlink 
            ...
            /**
             ...
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void GetCheckedoutStatusOfObjects
            (
            ...
            /** Reorders the array of @link Assemblies::Component Assemblies::Component@endlink s before or after the target @link Assemblies::Component Assemblies::Component@endlink .
            ...
            (
                NXOpen::Assemblies::ComponentOrder * order /**  @link Assemblies::ComponentOrder Assemblies::ComponentOrder@endlink  in which components are reordered */,
            ...
            /** Assigns a new order to immediate children @link Assemblies::Component Assemblies::Component@endlink s of parent @link Assemblies::Component Assemblies::Component@endlink .
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void ReorderChildrenOfParent
            (
                NXOpen::Assemblies::ComponentOrder * order /**  @link Assemblies::ComponentOrder Assemblies::ComponentOrder@endlink  in which children are reordered */,
            ...
            /** Returns all @link Assemblies::ComponentOrder Assemblies::ComponentOrder@endlink s available in the part
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: void GetComponentOrders
            (
                std::vector<NXOpen::Assemblies::ComponentOrder *> & orders /** Returns array of @link Assemblies::ComponentOrder Assemblies::ComponentOrder@endlink s in part */
            );
            ...
            */
            ...
            /** The collection of @link Assemblies::ComponentPattern Assemblies::ComponentPattern@endlink  defined in the ComponentAssembly 
             <br>  Created in NX9.0.0.  <br>  
            */
            public: NXOpen::Assemblies::ComponentPatternCollection *ComponentPatterns();
            /** The collection of @link Assemblies::Subset Assemblies::Subset@endlink s defined in the ComponentAssembly 
             <br>  Created in NX8.5.0.  <br>  
            */
            public: NXOpen::Assemblies::SubsetCollection *Subsets();
            /** The collection of @link Assemblies::ClearanceSet Assemblies::ClearanceSet@endlink s defined in the ComponentAssembly 
             <br>  Created in NX9.0.0.  <br>  
            */
            public: NXOpen::Assemblies::ClearanceSetCollection *ClearanceSets();
            /** The collection of @link Assemblies::Order Assemblies::Order@endlink s defined in the ComponentAssembly 
             <br>  Created in NX9.0.0.  <br>  
            */
