...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** This class is the builder that is used for the rapid creation of design variables.  <br> To create a new instance of this class, use @link CAE::CorrelManager::CreateModelUpdateDesignVariablesRapidCreateBuilderBuilder  CAE::CorrelManager::CreateModelUpdateDesignVariablesRapidCreateBuilderBuilder @endlink  <br> 
         <br>  Created in NX8.0.1.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ModelUpdateDesignVariablesRapidCreateBuilder : public Builder
        {
            ...
            (
                const NXString & entityName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** This command selects one entity. 
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : nx_correl_update ("FE Model Update") */
            void SelectEntity
            (
                const char * entityName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & field /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** This command selects one field. 
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : nx_correl_update ("FE Model Update") */
            void SelectField
            (
                const char * field /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
