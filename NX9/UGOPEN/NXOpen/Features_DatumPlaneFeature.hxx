...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a datum plane feature  <br> To create or edit an instance of this class, use @link Features::DatumPlaneBuilder  Features::DatumPlaneBuilder @endlink  <br> 
         <br>  Created in NX3.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  DatumPlaneFeature : public Features::DatumFeature
        {
