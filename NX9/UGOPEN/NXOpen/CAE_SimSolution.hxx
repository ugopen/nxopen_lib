    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimSolution : public CAE::SimGroupContainer
        {
            ...
            (
                NXOpen::CAE::SimConditionSequence * conditionSeqeunce /** populate solution time properties from @link CAE::SimConditionSequence CAE::SimConditionSequence@endlink */
            );
