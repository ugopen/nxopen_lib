...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /** 
                Represents @link ClearanceAnalysisBuilder ClearanceAnalysisBuilder@endlink .  The builder builds the clearance set
             ...
             <br> To create a new instance of this class, use @link Assemblies::AssemblyManager::CreateClearanceAnalysisBuilder  Assemblies::AssemblyManager::CreateClearanceAnalysisBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ClearanceAnalysisBuilder : public Builder
        {
            ...
            (
                ...
                const NXString & text /** note for the exception   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Add an exception. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            (
                ...
                NXOpen::DisplayableObject * comp1 /** the first object of the pair */,
                NXOpen::DisplayableObject * comp2 /** the second object of the pair */,
                const char * text /** note for the exception   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Delete an exception. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /** Create an expression using the Clearance Zone naming convention.
                        ...
                        @link Assemblies::ClearanceAnalysisBuilder::SetDefaultClearanceZone Assemblies::ClearanceAnalysisBuilder::SetDefaultClearanceZone@endlink  
                        @link Assemblies::ClearanceAnalysisBuilder::AddPairClearanceZone Assemblies::ClearanceAnalysisBuilder::AddPairClearanceZone@endlink  
                        @link Assemblies::ClearanceAnalysisBuilder::AddObjectClearanceZone Assemblies::ClearanceAnalysisBuilder::AddObjectClearanceZone@endlink   @return  the new expression 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::Expression * CreateClearanceZoneExpression
            (
                const NXString & rhsExpression /** the text for the expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Create an expression using the Clearance Zone naming convention.
                        The expression is intended for use in the following methods:
                        @link Assemblies::ClearanceAnalysisBuilder::SetDefaultClearanceZone Assemblies::ClearanceAnalysisBuilder::SetDefaultClearanceZone@endlink  
            ...
            (
                const char * rhsExpression /** the text for the expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            /** Inquire the Clearance Zone for a specific pair of objects.  Both objects
                        ...
                        from object 1 or 2 (@link Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Object1 Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Object1@endlink 
                        or @link Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Object2 Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Object2@endlink .
                        @link Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Pair Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Pair@endlink 
                        means this pair has its own explicit clearance zone. 
                        @link Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Default Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Default@endlink  means the default clearance zone is used..  @return  the source of the clearance zone 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /**
                      ...
                      The text parameter is only returned for the @link Assemblies::ClearanceAnalysisBuilder::PairExcludedReason::UserDefined Assemblies::ClearanceAnalysisBuilder::PairExcludedReason::UserDefined@endlink  reason.
                     @return  the flag 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /**  Inquire the Clearance Zone assigned to a given object.  The object must be
                        ...
                        @link Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Defined Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Defined@endlink  specifies 
                        that the object has its own Clearance Zone.  
                        @link Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Default Assemblies::ClearanceAnalysisBuilder::ClearanceZoneSource::Default@endlink  means the 
