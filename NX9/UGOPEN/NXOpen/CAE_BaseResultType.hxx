...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  BaseResultType : public TaggedObject
        {
            ...
            /**Returns  the @link CAE::Result::Quantity CAE::Result::Quantity@endlink  for this result type 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::Result::Quantity Quantity
            (
            );
            /**Returns  the @link CAE::Result::Location CAE::Result::Location@endlink  where this result type is defined
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::Result::Location Location
            (
            );
            /**Returns  the @link CAE::Result::DataType CAE::Result::DataType@endlink  for this result type 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
