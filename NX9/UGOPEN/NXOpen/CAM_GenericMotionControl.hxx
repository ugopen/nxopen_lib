...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Generic Motion Control operation  <br> To create or edit an instance of this class, use @link CAM::GmcOpBuilder  CAM::GmcOpBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  GenericMotionControl : public CAM::Operation
        {
