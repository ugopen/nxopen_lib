    ...
    */
    class NXOPENCPPEXPORT  SelectionIntentRule : public TransientObject
    {
        ...
        public: enum RuleType
        {
            ...
            RuleTypeFeatureIntersectionEdges/** See documentation for  @link  FeatureIntersectionEdgesRule   FeatureIntersectionEdgesRule @endlink  for more details*/,
        ...
        /**Returns  the get the type of selection intent rule: @link  SelectionIntentRule   SelectionIntentRule @endlink  
         <br>  Created in NX3.0.0.  <br>  
