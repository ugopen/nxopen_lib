    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  AssemblyManager
        {
            ...
            /** Creates a @link Assemblies::ClearanceAnalysisBuilder Assemblies::ClearanceAnalysisBuilder@endlink . The builder can be populated 
            ...
            (
                NXOpen::Assemblies::ClearanceSet * clearanceSet /** @link Assemblies::ClearanceSet Assemblies::ClearanceSet@endlink  to be edited - may be NULL if creating a new Clearance Set. */
            );
