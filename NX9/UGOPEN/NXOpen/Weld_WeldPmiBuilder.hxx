...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Create PMI symbols for multiple structure welds, this builder's Commit can produce more than one object, 
                the GetCommittedObjects can be used to get the objects and the order of GetCommittedObject's output array is stable.  <br> To create a new instance of this class, use @link Weld::WeldManager::CreateWeldPmiBuilder  Weld::WeldManager::CreateWeldPmiBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  WeldPmiBuilder : public Builder
        {
