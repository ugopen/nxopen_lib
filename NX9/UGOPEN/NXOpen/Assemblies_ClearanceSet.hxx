...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /** 
            Represents @link ClearanceSet ClearanceSet@endlink .
          <br> Currently we don't support KF at this time.  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ClearanceSet : public NXObject
        {
            ...
            struct  Summary
            {
                ...
                public: /** The analysis mode.  One of
                                                                                   @link Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Lightweight Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Lightweight@endlink ,
                                                                                   @link Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::ExactifLoaded Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::ExactifLoaded@endlink ,
                                                                                   @link Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Exact Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Exact@endlink .
                ...
                public: /** Indicates if the analysis was
                                                                                   ...
                                                                                   @link Assemblies::ClearanceSet::JobStatus::NotAborted Assemblies::ClearanceSet::JobStatus::NotAborted@endlink ,
                                                                                   @link Assemblies::ClearanceSet::JobStatus::AbortedByUser Assemblies::ClearanceSet::JobStatus::AbortedByUser@endlink  and
                                                                                   @link Assemblies::ClearanceSet::JobStatus::AbortedOnError Assemblies::ClearanceSet::JobStatus::AbortedOnError@endlink .
            ...
            /** Inquires a summary of the results of the most recent clearance analysis run. 
                    The @link Assemblies::ClearanceSet::Summary Assemblies::ClearanceSet::Summary@endlink  structure is 
            ...
            /** Makes a copy of a dataset.  You must supply a unique name.  There are three
                    modes in which to copy the dataset: @link Assemblies::ClearanceSet::CopyMode::NoResults Assemblies::ClearanceSet::CopyMode::NoResults@endlink  
                    only copies the setup data.  The version of the new dataset is set to zero (meaning clearance analysis 
                    has not been run);  @link Assemblies::ClearanceSet::CopyMode::Results Assemblies::ClearanceSet::CopyMode::Results@endlink  makes a copy of the current 
                    analysis results, but not the interference bodies; @link Assemblies::ClearanceSet::CopyMode::InterfBodies Assemblies::ClearanceSet::CopyMode::InterfBodies@endlink  
