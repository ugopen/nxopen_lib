...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a motion sensor  <br> To create or edit an instance of this class, use @link Motion::MotionSensorBuilder  Motion::MotionSensorBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSensor : public Motion::MotionObject
        {
