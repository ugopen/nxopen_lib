...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /** Represents a @link Features::ShipDesign::PenetrationRequest Features::ShipDesign::PenetrationRequest@endlink  builder  <br> To create a new instance of this class, use @link Features::ShipDesign::PenetrationRequestCollection::CreatePenetrationReviewRequestBuilder  Features::ShipDesign::PenetrationRequestCollection::CreatePenetrationReviewRequestBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  PenetrationReviewRequestBuilder : public Builder
            {
