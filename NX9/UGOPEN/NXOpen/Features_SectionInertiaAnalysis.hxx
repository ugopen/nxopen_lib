...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a section inertia analysis feature  <br> To create or edit an instance of this class, use @link Features::SectionInertiaAnalysisBuilder  Features::SectionInertiaAnalysisBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SectionInertiaAnalysis : public Features::BodyFeature
        {
