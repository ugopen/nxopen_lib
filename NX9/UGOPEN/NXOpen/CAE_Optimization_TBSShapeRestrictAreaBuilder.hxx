...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents the builder of @link CAE::Optimization::TBSShapeRestrictArea CAE::Optimization::TBSShapeRestrictArea@endlink  <br> To create a new instance of this class, use @link CAE::Optimization::TBSOptimizationManager::CreateShapeRestrictAreaBuilder  CAE::Optimization::TBSOptimizationManager::CreateShapeRestrictAreaBuilder @endlink  <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  TBSShapeRestrictAreaBuilder : public CAE::Optimization::TBSRestrictAreaBuilder
            {
