...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                    Represents a @link Features::VehicleDesign::DynamicCurb Features::VehicleDesign::DynamicCurb@endlink  builder
                     <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateDynamicCurbBuilder  Features::VehicleDesignCollection::CreateDynamicCurbBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  DynamicCurbBuilder : public Features::FeatureBuilder
            {
