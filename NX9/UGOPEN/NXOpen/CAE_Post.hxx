        ...
        */
        class NXOPENCPP_CAEEXPORT  Post
        {
            ...
            /** Set min-max marker options in the input postview id. Needs a PostviewUpdate call to take effect.
                        The input postview id is what was returned from CreatePostview or CreatePostviewForResult 
             <br>  @deprecated Deprecated in NX9.0.0.  Set @link CAE::PostAnnotation CAE::PostAnnotation@endlink  show hide instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Set CAE::PostAnnotation show hide instead.") void PostviewSetMarker
            (
                int postviewId /** postview id */ ,
                bool showMarker /** show marker */ ,
            ...
            /** Set min-max marker box options in the input postview id. Needs a PostviewUpdate call to take effect.
                        The input postview id is what was returned from CreatePostview, CreatePostviewForResult, or CreateCrossSectionViewForResult 
             <br>  @deprecated Deprecated in NX9.0.0.  Set @link CAE::PostAnnotation CAE::PostAnnotation@endlink  Display Attribute directly instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Set CAE::PostAnnotation Display Attribute directly instead.") void PostviewSetAnnotationBox
            (
                int postviewId /** postview id */ ,
            ...
            /** Activate or deactivate the laminate critical loadcase id label display for a given post view. The critical
                        loadcase id display is only supported for @link CAE::LaminateGraphicalReport CAE::LaminateGraphicalReport@endlink  results, for 
                        specific datasets. 
            ...
            /** Create a path from an ordered set of element ids on the input postview id. 
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: int CreatePathFromElemIds
            (
                int postviewId /** postview id */ ,
                const NXString & name /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            /** Creates entity annotation object  @return  
             <br>  @deprecated Deprecated in NX9.0.0.  use @link CAE::Post::JA_SPP_create_annotation CAE::Post::JA_SPP_create_annotation@endlink  with extra face parameter. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  use CAE::Post::JA_SPP_create_annotation with extra face parameter.") NXOpen::CAE::PostAnnotation * CreateAnnotation
            (
                int postviewId /** postview id */ ,
                const NXString & name /** Annotation name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            /** Plot or overlay @link CAE::PostGraph CAE::PostGraph@endlink  objects as XY plot  @return  @link CAE::Xyplot::Plot CAE::Xyplot::Plot@endlink  object 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            (
                ...
                int viewIndex /** View Index */,
                const std::vector<NXOpen::CAE::PostGraph *> & graphs /** @link CAE::PostGraph CAE::PostGraph@endlink  object list*/,
                bool overlay /** overlay option */
            );
            /** Deletes @link CAE::PostGraph CAE::PostGraph@endlink  objects 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
