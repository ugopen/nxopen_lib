...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents the builder for evaluating fatigue histories.  <br> To create a new instance of this class, use @link CAE::DurabilityManager::CreateDurabilityEvaluateFatigueHistoryBuilder  CAE::DurabilityManager::CreateDurabilityEvaluateFatigueHistoryBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurabilityEvaluateFatigueHistoryBuilder : public Builder
        {
            ...
            (
                const NXString & csvFilename /** fatigue history functions will be written-out to this file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Export fatigue history functions to a csv file. 
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            ...
            (
                const char * csvFilename /** fatigue history functions will be written-out to this file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
        };
    }
}
