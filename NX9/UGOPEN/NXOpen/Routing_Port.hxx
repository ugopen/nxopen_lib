...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  Port : public SmartObject, public virtual Routing::IRoutePosition
        {
            ...
            /** The clock angle increment value of @link Port Port@endlink   @return  Clock increment value in degrees 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: double GetClockIncrement
            (
            );
            /** The clock angle increment value of @link Port Port@endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Get the value of flow direction of @link Port Port@endlink   @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::Port::FlowDirectionType GetFlowDirection
            (
            );
            /** Set the flow direction value of @link Port Port@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Returns the forward extension value for a port i.e. the minimum length that
                      * a segment must remain straight coming out of a @link Port Port@endlink   @return  Port extension 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Finds another @link Routing::Port Routing::Port@endlink  to connect this port to.  Builds a
                        ...
                        this port already has a @link Routing::PortConnection Routing::PortConnection@endlink  object referencing it.  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::PortConnection * Connect
            (
            );
            /** Deletes any @link Routing::PortConnection Routing::PortConnection@endlink  objects that reference this port. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /**Returns  the clock angle increment expression of a
                       ...
                       @link Routing::Port Routing::Port@endlink . 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
