...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class CutVolumeImpl;
        /** The classs represent the sub builder for creating cut volume feature items  <br> To create a new instance of this class, use @link CAM::CutVolumeGeom::CreateCutVolume  CAM::CutVolumeGeom::CreateCutVolume @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  CutVolume : public TaggedObject
        {
