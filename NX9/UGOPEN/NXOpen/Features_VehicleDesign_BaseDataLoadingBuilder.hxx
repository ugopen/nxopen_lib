...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::BaseDataLoadingBuilder Features::VehicleDesign::BaseDataLoadingBuilder@endlink .  <br> An instance of this class can be obtained from @link BaseDataBuilder::CreateLoading BaseDataBuilder::CreateLoading@endlink   <br> 
             <br>  Created in NX8.5.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  BaseDataLoadingBuilder : public Builder
            {
