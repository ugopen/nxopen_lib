...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a boundary member set . <br> To create a new instance of this class, use @link CAM::BoundaryMillingSet::CreateBoundaryMillingMemberSet  CAM::BoundaryMillingSet::CreateBoundaryMillingMemberSet @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  BoundaryMillingMemberSet : public CAM::BoundaryMemberSet
        {
