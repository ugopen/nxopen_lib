    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  MechatronicsManager
        {
            ...
            (
                const NXString & itemID /** The Item ID of root function */,
            ...
            (
                const char * itemID /** The Item ID of root function */,
            ...
            (
                const NXString & itemID /** The Item ID of root logical */,
            ...
            (
                const char * itemID /** The Item ID of root logical */,
            ...
            (
                const NXString & itemID /** The Item ID of root requirement */,
            ...
            (
                const char * itemID /** The Item ID of root requirement */,
            ...
            (
                ...
                const NXString & itemID /** The Item ID of child function item */,
            ...
            (
                NXOpen::Mechatronics::SystemObject * object /** The parent object */,
                const char * itemID /** The Item ID of child function item */,
            ...
            (
                NXOpen::Mechatronics::SystemObject * object /** The parent object */,
                const NXString & itemID /** The Item ID of child logical item */,
            ...
            (
                NXOpen::Mechatronics::SystemObject * object /** The parent object */,
                const char * itemID /** The Item ID of child logical item */,
            ...
            (
                NXOpen::Mechatronics::SystemObject * object /** The parent object */,
                const NXString & itemID /** The Item ID of child requirement item */,
            ...
            (
                NXOpen::Mechatronics::SystemObject * object /** The parent object */,
                const char * itemID /** The Item ID of child requirement item */,
            ...
            /** Creates a @link Mechatronics::DependencyCreatorBuilder Mechatronics::DependencyCreatorBuilder@endlink  object.  @return  DependencyCreator Builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
