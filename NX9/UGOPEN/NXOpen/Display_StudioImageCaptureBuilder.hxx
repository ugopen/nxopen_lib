...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a @link Display::StudioImageCaptureBuilder Display::StudioImageCaptureBuilder@endlink   
            ...
            return NULL. <br>  <br> To create a new instance of this class, use @link ViewCollection::CreateStudioImageCaptureBuilder  ViewCollection::CreateStudioImageCaptureBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  StudioImageCaptureBuilder : public Builder
        {
