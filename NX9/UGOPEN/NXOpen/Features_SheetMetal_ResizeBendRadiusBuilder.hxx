...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ResizeBendRadiusBuilder : public Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                /**Returns  the relief type for the resize bend radius feature.The options are in @link Features::SheetMetal::ResizeBendRadiusBuilder::BendReliefType Features::SheetMetal::ResizeBendRadiusBuilder::BendReliefType@endlink . 
