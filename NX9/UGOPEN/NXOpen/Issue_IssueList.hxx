    ...
    namespace Issue
    {
        ...
        */
        class NXOPENCPP_ISSUEEXPORT  IssueList : public NXObject
        {
            ...
            /** Saves the config of @link Issue::IssueList Issue::IssueList@endlink  to server 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_issue_mgmt ("NX Issue Tracking") */
            public: void SaveConfig
            (
            );
            /** Resets the config of @link Issue::IssueList Issue::IssueList@endlink  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_issue_mgmt ("NX Issue Tracking") */
            public: void ResetConfig
            (
            );
            /** Changes the config of @link Issue::IssueList Issue::IssueList@endlink  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_issue_mgmt ("NX Issue Tracking") */
            ...
            /** Sets the related parts of @link Issue::IssueList Issue::IssueList@endlink  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_issue_mgmt ("NX Issue Tracking") */
