    ...
    */
    class NXOPENCPPEXPORT  Session : public BaseSession
    {
        ...
        */
        ...
        /** Returns the @link MechatronicsSession MechatronicsSession@endlink  belonging to this session 
         <br>  Created in NX9.0.0.  <br>  
        */
        public: NXOpen::Mechatronics::MechatronicsSession *MechatronicsSession();
        /** Returns the @link PDM::ConfigurationManager PDM::ConfigurationManager@endlink  belonging to this session 
         <br>  Created in NX9.0.0.  <br>  
        */
        ...
        /** Returns the Gateway.BookmarkCollection instance belonging to this session 
         <br>  Created in NX9.0.0.  <br>  
        */
        public: NXOpen::Gateway::BookmarkCollection *Bookmarks();
        /** Returns the @link SubdivisionTaskEnvironment SubdivisionTaskEnvironment@endlink  belonging to this session 
         <br>  Created in NX9.0.0.  <br>  
        */
