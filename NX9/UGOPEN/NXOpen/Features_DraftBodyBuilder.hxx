...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  DraftBodyBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the matching option 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link Features::DraftBodyBuilder::MatchScope Features::DraftBodyBuilder::MatchScope@endlink  instead <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Features::DraftBodyBuilder::MatchScope instead") NXOpen::Features::DraftBodyBuilder::MatchOption MatchingOption
            (
            );
            /**Sets  the matching option 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link Features::DraftBodyBuilder::SetMatchScope Features::DraftBodyBuilder::SetMatchScope@endlink  instead <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Features::DraftBodyBuilder::SetMatchScope instead") void SetMatchingOption
            (
            ...
            /**Returns  the repairing option 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link Features::DraftBodyBuilder::RepairPartingEdge Features::DraftBodyBuilder::RepairPartingEdge@endlink  instead <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Features::DraftBodyBuilder::RepairPartingEdge instead") NXOpen::Features::DraftBodyBuilder::RepairOption RepairingOption
            (
            );
            /**Sets  the repairing option 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link Features::DraftBodyBuilder::SetRepairPartingEdge Features::DraftBodyBuilder::SetRepairPartingEdge@endlink  instead <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Features::DraftBodyBuilder::SetRepairPartingEdge instead") void SetRepairingOption
            (
            ...
            /**Returns  the repair radius 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link Features::DraftBodyBuilder::FilletRadius Features::DraftBodyBuilder::FilletRadius@endlink  instead <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Features::DraftBodyBuilder::FilletRadius instead") NXOpen::Expression * RepairRadius
            (
            );
