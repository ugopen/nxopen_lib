        ...
        */
        class NXOPENCPP_CAMEXPORT  NcmPlanarBuilder : public CAM::NcmSubopBuilder
        {
            ...
            /**Returns  the transfer between regions type 
             <br>  @deprecated Deprecated in NX9.0.0.  Please use @link CAM::NcmTransfer::Type CAM::NcmTransfer::Type@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Please use CAM::NcmTransfer::Type instead.") NXOpen::CAM::NcmPlanarBuilder::TransferBetweenRegionsTypes TransferBetweenRegionsType
            (
            );
            /**Sets  the transfer between regions type 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Please use CAM::NcmTransfer::Type instead.") void SetTransferBetweenRegionsType
            (
            ...
            /**Returns  the transfer between regions safe distance builder (inheritable tool dep) 
             <br>  @deprecated Deprecated in NX9.0.0.  Please use @link CAM::NcmTransfer::SafeDistanceBuilder CAM::NcmTransfer::SafeDistanceBuilder@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Please use CAM::NcmTransfer::SafeDistanceBuilder instead.") NXOpen::CAM::InheritableToolDepBuilder * TransferBetweenRegionsSafeDistanceBuilder
            (
            );
