...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represent a sensor selection configuration  <br> To create or edit an instance of this class, use @link CAE::PreTestSensorConfigBuilder  CAE::PreTestSensorConfigBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  PreTestSensorConfig : public NXObject
        {
