...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  SurfaceContourBuilder : public CAM::MillOperationBuilder
        {
            ...
            /**Returns  the tool axis builder 
             <br>  @deprecated Deprecated in NX7.5.0.  Please use @link ToolAxisFixed ToolAxisFixed@endlink  or @link ToolAxisVariable ToolAxisVariable@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0.  Please use ToolAxisFixed or ToolAxisVariable instead.") NXOpen::CAM::ToolAxisCiBuilder * ToolAxis
            (
            );
