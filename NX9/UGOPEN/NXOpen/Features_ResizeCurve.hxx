...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a resize curve feature  <br> To create or edit an instance of this class, use @link Features::ResizeCurveBuilder  Features::ResizeCurveBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  ResizeCurve : public Features::BodyFeature
        {
