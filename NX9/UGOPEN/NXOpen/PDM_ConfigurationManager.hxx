...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        /** Represents Configuration Manager   <br> Use @link Session::ConfigurationManager Session::ConfigurationManager@endlink  to get the instance of this class.  <br> 
        ...
        */
        class NXOPENCPP_PDMEXPORT  ConfigurationManager
        {
            ...
            /** Creates a new @link PDM::ConfigurationContextBuilder PDM::ConfigurationContextBuilder@endlink  object for 
                        @link  PDM::ConfigurationContextBuilder::ConfigContextModeAssemblies   PDM::ConfigurationContextBuilder::ConfigContextModeAssemblies @endlink 
            ...
            /** Creates a new @link PDM::EffectivityAttributePropertiesBuilder PDM::EffectivityAttributePropertiesBuilder@endlink  object.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
