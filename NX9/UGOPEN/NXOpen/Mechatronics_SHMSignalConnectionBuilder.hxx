...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::SHMSignalConnectionBuilder Mechatronics::SHMSignalConnectionBuilder@endlink   <br> To create a new instance of this class, use @link Mechatronics::SHMSignalConnectionCollection::CreateSHMSignalConnectionBuilder  Mechatronics::SHMSignalConnectionCollection::CreateSHMSignalConnectionBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SHMSignalConnectionBuilder : public Builder
        {
