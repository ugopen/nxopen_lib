...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  HingeJointCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Mechatronics::HingeJointBuilder Mechatronics::HingeJointBuilder@endlink .  @return  
             <br>  Created in NX7.5.1.  <br>  
            ...
            /** Finds the @link  Mechatronics::HingeJoint   Mechatronics::HingeJoint @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  Mechatronics::HingeJoint   Mechatronics::HingeJoint @endlink  with this name. 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            (
                const char * name /** The name of the @link  Mechatronics::HingeJoint   Mechatronics::HingeJoint @endlink . */
            );
