...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Normal Cutout feature  <br> To create or edit an instance of this class, use @link Features::SheetMetal::NormalCutoutBuilder  Features::SheetMetal::NormalCutoutBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  NormalCutout : public Features::Feature
        {
