...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ReplaceFaceBuilder : public Features::FeatureBuilder
        {
            ...
            */
            ...
            /**Returns  the replace face type, set UGII_Simplify_Surface to 1 if wants to use simplify type, don't use it until nx502 
             <br>  Created in NX5.0.2.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ReplaceFaceBuilder::ReplaceTypes Type
            (
            );
            /**Sets  the replace face type, set UGII_Simplify_Surface to 1 if wants to use simplify type, don't use it until nx502 
             <br>  Created in NX5.0.2.  <br>  
