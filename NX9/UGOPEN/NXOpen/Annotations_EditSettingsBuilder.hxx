...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** the edit settings builder  <br> To create a new instance of this class, use @link Drafting::SettingsManager::CreateAnnotationEditSettingsBuilder  Drafting::SettingsManager::CreateAnnotationEditSettingsBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  EditSettingsBuilder : public Drafting::BaseEditSettingsBuilder
        {
