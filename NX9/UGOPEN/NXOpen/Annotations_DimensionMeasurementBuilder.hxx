...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link Annotations::DimensionMeasurementBuilder Annotations::DimensionMeasurementBuilder@endlink 
             <br> This is a sub-builder class and cannot be directly instantiated  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionMeasurementBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the measurement direction when using @link Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint@endlink   (optional) 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * Direction
            (
            );
            /**Sets  the measurement direction when using @link Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint@endlink   (optional) 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") OR solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the measurement direction view when using @link Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint@endlink   (optional) 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::View * DirectionView
            (
            );
            /**Sets  the measurement direction view when using @link Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint Annotations::DimensionMeasurementBuilder::MeasurementMethodPointToPoint@endlink   (optional) 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") OR solid_modeling ("SOLIDS MODELING") */
