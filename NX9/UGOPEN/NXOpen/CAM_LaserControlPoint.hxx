...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Laser Control Point builder  <br> To create a new instance of this class, use @link CAM::LaserProfileMove::CreateControlPoint  CAM::LaserProfileMove::CreateControlPoint @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  LaserControlPoint : public TaggedObject
        {
