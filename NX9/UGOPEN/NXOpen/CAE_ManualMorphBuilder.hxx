...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::ManualMorphBuilder CAE::ManualMorphBuilder@endlink  <br> To create a new instance of this class, use @link CAE::NodeElementManager::CreateManualMorphBuilder  CAE::NodeElementManager::CreateManualMorphBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ManualMorphBuilder : public Builder
        {
            ...
            (
                ...
                const NXString & mapName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Sets the name of manual mapping
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            (
                NXOpen::TaggedObject * mapDataTag /** mapdatatag */ ,
                const char * mapName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
