...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**  @brief  This class represents a named measurable quantity.  A collection of @link CAE::SimConditionParam CAE::SimConditionParam@endlink  
                represents a measurable environment.  A @link CAE::SimCondition CAE::SimCondition@endlink  consists of specified values for
                all @link CAE::SimConditionParam CAE::SimConditionParam@endlink , thus defining a state of the measurable environment. 

           <br> An instance of this class can be obtained from @link CAE::SimConditionSeqMgr CAE::SimConditionSeqMgr@endlink .  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SimConditionParam : public TaggedObject
        {
            ...
            /** Modifies the name and units of @link CAE::SimConditionParam CAE::SimConditionParam@endlink .
