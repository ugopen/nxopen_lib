...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        /**
                Represents an @link PDM::EffectivityAttributePropertiesBuilder PDM::EffectivityAttributePropertiesBuilder@endlink  to be used for creating effectivity attributes.
                The attribute will be distributed to all objects supplied in the selected object list.
             <br> To create a new instance of this class, use @link PDM::ConfigurationManager::CreateEffectivityAttributePropertiesBuilder  PDM::ConfigurationManager::CreateEffectivityAttributePropertiesBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_PDMEXPORT  EffectivityAttributePropertiesBuilder : public Builder
        {
