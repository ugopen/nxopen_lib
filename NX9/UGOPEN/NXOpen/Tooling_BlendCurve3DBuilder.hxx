...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**Represents a @link Tooling::BlendCurve3DBuilder Tooling::BlendCurve3DBuilder@endlink  builder which implements 
            ...
            used to get the objects. The input curves will be deleted.  <br> To create a new instance of this class, use @link Tooling::CAMDataManager::CreateBlendCurve3dBuilder  Tooling::CAMDataManager::CreateBlendCurve3dBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  BlendCurve3DBuilder : public Builder
        {
            /** The input curves option to keep, hide or delete input curves */
            public: enum InputCurvesOption
            {
                InputCurvesOptionKeep/** keep */ ,
                InputCurvesOptionHide/** hide */ ,
                InputCurvesOptionDelete/** delete */ 
            };
