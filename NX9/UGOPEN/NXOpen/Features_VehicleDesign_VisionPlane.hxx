...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a vision plane feature.  <br> To create or edit an instance of this class, use @link Features::VehicleDesign::VisionPlaneBuilder  Features::VehicleDesign::VisionPlaneBuilder @endlink  <br> 
