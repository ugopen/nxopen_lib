...
namespace NXOpen
{
    ...
    namespace Layout2d
    {
        ...
        /** Represents a Builder for Define 2D component functionality which will define
             *  a 2D Component and stores its definition in the Reuse Library              <br> To create a new instance of this class, use @link Layout2d::ComponentCollection::CreateDefineComponentBuilder  Layout2d::ComponentCollection::CreateDefineComponentBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_LAYOUT2DEXPORT  DefineComponentBuilder : public Builder
        {
