...
namespace NXOpen
{
    ...
    namespace Formboard
    {
        ...
        */
        class NXOPENCPP_FORMBOARDEXPORT  OrientBranchBuilder : public Builder
        {
            ...
            /**Returns  the user selected @link  Formboard::OrientBranchBuilder::BranchAngleMethod   Formboard::OrientBranchBuilder::BranchAngleMethod @endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            public: NXOpen::Formboard::OrientBranchBuilder::BranchAngleMethod BranchAngleType
            (
            );
            /**Sets  the user selected @link  Formboard::OrientBranchBuilder::BranchAngleMethod   Formboard::OrientBranchBuilder::BranchAngleMethod @endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            ...
            /**Returns  the user selected from point when @link  Formboard::OrientBranchBuilder::BranchAngleMethod   Formboard::OrientBranchBuilder::BranchAngleMethod @endlink  is 
             ...
             <br>  @deprecated Deprecated in NX8.5.0.  This @link  Formboard::OrientBranchBuilder::BranchAngleMethodTwoPoints   Formboard::OrientBranchBuilder::BranchAngleMethodTwoPoints @endlink  is no longer supported. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This  Formboard::OrientBranchBuilder::BranchAngleMethodTwoPoints  is no longer supported.") NXOpen::Point * FromPoint
            (
            );
            /**Sets  the user selected from point when @link  Formboard::OrientBranchBuilder::BranchAngleMethod   Formboard::OrientBranchBuilder::BranchAngleMethod @endlink  is 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This  Formboard::OrientBranchBuilder::BranchAngleMethodTwoPoints  is no longer supported.") void SetFromPoint
            (
            ...
            /**Returns  the user selected to point when @link  Formboard::OrientBranchBuilder::BranchAngleMethod   Formboard::OrientBranchBuilder::BranchAngleMethod @endlink  is 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This  Formboard::OrientBranchBuilder::BranchAngleMethodTwoPoints  is no longer supported.") NXOpen::Point * ToPoint
            (
            );
            /**Sets  the user selected to point when @link  Formboard::OrientBranchBuilder::BranchAngleMethod   Formboard::OrientBranchBuilder::BranchAngleMethod @endlink  is 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  This  Formboard::OrientBranchBuilder::BranchAngleMethodTwoPoints  is no longer supported.") void SetToPoint
            (
