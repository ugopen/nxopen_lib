...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** this class represents the "this class represents Drawings.CustomViewSettingsBuilder..
                ...
                settings are subset of the view style settings  <br> To create a new instance of this class, use @link Drawings::DraftingViewCollection::CreateCustomViewSettingsBuilder  Drawings::DraftingViewCollection::CreateCustomViewSettingsBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  CustomViewSettingsBuilder : public Builder
        {
