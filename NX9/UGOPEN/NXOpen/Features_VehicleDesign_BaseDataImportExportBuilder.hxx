...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::BaseDataImportExportBuilder Features::VehicleDesign::BaseDataImportExportBuilder@endlink  
                        builder used to import and export expressions from and to a spreadsheet. <br> To create a new instance of this class, use @link Features::VehicleDesignCollection::CreateBaseDataImportExportBuilder  Features::VehicleDesignCollection::CreateBaseDataImportExportBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  BaseDataImportExportBuilder : public Builder
            {
                ...
                (
                    const NXString & itemId /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    NXString* itemRevision /** itemrevision */ ,
                    bool* revSensitivity /** revsensitivity */ 
                );
                /** Used to assign Item revision in Teamcenter. 
                ...
                (
                    const char * itemId /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    NXString* itemRevision /** itemrevision */ ,
                    bool* revSensitivity /** revsensitivity */ 
                );
            };
