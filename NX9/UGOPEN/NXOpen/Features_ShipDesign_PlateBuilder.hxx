...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                    Represents a @link Features::ShipDesign::Plate Features::ShipDesign::Plate@endlink  builder. This builder is used to
                    ...
                    boundary faces or planes. And also a solid body cab be adopted as a plate.
                     <br> To create a new instance of this class, use @link Features::ShipCollection::CreatePlateBuilder  Features::ShipCollection::CreatePlateBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PlateBuilder : public Features::FeatureBuilder
            {
