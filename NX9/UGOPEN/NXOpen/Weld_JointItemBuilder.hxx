...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Used to create or edit a @link Weld::WeldJoint Weld::WeldJoint@endlink  feature.  <br> To create a new instance of this class, use @link Weld::WeldJointBuilder::NewItem  Weld::WeldJointBuilder::NewItem @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  JointItemBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
