...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a collection of laminate dynamic sims  <br> To obtain an instance of this class, refer to @link CAE::LaminateManager  CAE::LaminateManager @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  LaminateDynamicSimCollection : public TaggedObjectCollection
        {
            ...
            public:
                ...
                typedef CAE::LaminateDynamicSim * value_type;
                /** Default constructor */
