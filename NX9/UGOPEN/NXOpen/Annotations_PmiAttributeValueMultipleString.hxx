...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI Attribute MultipleString Value  <br> To create or edit an instance of this class, use @link Annotations::PmiAttributeValueMultipleStringBuilder  Annotations::PmiAttributeValueMultipleStringBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiAttributeValueMultipleString : public Annotations::PmiAttributeValue
        {
