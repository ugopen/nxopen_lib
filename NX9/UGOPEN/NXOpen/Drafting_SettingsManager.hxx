...
namespace NXOpen
{
    ...
    namespace Drafting
    {
        ...
        /** Represents an object that manages drafting settings.  <br> To obtain an instance of this class, refer to @link Part  Part @endlink  <br> 
        ...
        */
        class NXOPENCPP_DRAFTINGEXPORT  SettingsManager
        {
            ...
            /** Creates a @link Drafting::PreferencesBuilder Drafting::PreferencesBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NXOpen::Drafting::PreferencesBuilder * CreatePreferencesBuilder
            (
            );
            /** Creates a @link Annotations::EditSettingsBuilder Annotations::EditSettingsBuilder@endlink   @return  The annotations settings builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Drawings::EditSectionLineSettingsBuilder Drawings::EditSectionLineSettingsBuilder@endlink   @return  The section line settings builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Drawings::EditViewSettingsBuilder Drawings::EditViewSettingsBuilder@endlink   @return  The view settings builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Layout2d::EditComponentSettingsBuilder Layout2d::EditComponentSettingsBuilder@endlink  
                        This builder is the interface to edit the 2d component settings of 2d layout
            ...
            /** Creates a @link Drawings::EditViewLabelSettingsBuilder Drawings::EditViewLabelSettingsBuilder@endlink   @return  The view label settings builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Creates a @link Annotations::TableEditSettingsBuilder Annotations::TableEditSettingsBuilder@endlink   @return  The table settings builder 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Process edit settings builders for mutiple objects
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void ProcessForMutipleObjectsSettings
            (
