        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PartModuleBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the option indicating whether only part module contents are to be shown. If true, only displayable objects in the part module will be shown. Else, no action is taken.
                      <br> 
                     This API is now deprecated.
                     Please use @link Features::PartModule::ShowOnly Features::PartModule::ShowOnly@endlink  instead.
                      <br> 
                    
             <br>  @deprecated Deprecated in NX9.0.0.  Please use @link Features::PartModule::ShowOnly Features::PartModule::ShowOnly@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Please use Features::PartModule::ShowOnly instead.") bool ShowOnlyPartModule
            (
            );
            /**Sets  the option indicating whether only part module contents are to be shown. If true, only displayable objects in the part module will be shown. Else, no action is taken.
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Please use Features::PartModule::ShowOnly instead.") void SetShowOnlyPartModule
            (
