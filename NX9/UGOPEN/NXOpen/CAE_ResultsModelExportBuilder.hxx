...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::ResultsModelExportBuilder CAE::ResultsModelExportBuilder@endlink   <br> To obtain an instance of this class use @link Session::ResultManager Session::ResultManager@endlink .  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ResultsModelExportBuilder : public CAE::ResultsManipulationBuilder
        {
