...
namespace NXOpen
{
    ...
    namespace PartFamily
    {
        ...
        /**
             ...
             <br> Use @link Assemblies::Component::CreateEmptyPartFamilyInstanceSelectionCriteria Assemblies::Component::CreateEmptyPartFamilyInstanceSelectionCriteria@endlink  to get an instance of this class.  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_PARTFAMILYEXPORT  InstanceSelectionCriteria : public TaggedObject
        {
            ...
            /**Returns  the @link PartFamily::Template PartFamily::Template@endlink  that corresponds to this criteria object 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::PartFamily::Template * Family
            (
            );
            /**Returns  the @link PartFamily::Instance PartFamily::Instance@endlink  of criteria. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** Sets criteria on @link PartFamily::InstanceSelectionCriteria PartFamily::InstanceSelectionCriteria@endlink .
