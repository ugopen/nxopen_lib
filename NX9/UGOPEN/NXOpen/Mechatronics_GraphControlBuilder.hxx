        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  GraphControlBuilder : public Mechatronics::PhysicsConstraintBuilder
        {
            ...
            /**Returns  a cam profile that contains a number of curves that describes the dependency of 
                        the motion of a Slave Axis with respect to the Master Axis. This can be @link CamProfile CamProfile@endlink .
            ...
            /**Returns  the select axis joint. This can be a * @link HingeJoint HingeJoint@endlink ,
                         @link SlidingJoint SlidingJoint@endlink , @link CylindricalJoint CylindricalJoint@endlink . 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
