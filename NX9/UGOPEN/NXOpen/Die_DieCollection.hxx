...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  DieCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Die::QuickBinderBuilder Die::QuickBinderBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Die::QuickBinderBuilder * CreateQuickBinderBuilder
            (
                NXOpen::Features::QuickBinder * quickBinder /** @link Features::QuickBinder Features::QuickBinder@endlink  to be edited */
            );
            /** Creates a @link Die::QuickBinderWrapBuilder Die::QuickBinderWrapBuilder@endlink .  @return  
            ...
            /** Creates a @link Die::TrimLineDevelopmentBuilder Die::TrimLineDevelopmentBuilder@endlink .  @return  
            ...
            /** Creates a @link Die::AddSurfBuilder Die::AddSurfBuilder@endlink .  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /** Creates a @link Die::FaceSheetBuilder Die::FaceSheetBuilder@endlink .  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Creates a die_shoe feature builder @link Die::DieShoeBuilder Die::DieShoeBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a @link Die::DieAttributesBuilder Die::DieAttributesBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::DieAttributesBuilder * CreateDieAttribute
            (
            );
            /** Creates a @link Die::DieBooleanBuilder Die::DieBooleanBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::DieBooleanBuilder * CreateDieBoolean
            (
            );
            /** Creates a @link Die::DieDirectionBuilder Die::DieDirectionBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a @link Die::DiePlaneBuilder Die::DiePlaneBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a clamping slot feature builder @link Die::ClampingSlotBuilder Die::ClampingSlotBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a @link Die::CompensateRoughDataBuilder Die::CompensateRoughDataBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Creates a keyway feature builder @link Die::KeywayBuilder Die::KeywayBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a heelpost feature builder @link Die::HeelpostBuilder Die::HeelpostBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a cast relief feature builder @link Die::CastReliefBuilder Die::CastReliefBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a @link Die::UncutRegionsBuilder Die::UncutRegionsBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Die::UncutRegionsBuilder * CreateUncutRegionsBuilder
            (
            );
            /** Creates a @link Die::DieLocationBuilder Die::DieLocationBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::DieLocationBuilder * CreateDieLocation
            (
            );
            /** Creates a @link Die::DieLimitsBuilder Die::DieLimitsBuilder@endlink .  @return  
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Die::DieLimitsBuilder * CreateDieLimits
            (
            );
            /** Creates a @link Die::DieLocationsBuilder Die::DieLocationsBuilder@endlink .  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            ...
            /** Creates a fill area builder @link Die::FillAreaBuilder Die::FillAreaBuilder@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::FillAreaBuilder * CreateFillAreaBuilder
            (
                NXOpen::Die::FillArea * fillArea /** @link Die::FillArea Die::FillArea@endlink  to be edited. */
            );
            /** Creates a finger clearance notch builder @link Die::FingerClearanceNotchBuilder Die::FingerClearanceNotchBuilder@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::FingerClearanceNotchBuilder * CreateFingerClearanceNotchBuilder
            (
                NXOpen::Die::FingerClearanceNotch * fingerClearanceNotch /** @link Die::FingerClearanceNotch Die::FingerClearanceNotch@endlink  to be edited. */
            );
            /** Creates a clearance builder @link Die::ClearanceBuilder Die::ClearanceBuilder@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::ClearanceBuilder * CreateClearanceBuilder
            (
                NXOpen::Die::Clearance * clearance /** @link Die::Clearance Die::Clearance@endlink  to be edited. */
            );
            /** Creates a handling core builder @link Die::HandlingCoreBuilder Die::HandlingCoreBuilder@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::HandlingCoreBuilder * CreateHandlingCoreBuilder
            (
                NXOpen::Die::HandlingCore * handlingCore /** @link Die::HandlingCore Die::HandlingCore@endlink  to be edited. */
            );
            /** Creates a machine relief builder @link Die::MachineReliefBuilder Die::MachineReliefBuilder@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::MachineReliefBuilder * CreateMachineReliefBuilder
            (
                NXOpen::Die::MachineRelief * machineRelief /** @link Die::MachineRelief Die::MachineRelief@endlink  to be edited. */
            );
            /** Creates a draw bead builder @link Die::DrawBeadBuilder Die::DrawBeadBuilder@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Die::DrawBeadBuilder * CreateDrawBeadBuilder
            (
                NXOpen::Die::DrawBead * drawBead /** @link Die::DrawBead Die::DrawBead@endlink  to be edited. */
            );
            /** Creates a springback compensation builder @link Die::SpringbackCompensationBuilder Die::SpringbackCompensationBuilder@endlink .  @return  
             <br>  Created in NX7.5.0.  <br>  
            ...
            (
                NXOpen::Die::SpringbackCompensation * springbackCompensation /** @link Die::SpringbackCompensation Die::SpringbackCompensation@endlink  to be edited */
            );
