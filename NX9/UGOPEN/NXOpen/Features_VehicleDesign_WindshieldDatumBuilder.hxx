...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /**
                    Represents a @link Features::VehicleDesign::WindshieldDatum Features::VehicleDesign::WindshieldDatum@endlink  builder used to create or edit a Windshield Datum.
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  WindshieldDatumBuilder : public Features::FeatureBuilder
            {
