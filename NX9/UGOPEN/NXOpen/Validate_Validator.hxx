        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  Validator : public TaggedObject
        {
            ...
            /** Runs checking process and returns the checking status.
                        ...
                        Call @link Validate::Validator::GetLastErrorListFromCommit Validate::Validator::GetLastErrorListFromCommit@endlink  for the execeptions happened during the checking process.
                     @return  
             <br>  Created in NX7.5.0.  <br>  
            ...
            /** Return the list of errors happened during last @link Validate::Validator::Commit Validate::Validator::Commit@endlink .
