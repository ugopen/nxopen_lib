...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  HoleBossGeom : public TaggedObject
        {
            ...
            */
            ...
            /** the depth limit types 
             <br>  @deprecated Deprecated in NX8.0.0.  The property that used this enum is replaced by @link CAM::HoleBossSet::DepthLimit CAM::HoleBossSet::DepthLimit@endlink . <br>  

             <br>  Created in NX7.5.0.  <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  The property that used this enum is replaced by CAM::HoleBossSet::DepthLimit.") enum DepthLimitTypes
            {
            ...
            */
            ...
            /**Returns  the Depth Limit types 
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAM::HoleBossSet::DepthLimit CAM::HoleBossSet::DepthLimit@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAM::HoleBossSet::DepthLimit instead.") NXOpen::CAM::HoleBossGeom::DepthLimitTypes DepthLimit
            (
            );
            /**Sets  the Depth Limit types 
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAM::HoleBossSet::SetDepthLimit CAM::HoleBossSet::SetDepthLimit@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAM::HoleBossSet::SetDepthLimit instead.") void SetDepthLimit
            (
