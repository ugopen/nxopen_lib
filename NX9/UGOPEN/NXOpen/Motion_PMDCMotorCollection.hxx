...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PMDCMotorCollection : public TaggedObjectCollection
        {
            ...
            /**   Return  @link  Motion::PMDCMotorBuilder   Motion::PMDCMotorBuilder @endlink  object   @return  PMDCMotorBuilder object 
             <br>  Created in NX6.0.0.  <br>  
