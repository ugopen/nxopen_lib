...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  CutParameters : public TaggedObject
        {
            ...
            /**Returns  the Part Safe Clearance  
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAM::CutParameters::HolderClearance instead.") NXOpen::CAM::InheritableToolDepBuilder * PartSafeClearance
            (
            );
