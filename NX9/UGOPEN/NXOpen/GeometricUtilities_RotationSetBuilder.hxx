...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  RotationSetBuilder : public TaggedObject, public virtual INXObject, public virtual GeometricUtilities::IComponentBuilder
        {
