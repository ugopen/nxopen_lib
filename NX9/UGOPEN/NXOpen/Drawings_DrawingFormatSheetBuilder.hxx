...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /**
            Represents a @link Drawings::DrawingFormatSheetBuilder Drawings::DrawingFormatSheetBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  DrawingFormatSheetBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
