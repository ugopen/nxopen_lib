...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /**
            Represents a @link Display::SaveImageFileBrowserBuilder Display::SaveImageFileBrowserBuilder@endlink .
            ...
            return NULL. <br> 
             <br> To create a new instance of this class, use @link ViewCollection::CreateSaveImageFileBrowserBuilder  ViewCollection::CreateSaveImageFileBrowserBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DISPLAYEXPORT  SaveImageFileBrowserBuilder : public Builder
        {
