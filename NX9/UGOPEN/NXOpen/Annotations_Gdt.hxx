...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  Gdt : public Annotations::SimpleDraftingAid, public virtual Annotations::IFcf
        {
            ...
            /** Returns the single FCF frames data  @return  FCF frame data 
            ...
            /** Returns the multiple FCF frames data  @return  FCF frame datas 
