...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Solid Punch feature  <br> To create or edit an instance of this class, use @link Features::SheetMetal::SolidPunchBuilder  Features::SheetMetal::SolidPunchBuilder @endlink  <br> 
         <br>  Created in NX6.0.2.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SolidPunch : public Features::Feature
        {
