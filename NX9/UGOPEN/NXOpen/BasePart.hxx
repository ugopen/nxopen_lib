    ...
    */
    class NXOPENCPPEXPORT  BasePart : public NXObject
    {
        ...
        /**Returns  the full path of the part. When called in a managed environment, this will give the same value as 
                @link BasePart::Leaf BasePart::Leaf@endlink . 
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Creates copy of target part.  @return  Parts that could could not saved and their associated errors. 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        ...
        (
            const char * fileName /** name of part file to open   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::BasePart::CloseModified closeModified /** Behavior of close if component
                        parts are modified. */,
            NXOpen::PartCloseResponses * responses /** Class representing list of parts to close or leave open if modified. Only
                        used if closed_modified is set to
        ...
        (
            ...
            NXOpen::BasePart::BookmarkOption option /** See definitions of <ja_type>BasePart.BookmarkOption</ja_type> */
        );
        /** Saves a bookmark file. 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        void SaveBookmark
        (
            const char * fileName /** Name of bookmark file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::BasePart::BookmarkOption option /** See definitions of <ja_type>BasePart.BookmarkOption</ja_type> */
        );

        /// \cond NX_NO_DOC 
        /** Saves a bookmark file including a description for the bookmark. 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: void SaveBookmarkWithDescription
        (
            const NXString & fileName /** Name of bookmark file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::BasePart::BookmarkOption option /** See definitions of <ja_type>BasePart.BookmarkOption</ja_type> */,
        ...
        /** Saves a bookmark file including a description for the bookmark. 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        void SaveBookmarkWithDescription
        (
            const char * fileName /** Name of bookmark file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::BasePart::BookmarkOption option /** See definitions of <ja_type>BasePart.BookmarkOption</ja_type> */,
        ...
        /** Creates a @link Display::DynamicSectionBuilder Display::DynamicSectionBuilder@endlink  
                ...
                will be thrown.    
                 <br> 
              @return  
         <br>  @deprecated Deprecated in NX6.0.0.  Use @link NXOpen::BasePart::DynamicSections NXOpen::BasePart::DynamicSections @endlink and @link NXOpen::BasePart::SetDynamicSections NXOpen::BasePart::SetDynamicSections @endlink  instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX6.0.0.  Use NXOpen::BasePart::DynamicSections NXOpen::BasePart::DynamicSections @endlink and @link NXOpen::BasePart::SetDynamicSections NXOpen::BasePart::SetDynamicSections @endlink  instead.") NXOpen::Display::DynamicSectionBuilder * CreateDynamicSectionBuilder
        (
        ...
        /** Creates a @link ReferenceSet ReferenceSet@endlink  object  @return  New reference set object 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ReferenceSet * CreateReferenceSet
        (
        );
        /** Deletes a @link ReferenceSet ReferenceSet@endlink  object 
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Get all the @link ReferenceSet ReferenceSet@endlink  objects in this part.  Does not include the default reference sets Empty and Entire Part.  @return  
        ...
        (
            const NXString & newUniqueName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Sets the unique name on part for the Make Unique operation 
         <br>  Created in NX8.0.0.  <br>  
         <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
        ...
        (
            const char * newUniqueName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Creates a @link EffectivityConditionBuilder EffectivityConditionBuilder@endlink   @return  
        ...
        /** Creates a @link EffectivityConditionBuilder EffectivityConditionBuilder@endlink  with initializing validation basis formula @return  
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::EffectivityConditionBuilder * CreateEffectivityConditionBuilder
        (
        ...
        /** The collaborative content type of this part. It will return @link BasePart::CollaborativeContentType::NotAssigned BasePart::CollaborativeContentType::NotAssigned@endlink 
