...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents the builder for analyzing strain gage data.  <br> To create a new instance of this class, use @link CAE::DurabilityManager::CreateStrainGageAnalyzerBuilder  CAE::DurabilityManager::CreateStrainGageAnalyzerBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  DurabilityStrainGageAnalyzerBuilder : public Builder
        {
            ...
            /** Add gage data. 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAE::DurabilityStrainGageAnalyzerBuilder::UseStrainGageData CAE::DurabilityStrainGageAnalyzerBuilder::UseStrainGageData@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAE::DurabilityStrainGageAnalyzerBuilder::UseStrainGageData instead.") void AddStrainGageData
            (
                const NXString & strainGage /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & afuName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            /** Add gage data. 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            void AddStrainGageData
            (
                const char * strainGage /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * afuName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int numRecords /** numrecords */ ,
                int index1 /** index1 */ ,
                int index2 /** index2 */ ,
                int index3 /** index3 */ 
            ...
            (
                const NXString & prefixName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                const char * prefixName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
