...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  DrawBeadBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the expression containing the female depth value. Only valid when taper bead is false and type is @link Die::DrawBeadBuilder::FemaleDepthTypesConstant Die::DrawBeadBuilder::FemaleDepthTypesConstant@endlink . 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the expression containing the female width value. Only valid when taper bead is false and type is @link Die::DrawBeadBuilder::FemaleWidthTypesConstant Die::DrawBeadBuilder::FemaleWidthTypesConstant@endlink .
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link Die::DrawBeadSegmentBuilder Die::DrawBeadSegmentBuilder@endlink  builder.  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Die::DrawBeadSegmentBuilder * CreateDrawBeadSegment
            (
            );
            /**Returns  the list of @link Die::DrawBeadSegmentBuilder Die::DrawBeadSegmentBuilder@endlink  defining the bead sections along the centerline. 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
