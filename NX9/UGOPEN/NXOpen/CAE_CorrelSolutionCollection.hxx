...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CorrelSolutionCollection : public TaggedObjectCollection
        {
            ...
            /** Returns next valid correlation solution name  @return  a  @link CAE::CorrelSolution CAE::CorrelSolution@endlink  valid name 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetValidSolutionName
            (
            );
            /** Clones a correl meta solution  @return  the  newly created @link CAE::CorrelSolution CAE::CorrelSolution@endlink   
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
