            ...
            */
            class NXOPENCPP_FEATURESEXPORT  EndCutBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the connection type. 
                             <br> 
                                If the Limit Type is @link Features::ShipDesign::EndCutBuilder::LimitTypesNeatTrim Features::ShipDesign::EndCutBuilder::LimitTypesNeatTrim@endlink , users can define the connection type between the endcut face and the limiting geometry.
