...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  BlockFeatureBuilder : public Features::FeatureBuilder
        {
            ...
            (
                const NXOpen::Point3d & originPoint /** Block origin point */,
                const char * lengthExpression /** Block length in the WCS x direction   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * widthExpression /** Block width in the WCS y direction   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * heightExpression /** Block height in the WCS z direction   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            /**Returns  the type represented by @link  Features::BlockFeatureBuilder::Types  Features::BlockFeatureBuilder::Types@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::BlockFeatureBuilder::Types Type
            (
            );
            /**Sets  the type represented by @link  Features::BlockFeatureBuilder::Types  Features::BlockFeatureBuilder::Types@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: void SetType
            (
