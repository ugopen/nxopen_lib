    ...
    namespace Formboard
    {
        ...
        */
        class NXOPENCPP_FORMBOARDEXPORT  FormboardManager
        {
            ...
            /** Creates a @link Formboard::PathLengthAnnotationBuilder Formboard::PathLengthAnnotationBuilder@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            ...
            /** Gets @link Positioning::ComponentConstraint Positioning::ComponentConstraint@endlink  which are associated to the formboard plane.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
