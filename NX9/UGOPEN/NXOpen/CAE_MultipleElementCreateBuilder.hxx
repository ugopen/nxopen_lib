...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MultipleElementCreateBuilder : public Builder
        {
            ...
            /**Returns  the element type builder. Through the @link CAE::ElementTypeBuilder CAE::ElementTypeBuilder@endlink  you can 
                        ...
                        @link CAE::MeshCollector CAE::MeshCollector@endlink  the new elements will be placed in.   
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Adds new element definition defined by the list of input @link CAE::FENode CAE::FENode@endlink  
                        ...
                        and  @link CAE::MultipleElementCreateBuilder::LabelIncrement CAE::MultipleElementCreateBuilder::LabelIncrement @endlink and @link CAE::MultipleElementCreateBuilder::SetLabelIncrement CAE::MultipleElementCreateBuilder::SetLabelIncrement @endlink 
             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
