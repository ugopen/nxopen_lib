...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /**Represents a @link Motion::MotionMethods Motion::MotionMethods@endlink  class <br> To obtain an instance of this class, refer to @link Motion::MotionSession  Motion::MotionSession @endlink  <br> 
