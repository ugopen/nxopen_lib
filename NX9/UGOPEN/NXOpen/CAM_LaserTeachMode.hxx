...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Laser TeachMode  <br> To create a new instance of this class, use @link CAM::OperationCollection::CreateLaserTeachMode  CAM::OperationCollection::CreateLaserTeachMode @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  LaserTeachMode : public CAM::OperationBuilder
        {
