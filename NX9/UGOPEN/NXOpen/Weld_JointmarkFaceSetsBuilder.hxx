...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Used to create or edit a set of faces for Jointmark  <br> To create a new instance of this class, use @link Weld::JointmarkBuilder::NewFaceSets  Weld::JointmarkBuilder::NewFaceSets @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  JointmarkFaceSetsBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
