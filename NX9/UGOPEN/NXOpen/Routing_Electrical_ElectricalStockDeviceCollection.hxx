...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ElectricalStockDeviceCollection : public TaggedObjectCollection
            {
                ...
                /** Automatically routes the selected stock devices. Routing can be done
                                ...
                                (See @link Routing::Electrical::ElectricalStockDevice Routing::Electrical::ElectricalStockDevice@endlink  for more details).  @return  
