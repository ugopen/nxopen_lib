...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a CMM Inspection Edge Point Feature builder  <br> To create a new instance of this class, use @link CAM::InspectionOperationCollection::CreateInspectionEdgePointFeatureBuilder  CAM::InspectionOperationCollection::CreateInspectionEdgePointFeatureBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  InspectionEdgePointFeatureBuilder : public CAM::OperationBuilder
        {
