...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** The builder for creating the list item of RunItems  <br> To create a new instance of this class, use @link Routing::DefineRunBuilder::CreateRunItemsBuilder  Routing::DefineRunBuilder::CreateRunItemsBuilder @endlink  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  RunItemsBuilder : public Builder
        {
            ...
            (
                ...
                const NXString & referenceId /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & portName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                NXOpen::TaggedObject * scopedObject /** scopedobject */ ,
                const char * referenceId /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * portName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<NXOpen::TaggedObject *> & availablePorts /** availableports */ 
            );
            ...
            (
                const NXString & virtualReferenceId /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** A virtual stub item to be used as From/To item.  @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            ...
            (
                const char * virtualReferenceId /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
        };
    }
}
