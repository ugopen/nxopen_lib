...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** 
            ...
            The number of nodes in this results model can be obtained by using  @link CAE::Result::AskNumNodes CAE::Result::AskNumNodes@endlink . 
            The number of elements in this results model can be obtained by using @link CAE::Result::AskNumElements CAE::Result::AskNumElements@endlink .  
            Elements are also organized in several groups (of type @link CAE::Result::GroupContainer  CAE::Result::GroupContainer @endlink ) based
        ...
        */
        class NXOPENCPP_CAEEXPORT  Result : public NXObject
        {
            /** Group Containers */
            ...
            public: enum DataType
            {
                ...
                DataTypeSixScalars/**Applicable for @link CAE::Result::QuantitySolidLaminateFailureIndex CAE::Result::QuantitySolidLaminateFailureIndex@endlink  */,
            ...
            public: enum Component
            {
                ...
                ComponentSpringDashpotForce/** No longer used; it means @link CAE::Result::ComponentSpringDashpotForceX CAE::Result::ComponentSpringDashpotForceX@endlink  in new format */,
            ...
            public: enum CoordinateSystem
            {
                ...
                CoordinateSystemMaterial/**Material coordinate system is applicable only when
                                                                                  ...
                                                                                  @link CAE::Result::CoordinateSystemAbsoluteRectangular CAE::Result::CoordinateSystemAbsoluteRectangular@endlink    
                                                                                  will be used*/,
            ...
            struct  ElementValue
            {
             ...
             <br>  @deprecated Deprecated in NX7.5.1.  This structure has been replaced by @link CAE::ResultParameters CAE::ResultParameters@endlink  <br>  
            */
            public:
            struct  NX_DEPRECATED("Deprecated in NX7.5.1.  This structure has been replaced by CAE::ResultParameters")  ResultParameters
            {
             ...
             /** Deformation parameter structure to specify complete result state for the deformed shape 
                        This structure has been replaced by @link CAE::DeformationParameters CAE::DeformationParameters@endlink 
             <br>  @deprecated Deprecated in NX7.5.1.  This structure has been replaced by @link CAE::DeformationParameters CAE::DeformationParameters@endlink  <br>  
            */
            public:
            struct  NX_DEPRECATED("Deprecated in NX7.5.1.  This structure has been replaced by CAE::DeformationParameters")  DeformationParameters
            {
                public: /** load case number starting from 0 */int LoadCaseIndex;
                public: /** iteration number starting from 0 */int IterationIndex;
                public: /** type */ NXOpen::CAE::Result::Type Type;
            ...
            /** This enumeration defines the methods that can be used when calculating absolute values for the following derived components of @link CAE::Result::DataTypeTensor CAE::Result::DataTypeTensor@endlink  
                        @link CAE::Result::ComponentDeterminant CAE::Result::ComponentDeterminant@endlink ,   
                        @link CAE::Result::ComponentMean CAE::Result::ComponentMean@endlink ,
                        @link CAE::Result::ComponentMaximumShear CAE::Result::ComponentMaximumShear@endlink , 
                        @link CAE::Result::ComponentMinimumPrincipal CAE::Result::ComponentMinimumPrincipal@endlink ,
                        @link CAE::Result::ComponentMiddlePrincipal CAE::Result::ComponentMiddlePrincipal@endlink , 
                        @link CAE::Result::ComponentMaximumPrincipal CAE::Result::ComponentMaximumPrincipal@endlink ,
                        @link CAE::Result::ComponentOctahedral CAE::Result::ComponentOctahedral@endlink 

                        @link CAE::Result::TensorDerivedAbsoluteAllComponents CAE::Result::TensorDerivedAbsoluteAllComponents@endlink  will make all tensor primary components (XX, YY, ZZ, XY, YZ, ZX)
                        to absolute and then calculate derived component. 
                        @link CAE::Result::TensorDerivedAbsoluteDerivedComponent CAE::Result::TensorDerivedAbsoluteDerivedComponent@endlink  is absolute value of derived component without changing primary components.
                    */
            ...
            /** Returns a @link CAE::BaseLoadcase CAE::BaseLoadcase@endlink   @return  
             <br>  Created in NX7.5.0.  <br>  
            ...
            (
                int id /** id */ ,
                NXOpen::CAE::Result::CoordinateSystem* type /** returns any of @link CAE::Result::CoordinateSystemSelectRectangular CAE::Result::CoordinateSystemSelectRectangular@endlink ,
                                                                         @link CAE::Result::CoordinateSystemSelectCylindrical CAE::Result::CoordinateSystemSelectCylindrical@endlink , @link CAE::Result::CoordinateSystemSelectSpherical CAE::Result::CoordinateSystemSelectSpherical@endlink  */,
