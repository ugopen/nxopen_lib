...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::LaminateSpreadsheetReport CAE::LaminateSpreadsheetReport@endlink  builder  <br> There is no kf creator.  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  LaminateSpreadsheetReportBuilder : public Builder
        {
            /** (Deprecated) Options for ply stresses calculation when using the solver shell stress resultant
                        as an input for the advance report.  NXLC can compute ply stresses at the bottom,
                        middle or top of each ply. 
             <br>  @deprecated Deprecated in NX8.5.0.  There is no replacement for this enum. Each ply location is now set separatly thru @link CAE::LaminateSpreadsheetReportBuilder::PlyBottom CAE::LaminateSpreadsheetReportBuilder::PlyBottom@endlink , @link CAE::LaminateSpreadsheetReportBuilder::PlyMiddle CAE::LaminateSpreadsheetReportBuilder::PlyMiddle@endlink  and @link CAE::LaminateSpreadsheetReportBuilder::PlyTop CAE::LaminateSpreadsheetReportBuilder::PlyTop@endlink . <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  There is no replacement for this enum. Each ply location is now set separatly thru CAE::LaminateSpreadsheetReportBuilder::PlyBottom, CAE::LaminateSpreadsheetReportBuilder::PlyMiddle and CAE::LaminateSpreadsheetReportBuilder::PlyTop.") enum PlyLocationType
            {
                PlyLocationTypeBottom/** Compute ply stresses at the bottom of each ply */,
                PlyLocationTypeMiddle/** Compute ply stresses at the middle of each ply */,
                PlyLocationTypeTop/** Compute ply stresses at the top of each ply */,
                PlyLocationTypeAll/** Compute ply stresses at the bottom, middle and top of each ply */
            };
            ...
            /**Returns  the solver shell stress resultant 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAE::LaminateSpreadsheetReportBuilder::SolverInput CAE::LaminateSpreadsheetReportBuilder::SolverInput@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::LaminateSpreadsheetReportBuilder::SolverInput instead.") bool SolverShellResultant
            (
            );
            /**Sets  the solver shell stress resultant 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link CAE::LaminateSpreadsheetReportBuilder::SetSolverInput CAE::LaminateSpreadsheetReportBuilder::SetSolverInput@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::LaminateSpreadsheetReportBuilder::SetSolverInput instead.") void SetSolverShellResultant
            (
            ...
            /**Returns  the ply location option for ply stresses calculation from the solver shell stress resultant 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAE::LaminateSpreadsheetReportBuilder::PlyBottom CAE::LaminateSpreadsheetReportBuilder::PlyBottom@endlink , @link CAE::LaminateSpreadsheetReportBuilder::PlyMiddle CAE::LaminateSpreadsheetReportBuilder::PlyMiddle@endlink  or @link CAE::LaminateSpreadsheetReportBuilder::PlyTop CAE::LaminateSpreadsheetReportBuilder::PlyTop@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAE::LaminateSpreadsheetReportBuilder::PlyBottom, CAE::LaminateSpreadsheetReportBuilder::PlyMiddle or CAE::LaminateSpreadsheetReportBuilder::PlyTop instead.") NXOpen::CAE::LaminateSpreadsheetReportBuilder::PlyLocationType PlyLocation
            (
            );
            /**Sets  the ply location option for ply stresses calculation from the solver shell stress resultant 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAE::LaminateSpreadsheetReportBuilder::SetPlyBottom CAE::LaminateSpreadsheetReportBuilder::SetPlyBottom@endlink , @link CAE::LaminateSpreadsheetReportBuilder::SetPlyMiddle CAE::LaminateSpreadsheetReportBuilder::SetPlyMiddle@endlink  or @link CAE::LaminateSpreadsheetReportBuilder::SetPlyTop CAE::LaminateSpreadsheetReportBuilder::SetPlyTop@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAE::LaminateSpreadsheetReportBuilder::SetPlyBottom, CAE::LaminateSpreadsheetReportBuilder::SetPlyMiddle or CAE::LaminateSpreadsheetReportBuilder::SetPlyTop instead.") void SetPlyLocation
            (
                NXOpen::CAE::LaminateSpreadsheetReportBuilder::PlyLocationType plyLocation /** plylocation */ 
            );
            ...
            /**Returns  the solver ply stresses 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::LaminateSpreadsheetReportBuilder::SolverInput instead.") bool SolverPlyStress
            (
            );
            /**Sets  the solver ply stresses 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use CAE::LaminateSpreadsheetReportBuilder::SetSolverInput instead.") void SetSolverPlyStress
            (
