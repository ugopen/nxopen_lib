...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::DurabilityRandomEvent CAE::DurabilityRandomEvent@endlink . 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  DurabilityRandomEvent : public CAE::DurabilityEvent
        {
