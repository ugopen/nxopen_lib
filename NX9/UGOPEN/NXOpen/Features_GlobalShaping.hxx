...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a global shaping feature  <br> To create or edit an instance of this class, use @link Features::GlobalShapingBuilder  Features::GlobalShapingBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  GlobalShaping : public Features::BodyFeature
        {
