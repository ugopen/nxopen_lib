...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Used to create or edit a point in the list of points for Jointmark  <br> To create a new instance of this class, use @link Weld::JointmarkBuilder::NewPoints  Weld::JointmarkBuilder::NewPoints @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  JointmarkPointsBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
