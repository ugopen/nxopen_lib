...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /**
            Represents a @link Features::OffsetEdge Features::OffsetEdge@endlink  builder
             <br> To create a new instance of this class, use @link Features::SynchronousEdgeCollection::CreateOffsetEdgeBuilder  Features::SynchronousEdgeCollection::CreateOffsetEdgeBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  OffsetEdgeBuilder : public Features::FeatureBuilder
        {
