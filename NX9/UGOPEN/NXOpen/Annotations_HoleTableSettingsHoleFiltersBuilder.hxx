...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::HoleTableSettingsHoleFiltersBuilder Annotations::HoleTableSettingsHoleFiltersBuilder@endlink  
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  HoleTableSettingsHoleFiltersBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            /** the Scope enum */
