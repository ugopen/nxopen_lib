...
namespace NXOpen
{
    ...
    /** SIAutotestePreferences class stores preferences for creating SI tests. This is an internal class for development.
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT  SIAutotestPreferencesBuilder : public Builder
    {
