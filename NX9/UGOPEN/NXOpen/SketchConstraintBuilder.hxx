...
namespace NXOpen
{
    ...
    /** Represents a @link SketchConstraint SketchConstraint@endlink  builder  <br> To create a new instance of this class, use @link SketchCollection::CreateConstraintBuilder  SketchCollection::CreateConstraintBuilder @endlink  <br> 
     <br>  Created in NX8.5.0.  <br>  
    */
    class NXOPENCPPEXPORT  SketchConstraintBuilder : public Builder
    {
