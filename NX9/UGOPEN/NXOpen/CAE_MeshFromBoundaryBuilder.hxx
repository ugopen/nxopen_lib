...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**
              Represents a @link CAE::MeshFromBoundaryBuilder CAE::MeshFromBoundaryBuilder@endlink 
             <br> To create a new instance of this class, use @link CAE::NodeElementManager::CreateMeshFromBoundaryBuilder  CAE::NodeElementManager::CreateMeshFromBoundaryBuilder @endlink  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  MeshFromBoundaryBuilder : public Builder
        {
            /**  Type of loop */
