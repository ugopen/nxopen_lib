...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents a @link CAE::Optimization::DAOSolution CAE::Optimization::DAOSolution@endlink .  <br> To create or edit an instance of this class, use @link CAE::Optimization::DAOSolutionBuilder  CAE::Optimization::DAOSolutionBuilder @endlink  <br> 
             <br>  Created in NX8.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  DAOSolution : public NXObject
            {
                ...
                /** Sets the optimization solution design constraints 
                 <br>  @deprecated Deprecated in NX9.0.0.  Not a valid method. Use @link CAE::Optimization::DAOSolution::CreateConstraintBuilder CAE::Optimization::DAOSolution::CreateConstraintBuilder@endlink  instead. <br>  

                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_design_sim ("NX Design Simulation") */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Not a valid method. Use CAE::Optimization::DAOSolution::CreateConstraintBuilder instead.") void SetDesignConstraints
                (
                ...
                /** Sets the optimization solution design variables for general optimization type 
                 <br>  @deprecated Deprecated in NX9.0.0.  Not a valid method. Use @link CAE::Optimization::DAOSolution::CreateDesignVariableBuilder CAE::Optimization::DAOSolution::CreateDesignVariableBuilder@endlink  instead. <br>  

                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_design_sim ("NX Design Simulation") */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Not a valid method. Use CAE::Optimization::DAOSolution::CreateDesignVariableBuilder instead.") void SetOptimizationDesignVariables
                (
                ...
                /**Returns  the optimization solution optimizer control 
                 <br>  @deprecated Deprecated in NX9.0.0.  Not a valid method. Use @link CAE::Optimization::DAOSolution::GetSolutionControls CAE::Optimization::DAOSolution::GetSolutionControls@endlink  instead. <br>  

                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Not a valid method. Use CAE::Optimization::DAOSolution::GetSolutionControls instead.") NXOpen::CAE::Optimization::DAOStopCondition * OptimizerControl
                (
                );
                /**Sets  the optimization solution optimizer control 
                 ...
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_design_sim ("NX Design Simulation") */
                public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Not a valid method. Use CAE::Optimization::DAOSolution::GetSolutionControls instead.") void SetOptimizerControl
                (
