...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SurfaceFinishBuilder : public Annotations::BaseSurfaceFinishBuilder
        {
            ...
            /**Returns  the parantheses. This method is deprecated.
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link Annotations::SurfaceFinishBuilder::Parentheses Annotations::SurfaceFinishBuilder::Parentheses @endlink and @link Annotations::SurfaceFinishBuilder::SetParentheses Annotations::SurfaceFinishBuilder::SetParentheses @endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Annotations::SurfaceFinishBuilder::Parentheses Annotations::SurfaceFinishBuilder::Parentheses @endlink and @link Annotations::SurfaceFinishBuilder::SetParentheses Annotations::SurfaceFinishBuilder::SetParentheses @endlink  instead.") NXOpen::Annotations::BaseSurfaceFinishBuilder::ParanthesesType Parantheses
            (
            );
            /**Sets  the parantheses. This method is deprecated.
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Annotations::SurfaceFinishBuilder::Parentheses Annotations::SurfaceFinishBuilder::Parentheses @endlink and @link Annotations::SurfaceFinishBuilder::SetParentheses Annotations::SurfaceFinishBuilder::SetParentheses @endlink  instead.") void SetParantheses
            (
