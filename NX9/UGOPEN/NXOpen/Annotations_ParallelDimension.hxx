...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a parallel dimension  <br> To create or edit an instance of this class, use @link Annotations::LinearDimensionBuilder  Annotations::LinearDimensionBuilder @endlink  <br> 
