...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /**
            Represents a @link Drawings::ViewDetailLabelBuilder Drawings::ViewDetailLabelBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewDetailLabelBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
