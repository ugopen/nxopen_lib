...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            /**
                This class is used to create or edit a @link Features::ShipDesign::StiffenerSystem Features::ShipDesign::StiffenerSystem@endlink  feature.
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  StiffenerSystemBuilder : public Features::ShipDesign::ProfileSystemBuilder
            {
                ...
                /**Returns  the distance from the OffsetPlane to generate the first plane. 
                            Only used when Type is @link Features::ShipDesign::StiffenerSystemBuilder::TypesOffsetPlanes Features::ShipDesign::StiffenerSystemBuilder::TypesOffsetPlanes@endlink  
                            and OffsetSpacing is @link Features::ShipDesign::StiffenerSystemBuilder::OffsetSpacingModesSingle Features::ShipDesign::StiffenerSystemBuilder::OffsetSpacingModesSingle@endlink . 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the distance from the OffsetPlane to generate the location at the start of the stiffener system. 
                            Only used when Type is @link Features::ShipDesign::StiffenerSystemBuilder::TypesOffsetPlanes Features::ShipDesign::StiffenerSystemBuilder::TypesOffsetPlanes@endlink  
                            and OffsetSpacing is @link Features::ShipDesign::StiffenerSystemBuilder::OffsetSpacingModesDouble Features::ShipDesign::StiffenerSystemBuilder::OffsetSpacingModesDouble@endlink .
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /** Creates a @link Features::ShipDesign::PlanePairBuilder Features::ShipDesign::PlanePairBuilder@endlink  to add another pair of planes to the list.  @return  
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
