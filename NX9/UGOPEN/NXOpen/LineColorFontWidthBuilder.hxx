...
namespace NXOpen
{
    ...
    /** 
    Represent a @link LineColorFontWidthBuilder LineColorFontWidthBuilder@endlink  
     <br> This is a sub-builder class and cannot be directly instantiated  <br> 
     <br>  Created in NX9.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  LineColorFontWidthBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
    {
