        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  ConicCrossSection : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /** Sets the first offset for the conic section with face blend.
             ...
             <br>  @deprecated Deprecated in NX9.0.0.  To set the value of the expression modify the expression directly using @link GeometricUtilities::ConicCrossSection::FirstOffset GeometricUtilities::ConicCrossSection::FirstOffset@endlink  and @link Expression::SetRightHandSide Expression::SetRightHandSide@endlink . <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  To set the value of the expression modify the expression directly using GeometricUtilities::ConicCrossSection::FirstOffset and Expression::SetRightHandSide.") void SetFirstOffset
            (
            ...
            /** Sets the second offset for the conic section with face blend.
             ...
             <br>  @deprecated Deprecated in NX9.0.0.  To set the value of the expression modify the expression directly using @link GeometricUtilities::ConicCrossSection::SecondOffset GeometricUtilities::ConicCrossSection::SecondOffset@endlink  and @link Expression::SetRightHandSide Expression::SetRightHandSide@endlink . <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  To set the value of the expression modify the expression directly using GeometricUtilities::ConicCrossSection::SecondOffset and Expression::SetRightHandSide.") void SetSecondOffset
            (
                const NXString & offset /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Sets the second offset for the conic section with face blend.
            ...
            /** Sets a rho expression for the conic section with face blend.
             ...
             <br>  @deprecated Deprecated in NX9.0.0.  To set the value of the expression modify the expression directly using @link GeometricUtilities::ConicCrossSection::Rho GeometricUtilities::ConicCrossSection::Rho@endlink  and @link Expression::SetRightHandSide Expression::SetRightHandSide@endlink . <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  To set the value of the expression modify the expression directly using GeometricUtilities::ConicCrossSection::Rho and Expression::SetRightHandSide.") void SetRho
            (
