...
/*
#define UF_OPER_MAX_NAME_LEN   UF_OPER_OPNAME_LEN
...
*/
#define UF_OPER_MAX_NAME_NCHARS   UF_OPER_OPNAME_LEN
#define UF_OPER_MAX_NAME_BUFSIZE NX_BUFSIZE(UF_OPER_MAX_NAME_NCHARS)
#define UF_OPER_MAX_NAME_LEN   UF_OPER_MAX_NAME_NCHARS
...
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_program_group
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_method_group
(
   tag_t    oper, /* <I> - see above */
   tag_t   *group /* <O> - see above */
);
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_geom_group
(
   tag_t    oper, /* <I> - see above */
   tag_t   *group /* <O> - see above */
);
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_cutter_group
(
   tag_t    oper, /* <I> - see above */
   tag_t   *group /* <O> - see above */
);
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_status
(
   tag_t               oper, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_oper_type
(
   tag_t   oper, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_machining_mode
(
   tag_t                  oper, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_is_path_gouged
(
   tag_t      oper,  /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_ask_name_from_tag
(
   tag_t      oper, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_has_self_ipw
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_delete_tool_path
(
   tag_t    oper /* <I> - see above */
);
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_OPER_create
(
 ...
 *************************************************************/
extern UFUNEXPORT int UF_OPER_ask_selected_tracking_point_count
(
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_OPER_select_tracking_point
(
 ...
 * History: Released in NX2.0
 *************************************************************/
extern UFUNEXPORT int UF_OPER_deselect_tracking_point
(
    tag_t  object_tag,  /* <I> the tag of the operation  */
 ...
 * History: Released in NX2.0
 **************************************************************/
extern UFUNEXPORT int UF_OPER_ask_selected_point_data
(
    tag_t  object_tag,  /* <I> the tag of the operation of the points  */
 ...
 **************************************************************/
extern UFUNEXPORT int UF_OPER_ask_selected_turn_point_data
(
    tag_t  object_tag,  /* <I> the tag of the operation of the points  */
 ...
 ******************************************************************/
extern UFUNEXPORT int UF_OPER_ask_ref_cutter
(
 ...
 * History: Released in NX 2.0
 ******************************************************************/
extern UFUNEXPORT int UF_OPER_set_ref_cutter
(
    tag_t  oper_tag,  /* <I> the operation tag */
 ...
 *************************************************************/
 extern UFUNEXPORT int UF_OPER_set_machining_data
(
 ...
 *************************************************************/
 extern UFUNEXPORT int UF_OPER_reset_from_table
(
    tag_t      oper_tag                /* <I> tag of the operation */
);
/***************************************************************
 ...
 *************************************************************/
extern  UFUNEXPORT int UF_OPER_unload_path
(
   tag_t       oper_tag                          /* <I> tag of the operation */ 
);
#ifdef __cplusplus
