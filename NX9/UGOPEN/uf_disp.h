...
/* UF_SH_MAX_MAT_NAME_SIZE is being deprecated because NX is moving to support
                           ...
                           below:
   UF_SH_MAX_MAT_NAME_BUFSIZE should be used for buffer allocations and memory allocations.
   UF_SH_MAX_MAT_NAME_NCHARS should be used to limit the number of characters in a buffer.
