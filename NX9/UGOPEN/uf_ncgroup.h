...
#define UF_NCGROUP_MAX_REASON_LEN   1024
...
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_is_group
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_can_accept_member
(
   tag_t      obj1,  /* <I> - the group */
   tag_t      obj2,  /* <I> - can this object be placed into the group */
   logical   *answer, /* <O> - see above */
   char       reason[UF_NCGROUP_MAX_REASON_LEN+1]  /* <O> - see above */
);
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_ask_member_list
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_is_a_member
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_accept_member
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_insert_member
(
   tag_t   parent, /* <I> - see above */
   tag_t   member, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_ask_member_in_list
(
   tag_t    parent, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_cycle_members
(
   tag_t                     group, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_ask_object_of_name
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGROUP_ask_root_of_object
(
   tag_t    obj_tag, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCPROG_create
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCGEOM_create
(
   char    *type_name,    /* <I> - the type name of the object to create */
   char    *subtype_name, /* <I> - the subtype name of the object to create */
   tag_t   *new_object    /* <O> - the newly created object */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_NCMTHD_create
(
   char    *type_name,    /* <I> - the type name of the object to create */
   char    *subtype_name, /* <I> - the subtype name of the object to create */
   tag_t   *new_object    /* <O> - the newly created object */
