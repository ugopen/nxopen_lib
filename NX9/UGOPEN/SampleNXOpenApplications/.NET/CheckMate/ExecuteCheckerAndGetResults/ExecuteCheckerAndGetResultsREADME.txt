...
--------------
    ...
    $UGII_BASE_DIR\ugopen\SampleNXOpenApplications\.NET\ExecuteCheckerAndGetResults
...
For VB.Net:
    ...
    5. Confirm following four references are added into this project:
        ...
        $UGII_BASE_DIR\ugii\managed\NXOpen.dll
        $UGII_BASE_DIR\ugii\managed\NXOpen.UF.dll
        $UGII_BASE_DIR\ugii\managed\NXOpen.Utilities.dll
        $UGII_BASE_DIR\ugii\managed\NXOpenUI.dll
...
--------------------------
    ...
    3. Change the Role to Advanced with full menus if not set.
