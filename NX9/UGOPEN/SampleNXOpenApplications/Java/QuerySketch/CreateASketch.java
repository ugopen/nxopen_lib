...
public class CreateASketch
{
  public static void main(String [] args) throws NXException, java.rmi.RemoteException
  {
    ...
    sketchInPlaceBuilder1 = theSession.parts().work().sketches().createNewSketchInPlaceBuilder(nullSketch);
    ...
    selectIReferenceAxis1.setValue(datumAxis2);
    ...
    sketch1.setReferenceDirection(selectIReferenceAxis1.value(), vector3d1, AxisOrientation.HORIZONTAL, Sense.FORWARD);
