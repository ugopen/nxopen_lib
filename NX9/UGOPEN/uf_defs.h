 ...
 *
****************************************************************************/
#define MAX_FSPEC_NCHARS      256  /* Maximum number of characters in a filespec excluding the trailing '\0'. These may be multi-byte characters. */ 
