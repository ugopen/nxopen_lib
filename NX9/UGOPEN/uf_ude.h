...
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_name
(
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_params
(
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_param_type
(
   UF_UDE_t             ude_obj,    /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_is_param_optional
(
   UF_UDE_t                ude_obj,    /* <I> see above */
   char                   *param_name, /* <I> see above */
...
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_param_toggle
(
   UF_UDE_t                ude_obj,    /* <I> see above */
   char                   *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_set_param_toggle
(
   UF_UDE_t                ude_obj,    /* <I> see above */
   char                   *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_set_integer
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_integer
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_set_double
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_double
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_set_string
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_string
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_set_boolean
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_boolean
(
   UF_UDE_t             ude_obj,    /* <I> see above */
   char                *param_name, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_set_point
(
   UF_UDE_t             ude_obj,        /* <I> see above */
   char                *param_name,     /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_point
(
   UF_UDE_t             ude_obj,        /* <I> see above */
   char                *param_name,     /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_set_vector
(
   UF_UDE_t             ude_obj,         /* <I> see above */
   char                *param_name,      /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_UDE_ask_vector
(
