...
*   07-Nov-2012  Bhanu Peddi       CAE 1462 - Batcher Mesh rewrite ( added more params that did not exist previously).
...
*   15-Jan-2013  Bhanu Peddi       Fixed a typo in getting suppress hole diameter value.
...
void paramReader::Set_body_type ( const char   scBody_type[PARAMREADER_MAX_LINE_LENGTH] )
{
...
int paramReader::Get_suppress_hole_point_type  (char scPoint_Type[PARAMREADER_MAX_LINE_LENGTH]) const
{
    if ( fSET__suppress_hole_point_type )
         strcpy(scPoint_Type, suppress_hole_point_type);   
    return fSET__suppress_hole_point_type;
}
void paramReader::Set_suppress_hole_point_type (const char scPoint_Type[PARAMREADER_MAX_LINE_LENGTH]) 
{
