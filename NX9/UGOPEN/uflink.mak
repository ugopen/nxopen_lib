...
UGOpenLibs         = "$(UGII_USERFCN)\libufun.lib" "$(UGII_USERFCN)\libufun_cae.lib" $(allNXOpenCppLibs) "$(UGII_USERFCN)\libopenpp.lib" "$(UGII_USERFCN)\libvmathpp.lib"
UGOpenInternalLibs = "$(UGII_USERFCN)\libugopenint.lib" "$(UGII_USERFCN)\libugopenint_cae.lib" "$(UGII_USERFCN)\libnxopenuicpp.lib" "$(UGII_USERFCN)\libopenintpp.lib"
