...
struct UF_ROUTE_component_name_plugin_s
{
    ...
    char    path_name[ UF_CFI_MAX_FILE_NAME_BUFSIZE ]; /* <len:UF_CFI_MAX_FILE_NAME_BUFSIZE>
    ...
    char    folder_name[ UF_CFI_MAX_FILE_NAME_BUFSIZE ]; /* <len:UF_CFI_MAX_FILE_NAME_BUFSIZE>
