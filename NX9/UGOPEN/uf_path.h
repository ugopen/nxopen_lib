...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_init_tool_path(
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_contact_linear_motion
(
...
History:
 ******************************************************************************/
extern UFUNEXPORT int   UF_PATH_create_contact_circular_motion
(
   UF_PATH_id_t               path_id,
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_end_tool_path(
UF_PATH_id_t path_id  /* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_linear_motion(
UF_PATH_id_t path_id ,/* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_circular_motion(
UF_PATH_id_t path_id ,/* <I>
                      Path to perform action on
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_helical_motion(
UF_PATH_id_t path_id ,/* <I>
                      Path to perform action on
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_text(
UF_PATH_id_t path_id ,/* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_pprint(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char* text  /* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_opmessage(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char* text  /* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_origin(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_seqno(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_set_mode(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_select_head(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_tool_change(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_tracking_point_change
(
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_spindle_on(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_spindle_off(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char * text  /* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_spindle_reverse(
UF_PATH_id_t path_id ,/* <I> The path id for this event */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_coolant_on(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_coolant_off(
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_op_stop(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char * text  /* <I>
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_op_skip(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_stop(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char * text  /* <I>
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_dwell(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_auxfun(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
int auxfun_code ,/* <I>
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_prefun(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
int prefun_code ,/* <I>
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_clamp(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_tool_length_comp(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_tool_preselect(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
int tool_number ,/* <I>
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_rotate(
UF_PATH_id_t path_id ,/* <I>
                      The path ID for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_thread_wire(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char * text  /* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_cut_wire(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char * text  /* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_flush(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_flush_tank(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_power(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_wire_guides(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
const char * text  /* <I>
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_fedrat(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_wire_angle(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_wire_cutcom(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_PATH_create_cutcom(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_PATH_create_level_marker(
