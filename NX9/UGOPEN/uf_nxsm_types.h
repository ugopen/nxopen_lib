...
struct UF_NXSM_tab_data_s
{
    ...
    char sweep_dist[ UF_MAX_EXP_BUFSIZE ]; /* Sweep distance */
...
struct UF_NXSM_bend_data_s
{
    ...
    char bend_angle[ UF_MAX_EXP_BUFSIZE ];           /* Bend angle in degrees*/
...
struct UF_NXSM_base_cflange_data_s
{
    ...
    char thickness[ UF_MAX_EXP_BUFSIZE ];            /* Thickness of contour flange */
...
struct UF_NXSM_jog_data_s
{
    ...
    char  offset_dist[ UF_MAX_EXP_BUFSIZE ];    /* Distance through which the two faces will be separated */
