...
enum UF_UI_dialog_filter_id_e{
    ...
    UF_UI_CAE_RST_XDB_FLTR,             /* Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des and *.fil (To be removed later)*/
    UF_UI_CAE_RST_XDB_ODB_FLTR,         /* Specifies *.op2 *.xdb, *.vdm *.rst *.rth *.des *.fil and *.odb (To be removed later)*/
