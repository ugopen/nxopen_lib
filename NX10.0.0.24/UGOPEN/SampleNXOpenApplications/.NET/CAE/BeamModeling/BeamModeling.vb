...
Module BeamSection
    ...
    Sub CreateFemPart()
        ...
        femPart2.FinalizeCreation(part1, "fem_i.prt", CAE.FemPart.UseBodiesOption.VisibleBodies, bodies1, femSynchronizeOptions1, "NX NASTRAN", "Structural", CAE.BaseFemPart.AxisymAbstractionType.None, description1)
