...
class ColoredBlock:
    ...
    def initialize_cb(self):
        try:
            ...
            blockHeightProps = self.blockHeight.GetProperties()
            ...
            blockHeightProps = None

            blockWidthProps = self.blockWidth.GetProperties()
            ...
            blockWidthProps = None

            blockLengthProps = self.blockLength.GetProperties()
    ...
    def apply_cb(self):
        ...
        try:
            ...
            blockHeightProps = self.blockHeight.GetProperties()
            theHeight = blockHeightProps.GetDouble("Value")
            blockHeightProps.Dispose()
            blockHeightProps = None

            blockWidthProps = self.blockWidth.GetProperties()
            theWidth = blockWidthProps.GetDouble("Value")
            blockWidthProps.Dispose()
            blockWidthProps = None

            blockLengthProps = self.blockLength.GetProperties()
            theLength = blockLengthProps.GetDouble("Value")
            blockLengthProps.Dispose()
            blockLengthProps = None

            blockOriginProps = self.blockOrigin.GetProperties()
            originPoint = blockOriginProps.GetPoint("Point")
            blockOriginProps.Dispose()
            blockOriginProps = None

            blockColorProps = self.blockColor.GetProperties()
            color = blockColorProps.GetIntegerVector("Value")
            blockColorProps.Dispose()
            blockColorProps = None
