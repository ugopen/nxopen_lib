...
History: Originally released in V19.0, Deprecated in NX10.0
*******************************************************************************/
...
(
      ...
      char text_str[MAX_LINE_BUFSIZE]  /*<O> Formated text string.  No memory is allocated.
                            Calling function should allocate text_str
                            with the size of MAX_LINE_BUFSIZE.
                      */
 );
...
Equivalent JA function/property:
Please use the CreateFromAxis method in Routing::FittingPortCollection or Routing::FixturePortCollection
 ***********************************************************************/
...
Equivalent JA function/property:
Please use the CreateFromCSys method in Routing::FittingPortCollection or Routing::FixturePortCollection
 ***********************************************************************/
