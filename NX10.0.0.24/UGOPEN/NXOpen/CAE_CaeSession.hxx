    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeSession
        {
            ...
            (
                const char * solverName /** the solver name to indicate what type of data is being imported   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::CAE::CaeDataContainer * propertyList /** the import parameters see @link GetDataContainer  GetDataContainer @endlink .
                 */
            );


            /** Returns the @link MaterialUtilities MaterialUtilities@endlink  instance belonging to this session 
