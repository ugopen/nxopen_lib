...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::CaeRegionBuilder CAE::CaeRegionBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::CAE::SimSimulation::CreateCaeRegionBuilder  NXOpen::CAE::SimSimulation::CreateCaeRegionBuilder @endlink  <br> 
