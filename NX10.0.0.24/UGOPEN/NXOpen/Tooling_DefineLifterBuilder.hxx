    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DefineLifterBuilder : public NXOpen::Builder
        {
            ...
            (
                const NXString & lifterName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Delete the generic lifter 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            (
                const char * lifterName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
