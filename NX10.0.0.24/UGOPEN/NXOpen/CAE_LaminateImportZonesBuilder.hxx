...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::LaminateImportZonesBuilder CAE::LaminateImportZonesBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::CAE::LaminateGlobalLayupMgr::CreateLaminateImportZonesBuilder  NXOpen::CAE::LaminateGlobalLayupMgr::CreateLaminateImportZonesBuilder @endlink  <br> 
