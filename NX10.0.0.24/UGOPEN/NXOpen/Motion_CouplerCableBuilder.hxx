...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a @link Motion::CouplerCableBuilder Motion::CouplerCableBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::Motion::CouplerCollection::CreateCouplerCableBuilder  NXOpen::Motion::CouplerCollection::CreateCouplerCableBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
