...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            /** Represents @link Routing::Electrical::CablewaysBuilder Routing::Electrical::CablewaysBuilder@endlink .  <br> To create a new instance of this class, use @link NXOpen::Routing::RouteManager::CreateCablewaysBuilder  NXOpen::Routing::RouteManager::CreateCablewaysBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
