...
namespace NXOpen
{
    ...
    namespace Validate
    {
        ...
        /** Represents a @link Validate::Requirement Validate::Requirement@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Validate::RequirementCollection::CreateRequirementBuilder  NXOpen::Validate::RequirementCollection::CreateRequirementBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
