        ...
        class NXOPENCPP_CAMEXPORT  HoleBossGeom : public NXOpen::TaggedObject
        {
            ...
            */
            ...
            /** the depth limit types 
             ...
             <br>  Created in NX7.5.0.  <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  The property that used this enum is replaced by NXOpen::CAM::HoleBossSet::DepthLimit.") enum DepthLimitTypes
            {
            ...
            */
            ...
            (
                NXOpen::CAM::HoleBossGeom::FormTypes type /** the Form Standard type*/,
                const char * formCustom /** the User Defined Form    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /**Returns  the Pitch 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            ...
            (
                ...
                double minorDiameter /** the minor diameter*/,
                double lengh /** the lengh*/,
                const char * size /** the size  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * radialEngage /** the radial engage  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                double pitch /** the pitch*/,
                int rotation /** the rotation*/,
                NXOpen::CAM::HoleBossGeom::FormTypes form /** the form*/,
                const char * formUserDefined /** the user defined Form  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * tableStandard /** the Standard  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int depthLimit /** the depth limit*/
            );
            ...
            (
                ...
                double minorDiameter /** the minor diameter*/,
                double lengh /** the lengh*/,
                const char * size /** the size title  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                double pitch /** the pitch*/,
                int rotation /** the rotation*/,
                NXOpen::CAM::HoleBossGeom::FormTypes form /** the form*/,
                const char * formUserDefined /** the user defined Form  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
