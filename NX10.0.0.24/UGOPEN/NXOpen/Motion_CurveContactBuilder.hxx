...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a @link Motion::CurveContactBuilder Motion::CurveContactBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::Motion::CurveContactCollection::CreateCurveContactBuilder  NXOpen::Motion::CurveContactCollection::CreateCurveContactBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
