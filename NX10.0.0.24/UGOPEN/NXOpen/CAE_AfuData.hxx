        ...
        */
        class NXOPENCPP_CAEEXPORT  AfuData : public NXOpen::TransientObject
        {
            ...
            /** Sets the main AFU Data Record ID information 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link AfuData::SetAfuHeaderId AfuData::SetAfuHeaderId@endlink  instead. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use AfuData::SetAfuHeaderId instead.") void SetIdInformation
            (
            ...
            /** Returns main AFU Data Record ID information 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link AfuData::AfuHeaderId AfuData::AfuHeaderId@endlink  instead. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use AfuData::AfuHeaderId instead.") void GetIdInformation
            (
            ...
            /** Set the Abscissa and Ordinate Axis definitions of an AFU Data Record 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link AfuData::SetAbscissaAndOrdinateAxisDefinition AfuData::SetAbscissaAndOrdinateAxisDefinition@endlink  with Denominator. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use AfuData::SetAbscissaAndOrdinateAxisDefinition with Denominator.") void SetAxisDefinition
            (
            ...
            /** Get the Abscissa and Ordinate Axis definitions of an AFU Data Record 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link AfuData::GetAbscissaAndOrdinateAxisDefinition AfuData::GetAbscissaAndOrdinateAxisDefinition@endlink  with Denominator. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use AfuData::GetAbscissaAndOrdinateAxisDefinition with Denominator.") void GetAxisDefinition
            (
                NXOpen::CAE::AfuData::AbscissaType* abscissaType /** Abscissa specific data type */,
                NXOpen::CAE::XyFunctionUnit* xUnit /** Unit Code of abscissa data */,
                NXOpen::CAE::AfuData::OrdinateType* oridinateType /** Ordinate data type */,
                NXOpen::CAE::XyFunctionUnit* yUnit /** Unit Code of ordinate data */
            );
            /** Get the Abscissa and Ordinate Axis definitions of an AFU Data Record 
             <br>  Created in NX9.0.0.  <br>  
            ...
            /** Set the Abscissa Information for AFU Data Record when abscissa type is even 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link AfuData::SetRealData AfuData::SetRealData@endlink  or @link AfuData::SetComplexData AfuData::SetComplexData@endlink that takes minimum abscissa value and increment instead. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use AfuData::SetRealData or AfuData::SetComplexDatathat takes minimum abscissa value and increment instead.") void SetEvenData
            (
