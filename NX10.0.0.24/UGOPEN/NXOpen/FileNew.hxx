...
namespace NXOpen
{
    ...
    /** 
     ...
     <br>  @deprecated Deprecated in NX9.0.0.  Use @link FileNew::GetApplicationNames FileNew::GetApplicationNames@endlink  that returns all application names. <br>  
    */
     NX_DEPRECATED("Deprecated in NX9.0.0.  Use FileNew::GetApplicationNames that returns all application names.") enum FileNewApplication
    {
    ...
    */
    class NXOPENCPPEXPORT  FileNew : public NXOpen::Builder
    {
        ...
        /**Returns  the application type for the new file being created 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link FileNew::ApplicationName FileNew::ApplicationName@endlink  that takes a string name instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use FileNew::ApplicationName that takes a string name instead.") NXOpen::FileNewApplication Application
        (
        );
        /**Sets  the application type for the new file being created 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link FileNew::SetApplicationName FileNew::SetApplicationName@endlink  that takes a string name instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use FileNew::SetApplicationName that takes a string name instead.") void SetApplication
        (
            NXOpen::FileNewApplication application /** application */ 
        );
        /**Returns  the application type for the new file being created 
                     Use @link FileNew::GetApplicationNames FileNew::GetApplicationNames@endlink  to get valid application names.
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        ...
        /**Returns  the property that controls if the new file should be created using a blank template.  
                ...
                @link FileNew::SetTemplateFileName FileNew::SetTemplateFileName@endlink .  If set to True, this means that no template
        ...
        /** Teamcenter projects data 
         <br>  @deprecated Deprecated in NX10.0.0.  Use @link Session::AssignRemoveProjects Session::AssignRemoveProjects@endlink  to assign/remove projects. <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use Session::AssignRemoveProjects to assign/remove projects.") void SetProjectsData
        (
        ...
        /** Returns logical value to indicate whether master to be added as child component  @return  whether master to be added as child component 
         <br>  @deprecated Deprecated in NX10.0.0.  Use @link PDM::PartOperationCreateBuilder::GetAddMaster PDM::PartOperationCreateBuilder::GetAddMaster@endlink  to get addMaster flag. <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use PDM::PartOperationCreateBuilder::GetAddMaster to get addMaster flag.") bool GetAddMasterFlag
        (
        );
        /** Sets addMaster flag 
         <br>  @deprecated Deprecated in NX10.0.0.  Use @link PDM::PartOperationCreateBuilder::SetAddMaster PDM::PartOperationCreateBuilder::SetAddMaster@endlink  to set addMaster flag. <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use PDM::PartOperationCreateBuilder::SetAddMaster to set addMaster flag.") void SetAddMasterFlag
        (
        ...
        /**Returns  the relation type of the underlying template which is used for the new file being created. 
                 ...
                 require @link FileNew::SetUsesMasterModel FileNew::SetUsesMasterModel@endlink  to be set to 'Yes'
        ...
        /** Sets @link PDM::PartOperationBuilder PDM::PartOperationBuilder@endlink  
