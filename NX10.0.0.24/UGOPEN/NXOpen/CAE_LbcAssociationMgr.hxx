    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  LbcAssociationMgr : public NXOpen::Builder
        {
            ...
            (
                const NXString & csvFileName /** CSV file name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Export to csv 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            void ExportToCsv
            (
                const char * csvFileName /** CSV file name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Import from csv 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
