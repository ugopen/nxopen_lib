    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  WaveQuery : public NXOpen::TransientObject
        {
            ...
            void GetPartPreview
            (
                const char * partSpec /** the part's specification   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int partIdentifier /** part's in-session identifier */,
                int* height /** height of preview image */,
                int* width /** width of preview image */,
                std::vector<int> & pixels /** the pixels */
            ...
            (
                const char * parentPartSpec /** the part's specification   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int parentPartIdentifier /** part's in-session identifier */,
                bool walkAll /** true if children of all descendants are obtained */
            );
            /**
            ...
            (
                const char * childPartSpec /** the part's specification   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int childPartIdentifier /** part's in-session identifier */,
                bool walkAll /** true if parents of all ancestors are obtained */
            );
            /**
            ...
            (
                const char * owningPartSpec /** the owning part's specification   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int owningPartIdentifier /** owning part's in-session identifier */,
                const char * prodintHandle /** the product interface's handle   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int prodintIdentifier /** product interface's in-session identifier */
            );
            /**
            ...
            (
                NXOpen::Assemblies::AssembliesEventTypes eventType /** type of event for processing */,
                const char * eventDescription /** textual description of the event for reporting   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                std::vector<NXString> & entitySpecs /** the NX part specifications or the handles of the objects   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<int> & entityIdentifiers /** the NX part or object identifiers */
            );
            /**
