        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultParameters : public NXOpen::TaggedObject
        {
            ...
            /** Set Current loadcase and iteration.
             ...
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAE::ResultParameters::SetGenericResultType CAE::ResultParameters::SetGenericResultType@endlink  instead. <br>  

             <br>  Created in NX6.0.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAE::ResultParameters::SetGenericResultType instead.") void SetLoadcaseIteration
            (
            ...
            /** Ask FE entity where the result is defined  
                    This method has been deprecated. This functionality was moved to this class @link CAE::BaseResultType CAE::BaseResultType@endlink , which         can be obtained by using  @link CAE::ResultParameters::GetGenericResultType CAE::ResultParameters::GetGenericResultType@endlink . 
                     @return   
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAE::BaseResultType::Location CAE::BaseResultType::Location@endlink  instead. <br>  

             <br>  Created in NX6.0.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAE::BaseResultType::Location instead.") NXOpen::CAE::Result::Location GetResultDataLocation
            (
            );
