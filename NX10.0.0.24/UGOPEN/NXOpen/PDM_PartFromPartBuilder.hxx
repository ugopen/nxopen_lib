...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        /** This class provides the methods necessary to create a new part in NX Manager
            ...
            For Save As of master parts, use @link PDM::PartOperationCopyBuilder PDM::PartOperationCopyBuilder@endlink .
        ...
        */
        class NXOPENCPP_PDMEXPORT  PartFromPartBuilder : public NXOpen::PDM::PartBuilder
        {
            ...
            /**Sets  the non-master parts to save during the save as operation
                    ...
                    For Save As of master parts, use @link PDM::PartOperationCopyBuilder::GetCopyNonMasterPartsOption PDM::PartOperationCopyBuilder::GetCopyNonMasterPartsOption@endlink .
                     <br> 
            ...
            /**Sets  the dependent files to save during the save as operation
                    ...
                    Deprecated in NX10 for "Save As of master parts" operation. 
                    This should only be used in case of Save As New Item Type Operations. 
                    For Save As of master parts, use @link PDM::PartOperationCopyBuilder::DependentFilesToCopyOption PDM::PartOperationCopyBuilder::DependentFilesToCopyOption@endlink .
                     <br> 
            ...
            /** Initializes the list of non-master parts that can be saved during the
                    ...
                    Deprecated in NX10 for "Save As of master parts" operation. 
                    This should only be used in case of Save As New Item Type Operations. 
                    For Save As of master parts, use @link PDM::PartOperationCopyBuilder::CreateNonMasterListForCopyLogicalObject PDM::PartOperationCopyBuilder::CreateNonMasterListForCopyLogicalObject@endlink .
                     <br> 
            ...
            /** Gets the list of non-master parts.
                    ...
                    Deprecated in NX10 for "Save As of master parts" operation. 
                    This should only be used in case of Save As New Item Type Operations. 
                    For Save As of master parts, use @link PDM::PartOperationCopyBuilder::GetNonMasterListForCopyLogicalObject PDM::PartOperationCopyBuilder::GetNonMasterListForCopyLogicalObject@endlink .
                     <br> 
            ...
            /** Returns whether or not the non-master part specified will actually
                    ...
                    Deprecated in NX10 for "Save As of master parts" operation. 
                    This should only be used in case of Save As New Item Type Operations. 
                    For Save As of master parts, use @link PDM::PartOperationCopyBuilder::IsNonMasterForLogicalObjectBeingCopied PDM::PartOperationCopyBuilder::IsNonMasterForLogicalObjectBeingCopied@endlink .
                     <br> 
            ...
            /** Sets whether or not the non-master part specified will actually
                    ...
                    Deprecated in NX10 for "Save As of master parts" operation. 
                    This should only be used in case of Save As New Item Type Operations. 
                    For Save As of master parts, use @link PDM::PartOperationCopyBuilder::SetSelectedNonMasterToCopy PDM::PartOperationCopyBuilder::SetSelectedNonMasterToCopy@endlink .
                     <br> 
            ...
            /** Sets the name the non-master part will get saved as. It will get saved as the
                    ...
                    Deprecated in NX10 for "Save As of master parts" operation. 
                    This should only be used in case of Save As New Item Type Operations. 
                    For Save As of master parts, use @link PDM::PartOperationCopyBuilder::EditNonMasterToCopyName PDM::PartOperationCopyBuilder::EditNonMasterToCopyName@endlink .
                     <br> 
