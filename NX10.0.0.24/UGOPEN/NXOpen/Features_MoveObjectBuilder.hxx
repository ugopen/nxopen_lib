...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link NXOpen::Features::MoveObjectBuilder NXOpen::Features::MoveObjectBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::Features::BaseFeatureCollection::CreateMoveObjectBuilder  NXOpen::Features::BaseFeatureCollection::CreateMoveObjectBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
