...
namespace NXOpen
{
    ...
    */
    class NXOPENUICPPEXPORT  MovieManager
    {
        ...
        void Start
        (
            const char * filename /** Filename of the movie to be createed   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            bool userFrames /** If true, user will provide frames through @link MovieManager::CaptureFrame MovieManager::CaptureFrame@endlink . If false, system generates frames */
        );
        ...
        (
            int fps /** Specifies the playback speed of the movie in frames per second. Valid range is 1 to 30 fps */
        );
