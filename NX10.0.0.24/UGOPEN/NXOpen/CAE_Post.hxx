        ...
        */
        class NXOPENCPP_CAEEXPORT  Post
        {
            ...
            /** Creates entity annotation object  @return  
             <br>  @deprecated Deprecated in NX9.0.0.  use @link NXOpen::CAE::Post::JA_SPP_create_annotation NXOpen::CAE::Post::JA_SPP_create_annotation@endlink  with extra face parameter. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  use NXOpen::CAE::Post::JA_SPP_create_annotation with extra face parameter.") NXOpen::CAE::PostAnnotation * CreateAnnotation
            (
                int postviewId /** postview id */ ,
                const NXString & name /** Annotation name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
