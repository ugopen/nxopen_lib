...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        {
            class ManagerImpl;
            /** Represents the Response Simulation manager to contain all Response Simulation objects  <br> To obtain an instance of this class, refer to @link NXOpen::CAE::SimSimulation  NXOpen::CAE::SimSimulation @endlink  <br> 
