#ifndef NXOpen_SELECTPLANELIST_HXX_INCLUDED
#define NXOpen_SELECTPLANELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectPlaneListBuilder;
    class SelectPlaneListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectPlaneList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectPlaneListImpl * m_selectplanelist_impl;
        private: friend class  _SelectPlaneListBuilder;
        protected: SelectPlaneList();
        public: ~SelectPlaneList();
        ...
        public: bool Add
        (
            NXOpen::Plane * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Plane *> & objects /** objects to add */
        );
        ...
        public: bool Remove
        (
            NXOpen::Plane * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if succesully removed from list;
        ...
        (
            const std::vector<NXOpen::Plane *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Plane * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Plane *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Plane *> GetArray
        (
        );
