...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /**  Represents a @link Routing::WatertightFittingsBuilder Routing::WatertightFittingsBuilder@endlink    <br> To create a new instance of this class, use @link NXOpen::Routing::RouteManager::CreateWatertightFittingsBuilder  NXOpen::Routing::RouteManager::CreateWatertightFittingsBuilder @endlink  <br> 
