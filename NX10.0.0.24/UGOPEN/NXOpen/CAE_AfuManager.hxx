        ...
        */
        class NXOPENCPP_CAEEXPORT  AfuManager
        {
            ...
            (
                std::vector<NXString> & sourceAfuFileNames /** List of the AFU Files to be copied (full filenames)   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<int> & recordIndexes /** Indexes of the AFU Data Records to be copied. Each index Must begin with 1 */,
                const char * destinationAfuFileName /** Destination AFU file (full filename)   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            void DeleteRecords
            (
                const char * afuFileName /** AFU file full name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<int> & afuRecordIndexes /** List of Indexes of data records to be deleted from the AFU file. (Indexes begin with 1) */
            );
            ...
            NXString GetAfuData
            (
                const char * afuFileName /** AFU filename   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int recordIndex /** Index of the AFU Data Record in the AFU file. Must begin with 1*/,
                NXOpen::CAE::AfuData ** afuData /** AFU record data queried */
            );
            /** Create an AFU Data Record object  @return  AFU Data Record 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link AfuManager::CreateAfuData AfuManager::CreateAfuData@endlink  that takes abscissa type instead. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use AfuManager::CreateAfuData that takes abscissa type instead.") NXOpen::CAE::AfuData * CreateAfuData
            (
            );
            ...
            void ImportAfu
            (
                const char * importFileName /** Filename for the file to be imported   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * afuFileName /** AFU Filename to import data into   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * afuFileName /** AFU filename   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int recordIndex /** Index of the AFU Data Record to be exported */,
                const char * exportFileName /** Name of destination file to which AFU Data Record is exported   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * afuFileName /** AFU Filename   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int recordIndex /** Index of the AFU Data Record in the AFU file. Must begin with 1. */,
                const char * newRecordName /** New Data Record name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                ...
                int recordIndex /** Index of the AFU Data Record to be listed */,
                bool listPointData /** List control flag. If true, the record XY data will be listed. Otherwise only AFU header information is listed. */,
                const char * outputFileName /** Output file to which the record information is written. If NULL, the information is only output to the listing window.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::CAE::AfuManager::WritingFileMode mode /** Overwrite or Append Output Mode for file output. Only valid when output file name is not NULL.*/
            );
