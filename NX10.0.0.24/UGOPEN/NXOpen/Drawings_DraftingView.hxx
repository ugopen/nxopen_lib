    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  DraftingView : public NXOpen::View, public virtual NXOpen::IFitTo
        {
            ...
            /**Returns  the status on whether this @link DraftingView DraftingView@endlink  is slave. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: bool IsSlave
            (
            );
            /**Returns  the status on whether this @link DraftingView DraftingView@endlink  is decoration. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
