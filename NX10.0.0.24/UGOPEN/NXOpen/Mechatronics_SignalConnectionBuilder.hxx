...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::SignalConnectionBuilder Mechatronics::SignalConnectionBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::Mechatronics::SignalConnectionCollection::CreateSignalConnectionBuilder  NXOpen::Mechatronics::SignalConnectionCollection::CreateSignalConnectionBuilder @endlink  <br> 
