...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Trim Body feature. This class is to be used only for editing pre-NX7.5.0 trim body features.
            Use @link Features::TrimBody2 Features::TrimBody2@endlink  to create and edit trim body features.  <br> To create or edit an instance of this class, use @link NXOpen::Features::TrimBodyBuilder  NXOpen::Features::TrimBodyBuilder @endlink  <br> 
