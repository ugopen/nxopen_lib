        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DesignTrimToolBuilder : public NXOpen::Builder
        {
            ...
            (
                NXOpen::NXObject * trimPart /** the trim part where to create or edit or trim surface feature. */,
                NXOpen::NXObject * sourceObjectOcc /** the source object occurrence used to create a linked feature in the trim part. */,
                const char * currentTrimSurfaceName /** the name to set to the trim surface feature.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * previousTrimSurfaceName /** the previous name of the trim surface feature.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * partName /** the part name for the new component.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * instanceName /** the instance name for the new component.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * surfaceName /** the name for the default sheet to create.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::NXObject * trimPart /** the trim part where to create the default trim surface feature. */,
                int sheetType /** the sheet type, parting sheet or mold surface. */,
                int layer /** the layer to put the new sheet feature. */
            );
