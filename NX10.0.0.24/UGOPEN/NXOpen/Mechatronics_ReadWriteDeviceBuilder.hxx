...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /**
            Represents a @link Mechatronics::ReadWriteDeviceBuilder Mechatronics::ReadWriteDeviceBuilder@endlink .
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ReadWriteDeviceBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the selected sensor @link Mechatronics::CollisionSensor Mechatronics::CollisionSensor@endlink  object. 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            public: NXOpen::Mechatronics::SelectCollisionSensor * Sensor
            (
            );
            /** Gets the form @link Mechatronics::TagFormObject Mechatronics::TagFormObject@endlink  object.  @return  
             <br>  Created in NX10.0.0.  <br>  
            ...
            /** Gets the table @link Mechatronics::TagTableObject Mechatronics::TagTableObject@endlink  object.  @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::TagTableObject * GetTable
            (
            );
            /** Sets the table @link Mechatronics::TagTableObject Mechatronics::TagTableObject@endlink  object. 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
