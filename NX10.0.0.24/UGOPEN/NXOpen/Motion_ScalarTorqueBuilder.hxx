...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /**Represents a @link Motion::ScalarTorqueBuilder Motion::ScalarTorqueBuilder@endlink  <br> To create a new instance of this class, use @link NXOpen::Motion::ScalarTorqueCollection::CreateScalarTorqueBuilder  NXOpen::Motion::ScalarTorqueCollection::CreateScalarTorqueBuilder @endlink  <br> 
