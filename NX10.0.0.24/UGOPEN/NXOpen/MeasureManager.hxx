...
namespace NXOpen
{
    ...
    /** Provides methods for manipulating the measurement objects in a part  <br> To obtain an instance of this class, refer to @link NXOpen::BasePart  NXOpen::BasePart @endlink  <br> 
    ...
    */
    class NXOPENCPPEXPORT  MeasureManager
    {
        ...
        /** Create a projected, minimum clearance or maximum clearance distance measure between two objects.
             <br> Features.SewBuilder.Types of allowed input objects include - Point, Curve, Edge, Face, Body. The Datum Plane and Datum Axis
        ...
        /** Creates a @link NXOpen::MeasureFaceBuilder NXOpen::MeasureFaceBuilder@endlink 
            Note:  This class is used internally for measurement, but is not required for creation 
            of a face measurement.  To create face measurements use @link Preferences::SessionModeling::NewFacePropertiesInheritance Preferences::SessionModeling::NewFacePropertiesInheritance@endlink .  @return  
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
