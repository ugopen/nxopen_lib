    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  Laminate : public NXOpen::CAE::PhysicalPropertyTable
        {
            ...
            (
                const NXString & csvFilename /** The name of the CSV file in which the analysis result will be written.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Perform a strength analysis on the current laminate definition using the current laminate strength loadcase. 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            ...
            (
                const char * csvFilename /** The name of the CSV file in which the analysis result will be written.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
