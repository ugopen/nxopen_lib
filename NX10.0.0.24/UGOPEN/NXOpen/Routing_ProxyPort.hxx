    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  ProxyPort : public NXOpen::Routing::Port, public virtual NXOpen::Routing::IAxisPort
        {
            ...
            protected: ProxyPort();
            public: ~ProxyPort();
            /**Returns  the backward extension of @link NXOpen::Routing::ProxyPort NXOpen::Routing::ProxyPort@endlink ,
                        i.e. the minimum length that a segment must remain straight
                        before entering a @link NXOpen::Routing::ProxyPort NXOpen::Routing::ProxyPort@endlink 
            ...
            /**Sets  the backward extension of @link NXOpen::Routing::ProxyPort NXOpen::Routing::ProxyPort@endlink ,
                        i.e. the minimum length that a segment must remain straight
                        before entering a @link NXOpen::Routing::ProxyPort NXOpen::Routing::ProxyPort@endlink 
