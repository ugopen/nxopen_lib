...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Part : public NXOpen::BasePart
    {
        ...
        */
        public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::PartFamily::FamilyAttribute::AttrType instead") enum PartFamilyAttrType
        {
        ...
        */
        ...
        /** Creates a @link NXOpen::GeometricUtilities::SelectionList NXOpen::GeometricUtilities::SelectionList@endlink  object.  @return  
         <br>  Created in NX8.0.0.  <br>  
         <br> License requirements : None */
