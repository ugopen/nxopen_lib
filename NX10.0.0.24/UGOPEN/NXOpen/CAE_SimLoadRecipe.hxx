    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimLoadRecipe : public NXOpen::TaggedObject
        {
            ...
            (
                const NXString & loadCondition /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Disables a load condition in the Load Recipe. Disabled load conditions will not be used when
                        creating a solution from load recipe.
             <br>  Created in NX10.0.0.  <br>  
            ...
            (
                const char * loadCondition /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & trackingValue /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Disables a tracking value in the Load Recipe. Disabled tracking values will not be used when
                        creating a solution from load recipe. 
             <br>  Created in NX10.0.0.  <br>  
            ...
            (
                const char * trackingValue /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & filePath /** Path of the CSV file   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & csvDelim /** Delimiter character used in the CSV file. 
                                                                            If NULL, the comma character will be used. 
                                                                            If this string contains more then one character, only the first one will be used.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                const char * filePath /** Path of the CSV file   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
