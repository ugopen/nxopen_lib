        ...
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ConnectorDevice : public NXOpen::Routing::SingleDevice
            {
                ...
                /** Get the nearest @link Routing::Electrical::HarnessDevice Routing::Electrical::HarnessDevice@endlink  encountered up the parent-child hierarchy.  @return  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                public: NXOpen::Routing::Electrical::HarnessDevice * FindNearestHarnessDevice
                (
                );
                /** Get the nearest @link Routing::Electrical::CableDevice Routing::Electrical::CableDevice@endlink  encountered up the parent-child hierarchy.  @return  
                 <br>  Created in NX4.0.2.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                ...
                (
                    const char * terminalName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    bool createTerminal /** TRUE - creates a new terminal if one does not exist with given name*/
                );
