        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  RollingLineBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /**Returns  the initial flow direction. Not used for @link NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure@endlink .
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Direction * SpecifyDirection
                (
                );
                /**Sets  the initial flow direction. Not used for @link NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure@endlink .
                 <br>  Created in NX8.0.0.  <br>  
                ...
                /**Returns  the plane orientation to be used for @link NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure@endlink .
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Plane * PlaneOrientation
                (
                );
                /**Sets  the plane orientation to be used for @link NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure@endlink .
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                ...
                /**Returns  the selected point for evaluation when @link NXOpen::Features::ShipDesign::RollingLineBuilder::StartEvaluationTypes NXOpen::Features::ShipDesign::RollingLineBuilder::StartEvaluationTypes@endlink  is
                            ...
                            Not used for @link NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure NXOpen::Features::ShipDesign::RollingLineBuilder::Types::SteppedPressure@endlink . 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
