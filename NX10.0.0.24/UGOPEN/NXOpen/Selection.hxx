    ...
    */
    class NXOPENUICPPEXPORT  Selection
    {
        ...
        public: /** It is an optional callback which the user can provide to perform
         ...
         <br>  @deprecated Deprecated in NX8.0.0.  Use @link Selection::FilterTaggedObjectCallback Selection::FilterTaggedObjectCallback@endlink  instead <br>  
        ...
        public: /** It is an optional callback which the user can provide to customize his selection 
         <br>  @deprecated Deprecated in NX8.0.0.  Use @link Selection::TaggedObjectSelectionCallback Selection::TaggedObjectSelectionCallback@endlink  instead <br>  
        ...
        (
            const char * message /** Cue line message to display   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const char * title /** Dialog title   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::Selection::SelectionScope scope /** Selection scope */,
            bool includeFeatures /** Whether to allow the selection of features */,
            bool keepHighlighted /** Whether to keep the selection highlighted after it has been selected */,
            std::vector<NXOpen::NXObject *> & objectArray /** The selected objects */
        ...
        /** Specify selection filter callback for additional filtering based on
         ...
         <br>  @deprecated Deprecated in NX8.0.0.  Use @link Selection::SetTaggedObjectSelectionCallbacks Selection::SetTaggedObjectSelectionCallbacks@endlink  instead <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Selection::SetTaggedObjectSelectionCallbacks instead") void SetSelectionCallbacks
        (
            NXOpen::SelectionHandle * select /** Selection handle */,
