...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link Features::IntersectionCurveBuilder Features::IntersectionCurveBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Features::FeatureCollection::CreateIntersectionCurveBuilder  NXOpen::Features::FeatureCollection::CreateIntersectionCurveBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
