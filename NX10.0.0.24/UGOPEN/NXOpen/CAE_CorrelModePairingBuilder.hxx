...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** This builder is used to control the mode pairing behavior of a @link CAE::CorrelSolution CAE::CorrelSolution@endlink   <br> To create a new instance of this class, use @link NXOpen::CAE::CorrelSolution::CreateModePairingBuilder  NXOpen::CAE::CorrelSolution::CreateModePairingBuilder @endlink  <br> 
