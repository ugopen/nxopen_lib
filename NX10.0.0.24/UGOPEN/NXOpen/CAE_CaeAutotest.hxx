    ...
    namespace CAE
    {
        ...
        */
        class NXOPENDEBUGSESSIONCPPEXPORT  CaeAutotest
        {
            ...
            (
                const char * newFileName /** New text file to be compared against   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * benchMarkFilename /** Benchmark file used as base line   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
