...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::PointOnCurveJoint Mechatronics::PointOnCurveJoint@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Mechatronics::PointOnCurveJointCollection::CreatePointOnCurveJointBuilder  NXOpen::Mechatronics::PointOnCurveJointCollection::CreatePointOnCurveJointBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
