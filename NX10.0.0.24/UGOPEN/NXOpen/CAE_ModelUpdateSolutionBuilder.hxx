...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::ModelUpdateSolutionBuilder CAE::ModelUpdateSolutionBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::CAE::ModelUpdateSolutionCollection::CreateSolutionBuilder  NXOpen::CAE::ModelUpdateSolutionCollection::CreateSolutionBuilder @endlink  <br> 
