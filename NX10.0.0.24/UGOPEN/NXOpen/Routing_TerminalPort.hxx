    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  TerminalPort : public NXOpen::Routing::Port, public virtual NXOpen::Routing::IAxisPort
        {
            ...
            /**Returns  the pin identifier (name) of the @link Routing::TerminalPort Routing::TerminalPort@endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXString PinIdentifier
            (
            );
            /**Sets  the pin identifier (name) of the @link Routing::TerminalPort Routing::TerminalPort@endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
