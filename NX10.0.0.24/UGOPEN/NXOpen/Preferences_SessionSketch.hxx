    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionSketch
        {
            ...
            public: enum RigidSetConstraintType
            {
            ...
            /**Returns  the rigid set external constraint management option 
             ...
             <br> License requirements : None */
            public: NXOpen::Preferences::SessionSketch::RigidSetConstraintType RigidSetConstraintOption
            (
            );
            /**Sets  the rigid set external constraint management option 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: void SetRigidSetConstraintOption
            (
