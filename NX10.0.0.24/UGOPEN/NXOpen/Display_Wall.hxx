        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  Wall : public NXOpen::Builder
        {
            /** Defines the material characteristics of a stage wall.
             ...
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link Display::Wall::WallMaterialTextureType Display::Wall::WallMaterialTextureType@endlink  instead. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use Display::Wall::WallMaterialTextureType instead.") enum MaterialType
            {
            ...
            /**Returns  the wall material type - either shadow_catcher, reflective, or invisible 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link Display::Wall::WallMaterialTextureType Display::Wall::WallMaterialTextureType @endlink and @link Display::Wall::SetWallMaterialTextureType Display::Wall::SetWallMaterialTextureType @endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use Display::Wall::WallMaterialTextureType Display::Wall::WallMaterialTextureType @endlink and @link Display::Wall::SetWallMaterialTextureType Display::Wall::SetWallMaterialTextureType @endlink  instead.") NXOpen::Display::Wall::MaterialType WallMaterialType
            (
            );
            /**Sets  the wall material type - either shadow_catcher, reflective, or invisible 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use Display::Wall::WallMaterialTextureType Display::Wall::WallMaterialTextureType @endlink and @link Display::Wall::SetWallMaterialTextureType Display::Wall::SetWallMaterialTextureType @endlink  instead.") void SetWallMaterialType
            (
            ...
            /**Returns  the pattern repeat factor - the number of times the image repeats 
             <br>  @deprecated Deprecated in NX10.0.0.  This functionality is moved to @link Display::Image Display::Image@endlink . <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  This functionality is moved to Display::Image.") double PatternRepeatFactor
            (
            );
            /**Sets  the pattern repeat factor - the number of times the image repeats 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  This functionality is moved to Display::Image.") void SetPatternRepeatFactor
            (
