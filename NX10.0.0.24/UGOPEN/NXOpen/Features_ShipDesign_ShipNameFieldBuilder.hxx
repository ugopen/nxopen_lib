        ...
        namespace ShipDesign
        {
            ...
            /** A field, combined with other fields, to generate a name for a Ship Basic Design Object such as a Deck.
                        ...
                        Fields can be one of four types:
                            ...
                            2) Any              A user enterable string value
                            3) Option           A pre-defined set of strings from which the user can choose one
                        ...
                        The fields for a particular Ship object type (JA_SHIPNAMES_BUILDER_Type) are defined in
