...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link Features::PartModule Features::PartModule@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Features::FeatureCollection::CreatePartModuleBuilder  NXOpen::Features::FeatureCollection::CreatePartModuleBuilder @endlink  <br> 
