...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /** Represents a @link Assemblies::ReplaceComponentBuilder Assemblies::ReplaceComponentBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Assemblies::AssemblyManager::CreateReplaceComponentBuilder  NXOpen::Assemblies::AssemblyManager::CreateReplaceComponentBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ReplaceComponentBuilder : public NXOpen::Builder
        {
            ...
            (
                NXOpen::Assemblies::ReplaceComponentBuilder::ComponentReferenceSet componentReferenceSet /** Reference set */,
                const char * referenceSetName /** Name of the reference set. Used only when componentReferenceSet is @link Assemblies::ReplaceComponentBuilder::ComponentReferenceSetOthers Assemblies::ReplaceComponentBuilder::ComponentReferenceSetOthers@endlink    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
