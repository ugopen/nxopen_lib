    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  JointmarkBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Creates a @link NXOpen::Weld::JointmarkGuideBuilder NXOpen::Weld::JointmarkGuideBuilder@endlink  object.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Weld::JointmarkGuideBuilder * NewGuide
            (
            );
            /** Creates a @link NXOpen::Weld::JointmarkFaceSetsBuilder NXOpen::Weld::JointmarkFaceSetsBuilder@endlink  object.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Weld::JointmarkFaceSetsBuilder * NewFaceSets
            (
            );
            /** Creates a @link NXOpen::Weld::JointmarkPointsBuilder NXOpen::Weld::JointmarkPointsBuilder@endlink  object.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            ...
            (
                ...
                const NXString & name /** Symbol id     <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Create curve From PMI symbol  @return  Curve from symbol 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            ...
            (
                ...
                const char * name /** Symbol id     <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                bool createSingleFeatures /** true- Full associative features are created. fale- single non associative features.*/
            );
