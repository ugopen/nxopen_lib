    ...
    namespace Diagramming
    {
        ...
        */
        class NXOPENDEBUGSESSIONCPPEXPORT  PipeBuilder : public NXOpen::Builder
        {
            ...
            /** Set the owning sheet after the pipe is created.
            ...
            /**Returns  the type of this pipe. 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXString Type
            (
            );
            /**Sets  the type of this pipe. 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: void SetType
            (
            ...
            /** Get connection rendering properties.  @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Diagramming::LineRenderingPropertiesBuilder * GetConnectionRenderingProperties
            (
            );
        };
    }
