    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  ClockPartBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the user selected @link Routing::Port  Routing::Port @endlink  for rotation of compoent 
             <br>  Created in NX7.5.0.  <br>  
            ...
            /** Suppress the constraind applied to the selected @link  Routing::Port   Routing::Port @endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
