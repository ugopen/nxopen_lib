...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a hole package and hole series feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::HolePackageBuilder  NXOpen::Features::HolePackageBuilder @endlink  <br> 
