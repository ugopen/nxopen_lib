...
namespace NXOpen
{
    ...
    namespace Facet
    {
        ...
        /** This class finds and fills holes to a prescribed boundary smoothness condition  <br> To create a new instance of this class, use @link NXOpen::Facet::FacetedBodyCollection::CreateFillHoleBuilder  NXOpen::Facet::FacetedBodyCollection::CreateFillHoleBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
