...
namespace NXOpen
{
    ...
    /** Manages the display and changes to it  <br> To obtain an instance of this class, refer to @link NXOpen::Session  NXOpen::Session @endlink  <br> 
    ...
    */
    class NXOPENCPPEXPORT  DisplayManager
    {
        ...
        /** Hides a set of objects by type.  You may want to use @link NXOpen::View::FitAfterShowOrHide NXOpen::View::FitAfterShowOrHide@endlink 
         ...
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::DisplayManager::HideByType NXOpen::DisplayManager::HideByType@endlink  that takes a string type instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::DisplayManager::HideByType that takes a string type instead.") int HideByType
        (
