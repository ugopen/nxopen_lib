...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::SCOUTExportBuilder Mechatronics::SCOUTExportBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::Mechatronics::PhysicsManager::CreateSCOUTExportBuilder  NXOpen::Mechatronics::PhysicsManager::CreateSCOUTExportBuilder @endlink  <br> 
