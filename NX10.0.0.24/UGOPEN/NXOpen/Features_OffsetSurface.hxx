...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a offset surface feature.  <br> To create or edit an instance of this class, use @link NXOpen::Features::OffsetSurfaceBuilder  NXOpen::Features::OffsetSurfaceBuilder @endlink  <br> 
