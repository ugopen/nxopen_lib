...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a @link NXOpen::Features::HolePackage NXOpen::Features::HolePackage@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Features::FeatureCollection::CreateHolePackageBuilder  NXOpen::Features::FeatureCollection::CreateHolePackageBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
