        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  MasterSymbolBuilder : public NXOpen::Builder
        {
            ...
            /** Item number assign button. This will generate the item number, valid in team center 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link JA_MASTER_SYMBOL_BUILDER_set_ItemNumber JA_MASTER_SYMBOL_BUILDER_set_ItemNumber@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use JA_MASTER_SYMBOL_BUILDER_set_ItemNumber instead.") void GenerateItemNumber
            (
            );
            /** Revision assign button, This will generate the revision number, valid in team center 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link JA_MASTER_SYMBOL_BUILDER_set_Revision JA_MASTER_SYMBOL_BUILDER_set_Revision@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use JA_MASTER_SYMBOL_BUILDER_set_Revision instead.") void GenerateRevision
            (
            );
