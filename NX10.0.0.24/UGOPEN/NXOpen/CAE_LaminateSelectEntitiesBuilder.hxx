...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::LaminateSelectEntitiesBuilder CAE::LaminateSelectEntitiesBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::CAE::LaminateGlobalLayupMgr::CreateLaminateSelectEntitiesBuilder  NXOpen::CAE::LaminateGlobalLayupMgr::CreateLaminateSelectEntitiesBuilder @endlink  <br> 
