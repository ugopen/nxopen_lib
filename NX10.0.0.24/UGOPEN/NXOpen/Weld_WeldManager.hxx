    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  WeldManager : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Creates a @link Weld::PointMarkBuilder Weld::PointMarkBuilder@endlink  object.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            ...
            /** Creates a @link Weld::PointMarkBuilder Weld::PointMarkBuilder@endlink  object from a single element feature.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
