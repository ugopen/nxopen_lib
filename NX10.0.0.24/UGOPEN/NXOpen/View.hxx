    ...
    */
    class NXOPENCPPEXPORT  View : public NXOpen::NXObject
    {
        ...
        /**Returns  the view origin.  This is the negation of the position in "untranslated view space",
            ...
            from @link NXOpen::View::Matrix NXOpen::View::Matrix @endlink and @link NXOpen::View::SetMatrix NXOpen::View::SetMatrix @endlink .  Note that the origin in this method is not in
            ...
            @link NXOpen::View::AbsoluteOrigin NXOpen::View::AbsoluteOrigin @endlink and @link NXOpen::View::SetAbsoluteOrigin NXOpen::View::SetAbsoluteOrigin @endlink 
             <br> 
