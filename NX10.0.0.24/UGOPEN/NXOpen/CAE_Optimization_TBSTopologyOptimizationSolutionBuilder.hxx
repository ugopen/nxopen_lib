...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents the builder of @link CAE::Optimization::TBSTopologyOptimizationSolution CAE::Optimization::TBSTopologyOptimizationSolution@endlink . <br> To create a new instance of this class, use @link NXOpen::CAE::Optimization::TBSOptimizationManager::CreateTopologyOptimizationSolutionBuilder  NXOpen::CAE::Optimization::TBSOptimizationManager::CreateTopologyOptimizationSolutionBuilder @endlink  <br> 
