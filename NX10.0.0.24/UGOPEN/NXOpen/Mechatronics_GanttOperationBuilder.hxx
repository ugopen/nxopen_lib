...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::GanttOperationBuilder Mechatronics::GanttOperationBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Mechatronics::GanttCollection::CreateGanttOperationBuilder  NXOpen::Mechatronics::GanttCollection::CreateGanttOperationBuilder @endlink  <br> 
