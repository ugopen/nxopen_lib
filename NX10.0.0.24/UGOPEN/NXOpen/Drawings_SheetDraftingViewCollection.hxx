...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Represents a collection of @link Drawings::DraftingView Drawings::DraftingView@endlink s.    <br> Use @link Drawings::DrawingSheet::SheetDraftingViews Drawings::DrawingSheet::SheetDraftingViews@endlink  to get the instance of this class.  <br> 
