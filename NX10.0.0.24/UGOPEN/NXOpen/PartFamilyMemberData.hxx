...
namespace NXOpen
{
    ...
    /** This class is responsible for storing part family member data 
     ...
     <br>  @deprecated Deprecated in NX9.0.0.  Use @link PartFamily::InstanceDefinition PartFamily::InstanceDefinition@endlink  and @link PartFamily::TemplateManager PartFamily::TemplateManager@endlink  instead. <br>  

     <br>  Created in NX6.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  NX_DEPRECATED("Deprecated in NX9.0.0.  Use PartFamily::InstanceDefinition and PartFamily::TemplateManager instead.")  PartFamilyMemberData : public NXOpen::TransientObject
    {
        ...
        /** Set the part family member data 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link PartFamily::TemplateManager::AddInstanceDefinition PartFamily::TemplateManager::AddInstanceDefinition@endlink  and @link PartFamily::InstanceDefinition::SetValueOfAttribute PartFamily::InstanceDefinition::SetValueOfAttribute@endlink  instead <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use PartFamily::TemplateManager::AddInstanceDefinition and PartFamily::InstanceDefinition::SetValueOfAttribute instead") void SetMemberData
        (
