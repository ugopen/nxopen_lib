    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseCustomSymbol : public NXOpen::Annotations::DraftingAid, public virtual NXOpen::Annotations::IPmi
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Annotations::DraftingCustomSymbolBuilder for Drafting Custom Symbol and Annotations::PmiCustomSymbolBuilder for PMI Custom Symbol objects.") NXOpen::Annotations::CustomSymbolData * GetSymbolData
            (
            );
            ...
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use Annotations::DraftingCustomSymbolBuilder for Drafting Custom Symbol and Annotations::PmiCustomSymbolBuilder for PMI Custom Symbol objects.") void SetSymbolData
            (
