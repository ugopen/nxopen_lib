        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionPreferences : public NXOpen::TransientObject
        {
            ...
            /**Returns  the zero tolerance display style 
             <br>  @deprecated Deprecated in NX7.5.0.  Use @link Annotations::LinearTolerance::ZeroToleranceDisplayStyle Annotations::LinearTolerance::ZeroToleranceDisplayStyle@endlink  for linear dimensions and @link Annotations::AngularTolerance::ZeroToleranceDisplayStyle Annotations::AngularTolerance::ZeroToleranceDisplayStyle@endlink  for angular dimensions instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0.  Use Annotations::LinearTolerance::ZeroToleranceDisplayStyle for linear dimensions and Annotations::AngularTolerance::ZeroToleranceDisplayStyle for angular dimensions instead.") NXOpen::Annotations::ZeroToleranceDisplayStyle ZeroToleranceDisplayStyle
            (
            );
            /**Sets  the zero tolerance display style 
             <br>  @deprecated Deprecated in NX7.5.0.  Use @link Annotations::LinearTolerance::SetZeroToleranceDisplayStyle Annotations::LinearTolerance::SetZeroToleranceDisplayStyle@endlink  for linear dimensions and @link Annotations::AngularTolerance::SetZeroToleranceDisplayStyle Annotations::AngularTolerance::SetZeroToleranceDisplayStyle@endlink  for angular dimensions instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0.  Use Annotations::LinearTolerance::SetZeroToleranceDisplayStyle for linear dimensions and Annotations::AngularTolerance::SetZeroToleranceDisplayStyle for angular dimensions instead.") void SetZeroToleranceDisplayStyle
            (
            ...
            /**Returns  the display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::FitAssemblyDisplayStyle LimitFitAssemblyDisplayStyle
            (
            );
            /**Sets  the display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLimitFitAssemblyDisplayStyle
            (
