        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LetteringStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the dimension text line width.
                        ...
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link Annotations::LetteringStyleBuilder::DimensionTextItalicized Annotations::LetteringStyleBuilder::DimensionTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetDimensionTextItalicized Annotations::LetteringStyleBuilder::SetDimensionTextItalicized @endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Bold" or "Bold Italic" (if @link Annotations::LetteringStyleBuilder::DimensionTextItalicized Annotations::LetteringStyleBuilder::DimensionTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetDimensionTextItalicized Annotations::LetteringStyleBuilder::SetDimensionTextItalicized @endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the appended text line width.
                        The values for @link NXOpen::Annotations::LineWidth NXOpen::Annotations::LineWidth@endlink  when using standard font : 
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link Annotations::LetteringStyleBuilder::AppendedTextItalicized Annotations::LetteringStyleBuilder::AppendedTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetAppendedTextItalicized Annotations::LetteringStyleBuilder::SetAppendedTextItalicized @endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Bold" or "Bold Italic" (if @link Annotations::LetteringStyleBuilder::AppendedTextItalicized Annotations::LetteringStyleBuilder::AppendedTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetAppendedTextItalicized Annotations::LetteringStyleBuilder::SetAppendedTextItalicized @endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the tolerance text line width.
                        The values for @link NXOpen::Annotations::LineWidth NXOpen::Annotations::LineWidth@endlink  when using standard font : 
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link Annotations::LetteringStyleBuilder::ToleranceTextItalicized Annotations::LetteringStyleBuilder::ToleranceTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetToleranceTextItalicized Annotations::LetteringStyleBuilder::SetToleranceTextItalicized @endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Bold" or "Bold Italic" (if @link Annotations::LetteringStyleBuilder::ToleranceTextItalicized Annotations::LetteringStyleBuilder::ToleranceTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetToleranceTextItalicized Annotations::LetteringStyleBuilder::SetToleranceTextItalicized @endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the general text line width.
                        The values for @link NXOpen::Annotations::LineWidth NXOpen::Annotations::LineWidth@endlink  when using standard font : 
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link Annotations::LetteringStyleBuilder::GeneralTextItalicized Annotations::LetteringStyleBuilder::GeneralTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetGeneralTextItalicized Annotations::LetteringStyleBuilder::SetGeneralTextItalicized @endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Bold" or "Bold Italic" (if @link Annotations::LetteringStyleBuilder::GeneralTextItalicized Annotations::LetteringStyleBuilder::GeneralTextItalicized @endlink and @link Annotations::LetteringStyleBuilder::SetGeneralTextItalicized Annotations::LetteringStyleBuilder::SetGeneralTextItalicized @endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
