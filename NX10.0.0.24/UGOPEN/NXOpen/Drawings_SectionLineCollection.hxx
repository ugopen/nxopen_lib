        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  SectionLineCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Creates the Section Line Style Builder  @return  
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link Drawings::ViewSectionLineBuilder Drawings::ViewSectionLineBuilder@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use Drawings::ViewSectionLineBuilder instead.") NXOpen::Drawings::SectionLineStyleBuilder * CreateSectionLineStyleBuilder
            (
                NXOpen::Drawings::SectionLine * sectionline /** sectionline */ 
            );
