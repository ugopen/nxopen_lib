    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ComponentOrder : public NXOpen::Assemblies::Order
        {
            ...
            /** Given a parent @link NXOpen::Assemblies::ComponentAssembly NXOpen::Assemblies::ComponentAssembly@endlink  this method
                    returns immediate child @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink s in the same order in
                    which they are ordered in this @link NXOpen::Assemblies::ComponentOrder NXOpen::Assemblies::ComponentOrder@endlink  @return  Children of @link NXOpen::Assemblies::ComponentAssembly NXOpen::Assemblies::ComponentAssembly@endlink   
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Assemblies::Component *> AskChildrenOrder
            (
                NXOpen::Assemblies::ComponentAssembly * parent /** @link NXOpen::Assemblies::ComponentAssembly NXOpen::Assemblies::ComponentAssembly@endlink  whose children are required */
            );
        };
    }
}
