...
namespace NXOpen
{
    ...
    */
    class NXOPENDEBUGUICPPEXPORT  BlockStylerDebugSession
    {
        ...
        (
            const char * blockName /** Class name of the block. E.g., UICOMP_toggle, UGS::UI::Comp::DoubleTable etc  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
