        ...
        namespace Xyplot
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  PlotGraphTemplate : public NXOpen::TaggedObject, public virtual NXOpen::CAE::Xyplot::IDisplayStyle
            {
                ...
                (
                    const NXString & strXmlFile /** Template xml file name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                /** Updates current graph template setting from a template xml file 
                 <br>  Created in NX10.0.0.  <br>  
                 <br> License requirements : nx_ftk ("NX Advanced Graphing") */
                void ImportTemplate
                (
                    const char * strXmlFile /** Template xml file name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
