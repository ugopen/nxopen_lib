        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  CompDrawingBuilder : public NXOpen::Builder
        {
            ...
            (
                ...
                const NXString & drawingName /** drawing name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & templateName /** template name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                std::vector<NXString> & attributeTitles /** attribute titles   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                std::vector<NXString> & attributeValues /** attribute values   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Creates a drawing for a component and copy attribute to the drawing part 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
