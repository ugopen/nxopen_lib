...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents a @link CAE::Optimization::DAODesignVariableBuilder CAE::Optimization::DAODesignVariableBuilder@endlink .  <br> To create a new instance of this class, use @link NXOpen::CAE::Optimization::DAOSolutionCollection::CreateDesignVariableBuilder  NXOpen::CAE::Optimization::DAOSolutionCollection::CreateDesignVariableBuilder @endlink  <br> 
