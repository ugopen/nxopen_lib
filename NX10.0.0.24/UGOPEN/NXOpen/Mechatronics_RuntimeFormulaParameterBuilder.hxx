...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::RuntimeFormulaParameterBuilder Mechatronics::RuntimeFormulaParameterBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Mechatronics::RuntimeFormulaCollection::CreateRuntimeFormulaParameterBuilder  NXOpen::Mechatronics::RuntimeFormulaCollection::CreateRuntimeFormulaParameterBuilder @endlink  <br> 
