...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a collection of @link Annotations::IntersectionSymbol Annotations::IntersectionSymbol@endlink  objects  <br> To obtain an instance of this class, refer to @link NXOpen::Annotations::AnnotationManager  NXOpen::Annotations::AnnotationManager @endlink  <br> 
