...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Represents a @link Weld::UserDefinedWeldBuilder Weld::UserDefinedWeldBuilder@endlink  builder.  <br> To create a new instance of this class, use @link NXOpen::Weld::WeldManager::CreateUserDefinedWeldBuilder  NXOpen::Weld::WeldManager::CreateUserDefinedWeldBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
