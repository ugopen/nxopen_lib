...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /**Represents a @link Motion::ScalarForceBuilder Motion::ScalarForceBuilder@endlink  <br> To create a new instance of this class, use @link NXOpen::Motion::ScalarForceCollection::CreateScalarForceBuilder  NXOpen::Motion::ScalarForceCollection::CreateScalarForceBuilder @endlink  <br> 
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  ScalarForceBuilder : public NXOpen::Motion::MotionBuilder
        {
            ...
            /**Returns  the constant value 
             <br>  @deprecated Deprecated in NX8.0.0.  Obtain the expression using @link Motion::ScalarForceBuilder::ValueExpression Motion::ScalarForceBuilder::ValueExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Obtain the expression using Motion::ScalarForceBuilder::ValueExpression to query or edit it.") double ConstantValue
            (
            );
            /**Sets  the constant value 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Obtain the expression using Motion::ScalarForceBuilder::ValueExpression to query or edit it.") void SetConstantValue
            (
