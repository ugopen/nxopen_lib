...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ExpressionCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        /** Returns the right hand side name for an interpart expression reference.  @return  right hand side name 
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Returns the left hand side name for an overriding interpart expression reference.  @return  left hand side name 
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : None */
