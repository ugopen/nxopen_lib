...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a collection of @link Routing::LineSegment Routing::LineSegment@endlink  objects.  <br> To obtain an instance of this class, refer to @link NXOpen::Routing::SegmentManager  NXOpen::Routing::SegmentManager @endlink  <br> 
