...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a pattern geometry feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::PatternGeometryBuilder  NXOpen::Features::PatternGeometryBuilder @endlink  <br> 
