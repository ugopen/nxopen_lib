...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Subdivision
        {
            ...
            /** Represents a @link Features::Subdivision::SubdivisionBridgeFaceBuilder Features::Subdivision::SubdivisionBridgeFaceBuilder@endlink  builder.   <br> To create a new instance of this class, use @link NXOpen::Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionBridgeFaceBuilder  NXOpen::Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionBridgeFaceBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
