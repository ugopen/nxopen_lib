    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewWorkflowBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            */
            public:  NX_DEPRECATED("Deprecated in NX9.0.3.  Use NXOpen::Drawings::ViewWorkflowBuilder::HandlingBodiesType instead.") enum Handlingbodies
            {
            ...
            /**Sets  the handling bodies provides option for update view without lightweight data 
             <br>  @deprecated Deprecated in NX9.0.3.  Use @link NXOpen::Drawings::ViewWorkflowBuilder::SetSetHandlingBodiesTypes NXOpen::Drawings::ViewWorkflowBuilder::SetSetHandlingBodiesTypes@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.3.  Use NXOpen::Drawings::ViewWorkflowBuilder::SetSetHandlingBodiesTypes instead.") void SetHandlingBodies
            (
