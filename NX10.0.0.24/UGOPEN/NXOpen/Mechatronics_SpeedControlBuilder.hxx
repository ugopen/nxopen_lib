...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents a @link Mechatronics::SpeedControl Mechatronics::SpeedControl@endlink  builder.  <br> To create a new instance of this class, use @link NXOpen::Mechatronics::SpeedControlCollection::CreateSpeedControlBuilder  NXOpen::Mechatronics::SpeedControlCollection::CreateSpeedControlBuilder @endlink  <br> 
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SpeedControlBuilder : public NXOpen::Mechatronics::PhysicsConstraintBuilder
        {
            ...
            /**Returns  the joint select. This can be a @link HingeJoint HingeJoint@endlink , @link SlidingJoint SlidingJoint@endlink 
                    , @link CylindricalJoint CylindricalJoint@endlink  and @link TransportSurface TransportSurface@endlink .
             <br>  Created in NX7.5.1.  <br>  
            ...
            /**Returns  the direction type, which works only when the speed control is used to
                        drive @link TransportSurface TransportSurface@endlink  
