...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link Annotations::RegionBuilder Annotations::RegionBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Annotations::PmiRegionCollection::CreateRegionBuilder  NXOpen::Annotations::PmiRegionCollection::CreateRegionBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  RegionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the origin
                        ...
                        @link Annotations::RegionBuilder::TypesAnnularRegion Annotations::RegionBuilder::TypesAnnularRegion@endlink  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /**Returns  the select cylindrical face 
                        Only available when region type is
                        @link Annotations::RegionBuilder::TypesCylindricalRegion Annotations::RegionBuilder::TypesCylindricalRegion@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the arbitrary area list
                        Only available when the region type is
                        @link Annotations::RegionBuilder::TypesArbitraryRegion Annotations::RegionBuilder::TypesArbitraryRegion@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::ArbitraryAreaSeedBuilderList * ArbitraryAreaList
            (
            );
            /**Returns  the crosshatch distance. Use @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  instead. 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Annotations::RegionBuilder::CrosshatchSettings instead.") NXOpen::Expression * CrosshatchDistance
            (
            );
            /**Returns  the crosshatch angle. Use @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  instead. 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Annotations::RegionBuilder::CrosshatchSettings instead.") NXOpen::Expression * CrosshatchAngle
            (
            );
            /**Returns  the crosshatch pattern enum. Use @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  instead. 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use Annotations::RegionBuilder::CrosshatchSettings instead.") NXOpen::Annotations::RegionBuilder::CrosshatchPatterns CrosshatchPattern
            (
            );
            /**Sets  the crosshatch pattern enum. Use @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  instead. 
             <br>  @deprecated Deprecated in NX8.5.0.  Use the sublock of  @link Annotations::RegionBuilder::CrosshatchSettings Annotations::RegionBuilder::CrosshatchSettings@endlink  called Pattern instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use the sublock of  Annotations::RegionBuilder::CrosshatchSettings called Pattern instead.") void SetCrosshatchPattern
            (
