        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  ResultObject : public NXOpen::NXObject
        {
            ...
            /**Returns  the name of check result 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXObject::Name NXObject::Name @endlink and @link NXObject::SetName NXObject::SetName @endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXObject::Name NXObject::Name @endlink and @link NXObject::SetName NXObject::SetName @endlink  instead.") NXString Name
            (
            );
            /**Sets  the name of check result 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXObject::Name NXObject::Name @endlink and @link NXObject::SetName NXObject::SetName @endlink  instead.") void SetName
            (
