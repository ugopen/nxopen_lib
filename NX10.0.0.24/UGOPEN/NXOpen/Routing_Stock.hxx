    ...
    namespace Routing
    {
        ...
        /**
                 ...
                 <br> 
                    ...
                    style (if availble, otherwise it uses the @link NXOpen::Routing::StockStyleDetailed NXOpen::Routing::StockStyleDetailed@endlink  style) and
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  Stock : public NXOpen::NXObject, public virtual NXOpen::Routing::ICharacteristic
        {
            ...
            /** Makes the stock "featurable" by generating a sweep feature over every segment of the stock, 
             ...
             <br>  @deprecated Deprecated in NX10.0.0.  Change stock style to anything other than centerline instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Change stock style to anything other than centerline instead.") void EnableFeatures
            (
            );
