...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        /** Represents a @link Weld::AutoPointBuilder Weld::AutoPointBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Weld::WeldManager::CreateAutoPointBuilder  NXOpen::Weld::WeldManager::CreateAutoPointBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
