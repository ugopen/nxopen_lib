...
namespace NXOpen
{
    ...
    class BasePartImpl;
    /** Base class for an NX part.  <br> Use the @link NXOpen::PartCollection NXOpen::PartCollection@endlink  class to load or create a part. Use @link NXOpen::PartCollection::WorkComponentOption NXOpen::PartCollection::WorkComponentOption@endlink  to obtain the current work part.  <br> 
    ...
    */
    class NXOPENCPPEXPORT  BasePart : public NXOpen::NXObject
    {
        ...
        /** The collaborative content type of this part. It will return @link NXOpen::BasePart::CollaborativeContentType::NotAssigned NXOpen::BasePart::CollaborativeContentType::NotAssigned@endlink 
        ...
        /** Returns the Display.CgfxAttrCollection instance belonging to this part 
         <br>  Created in NX5.0.6.  <br>  
        */
        public: NXOpen::Display::CgfxAttrCollection *CgfxAttrs();
        /** Returns the Display.CgfxMattexCollection instance belonging to this part 
         <br>  Created in NX5.0.6.  <br>  
        */
        public: NXOpen::Display::CgfxMattexCollection *CgfxMattex();
