...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a collection of features  <br> To obtain an instance of this class, refer to @link NXOpen::Part  NXOpen::Part @endlink  <br> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Creates a Datum CSYS feature builder  @return  DatumCsysBuilder object 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : features_modeling ("FEATURES MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT"), solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT") */
            ...
            /** Returns if a @link NXOpen::Features::MasterCutBuilder NXOpen::Features::MasterCutBuilder@endlink  is visbible in specified @link NXOpen::CutView NXOpen::CutView@endlink  . @return  True if master cut is visible in view
                                                                 False otherwise 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** Creates a delete face builder, don't use it until nx502  @return  Features.DeleteFaceBuilder object 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") */
            ...
            /** Creates a @link NXOpen::Features::ReplaceFeatureBuilder NXOpen::Features::ReplaceFeatureBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ReplaceFeatureBuilder * CreateReplaceFeatureBuilder
            (
            );
            /** Creates a @link NXOpen::Features::PaintParametersBuilder NXOpen::Features::PaintParametersBuilder@endlink   @return  
            ...
            /** Creates a @link NXOpen::GeometricUtilities::RenameLinkedPartModulePartBuilder NXOpen::GeometricUtilities::RenameLinkedPartModulePartBuilder@endlink   @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
