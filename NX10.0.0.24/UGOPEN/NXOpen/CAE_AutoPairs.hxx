    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AutoPairs : public NXOpen::NXObject
        {
            ...
            protected: AutoPairs();
            public: ~AutoPairs();
            /** Set the list of @link CAE::CAEFace CAE::CAEFace@endlink   
             <br>  Created in NX5.0.0.  <br>  
            ...
            /** Get the list @link CAE::CAEFace CAE::CAEFace@endlink   
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Set the list of @link CAE::CAEBody CAE::CAEBody@endlink    
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Get the list of @link CAE::CAEBody CAE::CAEBody@endlink   
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Create face pairs whose distance is less than the distance tolerance stored
                        in the recipe. These faces are instances of @link CAE::CAEFace CAE::CAEFace@endlink  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
