        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  Stage : public NXOpen::Builder
        {
            ...
            /**Returns  the size all of the stage walls (length and width), in part units 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link Display::Stage::SizeExpression Display::Stage::SizeExpression @endlink and @link Display::Stage::SetSizeExpression Display::Stage::SetSizeExpression @endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use Display::Stage::SizeExpression Display::Stage::SizeExpression @endlink and @link Display::Stage::SetSizeExpression Display::Stage::SetSizeExpression @endlink  instead.") double Size
            (
            );
            ...
            /**Returns  the offset distance to translate the stage in the z-direction, in part units 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link Display::Stage::OffsetExpression Display::Stage::OffsetExpression @endlink and @link Display::Stage::SetOffsetExpression Display::Stage::SetOffsetExpression @endlink instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use Display::Stage::OffsetExpression Display::Stage::OffsetExpression @endlink and @link Display::Stage::SetOffsetExpression Display::Stage::SetOffsetExpression @endlink instead.") double Offset
            (
            );
