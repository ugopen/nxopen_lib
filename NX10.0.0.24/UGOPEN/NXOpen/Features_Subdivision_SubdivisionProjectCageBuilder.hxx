...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Subdivision
        {
            ...
            /** Represents a @link Features::Subdivision::SubdivisionProjectCageBuilder Features::Subdivision::SubdivisionProjectCageBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionProjectCageBuilder  NXOpen::Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionProjectCageBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
