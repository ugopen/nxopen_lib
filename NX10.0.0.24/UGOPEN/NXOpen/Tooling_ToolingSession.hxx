    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ToolingSession
        {
            ...
            /** Create Tooling.SpreadsheetData object.  @return  the new @link NXOpen::Tooling::SpreadsheetData NXOpen::Tooling::SpreadsheetData@endlink  instance 
             <br>  Created in NX8.0.0.  <br>  
            ...
            /** Gets the reusable component  @return  The array of reuseable components 
            ...
            (
                const NXString & filename /** Name of part file   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                const char * filename /** Name of part file   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                bool isNativePart /** Is the file from native or TC */
            );
