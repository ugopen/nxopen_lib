        ...
        */
        class NXOPENCPP_CAEEXPORT  FemPart : public NXOpen::CAE::BaseFemPart
        {
            ...
            /** Finalizes the creation of the fem part file.
             ...
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::CAE::FemPart::FinalizeCreation NXOpen::CAE::FemPart::FinalizeCreation@endlink  that includes abstraction type instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::CAE::FemPart::FinalizeCreation that includes abstraction type instead.") void FinalizeCreation
            (
            ...
            /** Finalizes the creation of the fem part file.
                        ...
                        based on solver name and analysis type.
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::CAE::FemPart::FinalizeCreationManaged NXOpen::CAE::FemPart::FinalizeCreationManaged@endlink  that includes abstraction type instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::CAE::FemPart::FinalizeCreationManaged that includes abstraction type instead.") void FinalizeCreationManaged
            (
                NXOpen::Part * cadPart /** the cad part to be associated with the fem part */,
                bool createIdealPart /** idealized part created if true */,
                NXOpen::CAE::FemPart::UseBodiesOption useBodiesOption /** The option to specify bodies to use from the cad part while creating the fem part */,
