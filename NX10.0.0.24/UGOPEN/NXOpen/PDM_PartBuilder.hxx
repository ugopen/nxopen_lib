        ...
        */
        class NXOPENCPP_PDMEXPORT  PartBuilder : public NXOpen::TransientObject
        {
            ...
            (
                ...
                const NXString & partNumber /** the multifield key   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                ...
                const NXString & partFileName /** the dataset name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Create the specification for the new part that will be created.
                    For the input part_number:
                    In case of Default Domain: it is Teamcenter item ID.
            ...
            (
                ...
                const char * partNumber /** the multifield key   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                ...
                const char * partFileName /** the dataset name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
