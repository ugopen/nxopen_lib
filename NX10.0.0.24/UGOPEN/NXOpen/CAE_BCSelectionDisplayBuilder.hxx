        ...
        */
        class NXOPENCPP_CAEEXPORT  BCSelectionDisplayBuilder : public NXOpen::Builder
        {
            ...
            /** Returns the list of BC family names used in the current solution.  Use the returned names as a filter
                        in @link JA_BCSELECTION_DISPLAY_BUILDER_AskBCsByFilter JA_BCSELECTION_DISPLAY_BUILDER_AskBCsByFilter@endlink 
            ...
            (
                ...
                const NXString & familyFilterNames /** Family filter name, they can be found using  @link CAE::BCSelectionDisplayBuilder::AskFamilyNamesByFilter CAE::BCSelectionDisplayBuilder::AskFamilyNamesByFilter@endlink    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                ...
                bool constraintFilter /**The constraint filter status*/,
                bool simObjFilter /**The simulation object filter status*/,
                const char * familyFilterNames /** Family filter name, they can be found using  @link CAE::BCSelectionDisplayBuilder::AskFamilyNamesByFilter CAE::BCSelectionDisplayBuilder::AskFamilyNamesByFilter@endlink    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                std::vector<NXOpen::CAE::SimBC *> & bcs /** bcs */ 
            );
            ...
            /**Returns  a value indicating whether the builder will display polygonal geometry or mesh, 
                        which do not have these BCs specified on them, with the unspecifed color  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  a value indicating how the BCs excluded Model objects will be displayed with the
                        color set by @link JA_BCSELECTION_DISPLAY_BUILDER_set_ExcludesColor JA_BCSELECTION_DISPLAY_BUILDER_set_ExcludesColor@endlink , 
            ...
            (
                NXOpen::NXColor * unspecifedColor /** unspecifedcolor */ 
            );
