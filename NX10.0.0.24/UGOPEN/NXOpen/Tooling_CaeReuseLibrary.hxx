    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  CaeReuseLibrary
        {
            ...
            (
                const char * reuseLibraryName /** Library to which beam-section is exported   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::Tooling::ReusableObject * reusableObject /** @link  NXOpen::Tooling::ReusableObject   NXOpen::Tooling::ReusableObject @endlink  */
            );
            ...
            (
                const char * reuseLibraryName /** Library from where beam-section is imported   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                ...
                const char * reuseLibraryName /** Library to update   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * previewImageFile /** New preview image file name including the path   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
