    ...
    namespace CAE
    {
        namespace ModelCheck
        {
            ...
            /**Represents a @link NXOpen::CAE::ModelCheck::ModelSetupCheckBuilder NXOpen::CAE::ModelCheck::ModelSetupCheckBuilder@endlink  which can be
                ...
                file or listed in a seperate information window, along with an error summary for each topic   <br> To create a new instance of this class, use @link NXOpen::CAE::ModelCheckManager::CreateModelSetupCheckBuilder  NXOpen::CAE::ModelCheckManager::CreateModelSetupCheckBuilder @endlink  <br> 
