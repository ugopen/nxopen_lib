        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  GeneralInsertBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the heigth 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * Heigth
            (
            );
            ...
            (
                std::vector<NXString> & titleName /**the list of title  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                std::vector<NXString> & valueText /**the list of title  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
