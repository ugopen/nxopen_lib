...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Builder class for Cope Corner object <br> To create a new instance of this class, use @link NXOpen::Routing::RouteManager::CreateCopeCornerBuilder  NXOpen::Routing::RouteManager::CreateCopeCornerBuilder @endlink  <br> 
         <br>  @deprecated Deprecated in NX8.0.0.  Use @link Routing::AssignCornerBuilder Routing::AssignCornerBuilder@endlink  instead. <br>  

         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Routing::AssignCornerBuilder instead.")  CopeCornerBuilder : public NXOpen::Builder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Routing::AssignCornerBuilder instead.") NXOpen::SelectNXObject * SelectControlPoint
            (
            );
            /**Returns  the user selected correct object where correct object is
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Routing::AssignCornerBuilder instead.") NXOpen::SelectNXObjectList * SelectCopeStock
            (
            );
            /** Set the @link Routing::Stock Routing::Stock@endlink  object list when list box
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public:  NX_DEPRECATED("Deprecated in NX8.0.0.  Use Routing::AssignCornerBuilder instead.") void SetStockList
            (
