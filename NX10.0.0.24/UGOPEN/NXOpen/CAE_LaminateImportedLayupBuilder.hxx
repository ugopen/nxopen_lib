...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link CAE::LaminateImportedLayupBuilder CAE::LaminateImportedLayupBuilder@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::CAE::LaminateGlobalLayupMgr::CreateLaminateImportedLayupBuilder  NXOpen::CAE::LaminateGlobalLayupMgr::CreateLaminateImportedLayupBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
