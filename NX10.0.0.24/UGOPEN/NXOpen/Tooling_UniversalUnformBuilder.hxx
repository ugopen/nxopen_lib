...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**Represents a @link Tooling::UniversalUnformBuilder Tooling::UniversalUnformBuilder@endlink  builder.  <br> To create a new instance of this class, use @link NXOpen::Features::ToolingCollection::CreateUniversalUnformBuilder  NXOpen::Features::ToolingCollection::CreateUniversalUnformBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
