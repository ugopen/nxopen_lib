...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            /** Represents a @link Features::VehicleDesign::HeadImpactBPillarWizardBuilder Features::VehicleDesign::HeadImpactBPillarWizardBuilder@endlink .  <br> This is an abstract class and cannot be instantiated.  <br> 
