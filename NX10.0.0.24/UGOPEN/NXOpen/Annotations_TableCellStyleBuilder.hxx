    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  TableCellStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::Annotations::TableCellStyleBuilder::CellFormatTypes instead.") enum FormatType
            {
            ...
            {
                FitMethodTypeOverwriteBorder = 1/** overwrite border */ ,
            ...
            /**Returns  the cell time format.  It is valid to use this when the 
                    @link NXOpen::Annotations::TableCellStyleBuilder::CellFormatType NXOpen::Annotations::TableCellStyleBuilder::CellFormatType @endlink and @link NXOpen::Annotations::TableCellStyleBuilder::SetCellFormatType NXOpen::Annotations::TableCellStyleBuilder::SetCellFormatType @endlink  
