        ...
        class NXOPENCPP_VISUALREPORTINGEXPORT  VisualReportBuilder : public NXOpen::Builder
        {
            ...
            (
                const NXString & name /** The initial name. If this name is empty then a system-generated name will be
                                                                                                                                    assigned when the owning @link NXOpen::VisualReporting::VisualReport NXOpen::VisualReporting::VisualReport@endlink  is next activated   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
