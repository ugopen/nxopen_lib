    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            /** Represents the parameters setting for strain gage evaluation.  For more information, see the 
                Response Simulation section of the Gateway Help  <br> To create or edit an instance of this class, use @link NXOpen::CAE::ResponseSimulation::StrainGageEvaluationSettingBuilder  NXOpen::CAE::ResponseSimulation::StrainGageEvaluationSettingBuilder @endlink  <br> 
