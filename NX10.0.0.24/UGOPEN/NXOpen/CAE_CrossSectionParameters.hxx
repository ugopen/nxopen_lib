    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CrossSectionParameters : public NXOpen::TaggedObject
        {
            ...
            /** Set the method used when calculating the absolute values for the derived components of @link NXOpen::CAE::Result::DataType::Tensor NXOpen::CAE::Result::DataType::Tensor@endlink  
                         like  @link NXOpen::CAE::Result::Component::MaximumPrincipal NXOpen::CAE::Result::Component::MaximumPrincipal@endlink  
            ...
            /** Get the method used when calculating the absolute values for the derived components of
                        @link NXOpen::CAE::Result::DataType::Tensor NXOpen::CAE::Result::DataType::Tensor@endlink  like  @link NXOpen::CAE::Result::Component::MaximumPrincipal NXOpen::CAE::Result::Component::MaximumPrincipal@endlink   @return   
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
