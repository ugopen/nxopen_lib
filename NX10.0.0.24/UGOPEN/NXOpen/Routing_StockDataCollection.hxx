...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a collection of @link Routing::StockData Routing::StockData@endlink  objects.   <br> To obtain an instance of this class, refer to @link NXOpen::Routing::RouteManager  NXOpen::Routing::RouteManager @endlink  <br> 
