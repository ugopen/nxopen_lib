...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /** 
            Represents @link NXOpen::Assemblies::ClearanceSet NXOpen::Assemblies::ClearanceSet@endlink .
        ...
        class NXOPENCPP_ASSEMBLIESEXPORT  ClearanceSet : public NXOpen::NXObject
        {
            ...
            struct  Summary
            {
                ...
                public: /** The analysis mode.  One of
                                                                                   @link NXOpen::Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Lightweight NXOpen::Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Lightweight@endlink ,
                                                                                   @link NXOpen::Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::ExactifLoaded NXOpen::Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::ExactifLoaded@endlink ,
                                                                                   @link NXOpen::Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Exact NXOpen::Assemblies::ClearanceAnalysisBuilder::CalculationMethodType::Exact@endlink .
                ...
                public: /** Indicates if the analysis was
                                                                                   ...
                                                                                   @link NXOpen::Assemblies::ClearanceSet::JobStatus::NotAborted NXOpen::Assemblies::ClearanceSet::JobStatus::NotAborted@endlink ,
                                                                                   @link NXOpen::Assemblies::ClearanceSet::JobStatus::AbortedByUser NXOpen::Assemblies::ClearanceSet::JobStatus::AbortedByUser@endlink  and
                                                                                   @link NXOpen::Assemblies::ClearanceSet::JobStatus::AbortedOnError NXOpen::Assemblies::ClearanceSet::JobStatus::AbortedOnError@endlink .
            ...
            /** Makes a copy of a dataset.  You must supply a unique name.  There are three
                    modes in which to copy the dataset: @link NXOpen::Assemblies::ClearanceSet::CopyMode::NoResults NXOpen::Assemblies::ClearanceSet::CopyMode::NoResults@endlink  
                    only copies the setup data.  The version of the new dataset is set to zero (meaning clearance analysis 
                    has not been run);  @link NXOpen::Assemblies::ClearanceSet::CopyMode::Results NXOpen::Assemblies::ClearanceSet::CopyMode::Results@endlink  makes a copy of the current 
                    analysis results, but not the interference bodies; @link NXOpen::Assemblies::ClearanceSet::CopyMode::InterfBodies NXOpen::Assemblies::ClearanceSet::CopyMode::InterfBodies@endlink  
            ...
            (
                const NXString & name /** the name of the new dataset   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                const char * name /** the name of the new dataset   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::Assemblies::ClearanceSet::CopyMode mode /** copy mode */
            );
            ...
            (
                NXOpen::DisplayableObject * object1 /** the first object in the pair */,
                NXOpen::DisplayableObject * object2 /** the second object in the pair */,
                const NXString & text /** the name of the new dataset   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Associates a text string to an interfering object pair. Both objects must
                    be members of the given dataset. If the object pair does not refer to
                    an existing interference, an error is returned. 
            ...
            (
                NXOpen::DisplayableObject * object1 /** the first object in the pair */,
                NXOpen::DisplayableObject * object2 /** the second object in the pair */,
                const char * text /** the name of the new dataset   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
        };
    }
}
