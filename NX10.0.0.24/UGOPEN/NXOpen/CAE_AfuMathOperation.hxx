    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AfuMathOperation
        {
            ...
            (
                double scaleValue /** Value of scale */,
                const char * sourceAfuFileName /** File name of the source AFU   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int sourceRecordIndex /** Index of the source AFU Data Record */,
                NXOpen::CAE::AfuMathOperation::OutputType outputType /** Output type of new AFU Data Record */,
            ...
            (
                NXOpen::CAE::AfuMathOperation::MultiType multiMathType /** Multi Math Operation type */,
                const char * sourceAfuFileName1 /** File name of the first source AFU   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int sourceRecordIndex1 /** Index of the first source AFU Data Record */,
                const char * sourceAfuFileName2 /** File name of the second source AFU   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int sourceRecordIndex2 /** Index of the second source AFU Data Record */,
                NXOpen::CAE::AfuMathOperation::OutputType outputType /** Output type of new AFU Data Record */,
                const char * destinationAfuFileName /** Destination AFU file name. It is NULL if output_type is not
                                                                                         @link CAE::AfuMathOperation::OutputTypeOtherFile CAE::AfuMathOperation::OutputTypeOtherFile@endlink .
            ...
            void SrsToTime
            (
                const char * inputAfuFileName /** Input afu file name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int inputRecordId /** Input record index */,
                NXOpen::CAE::AfuMathOperation::SrsToTimeOption conversionOption /** Conversion option */,
                double dampingRatio /** Damping ratio (of critical damping) */,
                int numTimePoints /** Number of requested time points */,
                ...
                NXOpen::CAE::AfuMathOperation::SrsToTimeStrategy strategy /** Conversion strategy conversionOption is
                                                                                                    ...
                                                                                                    */,
                bool saveSrsResults /** Save the two srs results when converting the srs function to time if TRUE */,
                const char * outputAfuFileName /** Output AFU file name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const char * outputRecordName /** Output record name of afu   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Convert Time to SRS 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
