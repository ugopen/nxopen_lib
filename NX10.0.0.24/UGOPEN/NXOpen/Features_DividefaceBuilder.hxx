...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a divide face builder  <br> To create a new instance of this class, use @link NXOpen::Features::FeatureCollection::CreateDividefaceBuilder  NXOpen::Features::FeatureCollection::CreateDividefaceBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
