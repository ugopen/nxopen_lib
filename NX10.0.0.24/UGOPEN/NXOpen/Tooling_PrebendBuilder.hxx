...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**Represents a @link Tooling::PrebendBuilder Tooling::PrebendBuilder@endlink  builder to divide bend faces.  <br> To create a new instance of this class, use @link NXOpen::Features::ToolingCollection::CreatePrebendBuilder  NXOpen::Features::ToolingCollection::CreatePrebendBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
