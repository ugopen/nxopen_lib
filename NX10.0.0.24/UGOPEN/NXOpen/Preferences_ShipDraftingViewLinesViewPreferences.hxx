    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  ShipDraftingViewLinesViewPreferences
        {
            ...
            (
                const NXString & featureName /** feature name e.g. decks, bulkheads etc.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                const char * featureName /** feature name e.g. decks, bulkheads etc.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                bool singleLine /** status that determines SLR for the feature */
            );
