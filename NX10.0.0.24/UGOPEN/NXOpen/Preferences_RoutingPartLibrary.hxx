    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  RoutingPartLibrary
        {
            ...
            (
                const char * parent /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const char * node /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
