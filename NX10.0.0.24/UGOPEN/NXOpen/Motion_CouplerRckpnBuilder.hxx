...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a @link Motion::CouplerRckpnBuilder Motion::CouplerRckpnBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::Motion::CouplerCollection::CreateCouplerRckpnBuilder  NXOpen::Motion::CouplerCollection::CreateCouplerRckpnBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
