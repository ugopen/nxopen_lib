    ...
    namespace Diagramming
    {
        ...
        */
        class NXOPENCPP_DIAGRAMMINGEXPORT  CannedAnnotationBuilder : public NXOpen::Builder
        {
            ...
            /** Create a new @link Diagramming::LeaderLineBuilder Diagramming::LeaderLineBuilder@endlink  builder.  @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the alignment of the text box in the canned annotation. 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Diagramming::DiagrammingAlignment TextBoxAlignment
            (
            );
            /**Sets  the alignment of the text box in the canned annotation. 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTextBoxAlignment
            (
                NXOpen::Diagramming::DiagrammingAlignment alignment /** alignment */ 
            );
