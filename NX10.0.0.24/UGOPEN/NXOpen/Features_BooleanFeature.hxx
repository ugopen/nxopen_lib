...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a boolean feature.  <br> To create or edit an instance of this class, use @link NXOpen::Features::BooleanBuilder  NXOpen::Features::BooleanBuilder @endlink  <br> 
