...
namespace NXOpen
{
    ...
    namespace Markup
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link NXOpen::Markup::MarkupFileObjectCollection::CreateEllipse  NXOpen::Markup::MarkupFileObjectCollection::CreateEllipse @endlink  <br> 
         <br>  Created in NX10.0.0.  <br>  
        */
        class NXOPENCPP_MARKUPEXPORT  Ellipse : public NXOpen::Markup::MarkupObject
        {
