        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionModeling
        {
            ...
            */
            ...
            /**Returns  the update pending option. If the option only works when update delayed option is true, 
                if the option is true, there is an edited feature to be updated till @link NXOpen::Update::DoUpdate NXOpen::Update::DoUpdate@endlink  is
            ...
            /**Sets  the update pending option. If the option only works when update delayed option is true, 
                if the option is true, there is an edited feature to be updated till @link NXOpen::Update::DoUpdate NXOpen::Update::DoUpdate@endlink  is
                explicitly called.  If the option is false, there is not an edited feature to be updated. The default is false. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR geometric_tol ("GDT") */
            ...
            /**Returns  the option " Notify on Delete " gives choice, whether the user wants a 
                 ...
                 if the option is true then it will not popup any notification message 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the option " Save Rollback Data " saves extra data with the part file 
                     ...
                     of it. 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link NXOpen::Preferences::SessionModeling::SaveDataForFeatureEdit NXOpen::Preferences::SessionModeling::SaveDataForFeatureEdit@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::Preferences::SessionModeling::SaveDataForFeatureEdit instead.") bool SaveRollbackData
            (
            );
            /**Sets  the option " Save Rollback Data " saves extra data with the part file 
                     ...
                     This option has been deprecated. Use "Save Data for Feature Edit" instead
                     of it. 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link NXOpen::Preferences::SessionModeling::SetSaveDataForFeatureEdit NXOpen::Preferences::SessionModeling::SetSaveDataForFeatureEdit@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::Preferences::SessionModeling::SetSaveDataForFeatureEdit instead.") void SetSaveRollbackData
            (
