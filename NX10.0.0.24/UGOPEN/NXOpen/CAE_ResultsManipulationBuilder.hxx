...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        ...
        {
            /** Action options 
             <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::CAE::ResultsManipulationBuilder::JA_RESULTS_MANIPULATION_BUILDER_OutputResultType NXOpen::CAE::ResultsManipulationBuilder::JA_RESULTS_MANIPULATION_BUILDER_OutputResultType@endlink  instead. <br>  
            */
            public:  NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::CAE::ResultsManipulationBuilder::JA_RESULTS_MANIPULATION_BUILDER_OutputResultType instead.") enum Action
            {
                ActionExport/** export */ ,
