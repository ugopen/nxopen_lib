...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /** Represents a builder@link Assemblies::LoadInterpartDataBuilder Assemblies::LoadInterpartDataBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::Assemblies::AssemblyManager::CreateLoadInterpartDataBuilder  NXOpen::Assemblies::AssemblyManager::CreateLoadInterpartDataBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
