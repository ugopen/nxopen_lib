    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  CutterExport : public NXOpen::TaggedObject
        {
            ...
            (
                std::vector<NXString> & attributes /** The attributes   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                std::vector<NXString> & values /** The values   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                ...
                const NXString & replaceLibref /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** The valid target classes of the cutter @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                NXOpen::CAM::CutterExport::SaveFlags saveFlag /** saveflag */ ,
                const char * replaceLibref /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & targetClass /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** The valid attributes, target class in the builder
                    needs to be set before this method is called @return  
             <br>  Created in NX9.0.0.  <br>  
            ...
            (
                const char * targetClass /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & attr /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            (
                const char * attr /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                std::vector<NXString> & valueIds /** valueids */ ,
                std::vector<NXString> & valueTexts /** valuetexts */ 
            );
        };
