...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**  @brief  Provides methods for managing ResultMeasures @link CAE::ResultMeasure CAE::ResultMeasure@endlink  
        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultMeasureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Create a ResultMeasure  @return  The created result measure object 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link CAE::ResultMeasureCollection::CreateResultMeasureNew CAE::ResultMeasureCollection::CreateResultMeasureNew@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use CAE::ResultMeasureCollection::CreateResultMeasureNew instead.") NXOpen::CAE::ResultMeasure * CreateResultMeasure
            (
                ...
                const NXString & expName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Create a ResultMeasure  @return  The created result measure object 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link CAE::ResultMeasureCollection::CreateResultMeasureNew CAE::ResultMeasureCollection::CreateResultMeasureNew@endlink  instead. <br>  
            ...
            (
                ...
                const NXOpen::CAE::Result::Type & pType /** ptype */ ,
                NXOpen::CAE::Result::Component eComp /** ecomp */ ,
                const char * expName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Finds the @link  CAE::ResultMeasure   CAE::ResultMeasure @endlink  with the given identifier as recorded in a journal. 
            ...
            /** Create a result options for result measure  @return  
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link CAE::SimResultReference CAE::SimResultReference@endlink :@link CreateResultMeasureNew CreateResultMeasureNew@endlink  instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public:  NX_DEPRECATED("Deprecated in NX10.0.0.  Use CAE::SimResultReference:CreateResultMeasureNew instead.") NXOpen::CAE::ResultMeasureResultOptions * CreateResultOptions
            (
                NXOpen::CAE::SimSolution * tSol /** tsol */ ,
                int iStepIndex /** istepindex */ ,
                int iIterIndex /** iiterindex */ ,
            ...
            /** Create a result options for result measure  @return  
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ResultMeasureResultOptions * CreateResultOptionsNew
            (
                NXOpen::CAE::SimSolution * tSol /** tsol */ ,
            ...
            (
                ...
                const NXString & expName /** The new expression name for the result measure   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Create a ResultMeasure  @return  The created result measure object 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            (
                NXOpen::CAE::ResultMeasureResultOptions * pResOpt /** presopt */ ,
                NXOpen::CAE::ResultMeasureModelSubset * pSubset /** The model subset, can be null */,
                const char * expName /** The new expression name for the result measure   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
