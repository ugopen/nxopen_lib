...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Subdivision
        {
            ...
            /** Represents a @link Features::Subdivision::SubdivisionSetContinuityBuilder Features::Subdivision::SubdivisionSetContinuityBuilder@endlink  builder.   <br> To create a new instance of this class, use @link NXOpen::Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionSetContinuityBuilder  NXOpen::Features::Subdivision::SubdivisionBodyCollection::CreateSubdivisionSetContinuityBuilder @endlink  <br> 
            Default values.
            <table border="1"> 
