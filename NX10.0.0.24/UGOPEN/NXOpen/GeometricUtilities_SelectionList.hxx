...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /** Represents a @link GeometricUtilities::SelectionList GeometricUtilities::SelectionList@endlink   <br> To create a new instance of this class, use @link NXOpen::Part::CreateSelectionList  NXOpen::Part::CreateSelectionList @endlink  <br> 
