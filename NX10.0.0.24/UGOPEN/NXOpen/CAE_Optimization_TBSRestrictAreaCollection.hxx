...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            /** Represents a collection of @link CAE::Optimization::TBSRestrictArea CAE::Optimization::TBSRestrictArea@endlink   <br> To obtain an instance of this class, refer to @link NXOpen::CAE::Optimization::TBSOptimizationSolution  NXOpen::CAE::Optimization::TBSOptimizationSolution @endlink  <br> 
