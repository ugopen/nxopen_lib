...
namespace NXOpen
{
    namespace CAE
    {
        namespace Optimization
        {
            ...
            */
             NX_DEPRECATED("Deprecated in NX10.0.0.  Use the ShellSection property on one of the following classes - NXOpen::CAE::ResultMeasureResultSectionOptions, NXOpen::CAE::ResultMeasureResultDirectionSectionOptions, or NXOpen::CAE::ResultMeasureResultAllOptions") enum Hookes
            {
                HookesTop/** Top */,
                HookesBottom/** Bottom */,
                HookesMiddle/** Middle */,
