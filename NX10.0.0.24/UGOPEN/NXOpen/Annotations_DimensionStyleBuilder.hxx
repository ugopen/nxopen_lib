    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the dimension limit fit assembly display style.  When the limit fit type is FIT, the hole and shaft tolerances
                        can be shown on a single line, two lines centered with the dimension text, or two lines with the 
                        shaft text in line with the dimension text 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::FitAssemblyDisplayStyle LimitFitAssemblyDisplayStyle
            (
            );
            /**Sets  the dimension limit fit assembly display style.  When the limit fit type is FIT, the hole and shaft tolerances
                        can be shown on a single line, two lines centered with the dimension text, or two lines with the 
                        shaft text in line with the dimension text 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /** Returns the overridden dimension text value @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
