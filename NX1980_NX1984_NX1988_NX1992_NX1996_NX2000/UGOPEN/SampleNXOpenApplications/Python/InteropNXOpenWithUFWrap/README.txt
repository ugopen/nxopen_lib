...
------------
  ...
  Explorer.  
   ...
   5. The executable will be placed in a subdirectory named "Debug" or "Release" as per selected configuration ,under the working 
...
InteropNXOpenWithUFWrap.exe in the Release or Debug  directory as per selected configuration.
