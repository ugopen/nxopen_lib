...
-----------
    ...
    This will create an executable called MenuBarVbApp.dll in the Release or Debug  directory as per selected configuration.
    ...
    This will create an executable called MenuBarCSharpApp.dll in the Release or Debug  directory as per selected configuration.
