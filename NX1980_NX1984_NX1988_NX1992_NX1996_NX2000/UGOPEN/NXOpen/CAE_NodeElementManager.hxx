    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  NodeElementManager
        {
            ...
            /** Creates a @link NXOpen::CAE::ConvexMeshBuilder NXOpen::CAE::ConvexMeshBuilder@endlink  
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::NodeElementManager NXOpen::CAE::NodeElementManager@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : sc_acou_meshing (" SC Acoustic Meshing") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::NodeElementManager instead.") NXOpen::CAE::ConvexMeshBuilder * CreateConvexMeshBuilder
            (
            );
