    ...
    */
    class NXOPENCPPEXPORT  Session : public NXOpen::BaseSession
    {
        ...
        /** Invokes an entry point function in a managed library. Currently supported library types
                ...
                For Python, only class bound staticmethods and global functions can be invoked.
                Do not use this method for other Python methods since the behavior is undefined.
         <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::Session::ExecuteWithStringArguments NXOpen::Session::ExecuteWithStringArguments@endlink  instead <br>  

         <br>  Created in NX10.0.2.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Session::ExecuteWithStringArguments instead") void ExecuteManagedProgram
        (
            const NXString & libName /** Name of the library containing the entry point.  The full path to the library is required. */,
            const NXString & entryPointName /** Name of the entry point function to invoke */,
        ...
        /// \cond NX_NO_DOC 
        /** Returns the translation loaded in the session 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the name given to this release or empty if no specific release name is defined. Release name is listed for Help->About when its not empty and that only some products like Simcenter set it 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        public: NXString ReleaseName
        (
        );

        /// \endcond 
        /**Returns  the main release number 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        ...
        /**Returns  the main build number for the release 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the name of the group build for this release or empty if not a group build 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        ...
        */
        ...
        /// \cond NX_NO_DOC 
        /** Returns the @link NXOpen::MendixReporting::CheckerDataStatus NXOpen::MendixReporting::CheckerDataStatus@endlink  belonging to this session 
         <br>  Created in NX1926.0.0.  <br>  
        */
        ...
        /// \cond NX_NO_DOC 
        /** Returns the @link NXOpen::AutomatedTesting::TestingManager NXOpen::AutomatedTesting::TestingManager@endlink  belonging to this session 
        ...
        */
        ...
        /// \cond NX_NO_DOC 
        /** Returns the @link NXOpen::TopologyOptimizationTaskEnvironment NXOpen::TopologyOptimizationTaskEnvironment@endlink  belonging to this session 
