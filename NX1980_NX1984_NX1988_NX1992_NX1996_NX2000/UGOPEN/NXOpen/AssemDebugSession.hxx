    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  AssemDebugSession
    {
        ...
        */
        ...
        /// \cond NX_NO_DOC 
        /** Count the number of objects of the given type in the given part.
                 This function will traverse the RM_entity_chains looking of objects of the given type.
                 The object type and subtype are listed in uf_object_types.h
        ...
        /** Print the corresponding lightweight bodies for the solid bodies
                that are displayed in the current work view 
                This is a newer version of the API JA_ASSEM_DEBUG_print_lightweight_of_all_displayed_bodies_in_work_view 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
