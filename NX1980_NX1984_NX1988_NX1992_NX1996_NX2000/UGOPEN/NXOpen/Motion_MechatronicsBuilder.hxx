...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        IntegrationType (deprecated) </term> <description> 
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MechatronicsBuilder : public NXOpen::Motion::MotionBuilder, public virtual NXOpen::IExternalFileReferencer
        {
            ...
            /**Returns  the integration type - possible values are CoSimulation, ModelExchange 
             <br>  @deprecated Deprecated in NX1953.0.0.  This method has no replacement. It is no longer supported anymore. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  This method has no replacement. It is no longer supported anymore.") NXOpen::Motion::MechatronicsBuilder::SolverIntegrationType IntegrationType
            (
            );
            /**Sets  the integration type - possible values are CoSimulation, ModelExchange 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  This method has no replacement. It is no longer supported anymore.") void SetIntegrationType
            (
            ...
            /**Returns  the input ports list for Generic and FMI
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::Motion::MechatronicsBuilder::InputPortsListGeneric NXOpen::Motion::MechatronicsBuilder::InputPortsListGeneric@endlink  or @link NXOpen::Motion::MechatronicsBuilder::InputPortsListFMI NXOpen::Motion::MechatronicsBuilder::InputPortsListFMI@endlink  <br>  

             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Motion::MechatronicsBuilder::InputPortsListGeneric or NXOpen::Motion::MechatronicsBuilder::InputPortsListFMI") NXOpen::Motion::InputPortAssociationList * InputPortsListGenericAndFMI
            (
            );
            ...
            /**Returns  the output ports list for Generic and FMI
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::Motion::MechatronicsBuilder::OutputPortsListGeneric NXOpen::Motion::MechatronicsBuilder::OutputPortsListGeneric@endlink  or @link NXOpen::Motion::MechatronicsBuilder::OutputPortsListFMI NXOpen::Motion::MechatronicsBuilder::OutputPortsListFMI@endlink  <br>  

             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Motion::MechatronicsBuilder::OutputPortsListGeneric or NXOpen::Motion::MechatronicsBuilder::OutputPortsListFMI") NXOpen::Motion::OutputPortAssociationList * OutputPortsListGenericAndFMI
            (
            );
            ...
            /**Returns  the input ports list during export 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::OutputPortAssociationList * InputPortsListExport
            (
            );
