...
(
 ...
 int    **count_array, /* <OF,len:loop_count>
                        Number of curves in each loop - freed by user using UF_free
                       */
 tag_t ***curve_array, /* <OF,len:count_array>
                        ...
                        up the first shadow loop.  This must be freed (using UF_free) by the
...
tag_t    **shadow_curves      /*<OF,len:shadow_curve_count>
                               Array of curve tags.  This must be freed (using UF_free) by the caller.
                               */
);
...
Create precise outline for a given array of solids. If created outline curves
can not form loops, please use UF_CURVE_create_precise_outline_curves instead to get
outline curves.

Environment: Internal and External
History Released in NX 12.0.1
*****************************************************************************/
extern UFUNEXPORT int UF_CURVE_create_precise_outline
(
    int     solid_count, /*<I>
                         Number of solids to shadow
                         */
...
/*************************************************************************************
Function:             UF_CURVE_create_precise_outline_curves
Purpose:              Create curves for the precise outline of a group of bodies in a view
...
extern UFUNEXPORT int UF_CURVE_create_precise_outline_curves
(
    int      solid_count, /*<I>
                          Number of solid bodies to shadow
                          */
    ...
    int      *curve_count, /*<O>
                                  Number of curves created
                                  */
    tag_t    **outline_curves      /*<OF,len:curve_count>
                                  Array of curve tags.  This must be freed (using UF_free) by the caller.
                                  */
    );
...
extern UFUNEXPORT void uf5063(int *ip1, double *rp2, double *rp3,
                        double *rp4, tag_t *nr5);

/* uf5070 create conic
   replaced by UF_CURVE_convert_conic_to_std and UF_CURVE_create_conic */
extern UFUNEXPORT void uf5070(double *rp1, double *rp2, double *rp3, double *rp4,
...
extern UFUNEXPORT void uf5071(tag_t *np1, double *rar2);

/* uf5072 edit conic real data
   No replacement */
extern UFUNEXPORT void uf5072(tag_t *np1, double *ra2);

/* uf5072x edit conic real data  without update
   No Replacement */
extern UFUNEXPORT void uf5072x(tag_t *np1, double *ra2);

/* uf5073 read conic data
   Replaced by UF_CURVE_ask_conic_data and UF_CURVE_convert_conic_to_gen */
extern UFUNEXPORT void uf5073(tag_t *np1, double *rr2, double *rr3, double *rr4,
double *rr5, double *rr6, double *rr7, double *rar8, double *rar9,
double *rr10);

/* uf5074 edit conic data
   No Replacement */
extern UFUNEXPORT void uf5074(tag_t *np1, double *rp2, double *rp3, double *rp4,
double *rp5, double *rp6, double *rp7, double *ra8, double *ra9, double *rp10);

/* uf5074x edit conic data  without update
   No Replacement */
extern UFUNEXPORT void uf5074x(tag_t *np1, double *rp2, double *rp3, double *rp4,
double *rp5, double *rp6, double *rp7, double *ra8, double *ra9, double *rp10);

/* uf5075 create conic
   Replaced by UF_CURVE_create_conic */
extern UFUNEXPORT void uf5075(int *ip1, double *rp2, tag_t *np3, tag_t *nr4);

/* uf5080 create spline
   Replace by UF_CURVE_create_spline_thru_pts */
extern UFUNEXPORT void uf5080(int *ip1, int *ip2, double *rp3, tag_t *nr4);

/* uf5081 create spline using complete definition
   Replaced by UF_CURVE_create_spline_thru_pts */
extern UFUNEXPORT void uf5081(int *ip1, int *ip2, double *rp3, double *rp4,
double *rp5, tag_t *nr6);

/* uf5082 read spline data
   Replaced by UF_CURVE_ask_spline_thru_pts */
extern UFUNEXPORT void uf5082(tag_t *np1, int *ip2, double *rr3, double *rar4,
double *rar5);

/* uf5083 edit spline data
   Replaced by UF_CURVE_edit_spline_thru_pts and
UF_CURVE_edit_move_mult_points*/
extern UFUNEXPORT void uf5083(tag_t *np1, int *ip2, double *rp3, double *ra4,
double *ra5);

/* uf5083x edit spline data without update
   No Replacement */
extern UFUNEXPORT void uf5083x(tag_t *np1, int *ip2, double *rp3, double *ra4,
double *ra5);


/* uf5084 add spline knot point
   Replaced by UF_CURVE_ask_spline_thru_pts and UF_CURVE_edit_spline_thru_pts*/
extern UFUNEXPORT void uf5084(tag_t *np1, double *rp2, double *ra3, double *ra4);

/* uf5085 count spline knot points
   Replaced by UF_CURVE_ask_spine_thru_pts */
extern UFUNEXPORT int uf5085(tag_t *np1);

/* uf5445 create spline
   Replaced by UF_MODL_create_spline */
extern UFUNEXPORT void uf5445(int *ip1, int *ip2, int *ip3, int *ip4, double *rp5,
double *rp6, tag_t *nr7);

/* uf5446 read spline data
   No Replacement */
extern UFUNEXPORT void uf5446(tag_t *np1, int *ir2, int *ir3, int *ir4, int *ir5,
...
extern UFUNEXPORT void uf5447(int *ip1, int *ip2, int *ip3, int *ip4, double *rp5,
double *rp6, tag_t *nr7, int *ir8);

/* uf5463 reads the count of poles
   No Replacement */
extern UFUNEXPORT void uf5463(tag_t *np1, int *ir2, int *ir3);

/* uf5466 create a spline from a curve
   Replaced by UF_CURVE_create_joined_curve */
extern UFUNEXPORT void uf5466(tag_t *np1, int *ip2, tag_t *nr3, int *ir4);
...
extern UFUNEXPORT void uf5900(tag_t *np1, double *rp2, double *rr3);

/* uf5901 evaluate curve point data
   Replaced by UF_CURVE_evaluate_curve or UF_MODL_ask_curve_props */
extern UFUNEXPORT void uf5901(tag_t *np1, double *rp2, double *rr3);

/* uf5903 trim curve by a given arclength
   Replaced by UF_CURVE_edit_length */
extern UFUNEXPORT void uf5903(tag_t *np1, int *ip2, double *rp3, int *ip4, double *rp5
, int *ir6);

/* uf5910 evaluate point on a face
   Replaced by UF_MODL_ask_face_props */
extern UFUNEXPORT void uf5910(int *np1, double *rp2, double *rr3);

/* uf5911 evaluate face point data
   Replaced by UF_MODL_ask_face_props */
extern UFUNEXPORT void uf5911(tag_t *np1, double *rp2, double *rr3, double *rr4,
double *rr5, double *rr6);


/* uf5930 intersect two curves
   Replaced by UF_CURVE_intersect or UF_MODL_intersect_objects */
extern UFUNEXPORT void uf5930(tag_t *np1, tag_t *np2, double *rp3, double *rr4,
double *rr5, double *rr6, int *ir7);

/* uf5931 intersect curve and face/plane
   Replaced by UF_CURVE_intersect or UF_MODL_intersect_objects */
extern UFUNEXPORT void uf5931(tag_t *np1, tag_t *np2, double *rp3, double *rr4,
double *rr5, double *rr6, int *ir7);

/* uf5932 intersection of two faces
   Replaced by UF_MODL_intersect_objects */
extern UFUNEXPORT void uf5932(tag_t *jp1, tag_t *jp2, double *rp3, tag_t *jp4,
