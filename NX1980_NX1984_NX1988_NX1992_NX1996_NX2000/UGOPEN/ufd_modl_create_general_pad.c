 ...
 *    commands to create a block, create a set of outline curves for the      *
 *    placement outline of the pad, and then create a pad with a taper angle  *
 *    of 20 degrees relative to the face normals. Then the parameters of the  *
 *    pad are asked for and printed out, the taper angle of the pad is        * 
 *    changed to 30 degrees, and finally the output parameters from           *
 *    UF_MODL_ask_general_pad are freed.                                      *
 *                                                                            *
...
/* the top face will be the face whose normal is mostly   */
