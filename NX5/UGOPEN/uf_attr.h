 ...
 * returning the title and value of the next attribute. If the type specified
 * is UF_ATTR_any (or 6) then cycle through the attributes by type in
 * the following order:  UF_ATTR_integer (1), UF_ATTR_real (2),
 * UF_ATTR_time (3), UF_ATTR_null (4), UF_ATTR_string (5), and
 * UF_ATTR_reference (7). If there are no more attributes to cycle then
 ...
 * value of the first attribute found searching by type in the following
 * order:
 *
 * UF_ATTR_integer (1),
 * UF_ATTR_real (2),
 ...
 * specified is UF_ATTR_any (or 6) then search through all attribute
