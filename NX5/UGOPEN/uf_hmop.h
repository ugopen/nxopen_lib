...
*******************************************************************************/
extern UFUNEXPORT int UF_HMOP_ask_hole_top
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_HMOP_set_hole_top
(
   tag_t                  hmop_tag,      /* <I> The tag of the hole making operation of interest */
   UF_NCFEAT_t            rep_feature,   /* <I> A representative feature. */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_HMOP_ask_hole_axis
(
   tag_t                 hmop_tag,      /* <I> The tag of the hole making operation of interest */
   UF_NCFEAT_t           rep_feature,   /* <I> A representative feature. */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_HMOP_set_hole_axis
(
   tag_t             hmop_tag,      /* <I> The tag of the hole making operation of interest */
   UF_NCFEAT_t       rep_feature,   /* <I> A representative feature. */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_HMOP_ask_hole_depth
(
   tag_t                 hmop_tag,     /* <I> The tag of the hole making operation of interest */
   UF_NCFEAT_t           rep_feature,  /* <I> A representative feature. */
...
/*******************************************************************************
   ...
   History: Released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_HMOP_set_hole_depth
(
   tag_t                  hmop_tag,     /* <I> The tag of the hole making operation of interest */
   UF_NCFEAT_t            rep_feature,  /* <I> A representative feature. */
   tag_t                  *smart_point  /* <I> Smart point associated to one of the entities of rep_feature. */
