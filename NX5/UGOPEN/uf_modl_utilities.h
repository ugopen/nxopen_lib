...
Retrieves an object from a linked list of objects. A list of objects may
contain identifiers for bodies, features, faces and edges.
The point of a cone is a loop of type 3 (other).  Also, any closed loop
interior to a surface is a type 2 (hole) whether the feature that intersects
the surface is concave (e.g.  a c-bore hole) or convex (e.g.  a pad).
...
(
    double   * end_point ,      /* <I> : The input endpoint */
