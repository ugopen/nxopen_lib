...
*****************************************************************************/
extern UFUNEXPORT int UF_WELD_locate_welds2(
tag_t           work_part,   /* <I>
...
See Also:   UF_WELD_locate_welds

History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_number_of_welds (
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_spacing_of_welds (
tag_t  feature_set_tag,  /* <I>
                         Feature set tag of weld
                         */
double *spacing          /* <O>
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_segment_len_of_welds (
tag_t  feature_set_tag,  /* <I>
                         Feature set tag of weld
                         */
double *seg_len          /* <O>
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_connected_parts (
tag_t feature_set_tag, /* <I>
                       Feature set tag of the weld
                       */
UF_WELD_conn_parts_info_p_t conn_info
                       /* <O>
                        UF_WELD_conn_parts_info_s. Must free ithe body tags using UF_free.
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_populate_attr_list (
tag_t feature_set_tag,    /* <I>
                          Feature set tag of the weld
                          */
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_body_id (
tag_t   feature_set_tag,    /* <I>
                            Feature set tag of the weld
                            */
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_is_object_weld (
tag_t object,      /* <I>
                   Tag of weld body
                   */
logical *is_weld,  /* <O>
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_linked_feat_source(
...
History: Original release was in V16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_linked_face_parent(
tag_t face_tag, /* <I>
...
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_spot_weld_info(
...
History : Originally released in v16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_spot_face_data(
tag_t spot_feature_set,           /* <I>
                              tag of the spot feature set
                                  */
int   *num_sets,                  /* <O>
...
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_spot_face_info(
tag_t spot_feature_set,           /* <I>
                              tag of the spot feature set
                                  */
int   *num_sets,                  /* <O>
...
History : Originally released in v16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_free_spot_data(
int spot_count,                  /* <I>
...
History : Originally released in v18.0.4 . Will be made obsolete in V20
******************************************************************************/
extern UFUNEXPORT int UF_WELD_free_spot_info (
int spot_count,                  /* <I>
                          number of spots in the spot feature set
                                 */
...
History : Originally released in v16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_seam_weld_info(
...
History : Originally released in v16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_guide_curves (
...
History : Originally released in v16.0.1
******************************************************************************/
extern UFUNEXPORT int UF_WELD_ask_groove_or_edge_guide (
tag_t weld_feat_tag,            /* <I>
