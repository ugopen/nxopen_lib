...
/******************************** Defines *************************************/
#define UF_PARAM_MAX_PARAM_NAME_LEN   MAX_LINE_SIZE
#define UF_PARAM_MAX_STRING_LEN       MAX_LINE_SIZE
...
{                           /* If parameter changes then: */
   UF_PARAM_REGEN_NONE,     /*    no regeneration is needed */
   UF_PARAM_REGEN_POST,     /*    regenerate post only */
   UF_PARAM_REGEN_PATH,     /*    regenerate toolpath only */
   UF_PARAM_REGEN_ALL       /*    regenerate both */
};
...
struct UF_PARAM_index_attribute_s
{
   ...
   char               name[UF_PARAM_MAX_PARAM_NAME_LEN + 1]; /* The parameter's
                                                                name */
...
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_is_same_class
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_duplicate
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_rename
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_required_params
(
   tag_t   param_tag, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_inherited_params
(
   tag_t   param_tag,  /* <I> - see above */
   int    *count,      /* <O> - see above */
   int    *indices     /* <O> - see above */
);
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_inherit_value
(
   tag_t   param_tag,  /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_is_inherited
(
   tag_t      param_tag /* <I> - see above */,
   int        param_index, /* <I> - see above */
   logical   *answer /* <O> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_param_definer
(
   tag_t    param_tag, /* <I> - see above */
   int      param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_param_attributes
(
   int                           param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_int_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_double_value
(
   tag_t     param_tag, /* <I> - see above */
   int       param_index, /* <I> - see above */
...
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_2d_value
(
   tag_t     param_tag, /* <I> - see above */
   int       param_index, /* <I> - see above */
...
History: Originally released in NX2.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_3d_value
(
   tag_t     param_tag, /* <I> - see above */
   int       param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_logical_value
(
   tag_t      param_tag, /* <I> - see above */
   int        param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_subobj_ptr_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_tag_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_str_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
   char    value[UF_PARAM_MAX_STRING_LEN+1] /* <O> - see above */
);
...
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_tag_vla
(
   tag_t   param_tag,     /* <I> - see above */
   int     param_index,   /* <I> - see above */
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_int_vla
(
   tag_t   param_tag,     /* <I> - see above */
   int     param_index,   /* <I> - see above */
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_double_vla
(
   tag_t   param_tag,     /* <I> - see above */
   int     param_index,   /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_int_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_double_value
(
   tag_t    param_tag, /* <I> - see above */
   int      param_index, /* <I> - see above */
...
History: Originally released in NX2.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_2d_value
(
   tag_t    param_tag, /* <I> - see above */
   int      param_index, /* <I> - see above */
...
History: Originally released in NX2.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_3d_value
(
   tag_t    param_tag, /* <I> - see above */
   int      param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_logical_value
(
   tag_t     param_tag, /* <I> - see above */
   int       param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_subobj_ptr_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_tag_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_str_value
(
   tag_t   param_tag, /* <I> - see above */
   int     param_index, /* <I> - see above */
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_tag_vla
(
   tag_t   param_tag,     /* <I> - see above */
   int     param_index,   /* <I> - see above */
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_int_vla
(
   tag_t   param_tag,     /* <I> - see above */
   int     param_index,   /* <I> - see above */
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_set_double_vla
(
   tag_t   param_tag,     /* <I> - see above */
   int     param_index,   /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_param_status
(
   tag_t                param_tag, /* <I> - see above */
   int                  param_index, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_generate
(
   tag_t      param_tag, /* <I> - see above */
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_check
(
...
History: Originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_reinit
(
...
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_can_accept_ude_set
(
   tag_t               param,        /* <I> - see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_ask_udes
(
   tag_t               param,        /* <I> see above */
   UF_UDE_set_type_t   ude_set_type, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_delete_all_udes
(
   tag_t               param,        /* <I> see above */
   UF_UDE_set_type_t   ude_set_type  /* <I> see above */
);
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_append_ude
(
   tag_t               param,        /* <I> see above */
   UF_UDE_set_type_t   ude_set_type, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_delete_ude
(
   tag_t               param,        /* <I> see above */
   UF_UDE_set_type_t   ude_set_type, /* <I> see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_can_accept_ude
(
   tag_t               param,        /* <I> - see above */
   UF_UDE_set_type_t   ude_set_type, /* <I> - see above */
   char               *ude_name,     /* <I> - see above */
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_is_template
(
   tag_t      param,     /* <I> - see above */
   logical   *response   /* <O> - see above */
);
...
History: Originally released in V18.0
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_is_load_with_parent
(
   tag_t      param,     /* <I> - see above */
   logical   *response   /* <O> - see above */
);
...
*******************************************************************************/
extern UFUNEXPORT int UF_PARAM_replay_path
(
   tag_t      param_tag  /* <I> - see above */
);
