...
/******************************************************************************
Interactively choose a CSYS. When the inputed csys_tag is not NULL_TAG, dialog
initial CSYS will be located it. Otherwise will be located absolute CSYS.
The outputed CSYS is user specified CSYS. (refer to uc1630)
