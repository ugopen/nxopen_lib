...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI baseline dimension. It is a set of horizontal or vertical
                dimensions.  <br> To create a new instance of this class, use @link Annotations::DimensionSetCollection::CreateKfPmiHorizontalBaselineDimension Annotations::DimensionSetCollection::CreateKfPmiHorizontalBaselineDimension@endlink  <br> */
