...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Area Milling Drive Method Builder  <br> This is an abstract class and cannot be instantiated. <br> */
        class NXOPENCPPEXPORT DmAmBuilder : public Builder
        {
            ...
            (
                bool dm_am_region_con /** the Region Connection value */
            );
