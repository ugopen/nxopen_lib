    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            class NXOPENCPPEXPORT Connection : public Routing::LogicalConnection
            {
                ...
                (
                    NXOpen::Routing::LogicalTerminal * from_terminal /** May not be NULL */
                );
                ...
                (
                    NXOpen::Routing::LogicalTerminal * to_terminal /**May not be NULL*/
                );
                ...
                (
                    const std::vector<NXOpen::Routing::LogicalTerminal *> & intermediate_terminals /** Collection of intermediate @link Routing::LogicalTerminal Routing::LogicalTerminal@endlink  - Use NULL to remove all intermdiate terminals */
                );
                ...
                (
                    NXOpen::Routing::LogicalTerminal * intermediate_terminal /** may be NULL */
                );
                ...
                (
                    double path_length /** May be zero */
                );
                ...
                (
                    const NXString & path_length_multiplier /** May be zero (cut length will be zero)  */
                );
                ...
                (
                    const NXString & path_length_offset /** May be zero */
                );
