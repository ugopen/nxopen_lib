...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        /** Represents set of Shading View style applicable to drafting views.  <br> To obtain an instance of this class, refer to @link Drawings::ViewStyle Drawings::ViewStyle@endlink  <br> */
        class NXOPENCPPEXPORT ShadingViewStyle: public virtual Preferences::IShadingViewPreferences
        {
            private: NXOpen::Drawings::ViewStyle* m_owner;
            public: explicit ShadingViewStyle(NXOpen::Drawings::ViewStyle *owner): m_owner(owner)
            {
            }
            public: 
