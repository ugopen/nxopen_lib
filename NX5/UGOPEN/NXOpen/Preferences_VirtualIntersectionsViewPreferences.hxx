...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT VirtualIntersectionsViewPreferences: public virtual Preferences::IVirtualIntersectionsViewPreferences
        {
            private: NXOpen::Preferences::ViewPreferences* m_owner;
            public: explicit VirtualIntersectionsViewPreferences(NXOpen::Preferences::ViewPreferences *owner): m_owner(owner)
            {
            }
            public: 
