...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        enum LeaderType
        {
            ...
            LeaderTypeDatumOnDotTerminatedLeader/** datum on dot terminated leader */ ,
        ...
        struct LineCfw
        {
            ...
            public: LineCfw(int INIT_color /** color */ , NXOpen::DisplayableObject::ObjectFont INIT_font /** Line font (solid, dashed, etc) */, NXOpen::Annotations::LineWidth INIT_width /** width */ ) :
                Color(INIT_color),
                Font(INIT_font),
                Width(INIT_width)
            {
        ...
        struct TextCfw
        {
            ...
            public: TextCfw(int INIT_color /** color */ , int INIT_font /** Character font (blockfont, etc).
                                    The font must be a font that has been
                                    loaded into the part.  The @link FontCollection FontCollection@endlink  class
                                    can be used to load fonts into the part. */, NXOpen::Annotations::LineWidth INIT_width /** width */ ) :
                Color(INIT_color),
                Font(INIT_font),
                Width(INIT_width)
            {
        ...
        {
            StackVerticalAlignmentLeft/** left */ ,
            StackVerticalAlignmentCenter/** center */ ,
            StackVerticalAlignmentRight/** right */ 
        };
        ...
        {
            StackHorizontalAlignmentTop/** top */ ,
            StackHorizontalAlignmentMiddle/** middle */ ,
            StackHorizontalAlignmentBottom/** bottom */ 
        };
