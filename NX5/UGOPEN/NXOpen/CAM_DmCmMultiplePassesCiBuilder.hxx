...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a DmCmMultiplePassesCiBuilder  <br> To obtain an instance of this class use @link CAM::SurfaceContourBuilder::DmCmBuilder::DmCmMultiplePassesCiBuilder CAM::SurfaceContourBuilder::DmCmBuilder::DmCmMultiplePassesCiBuilder@endlink  <br> */
        class NXOPENCPPEXPORT DmCmMultiplePassesCiBuilder : public Builder
        {
            ...
            /**Returns  the  builder of Wall Stock Offset  <br> License requirements : cam_base ("CAM BASE") */
            ...
            (
                NXOpen::CAM::DmCmMultiplePassesCiBuilder::WallStepMethodType wall_step_method /** the value of Wall Step Method */
            );
            /**Returns  the  builder of Wall Increment  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * WallIncrementBuilder
            (
            );
            /**Returns  the  builder of Wall Number of Passes  <br> License requirements : cam_base ("CAM BASE") */
            ...
            (
                bool aux_floor /** the toggle value of Use Auxiliary Floor*/
            );
            /**Returns  the  builder of Floor Stock Offset  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the  builder of Floor Increment  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * FloorIncrementBuilder
            (
            );
            /**Returns  the  builder of Floor Number of Passes  <br> License requirements : cam_base ("CAM BASE") */
