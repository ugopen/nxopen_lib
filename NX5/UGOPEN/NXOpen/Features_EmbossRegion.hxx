    ...
    namespace Features
    {
        ...
        /** Represents an emboss region object. 
                ...
                <b>Direction</b>    If user do not specify it, it uses section normal as default direction. 
                 <br> 
                 <br> 
                <b>Convexity Option</b>    @link  EmbossRegion::ConvexityOptionMixed   EmbossRegion::ConvexityOptionMixed @endlink 
                 <br>  
                 <br> 
        ...
        class NXOPENCPPEXPORT EmbossRegion : public TaggedObject
        {
            ...
            /**Sets  the section that is composed of chains  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the section that is composed of chains  <br> License requirements : None */
            public: NXOpen::Section * Section
            (
            );
            /**Sets   the default direction  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns   the default direction  <br> License requirements : None */
            public: NXOpen::Direction * Direction
            (
            );
            /**Sets   the convexity option   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetConvexity
            (
                NXOpen::Features::EmbossRegion::ConvexityOption convexity /**The convexity option. See the comment of @link EmbossRegion::ConvexityOption EmbossRegion::ConvexityOption@endlink  for more details.*/
            );
            /**Returns   the convexity option   <br> License requirements : None */
            public: NXOpen::Features::EmbossRegion::ConvexityOption Convexity
            (
            );
            /**Sets  the emboss projection object <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetProjection
            (
                NXOpen::Features::EmbossProjection * projection /**The emboss projection object*/
            );
            /**Returns  the emboss projection object <br> License requirements : None */
            public: NXOpen::Features::EmbossProjection * Projection
            (
            );
            /**Sets  the emboss sidewall object  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetSidewall
            (
                NXOpen::Features::EmbossSidewall * sidewall /**The emboss sidewall object*/
            );
            /**Returns  the emboss sidewall object  <br> License requirements : None */
            public: NXOpen::Features::EmbossSidewall * Sidewall
            (
            );
            /** The emboss limits  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetLimits
            (
                const std::vector<NXOpen::Features::EmbossLimit *> & limits /**Array of EmbossLimit objects. In NX4, only one limit is supported.*/
            );
            /** The emboss limits  @return Array of EmbossLimit objects. In NX4, only one limit is supported. <br> License requirements : None */
