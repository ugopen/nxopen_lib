...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT SessionVisualizationHighQualityImage
        {
            ...
            (
                NXOpen::Preferences::SessionVisualizationHighQualityImage::ImageSizeType* image_size /** image size */ ,
            ...
            (
                NXOpen::Preferences::SessionVisualizationHighQualityImage::PlotQualityType plot_quality /** plot quality */ 
            );
            ...
            (
                bool use_sub_region /** use sub region */ 
            );
