...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT CurveCollection : public TaggedObjectCollection
    {
        ...
        public: NXOpen::Line * CreateLine
        (
            NXOpen::Point * start_point /** Start @link Point Point@endlink  */,
            NXOpen::Point * end_point /** End @link Point Point@endlink  */
        );
        ...
        (
            const NXOpen::Point3d & start_point /** Start point */,
            const NXOpen::Point3d & point_on /** Point that the arc passes through. */,
            const NXOpen::Point3d & end_point /** End point */,
            bool alternate_solution /** If true, the arc will be created using the alternate solution instead of the regular solution.
            ...
            bool* start_and_end_got_flipped /** If true, the start point of the arc that is
        ...
        (
            const NXOpen::Point3d & center /** Center of the arc */,
            const NXOpen::Vector3d & x_direction /** X direction of the arc */,
            const NXOpen::Vector3d & y_direction /** Y direction of the arc */,
            double radius /** Radius of the arc.  Must be greater than zero. */,
            double start_angle /** Start angle in radians  */,
            double end_angle /** End angle in radians */
        );
        ...
        (
            ...
            const NXOpen::Vector3d & x_direction /** X direction of the ellipse */,
            const NXOpen::Vector3d & y_direction /** Y direction of the ellipse */,
            double major_radius /** Major radius of the ellipse.  Must be greater than zero. */,
            double minor_radius /** Minor radius of the ellipse.  Must be greater than zero. */,
            double start_angle /** Start angle in radians  */,
            double end_angle /** End angle in radians */
        );
        ...
        (
            ...
            double minimum_d_y /** Minimum DY width */,
            double maximum_d_y /** Maximum DY width */,
            double rotation_angle /** Rotation angle in radians */,
        ...
        (
            ...
            const NXOpen::Vector3d & x_direction /** X direction of the parabola */,
            const NXOpen::Vector3d & y_direction /** Y direction of the parabola */,
            double focal_length /** Focal length */,
            double minimum_d_y /** Minimum DY width */,
            double maximum_d_y /** Maximum DY width */
        );
        ...
        (
            ...
            double semi_transverse_length /** Semi-transverse length */,
            double semi_conjugate_length /** Semi-conjugate length */,
            double minimum_d_y /** Minimum DY width */,
            double maximum_d_y /** Maximum DY width */,
            double rotation_angle /** Rotation angle in radians */,
        ...
        (
            ...
            const NXOpen::Vector3d & x_direction /** X direction of the hyperbola */,
            const NXOpen::Vector3d & y_direction /** Y direction of the hyperbola */,
            double semi_transverse_length /** Semi-transverse length */,
            double semi_conjugate_length /** Semi-conjugate length */,
            double minimum_d_y /** Minimum DY width */,
            double maximum_d_y /** Maximum DY width */
