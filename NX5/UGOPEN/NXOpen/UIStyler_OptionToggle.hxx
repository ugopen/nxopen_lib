...
namespace NXOpen
{
    ...
    namespace UIStyler
    {
        ...
        class NXOPENUICPPEXPORT OptionToggle : public UIStyler::StylerItem
        {
            ...
            (
                const NXString & str_label /** Text to be set for the tool tip.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Sets items in the array  <br> License requirements : None */
            public: void SetItems
            (
                std::vector<NXString> & str_list_array /** An array of new choices to be used for the dialog item. 
