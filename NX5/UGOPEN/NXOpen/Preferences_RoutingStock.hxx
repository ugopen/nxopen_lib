...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT RoutingStock
        {
            ...
            (
                NXOpen::Routing::StockStyle default_stock_style /** default stock style */ 
            );
            ...
            (
                NXOpen::Preferences::RoutingStock::StockModeFlag stock_mode /** stock mode */ 
            );
            ...
            (
                const NXString & stock_folder /** stock folder */ 
            );
            ...
            (
                bool delete_overstock /** delete overstock */ 
            );
            ...
            (
                const NXString & anchor_name /** anchor name */ 
            );
            ...
            (
                NXOpen::Routing::CharacteristicList * stock_part /** Characteristic list used to find the appropriate 
                ...
                NXOpen::Routing::CharacteristicList * data_charx /** The list of optional and required characteristics to apply to the new stock. */
            );
