...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT BridgeCurveBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the start tangent magnitude for shape control option of @link ShapeControlTypesEndPoint ShapeControlTypesEndPoint@endlink   <br> License requirements : None */
            public: NXOpen::Expression * StartTangentMagnitude
            (
            );
            /**Returns  the end tangent magnitude for shape control option of @link ShapeControlTypesEndPoint ShapeControlTypesEndPoint@endlink   <br> License requirements : None */
            public: NXOpen::Expression * EndTangentMagnitude
            (
            );
            /**Returns  the depth value for shape control option of @link ShapeControlTypesPeakPoint ShapeControlTypesPeakPoint@endlink   <br> License requirements : None */
            public: NXOpen::Expression * Depth
            (
            );
            /**Returns  the skew value for shape control option of @link ShapeControlTypesPeakPoint ShapeControlTypesPeakPoint@endlink   <br> License requirements : None */
            public: NXOpen::Expression * Skew
            (
            );
            /**Returns  the rho value for shape control option of @link ShapeControlTypesConic ShapeControlTypesConic@endlink   <br> License requirements : None */
            public: NXOpen::Expression * Rho
            (
            );
            /**Returns  the shape curve for shape control option of @link ShapeControlTypesShapeCurve ShapeControlTypesShapeCurve@endlink   <br> License requirements : None */
