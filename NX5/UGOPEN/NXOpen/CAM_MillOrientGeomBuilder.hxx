...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT MillOrientGeomBuilder : public CAM::OrientGeomBuilder
        {
            ...
            /** the lower limit mode  @return  the lower limit mode  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the lower limit plane  <br> License requirements : cam_base ("CAM BASE") */
