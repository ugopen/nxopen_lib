...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT DisplayManager
    {
        ...
        struct J3dColor
        {
            ...
            public: J3dColor(double INIT_red /** red value in the range 0.0 to 1.0 */, double INIT_green /** blue color value */, double INIT_blue /** green color value */) :
                Red(INIT_red),
                Green(INIT_green),
                Blue(INIT_blue)
            {
        ...
        struct J3dMaterial
        {
            ...
            public: J3dMaterial(NXOpen::DisplayManager::J3dColor INIT_color /** object color */, NXOpen::DisplayManager::J3dColor INIT_highlight_color /** object highlight color */, double INIT_roughness /** surface roughness parameter */, double INIT_specular_factor /** specular reflection coeficient */, double INIT_diffuse_factor /** diffuse reflection coeficient */, double INIT_ambient_factor /** ambient light coeficient */, double INIT_transparency /** 0.0 is opaque, 1.0 is totally transparent */) :
                Color(INIT_color),
        ...
        struct J3dData
        {
            ...
            public: J3dData(NXOpen::DisplayableObject * INIT_eid /** NX identifier for this shape */, bool INIT_has_transform /** true if an assembly transform is used */, bool INIT_sheet /** true if this is a sheet body */, NXString INIT_name /** entity name */, NXOpen::DisplayManager::J3dMaterial INIT_material /** material properties */) :
                Eid(INIT_eid),
        ...
        public: enum ShowHideType
        {
            ...
            ShowHideTypeDatums/** Show or hide Datums i.e Coordinate Systems
                                                                  Datum Axes, Datum Planes, Points */,
        ...
        (
            ...
            std::vector<int> & points_per_strip /** points for each triangle strip */
        );
