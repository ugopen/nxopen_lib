    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT RSEvent : public NXObject
            {
                ...
                (
                    NXOpen::CAE::ResponseSimulation::RSEvent::ResultFileType result_file_type /** result file type */ 
                );
                ...
                (
                    NXOpen::CAE::ResponseSimulation::NodalFunctionEvaluationSetting * evaluation_setting /** evaluation setting */ 
                );
                ...
                (
                    NXOpen::CAE::ResponseSimulation::ElementalFunctionEvaluationSetting * evaluation_setting /** evaluation setting */ 
                );
                ...
                (
                    NXOpen::CAE::ResponseSimulation::ResponseResultsEvaluationSetting * evaluation_setting /** evaluation setting */ 
                );
                ...
                (
                    NXOpen::CAE::ResponseSimulation::StrengthResultsEvaluationSetting * evaluation_setting /** evaluation setting */ 
                );
                ...
                (
                    NXOpen::CAE::ResponseSimulation::PeakValueEvaluationSetting * evaluation_setting /** evaluation setting */ 
                );
                /** Perfroms evaluation for RMS results. The results is stored in an RS2 file, which file name
                        could be returned by @link CAE::ResponseSimulation::RSEvent::GetResultFileName CAE::ResponseSimulation::RSEvent::GetResultFileName@endlink .  <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: void EvaluateRmsResults
                (
                    NXOpen::CAE::ResponseSimulation::RmsResultsEvaluationSetting * evaluation_setting /** evaluation setting */ 
                );
                /** Performs evaluation for LCR results. The results is stored in an RS2 file, which file name
                        could be returned by @link CAE::ResponseSimulation::RSEvent::GetResultFileName CAE::ResponseSimulation::RSEvent::GetResultFileName@endlink   <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: void EvaluateLcrResults
                (
                    NXOpen::CAE::ResponseSimulation::LcrResultsEvaluationSetting * evaluation_setting /** evaluation setting */ 
                );
