    ...
    namespace BodyDes
    {
        ...
        /**
            Represents a @link BodyDes::OnestepUnformBuilder BodyDes::OnestepUnformBuilder@endlink . This allows the creation of an Onestep Unform.
             <br> To create a new instance of this class, use @link BodyDes::OnestepUnformCollection::CreateBuilder BodyDes::OnestepUnformCollection::CreateBuilder@endlink  <br> */
        class NXOPENCPPEXPORT OnestepUnformBuilder : public Builder
        {
            ...
            /**Returns  the constraint curve used to define curve to curve or curve along curve constraint.  <br> License requirements : None */
            public: NXOpen::ScCollector * ConstraintCurve
            (
            );
            /**Returns  the constraint point used to define point to point constraint for complete unform.  <br> License requirements : None */
            public: NXOpen::Point * ConstraintPoint
            (
            );
            /**Sets  the constraint point used to define point to point constraint for complete unform.  <br> License requirements : nx_onestep_analysis ("NX Onestep Analysis") OR ug_body_design ("Body Design") OR die_engineering ("DIE ENGINEERING") */
