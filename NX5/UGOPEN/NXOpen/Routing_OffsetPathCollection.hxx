    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT OffsetPathCollection : public TaggedObjectCollection
        {
            ...
            (
                ...
                bool maintain_stock /** if TRUE: Maintain stock on paths */,
                bool copy_bend_corners /** if TRUE: Copy the bend corners*/,
                NXOpen::Routing::OffsetPathCollection::BendType maintain /** Maintain radius or center  */,
                bool use_minimum_bend_ratio /** if TRUE: Use Ratio to Stock Diameter*/,
                double minimum_bend_ratio /** Minimum Bend Ratio */,
                double minimum_bend_radius /** Minimum Bend Radius*/,
                bool delete_all_duplicates /** if TRUE: Delete all duplicate paths */,
                bool create_associative_paths /** if TRUE: Create associative paths */,
                const NXOpen::Vector3d & pattern_x_vector /** X vector to set the pattern reference axis */,
                const NXOpen::Vector3d & pattern_y_vector /** Y vector to set the pattern reference axis  */,
                const NXOpen::Point3d & pattern_axis_end_point /** Point to set the pattern reference axis direction 
                                                                               if NULL: Computes reference axis using heuristics*/,
                double pattern_start_angle /** Start angle of the point */,
                double radial_offset /** Offset distance */,
                int n_paths /** Number of paths */,
                double total_angle /** Total angle */,
                std::vector<NXOpen::Routing::OffsetPath *> & slave_paths_created /** The created slave offset paths */
            );
            ...
            (
                ...
                const NXOpen::Point3d & pattern_axis_end_point /** Point to set the pattern reference axis direction 
                                                                               if NULL: Computes reference axis using heuristics*/,
                double pattern_start_angle /** Start angle of the pattern */,
                double row_offset /** Offset distance along the row */,
                double column_offset /** Offset distance along the column*/,
                int n_rows /** Number of rows */,
                int n_columns /** Number of columns */,
                int master_row /** Row of the master path */,
                int master_column /** Column of the master path*/,
                std::vector<NXOpen::Routing::OffsetPath *> & slave_paths_created /** The created slave offset paths */
            );
            ...
            (
                NXOpen::Routing::OffsetPath * master_offset_path /** master offset path */ 
            );
