        ...
        class NXOPENCPPEXPORT UserDefinedObjectDisplayContext : public TransientObject
        {
            ...
            (
                const std::vector<NXOpen::Point3d> & points /** Array of point coordinates. 
                                                                                  points[0-2] defines the first point, points[3-5] defines the second point, etc.*/,
                NXOpen::UserDefinedObjects::UserDefinedObjectDisplayContext::PolyMarker marker_type /** The type of marker displayed for each point */
            );
            ...
            (
                int num_vertices /** Number of points to define a facet. */,
                int num_facets /** Number of facets to display. */,
                ...
                NXOpen::UserDefinedObjects::UserDefinedObjectDisplayContext::FacetType type_of_facet /** The format of the facet in the facet array */
            );
            ...
            (
                ...
                const NXOpen::Point3d & text_coordinates /** Position of text box reference point in abs */,
                NXOpen::UserDefinedObjects::UserDefinedObjectDisplayContext::TextRef reference_point /** Reference point of text box */
            );
        };
    }
}
