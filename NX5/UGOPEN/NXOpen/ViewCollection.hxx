    ...
    class NXOPENCPPEXPORT ViewCollection : public TaggedObjectCollection
    {
        ...
        */
        ...
        (
            ...
            bool make_referenced_objects /** true if scene objects are to be created */
        );
        ...
        (
            ...
            bool make_referenced_objects /** true if referenced image object is to be created */
        );
        ...
        (
            ...
            bool make_referenced_objects /** true if first wall's image object is to be created */
        );
        ...
        (
            NXOpen::View * view /** view to which stage data will be associated */,
            NXOpen::Display::Stage::WallType wall_type /** where the wall sits in the Display.Stage */
        );
