    ...
    namespace GeometricAnalysis
    {
        ...
        class NXOPENCPPEXPORT ExamineGeometry : public Builder
        {
            ...
            /** Examines the geometry.  Before calling this method, use 
                        @link SetCheck SetCheck@endlink  and @link ClearCheck ClearCheck@endlink  
                        to specify which checks to perform and use @link ObjectsToExamine ObjectsToExamine @endlink and @link SetObjectsToExamine SetObjectsToExamine @endlink  
                        to specify which objects to examine.  After calling this method, 
                        use @link GetResults GetResults@endlink  and 
                        @link GetFailedObjects GetFailedObjects@endlink  to get the results.  <br> License requirements : None */
            public: void Examine
            (
            );
            /** Returns an array containing the number of objects that failed each check.
                          ...
                          @link CheckObjectTiny CheckObjectTiny@endlink  check.  
                          ...
                          <li> <b>-2</b>    a type of @link Check Check@endlink  is selected, no objects relevant to that type 
                                ...
                                @link CheckBodyDataStructures CheckBodyDataStructures@endlink  check is
                                set or selected. </li>
                          <li> <b>-3</b>    @link Check Check@endlink  not performed as other relevant @link Check Check@endlink  failed. This occurs when 
                                @link CheckBodyConsistency CheckBodyConsistency@endlink 
                                and/or @link CheckBodyFaceIntersections CheckBodyFaceIntersections@endlink  check is set along with 
                                @link CheckBodyDataStructures CheckBodyDataStructures@endlink  check.
                                If @link CheckBodyDataStructures CheckBodyDataStructures@endlink  check
                                failed, @link CheckBodyConsistency CheckBodyConsistency@endlink 
                                and/or
                                @link CheckBodyFaceIntersections CheckBodyFaceIntersections@endlink  will
                                not be performed. </li> 
            ...
            /** Returns the objects that failed a given type of check.  You should 
                    call @link ExamineGeometry ExamineGeometry@endlink  before calling this method.    @return  Objects that
