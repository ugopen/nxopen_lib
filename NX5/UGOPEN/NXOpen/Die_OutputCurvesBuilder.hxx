...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT OutputCurvesBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::Die::OutputCurvesBuilder::TrimCurveTypes trim_curve_type /** trim curve type */ 
            );
            ...
            (
                NXOpen::Features::Feature * reference_feature /** reference feature */ 
            );
            ...
            (
                const NXOpen::Point3d & first_limit_point /** first limit point */ 
            );
            ...
            (
                const NXOpen::Point3d & last_limit_point /** last limit point */ 
            );
            ...
            (
                double offset_distance /** each non-trim offset curve will be output by this distance */
            );
            ...
            (
                NXOpen::Die::OutputCurvesBuilder::TrimOutputCurveTypes trim_curve_output_type /** trim curve output type */ 
            );
            ...
            (
                NXOpen::Die::OutputCurvesBuilder::TrimCurveCreateTypes trim_curve_type /** trim curve type */ 
            );
            ...
            (
                NXOpen::Die::OutputCurvesBuilder::SmoothTypes smooth_type /** smooth type */ 
            );
            ...
            (
                double smooth_tolerance /** smooth tolerance */ 
            );
