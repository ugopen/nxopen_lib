...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT PmiManager
        {
            ...
            (
                const std::vector<NXOpen::Annotations::Pmi *> & input_objects /** PMI objects to be copied */
            );
            ...
            (
                const std::vector<NXOpen::Annotations::Annotation *> & input_objects /** PMI Display Instance objects to be copied */,
            ...
            (
                const std::vector<NXOpen::Annotations::Annotation *> & input_objects /** PMI Display Instance objects to be cut */,
                const std::vector<NXOpen::View *> & cut_views /** List of cut views. Each PMI Display Instance
                                                                              object is cut from the corresponding view 
                                                                              in the list. 
                                                                              */,
                NXOpen::View * view_of_paste /** View in which PMI Display Instances are pasted. */
            );
            ...
            (
                NXOpen::Annotations::Annotation * inherited_pmi /** Inherited PMI */
            );
            ...
            (
                NXOpen::Annotations::Annotation * display_instance /** PMI Display Instance */
            );
