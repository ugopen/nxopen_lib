...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /**   <br> To obtain an instance of this class, refer to @link Preferences::RoutingPart Preferences::RoutingPart@endlink  <br> */
        class NXOPENCPPEXPORT RoutingPartLibrary
        {
            ...
            (
                const NXString & start_node /** Must not be a @link NXOpen::Preferences::RoutingPartLibrary::NodeTypePart NXOpen::Preferences::RoutingPartLibrary::NodeTypePart@endlink  
            ...
            (
                ...
                std::vector<NXString> & part_classes /** The part class hierarchy list that contains the matching part. 
