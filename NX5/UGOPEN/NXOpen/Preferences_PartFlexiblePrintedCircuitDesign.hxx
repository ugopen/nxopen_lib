...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT PartFlexiblePrintedCircuitDesign
        {
            ...
            /** RETURNS the material name saved with the part  @return   <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
