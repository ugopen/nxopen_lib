    ...
    namespace CAM
    {
        ...
        /**
            Represents a @link CAM::NcmScBuilder CAM::NcmScBuilder@endlink 
             <br> To create a new instance of this class, use @link CAM::NCGroupCollection::CreateNcmScBuilder CAM::NCGroupCollection::CreateNcmScBuilder@endlink  <br> */
        class NXOPENCPPEXPORT NcmScBuilder : public CAM::NcmSubopBuilder
        {
            ...
            /**Returns  the open area engage settings  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmScEngRetBuilder * EngageOpenAreaBuilder
            (
            );
            /**Returns  the against check engage settings  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmScEngRetBuilder * EngageAgainstCheckBuilder
            (
            );
            /**Returns  the initial engage settings  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmScEngRetBuilder * EngageInitialBuilder
            (
            );
            /**Returns  the open area retract settings  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmScEngRetBuilder * RetractOpenAreaBuilder
            (
            );
            /**Returns  the against check retract settings  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmScEngRetBuilder * RetractAgainstCheckBuilder
            (
            );
            /**Returns  the final retract settings  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmScEngRetBuilder * RetractFinalBuilder
            (
            );
            /**Returns  the region distance setting  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableToolDepBuilder * TransferRegionDistanceBuilder
            (
            );
            /**Returns  the common clearance setting  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmClearanceBuilder * TransferCommonClearanceBuilder
            (
            );
            /**Returns  the transfer settings for within regions  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmTransferBuilder * TransferWithinRegionsBuilder
            (
            );
            /**Returns  the transfer settings for between regions  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NcmTransferBuilder * TransferBetweenRegionsBuilder
            (
            );
            /**Returns  the smoothing option  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the max tool axis change  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the smoothing radius settings  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the collision check activation  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the contact data output activation  <br> License requirements : cam_base ("CAM BASE") */
