...
namespace NXOpen
{
    ...
    /**
        Represents a @link PlotBuilder PlotBuilder@endlink .  This class contains all information relating to
        plotting.  The user must specify the sheets to be plotted by setting the appropriate fields 
        through the @link PlotSourceBuilder PlotSourceBuilder@endlink .  For each sheet selected, a temporary CGM 
        ...
        handles all Banner data and Manufacturing data to be used during plotting.
         <br> To create a new instance of this class, use @link PlotCollection::CreatePlotBuilder PlotCollection::CreatePlotBuilder@endlink  <br> */
    class NXOPENCPPEXPORT PlotBuilder : public Builder
    {
        ...
        /**Returns  the type of plot.  This can be Standard or Plot Using a Layout.  <br> License requirements : None */
        public: NXOpen::PlotBuilder::PlotTypes PlotType
        (
        );
        /**Sets  the type of plot.  This can be Standard or Plot Using a Layout.  <br> License requirements : None */
        public: void SetPlotType
        (
            NXOpen::PlotBuilder::PlotTypes plotType /** plottype */ 
        );
        /** Add Plot to Layout.  This routine adds a sheet to the plot layout.  <br> License requirements : None */
        public: void AddToPlotLayout
        (
        );
        /** Clear Plot from Layout.  This routine clears all sheets from the plot layout.  <br> License requirements : None */
        public: void ClearPlotLayout
        (
        );
        /**Returns  the display banner.  If true, the specified banner options will be used in adding
                    a banner to the plot.  If false, no banner will be used to plot.  <br> License requirements : None */
        ...
        /**Returns  the banner message.  This text field will be added to the banner if Display
                    Banner is set to true.  <br> License requirements : None */
        ...
        /**Returns  the units used to create the banner.  The units can be either English or
                    ...
                    size when creating a banner.  <br> License requirements : None */
        ...
        /**Returns  the X coordinate of a banner.  If Display Banner is true, the
                    ...
                    This can be set to Left, Center, or Right.   <br> License requirements : None */
        ...
        /**Returns  the X coordinate offset of a banner.  If Display Banner is true, the X offset
                    ...
                    where the banner will appear when plotting.  <br> License requirements : None */
        ...
        /**Returns  the Y coordinate of a banner.  If Display Banner is true, the
                    X and Y coordinates will determine where the banner will appear when plotting. 
                    This can be set to Bottom, Center, or Top.   <br> License requirements : None */
        ...
        /**Returns  the character size of the banner.  If Display Banner is true, the character size
                    value will be used to determine the size of the banner text.  <br> License requirements : None */
        ...
        /**Returns  the rotation of the banner.  This can be set to 0, 90, 180, or 270 and will determine
                    the rotation of the banner if Display Banner is true.  <br> License requirements : None */
        ...
        /**Returns  the justification of the banner text.  If Display Banner is true, the justification
                    ...
                    Justify, or Right Justify.  <br> License requirements : None */
        ...
        /** Saves the selected sheets as CGM files.  <br> License requirements : None */
        public: void SaveCgm
        (
        );
        /** Initialize the SDI dialog.  <br> License requirements : None */
        public: void AdvancedPlot
        (
        );
        /**Returns  the number of copies to be plotted. <br> License requirements : None */
        public: int Copies
        (
        );
        /**Sets  the number of copies to be plotted. <br> License requirements : None */
        public: void SetCopies
        (
            int copies /** copies */ 
        );
        /**Returns  the job name to be used for plotting.  <br> License requirements : None */
        public: NXString JobName
        (
        );
        /**Sets  the job name to be used for plotting.  <br> License requirements : None */
        ...
        /**Returns  the plotting tolerance.  The tolerance is a unitless value that controls
                    ...
                    than or equal to 0.0001.  Smaller values produce smoother curves.  <br> License requirements : None */
        ...
        /**Returns  the option to plot clsf data.  If clsf data is true, the current clsf data
                    will be included in the plot.  <br> License requirements : None */
        ...
        /**Returns  the raster images option.  This option determines whether or not raster images will
                    be used when plotting.  <br> License requirements : None */
        ...
        /**Returns  the Colors Widths builder.  The Colors Widths builder contains all information
                    relating to both colors and widths.  <br> License requirements : None */
        ...
        /**Returns  the Source builder.  The Source builder contains all data involving the sheets to
                    to be plotted.  <br> License requirements : None */
        ...
        /** Gets all the temporary CGM filenames to be plotted.  This list will contain the full
                    ...
                    operation is finished.  @return   <br> License requirements : None */
        ...
        /** Sets all the temporary CGM filenames to be plotted.  This list will contain the full
                    ...
                    operation is finished.  <br> License requirements : None */
        ...
        /** Gets all the Graphic filenames to be saved.  If the plotter selected is an image type 
                    ...
                    of sheets selected to plot.  @return   <br> License requirements : None */
        ...
        /** Sets all the Graphic filenames to be saved.  If the plotter selected is an image type 
                    (JPEG, CGM, TIFF, EMF, or PNG) then the graphic filenames text list will contain the
                    full path of where these images will be saved to disk.  This list must equal the number
                    of sheets selected to plot.  <br> License requirements : None */
        ...
        /**Returns  the plotter text.  The plotter field represents which plotter the user wishes to plot to, it
                    ...
                    be set.  <br> License requirements : None */
        ...
        /**Returns  the profile text.  The profile must be a valid SDI created profile associated with the
                    current plotter.  <br> License requirements : None */
        ...
        /**Returns  the printer group text.  The printer group must be set if a printer is used as
                the plotter.  <br> License requirements : None */
        ...
        /**Returns  the resolution of images created for plotting shaded views.  <br> License requirements : None */
        public: NXOpen::PlotBuilder::ImageResolutionOption ImageResolution
        (
        );
        /**Sets  the resolution of images created for plotting shaded views.  <br> License requirements : None */
