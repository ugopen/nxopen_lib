    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT AfuManager
        {
            ...
            (
                ...
                const std::vector<int> & record_indexes /** Indexes of the AFU Data Records to be copied. Each index Must begin with 1 */,
            ...
            (
                ...
                const std::vector<int> & afu_record_indexes /** List of Indexes of data records to be deleted from the AFU file. (Indexes begin with 1) */
            );
            ...
            (
                ...
                const NXString & export_file_name /** Name of destination file to which AFU Data Record is exported   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
