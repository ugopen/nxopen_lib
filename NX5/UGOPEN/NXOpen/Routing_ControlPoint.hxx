...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT ControlPoint : public SmartObject, public virtual Routing::IRoutePosition
        {
            ...
            /** Returns all segments whose start or end rcp is this rcp.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
