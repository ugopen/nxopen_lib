    ...
    namespace PDM
    {
        ...
        class NXOPENCPPEXPORT PartBuilder : public TransientObject
        {
            ...
            struct PartNumberData
            {
                ...
                public: PartNumberData(NXString INIT_part_name /** The part name*/, bool INIT_part_name_modifiable /** Modifiable flag for part name.*/, NXString INIT_part_description /** The part description*/, bool INIT_part_description_modifiable /** Modifiable flag for part description.*/, NXString INIT_part_number /** The part number*/, bool INIT_part_number_modifiable /** Modifiable flag for part number.*/) :
            ...
            struct PartRevisionData
            {
                ...
                public: PartRevisionData(NXString INIT_part_revision /**Part revision*/, bool INIT_part_revision_modifiable /** Revision Modifiable flag. False if part revision is not modifiable*/) :
            ...
            struct PartFileNameData
            {
                ...
                public: PartFileNameData(NXString INIT_part_file_name /**Part file name*/, bool INIT_part_file_name_modifiable /** False if part file name is not modifiable*/) :
            ...
            (
                const NXString & old_part_number /** Old part number   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & part_type /** Part type   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & part_number /**Part Number  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & part_revision /** part revision  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & part_file_name_type /**Part file name type.
                ...
                const NXString & old_part_file_name /**Old part file name  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /**
            ...
            (
                const NXString & part_type /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** 
