...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT SpinePointData : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            (
                double percent_parameter /** percent parameter */ 
            );
            ...
            (
                double length_parameter /** length parameter */ 
            );
            /** the law value at the specified point  @return  Law value Expression Object  <br> License requirements : None */
            public: NXOpen::Expression * GetLawValueAtPoint
            (
            );
            public: void SetLawValueAtPoint
            (
                const NXString & val_string /** Law value string   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** the parent spine on which spine point is defined	 @return  section object <br> License requirements : None */
