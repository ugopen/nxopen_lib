#ifndef NXOpen_FEATURES_BULKHEADLISTITEMBUILDERLIST_HXX_INCLUDED
#define NXOpen_FEATURES_BULKHEADLISTITEMBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Features_BulkHeadListItemBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT BulkHeadListItemBuilderList : public TaggedObject
        {
            ...
            public: void Append
            (
                const std::vector<NXOpen::Features::BulkHeadListItemBuilder *> & objects /** items to append */
            );
            /** Appends an object to the list
                 <br> License requirements : None */
            public: void Append
            (
                NXOpen::Features::BulkHeadListItemBuilder * object /** item to append */
            );
            ...
            /** Returns the list of entities stored.  This list may contain NULL entities.
             ...
             <br> License requirements : None */
            public: std::vector<NXOpen::Features::BulkHeadListItemBuilder *> Vector
            (
            );
            ...
            (
                NXOpen::Features::BulkHeadListItemBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index  <br> License requirements : None */
            public: NXOpen::Features::BulkHeadListItemBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Features::BulkHeadListItemBuilder * obj /** object to be removed from the list */
            );
            ...
            public: std::vector<NXOpen::Features::BulkHeadListItemBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Features::BulkHeadListItemBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Features::BulkHeadListItemBuilder * object1 /** first item */,
                NXOpen::Features::BulkHeadListItemBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Features::BulkHeadListItemBuilder * object /** object to be inserted */
            );
        };
    }
}
