...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT STLImporter : public Importer
    {
        ...
        (
            NXOpen::STLImporter::AngularToleranceType angular_tolerance /** angular tolerance */ 
        );
        ...
        (
            NXOpen::STLImporter::FileUnitsType file_units /** file units */ 
        );
        ...
        (
            bool display_information /** display information */ 
        );
        ...
        (
            NXOpen::STLImporter::FileFormatType file_format /** file format */ 
        );
    };
}
#undef EXPORTLIBRARY
