...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        /** Represents a Pierce Task feature builder  <br> To create a new instance of this class, use @link Die::DieCollection::PierceTask Die::DieCollection::PierceTask@endlink  <br> */
        class NXOPENCPPEXPORT PierceTaskBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::Die::PierceTaskBuilder::CamTypes cam_type /** cam type */ 
            );
            ...
            (
                NXOpen::Die::PierceTaskBuilder::PrecisionTypes precision_type /** precision type */ 
            );
            /**Returns  the center point output option of the pierce task  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Die::PierceTaskBuilder::CenterPointOptionTypes CenterPointOption
            (
            );
            /**Sets  the center point output option of the pierce task  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetCenterPointOption
            (
                NXOpen::Die::PierceTaskBuilder::CenterPointOptionTypes center_point_option /** center point option */ 
            );
            ...
            /**Returns  the tip feature  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Features::SelectFeature * TipFeature
            (
            );
            /**Returns  the pierce holes  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::ScCollector * PierceHoles
            (
            );
            /**Returns  the pierce holes list  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Die::PierceItemBuilderList * PierceHolesList
            (
            );
            /** Creates a new pierce hole item in the set  @return   <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Die::PierceItemBuilder * NewPierceHole
            (
                NXOpen::Die::PierceItemBuilder::HoleShapeType hole_shape /** hole shape */ 
            );
            /**Returns  the assoc objects  <br> License requirements : die_engineering ("DIE ENGINEERING") */
