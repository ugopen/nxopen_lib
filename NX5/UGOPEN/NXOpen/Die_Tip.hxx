...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT Tip : public Features::Feature
        {
            ...
            /** Maps the edge to find the part and die position entity, either can be a NULL_TAG.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void MapEdge
            (
                NXOpen::IProfile * in_edge /** in edge */ ,
                NXOpen::IProfile ** part_edge /** part edge */ ,
                NXOpen::IProfile ** die_edge /** die edge */ 
            );
