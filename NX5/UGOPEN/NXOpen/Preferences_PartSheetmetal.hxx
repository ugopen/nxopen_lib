...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT PartSheetmetal
        {
            ...
            {
                FlatPatternObjectTypeBendCenterLine/** bend center line */ ,
                ...
                FlatPatternObjectTypeInteriorCurves/** interior curves */ ,
            ...
            struct FlatPatternObjectTypeDisplay
            {
                ...
                public: FlatPatternObjectTypeDisplay(NXOpen::Preferences::PartSheetmetal::FlatPatternObjectType INIT_type /** Object type */, int INIT_is_enabled /** Enabled status for the object type */, NXColor* INIT_color /** Object color */, int INIT_layer /** Object Layer */, NXOpen::DisplayableObject::ObjectFont INIT_font /** Object font */, NXOpen::DisplayableObject::ObjectWidth INIT_width /** Object width */) :
                    Type(INIT_type),
            ...
            struct FlatPatternCalloutTypeDisplay
            {
                ...
                public: FlatPatternCalloutTypeDisplay(NXString INIT_type /** The name of the callout type.
                                    ...
                                    of hand-coded callout type is usable as long as the
                                    callout type name is unique within the application name. 
                                    Beware of changing the defaults and loading old parts. */, int INIT_is_enabled /** Enabled status for the callout type. */, NXString INIT_name /** dialog name for the callout type. */) :
                    Type(INIT_type),
                    IsEnabled(INIT_is_enabled),
                    Name(INIT_name)
                {
            ...
            (
                bool update_model /** Specifies whether the solid model be recomputed immediately*/,
                NXOpen::Preferences::PartSheetmetal::BendDefinitionMethodOptions bend_definition_method /** bend definition method option */
            );
            ...
            (
                bool update_model /** Specifies whether the solid model be recomputed immediately*/,
                const NXString & bend_table /** bend table name*/
            );
            ...
            (
                bool update_model /** Specifies whether the solid model be recomputed immediately*/,
                const NXString & bend_allowance_formula /** bend allowance formula*/
            );
            ...
            /** RETURNS the material name saved with the part  @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            ...
            /** RETURNS the flag indicating whether or not maintain holes in deformed flanges as part of the Flat Solid creation @return  flag   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public: bool GetMaintainHolesInDeformedFlangesInFlatSolid
            (
            );
            /** SETS the flag indicating whether or not maintain holes in deformed flanges as part of the Flat Solid creation <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public: void SetMaintainHolesInDeformedFlangesInFlatSolid
            (
                bool update_model /** Specifies whether the solid model be recomputed immediately*/,
                bool is_maintain_holes_for_deformed_flanges /** flag  */
            );
            ...
            /** Returns the display data for a callout type. The name member of the
                        @link Preferences::SheetMetal::FlatPatternCallout::Display Preferences::SheetMetal::FlatPatternCallout::Display@endlink 
