        ...
        class NXOPENCPPEXPORT Annotation : public DisplayableObject
        {
            ...
            struct AssociativeOriginData
            {
                ...
                public: AssociativeOriginData(NXOpen::Annotations::AssociativeOriginType INIT_origin_type /** Type of associativity */, NXOpen::View * INIT_view /** View of associativity for the annotation. 
                                                    Used for @link NXOpen::Annotations::AssociativeOriginTypeRelativeToView NXOpen::Annotations::AssociativeOriginTypeRelativeToView@endlink  */, NXOpen::View * INIT_view_of_geometry /** The member view in which the absolute model
                                                    point lies.  This is used for mapping onto
                                                    the drawing. 
                                                    Used for @link NXOpen::Annotations::AssociativeOriginTypeRelativeToGeometry NXOpen::Annotations::AssociativeOriginTypeRelativeToGeometry@endlink */, NXOpen::Point * INIT_point_on_geometry /** Absolute point in absolute space the annotation
                                                    is associated with. */, NXOpen::Annotations::Annotation * INIT_vert_annotation /** Annotation to align with. 
                                                    Used for @link NXOpen::Annotations::AssociativeOriginTypeVerticallyAligned NXOpen::Annotations::AssociativeOriginTypeVerticallyAligned@endlink */, NXOpen::Annotations::AlignmentPosition INIT_vert_alignment_position /** Alignment position on
                                                                            vert_annotation to
                                                                            align to. 
                                                                            Used for @link NXOpen::Annotations::AssociativeOriginTypeVerticallyAligned NXOpen::Annotations::AssociativeOriginTypeVerticallyAligned@endlink */, NXOpen::Annotations::Annotation * INIT_horiz_annotation /** Annotation to align with. 
                                                                            Used for @link NXOpen::Annotations::AssociativeOriginTypeHorizontallyAligned NXOpen::Annotations::AssociativeOriginTypeHorizontallyAligned@endlink */, NXOpen::Annotations::AlignmentPosition INIT_horiz_alignment_position /** Alignment position on
                                                                            horiz_annotation to
                                                                            align to. 
                                                                            Used for @link NXOpen::Annotations::AssociativeOriginTypeHorizontallyAligned NXOpen::Annotations::AssociativeOriginTypeHorizontallyAligned@endlink */, NXOpen::Annotations::Annotation * INIT_aligned_annotation /** Alignment annotation.
                                                    Used for @link NXOpen::Annotations::AssociativeOriginTypeAlignedWithArrows NXOpen::Annotations::AssociativeOriginTypeAlignedWithArrows@endlink .*/, int INIT_dimension_line /** 1 for dimension line 1, 2 for dimension line 2.
                                                    Used for @link NXOpen::Annotations::AssociativeOriginTypeAlignedWithArrows NXOpen::Annotations::AssociativeOriginTypeAlignedWithArrows@endlink */, NXOpen::View * INIT_associated_view /** The member view in  which the absolute model
                                                    point lies.  This is used for mapping onto
                                                    the drawing.  May be NULL if annotation is
                                                    on the model or the point is on the drawing.
                                                    Used for @link NXOpen::Annotations::AssociativeOriginTypeAtAPoint NXOpen::Annotations::AssociativeOriginTypeAtAPoint@endlink */, NXOpen::Point * INIT_associated_point /** Origin location of annotation.
                                                    Used for @link NXOpen::Annotations::AssociativeOriginTypeAtAPoint NXOpen::Annotations::AssociativeOriginTypeAtAPoint@endlink */, NXOpen::Annotations::Annotation * INIT_offset_annotation /** Annotation to align to.
                                                                                @link NXOpen::Annotations::AssociativeOriginTypeOffsetFromText NXOpen::Annotations::AssociativeOriginTypeOffsetFromText@endlink */, NXOpen::Annotations::AlignmentPosition INIT_offset_alignment_position /** Alignment position
                                                                                on annotation to
                                                                                align with.
                                                                                @link NXOpen::Annotations::AssociativeOriginTypeOffsetFromText NXOpen::Annotations::AssociativeOriginTypeOffsetFromText@endlink */, double INIT_x_offset_factor /** X Offset factor from
                                                                                associated point.
                                                                                @link NXOpen::Annotations::AssociativeOriginTypeOffsetFromText NXOpen::Annotations::AssociativeOriginTypeOffsetFromText@endlink */, double INIT_y_offset_factor /** Y Offset factor from
                                                                                associated point.
                                                                                @link NXOpen::Annotations::AssociativeOriginTypeOffsetFromText NXOpen::Annotations::AssociativeOriginTypeOffsetFromText@endlink */, NXOpen::Annotations::StackAlignmentPosition INIT_stack_alignment_position /** stack alignment position */ ) :
                    ...
                    StackAlignmentPosition(INIT_stack_alignment_position)
                {
                }
            };
            ...
            */
            ...
            (
                NXOpen::Annotations::LetteringPreferences * lettering_prefs /** lettering prefs */ 
            );
            ...
            (
                NXOpen::Annotations::LineAndArrowPreferences * line_arrow_prefs /** line arrow prefs */ 
            );
            /** Returns the symbol preferences for the annotation  @return   <br> License requirements : None */
            public: NXOpen::Annotations::SymbolPreferences * GetSymbolPreferences
            (
            );
            /** Sets the symbol preferences for the annotation  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSymbolPreferences
            (
                NXOpen::Annotations::SymbolPreferences * symbol_prefs /** symbol prefs */ 
            );
            ...
            (
                NXOpen::Annotations::LeaderOrientation leader_orientation /** leader orientation */ 
            );
            ...
            */
            ...
            (
                NXOpen::Xform * annotation_plane /** annotation plane */ 
            );
            ...
            (
                NXOpen::Annotations::PmiDefaultPlane ja_default_plane /** ja default plane */ 
            );
            /** Returns the views that the PMI display instance object is displayed in
                        NOTE: This method is only valid for PMI display instance objects
                              This method will return an empty view list for non-PMI display instance objects  @return  List of views that PMI display instance object is displayed in  <br> License requirements : None */
            public: std::vector<NXOpen::View *> GetViews
            (
            );
            /** Sets the views that the PMI display instance object is displayed in  <br> License requirements : geometric_tol ("GDT") */
            public: void SetViews
            (
                const std::vector<NXOpen::View *> & model_views /** List of new views to display PMI display instance object in */
            );
        };
    }
}
