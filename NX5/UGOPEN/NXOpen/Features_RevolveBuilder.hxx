        ...
        class NXOPENCPPEXPORT RevolveBuilder : public Features::FeatureBuilder
        {
            ...
            */
            ...
            /**Returns  the Offset enabled status 
                     <br> 
                    This is deprecated. Please use @link GeometricUtilities::FeatureOffset::OffsetTypeGeometricUtilities::FeatureOffset::OffsetType @endlink and @link GeometricUtilities::FeatureOffset::SetOffsetTypeGeometricUtilities::FeatureOffset::SetOffsetType @endlink  instead.	
                     <br> 	
            ...
            (
                bool offset_enabled /** If true then offset will be enabled on this revolve, else it will be disabled. */
            );
        };
    }
}
