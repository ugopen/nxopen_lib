...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT RoutingApplicationView
        {
            ...
            (
                const NXString & file_name /** filename of application view.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & current_spec /** current spec */ 
            );
            ...
            /**Sets  the given routing application type. This is only used in the context of routing to execute design rules. 
                    Application type should be set to@link Preferences::RoutingApplicationViewAppTypeNone Preferences::RoutingApplicationViewAppTypeNone@endlink 
            ...
            (
                NXOpen::Preferences::RoutingApplicationView::AppType app_type /** app type */ 
            );
