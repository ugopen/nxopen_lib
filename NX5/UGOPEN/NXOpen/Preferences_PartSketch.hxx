...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT PartSketch
        {
            ...
            (
                int sketch_curve_color /** sketch curve color */ 
            );
            ...
            (
                int sketch_dimension_color /** sketch dimension color */ 
            );
            ...
            (
                int sketch_overconstrained_color /** sketch overconstrained color */ 
            );
            ...
            (
                int sketch_conflicting_color /** sketch conflicting color */ 
            );
            ...
            (
                int sketch_partial_color /** sketch partial color */ 
            );
            ...
            (
                int sketch_fully_color /** sketch fully color */ 
            );
            ...
            (
                int sketch_reference_curve_color /** sketch reference curve color */ 
            );
            ...
            (
                int sketch_reference_dimension_color /** sketch reference dimension color */ 
            );
            ...
            (
                int sketch_out_of_date_color /** sketch out of date color */ 
            );
            ...
            (
                int sketch_d_o_f_color /** sketch d o f color */ 
            );
            ...
            (
                int sketch_inactive_color /** sketch inactive color */ 
            );
            ...
            (
                int sketch_participating_datum_color /** sketch participating datum color */ 
            );
