...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT Stock : public NXObject, public virtual Routing::ICharacteristic
        {
            ...
            (
                NXOpen::Routing::StockData * stock_data /** stock data */ 
            );
            ...
            (
                NXOpen::Routing::ProfileFrom profile_end /** profile end */ 
            );
            ...
            (
                bool is_new_part /** Is the part new? */
            );
