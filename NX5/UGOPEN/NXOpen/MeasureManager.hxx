...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT MeasureManager
    {
        ...
        public: explicit MeasureManager(NXOpen::BasePart *owner): m_owner(owner)
        {
        }
        public: 
        ...
        (
            ...
            NXOpen::MeasureManager::MeasureType min_max_flag /** chooses minimum or maximum distance */,
        ...
        (
            ...
            NXOpen::DisplayableObject * object2 /** Second object */,
            NXOpen::Direction * direction /** Direction vector */,
            NXOpen::MeasureManager::ProjectionType proj_type /** type of projected distance */
        );
        ...
        (
            ...
            NXOpen::DisplayableObject * object2 /** Second object */,
            NXOpen::Direction * direction /** Direction vector */,
            NXOpen::MeasureManager::ProjectionType proj_type /** Projection type */
        );
        ...
        (
            ...
            bool minor_angle /** selects minimum arc */
        );
        /** Create an angle measurement between two objects.
             <br> Type of allowed input objects include - Line, linear edge, Face,
            Datum Plane, Datum Axis. <br> 
        ...
        (
            ...
            NXOpen::MeasureManager::EndpointType qualifier2 /** second end point qualifier */,
            bool minor_angle /** selects minimum arc */,
            bool true_angle /** selects type of algorithm for the angle calculation */
        );
        ...
        (
            NXOpen::Unit * units /** Measurement units */,
            NXOpen::Point * base_point /** Base point */,
            NXOpen::Point * end_point1 /** End point 1 */,
            NXOpen::Point * end_point2 /** End point 2 */,
            bool minor_angle /** selects minimum arc */
        );
        ...
        (
            ...
            NXOpen::MeasureManager::EndpointType qualifier2 /** second end point qualifier */,
            bool minor_angle /** selects minimum arc */,
            bool true_angle /** selects the algorithm for angle calculations */
        );
        ...
        (
            ...
            NXOpen::MeasureManager::EndpointType qualifier2 /** second end point qualifier */,
            bool minor_angle /** selects minimum arc */,
            bool true_angle /** selects the algorithm for angle calculation */
        );
        ...
        (
            NXOpen::Unit * area_unit /** Area unit */,
            NXOpen::Unit * length_unit /** Length unit for perimeter */,
        ...
        (
            const std::vector<NXOpen::Unit *> & mass_units /** An array of input units:
