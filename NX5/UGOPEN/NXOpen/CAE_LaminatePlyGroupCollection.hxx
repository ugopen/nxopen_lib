...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT LaminatePlyGroupCollection : public TaggedObjectCollection
        {
            ...
            (
                int insertion_index /** index in the sequence to insert at */
            );
            ...
            (
                const NXString & name /** Name of ply group   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                NXOpen::CAE::LaminatePlyGroup::Link link_type /** Type of link */,
                const NXString & parent_name /** name of parent PlyGroup   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                int insertion_index /** index in the sequence to insert at */
            );
            ...
            (
                NXOpen::CAE::LaminatePlyGroup * ply_group /** group to remove */
            );
            ...
            (
                int group_index /** index of group to remove */
            );
            ...
            (
                int group_index /** index in the sequence */
            );
            ...
            (
                int group_index_1 /** group index 1 */ ,
                int group_index_2 /** group index 2 */ 
            );
