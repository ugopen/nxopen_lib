    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT NormalCutoutBuilder : public Features::FeatureBuilder
            {
                ...
                (
                    NXOpen::Features::SheetMetal::NormalCutoutBuilder::DepthSideOptions depth_side /** depth side */ 
                );
                ...
                (
                    NXOpen::Features::SheetMetal::NormalCutoutBuilder::SectionSideOptions section_side /** section side */ 
                );
                ...
                (
                    NXOpen::Features::SheetMetal::NormalCutoutBuilder::CutTypeOptions cut_type /** cut type */ 
                );
                ...
                /** the application context of Normal Cutout  @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
