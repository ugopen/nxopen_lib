...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT FillBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::Features::Feature * tipped_product /** tipped product */ 
            );
            ...
            (
                NXOpen::ISurface * mirror_plane /** mirror plane */ 
            );
            ...
            (
                bool copy_and_mirror /** = true - original sheet body will be copied in its current
