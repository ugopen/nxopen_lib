...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT StockData : public NXObject, public virtual Routing::ICharacteristic
        {
            ...
            (
                const NXString & anchor_name /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                NXOpen::Routing::StockStyle stock_style /** stock style */ 
            );
