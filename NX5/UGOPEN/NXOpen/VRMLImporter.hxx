...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT VRMLImporter : public Importer
    {
        ...
        (
            bool hide_smooth_edges /** hide smooth edges */ 
        );
        ...
        (
            NXOpen::VRMLImporter::AngularToleranceType angular_tolerance /** angular tolerance */ 
        );
        ...
        (
            bool generate_one_model /** generate one model */ 
        );
        ...
        (
            bool all_levels_of_detail /** all levels of detail */ 
        );
        ...
        (
            NXOpen::VRMLImporter::FileUnitsType file_units /** file units */ 
        );
        ...
        (
            bool more_summary_details /** more summary details */ 
        );
        ...
        (
            bool suppress_warning_messages /** suppress warning messages */ 
        );
    };
}
#undef EXPORTLIBRARY
