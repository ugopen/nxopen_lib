...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        /** Represents set of Hidden Lines View Style Preferences applicable to drafting views.  <br> To obtain an instance of this class, refer to @link Drawings::ViewStyle Drawings::ViewStyle@endlink  <br> */
        class NXOPENCPPEXPORT HiddenLinesViewStyle: public virtual Preferences::IHiddenLinesViewPreferences
        {
            private: NXOpen::Drawings::ViewStyle* m_owner;
            public: explicit HiddenLinesViewStyle(NXOpen::Drawings::ViewStyle *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /**Sets  the color of hiddenline. The value should be between 1 and 216.  <br> License requirements : drafting ("DRAFTING") */
            public: void SetHiddenlineColor
            (
                int color /** color */ 
            );
            /**Returns  the color of hiddenline. The value should be between 1 and 216.  <br> License requirements : None */
            public: int HiddenlineColor
            (
            );
            /**Sets  the font of hiddenline  <br> License requirements : drafting ("DRAFTING") */
            public: void SetHiddenlineFont
            (
                NXOpen::Preferences::Font font /** font */ 
            );
            /**Returns  the font of hiddenline  <br> License requirements : None */
            public: NXOpen::Preferences::Font HiddenlineFont
            (
            );
            /**Sets  the width of hiddenline  <br> License requirements : drafting ("DRAFTING") */
            public: void SetHiddenlineWidth
            (
                NXOpen::Preferences::Width width /** width */ 
            );
            /**Returns  the width of hiddenline  <br> License requirements : None */
            ...
            (
                bool reference_edges_only /** reference edges only */ 
            );
            ...
            (
                bool edges_hidden_by_edges /** edges hidden by edges */ 
            );
            ...
            (
                bool interfering_solids /** interfering solids */ 
            );
            ...
            /**Sets  the status of include model curves  <br> License requirements : drafting ("DRAFTING") */
            public: void SetIncludeModelCurves
            (
                bool include_model_curves /** include model curves */ 
            );
            /**Returns  the status of include model curves  <br> License requirements : None */
            ...
            (
                NXOpen::Preferences::HiddenLineSmallFeatureOption small_feature /** small feature */ 
            );
            ...
            (
                double small_features_tolerance /** small features tolerance */ 
            );
