...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT AfuDataConvertor
        {
            ...
            (
                NXOpen::CAE::AfuDataConvertor::Fft fft_type /** The way of FFT */,
                NXOpen::CAE::AfuData::OrdinateType in_complex_type /** Complex type of ordinate data before FFT */
            );
            ...
            (
                const std::vector<double> & in_x_values /** X values of the input data */,
                const std::vector<double> & in_y_values /** Y values of the input data */,
                std::vector<double> & x_values /** X values of the output data */,
                std::vector<double> & y_values /** Real part of Y values of the output data */
            );
            ...
            (
                const std::vector<double> & in_x_values /** X values of the input data */,
                const std::vector<double> & in_y_values /** Real part of Y values of the input data */,
                const std::vector<double> & in_z_values /** Imaginary part of Y values of the input data */,
                std::vector<double> & x_values /** X values of the output data */
            );
