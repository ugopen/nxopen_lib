    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT BendOptions : public TaggedObject
            {
                ...
                /** Sets the global neutral factor.  <br> License requirements : None */
                public: void SetGlobalNeutralFactor
                (
                    bool is_neutral_factor_global /** is neutral factor global */ 
                );
                /**Returns  the global neutral factor.  <br> License requirements : None */
