...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT RuleManager
    {
        ...
        struct AdoptableTypes
        {
            ...
            public: AdoptableTypes(int INIT_object_type /** object type */ , int INIT_object_subtype /** object subtype */ , int INIT_feature_type /** feature type */ ) :
        ...
        struct DebugInstance
        {
            ...
            public: DebugInstance(NXString INIT_part_name /** part of instance  */, NXString INIT_ref_chain /** name of instance  */, NXString INIT_nha_chain /** nha of instance   */, int INIT_n_rules /** number of rules   */, int INIT_rules0 /** index of rules[0] */) :
        ...
        struct DebugRule
        {
            ...
            public: DebugRule(NXString INIT_unit /** unit of rule    */, NXString INIT_name /** name of rule    */, NXString INIT_formula /** formula of rule */, NXString INIT_type /** type of value   */, NXString INIT_value /** value of rule   */) :
                Unit(INIT_unit),
                Name(INIT_name),
        ...
        /** Create or modify a dynamic rule.  <br> License requirements : ug_kf_author ("UG/Knowledge Fusion - Author") */
        ...
        (
            NXOpen::Session::UndoMarkId undo_mark /** If any update error occurs, the system 
        ...
        (
            NXOpen::NXObject * ug_object /** object to find name chain  */
        );
        ...
        (
            const NXString & rule_name /** Dynamic rule name */
        );
        ...
        (
            const NXString & reference_chain /** name chain for a dynamic rule */
        );
