...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT RotorBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::Body * rotor_solid /** rotor solid */ 
            );
            ...
            (
                NXOpen::CartesianCoordinateSystem * throat_orientation /** throat orientation */ 
            );
            ...
            (
                NXOpen::IReferenceAxis * press_direction /** press direction */ 
            );
            ...
            (
                const std::vector<NXOpen::ISurface *> & start_entries /** start entries */ 
            );
            ...
            (
                const std::vector<NXOpen::ISurface *> & end_entries /** end entries */ 
            );
