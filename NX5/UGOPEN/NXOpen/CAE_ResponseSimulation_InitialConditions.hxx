    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT InitialConditions : public NXObject
            {
                ...
                (
                    NXOpen::CAE::ResponseSimulation::InitialConditions::Type initial_condition_type /** initial condition type */ 
                );
                ...
                (
                    NXOpen::CAE::ResponseSimulation::InitialConditions::EntryMethod entry_method /** entry method */ 
                );
                ...
                (
                    const NXString & eef_file /** eef file */ 
                );
