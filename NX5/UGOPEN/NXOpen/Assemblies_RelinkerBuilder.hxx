    ...
    namespace Assemblies
    {
        ...
        class NXOPENCPPEXPORT RelinkerBuilder : public Builder
        {
            /** Represents the relink scope type of Relinker. 
                     Relink Scope defines the link destination part files. Relinker only searches part files defined in relink scope to get link/destination information for later reparenting*/
            ...
            /**Returns  the current relink scope.  <br> License requirements : None */
            public: NXOpen::Assemblies::RelinkerBuilder::LinkScope RelinkScope
            (
            );
            /**Sets  the current relink scope.  <br> License requirements : wave ("WAVE FUNCTIONALITY") */
            public: void SetRelinkScope
            (
                NXOpen::Assemblies::RelinkerBuilder::LinkScope relinkScope /** relinkscope */ 
            );
            /**Returns  a list of the selected component as relink scope. <br> License requirements : None */
