...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT PartCleanup : public TransientObject
    {
        ...
        /**Sets  the option that specifies what parts will be cleaned up when
            @link PartCleanup::DoCleanup PartCleanup::DoCleanup@endlink  is called.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link PartsToCleanup() PartsToCleanup@endlink instead.
        @deprecated
        */
        public: NXOpen::PartCleanup::CleanupParts GetPartsToCleanup
        (
        ) { return this->PartsToCleanup(); }
        /**Sets  the option that specifies what empty groups should be
            deleted.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link GroupsToDelete() GroupsToDelete@endlink instead.
        @deprecated
        */
        public: NXOpen::PartCleanup::DeleteGroups GetGroupsToDelete
        (
        ) { return this->GroupsToDelete(); }
        /**Sets  the option that specifies whether to turn off highlighting for
            all displayable objects in the displayed part.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link TurnOffHighlighting() TurnOffHighlighting@endlink instead.
        @deprecated
        */
        public: bool GetTurnOffHighlighting
        (
        ) { return this->TurnOffHighlighting(); }
        /**Sets  the option that specifies whether to delete all extraneous
            objects from the work part  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link DeleteUnusedObjects() DeleteUnusedObjects@endlink instead.
        @deprecated
        */
        public: bool GetDeleteUnusedObjects
        (
        ) { return this->DeleteUnusedObjects(); }
        /**Sets  the option that specifies whether to delete expressions that are
            not used in the part.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link DeleteUnusedExpressions() DeleteUnusedExpressions@endlink instead.
        @deprecated
        */
        public: bool GetDeleteUnusedExpressions
        (
        ) { return this->DeleteUnusedExpressions(); }
        /**Sets  the option that specifies whether to perform solid cleanup.  <br> License requirements : None */
        public: void SetCleanupFeatureData
        (
            bool option /** option */ 
        );
        /**Returns  the option that specifies whether to perform solid cleanup.  <br> License requirements : None */
        public: bool CleanupFeatureData
        (
        );
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link CleanupFeatureData() CleanupFeatureData@endlink instead.
        @deprecated
        */
        public: bool GetCleanupFeatureData
        (
        ) { return this->CleanupFeatureData(); }
        /**Sets  the option that specifies whether to fix off-plane sketch curves.  <br> License requirements : None */
        public: void SetFixOffplaneSketchCurves
        (
            bool option /** option */ 
        );
        /**Returns  the option that specifies whether to fix off-plane sketch curves.  <br> License requirements : None */
        public: bool FixOffplaneSketchCurves
        (
        );
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link FixOffplaneSketchCurves() FixOffplaneSketchCurves@endlink instead.
        @deprecated
        */
        public: bool GetFixOffplaneSketchCurves
        (
        ) { return this->FixOffplaneSketchCurves(); }
        /**Sets  the option that specifies whether to cleanup mating data.  <br> License requirements : None */
        public: void SetCleanupMatingData
        (
            bool option /** option */ 
        );
        /**Returns  the option that specifies whether to cleanup mating data.  <br> License requirements : None */
        public: bool CleanupMatingData
        (
        );
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link CleanupMatingData() CleanupMatingData@endlink instead.
        @deprecated
        */
        public: bool GetCleanupMatingData
        (
        ) { return this->CleanupMatingData(); }
        /**Sets  the option that specifies whether to delete or fix any corrupt
            internal CAM objects.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link CleanupCAMObjects() CleanupCAMObjects@endlink instead.
        @deprecated
        */
        public: bool GetCleanupCAMObjects
        (
        ) { return this->CleanupCAMObjects(); }
        /**Sets  the option that specifies whether to perform drafting cleanup.  <br> License requirements : None */
        public: void SetCleanupDraftingObjects
        (
            bool option /** option */ 
        );
        /**Returns  the option that specifies whether to perform drafting cleanup.  <br> License requirements : None */
        public: bool CleanupDraftingObjects
        (
        );
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link CleanupDraftingObjects() CleanupDraftingObjects@endlink instead.
        @deprecated
        */
        public: bool GetCleanupDraftingObjects
        (
        ) { return this->CleanupDraftingObjects(); }
        /**Sets  the option that specifies whether to remove character fonts
            that are not used in any drafting text in the current part.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link DeleteUnusedFonts() DeleteUnusedFonts@endlink instead.
        @deprecated
        */
        public: bool GetDeleteUnusedFonts
        (
        ) { return this->DeleteUnusedFonts(); }
        /**Sets  the option that specifies whether to remove assembly-specific
            geometry in component parts.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link ResetComponentDisplay() ResetComponentDisplay@endlink instead.
        @deprecated
        */
        public: NXOpen::PartCleanup::ResetComponentDisplayAction GetResetComponentDisplay
        (
        ) { return this->ResetComponentDisplay(); }
        /**Sets  the option that specifies whether to delete all spreadsheets from
            the part file.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link DeleteSpreadSheetData() DeleteSpreadSheetData@endlink instead.
        @deprecated
        */
        public: bool GetDeleteSpreadSheetData
        (
        ) { return this->DeleteSpreadSheetData(); }
        /**Sets  the option that specifies whether to delete Visual Editor data
            from the part file.  <br> License requirements : None */
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link DeleteVisualEditorData() DeleteVisualEditorData@endlink instead.
        @deprecated
        */
        public: bool GetDeleteVisualEditorData
        (
        ) { return this->DeleteVisualEditorData(); }
        /**Sets  the option that specifies whether or not to delete all inter-part links
                where one or more components in that inter-part link have been removed.  <br> License requirements : None */
        ...
        /** Actually performs the part cleanup operation according to the
            properties set on this object  <br> License requirements : None */
        public: void DoCleanup
        (
        );
        /** Resets all the properties back to the default values (i.e. everything
            turned off).  <br> License requirements : None */
        public: void Reset
        (
        );
    };
