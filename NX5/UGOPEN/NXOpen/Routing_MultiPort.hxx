...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT MultiPort : public Routing::Port, public virtual Routing::IAxisPort
        {
            ...
            (
                std::vector<NXString> & virtual_ports /** Virtual Ports names associated with this
            ...
            (
                std::vector<NXString> & virtual_ports /**  List of virtual port names to remove.
            ...
            (
                std::vector<NXString> & virtual_ports /**  List of virtual port names to add.
            ...
            (
                const std::vector<NXOpen::Routing::TerminalPort *> & terminal_ports /**  List of @link Routing::TerminalPort Routing::TerminalPort@endlink s to remove. */
            );
            ...
            (
                const std::vector<NXOpen::Routing::TerminalPort *> & terminal_ports /**  List of @link Routing::TerminalPort Routing::TerminalPort@endlink s to add. */
            );
