...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT SheetDraftingViewCollection : public TaggedObjectCollection
        {
            ...
            public: explicit SheetDraftingViewCollection(NXOpen::Drawings::DrawingSheet *owner): m_owner(owner)
            {
            }
            public: 
            ...
            (
                NXOpen::ModelingView * model_view /** Modeling View to be import as base view. */,
                const NXOpen::Point3d & drawing_reference_point /** view origin(location) */,
                double view_scale /** view scale */,
                bool inherit_clipping_boundry /** if true inherit xyclip */
            );
            ...
            (
                NXOpen::Drawings::DraftingView * parent_view /** Selected Parent view */,
                const NXOpen::Point3d & drawing_reference_point /** view origin(location) */
            );
            ...
            (
                NXOpen::Drawings::DraftingView * current_view /** View to be deleted */
            );
