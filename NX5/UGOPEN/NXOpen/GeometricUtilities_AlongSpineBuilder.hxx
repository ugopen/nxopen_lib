...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT AlongSpineBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            (
                NXOpen::GeometricUtilities::AlongSpineBuilder::RetainSpineOption spine_option /** spine option */ 
            );
            ...
            (
                std::vector<NXOpen::GeometricUtilities::OnPathDimWithValueBuilder *> & sp_points /** Array of SpinePointData Objects */
            );
