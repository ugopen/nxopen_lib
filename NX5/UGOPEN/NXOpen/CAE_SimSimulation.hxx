...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT SimSimulation : public NXObject
        {
            ...
            /** Creates a @link CAE::AutoBCBuilder CAE::AutoBCBuilder@endlink   @return  The AutoPairsBuilder object  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
