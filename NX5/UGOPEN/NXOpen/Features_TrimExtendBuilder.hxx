...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT TrimExtendBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::Features::TrimExtendBuilder::ExtensionMethods extension_method /** extension method */ 
            );
            ...
            (
                NXOpen::Features::TrimExtendBuilder::ArrowSideOptions arrow_side_option /** arrow side option */ 
            );
