...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Boundary Drive Method Builder  <br> This is an abstract class and cannot be instantiated. <br> */
        class NXOPENCPPEXPORT DmBndBuilder : public Builder
        {
            ...
            /** Get boundary intol outtol  @return  the boundary inside and outside tolerance values  <br> License requirements : None */
            public: std::vector<double> GetDmBndIntolOuttol
            (
            );
            /** Set boundary intol outtol  <br> License requirements : None */
            ...
            /**Returns  the Island Clean  <br> License requirements : None */
            public: bool IslandCleanupStatus
            (
            );
            /**Sets  the Island Clean  <br> License requirements : None */
            ...
            /**Returns  the Profile Pass Stock  <br> License requirements : None */
            public: double BndProfilePassStock
            (
            );
            /**Sets  the Profile Pass Stock  <br> License requirements : None */
            ...
            /**Returns  the Apply at Boundary  <br> License requirements : None */
            public: bool ApplyAtBoundary
            (
            );
            /**Sets  the Apply at Boundary  <br> License requirements : None */
            public: void SetApplyAtBoundary
            (
                bool applyBoundaryValue /** the Apply at Boundary */
            );
            /**Returns  the Apply at Part Surface  <br> License requirements : None */
            public: bool ApplyAtPartSurface
            (
            );
            /**Sets  the Apply at Part Surface  <br> License requirements : None */
            public: void SetApplyAtPartSurface
            (
                bool applyPartSurface /** the Apply at Part Surface */
            );
            /**Returns  the Custom Start  <br> License requirements : None */
            public: NXOpen::CAM::DmBndBuilder::BndCustomStartTypes BndCustomStart
            (
            );
            /**Sets  the Custom Start  <br> License requirements : None */
            public: void SetBndCustomStart
            (
                NXOpen::CAM::DmBndBuilder::BndCustomStartTypes customStartValue /** the Custom Start */
            );
            /**Returns  the Display Tool End  <br> License requirements : None */
            public: bool DispToolEnd
            (
            );
            /**Sets  the Display Tool End  <br> License requirements : None */
            public: void SetDispToolEnd
            (
                bool dispToolEndValue /** the Display Tool End */
            );
            /**Returns  the Display Contact  <br> License requirements : None */
            public: bool DispContact
            (
            );
            /**Sets  the Display Contact  <br> License requirements : None */
            public: void SetDispContact
            (
                bool dispContactdValue /** the Display Contact */
            );
            /**Returns  the Display Contact Normal  <br> License requirements : None */
            public: bool DispContactNormal
            (
            );
            /**Sets  the Display Contact Normal  <br> License requirements : None */
            public: void SetDispContactNormal
            (
                bool dispContactNormalValue /** the Display Contact Normal */
            );
            /**Returns  the Display Tool End Projection  <br> License requirements : None */
            public: bool DisToolEndProj
            (
            );
            /**Sets  the Display Tool End Projection  <br> License requirements : None */
            public: void SetDisToolEndProj
            (
                bool dispToolEndProjValue /** the Display Tool End Projection */
            );
            /**Returns  the cut angle ci builder  <br> License requirements : None */
            public: NXOpen::CAM::BndCutAngleCiBuilder * CutAngleCiBuilder
            (
            );
            /**Returns  the stepover ci builder  <br> License requirements : None */
            public: NXOpen::CAM::BndStepoverCiBuilder * StepoverCiBuilder
            (
            );
            /**Returns  the apply fillet  <br> License requirements : None */
            public: NXOpen::CAM::DmBndBuilder::ApplyFilletAtTypes ApplyFilletAt
            (
            );
            /**Sets  the apply fillet  <br> License requirements : None */
