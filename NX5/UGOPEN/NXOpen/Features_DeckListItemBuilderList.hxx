#ifndef NXOpen_FEATURES_DECKLISTITEMBUILDERLIST_HXX_INCLUDED
#define NXOpen_FEATURES_DECKLISTITEMBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Features_DeckListItemBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT DeckListItemBuilderList : public TaggedObject
        {
            ...
            public: void Append
            (
                const std::vector<NXOpen::Features::DeckListItemBuilder *> & objects /** items to append */
            );
            /** Appends an object to the list
                 <br> License requirements : None */
            public: void Append
            (
                NXOpen::Features::DeckListItemBuilder * object /** item to append */
            );
            ...
            /** Returns the list of entities stored.  This list may contain NULL entities.
             ...
             <br> License requirements : None */
            public: std::vector<NXOpen::Features::DeckListItemBuilder *> Vector
            (
            );
            ...
            (
                NXOpen::Features::DeckListItemBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index  <br> License requirements : None */
            public: NXOpen::Features::DeckListItemBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Features::DeckListItemBuilder * obj /** object to be removed from the list */
            );
            ...
            public: std::vector<NXOpen::Features::DeckListItemBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Features::DeckListItemBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Features::DeckListItemBuilder * object1 /** first item */,
                NXOpen::Features::DeckListItemBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Features::DeckListItemBuilder * object /** object to be inserted */
            );
        };
    }
}
