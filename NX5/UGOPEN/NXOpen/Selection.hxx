...
namespace NXOpen
{
    ...
    class NXOPENUICPPEXPORT Selection
    {
        ...
        struct MaskTriple
        {
         ...
         /** For a rectangle deselection, the @link  SelectionDescriptor::Deselction   SelectionDescriptor::Deselction @endlink , 
        	@link  SelectionDescriptor::Multiple   SelectionDescriptor::Multiple @endlink , @link  SelectionDescriptor::Rectangle   SelectionDescriptor::Rectangle @endlink  
        	bits would be set. 
        	For a name selection which selected one object, the @link  SelectionDescriptor::Selection   SelectionDescriptor::Selection @endlink , 
        	@link  SelectionDescriptor::Single   SelectionDescriptor::Single @endlink , and @link  SelectionDescriptor::NameSelection   SelectionDescriptor::NameSelection @endlink 
        	bits would be set.
        	If a reselect was done (an object is selected and the previous object selected is deselected), 
        	only the @link  SelectionDescriptor::Reselection   SelectionDescriptor::Reselection @endlink  bit is set.
        	The @link  SelectionDescriptor::Single   SelectionDescriptor::Single @endlink  and @link  SelectionDescriptor::Multiple   SelectionDescriptor::Multiple @endlink  
        	bits are not set for position.
        	The @link  SelectionDescriptor::Rectangle   SelectionDescriptor::Rectangle @endlink  bit is set for rectangle selection, 
        ...
        struct SelectionDescriptor
        {
            ...
            public: SelectionDescriptor(bool INIT_selection /** selection */ , bool INIT_deselection /** deselection */ , bool INIT_reselection /** reselection */ , bool INIT_single_selection /** single selection */ , bool INIT_multiple_selection /** multiple selection */ , bool INIT_single_position /** single position */ , bool INIT_rectangle_position /** rectangle position */ , bool INIT_name_selection /** name selection */ , bool INIT_rectangle /** rectangle */ ) :
        ...
        public: typedef NXOpen::Callback3<int, NXOpen::NXObject *, NXOpen::Selection::MaskTriple *, NXOpen::SelectionHandle *> FilterCallback;
        public: typedef NXOpen::Callback3<int, std::vector<NXOpen::NXObject *>, std::vector<NXOpen::NXObject *>, NXOpen::SelectionHandle *> SelectionCallback;
        ...
        (
            ...
            const std::vector<NXOpen::Selection::MaskTriple> & mask_array /** Mask triples */
        );
        ...
        (
            NXOpen::UserDefinedObjects::UserDefinedClass * udo_class /** The UserDefinedClass in question */
        );
        ...
        (
            NXOpen::UserDefinedObjects::UserDefinedClass * udo_class /** The UserDefinedClass in question */,
            bool selection_status /** Allow the selection of this UserDefinedClass */
        );
        ...
        (
            NXOpen::SelectionHandle * select /** Selection handle */,
            const std::vector<NXOpen::NXObject *> & objs /** Array of object tags */,
        ...
        (
            NXOpen::SelectionHandle * select /** Selection handle */,
            NXOpen::NXObject * object /** Object tag */
        );
        ...
        (
            ...
            bool highlight_flag /** If true, highlight objects */
        );
        ...
        /** Returns the view and absolute coordinates of the cursor position for the associated selection. 
                ...
                view = <JA_NULL> and the cursor position is undefined.
             @return   <br> License requirements : None */
