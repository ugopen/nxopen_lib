    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT SegmentManager
        {
            ...
            struct SubdivideOption
            {
                ...
                public: SubdivideOption(NXOpen::Routing::SegmentManager::SubdivideSpacing INIT_spacing_option /** Spacing Option */, double INIT_start_percent /** Start Percentage; 0 \<= Start percent \< End percent */, double INIT_end_percent /** End Percentage; start_percent \< end_percent \<= 100.0 */, double INIT_screen_point_percentage /** Screen Point Percentage*/, int INIT_direction /**Direction; If direction = 1, normal curve direction
                                                                                            else if direction = -1, reverse the sense of curve direction */, int INIT_number_of_segments /** Number of Segments */, double INIT_geometric_ratio /** Geometric Progression Ratio */, double INIT_incremental_arc_length /** Incremental Arc Length */, double INIT_chordal_tolerance /** Chordal Tolerance */) :
            ...
            (
                ...
                bool do_update /**Fires update if True */,
                std::vector<NXOpen::Routing::ISegment *> & new_segments /** resulting segments */
            );
            ...
            (
                ...
                const NXOpen::Routing::SegmentManager::SubdivideOption & subdivide_option /** subdivide option */ ,
                std::vector<NXOpen::Routing::ISegment *> & subdivide_segments /** resulting segments */
            );
            ...
            (
                NXOpen::DisplayableObject * start_object /** Start @link DisplayableObject DisplayableObject@endlink  of the segment, ideally it should be @link Routing::Port Routing::Port@endlink  */,
                NXOpen::DisplayableObject * end_object /** End @link DisplayableObject DisplayableObject@endlink  of the segment, ideally it should be @link Routing::Port Routing::Port@endlink  */,
                NXOpen::Routing::HealPath * heal_path /** heal path */ 
            );
            ...
            (
                NXOpen::Routing::Port * multi_port /** MultiPort whose terminals are modelled */,
                double cut_back_length /** Length of cut back path connected to multiport. */,
                const NXString & extension_string /** Length of terminal segments which extends parallel to terminal ports   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                bool override_charx /** if TRUE: extension_string determines all terminal extensions */,
                const std::vector<NXOpen::Routing::Port *> & terminal_ports /** Terminal ports from which terminals are modelled */
            );
            ...
            (
                NXOpen::Routing::Port * multi_port /** MultiPort whose terminals being unmodelled */,
                const std::vector<NXOpen::Routing::Port *> & terminal_ports /** Terminal ports being modelled */
            );
