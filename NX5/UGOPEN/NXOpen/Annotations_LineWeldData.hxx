...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT LineWeldData : public TransientObject
        {
            ...
            (
                NXOpen::Annotations::LineWeldSideData * arrow_side /** New arrow side line weld data */
            );
            ...
            (
                NXOpen::Annotations::LineWeldSideData * other_side /** New other side line weld data */
            );
            ...
            (
                bool center_symbol /** Flag indicating the weld symbol at the center of reference line */
            );
            ...
            (
                bool field_weld /** Flag indicating whether the weld is done at field site */
            );
            ...
            (
                bool staggered_display /** Flag indicating whether the staggered symbol is displayed */
            );
            ...
            (
                bool top_seam_display /** Flag indicating whether the top seam is displayed */
            );
            ...
            (
                bool side_seam /** Flag indicating whether the side seam is displayed */
            );
            ...
            (
                bool vertical_flip /** Flag indicating whether the side seam is vertically flipped */
            );
            ...
            (
                bool horizontal_flip /** Flag indicating whether the side seam is horizontally flipped */
            );
            ...
            (
                bool allround_symbol /** Flag indicating whether to display all around symbol */
            );
            ...
            (
                NXOpen::Drawings::DraftingView * top_seam_view /** New view for which top seam is to be created */
            );
            ...
            (
                NXOpen::Drawings::DraftingView * side_seam_view /** New view for which side seam is to be created */
            );
