...
namespace NXOpen
{
    ...
    namespace Features
    {
        /** Represents a collection of features  <br> To obtain an instance of this class, refer to @link BasePart BasePart@endlink  <br> */
        class NXOPENCPPEXPORT BaseFeatureCollection : public TaggedObjectCollection
        {
            ...
            (
                NXOpen::Features::Feature * trim_corner /** Not used as trim corner is non-associative operation */
            );
            ...
            (
                NXOpen::Features::Feature * divide_curve /** Not used as divide curve is non-associative operation */
            );
            ...
            (
                NXOpen::Features::AssociativeLine * associative_line /** @link Features::AssociativeLine Features::AssociativeLine@endlink  to be edited */
            );
            ...
            (
                NXOpen::Features::AssociativeArc * associative_arc /** @link Features::AssociativeArc Features::AssociativeArc@endlink  to be edited */
            );
            ...
            (
                NXOpen::Features::Feature * wavelink /** @link Features::Wavelink Features::Wavelink@endlink  to be edited */
            );
