...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT ScaleBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the scale type @link ScaleBuilder::Type ScaleBuilder::Type@endlink  <br> License requirements : None */
            public: NXOpen::Features::ScaleBuilder::Types Type
            (
            );
            /**Sets  the scale type @link ScaleBuilder::Type ScaleBuilder::Type@endlink  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetType
            (
            ...
            /**Returns  the vector as @link Vector Vector@endlink   <br> License requirements : None */
            public: NXOpen::Direction * Vector
            (
            );
            /**Sets  the vector as @link Vector Vector@endlink   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetVector
            (
                NXOpen::Direction * vector /** Set the reference Axis along which scaling has to be done */
            );
            /**Returns  the csys as @link Csys Csys@endlink   <br> License requirements : None */
            public: NXOpen::CoordinateSystem * Csys
            (
            );
            /**Sets  the csys as @link Csys Csys@endlink   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCsys
            (
