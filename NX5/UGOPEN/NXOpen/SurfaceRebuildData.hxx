...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT SurfaceRebuildData : public TransientObject
    {
        ...
        (
            NXOpen::SurfaceRebuildData::Type primary_rebuild_type /** primary rebuild type */ 
        );
        ...
        (
            NXOpen::SurfaceRebuildData::Type cross_rebuild_type /** cross rebuild type. */
        );
        /**Returns   <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
        ...
        (
            int num_tolerances /** num tolerances */ 
        );
    };
}
#undef EXPORTLIBRARY
