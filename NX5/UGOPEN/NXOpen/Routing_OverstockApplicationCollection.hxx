        ...
        class NXOPENCPPEXPORT OverstockApplicationCollection : public TaggedObjectCollection
        {
            ...
            (
                ...
                const std::vector<NXOpen::Routing::ISegment *> & segments /** Segments to cover with
                                                                                                                       overstock */,
                NXOpen::Routing::CharacteristicList * overstock_part /** overstock part */ ,
                NXOpen::Routing::StockType stock_type /** stock type */ ,
                NXOpen::Expression * wrap_value /** wrap value */ 
            );
            ...
            (
                ...
                const std::vector<NXOpen::Routing::Stock *> & stocks /** Stocks to cover with overstock */,
                NXOpen::Routing::CharacteristicList * overstock_part /** overstock part */ ,
                NXOpen::Routing::WrapApplicationType stock_wrap_type /** stock wrap type */ ,
                NXOpen::Expression * wrap_value /** wrap value */ 
            );
            ...
            (
                ...
                NXOpen::Expression * start_offset /** start offset */ ,
                NXOpen::Expression * end_offset /** end offset */ ,
                NXOpen::Expression * piece_length /** piece length */ ,
                NXOpen::Expression * gap /** gap */ ,
                NXOpen::Expression * number_of_pieces /** number of pieces */ ,
            ...
            (
                ...
                NXOpen::Point * end_point /** point at the end of the piece
                                                                                                             of overstock */,
                NXOpen::Routing::CharacteristicList * overstock_part /** overstock part */ ,
                NXOpen::Routing::WrapApplicationType stock_type /** stock type */ ,
                NXOpen::Expression * wrap_value /** wrap value */ 
            );
            ...
            (
                ...
                const std::vector<NXOpen::Routing::ISegment *> & segments /** Segments to cover
                                                                                                                               with overstock */,
                NXOpen::Point * defining_point /** defining point */ ,
            ...
            (
                ...
                const std::vector<NXOpen::Routing::Stock *> & stocks /** Stocks to cover with overstock */,
                NXOpen::Routing::CharacteristicList * overstock_part /** overstock part */ ,
                NXOpen::Routing::CharacteristicList * req_opt_charx_list /** List of optional and required characteristics to be
