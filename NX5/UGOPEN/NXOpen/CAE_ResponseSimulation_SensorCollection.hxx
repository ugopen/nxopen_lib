...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT SensorCollection : public TaggedObjectCollection
            {
                private: NXOpen::CAE::ResponseSimulation::Manager* m_owner;
                public: explicit SensorCollection(NXOpen::CAE::ResponseSimulation::Manager *owner): m_owner(owner)
                {
                }
                public: 
                ...
                /** Creates a sensor buider  @return    <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: NXOpen::CAE::ResponseSimulation::SensorBuilder * CreateSensorBuilder
                (
                    NXOpen::CAE::ResponseSimulation::Sensor * rs_sensor /** rs sensor */ 
                );
                /** Deletes an sensor  <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: void DeleteSensor
                (
                    NXOpen::CAE::ResponseSimulation::Sensor * rs_sensor /** rs sensor */ 
                );
                /** Finds an sensor with specified event name  @return    <br> License requirements : nx_response_anlys ("NX Response Analysis") */
