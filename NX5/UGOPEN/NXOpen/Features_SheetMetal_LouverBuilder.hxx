    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT LouverBuilder : public Features::FeatureBuilder
            {
                ...
                (
                    NXOpen::Features::SheetMetal::LouverBuilder::DepthSideOptions depth_side /** depth side */ 
                );
                ...
                (
                    NXOpen::Features::SheetMetal::LouverBuilder::SectionSideOptions section_side /** section side */ 
                );
                ...
                (
                    NXOpen::Features::SheetMetal::LouverBuilder::EndTypeOptions end_type /** end type */ 
                );
