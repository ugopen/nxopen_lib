...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT BlockFeatureBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::Vector3d* x_axis /** x axis */ ,
                NXOpen::Vector3d* y_axis /** y axis */ 
            );
            ...
            (
                const NXOpen::Vector3d & x_axis /** x axis */ ,
                const NXOpen::Vector3d & y_axis /** y axis */ 
            );
            ...
            (
                NXOpen::Features::Feature::BooleanType boolean_type /** boolean type */ 
            );
            /**Sets  the boolean operation for the block  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
