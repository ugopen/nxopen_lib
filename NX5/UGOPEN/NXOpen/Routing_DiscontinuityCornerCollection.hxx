    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT DiscontinuityCornerCollection : public TaggedObjectCollection
        {
            ...
            (
                ...
                NXOpen::Routing::ISegment * first_segment /** first segment to form discontinuity on, 
                                                            must be attached to the input RCP. */,
                NXOpen::Routing::ISegment * second_segment /** second segment to form discontinuity on, 
                                                            must be attached to the input RCP. */
            );
