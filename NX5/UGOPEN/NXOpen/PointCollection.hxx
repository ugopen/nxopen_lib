...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT PointCollection : public TaggedObjectCollection
    {
        ...
        /** 
            Creates a @link Point Point@endlink  at an angle along an @link ICurve ICurve@endlink .
             @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::Point * CreatePoint
        (
            NXOpen::ICurve * edge_curve /** edge curve */ ,
        ...
        public: NXOpen::Point * CreatePoint
        (
            NXOpen::IBaseCurve * edge_curve /** edge curve */ ,
            NXOpen::SmartObject::UpdateOption update_option /** update option */ 
        );
        /**
        ...
        public: NXOpen::Point * CreatePoint
        (
            NXOpen::IParameterizedSurface * spherical_face /** spherical face */ ,
            NXOpen::SmartObject::UpdateOption update_option /** update option */ 
        );
        /**
        ...
        public: NXOpen::Point * CreatePoint
        (
            NXOpen::Routing::IRoutePosition * route_position /** route position */ ,
        ...
        (
            ...
            NXOpen::Scalar * distance_percentage /** distance percentage */ ,
            NXOpen::SmartObject::UpdateOption update_option /** update option */ 
        );
