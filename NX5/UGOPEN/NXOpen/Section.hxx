        ...
        */
        ...
        (
            ...
            const NXOpen::Point3d & help_point /** This is used to determine which portion 
                                                    of the chain to use for creating section.*/,
            NXOpen::Section::Mode feature_mode /** Feature create or edit mode.*/,
            bool chain_within_feature /** True if chaining and discovery of intersection limits is to be restricted 
        ...
        public: void RemoveSingleSectionElement
        (
            NXOpen::Point * section_element /** The point that constructs the section */,
            NXOpen::Section::Mode feature_mode /** Feature create or edit mode*/
        );
        ...
        (
            const NXOpen::Point3d & point_specifying_chain /** The point should lie on the chain that is to be removed.*/,
