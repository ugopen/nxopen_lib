...
namespace NXOpen
{
    ...
    /**
        ...
        or selected sheets to a PDF document.
         <br> To create a new instance of this class, use @link PrintPDFCollection::CreatePrintPdfbuilder PrintPDFCollection::CreatePrintPdfbuilder@endlink  <br> */
    class NXOPENCPPEXPORT PrintPDFBuilder : public Builder
    {
        ...
        /**Returns  the dataset name to be used when Creating a New PDF document in a Teamcenter
                    environment.  The dataset name will not be used if Overwrite Existing PDF or
                    Append to Existing PDF are selected as the Action.  <br> License requirements : None */
