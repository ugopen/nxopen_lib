    ...
    namespace PDM
    {
        ...
        class NXOPENCPPEXPORT AlternateIdManager : public TransientObject
        {
            ...
            struct AlternateIdsData
            {
                ...
                public: AlternateIdsData(NXString INIT_alternate_item_id /** the new value for the alternate item ID  */, NXString INIT_alternate_rev_id /** the new value for the alternate Revision ID*/, NXString INIT_alternate_name /** the new value for the alternate Name*/, NXString INIT_alternate_description /** the new value for the alternate Description*/, bool INIT_modifiable /** the new value for the alternate for modifiable flag*/) :
            ...
            struct AssignAlternateRevData
            {
                ...
                public: AssignAlternateRevData(NXString INIT_alternate_rev_id /** the new value the alternate Revision ID  */, bool INIT_modifiable /** the new value of flag for revision modifiable */) :
                    AlternateRevId(INIT_alternate_rev_id),
                    Modifiable(INIT_modifiable)
                {
                }
            ...
            (
                const NXString & id_type /** the new value the ID type is to be set to   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & alternate_item_id /** the new value the alternate item ID is to be set to   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                NXString* alternate_item_id /** the newly generated alternate item ID value
                                                               that was set on this manager */,
                NXString* alternate_rev_id /** the newly generated alternate revision ID value
                                                               that was set on this manager */
            );
            ...
            (
                const NXString & alternate_rev_id /** the new value the alternate rev ID
            ...
            (
                const NXString & alternate_name /** the new value the alternate name is to be set to   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & alternate_description /** the new value the alternate description
                                                                     is to be set to   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                bool alternate_id_as_default_indentifier /** the new value the option
                                                                              is to be set to */
            );
            ...
            (
                const NXString & context /** the context   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & id_type /** the Id type   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
