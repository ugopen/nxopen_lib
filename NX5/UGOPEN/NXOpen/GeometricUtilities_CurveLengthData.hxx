...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT CurveLengthData : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            (
                NXOpen::GeometricUtilities::ExtensionMethod extension_method /** CurveLength extension method */
            );
            ...
            (
                NXOpen::GeometricUtilities::ExtensionDirection extension_direction /** CurveLength extension direction */
            );
            ...
            (
                NXOpen::GeometricUtilities::ExtensionSide extension_side /** CurveLength both ends */
            );
            ...
            (
                const NXString & start_distance /** Start distance   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & end_distance /** End distance   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & total_length /** Total Length   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
