...
namespace NXOpen
{
    ...
    namespace UIStyler
    {
        ...
        class NXOPENUICPPEXPORT IntegerItem : public UIStyler::StylerItem
        {
            ...
            (
                const NXString & str_label /** String to display on the left side of the text field.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
