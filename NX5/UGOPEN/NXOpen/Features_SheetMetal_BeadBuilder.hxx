    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT BeadBuilder : public Features::FeatureBuilder
            {
                ...
                (
                    const NXString & bead_height /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    const NXString & bead_width /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    const NXString & bead_angle /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    const NXString & bead_radius /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    const NXString & punched_width /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    const NXString & bead_die_radius /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                /**Returns  the Height side for the bead.
                             <br> 
                                ...
                                direction of the Section Normal (specified using the @link Features::SheetMetal::BeadBuilder::SectionFeatures::SheetMetal::BeadBuilder::Section @endlink and @link Features::SheetMetal::BeadBuilder::SetSectionFeatures::SheetMetal::BeadBuilder::SetSection @endlink ) then
                ...
                (
                    NXOpen::Features::SheetMetal::BeadBuilder::HeightSideOptions height_side /** height side */ 
                );
                ...
                (
                    NXOpen::Features::SheetMetal::BeadBuilder::EndTypeOptions bead_end_options /** bead end options */ 
                );
                ...
                (
                    NXOpen::Features::SheetMetal::BeadBuilder::CrossSectionTypeOptions cross_section_option /** cross section option */ 
                );
