...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT AnnotationManager
        {
            ...
            public: explicit AnnotationManager(NXOpen::Part *owner): m_owner(owner)
            {
            }
            public: 
            ...
            (
                std::vector<NXString> & text_lines /** text for the note */,
                ...
                NXOpen::Annotations::LetteringPreferences * lettering_preferences /** 
                                    lettering preferences.  If NULL, the global lettering preferences will be used */,
                NXOpen::Annotations::UserSymbolPreferences * user_symbol_preferences /** 
            ...
            (
                NXOpen::Annotations::LineWeld * drafting_aid /** the drafting aid to convert */,
                bool keep_drafting_aid /** whether to keep the drafting aid.  If false,
            ...
            (
                NXOpen::Annotations::SimpleDraftingAid * drafting_aid /** the drafting aid to convert */,
                bool keep_drafting_aid /** whether to keep the drafting aid.  If false,
                                                    the drafting aid will be deleted */
            );
            ...
            (
                std::vector<NXString> & text_lines /** text for the label */,
                const NXOpen::Point3d & origin /** origin for the label */,
                NXOpen::Annotations::LetteringPreferences * lettering_preferences /** 
                                    lettering preferences.  If NULL, the global lettering preferences will be used */,
                NXOpen::Annotations::UserSymbolPreferences * user_symbol_preferences /** 
                                    user symbol preferences.  If NULL, the scale and aspect ratio will be set to 1.0 */,
                NXOpen::Annotations::LineAndArrowPreferences * line_arrow_preferences /** 
            ...
            (
                std::vector<NXString> & text_lines /** text for the GDT */,
                ...
                NXOpen::Annotations::LineAndArrowPreferences * line_arrow_preferences /** 
                                    line and arrow preferences.  If NULL, the global line and arrow preferences will be used */,
                bool always_vertical /** always vertical */ ,
            ...
            /** <b>Deprecated</b>:<br>
            &nbsp;&nbsp;&nbsp;Use @link CurrentSbfFile() CurrentSbfFile@endlink instead.
            @deprecated
            */
            public: NXString GetCurrentSbfFile
            (
            ) { return this->CurrentSbfFile(); }
            ...
            (
                const NXString & symbol_name /** name of the symbol   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                double* symbol_width /** symbol width */ ,
                double* symbol_height /** symbol height */ 
            );
            ...
            (
                const std::vector<NXOpen::Annotations::Annotation *> & pmi_symbols /** List of PMI symbols, ordinarily from a geometry query */
            );
            ...
            private: NXOpen::Preferences::AnnotationPreferences *preferences;
            ...
            @deprecated
            */
            public: NXOpen::Preferences::AnnotationPreferences *GetPreferences() { return Preferences(); }
            private: NXOpen::Annotations::PmiFilterCollection *pmiFilters;
            /** PmiFilter collection */
            public: NXOpen::Annotations::PmiFilterCollection *PmiFilters()
            {
                return pmiFilters;
            }
            private: NXOpen::Annotations::FcfCollection *fcfs;
            /** Fcf collection */
            public: NXOpen::Annotations::FcfCollection *Fcfs()
            {
                return fcfs;
            }
            private: NXOpen::Annotations::GdtDatumCollection *datums;
            /** Datum collection */
            public: NXOpen::Annotations::GdtDatumCollection *Datums()
            {
                return datums;
            }
            private: NXOpen::Annotations::DatumTargetCollection *datumTargets;
            /** DatumTarget collection */
            public: NXOpen::Annotations::DatumTargetCollection *DatumTargets()
            {
                return datumTargets;
            }
            private: NXOpen::Annotations::WeldCollection *welds;
            /** Weld collection */
            public: NXOpen::Annotations::WeldCollection *Welds()
            {
                return welds;
            }
            private: NXOpen::Annotations::CustomSymbolCollection *customSymbols;
            /** CustomSymbol collection */
            public: NXOpen::Annotations::CustomSymbolCollection *CustomSymbols()
            {
                return customSymbols;
            }
            private: NXOpen::Annotations::IdSymbolCollection *idSymbols;
            /** IdSymbol collection */
            public: NXOpen::Annotations::IdSymbolCollection *IdSymbols()
            {
                return idSymbols;
            }
            private: NXOpen::Annotations::BusinessModifierCollection *businessModifiers;
            /** BusinessModifier collection */
            public: NXOpen::Annotations::BusinessModifierCollection *BusinessModifiers()
            {
                return businessModifiers;
            }
            private: NXOpen::Annotations::OrdinateMarginCollection *ordinateMargins;
            /** OrdinateMargin collection */
            public: NXOpen::Annotations::OrdinateMarginCollection *OrdinateMargins()
            {
                return ordinateMargins;
            }
            private: NXOpen::Annotations::DimensionSetCollection *dimensionSets;
