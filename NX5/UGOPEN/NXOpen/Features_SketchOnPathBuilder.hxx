    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT SketchOnPathBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::Point * thru_point /** thru point */ 
            );
            ...
            (
                int index_of_solution /** index to the possible solution, valid only when @link Features::SketchOnPathBuilder::ValueCount Features::SketchOnPathBuilder::ValueCount@endlink  \> 0 and must be between [1,@link Features::SketchOnPathBuilder::ValueCount Features::SketchOnPathBuilder::ValueCount@endlink ] */
            );
