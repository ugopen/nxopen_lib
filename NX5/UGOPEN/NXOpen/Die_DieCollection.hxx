...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT DieCollection : public TaggedObjectCollection
        {
            ...
            (
                NXOpen::Features::Feature * draw_die_punch /** Draw Die Punch to be edited, NULL if create. */
            );
            ...
            (
                NXOpen::Features::Feature * form_task /** Form Task to be edited, NULL if create. */
            );
            ...
            (
                NXOpen::Features::Feature * flange_task /** Flange Task to be edited, NULL if create */
            );
            ...
            (
                NXOpen::Features::Feature * trim_task /** Trim Task to be edited, NULL if create */
            );
            ...
            (
                NXOpen::Features::Feature * pierce_task /** Pierce Task to be edited, NULL if create */
            );
            ...
            (
                NXOpen::Features::Feature * steel_insert /** Steel Insert to be edited, NULL if create */
            );
            ...
            (
                NXOpen::Features::Feature * quick_binder_wrap /** the QuickBinderWrap feature to be edited, NULL if create */
            );
            ...
            (
                NXOpen::Features::Feature * face_sheet /** @link Die::FaceSheetBuilder Die::FaceSheetBuilder@endlink  to be edited */
            );
            ...
            (
                NXOpen::Features::Feature * null_feature /** must be NULL to create trim die */
            );
