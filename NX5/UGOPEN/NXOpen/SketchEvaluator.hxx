...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT SketchEvaluator : public TaggedObject
    {
        ...
        (
            bool create_curve_option /** create curve option */ 
        );
        ...
        (
            bool simplify_spline_option /** the simplify spline option */
        );
        ...
        (
            double path_location /** input path arc length percent to evaluate at. */
        );
