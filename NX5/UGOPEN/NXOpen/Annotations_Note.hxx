...
namespace NXOpen
{
    ...
    {
        class _NoteBuilder;
        /** Represents a Note  <br> To obtain an instance of this class use @link Annotations::NoteCollection Annotations::NoteCollection@endlink  <br> */
