    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT DDAMExcitationBuilder : public CAE::ResponseSimulation::ExcitationBuilder
            {
                ...
                (
                    NXOpen::CAE::ResponseSimulation::DDAMExcitation::LoadingType loading_type /** loading type */ 
                );
                ...
                (
                    NXOpen::CAE::ResponseSimulation::DDAMExcitation::ResponseType response_type /** response type */ 
                );
