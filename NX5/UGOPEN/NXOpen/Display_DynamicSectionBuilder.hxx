    ...
    namespace Display
    {
        ...
        /** Represents a Dynamic Section Builder used for creating sections. 
                ...
                interactive mode with visual feedback.
                 ...
                 <br> 
                When the builder is created, it reads the sectioning information from
                the view database. If no information is available, the defaults are
                used.
                 <br>  
                
                 <br> 
                See @link BasePart::CreateDynamicSectionBuilder BasePart::CreateDynamicSectionBuilder@endlink  
                 <br> 
                ...
                <b>Saving changes</b>
                 ...
                 <br> 
                @link Builder::Commit Builder::Commit@endlink  method will update the modeling 
                view database with dynamic sectioning parameters. It does not return
                any object for editing. 
                 <br> 
              ...
              <br> To create a new instance of this class, use @link BasePart::CreateDynamicSectionBuilder BasePart::CreateDynamicSectionBuilder@endlink  <br> */
        class NXOPENCPPEXPORT DynamicSectionBuilder : public Builder
        {
            ...
            /** Sets the the plane offset. When there are more than one
                        ...
                        not be allowed to cross-over the non-active clipping plane.
                         <br> 
                        If @link Display::DynamicSectionBuilder::LockPlanesDisplay::DynamicSectionBuilder::LockPlanes @endlink and @link Display::DynamicSectionBuilder::SetLockPlanesDisplay::DynamicSectionBuilder::SetLockPlanes @endlink 
            ...
            /** Sets the section origin. 
                        ...
                        of @link Display::DynamicSectionBuilder::LockPlanesDisplay::DynamicSectionBuilder::LockPlanes @endlink and @link Display::DynamicSectionBuilder::SetLockPlanesDisplay::DynamicSectionBuilder::SetLockPlanes @endlink .
                         <br> 
            ...
            /**Returns  the modeling view for which sectioning is being done.
                         <br> 
                        The view being set must be the current working view. This is provided
            ...
            /**Sets  the modeling view for which sectioning is being done.
                         <br> 
                        The view being set must be the current working view. This is provided
                        to handle scenarios when the working view is changed when sectioning
                        is in progress. It is the responsibility of user to save pending
            ...
            /** Creates a plane along X direction.
                        ...
                        @link Display::DynamicSectionBuilder::CsysTypeDisplay::DynamicSectionBuilder::CsysType @endlink and @link Display::DynamicSectionBuilder::SetCsysTypeDisplay::DynamicSectionBuilder::SetCsysType @endlink .                
                         <br> 
                         <br> 
            ...
            (
                const NXString & group_name /** Name of the group containing curves   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
