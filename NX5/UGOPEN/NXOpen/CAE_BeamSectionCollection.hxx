...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT BeamSectionCollection : public TaggedObjectCollection
        {
            ...
            public: explicit BeamSectionCollection(NXOpen::CAE::FEModel *owner): m_owner(owner)
            {
            }
            public: 
            ...
            (
                const NXString & journal_identifier /** Beam Section name   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
