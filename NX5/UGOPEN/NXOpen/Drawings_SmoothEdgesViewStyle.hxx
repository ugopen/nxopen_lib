...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        /** Represents set of Smooth Edges View Style Preferences applicable to drafting views.  <br> To obtain an instance of this class, refer to @link Drawings::ViewStyle Drawings::ViewStyle@endlink  <br> */
        class NXOPENCPPEXPORT SmoothEdgesViewStyle: public virtual Preferences::ISmoothEdgesViewPreferences
        {
            private: NXOpen::Drawings::ViewStyle* m_owner;
            public: explicit SmoothEdgesViewStyle(NXOpen::Drawings::ViewStyle *owner): m_owner(owner)
            {
            }
            public: 
            ...
            (
                NXOpen::Preferences::Font smooth_edge_font /** smooth edge font */ 
            );
            ...
            (
                NXOpen::Preferences::Width smooth_edge_width /** smooth edge width */ 
            );
            ...
            (
                bool smooth_edge_end_gaps /** smooth edge end gaps */ 
            );
            ...
            (
                double smooth_edge_end_gaps_data /** smooth edge end gaps data */ 
            );
