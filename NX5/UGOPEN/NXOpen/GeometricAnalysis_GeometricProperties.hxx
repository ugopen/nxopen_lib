    ...
    namespace GeometricAnalysis
    {
        ...
        class NXOPENCPPEXPORT GeometricProperties : public Builder
        {
            ...
            struct Face
            {
                ...
                public: Face(double INIT_u_paramater /** U parameter */, double INIT_v_paramater /** V parameter */, NXOpen::Point3d INIT_position_in_wcs /**   XYZ Position in Work Part coordinates*/, NXOpen::Vector3d INIT_u_derivative_in_wcs /**   Derivative Vector in U direction – Work Part  Coordinates*/, NXOpen::Vector3d INIT_v_derivative_in_wcs /**   Derivative Vector in V direction – Work Part  Coordinates*/, NXOpen::Vector3d INIT_normal_in_wcs /**  Unitized Face Normal – Work Part Coordinates*/, NXOpen::Point3d INIT_position /** XYZ Position */, NXOpen::Vector3d INIT_u_derivative /**   Derivative Vector in U direction –  Root Part Coordinates*/, NXOpen::Vector3d INIT_v_derivative /**   Derivative Vector in V direction – Root Part  Coordinates*/, NXOpen::Vector3d INIT_normal /**  Unitized Face Normal – Root Part Coordinates*/, double INIT_inv_of_min_radius_of_curvature /** Inverse of Minumum  Radius of
                                                    Curvature, 1/(minimum radius of curvature) */, double INIT_inv_of_max_radius_of_curvature /** Inverse of Maximum Radius of
            ...
            struct Edge
            {
                ...
                public: Edge(double INIT_parameter_percentage /** Curve Parameter Percentage */, double INIT_parameter /**  Curve Parameter*/, NXOpen::Point3d INIT_position_in_wcs /**   XYZ Position in Work Part coordinates*/, NXOpen::Point3d INIT_position /**   XYZ Position in Root Part coordinates*/, NXOpen::Vector3d INIT_tangent_in_wcs /**   Tangent Vector in Work Part coordinates*/, NXOpen::Vector3d INIT_tangent /**   Tangent Vector in Root Part coordinates*/, NXOpen::Vector3d INIT_normal_in_wcs /**   Curve Normal in Work Part coordinates*/, NXOpen::Vector3d INIT_normal /**   Curve Normal in Root Part coordinates*/, NXOpen::Vector3d INIT_binormal_in_wcs /**  Curve Binormal in Work Part coordinates*/, NXOpen::Vector3d INIT_binormal /**  Curve Binormal in Root Part coordinates*/, double INIT_torsion /**   Curve Torsion*/, double INIT_curvature /**    Curvature of the Curve*/) :
            ...
            struct CaeFace
            {
                ...
                public: CaeFace(NXOpen::Vector3d INIT_closest_point /** closest point on face in Root Part Coordinates*/, double INIT_u_parameter /**  u parameter of the closest point in Root Part Coordinates*/, double INIT_v_parameter /**  v parameter of the closest point in Root Part Coordinates*/, NXOpen::Vector3d INIT_normal /**  normal at the closest point in Root Part Coordinates*/, NXOpen::Point3d INIT_closest_point_in_wcs /**  closest point in Work Part Coordinates*/, NXOpen::Vector3d INIT_normal_in_wcs /** normal in Work Part Coordinates*/, NXOpen::Vector3d INIT_u_derivative /**  Derivative in U, Root Part Coordinates*/, NXOpen::Vector3d INIT_v_derivative /**  Derivative in V, Root Part Coordinates*/, NXOpen::Vector3d INIT_u_derivative_in_wcs /**  Derivative in U in Work Part Coordinates*/, NXOpen::Vector3d INIT_v_derivative_in_wcs /**  Derivative in V in Work Part Coordinates*/) :
            ...
            struct CaeCurve
            {
                ...
                public: CaeCurve(double INIT_arc_length_parameter /** ArcLength parametrization*/, double INIT_unit_arc_length_parameter /** UnitArcLength parametrization*/, NXOpen::Point3d INIT_closest_point_in_wcs /** closest point on curve in Work Part Coordinates*/, NXOpen::Vector3d INIT_normal_in_wcs /** normal of closest point in Work Part Coordinates*/, NXOpen::Vector3d INIT_tangent_in_wcs /** tangent of closest point in Work Part Coordinates*/, NXOpen::Vector3d INIT_tangent /** tangent of closest point in Root Part Coordinates*/, NXOpen::Vector3d INIT_normal /** normal of closest point in Root Part Coordinates*/, NXOpen::Point3d INIT_closest_point /** closest point on curve in Root Part Coordinates*/) :
            ...
            (
                NXOpen::GeometricAnalysis::GeometricProperties::OutputType output_method /** output method */ 
            );
            ...
            /** Displays the local properties of
                           <ja_member>ObjectsForAnalysis</ja_member> at the given point in 
