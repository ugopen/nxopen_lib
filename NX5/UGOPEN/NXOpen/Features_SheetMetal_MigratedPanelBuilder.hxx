    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT MigratedPanelBuilder : public Features::FeatureBuilder
            {
                ...
                (
                    NXOpen::Face * stationary_face /** The stationary face */
                );
                /**Returns 
                ...
                (
                    NXOpen::Face * bend_face /** The bend face */
                );
                /**Returns 
                ...
                (
                    NXOpen::Face * move_face /** The moving face */
                );
                /**Returns 
                ...
                (
                    NXOpen::Body * sheet_metal_body /** Parent Sheet Metal Body */
                );
                /**Returns 
                ...
                (
                    const NXString & bend_radius /** Gap tolerance */
                );
                /**Returns 
                ...
                (
                    const NXString & gap_tolerance /** Gap tolerance */
                );
                /**Returns 
                ...
                (
                    const NXString & cutoff_angle /** Cutoff angle */
                );
                /**Returns 
                ...
                (
                    bool along_face_normal /** Along Face Normal flag */
                );
