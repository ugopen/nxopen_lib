...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENUICPPEXPORT SessionVisualizationShade
        {
            ...
            /** <b>Deprecated</b>:<br>
            &nbsp;&nbsp;&nbsp;Use @link ShowFacetEdges() ShowFacetEdges@endlink instead.
            @deprecated
            */
            public: bool GetShowFacetEdges
            (
            ) { return this->ShowFacetEdges(); }
            ...
            /** <b>Deprecated</b>:<br>
            &nbsp;&nbsp;&nbsp;Use @link EdgesEmphasis() EdgesEmphasis@endlink instead.
            @deprecated
            */
            public: bool GetEdgesEmphasis
            (
            ) { return this->EdgesEmphasis(); }
            ...
            (
                bool edges_emphasis /** Edge Emphasis Option to be set or not */
            );
            ...
            (
                bool lwrt_studio_display /** Option to be set or not */
            );
            ...
            (
                bool update_env_option /** Send TRUE if env cube updation is required. Else send FALSE */
            );
