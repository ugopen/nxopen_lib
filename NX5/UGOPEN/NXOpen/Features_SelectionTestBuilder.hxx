...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Builder for the SelectionTest class  <br> To create a new instance of this class, use @link DebugSession::CreateSelectionTestBuilder DebugSession::CreateSelectionTestBuilder@endlink  <br> */
