...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT SolidTrackingBuilder : public CAM::TrackpointBuilder
        {
            ...
            (
                double xoff_value /** the xoff value */
            );
            ...
            (
                double yoff_value /** the yoff value */
            );
            ...
            (
                double zoff_value /** the zoff value */
            );
            /**Returns  the location tag  <br> License requirements : None */
            public: NXOpen::NXObject * Location
            (
            );
            /**Sets  the location tag  <br> License requirements : None */
            public: void SetLocation
            (
                NXOpen::NXObject * tp_location /** the tracking point tag */
            );
        };
    }
}
