...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT ToolBuilder : public CAM::ParamBuilder
        {
            ...
            (
                bool tl_manual_tool_change_value /**  the manual tool change value */
            );
            ...
            (
                const NXString & tl_ctlg_num_value /**  the catalog number value */
            );
            ...
            (
                const NXString & tl_description_value /**  the cutter  description  value */
            );
