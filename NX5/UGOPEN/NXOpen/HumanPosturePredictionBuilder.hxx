...
namespace NXOpen
{
    ...
    /** Represents a Human Posture Prediction Builder.  <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateHumanPosturePredictionBuilder Features::FeatureCollection::CreateHumanPosturePredictionBuilder@endlink  <br> */
    class NXOPENCPPEXPORT HumanPosturePredictionBuilder : public Builder
    {
        /** */
        ...
        /**Returns  the name of posture prediction, it is an internal name for posture prediction, and it does not display on
                user interface  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /**Returns  the flag of using vehicle package data, if true, use data from vehicle package, otherwize use
                customer defined vehicle data  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        (
            bool use_vehicle_packaging_data /** the flag of using vehicle package data */
        );
        /**Returns  the prediction method: aspect or pre_aspect  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::HumanPosturePredictionBuilder::PredictionMethodType PredictionMethod
        (
        );
        /**Sets  the prediction method: aspect or pre_aspect  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetPredictionMethod
        (
            NXOpen::HumanPosturePredictionBuilder::PredictionMethodType prediction_method_type /** the prediction method type */
        );
        /**Returns  the show report status, if true, then show the report of result  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: bool ShowReport
        (
        );
        /**Sets  the show report status, if true, then show the report of result  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetShowReport
        (
            bool show_report /** the show report status */
        );
        /**Returns  the Car Coordinate System  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::CoordinateSystem * CarCsys
        (
        );
        /** Create the Car Coordinate System, only one Car Coordinate System is allowed in a part or an assembly  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void CreateCarCsys
        (
            const NXOpen::Point3d & car_csys_origin /** the origin of Car Coordinate System */,
            const NXOpen::Matrix3x3 & car_csys_matrix /** the matrix of Car Coordinate System */
        );
        /**Returns  the vehicle packaging data name, it is invalid when using customer defined vehicle data.  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXString VehiclePackagingDataName
        (
        );
        /**Sets  the vehicle packaging data name, it is invalid when using customer defined vehicle data.  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetVehiclePackagingDataName
        (
            const NXString & vehicle_packaging_data_name /** the vehicle packaging data name */
        );
        /**Returns  the vehicle type: Class A or Class B  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::HumanPosturePredictionBuilder::VehicleType Vehicle
        (
        );
        /**Sets  the vehicle type: Class A or Class B  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetVehicle
        (
            NXOpen::HumanPosturePredictionBuilder::VehicleType vehicle_type /** the vehicle type */
        );
        /**Returns  the occupant type: driver, front passenger or rear passenger. The occupant type should be driver
                when vehicle type is Class B  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        (
            NXOpen::HumanPosturePredictionBuilder::OccupantType occupant_type /** the occupant type */
        );
        /**Returns  the transmission type: automatic or manual. The transmission type should be manual when vehicle
                type is Class B  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        (
            NXOpen::HumanPosturePredictionBuilder::TransmissionType transmission_type /** the transmission type */
        );
        /**Returns  the seat type: fixed seat or adjustable seat  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::HumanPosturePredictionBuilder::SeatType Seat
        (
        );
        /**Sets  the seat type: fixed seat or adjustable seat  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetSeat
        (
            NXOpen::HumanPosturePredictionBuilder::SeatType seat_type /** the seat type */
        );
        /**Returns  the cushion firmness type: soft cushion, medium cushion or firm cushion  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::HumanPosturePredictionBuilder::CushionFirmnessType CushionFirmness
        (
        );
        /**Sets  the cushion firmness type: soft cushion, medium cushion or firm cushion  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetCushionFirmness
        (
            NXOpen::HumanPosturePredictionBuilder::CushionFirmnessType cushion_firmness_type /** the cushion firmness type */
        );
        /**Returns  the lumbar prominence L81 of seat data, it should be set for Class A driver, Class A front passenger
                and Class A rear passenger  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /**Returns  the seat track X range lower limit TL1 of seat data, it should be set for Class A driver, Class A front passenger
                and Class B driver  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /** Get the SgRP point, it is NULL if SgRP is set by coordinates  @return  the SgRP point  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::Point * GetSgrpPoint
        (
        );
        /** Set the SgRP point by an existing point  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetSgrpPoint
        (
            NXOpen::Point * sgrp_point /** the SgRP point */
        );
        /** Get the SgRP point coordinates, L31, W20, H70. The coordinates are NULL if SgRP is
                set by an existing point  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void GetSgrpCoordinates
        (
            NXString* point_x /** the length coordinates L31 expression */,
            NXString* point_y /** the width  coordinates W20 expression */,
            NXString* point_z /** the height coordinates H70 expression */
        );
        /** Set the SgRP point by coordinates, L31, W20, H70  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetSgrpCoordinates
        (
            const NXString & point_x /** the length coordinates L31 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & point_y /** the width  coordinates W20 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & point_z /** the height coordinates H70 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Get the AHP point, it is NULL if AHP is set by coordinates  @return  the AHP point  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::Point * GetAhpPoint
        (
        );
        /** Set the AHP point by an existing point  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetAhpPoint
        (
            NXOpen::Point * ahp_point /** the AHP point */
        );
        /** Get the AHP point coordinates, L8, W8, H8. The coordinates are NULL if AHP is
                set by an existing point  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void GetAhpCoordinates
        (
            NXString* point_x /** the length coordinates L8 expression */,
            NXString* point_y /** the width  coordinates W8 expression */,
            NXString* point_z /** the height coordinates H8 expression */
        );
        /** Set the AHP point by coordinates, L8, W8, H8  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetAhpCoordinates
        (
            const NXString & point_x /** the length coordinates L8 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & point_y /** the width  coordinates W8 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & point_z /** the height coordinates H8 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Get the steering wheel and pedal types of hand foot data  @return  the type of steering wheel or pedal  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::HumanPosturePredictionBuilder::SteeringWheelPedalType GetHandFootDataType
        (
            NXOpen::HumanData::HandFootType hand_foot /** Indicates Human hand or foot        */,
        ...
        /** Set the steering wheel and pedal types of hand foot data. The steering wheel and pedal types of both hands
                ...
                For example, you can set solid - solid, curve - curve, sae - sae, csys - csys, any type - csys for both hands of a driver.  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetHandFootDataType
        (
            NXOpen::HumanData::HandFootType hand_foot /** Indicates Human hand or foot        */,
            NXOpen::HumanData::SideType side /** Indicates Human left or right       */,
            NXOpen::HumanPosturePredictionBuilder::SteeringWheelPedalType steering_wheel_pedal_type /** the type of steering wheel or pedal */
        );
        /** Get the solid bodies of steering wheel or pedal of hand foot data, it will return NULL if the steering wheel pedal type 
                is not Solid  @return  the solid bodies of steeing wheel or pedal  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: std::vector<NXOpen::Body *> GetHandFootDataSolids
        (
            NXOpen::HumanData::HandFootType hand_foot /** Indicates Human hand or foot  */,
            NXOpen::HumanData::SideType side /** Indicates Human left or right */
        );
        /** Set the solid bodies of steering wheel or pedal of hand foot data, the steering wheel pedal type should be set as Solid  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /** Get the curves or edges of steering wheel or pedal of hand foot data, it will return NULL if the steering wheel pedal type is
                not Curve  @return  the curves of steeing wheel or pedal  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /** Set the curves or edges of steering wheel or pedal of hand foot data, the steering wheel pedal type should
                be set as Curve and the input curves should be closed  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /** Get the steering wheel SAE Data, L11, H17, W9 and A18 for both hand, it will return NULL if the steering
                wheel pedal type is not Sae  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /** Set the steering wheel SAE Data, L11, H17, W9 and A18 of hand data, the steering wheel pedal type
                should be set as Sae  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetHandDataSae
        (
            NXOpen::HumanData::SideType side /** Indicates Human left or right                      */,
            const NXString & L11 /** AHP to steering wheel center length L11 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & H17 /** AHP to steering wheel center height H17 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & W9 /** the steering wheel angle A18 expression              <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & A18 /** the steering wheel outside diameter W9 expression    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Get the pedal Sae data of foot, the steering wheel pedal type should be set as Sae  @return  Left Foot Angle or Pedal Plane Angle A47 expression  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXString GetFootDataSae
        (
            NXOpen::HumanData::SideType side /** Indicates Human left or right                       */
        );
        /** Set the pedal Sae data of foot data, the steering wheel pedal type should be set as Sae  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void SetFootDataSae
        (
            NXOpen::HumanData::SideType side /** Indicates Human left or right                       */,
            const NXString & pedal_angle /** Left Foot Angle or Pedal Plane Angle A47 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Get the Csys of hand foot. Calculate method should be called to compute Csys first for solid, curve or sae 
                before get it  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /** Set the Csys of hand foot, the hand foot csys should be on solid, curve or not conflict with
                SAE data related to its steering wheel and pedal type.  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /** Compute the Csys of both hands according to solid, curve or sae data. The left hand and right
                hand are on the 10 / 2 position of the steering wheel.  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: void ComputeHandCsys
        (
            NXOpen::Point3d* left_hand_position /** the position of left hand     */,
            NXOpen::Matrix3x3* left_hand_orientation /** the orientation of left hand  */,
            NXOpen::Point3d* right_hand_position /** the position of right hand    */,
            NXOpen::Matrix3x3* right_hand_orientation /** the orientation of right hand */
        );
        /** Compute the Foot Csys according to solid, curve or sae data. The right foot is on the position of AHP  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        ...
        /**Returns  the human for posture prediction  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
        public: NXOpen::Features::Human * Human
        (
        );
        /**Sets  the human for posture prediction  <br> License requirements : solid_modeling ("SOLIDS MODELING"), ug_human ("Human Modelling") */
