...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT ModelingViewCollection : public TaggedObjectCollection
    {
        ...
        (
            const NXString & journal_identifier /** Identifier of the modeling view to be found   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
