...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT HoleParentBuilder : public Features::FeatureBuilder
        {
            ...
            (
                double counter_bore_diameter /** counter bore diameter */ 
            );
            ...
            (
                double drop_thru_diameter /** drop thru diameter */ 
            );
            ...
            (
                double pad_diameter /** pad diameter */ 
            );
            ...
            (
                bool create_with_pad /** create with pad */ 
            );
