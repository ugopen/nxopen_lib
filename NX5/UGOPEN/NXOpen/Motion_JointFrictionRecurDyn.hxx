...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT JointFrictionRecurDyn : public TaggedObject
        {
            ...
            (
                NXOpen::Motion::JointFrictionRecurDyn::FrictionYokeType yoke_type /** yoke type */ 
            );
            ...
            (
                NXOpen::Motion::JointFrictionRecurDyn::FrictionOverlapDelta overlap_delta /** overlap delta */ 
            );
            /**Returns  max friction force  <br> License requirements : mechanisms ("MECHANISMS") */
            public: double MaxFrictionForce
            (
            );
            /**Sets  max friction force  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMaxFrictionForce
            (
                double max_friction_force /** max friction force */ 
            );
            ...
            (
                bool enable_force /** enable force */ 
            );
            /**Returns  max friction torque  <br> License requirements : mechanisms ("MECHANISMS") */
            public: double MaxFrictionTorque
            (
            );
            /**Sets  max friction torque  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMaxFrictionTorque
            (
                double max_friction_torque /** max friction torque */ 
            );
