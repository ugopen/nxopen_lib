...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT UnitsFormatPreferences : public TransientObject
        {
            ...
            (
                NXOpen::Annotations::DimensionTextFormat text_format /** text format */ 
            );
            ...
            (
                NXOpen::Annotations::DecimalPointCharacter decimal_point_character /** decimal point character */ 
            );
            ...
            (
                bool display_trailing_zeros /** display trailing zeros */ 
            );
            ...
            (
                bool convert_primary_tolerance_to_dual_unit /** convert primary tolerance to dual unit */ 
            );
            ...
            (
                bool dimension_leading_zero /** dimension leading zero */ 
            );
            /**Returns  Returns the tolerance leading zero display property  <br> License requirements : None */
            public: bool ToleranceLeadingZero
            (
            );
            /**Sets  Returns the tolerance leading zero display property  <br> License requirements : None */
            public: void SetToleranceLeadingZero
            (
                bool tolerance_leading_zero /** tolerance leading zero */ 
            );
        };
    }
}
