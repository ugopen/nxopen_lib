...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        class NXOPENCPPEXPORT SessionSettings : public TransientObject
        {
            ...
            (
                bool app_logging_on /** app logging on */ 
            );
            ...
            (
                bool journaling_on /** journaling on */ 
            );
            ...
            (
                bool admin_logging_on /** admin logging on */ 
            );
            ...
            (
                bool security_logging_on /** security logging on */ 
            );
            ...
            (
                bool admin_bypass_on /** admin bypass on */ 
            );
