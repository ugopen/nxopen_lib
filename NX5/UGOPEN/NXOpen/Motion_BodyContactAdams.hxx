...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT BodyContactAdams : public NXObject
        {
            ...
            (
                NXOpen::Motion::BodyContactAdams::ForceModel force_model /** force model */ 
            );
            ...
            (
                double restitution_coefficent /** restitution coefficent */ 
            );
            ...
            (
                NXOpen::Motion::BodyContactAdams::CoulombFriction coulomb_friction /** coulomb friction */ 
            );
