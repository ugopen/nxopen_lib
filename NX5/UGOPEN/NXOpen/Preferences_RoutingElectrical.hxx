...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT RoutingElectrical
        {
            ...
            (
                NXOpen::Preferences::RoutingElectrical::CreateTerminalsType create_terminals_option /** create terminals option */ 
            );
            ...
            (
                bool terminal_segment_solid /** terminal segment solid */ 
            );
            ...
            (
                bool override_harness_name /** override harness name */ 
            );
            ...
            (
                bool is_pin_level_route /** is pin level route */ 
            );
            ...
            (
                bool report_route_errors /** report route errors */ 
            );
            ...
            (
                bool highlight_wire /** highlight wire */ 
            );
            ...
            (
                NXOpen::Preferences::RoutingElectrical::ComponentMatchType component_match_method /** component match method */ 
            );
            ...
            (
                const NXString & default_jumper_length /** default jumper length */ 
            );
            ...
            (
                bool standalone_filter_format_file /** standalone filter format file */ 
            );
            ...
            (
                bool export_format /** export format */ 
            );
            ...
            (
                double segment_length_tolerance /** segment length tolerance */ 
            );
