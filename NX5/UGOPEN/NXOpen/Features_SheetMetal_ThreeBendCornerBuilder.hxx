        ...
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT ThreeBendCornerBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the corner treatment type.
                             <br> 
                                The @link Features::SheetMetal::ThreeBendCornerBuilder::TreatmentTypeFeatures::SheetMetal::ThreeBendCornerBuilder::TreatmentType @endlink and @link Features::SheetMetal::ThreeBendCornerBuilder::SetTreatmentTypeFeatures::SheetMetal::ThreeBendCornerBuilder::SetTreatmentType @endlink ) specifies how the 
