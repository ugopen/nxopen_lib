...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        /** Represents set of Section View Style Preferences applicable to drafting views.  <br> To obtain an instance of this class, refer to @link Drawings::ViewStyle Drawings::ViewStyle@endlink  <br> */
        class NXOPENCPPEXPORT SectionViewStyle: public virtual Preferences::ISectionViewPreferences
        {
            private: NXOpen::Drawings::ViewStyle* m_owner;
            public: explicit SectionViewStyle(NXOpen::Drawings::ViewStyle *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /**Sets  the status of hidden line hatching. Controls whether hatching for a Break-Out
            		    ...
            		    Works when @link SectionViewStyle::CrossHatchSectionViewStyle::CrossHatch @endlink and @link SectionViewStyle::SetCrossHatchSectionViewStyle::SetCrossHatch @endlink  is True.  <br> 
                      <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Sets  the value of crosshatch adjacency tolarance. Controls the crosshatching angle of adjacent 
            		    ...
            		    Works when @link SectionViewStyle::AssemblyCrossHatchingSectionViewStyle::AssemblyCrossHatching @endlink and @link SectionViewStyle::SetAssemblyCrossHatchingSectionViewStyle::SetAssemblyCrossHatching @endlink  is True. <br> 
            		  <br> License requirements : drafting ("DRAFTING") */
