...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT DrawingSheetBuilder : public Builder
        {
            ...
            (
                NXOpen::Drawings::DrawingSheetBuilder::SheetStandardMetricScale metric_scale /** the standard Metric drawing scale */
            );
            ...
            (
                NXOpen::Drawings::DrawingSheetBuilder::SheetStandardEnglishScale english_scale /** the standard English drawing scale */
            );
            ...
            (
                double scale_numerator /** scale numerator */ 
            );
            ...
            (
                double scale_denominator /** the denominator of a custom scale */
            );
            ...
            (
                NXOpen::Drawings::DrawingSheetBuilder::SheetProjectionAngle projection_angle /** the projection_angle option */
            );
            ...
            (
                bool auto_start_base_view /** the add base view automatic start toggle */
            );
        };
    }
}
