...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT AfuHeaderId : public TransientObject
        {
            ...
            /** Free the AFU Header Id transient object memory  <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            ...
            (
                int reference_id /** the ID of reference element or node */
            );
            ...
            (
                int response_id /** the ID of response element or node */
            );
            ...
            (
                int load_case /** the load case of AFU Header Id */
            );
            ...
            (
                const NXString & id_line1 /** the id line1 of AFU Header Id.
            ...
            (
                const NXString & id_line2 /** the id line2 of AFU Header Id.
                                                                          Up to 80 characters are allowed and the redundant
                                                                          characters will be ignored.
                                                                         */
            );
            ...
            (
                const NXString & id_line3 /** the id line3 of AFU Header Id.
                                                                          Up to 80 characters are allowed and the redundant
                                                                          characters will be ignored.
                                                                         */
            );
            ...
            (
                const NXString & id_line4 /** the id line4 of AFU Header Id.
                                                                          Up to 80 characters are allowed and the redundant
                                                                          characters will be ignored.
                                                                         */
            );
