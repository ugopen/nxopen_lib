...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT RoutingLogical
        {
            ...
            (
                NXOpen::Preferences::RoutingLogical::FlowArrowEnumType flow_arrow_type /** flow arrow type */ 
            );
            ...
            (
                double flow_arrow_parameter_a /** flow arrow parameter a */ 
            );
            ...
            (
                double flow_arrow_parameter_b /** flow arrow parameter b */ 
            );
