...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT HoleFeatureBuilder : public Features::RPOBuilder
        {
            ...
            are ignored.
             @return  Thru face  <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
            ...
            are ignored and will prompt for thru_face.
             @return  Target Body  <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
            ...
            /** Creates a hole body which can be positioned  <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
            ...
            /** Sets parameters for simple hole  <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
            ...
            /** Sets parameters for counterbore hole  <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
            ...
            /** Sets parameters for countersink hole <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
