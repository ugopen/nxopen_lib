    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            class NXOPENCPPEXPORT ElectricalStockDevice : public Routing::StockDevice
            {
                ...
                (
                    const NXString & color_name /** color name */ 
                );
                ...
                (
                    int nx_color_value /** nx color value */ 
                );
                ...
                (
                    NXOpen::Routing::Electrical::HarnessDevice * harness_device /** harness device */ 
                );
            };
        }
    }
