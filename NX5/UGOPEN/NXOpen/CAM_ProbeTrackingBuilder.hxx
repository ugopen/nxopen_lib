...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT ProbeTrackingBuilder : public CAM::SolidTrackingBuilder
        {
            ...
            /**Returns  the stem axis tag  <br> License requirements : None */
            public: NXOpen::NXObject * Axis
            (
            );
            /**Sets  the stem axis tag  <br> License requirements : None */
            public: void SetAxis
            (
                NXOpen::NXObject * axis /** the axis tag */
            );
            /**Returns  the stem top tag  <br> License requirements : None */
            public: NXOpen::NXObject * StemTop
            (
            );
            /**Sets  the stem top tag  <br> License requirements : None */
            public: void SetStemTop
            (
                NXOpen::NXObject * stem_top /** the stem_top tag */
            );
        };
    }
}
