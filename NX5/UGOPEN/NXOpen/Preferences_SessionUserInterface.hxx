...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /** Represents the set of User Interface preferences applicable to entire session. Other User Interface 
            ...
            part and with @link NXOpen::Preferences::SessionUserInterfaceUI NXOpen::Preferences::SessionUserInterfaceUI@endlink  for UI based User Interface Preferences  <br> To obtain an instance of this class, refer to @link Preferences::SessionPreferences Preferences::SessionPreferences@endlink  <br> */
        class NXOPENCPPEXPORT SessionUserInterface
        {
            ...
            */
            ...
            (
                NXOpen::Preferences::SessionUserInterface::JournalFileFormatType journal_file_format /** journal file format */ 
            );
            ...
            */
            ...
            (
                bool inset_menu_dialog_comments /** inset menu dialog comments */ 
            );
