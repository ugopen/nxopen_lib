...
namespace NXOpen
{
    ...
    class NXOPENJAMTESTCPPEXPORT OMAttribute : public TaggedObject, public virtual IOMName
    {
        ...
        struct Info
        {
            ...
            public: Info(NXString INIT_name /** name */ , NXOpen::OMClass * INIT_defining_class /** defining class */ , NXOpen::OMSchema * INIT_defining_schema /** defining schema */ , NXOpen::OMAttribute::Type INIT_type /** type */ ) :
                Name(INIT_name),
