    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT SymbolPreferences : public TransientObject
        {
            ...
            */
            ...
            (
                double id_symbol_size /** id symbol size */ 
            );
            ...
            (
                const NXOpen::Annotations::LineCfw & id_symbol_cfw /** id symbol cfw */ 
            );
            ...
            (
                const NXOpen::Annotations::LineCfw & user_defined_symbol_cfw /** user defined symbol cfw */ 
            );
            ...
            (
                const NXOpen::Annotations::LineCfw & centerline_symbol_cfw /** centerline symbol cfw */ 
            );
            ...
            (
                const NXOpen::Annotations::LineCfw & intersection_symbol_cfw /** intersection symbol cfw */ 
            );
            ...
            (
                const NXOpen::Annotations::LineCfw & target_symbol_cfw /** target symbol cfw */ 
            );
            ...
            (
                const NXOpen::Annotations::LineCfw & gdt_symbol_cfw /** gdt symbol cfw */ 
            );
        };
    }
}
