...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        class NXOPENCPPEXPORT Wall : public Builder
        {
            /** The JA_DISPLAY_WALL_material_type defines the material characteristics
                        of a stage wall.
                    */
            ...
            protected: Wall();
            /**Returns  the wall material type - either shadow_catcher, reflective, or invisible  <br> License requirements : None */
            public: NXOpen::Display::Wall::MaterialType WallMaterialType
            (
            );
            /**Sets  the wall material type - either shadow_catcher, reflective, or invisible  <br> License requirements : None */
            public: void SetWallMaterialType
            (
                NXOpen::Display::Wall::MaterialType wallMaterialType /** wallmaterialtype */ 
            );
            /**Returns  the pattern repeat factor - the number of times the image repeats  <br> License requirements : None */
            public: double PatternRepeatFactor
            (
            );
            /**Sets  the pattern repeat factor - the number of times the image repeats  <br> License requirements : None */
            public: void SetPatternRepeatFactor
            (
                double patternRepeatFactor /** patternrepeatfactor */ 
            );
            /**Returns  the reflectivity of a wall - the percentage of the environment reflected off of the wall  <br> License requirements : None */
            public: double Reflectivity
            (
            );
            /**Sets  the reflectivity of a wall - the percentage of the environment reflected off of the wall  <br> License requirements : None */
            public: void SetReflectivity
            (
                double reflectivity /** reflectivity */ 
            );
            /**Returns  the walls's image builder  <br> License requirements : None */
            public: NXOpen::Display::Image * Image
            (
            );
            /**Sets  the walls's image builder  <br> License requirements : None */
            public: void SetImage
            (
                NXOpen::Display::Image * image_builder /** image builder */ 
            );
            /**Returns  the stage wall's image filename  <br> License requirements : None */
            public: NXString ImageFilename
            (
            );
            /**Sets  the stage wall's image filename  <br> License requirements : None */
            public: void SetImageFilename
            (
                const NXString & new_image_file_name /** new image file name */ 
            );
        };
    }
}
