#ifndef NXOpen_FEATURES_TRANSFRAMELISTITEMBUILDERLIST_HXX_INCLUDED
#define NXOpen_FEATURES_TRANSFRAMELISTITEMBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Features_TransFrameListItemBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT TransFrameListItemBuilderList : public TaggedObject
        {
            ...
            public: void Append
            (
                const std::vector<NXOpen::Features::TransFrameListItemBuilder *> & objects /** items to append */
            );
            /** Appends an object to the list
                 <br> License requirements : None */
            public: void Append
            (
                NXOpen::Features::TransFrameListItemBuilder * object /** item to append */
            );
            ...
            /** Returns the list of entities stored.  This list may contain NULL entities.
             ...
             <br> License requirements : None */
            public: std::vector<NXOpen::Features::TransFrameListItemBuilder *> Vector
            (
            );
            ...
            (
                NXOpen::Features::TransFrameListItemBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index  <br> License requirements : None */
            public: NXOpen::Features::TransFrameListItemBuilder * FindItem
            (
            ...
            (
                int index /** index of item to be removed from the list */,
                NXOpen::ObjectList::DeleteOption delete_option /** whether to delete the object */
            );
            /** Erases the object from the list, but does not delete the object.
                    The list is shifted so that there isn't a null where the object used to exist.  <br> License requirements : None */
            public: void Erase
            (
                NXOpen::Features::TransFrameListItemBuilder * obj /** object to be removed from the list */
            );
            ...
            public: void Clear
            (
                NXOpen::ObjectList::DeleteOption delete_option /** whether to delete the objects when removing them */
            );
            /** Gets the contents of the entire list  @return  The list contents  <br> License requirements : None */
            public: std::vector<NXOpen::Features::TransFrameListItemBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Features::TransFrameListItemBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Features::TransFrameListItemBuilder * object1 /** first item */,
                NXOpen::Features::TransFrameListItemBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Features::TransFrameListItemBuilder * object /** object to be inserted */
            );
        };
    }
}
