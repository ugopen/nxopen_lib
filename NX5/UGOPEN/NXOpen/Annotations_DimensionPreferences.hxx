...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT DimensionPreferences : public TransientObject
        {
            ...
            /**Returns  Returns the zero tolerance display style  <br> License requirements : None */
            public: NXOpen::Annotations::ZeroToleranceDisplayStyle ZeroToleranceDisplayStyle
            (
            );
            /**Sets  Returns the zero tolerance display style  <br> License requirements : None */
            public: void SetZeroToleranceDisplayStyle
            (
                NXOpen::Annotations::ZeroToleranceDisplayStyle zero_display_style /** zero display style */ 
            );
        };
    }
}
