...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT RotorSectionBuilder : public Features::FeatureBuilder
        {
            ...
            (
                const NXString & minimum_extension_length /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & minimum_cavity_depth /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
