...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT PartImporter : public Importer
    {
        ...
        (
            bool create_named_group /** create named group */ 
        );
        ...
        (
            bool import_views /** import views */ 
        );
        ...
        (
            bool import_cam_objects /** import cam objects */ 
        );
        ...
        (
            NXOpen::PartImporter::LayerOptionType layer_option /** layer option */ 
        );
        ...
        (
            NXOpen::PartImporter::DestinationCoordinateSystemSpecificationType destination_coordinate_system_specification /** destination coordinate system specification */ 
        );
        ...
        (
            NXOpen::NXMatrix * destination_coordinate_system /** destination coordinate system */ 
        );
        ...
        (
            const NXOpen::Point3d & destination_point /** destination point */ 
        );
    };
}
#undef EXPORTLIBRARY
