...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT CAMSession
        {
            ...
            (
                const NXString & config_file /** the name of the configuration file   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                ...
                NXOpen::CAM::CAMSession::ObjectSubtype subtype_class /** the subtype class*/
            );
