...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT DesignRuleViolationCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Routing::DesignRuleViolation Routing::DesignRuleViolation@endlink  object.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::DesignRuleViolation * CreateDesignRuleViolation
            (
                const NXString & short_description /**    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & long_description /**    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const std::vector<NXOpen::Routing::DesignRule *> & objects /** objects */ 
            );
