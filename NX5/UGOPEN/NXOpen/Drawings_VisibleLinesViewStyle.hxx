...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        /** Represents set of Visible Lines View Style Preferences applicable to drafting views.  <br> To obtain an instance of this class, refer to @link Drawings::ViewStyle Drawings::ViewStyle@endlink  <br> */
