...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /** Represents set of Detail View Preferences applicable to drafting views.  <br> To obtain an instance of this class, refer to @link Preferences::ViewPreferences Preferences::ViewPreferences@endlink  <br> */
        class NXOPENCPPEXPORT DetailViewPreferences: public virtual Preferences::IDetailViewPreferences
        {
            ...
            (
                bool circular_boundary_option /** circular boundary option */ 
            );
