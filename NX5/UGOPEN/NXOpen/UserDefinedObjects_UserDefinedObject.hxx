...
namespace NXOpen
{
    ...
    namespace UserDefinedObjects
    {
        ...
        class NXOPENCPPEXPORT UserDefinedObject : public DisplayableObject
        {
            ...
            struct LinkDefinition
            {
                ...
                public: LinkDefinition(NXOpen::TaggedObject * INIT_associated_object /** linked object */, NXOpen::UserDefinedObjects::UserDefinedObject::LinkStatus INIT_status /** status of the linked object */) :
                    AssociatedObject(INIT_associated_object),
                    Status(INIT_status)
                {
                }
            };
            ...
            /**Returns  the class name of this UDO  <br> License requirements : None */
            ...
            /** Gets the out of date indicator (status) of this UDO  @return  The status of this UDO 
                        ...
                        7 - Out of date due to addition or deletion of links to the UDO AND update being performed on an Associated (linked) object in the absence of a UDO Method AND deletion of associated (linked) objects in the absence of a UDO method  <br> License requirements : None */
            public: int GetUserDefinedObjectStatus
            (
            );
            /** Clears the out of data indicator (status) of this UDO  <br> License requirements : None */
            public: void ClearUserDefinedObjectStatus
            (
            );
            /**Returns  the @link UserDefinedObjects::UserDefinedClass UserDefinedObjects::UserDefinedClass@endlink  for this UDO  <br> License requirements : None */
            public: NXOpen::UserDefinedObjects::UserDefinedClass * UserDefinedClass
            (
            );
            /**Sets  the @link UserDefinedObjects::UserDefinedClass UserDefinedObjects::UserDefinedClass@endlink  for this UDO  <br> License requirements : None */
            public: void SetUserDefinedClass
            (
                NXOpen::UserDefinedObjects::UserDefinedClass * user_defined_class /** The new class for this UDO */
            );
            /** Gets the @link Features::UserDefinedObjectFeature Features::UserDefinedObjectFeature@endlink  associated with this UDO, if there isn't an associated feature, NULL is returned  @return  The UserDefinedObjectFeature associated this UDO  <br> License requirements : None */
            public: NXOpen::Features::UserDefinedObjectFeature * GetUserDefinedObjectFeature
            (
            );
            /** Gets all of the integers stored with this UDO  @return  Array of integers stored with this UDO  <br> License requirements : None */
            ...
            /** Gets the integers stored in the specified range with this UDO  @return  Array of integers stored within the specified  
                                                                    range of the integer array for this UDO  <br> License requirements : None */
            public: std::vector<int> GetIntegers
            (
            ...
            /** Sets all of the integers stored with this UDO  <br> License requirements : None */
            public: void SetIntegers
            (
                const std::vector<int> & integers /** New Array of integers stored with this UDO */
            );
            /** Replaces the integers stored with this UDO in the specified range with a new array of integers  <br> License requirements : None */
            public: void SetIntegers
            (
                int offset /** Index into the array of integers at the start of the 
            ...
            /** Removes the integers stored at the end of the integer array for this UDO, 
                        and returns them in an array  @return  Array of integers that have been 
                                                                      removed from this UDO  <br> License requirements : None */
            public: std::vector<int> PopIntegers
            (
                int num_integers /** num integers */ 
            );
            /** Add the specified integers to the end of the integer array for this UDO  <br> License requirements : None */
            ...
            /** Gets all of the doubles stored with this UDO  @return  Array of doubles stored with this UDO  <br> License requirements : None */
            ...
            /** Gets the doubles stored in the specified range with this UDO  @return  Array of doubles stored within the specified  
                                                                    range of the double array for this UDO  <br> License requirements : None */
            public: std::vector<double> GetDoubles
            (
            ...
            /** Sets all of the doubles stored with this UDO  <br> License requirements : None */
            public: void SetDoubles
            (
                const std::vector<double> & doubles /** New Array of doubles stored with this UDO */
            );
            /** Replaces the doubles stored with this UDO in the specified range with a new array of doubles  <br> License requirements : None */
            public: void SetDoubles
            (
                int offset /** Index into the array of doubles at the start of the 
                                                                range you wish to cut and replace.
            ...
            (
                int num_doubles /** num doubles */ 
            );
            /** Add the specified doubles to the end of the double array for this UDO  <br> License requirements : None */
            ...
            /** Gets all of the strings stored with this UDO  @return  Array of strings stored with this UDO  <br> License requirements : None */
            ...
            /** Gets the strings stored in the specified range with this UDO  @return  Array of strings stored within the specified  
                                                                    range of the string array for this UDO  <br> License requirements : None */
            public: std::vector<NXString> GetStrings
            (
            ...
            /** Sets all of the strings stored with this UDO  <br> License requirements : None */
            ...
            /** Replaces the strings stored with this UDO in the specified range with a new array of strings  <br> License requirements : None */
            public: void SetStrings
            (
                int offset /** Index into the array of strings at the start of the 
                                                                range you wish to cut and replace.
            ...
            (
                int num_strings /** num strings */ 
            );
            /** Add the specified strings to the end of the string array for this UDO  <br> License requirements : None */
            ...
            /** Gets all of the lengths stored with this UDO  @return  Array of lengths stored with this UDO  <br> License requirements : None */
            ...
            /** Gets the lengths stored in the specified range with this UDO  @return  Array of lengths stored within the specified  
                                                                    range of the length array for this UDO  <br> License requirements : None */
            public: std::vector<double> GetLengths
            (
            ...
            /** Sets all of the lengths stored with this UDO  <br> License requirements : None */
            public: void SetLengths
            (
                const std::vector<double> & lengths /** New Array of lengths stored with this UDO */
            );
            /** Replaces the lengths stored with this UDO in the specified range with a new array of lengths  <br> License requirements : None */
            public: void SetLengths
            (
                int offset /** Index into the array of lengths at the start of the 
                                                                range you wish to cut and replace.
            ...
            (
                int num_lengths /** num lengths */ 
            );
            /** Add the specified lengths to the end of the length array for this UDO  <br> License requirements : None */
            ...
            /** Gets all of the areas stored with this UDO  @return  Array of areas stored with this UDO  <br> License requirements : None */
            ...
            /** Gets the areas stored in the specified range with this UDO  @return  Array of areas stored within the specified  
                                                                    range of the area array for this UDO  <br> License requirements : None */
            public: std::vector<double> GetAreas
            (
            ...
            /** Sets all of the areas stored with this UDO  <br> License requirements : None */
            public: void SetAreas
            (
                const std::vector<double> & areas /** New Array of areas stored with this UDO */
            );
            /** Replaces the areas stored with this UDO in the specified range with a new array of areas  <br> License requirements : None */
            public: void SetAreas
            (
                int offset /** Index into the array of areas at the start of the 
                                                                range you wish to cut and replace.
            ...
            (
                int num_areas /** num areas */ 
            );
            /** Add the specified areas to the end of the area array for this UDO  <br> License requirements : None */
            ...
            /** Gets all of the volumes stored with this UDO  @return  Array of volumes stored with this UDO  <br> License requirements : None */
            ...
            /** Gets the volumes stored in the specified range with this UDO  @return  Array of volumes stored within the specified  
                                                                    range of the volume array for this UDO  <br> License requirements : None */
            public: std::vector<double> GetVolumes
            (
            ...
            /** Sets all of the volumes stored with this UDO  <br> License requirements : None */
            public: void SetVolumes
            (
                const std::vector<double> & volumes /** New Array of volumes stored with this UDO */
            );
            /** Replaces the volumes stored with this UDO in the specified range with a new array of volumes  <br> License requirements : None */
            public: void SetVolumes
            (
                int offset /** Index into the array of volumes at the start of the 
                                                                range you wish to cut and replace.
            ...
            (
                int num_volumes /** num volumes */ 
            );
            /** Add the specified volumes to the end of the volume array for this UDO  <br> License requirements : None */
            ...
            /** Gets all links with the given link type that are stored with this UDO  @return  Array of links (with the given link type) stored with this UDO  <br> License requirements : None */
            public: std::vector<NXOpen::UserDefinedObjects::UserDefinedObject::LinkDefinition> GetLinks
            (
                NXOpen::UserDefinedObjects::UserDefinedObject::LinkType link_type /** The type of links you wish to get */
            );
            /** Gets the links with the given link type that are stored in the specified range with this UDO  @return  Array of links stored within the specified  
                                                                    range of the link type's link array for this UDO  <br> License requirements : None */
            public: std::vector<NXOpen::UserDefinedObjects::UserDefinedObject::LinkDefinition> GetLinks
            (
                NXOpen::UserDefinedObjects::UserDefinedObject::LinkType link_type /** The type of links you wish to get */,
            ...
            /** Sets all of the links with the given link type stored with this UDO.
                        ...
                        this operation will over-write them with the newly specified links.  <br> License requirements : None */
            public: void SetLinks
            (
                NXOpen::UserDefinedObjects::UserDefinedObject::LinkType link_type /** The type of links you wish to set */,
            ...
            /** Replaces the links of the given link type stored with this UDO in the specified range with a new array of links  <br> License requirements : None */
            public: void SetLinks
            (
                NXOpen::UserDefinedObjects::UserDefinedObject::LinkType link_type /** The type of links you wish to set */,
                int offset /** Index into the array of links (with the given link type) 
            ...
            (
                NXOpen::UserDefinedObjects::UserDefinedObject::LinkType link_type /** The type of links you wish to remove */,
                int num_links /** num links */ 
            );
            /** Add the specified links to the end of the given link type's link array for this UDO  <br> License requirements : None */
            public: void PushLinks
            (
                NXOpen::UserDefinedObjects::UserDefinedObject::LinkType link_type /** The type of links you wish to add */,
