...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT DiameterRadiusPreferences : public TransientObject
        {
            ...
            (
                const NXString & symbol_text /** New symbol text */
            );
            ...
            (
                NXOpen::Annotations::DiameterRadiusSymbolPlacement symbol_placement /** New symbol placement relative to dimension text */
            );
            ...
            (
                double symbol_to_dimension_text_distance /** New distance between symbol and dimension text */
            );
            ...
            (
                NXOpen::Annotations::DiameterRadiusLeaderStub leader_stub /** New leader stub relative to dimension text */
            );
            ...
            (
                double folded_radius_angle /** New folded radius angle */
            );
        };
    }
}
