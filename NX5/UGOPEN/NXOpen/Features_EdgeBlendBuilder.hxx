...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT EdgeBlendBuilder : public Features::FeatureBuilder
        {
            ...
            (
                int cs_index /** Index of chainset */,
                NXOpen::ScCollector ** collector /** The collector for this edge blend chainset */,
                NXOpen::Expression ** radius /** The radius of this chain set collector */,
            ...
            (
                ...
                std::vector<bool> & from_start /** if true, then the setback is defined at the start
                                           vertex.  Otherwise, it is defined at the end vertex.
                                           There is one for each output edge. */,
                std::vector<NXOpen::Expression *> & distance_exp /**  The distance for the setback on each edge. */
            );
            ...
            (
                NXOpen::Features::EdgeBlendBuilder::Overlap overlap_option /** overlap option */ 
            );
            ...
            (
                NXOpen::Features::EdgeBlendBuilder::OrderOfBlending blend_order /** blend order */ 
            );
            ...
            (
                NXOpen::Features::EdgeBlendBuilder::Setback setback_option /** setback option */ 
            );
            ...
            (
                NXOpen::ScCollector * cliff_edge_collector /**The cliff edge collector */
            );
            ...
            (
                NXOpen::ScCollector * non_cliff_edge_collector /**The non cliff edge collector */
            );
