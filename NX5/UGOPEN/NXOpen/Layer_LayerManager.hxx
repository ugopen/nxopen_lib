        ...
        class NXOPENCPPEXPORT LayerManager
        {
            ...
            */
            ...
            /** Moves objects to the specified layer.
                    ...
                    @link LayerManager::MoveDisplayableObjects LayerManager::MoveDisplayableObjects@endlink  instead. <br> 
            ...
            (
                int new_layer /** The layer to move the objects to */,
                const std::vector<NXOpen::DisplayableObject *> & object_array /** The objects to be moved */
            );
            ...
            (
                ...
                std::vector<NXOpen::Layer::StateInfo> & state_array /** The current states for the layers.
            ...
            (
                ...
                const std::vector<NXOpen::Layer::StateInfo> & state_array /** The new states for the layers.
