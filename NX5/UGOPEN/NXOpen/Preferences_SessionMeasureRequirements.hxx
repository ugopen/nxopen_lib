    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT SessionMeasureRequirements
        {
            ...
            */
            ...
            public: explicit SessionMeasureRequirements(NXOpen::Preferences::SessionPreferences *owner): m_owner(owner)
            {
            }
            public: 
            ...
            (
                NXOpen::Preferences::SessionMeasureRequirements::ActionOnViolation violation_action /** violation action */ 
            );
