            ...
            class NXOPENCPPEXPORT JogBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the Offset Dimension
                             <br> 
                                ...
                                In case of @link Features::SheetMetal::JogBuilder::DimensionTypeOptions::Offset Features::SheetMetal::JogBuilder::DimensionTypeOptions::Offset@endlink  the actual extent distance will be offset dimension distance plus the thickness of sheet.
                                In case of @link Features::SheetMetal::JogBuilder::DimensionTypeOptions::Full Features::SheetMetal::JogBuilder::DimensionTypeOptions::Full@endlink  the actual extent distance will be the Full dimension distance.
                             <br> 
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                ...
                (
                    NXOpen::Features::SheetMetal::JogBuilder::DimensionTypeOptions dimension_type /** dimension type */ 
                );
                /**Returns   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                ...
                (
                    NXOpen::Features::SheetMetal::JogBuilder::FixedSideOptions section_side /** section side */ 
                );
                /**Returns   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                ...
                (
                    NXOpen::Features::SheetMetal::JogBuilder::BendLocationOptions bend_location /** bend location */ 
                );
                /**Returns   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                ...
                (
                    NXOpen::Features::SheetMetal::JogBuilder::DirectionTypeOptions direction_type /** direction type */ 
                );
                /**Returns   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
