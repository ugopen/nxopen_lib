 ...
 * File description:
 *
 *    This file contains the list of available parameter indices in UG CAM.
 *    Each index represents a parameter of a UG data object. The description
 ...
 * 
 */
#define UF_PARAM_STEPOVER_VAR_DISTS   274  /* UF_PARAM_type_vla_length, size 6 */
 ...
 *
 *   Possible Values: Within the range [100, 200]
 *
 * 
 *
 */
...
typedef enum
{
    ...
    UF_PARAM_tl_turn_holder_hand_groove_left_0,
    UF_PARAM_tl_turn_holder_hand_groove_left_90,
    UF_PARAM_tl_turn_holder_hand_groove_right_0,
    UF_PARAM_tl_turn_holder_hand_groove_right_90
 ...
 * 
 */
#define UF_PARAM_TURN_CUT_DEPTH_ARRAY   2817  
 ...
 * 
 */
#define UF_PARAM_TURN_FINISH_CUT_DEPTH_ARRAY   2936 
 ...
 * 
 */
#define UF_PARAM_TTDOPR_VARIABLE_INCREMENT   3346 
 ...
 *
 *   Description:
 *      This parameter specifies a set of finsh increments.
 *      Up to 6 different finish increments can be defined.
 *      Every increment is cut as often as specified in parameter
 *      UF_PARAM_TTDOPR_FINISH_PASSES_NO_OF_PASSES.
 *
 ...
 *
 *   Possible Values: 
 *        0 - False: Safe distance for level/blank engage is not tangential
 *        1 - True:  Safe distance for level/blank engage is tangential
 *
 * 
 */
 ...
 *
 *   Possible Values: 
 *        0 - False: Extend distance for level/safe engage is not tangential
 *        1 - True:  Extend distance for level/safe engage is tangential
 *
 * 
 */
...
typedef enum
{
   ...
   UF_PARAM_edgext_type_tool_diameter = 1,
   UF_PARAM_edgext_type_specify            = 2
 ...
 *   Description:
 *      This parameters specifies the type of tangent extension that is used.
 *
 *   Type: UF_PARAM_type_int
 *
