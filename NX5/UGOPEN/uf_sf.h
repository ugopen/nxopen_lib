...
#define   UF_SF_UGS_MESH_INVALID_SURF_MESH_SIZE_VARIATION \
                                                  (ERROR_UF_SFEM_base + 108)
#define   UF_SF_UGS_MESH_INVALID_VOL_MESH_SIZE_VARIATION \
                                                  (ERROR_UF_SFEM_base + 109)
...
History:
************************************************************************/
extern UFUNEXPORT int UF_SF_create_0d_mesh(
...
History:
************************************************************************/
extern UFUNEXPORT int UF_SF_create_0d_mesh_dist_mass(
int num_geom_objects ,/* <I>
                      The number of geometry objects to be meshed
                      */
tag_t* geom_array ,/* <I,len:num_geom_objects>
...
History:
************************************************************************/
extern UFUNEXPORT int UF_SF_create_1d_mesh(
...
History:
************************************************************************/
extern UFUNEXPORT int UF_SF_create_1d_connection_mesh(
UF_SF_1d_mesh_data_t* mesh_data ,/* <I>
                                 pointer to the structure UF_SF_1d_mesh_data_t
                                 */
UF_SF_orientation_data_t* orient_data ,/* <I>
...
History:
************************************************************************/
extern UFUNEXPORT int UF_SF_create_weld_mesh(
   UF_SF_1d_mesh_data_t* mesh_data , /* <I>
...
History: This new functionality was supported in v17.0
******************************************************************************************/
...
History:
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edit_beam_orientation (
tag_t mesh_tag ,/* <I>
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_get_auto_element_size
(
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_ugs_tet_mesh
(
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_ugs_tet_mesh_wt_abstraction_control (  UF_SF_ugs_tet_mesh_parms_p_t const  mesh_parms,/*<I> Parameters which
                                                                                                                    control the required
                                                                                                                    tet Mesh */
                                                      UF_SF_ugs_mesh_abstraction_params_p_t const  abs_data_p,/*<I> Abstraction control */
                                                               ...
                                                               tag_p_t const                bodies_p,/*<I,len:num_bodies> 
                                                                                                          Tag of the polygon bodies to
                                                                                                           mesh */
                                                               int                          fPartialSurfMesh,/*<I> 0 == don't allow creation of 
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_ugs_tet_mesh_parms
(
 ...
 *            >0 for error
 ******************************************************************************/
extern UFUNEXPORT int UF_SF_check_model_element_shapes
(
    int num_meshes,                    /*<I> Length of the mesh_tags array.*/
    tag_p_t mesh_tags,                 /*<I> Array of mesh tags*/
    ...
    const char *output_file_with_path, /*<I> Name with path of output file.
                                             NULL if File_To_AppendTo is 
                                             specified in arguement below. */
    FILE       *File_To_AppendTo       /*<I> Append output to end of the alteady
 ...
 *
 *  INPUT
 *     eElemType,                i - Element type for which 
 *                                   element shape thresholds asked.
 *
 *     pzThresholdValues         o - Str. in which thresholds are 
 *                                   returned  
 *
 *  OUTPUT:
 *    
...
(
    UF_SF_THRESHOLD_shape_t  eElemType,              /*<I> Element type for which element 
                                                           shape thresholds asked. */
    UF_SF_THRESHOLD_data_p_t pzThresholdValues       /*<O> Str. in which thresholds are 
                                                           returned. */
);
 ...
 *                                   element shape thresholds asked.
 *
 *     pzThresholdValues         i - Str. in which thresholds are 
 *                                   returned  
 *
 *
 *  OUTPUT:
...
(
    ...
    UF_SF_THRESHOLD_data_p_t pzThresholdValues        /*<I> Str. in which threshold values
                                                            are passed in. */
);
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_ugs_2d_mesh
(
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_ugs_2d_mesh_wt_abstraction_control
(
    UF_SF_ugs_2d_mesh_parms_p_t const mesh_parms,        /*<I> Parameters which
                                                               control the
                                                               required 2d
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_ugs_2d_mesh_with_hdpts
(
    UF_SF_ugs_2d_mesh_parms_p_t const mesh_parms, /*<I> Parameters which
                                                        control the
                                                        required 2d
...
Environment: Internal and External
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_ugs_2d_mesh_parms
(
    tag_t mesh_tag,                                /*<I> The mesh to get mesh
                                                         parameters for. */
...
extern UFUNEXPORT int UF_SF_edit_section(
tag_t section_tag ,/* <I>
                   Section name string
                   */
UF_SF_section_type_p_t section_type_ptr ,/* <I>
                                         The type of section.
                                         */
char* name_str  /* <I>
                String representing the name to be
...
History:
*****************************************************************************/
extern UFUNEXPORT int UF_SF_create_section(
UF_SF_section_type_t Section_type ,/* <I>
                                   ...
                                   */
char* name_str ,/* <I>
                pointer to string representing the name of
                the string. The maximum number of
                allowable characters is 12.
                */
double* property_values ,/* <I>
                         Array which represents property values to
                         create.**
                         */
char** offsets ,/* <I,len:2>
                Array of Y,Z,Offset values from the
                centroid of the section to the object.
                */
UF_SF_section_src_list_p_t section_src_ptr ,/* <I>
                                            Stress recovery coefficients 
                                            or NULL can be passed.
                                            */
int num_of_objects ,/* <I>
                    Number of objects for applying offsets.
                    */
tag_p_t object_tag ,/* <I,len:num_of_objects>
                    Object for applying offsets. Objects can be
                    bar or beam element mesh, curves, or points
                    */
tag_p_t section_tag_ptr /* <I/O>
                         Section tag to update or pass NULL_TAG
                         to create section.
                        */
);
...
History:
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_section_offsets(
tag_t object_tag ,/* <I>
                  Object on which offset exists.
                  */
double* y_offset ,/* <O>
                  y-offset value
                  */
...
History:
******************************************************************************/
extern UFUNEXPORT int UF_SF_apply_offsets(
char* y_offset_exp_text ,/* <I>
                         Y offset expression tag
                         */
char* z_offset_exp_text ,/* <I>
                         Z offset  expression tag
                         */
int num_items ,/* <I>
               Number of items to associate offset
               */
tag_p_t   items_array /* <I,len:num_items>
                       Tags of items to associate offsets
...
History:
******************************************************************************/
extern UFUNEXPORT   int    UF_SF_ask_section_prop (
  tag_t    section_tag, /*<I>
                        */
  UF_SF_section_prop_list_p_t section_prop /*<I/O>
...
History:
******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_section(
tag_t mesh_object ,/* <I>
...
History:
******************************************************************************/
extern UFUNEXPORT int UF_SF_link_section(
tag_t section_tag ,/* <I>
...
History:
******************************************************************************/
extern UFUNEXPORT int UF_SF_unlink_section(
tag_t section_tag ,/* <I>
                   The tag of section property.
                   */
tag_t  mesh_geom_tag  /* <I>
...
History:
*****************************************************************************/
extern UFUNEXPORT int UF_SF_locate_named_section(
char* section_name ,/* <I>
                    Section name string
                    */
...
Environment: Internal  and  External 
See Also:  UF_SF_create_section 
  

History: Originally released in V17.0 
 ***************************************************************************/ 
extern UFUNEXPORT int UF_SF_analyse_solid_section( 
char*     name_str     ,/* <I>
                        Name to assign to newly created section
                        or name of section to edit.
                        */
tag_t     section_face ,/* <I> 
                        A single, planar face representing the solid section 
                        to analyze. 
                        */ 
tag_t     vector       ,/* <I> 
                        Use to form the horizontal reference of the section. 
...
tag_p_t    final_tag  ,/*<O>
                       ...
                       */
double *          area,/* <O> 
                       The computed area of the cross section. 
                       */ 
double *   centroid[3],/* <O> 
                       The computed centroid of the cross section. 
                       In absolute coordinates.
                       */ 
double * shear_center[3],/* <O> 
                       The computed shear center of the cross section. 
                       In absolute coordinates.
                       */ 
double * principal_angle,/* <O> 
                       The computed principal angle of the cross section. 
                       In degrees with respect to the input vector.
                       */ 
double * moment_inertia[3],/* <O> 
                       The computed moments of inertia, Iyy, Izz, Iyz of the 
                       cross section. 
                       In absolute coordinates.
                       */ 
double * principal_moment_inertia[3],/* <O> 
                       The computed principal_moments of inertia, Ixx, Iyy 
                       of the cross section. 
                       In absolute coordinates.
                       */ 
double * torsional_constant,/* <O> 
                       The computed torsional constant of the cross section. 
                       */ 
double * warping_constant /* <O> 
                       The computed warping constant of the cross section. 
                       */ 
);
...
History: Originally released in V17.0 
 ***************************************************************************/ 
extern UFUNEXPORT int UF_SF_analyse_thin_section( 
char*     name_str     ,/* <I>
                        Name to assign to newly created section
                        or name of section to edit.
                         */
tag_t     sketch       ,/* <I> 
                        The sketch to analyse. 
                         */ 
tag_p_t   final_tag    ,/*<O>
                        The created section.
                         */
...
History:
****************************************************************************/
extern UFUNEXPORT int UF_SF_apply_beam_end_mass(
...
History:
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_beam_end_mass(
tag_t object_tag ,/* <I>
...
History:
**************************************************************************/
extern UFUNEXPORT int UF_SF_ask_combined_load_cases (
tag_t part_tag ,/* <I>
...
History:
**************************************************************************/
extern UFUNEXPORT int UF_SF_ask_combined_load_case (
tag_t  clc_tag ,/* <I>
...
History:
**************************************************************************/
extern UFUNEXPORT int UF_SF_create_combined_load_case (
char* clc_name ,/* <I>
...
History:
****************************************************************************/
extern UFUNEXPORT int UF_SF_set_shell_thickness(
char* shell_thick_exp ,/* <I>
...
History:
************************************************************************/
extern UFUNEXPORT int UF_SF_ask_mesh_dimension(
tag_t mesh_recipe ,/* <I>
...
History:
************************************************************************/
extern UFUNEXPORT int UF_SF_ask_dom_elm_type (
tag_t mesh_recipe ,/* <I>
                   Tag to mesh recipe or  mesh
                   */
...
See Also: UF_SF_free_section_data 

History:
************************************************************************/
extern UFUNEXPORT int UF_SF_ask_mesh_sections(
tag_t mesh_object ,/* <I>
                   The tag of the object to query
                   */
int*  num_sections ,/* <O>
                    Number of sections found
                    */
UF_SF_section_data_p_t** section_data_ptr  /* <OF,len:num_sections,free:UF_SF_free_section_data>
...
History:
 ***************************************************************************/
extern UFUNEXPORT int UF_SF_free_section_data(
int num_sections ,/* <I>
                  The number of allocated entries in The
                  number of allocated entries in
                  section_data_ptr.
                  */
UF_SF_section_data_p_t* section_data_ptr /* <I,len:num_sections>
                                          pointer to array of
 ...
 ***************************************************************************/
extern UFUNEXPORT int UF_SF_ask_section_data(
tag_t section_tag ,/* <I>
                   Tag of section to query.
                   */
tag_t mesh_object , /* <I>
                    Tag to the object which owns the section.
                    ...
                    */
tag_t mesh_recipe ,/* <I>
                   Tag to the mesh recipe for orientation
                   ...
                   in a NULL_TAG value.
                   */
UF_SF_section_data_p_t* section_data_ptr /* <OF>
...
History:
 ***************************************************************************/
extern UFUNEXPORT int UF_SF_ask_geom_data(
tag_t mesh_object ,/* <I>
                   Tag of the mesh
                   */
...
History:
 ***************************************************************************/
extern UFUNEXPORT int UF_SF_ask_edge_density (
tag_t object_tag ,/* <I>
...
History:
***************************************************************************/
extern UFUNEXPORT int UF_SF_find_mesh(
tag_t object_tag ,/* <I>
...
History:
***************************************************************************/
extern UFUNEXPORT int UF_SF_ask_mesh_visuals(
tag_t mesh_tag ,/* <I>
                The tag of the mesh
                */
...
History:
***************************************************************************/
extern UFUNEXPORT int UF_SF_set_mesh_visuals(
tag_t mesh_tag ,/* <I>
                The tag of the mesh
                */
UF_SF_mesh_visuals_t* mesh_vis /* <O>
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_hpt_mg_parents(
tag_t point_tag ,/* <I>
                 Tag to a hard point.
                 */
int* parent_cnt ,/* <O>
...
*********************************************************************/
extern UFUNEXPORT int UF_SF_create_scenario_nx(
...
History:
 ***************************************************************************/
extern UFUNEXPORT int UF_SF_is_scenario_part ( void );
...
*********************************************************************/
extern UFUNEXPORT int UF_SF_switch_scenarios(
...
History:
*************************************************************************/
extern UFUNEXPORT int UF_SF_locate_scenarios(
...
History:
**************************************************************************/
extern UFUNEXPORT int UF_SF_create_material    (
char* name ,/* <I>
            Name of material.  The maximum
            number of allowable characters is 12.
            */
char* category ,/* <I>
                Category of material, pass NULL if it is
                not required. The maximum number of
                allowable characters is 12.
                */
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_material(
tag_t object_tag ,/* <I>
                  The tag of object.
                  */
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_link_material(
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_named_material(
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_unlink_material(
tag_t  object_tag /* <I>
...
*******************************************************************************/
extern UFUNEXPORT   int  UF_SF_ask_material_type
    (
        tag_t                             material_tag, 
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_material (
tag_t  material_tag ,/* <I>
                     Tag of the material.
                     */
char** material_name ,/* <OF>
                      ...
                      */
UF_SF_material_prop_t* property_values /* <OF>
...
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_material_strength (
tag_t  material_tag ,/* <I>
                     Tag of the material.
                     */
...
History: This function was originally released in V19.1
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_material_formability (
tag_t  material_tag ,/* <I>
                     Tag of the material.
                     */
...
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_material_fatigue (
tag_t  material_tag ,/* <I>
                     Tag of the material.
                     */
...
******************************************************************************/
extern UFUNEXPORT int UF_SF_add_material_strength (
UF_SF_material_strength_prop_p_t property_values, 
                                    /* <I>
                                        Structure containing material strength
                                        properties.  The structure should be
...
******************************************************************************/
extern UFUNEXPORT int UF_SF_add_material_fatigue (
UF_SF_material_fatigue_prop_p_t property_values, 
                                    /* <I>
                                        Structure containing material strength
                                        properties.  The structure should be
...
/******************************************************************************
  ...
  Returns:                                Completion status.
                                          ...
                                          >0 error
******************************************************************************/
extern UFUNEXPORT int UF_SF_update_material 
( 
...
/******************************************************************************
  ...
  object only.
****************************************************************************/
extern UFUNEXPORT int UF_SF_update_strength
(
tag_t                       material_tag,  /*<I> The tag of material to be updated.
...
*****************************************************************************/
extern UFUNEXPORT int UF_SF_update_fatigue
(
tag_t                         material_tag, /* <I> The tag of material to be updated.
                                                   May be the PHYS_MAT or SFMAT object.
                                            */
...
*******************************************************************************/
extern UFUNEXPORT int UF_SF_init_matl_prop ( 
...
History: This function was originally released in V19.1
*******************************************************************************/
extern UFUNEXPORT int UF_SF_init_matl_strength_prop ( 
...
History: This function was originally released in V19.1
*******************************************************************************/
extern UFUNEXPORT int UF_SF_init_formability_prop ( 
...
History: This function was originally released in V19.1
*******************************************************************************/
extern UFUNEXPORT int UF_SF_init_fatigue_prop ( 
...
History:
*******************************************************************************/ 
extern UFUNEXPORT void UF_SF_free_matl_prop (
...
History: This function was originally released in V19.1
*******************************************************************************/ 
extern UFUNEXPORT void UF_SF_free_matl_strength_prop (
...
History: This function was originally released in V19.1
*******************************************************************************/ 
extern UFUNEXPORT void UF_SF_free_formability_prop (
...
History: This function was originally released in V19.1
*******************************************************************************/ 
extern UFUNEXPORT void UF_SF_free_fatigue_prop (
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_count_nodes(
tag_t mesh ,/* <I>
 ...
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_count_elements(
tag_t mesh ,/* <I>
            The tag of mesh.  If passed NULL_TAG
            then all meshes in the current part will be
            traversed
...
History:
*************************************************************************------*/
extern UFUNEXPORT int UF_SF_locate_nodes_on_mesh (
tag_t mesh_tag ,/* <I>
...
History:
*************************************************************************------*/
extern UFUNEXPORT int UF_SF_locate_element (
tag_t mesh_tag ,/* <I>
...
History:
*************************************************************************------*/
extern UFUNEXPORT int UF_SF_locate_nodes_on_element (
tag_t element_tag ,/* <I>
                   Element tag.
                   */
int* num_of_nodes ,/* <O>
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_element (
tag_t elm_tag ,/* <I>
               Element tag.
               */
int* elm_id ,/* <O>
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_node (
tag_t node_tag ,/* <I>
                Node tag.
                */
int* node_id ,/* <O>
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_element_edges(
tag_t elem_tag ,/* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_set_default_env_nx (
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_language (
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_cur_language_nx (
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_num_element_descriptors_nx ( 
tag_t language_tag,        /* <I>
                           Language tag.
                           */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_nth_element_descriptor_nx ( 
tag_t language_tag,        /* <I>
                           Language tag.
                           */
int   index,               /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_element_descriptor_nx ( 
tag_t       language_tag,        /* <I>
                                 Language tag.
                                 */
const char* name,               /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_element_descriptor_name_nx ( 
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_num_load_descriptors_nx ( 
tag_t language_tag,        /* <I>
                           Language tag.
                           */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_nth_load_descriptor_nx ( 
tag_t language_tag,        /* <I>
                           Language tag.
                           */
int   index,               /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_load_descriptor_nx ( 
tag_t       language_tag,        /* <I>
                                 Language tag.
                                 */
const char*  name,              /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_load_descriptor_name_nx ( 
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_num_bc_descriptors_nx ( 
tag_t language_tag,      /* <I>
                         Language tag.
                         */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_nth_bc_descriptor_nx ( 
tag_t language_tag,      /* <I>
                         Language tag.
                         */
int   index,             /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_bc_descriptor_nx ( 
tag_t       language_tag,      /* <I>
                               Language tag.
                               */
const char* name,             /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_bc_descriptor_name_nx ( 
tag_t  bc_desc_tag, /* <I>
                    The tag of the bc descriptor.
                    */
char** name_pp      /* <OF>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_num_solution_descriptors_nx ( 
tag_t language_tag,            /* <I>
                               Language tag.
                               */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_nth_solution_descriptor_nx ( 
tag_t language_tag,            /* <I>
                               Language tag.
                               */
int   index,                   /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_solution_descriptor_nx ( 
tag_t       language_tag,            /* <I>
                                     Language tag.
                                     */
const char* name,                   /* <I>
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_active_solution_nx (
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_active_step_nx (
tag_t *active_step     /* <O>
                       Pointer to the tag of the active
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_set_active_solution_and_step_nx (
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_descriptor_nx(
tag_t solution,   /* <I>
                   Tag of the solution.
                   */
tag_t* descriptor /* <O>
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_num_solutions_nx (
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_nth_solution_nx (
int solution,     /* <I>
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_num_steps_nx (
...
History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_nth_step_nx (
tag_t solution_tag,     /* <I>
                        Tag of the solution.
                        */
int step,               /* <I>
...
needs to be  called after creating load or boundary condition by using 
UF_SF_create_load_nx or UF_SF_create_bc_nx.

Environment: Internal  and  External

See Also:  UF_SF_create_load_nx
           UF_SF_create_bc_nx

History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT  int  UF_SF_add_to_solution_nx(
            int      num_of_lbc, /*<I>
...
called after creating load or boundary condition by using 
UF_SF_create_load_nx or UF_SF_create_bc_nx.
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT  int  UF_SF_add_to_step_nx(
                                  int      num_of_lbc,/*<I>
                                                      Number of loads or boundary conditions to
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_remove_from_solution_nx(
int num_of_lbc ,/* <I>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_remove_from_step_nx(
int num_of_lbc ,    /* <I>
                    Number of loads and boundary conditions.
                    */
tag_t*  lbc         /* <I>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_locate_solution_loads_nx(
tag_t solution ,/* <I>
                Tag of the solution.
                */
int *num_members ,/* <O>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_locate_solution_boundary_conditions_nx(
tag_t solution ,/* <I>
                Tag of the solution.
                */
int *num_members ,/* <O>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_locate_step_loads_nx(
tag_t step, /* <I>
            Step tag.
            */
int *num_members,/* <O>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_locate_step_boundary_conditions_nx(
tag_t step, /* <I>
            Step tag.
            */
int *num_members,/* <O>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_name_nx(
tag_t  solution ,/* <I>
                 Tag of the solution.
                 */
char* solution_name  /* <O>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_step_ask_name_nx(
tag_t  step ,    /* <I>
                 Step tag.
                 */
char* step_name  /* <O>
...
History:
****************************************************************************/
extern UFUNEXPORT int UF_SF_solution_set_name_nx(
tag_t  solution, /* <I>
...
History:
****************************************************************************/
extern UFUNEXPORT int UF_SF_step_set_name_nx(
tag_t  solution ,/* <I>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_solution_nx(
tag_t  lbc_tag ,/* <I>
...
History: Originally released in NX3.0
****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_step_nx(
tag_t  lbc_tag ,/* <I>
                Tag of the load or boundary condition.
                */
int *num_members ,/* <O>
...
History: Originally released in NX3.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_named_solution_nx(
const char* solution_name, /* <I>
                           Name of the solution.
                           */
tag_t*  solution_tag  /* <O>
...
History: Originally released in NX3.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_named_step_nx(
tag_t solution_tag,     /* <I>
                        Tag of the solution.
                        */
const char* step_name, /* <I>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_create_solution_nx(
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_create_step_nx(
tag_t step_desc, /* <I>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_language_nx(
tag_t solution, /* <I>
                 Tag for the solution.
                 */
tag_t* language /* <O>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_property_count_nx(
tag_t solution,   /* <I>
                  Tag for the solution.
                  */
int* num_props   /* <O>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_property_by_index_nx(
tag_t solution,     /* <I>
                    Tag for the solution.
                    */
int property,       /* <I>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_property_nx(
tag_t solution,     /* <I>
                    Tag for the solution.
                    */
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_solver_property_count_nx(
tag_t solution,   /* <I>
                  Tag for the solution.
                  */
int* num_props   /* <O>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_solver_property_by_index_nx(
tag_t solution,     /* <I>
                    Tag for the solution.
                    */
int property,       /* <I>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_solution_ask_solver_property_nx(
tag_t solution,     /* <I>
                     Tag for the solution.
                     */
const char* property_name, /* <I>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_step_ask_property_count_nx(
tag_t step,       /* <I>
                  Tag for the step.
                  */
int* num_props   /* <O>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_step_ask_property_by_index_nx(
tag_t step,         /* <I>
                    Tag for the step.
                    */
int property,       /* <I>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_step_ask_property_nx(
tag_t step,          /* <I>
                     Tag for the step.
                     */
const char* property_name,/* <I>
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_delete_solution_nx(
tag_t solution  /* <I>
                 Tag for the solution.
                 */
);
...
History: Originally released in NX3.0
**************************************************************************/
extern UFUNEXPORT int UF_SF_delete_step_nx(
tag_t step  /* <I>
            Tag for the step.
            */
);
...
History:
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_node_pgeoms (
tag_t node_tag ,/* <I>
...
History:
*************************************************************************------*/
extern UFUNEXPORT int UF_SF_locate_element_by_id (
tag_t mesh_tag ,/* <I>
                Mesh tag, pass in NULL_TAG to locate all
...
History:
*************************************************************************------*/
extern UFUNEXPORT int UF_SF_locate_node_by_id (
tag_t mesh_tag ,/* <I>
                Mesh tag, pass in NULL_TAG to locate all
                nodes in current part.
                */
...
History:
**************************************************************************-----*/
extern UFUNEXPORT int UF_SF_create_contact_mesh(
tag_p_t mesh ,/* <I/O>
...
History:
**************************************************************************-----*/
extern UFUNEXPORT int UF_SF_auto_create_surface_contact_mesh(
...
History:
**************************************************************************-----*/
extern UFUNEXPORT int UF_SF_create_surface_contact_mesh(
tag_t source_face ,/* <I>
...
History:
*******************************************************************************/
extern UFUNEXPORT  int  UF_SF_locate_nodes_on_geometry( 
tag_t   geom_tag, /* <I>
                  Tag of CAE geometry.
                  */
...
History: This function was originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_mesh_mating_condition (
...
extern UFUNEXPORT int UF_SF_delete_mesh_mating_condition
(
    int    num_mmc,      /*<I>
...
extern UFUNEXPORT int UF_SF_edit_mesh_mating_condition
(
    int    num_mmc,               /*<I>
                                  Number of MMCs to be deleted
                                  */
...
History: This function was originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_mesh_mating_condition_list (
...
History: This function was originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_locate_mesh_mating_condition_by_name (
char*   assembly_name,  /*<I>  
                        Assembly mesh name
                        */
tag_t*  assembly_mesh   /*<O>
...
History: This function was originally released in V16.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_mesh_mating_condition (
...
extern UFUNEXPORT int UF_SF_create_offset_midsrf
(
...
extern UFUNEXPORT int UF_SF_edit_offset_midsrf
(
...
extern UFUNEXPORT int UF_SF_is_offset_midsrf
(
...
extern UFUNEXPORT int UF_SF_ask_offset_midsrf_thickness
(
...
/*******************************************************************************
    ...
    be iniitalize to contain 0 faces
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_alloc_idealize_parms
(
  UF_SF_idealize_parms_p_t   *parms_p   /* <OF>
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_free_idealize_parms
(
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_idealize_parm_exp
(
  UF_SF_idealize_parms_p_t   parms_p,     /* <I>
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_set_idealize_parm_exp
(
  UF_SF_idealize_parms_p_t   parms_p,     /* <I>
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_idealize_parm_faces
(
    UF_SF_idealize_parms_p_t   parms_p,     /* <I>
                                            Idealize parameter entity to query
                                            */
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_set_idealize_parm_faces
(
    UF_SF_idealize_parms_p_t   parms_p,     /* <I>
                                            Idealize parameter entity to query
                                            */
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_alloc_idealize_region
(
    tag_t                      seed_face,     /* <I>
    ...
    tag_t                      angle_exp,     /* <I>
                                              ...
                                              */
    UF_SF_idealize_region_p_t  *region_p      /* <OF>
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_free_idealize_region
(
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_idealize_region
(
    UF_SF_idealize_region_p_t  region_p,      /* <I>
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_idealize_body
( 
  tag_t     body_tag,           /* <I> 
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_idealize_region
( 
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_idealize_parms 
( 
  tag_t feature_tag,           /* <I> 
...
History: Originally released in V17.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_edit_idealize_parms 
( 
  tag_t   feature_tag,         /* <I> 
                               The idealize feature 
                               */ 
...
extern UFUNEXPORT int UF_SF_create_auto_face_subdiv (
 ...
 *******************************************************************************/
extern UFUNEXPORT  int   UF_SF_locate_all_meshes ( 
                            tag_t mesh_tag,       /* <I> 
                                        Mesh tag, pass in NULL_TAG to locate all
 ...
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_test_gpe( FILE *fp  /* <I> file pointer */
                                    );
...
History:
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_open_scenario(
                            char* scenario_name,   /* <I>
...
History:
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_clone_scenario(
 ...
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_close_scenario(
                                            void
                                          );
 ...
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_delete_scenario(
                            tag_t master_tag,   /* <I> 
                                                  master part tag */
...
History:
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_rename_scenario(
                            tag_t master_tag,   /* <I>
                                               master part tag   */
                            char *old_scenario, /* <I> 
                                               old scenario name */
...
History:
 *************************************************************************------*/
extern UFUNEXPORT int UF_SF_save_scenario(
                                           void 
                                         );
...
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_disp_mesh
(
    UF_SF_disp_mesh_t  *disp_mesh,   /*<I> Node coordinates and their connectivity
                                           to define a connected set of elements. 
                                      */
    tag_t              *mesh_tag     /*<O> Tag to created display mesh object. */
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_delete_disp_mesh
(
    int                num_meshes,    /*<I> Number of display mesh objects to  
                                            be deleted. */
    tag_t              *mesh_tags     /*<I,len:num_meshes> 
                                            Array of display mesh objects to 
                                            be deleted. */ 
);
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_display_mesh
(
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_free_disp_mesh
(
 
    UF_SF_disp_mesh_p_t disp_mesh_p /*<I> Display mesh structure to free. */
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_node_delta
(
    tag_t              node_tag,    /*<I> Tag of Node entity. */
                                   
    double             *delta_a     /*<O> Node displacement values 
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_set_nodes_delta_by_id
(
    tag_t          mesh_tag,      /*<I> Tag of mesh object. 
                                        If mesh_tag = NULL_TAG then search 
                                        all meshes in the model. 
                                  */
    int            num_nodes,     /*<I> Number of nodes in the given mesh 
                                        to set diplacements for.
                                  */
    int            *node_id_a,    /*<I,len:num_nodes> 
                                        Array of node IDs the size of num_nodes. */
    double         *delta_vals_a  /*<I,len:num_nodes*3> 
                                        Array of displacement values the size of num_nodes*3, 
                                        The displacements of the i-th node are given by
                                        delta_vals_a[3*i+0], delta_vals_a[3*i+1], delta_vals_a[3*i+2] 
                                  */
);
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_elem_node_results
(
    tag_t               mesh_tag,        /*<I> Tag of mesh to set displacements
                                               as results. This should be the
                                               mesh tag inside the Simulation part */
    UF_SF_mesh_elem_node_result_p_t results_p /*<I> Empty 
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_set_elem_node_results
(
 
    UF_SF_mesh_elem_node_result_p_t results_p /*<I> An filled
                                                    UF_SF_mesh_elem_node_result_t
                                                    structure. 
                                              */ 
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_free_elem_node_results
(
 
    UF_SF_mesh_elem_node_result_p_t results_p /*<I> Element node results 
                                                    structure to free.   */ 
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int  UF_SF_get_extreme_values
(
    double   *max_result,       /*<O> Maximum result value */
    double   *min_result        /*<O> Minimum result value */
);
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_create_legend
(     
 
    UF_SF_LEGEND_attr_p_t legend_attr, /*<I> Attributes for the legend. 
                                            See uf_sf_legend.h
                                            for how to build the attribute structure. 
                                       */
    tag_t                 *view        /*<O> Tag of the legend view. 
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_delete_legend
(
 
    tag_t       view /*<I> Tag of the legend view. */
);
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_ask_attribute
(
 
    tag_t         view,                /*<I> Tag of the legend view */
    UF_SF_LEGEND_attr_p_t *legend_attr /*<O> Legend attribute structure. */ 
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_new_attr
(
    UF_SF_LEGEND_attr_p_t *legend_attr /*<O> Allocated and initialized
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_free_attr
(

    UF_SF_LEGEND_attr_p_t legend_attr /*<I> Legend attribute structure. */
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_add_index_text_title
(

    UF_SF_LEGEND_attr_p_t  legend_attr, /*<I> Legend attribute structure */
    UF_SF_LEGEND_title_p_t *title_p     /*<O> Text tttle which can be 
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_add_title_line
(

    UF_SF_LEGEND_title_p_t title_p, /*<I> Title structure to add line of text.*/
                                                                        
    char *line_str                 /*<I> Null terminated character string
                                         to add. */
...
History: Originally released in V19.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_LEGEND_format_real_to_str
(

      double value,   /*<I> Real value to format. */
      char *text_str  /*<I> Formated text string.  No memory is allocated.
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_SF_set_edge_density  
(
...
*******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_library_materials (
char*     type_filter,      /* <I>
...
History: Originally released in NX2
*******************************************************************************/
extern UFUNEXPORT int UF_SF_retrieve_library_material (
char*     libref,            /* <I>
 ...
 *
 **************************************************************************/
extern UFUNEXPORT int UF_SF_export_expression  ( void );
...
.* History: 
 ************************************************************************/
extern UFUNEXPORT int UF_SF_partition_body
(
...
.* History: 
 ************************************************************************/
extern UFUNEXPORT int UF_SF_partition_body_nx5
(
...
History: Originally released in NX2
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_userdef_midsrf
(
...
History: Originally released in NX2
*******************************************************************************/
extern UFUNEXPORT int UF_SF_edit_userdef_midsrf
(
    UF_SF_midsrf_user_parms_p_t parms_p, 
                               /* <I> 
...
History: Originally released in NX2
******************************************************************************/
extern UFUNEXPORT int UF_SF_is_userdef_midsrf 
( 
 ...
 * History: 
 ************************************************************************/
extern UFUNEXPORT int UF_SF_cae_information
(
...
******************************************************************************/
extern UFUNEXPORT int UF_SF_reset_element_ids
(
...
History: Originally released in NX3
******************************************************************************/
extern UFUNEXPORT int UF_SF_reset_node_ids
(
    int start_id   /*<I> Start ID */
);
...
History: Originally released in NX2
******************************************************************************/
extern UFUNEXPORT int UF_SF_is_midsrf 
( 
   tag_t     sheet_body_tag,     /*<I> Tag of given object */ 
   logical  *is_midsrf,          /*<O> Flag signifying the outcome: 
...
History: Originally released in NX2
******************************************************************************/
extern UFUNEXPORT int UF_SF_free_midsrf_user_parms 
(
...
History: Originally released in NX2
******************************************************************************/
extern UFUNEXPORT int UF_SF_ask_midsrf_frec_type 
( 
...
History: Originally released in NX2
******************************************************************************/
extern UFUNEXPORT int UF_SF_facepair_ask_midsrf_frec  
( 
...
History: Originally released in NX2
******************************************************************************/
extern UFUNEXPORT int UF_SF_create_swept_hex_mesh
(
...
History: Originally released in V17.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_update_scenario ( void );
...
*********************************************************************/
extern UFUNEXPORT tag_t UF_SF_map_object_to_current_part
(
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT tag_t UF_SF_idealized_part_ask_master_part
(
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT logical UF_SF_is_idealized_part
(
    tag_t           idealized_part_tag  /* <I> Tag of a Idealized Part */
);
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT int UF_SF_create_fem
(
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT tag_t UF_SF_fem_ask_cad_part
(
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT logical UF_SF_is_fem
(
    tag_t           fem_tag     /* <I> Tag of a fem */
);
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT int UF_SF_create_simulation
(
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT tag_t UF_SF_simulation_ask_fem
(
...
History: Originally released in NX4.0
*********************************************************************/
extern UFUNEXPORT logical UF_SF_is_simulation
(
    tag_t           simulation_tag     /* <I> Tag of a Simulation */
);
...
* History:
******************************************************************************/
extern UFUNEXPORT int UF_SF_auto_create_mesh_mating_condition 
(
...
*****************************************************************************/  
extern   UFUNEXPORT int     UF_SF_write_report ( void );
...
* History: Released in NX3
*****************************************************************************/  
extern   UFUNEXPORT int     UF_SF_create_report ( void );
 ...
 * History: Released in NX3
 * **********************************************************************************/
extern UFUNEXPORT int UF_SF_create_hardpoint_on_geom
(
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SF_property_ask_name_nx (
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SF_property_ask_type_nx (
tag_t property_tag,                     /* <I>
                                        The tag of the property.
                                        */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SF_property_set_value_nx (
tag_t       property_tag, /* <I>
                          The tag of the property.
                          */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SF_property_ask_value_nx (
tag_t  property_tag, /* <I>
                     The tag of the property.
                     */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SF_solve_active_solution_nx (
int format_choice /* <I>
                  Format/Solve option
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_solution_descriptor_ask_name_nx ( 
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_solution_ask_num_allowable_step_descriptors_nx ( 
tag_t sol_desc_tag,       /* <I>
                          Solution descriptor tag.
                          */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_solution_ask_nth_allowable_step_descriptor_nx ( 
tag_t sol_desc_tag,        /* <I>
                           Solution descriptor tag.
                           */
int   index,               /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_solution_ask_step_descriptor_nx ( 
tag_t sol_desc_tag,        /* <I>
                           Solution descriptor tag.
                           */
char * const step_desc_name,               /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_solution_ask_lbc_desc_valid_nx ( 
tag_t sol_desc_tag, /* <I>
                    Solution descriptor tag.
                    */
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_step_descriptor_ask_name_nx ( 
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_step_ask_lbc_desc_valid_nx ( 
tag_t step_desc_tag,                /* <I>
                                    Step descriptor tag.
                                    */
tag_t lbc_desc_tag,                 /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_num_solvers_nx ( 
int *num_solvers /* <O>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_nth_solver_nx (
int     index,                         /* <I>
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_solver_nx 
( 
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_num_languages_nx 
( 
...
History: Originally released in NX3.0
***************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_nth_language_nx 
( 
tag_t   solver_desc_tag,               /* <I>
                                       Solver descriptor tag.
                                       */
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SFL_ask_language_nx 
( 
tag_t       solver_desc_tag,              /* <I>
                                          Solver descriptor tag.
                                          */
...
* History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_alloc_defeature_parms
(
...
* History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_free_defeature_parms
(
...
* History: Originally released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_SF_create_defeature_body
( 
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edit_defeature_parms 
( 
  tag_t   feature_tag,         /* <I> 
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_locate_named_dursol_nx(
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_num_dursols_nx (
int *num_dursols   /* <O>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_nth_dursol_nx (
int    index,     /* <I>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_create_dursol_nx (
const char* name,   /* <I>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_delete_dursol_nx (
tag_t dursol_tag /* <I>
                 Durability Solution tag.
                 */
);
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_dursol_nx (
tag_t             dursol_tag,              /* <I>
                                           Durability Solution tag.
                                           */
char*             dursol_name,             /* <O>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edit_dursol_nx (
tag_t             dursol_tag,              /* <I>
                                           Durability Solution tag.
                                           */
const char*       dursol_name,             /* <I>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_dursol_add_load_nx (
tag_t dursol_tag,  /* <I>
                   Durability Solution tag
                   */
tag_t lv_tag       /* <I>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_dursol_remove_load_nx (
tag_t dursol_tag, /* <I>
                  Durability Solution tag
                  */
tag_t lv_tag      /* <I>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_dursol_ask_load_count_nx (
tag_t dursol_tag, /* <I>
                  Durability Solution tag
                  */
int   *num_lv     /* <O>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_dursol_ask_load_nx (
tag_t dursol_tag, /* <I>
                  Durability Solution tag
                  */
int   lv_index,   /* <I>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_dursol_locate_all_members_nx (
tag_t         dursol_tag,      /* <I>
                               Durability Solution tag 
                               */
int*          num_lv,          /* <O>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_create_lv_nx (
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_delete_lv_nx (
tag_t dursol_tag, /* <I>
                  Durability Solution tag
                  */
tag_t lv_tag      /* <I>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_lv_nx (
tag_t                    lv_tag,            /* <I>
                                            Load Variation tag
                                            */
char*                    lv_name,           /* <O>
...
History: Originally released in NX3.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edit_lv_nx (
tag_t                    lv_tag,          /* <I>
                                          Load Variation tag
                                          */
const char*              lv_name,         /* <I>
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_all_polygon_bodies (  int        *iNumberOf_PolygonBodies_p,/*<O> Number of polygon bodies in the fem*/
                                                      tag_t      **PolygonBodies_pp        /*<OF,len:iNumberOf_PolygonBodies_p> Tags of polygon bodies*/);
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_polygon_body_ask_type (  tag_t    PolygonBody_tag,/*<I> Polygon body tag*/
                                                     int      *body_type_p    /*<O> Polygon body type; 0=>Solid; 1=>Sheet not mid-surface; 2=>sheet mid surface*/);
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_body_ask_edges (  tag_t      cae_tag,  /*<I> Polygon body*/
                                   int        *iNumberOfEdgeTags_p,/*<O> Number of polygon edges */
                                   tag_p_t    *edgeTags_pp       /*<OF,len:iNumberOfEdgeTags_p> Tags of polygon edges */);
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_body_ask_faces (  tag_t      cae_tag,             /*<I> Polygon body */
                                   int        *iNumberOfFaceTags_p,/*<O> Number of polygon faces */
                                   tag_p_t    *faceTags_pp         /*<OF,len:iNumberOfFaceTags_p>Polygon faces*/);
/****************************************************************************
This function will get MODL(UG) body related to Polygon body.

Environment: Internal  and  External

History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_body_ask_modl_body (  tag_t      cae_tag,     /*<I> Polygon body */
                                       tag_p_t    modl_body_p /*<O> CAD MODL body */);
/****************************************************************************
This function will get Polygon body related to MODL(UG) body.

Environment: Internal  and  External

History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_modl_body_ask_body ( tag_t      modl_body,  /*<I> CAD MODL body */
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_body_ask_volume_and_centroid( tag_t      cae_tag,   /*<I> Polygon body */
                                               double     *pdVolume, /*<O> Volume */
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_body_ask_bounding_box (  tag_t      cae_tag,   /*<I> Polygon body */
                                          double     padBoundingVolume[6]  /*<O> Bounding box */);
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_face_ask_edges (  tag_t      cae_tag,             /*<I> Polygon face */
                                   int        *iNumberOfEdgeTags_p,/*<O> Number of polygon edges */
                                   tag_p_t    *edgeTags_pp /*<OF,len:iNumberOfEdgeTags_p> Polygon edges */)       ;
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_face_ask_body (  tag_t      cae_tag,        /*<I> Polygon face */
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_face_ask_area (  tag_t      cae_tag, /*<I> Polygon face */
                                  double     *pdArea  /*<O> Face Area */ ) ;
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_face_ask_bounding_box (  tag_t      cae_tag, /*<I> Polygon face */
                                          double     padBoundingBox[6] /*<O> Bounding box */);
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_face_ask_adjacent_faces (  tag_t      cae_tag, /*<I> Polygon face */
                                            int        *iNumberOfFaceTags_p,/*<O> Num of faces */
                                            tag_p_t    *Faces_pp /*<OF,len:iNumberOfFaceTags_p> Polygon faces*/)          ;
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_face_evaluate_closest_point ( tag_t      cae_tag, /*<I> Polygon face*/
                                 int numP,      /*<I> number of evaluations in U parameter */
                                 double xyz[],  /*<I> Input 3d points (can be NULL) */
                                 double xyzCl[],/*<O> Output closest 3d points (can be NULL) */
                                 double uvCl[], /*<O> uv values (can be NULL) */
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_face_evaluate_param_location (  tag_t      cae_tag, /*<I> Polygon face*/
                                                        double     adParam[2], /*<I> UV Param values */
                                                        double     adOutPoint[3] /*<O> Corresponding point */ );  
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_ask_faces ( tag_t      cae_tag,             /*<I> Polygon edge */
                                  int        *iNumberOfFaceTags_p,/*<O> Num of faces */
                                  tag_p_t    *Faces_pp /*<OF,len:iNumberOfFaceTags_p> Polygon faces*/)          ;
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_ask_adjacent_edges (  tag_t      cae_tag,             /*<I> Polygon edge */
                                            int        *iNumberOfEdgeTags_p,/*<O> Num of edges */
                                            tag_p_t    *edgeTags_pp /*<OF,len:iNumberOfEdgeTags_p> Polygon edges */ )       ;
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_ask_body ( tag_t      cae_tag,        /*<I> Polygon edge */
                                 tag_p_t    body_p /*<O> Polygon body */)       ;
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_ask_bounding_box (  tag_t      cae_tag,/*<I> Polygon edge */
                                          double     padBoundingBox[6] /*<O> Bounding box */);
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_ask_end_points (tag_t      cae_tag,         /*<I> Polygon edge */
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_ask_length (  tag_t      cae_tag,  /*<I> Polygon edge */
                                               double     *pdLength /*<O> Length of edge */ );
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_evaluate_closest_point (  tag_t      cae_tag, /*<I> Polygon edge*/
                                                       double     adPoint[3], /*<I> Input point to project*/
                                                       double     adOutPoint[3], /*<O> Projected point */
                                                       double     *pdParam  /*<O>Param value between 0 to 1*/ );    
/****************************************************************************
This function will find 3d location for given param value.
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_edge_evaluate_param_location (  tag_t      cae_tag, /*<I> Polygon edge*/
                                                        double     dParam, /*<I> Param value between 0 to 1*/
                                                        double     adOutPoint[3] /*<O> Corresponding point */ );   
/****************************************************************************
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_find_minimum_distance ( tag_t     entity_1,   /*<I> Polygon edge/face/body */
...
History: Originally released in NX4.0
*****************************************************************************/
extern UFUNEXPORT int UF_SF_ask_closest_point ( double    point[3],          /*<I> Input point */
...
*********************************************************************/
extern UFUNEXPORT int UF_SF_ask_num_mesh_recipes( tag_t fem_tag,        /*<I> FEM part */
...
History: Originally released in NX4.01
*********************************************************************/
extern UFUNEXPORT int UF_SF_ask_nth_mesh_recipe(
tag_t   fem_tag,            /* <I>
                            FEM part
                            */
int     index,              /* <I>
