...
*******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_sim_engine
( 
 ...
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_mount_kim_comp
(
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_unmount_kim_comp
(
   UF_SIM_engine_p_t engine,    /* <I> - the simulation engine object         */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_mount_tool
(
   UF_SIM_engine_p_t engine,           /* <I> - the simulation engine object  */
   ...
   double            duration,         /* <I> - time in seconds to complete   
                                                this mount on the machine tool */
   char*             tool_name         /* <O> - name of the tool              */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_unmount_tool
(
   UF_SIM_engine_p_t engine,       /* <I> - the simulation engine object      */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_move_linear_axis
(
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_move_rotary_axis
(
   UF_SIM_engine_p_t engine_id, /* <I> - the simulation engine object         */
   char*             axis,      /* <I> - the name of the linear NC-axis       */
   double            value,     /* <I> - the new position of the axis         */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_parameter
(
   UF_SIM_engine_p_t  engine,  /* <I> - the simulation engine object          */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_feedback_message
(
   UF_SIM_engine_p_t engine, /* <I> - the simulation engine object            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_update
(
   UF_SIM_engine_p_t engine, /* <I> - the simulation engine object            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_step
(
   UF_SIM_engine_p_t engine, /* <I> - the simulation engine object            */
   const char*       label   /* <I> - name of event                           */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_channel
(
   UF_SIM_engine_p_t engine,        /* <I> - the simulation engine object     */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_mtd_init
(
   UF_SIM_engine_p_t engine   /* <I> - the simulation engine object           */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_mtd_reset
(
   UF_SIM_engine_p_t engine   /* <I> - the simulation engine object           */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_activate_tool
(
   UF_SIM_engine_p_t engine,   /* <I> - the simulation engine object          */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_feed
(
   UF_SIM_engine_p_t  engine,  /* <I> - the simulation engine object          */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_speed
(
   UF_SIM_engine_p_t  engine,  /* <I> - the simulation engine object          */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_coolant
(
   UF_SIM_engine_p_t  engine,   /* <I> - the simulation engine object         */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_cutting_mode
(
   UF_SIM_engine_p_t  engine,    /* <I> - the simulation engine object        */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_transform_offset_acs_to_mtcs
(
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_transform_matrix_acs_to_mtcs
(
   UF_SIM_engine_p_t engine,        /* <I> - simulation engine object         */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_kim_comp_name_by_id
(
   UF_SIM_engine_p_t engine,       /* <I> - simulation engine object          */
   int               system_class, /* <I> - system class of the searched comp */
   char*             comp_id,      /* <I> - the id of the component           */
   char*             comp_name     /* <O> - name of the component             */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_tool_offsets
(
   UF_SIM_engine_p_t engine,    /* <I> - simulation engine object             */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_msg_nc_command
(
   UF_SIM_engine_p_t engine, /* <I> - simulation engine object                */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_msg_user_feedback
(
   UF_SIM_engine_p_t engine, /* <I> - simulation engine object                */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_start_of_simulation
(
   UF_SIM_engine_p_t  engine /* <I> - simulation engine object                */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_end_of_simulation
(
   UF_SIM_engine_p_t  engine /* <I> - simulation engine object                */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_junction_xform
(
   UF_SIM_engine_p_t engine,   /* <I> - simulation engine object              */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_create_junction
(
   UF_SIM_engine_p_t engine,           /* <I> - simulation engine object      */
   const char*       jct_name,         /* <I> - the name of the junction      */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_delete_junction
(
   UF_SIM_engine_p_t engine,     /* <I> - simulation engine object            */
   const char*       jct_name    /* <I> - the name of the junction            */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_is_junction_exist
(
   UF_SIM_engine_p_t engine,     /* <I> - simulation engine object            */
   const char*       jct_name,   /* <I> - the name of the junction            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_current_zcs_junction
(
   UF_SIM_engine_p_t engine,        /* <I> - simulation engine object         */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_init_junction_xform
(
   UF_SIM_engine_p_t engine,     /* <I> - simulation engine object            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_mtd_units
(
   UF_SIM_engine_p_t  engine,    /* <I> - simulation engine object            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_mtd_units
(
   UF_SIM_engine_p_t  engine,    /* <I> - simulation engine object            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_axis_position
(
   UF_SIM_engine_p_t  engine,    /* <I> - simulation engine object            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_dialog_set_item
(
   UF_SIM_engine_p_t engine,   /* <I> - simulation engine object             */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_mtcs_junction
(
   UF_SIM_engine_p_t engine,  /* <I> - simulation engine object               */
   char*             jct_name /* <O> - the name of the queried junction       */
);
 ...
 * character array has to be of length 2*UF_SV_KIM_MAX_NAME_LEN+2.
 *
 * Environment: Internal  and  External
 * See Also:
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_axis_dof_junction
(
   UF_SIM_engine_p_t            engine,   /* <I> - simulation engine object  */
   const char*                  axis,     /* <I> - the name of the axis      */
   char*                        jct_name, /* <O> - the name of the
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_axis_limits
(
   UF_SIM_engine_p_t engine, /* <I> - simulation engine object                */
   const char*       axis,   /* <I> - the name of the axis                    */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_delay
(
   UF_SIM_engine_p_t engine,  /* <I> - simulation engine object               */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_cording_tol
(
   UF_SIM_engine_p_t engine,     /* <I> - simulation engine object            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_dbg_start
(
   UF_SIM_engine_p_t engine, /* <I> - simulation engine object                */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_dbg_end
(
   UF_SIM_engine_p_t engine /* <I> - simulation engine object                */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_dbg_write_message
(
   UF_SIM_engine_p_t engine, /* <I> - simulation engine object               */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_dbg_set_output
(
   UF_SIM_engine_p_t engine, /* <I> - simulation engine object                */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_is_junction_dependent
(
   UF_SIM_engine_p_t engine,    /* <I> - simulation engine object             */
   const char*       jct_name,  /* <I> - name of the junction                 */
   const char*       axis_name, /* <I> - name of the axis                     */
   char*             dependent  /* <O> - dependency of the junction           */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_status_send_nc_command_msg
(
   UF_SIM_engine_p_t engine,    /* <I> - simulation engine object             */
   logical           onOff      /* <I> - switch to set the status             */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_status_send_nc_command_msg
(
   UF_SIM_engine_p_t engine,   /* <I> - simulation engine object             */
   logical           *onOff    /* <O> - the status                           */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_axis_rotary_dir_mode
(
   UF_SIM_engine_p_t          engine,    /* <I> - simulation engine object    */
   const char*                axis_name, /* <I> - name of the axis            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_axis_rotary_dir_mode
(
   UF_SIM_engine_p_t          engine,    /* <I> - simulation engine object    */
   const char*                axis_name, /* <I> - name of the axis            */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_axis_allow_reversal
(
   UF_SIM_engine_p_t engine,        /* <I> - simulation engine object         */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_axis_is_reversal_allowed
(
   UF_SIM_engine_p_t   engine,         /* <I> - simulation engine object      */
   const char*         axis_name,      /* <I> - name of the NC axis           */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_if_degof_exists
(
   UF_SIM_engine_p_t engine,      /* <I> - simulation engine object           */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_degof_data
(
   UF_SIM_engine_p_t          engine,     /* <I> - simulation engine object   */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_comp_from_dof
(
   UF_SIM_engine_p_t engine,     /* <I> - simulation engine object            */
   char*             degof_name, /* <I> - name of the degree of freedom       */
   char*             comp_name   /* <O> - the name of the component           */
);
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_find_comp_by_name
(
   UF_SIM_engine_p_t  engine,     /* <I> - simulation engine object           */
 ...
 * History: Released in NX2
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_nc_axes_of_mtool
(
   UF_SIM_engine_p_t engine,        /* <I> - simulation engine object         */
   int*              no_of_axes,    /* <O> - Number of NC axes                */
   char*             axis_name_list /* <O> - list of NC axis names            */
);
 ...
 *
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_set_immediate_update
(
   UF_SIM_engine_p_t engine,          /* <I> - simulation engine object       */
 ...
 *
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_ask_immediate_update
(
   UF_SIM_engine_p_t engine,         /* <I> - simulation engine object        */
 ...
 *
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_msg_program_mark
(
   UF_SIM_engine_p_t engine,         /* <I> - simulation engine object        */
 ...
 *
 ******************************************************************************/
extern UFUNEXPORT int UF_SIM_convert_nurbs_to_position_data
(
   UF_SIM_engine_p_t engine,           /* <I> - simulation engine object      */
