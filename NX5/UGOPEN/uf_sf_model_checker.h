...
This is the UG/Open public interface to the scenario model checker.
...
#define UF_SF_MAX_NAME_LENGTH MAX_FSPEC_SIZE
/**************************************************
...
struct UF_SF_THRESHOLD_data_s {
    ...
    char                           solver_name[UF_SF_MAX_NAME_LENGTH];
 ...
 *            >0 for error
 *************************************************************************/
extern UFUNEXPORT int UF_SF_check_model_comprehensive
(
 ...
 *            >0 for error
 *************************************************************************/
extern UFUNEXPORT int UF_SF_check_model_duplicate_nodes
(
   int num_meshes,              /*<I>*/
   tag_p_t mesh_tags,           /*<I>*/
