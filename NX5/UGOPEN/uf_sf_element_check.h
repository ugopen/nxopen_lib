...
{
    char  part_file[UF_SF_LANG_MAX_NAME_LENGTH];   /*  part file name  */
    char  solver[UF_SF_LANG_MAX_NAME_LENGTH];      /*  solver name     */
...
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_aspect_ratio (
UF_SF_element_type_t element_type ,/* <I> element type.  */
double* abspos ,/* <I> pointer to the node location in absolute
                coordinates.
                */
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_warp(
UF_SF_element_type_t element_type ,/* <I> element type.  */
double* abspos ,/* <I> pointer to the node location in absolute
                coordinates.
                */
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_skew (
UF_SF_element_type_t element_type ,/* <I> element type.  */
double* abspos ,/* <I> pointer to the node location in absolute
                coordinates.
                */
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_taper (
UF_SF_element_type_t element_type ,/* <I> element type.  */
double* abspos ,/* <I>
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_twist (
UF_SF_element_type_t element_type ,/* <I> element type.  */
double* abspos ,/* <I>
                pointer to the node location in absolute
                coordinates.
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_jacobian_ratio (
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_jacobian_zero (
UF_SF_element_type_t     element_type,/* <I>
                element type.
                */
double* abspos ,/* <I>
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_tetra_angle(
double* abspos ,/* <I>
                pointer to the node location in absolute
                coordinates.
                */
...
History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_2d_angle(
UF_SF_element_type_t     element_type,/* <I>
                element type.
                */
double* abspos ,/* <I>
...
/****************************************************************************
 ...
 History: released in v18.0
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_element_check( tag_t mesh_tag, /* <I>
...
/******************************************************************************
  ...
  returns:
        int               = 0  - successful completion
                          > 0  - error
******************************************************************************/
extern UFUNEXPORT int UF_SF_mc_tet_collapse
(
    UF_SF_element_type_t      element_type,     /*<I>*/
    double                   *abspos ,          /*<I>*/
    int                       node_count ,      /*<I>*/
