 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_ask_cut_regions_exist
(
 ...
 * 
 ************************************************************************/ 
extern UFUNEXPORT int UF_TURN_ask_cut_region_of_index
( 
    tag_t       oper_tag, /* <I> Tag of the operation for which
                                 cut regions are to be found                  */ 
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_save_spinning_ipw_as_part
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_teachmode_create_subop
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT double UF_TURN_map_angle_from_wcs
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT double UF_TURN_map_angle_to_wcs
(
    tag_t  oper_tag,   /* <I> Tag of the operation for which angle should be mapped */
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_tooltrackingpoint_from_wcs
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_tooltrackingpoint_to_wcs
(
    tag_t oper_tag,             /* <I> Tag of the operation for which the
	                                   tool tracking point should be mapped */
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_vec2_from_wcs
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_vec2_to_wcs
(
    tag_t oper_tag,      /* <I> Tag of the operation for which 2D vector should be mapped */
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_pnt2_from_wcs
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_pnt2_to_wcs
(
    tag_t oper_tag,      /* <I> Tag of the operation for which 2D point should be mapped */
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_vec3_from_acs
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_vec2_to_acs
(
    tag_t oper_tag,      /* <I> Tag of the operation for which 3D vector should be mapped */
    double scs_vec2[2],  /* <I> 2D vector relative to spindle coordinate system */
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_pnt3_from_acs
(
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_map_pnt2_to_acs
(
    tag_t oper_tag,      /* <I> Tag of the operation for which 3D point should be mapped */
    double scs_pnt2[2],  /* <I> 2D point relative to spindle coordinate system */
 ...
 *
 ************************************************************************/
extern UFUNEXPORT int UF_TURN_ipw_box
(
    tag_t  oper_tag,                 /* <I> Tag of the operation for which
 ...
 ********************************************************************** */
extern UFUNEXPORT int UF_TURN_create_parametric_blank
(
 ...
 * History: Released in NX2
 ********************************************************************** */
extern UFUNEXPORT int UF_TURN_create_blank_from_boundary
(
    tag_t                               object_tag,      /* <I> the parent object of the 
                                                                boundary */
