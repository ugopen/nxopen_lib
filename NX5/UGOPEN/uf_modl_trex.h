...
See Also:  UF_MODL_create_ask_trim_extend
...
for editing also. One can query for the creation parameters by calling UF_MODL_ask_trim_extend.
...
See Also:  UF_MODL_create_edit_trim_extend
