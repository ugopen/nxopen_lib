...
{
    char      plot_of_original[MAX_FSPEC_SIZE+1] = "original_plot.hpp"; 
    char      plot_of_revised [MAX_FSPEC_SIZE+1] = "revised_plot.hpp";
    char      result_plot     [MAX_FSPEC_SIZE+1] = "result_plot.hpp";
