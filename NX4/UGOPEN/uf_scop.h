 ...
 *
 * File description:
 *    This file contains the UG/Open interface for accessing drive data
...
typedef enum
{
	/* There are three data types for surface interpolation. */
	UF_SCOP_TX_INTP_DATYPE_VECTOR = 0,
	UF_SCOP_TX_INTP_DATYPE_ANGLE_PS = 1,
	UF_SCOP_TX_INTP_DATYPE_ANGLE_DS = 2
	/* However, there are only two data types for curve interpolation.
	   They are :
	   UF_SCOP_TX_INTP_DATYPE_VECTOR = 0,
	   UF_SCOP_TX_INTP_DATYPE_ANGLE_PS = 1
	*/
 ...
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_ask_tx_intp_data_type
(
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_set_tx_intp_data_type
(
    tag_t    object_tag,   /*  <I> The operation object  */
    UF_SCOP_tx_intp_data_type_t      tx_intp_data_type     
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_ask_tx_intp_method
(
    tag_t    object_tag,   /*  <I> The operation object  */
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_set_tx_intp_method
(
    tag_t    object_tag,   /*  <I> The operation object  */
    UF_SCOP_tx_intp_method_t      tx_intp_method     
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_ask_tx_intp_vector_data
(
    tag_t    object_tag,   /*  <I> The operation object  */
    int      *count,       /*  <I> The number of the vector data set */
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_set_tx_intp_vector_data
(
    tag_t    object_tag,   /*  <I> The operation object  */
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_ask_row_column_count
(
    tag_t    object_tag,   /*  <I> The operation object  */
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_get_next_drive_point
(
    tag_t          object_tag,   /*  <I> The operation object  */
 ...
 * History : Released in NX3.0
 ****************************************************************************/
extern UFUNEXPORT int UF_SCOP_rewind_drive_point
(
    tag_t          object_tag   /*  <I> The operation object  */
);
 ...
 * History: Released in NX3.0
********************************************************************** */
extern UFUNEXPORT int UF_SCOP_display_uv_dirs
(
 ...
 * History: Released in NX3.0
********************************************************************** */
extern UFUNEXPORT int UF_SCOP_eval_grid
(
    tag_t                 object_tag,      /* <I> */ 
