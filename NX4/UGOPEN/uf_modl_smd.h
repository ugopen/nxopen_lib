...
struct UF_MODL_smpunch_data_s
{
  ...
  char     depth[UF_MAX_EXP_LENGTH + 1];        /* <len:UF_MAX_EXP_LENGTH + 1>String for Depth */
  char     die_radius[UF_MAX_EXP_LENGTH + 1];   /* <len:UF_MAX_EXP_LENGTH + 1>String for Die Radius */
  char     taper_angle[UF_MAX_EXP_LENGTH + 1];  /* <len:UF_MAX_EXP_LENGTH + 1>String for Taper Angle */
  char     punch_radius[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH + 1>String for Punch Radius */
  char     cone_depth[UF_MAX_EXP_LENGTH + 1];   /* <len:UF_MAX_EXP_LENGTH + 1>String for Cone Depth */
...
{
    char           diameter[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH> Diameter of SMHole */
    char           depth[UF_MAX_EXP_LENGTH + 1];    /* <len:UF_MAX_EXP_LENGTH> Depth of SMHole.  Only
                                                       used for depth type
                                                       SMHoles */
    char           tip_angle[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH> Tip angle of SMHole.
                                                        Only used for depth
                                                        type SMHoles */
    tag_t          edge1;                            /* Tag of the first
                                                        offset edge */
    char           offset1[UF_MAX_EXP_LENGTH + 1];   /* <len:UF_MAX_EXP_LENGTH> Offset distance from
                                                        first offset edge */
    tag_t          edge2;                            /* Tag of the second
                                                        offset edge */
    char           offset2[UF_MAX_EXP_LENGTH + 1];   /* <len:UF_MAX_EXP_LENGTH> Offset distance from
                                                        second offset edge */
...
{
    char                length[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH> Length of SMSlot */
    char                width[UF_MAX_EXP_LENGTH + 1];  /* <len:UF_MAX_EXP_LENGTH> Width of SMSlot */
    char                depth[UF_MAX_EXP_LENGTH + 1];  /* <len:UF_MAX_EXP_LENGTH> 
                                                          Depth of SMSlot.
                                                          Only used for depth
                                                          type SMSlots */
    tag_t               edge1;                         /* Tag of the first
                                                          offset edge */
    char                offset1[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH>
														Offset distance
                                                           from first offset
                                                           edge */
    tag_t               edge2;                          /* Tag of the second
                                                           offset edge */
    char                offset2[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH>
                                                           Offset distance
                                                           from second offset
                                                           edge */
...
struct UF_MODL_gflange_options_data_s { 
    ...
    char        r_value[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH + 1> 
    ...
    char        tolerance[UF_MAX_EXP_LENGTH + 1];   /* <len:UF_MAX_EXP_LENGTH + 1> 
                                                   Tolerance */ 
    char        max_sample_pts[UF_MAX_EXP_LENGTH + 1]; /* <len:UF_MAX_EXP_LENGTH + 1> 
                                                          Maximum number of
                                                          sample points */ 
...
struct UF_MODL_gflange_data_s { 
    ...
    char thickness_str[UF_MAX_EXP_LENGTH+1]; /* <len:UF_MAX_EXP_LENGTH+1>
...
typedef struct UF_MODL_smbend_data_s
{
    ...
    UF_MODL_smbend_curve_e_t  app_curve_type;     /* Application Curve Type
                                                     ...
                                                     SMBEND_CONTOUR_LINE
                                                     SMBEND_MOLD_LINE        */
    char                      angle[UF_MAX_EXP_LENGTH+1]; /* <len:UF_MAX_EXP_LENGTH+1> 
                                                     Bend Angle      */
    UF_MODL_smbend_angle_e_t  angle_type;         /* Angle Type
                                                     SMBEND_BEND_ANGLE
                                                     SMBEND_INCLUDED_ANGLE   */
    char                      radius[UF_MAX_EXP_LENGTH+1]; /* <len:UF_MAX_EXP_LENGTH+1> 
                                                              Bend Radius    */
    ...
    UF_MODL_smbend_stat_side_e_t stat_side;   /* Stationary Side
                                                     SMBEND_AS_SPECIFIED
                                                     SMBEND_OPPOSITE_SIDE    */
    char                      baf[UF_MAX_EXP_LENGTH+1]; /* <len:UF_MAX_EXP_LENGTH+1> 
                                                           Bend Allowance Formula*/
} UF_MODL_smbend_data_t, *UF_MODL_smbend_data_p_t;
/* end of smbend feature structure*/
...
/* end of smbend converted corner feature structure*/
...
/* end of smbend converted cylinder feature structure*/
...
typedef struct UF_MODL_bend_operation_data_s      /* Bend operation data */
{ 
    ...
    char                       target_angle[UF_MAX_EXP_LENGTH+1]; /* <len:UF_MAX_EXP_LENGTH+1> 
                                                     Target angle */ 
