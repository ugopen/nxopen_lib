...
UG/Open definitions.  These are general typedefs and macros required by
all UG/Open interfaces.  Typedefs that are specific to a particular
...
#else
#error tag_t is now an unsigned int.  Your compilations had it defined as an int, you will need to deal with the change.
#endif
#endif
