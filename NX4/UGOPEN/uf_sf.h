...
/****************************************************************************
Returns tag of the current language. The active Solution defines the
current language. If no Solution is active, then the default environment
...
/****************************************************************************
Given a language tag and element descriptor name, returns the
tag of the element descriptor.
...
Valud only when the work part is a Simulation.
