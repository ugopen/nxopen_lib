...
Open API interface to Unigraphics Assemblies.  The major areas covered by these
routines are:
...
These subroutines offer access to assembly mating conditions. A "mating
condition" positions a component in an assembly by specifying how that
component is mated to other objects in the assembly. Each mating condition
consists of one or more "constraints". Each constraint describes how one
feature in the mated component fits to one feature in the rest of the assembly.

Depending upon the number of constraints specified, a mating condition may have
one or more "degrees of freedom". Each degree of freedom defines a way in which
the mated component is still free to move.

Using these subroutines, you can:

    Apply a mating condition to a component.
    Get the data that defined a mating condition.
    Check the validity of a mating condition's data structures.
    Delete a mating condition.
    Solve a mating condition and obtain information about it.

When performing a Component to Component Mating Condition (CCMC), the
UF_ASSEM_constraint_s data structure must be filled out in a specified way
depending on whether you have a first constraint or a subsequent constraint
of the CCMC.

The following fields of the UF_ASSEM_constraint_s structure must be filled in
for the first constraint of a CCMC:

    from_status - Same as ordinary mating constraint

    to_status - Same as ordinary mating constraint

    mate_type - Can be any of the three types - ignored

    from_type - Must be UF_ASSEM_component

    to_type - Must be UF_ASSEM_component

    from - Null (the components are being mated not the members of a component)

    from_part_occ - The mated part occurrence

    to  - Null (the components are being mated not the members of a component)

    to_part_occ - Part_occurrence mated to

    offset - Same as ordinary mating constraint

    name - Same as ordinary mating constraint

    user_name - Same as ordinary mating constraint

The following fields of the UF_ASSEM_constraint_s structure must be filled in
for subsequent constraints of a CCMC:

   from_status - Same as ordinary mating constraint

   to_status - Same as ordinary mating constraint

   mate_type - Can be any of the three types (UF_ASSEM_mate and UF_ASSEM_align
               translate the 'mated part occurrence'. UF_ASSEM_orient rotates
               the "mated part occurrence".
   ...
   CAUTION: For subsequent constraints of a CCMC, only one input object is
            allowed.  That object is used to determine the direction for
            translation or the axis of rotation.

            If the object selected is a member of the "mated part occurrence"
            (the from_part_occ of the first constraint), the "from" fields must
            be filled in with the object's information and the "to" fields are
            left null.

   from_type - Type of object selected

   to_type - Null

   from - The object selected
   ...
   If the object selected is a NOT a member of the "mated part occurrence"
   (the from_part_occ of the first constraint), the "to" fields must be filled
   in with the object's information and the "from" fields are left null.

   from_type - Null

   to_type - Type of object selected

   from - Null

   from_part_occ - Null

   to - The object selected

   to_part_occ - If the object selected was a member of a part occurrence, put
                 that part occurrence here.  If the object selected was not a
                 member of a part occurrence, leave null.

Component Arrays

These subroutines offer access to the Unigraphics database component arrays.
...
Tag               - is being used for the old term EID (Entity IDentifier) and
                    ...
                    object in the Unigraphics database.  The objects are not
...
Reference Set     - This is a named collection of geometry from a Unigraphics
...
const char * refset_name ,/* <I>
                          ...
                          */
const char * instance_name ,/* <I>
                            Name of instance to add to parent part
                            */
int units ,/* <I>
           1    = MM
           2    = Inches
...
tag_t component ,/* <I>
                 ...
                 */
char part_name[MAX_FSPEC_SIZE+1] ,/* <O>
                                  Name of part
                                  */
char refset_name[MAX_ENTITY_NAME_SIZE+1] ,/* <O>
                                          Name of the reference set in use
                                          */
char instance_name[UF_CFI_MAX_FILE_NAME_SIZE] ,/* <O>
                                            name of instance
                                            */
double origin[3] ,/* <O>
...
tag_t ref_set ,/* <I>
               ...
               */
char ref_set_name[MAX_ENTITY_NAME_SIZE+1] ,/* <O>
...
tag_t instance ,/* <I>
                Tag of instance to query for child part
                */
char part_fspec[MAX_FSPEC_SIZE+1]  /* <O>
...
Return:
         Returns the count of part occurrences in the list. If zero use
         UF_ERROR_ask_failure_code to check for error.
...
tag_t parent_part ,/* <I>
                   ...
                   */
const char * instance_name  /* <I>
                            Name of instance to obtain tag for
                            */
);/*<NEC>*/
...
*/
typedef logical (*UF_ASSEM_cset_fn_t)(tag_t member , /* <I> */ void *applData /* <I> */);
...
UF_ASSEM_mating_condition_p_t mc_data   /* <I/O>
...
extern UFUNEXPORT int uc5800(
   char *cp1,            /* <I>  Component name */
   char *cp2,            /* <I>  Component part fspec with extensions*/
   char *cp3,            /* <I>  Reference set name */
...
extern UFUNEXPORT void uc5801(
   ...
   char *cr2,    /* <O>  Component name */
   char *cr3,    /* <O>  Component part name */
   char *cr4,    /* <O>  Component reference set name */
...
extern UFUNEXPORT void uc5802(
   tag_t np1,    /* <I> Component entity id  */
   char *cp2,    /* <I> Component part name */
   char *cp3,    /* <I> Reference set name */
...
extern UFUNEXPORT int uc5816(
   char *cp1,    /* <I>   Component name */
   char *cp2,    /* <I>   Component part fpsec */
   char *cp3,    /* <I>   Reference set name
              0 = all of part */
   double *rp4,  /* <I>   Component information
              (1-9)   component orientation matrix
 ...
 *
 *****************************************************************************/
extern UFUNEXPORT void FTN(uf5804)(
tag_t *np1,    /* <I> Component entity id */
...
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_create_sequence(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_unprocessed_partoccs(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_sequences_in_part(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_create_step(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_set_time_of_step(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_time_of_step(
tag_t step,                     /* <I> The tag of the given step
                                */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_time_of_sequence(
tag_t sequence,                 /* <I> The tag of the given sequence
                                */
double *time                    /* <O> The time taken for the step
                                */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_set_cost_of_step(
tag_t step,                     /* <I> The tag of the given step
                            */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_cost_of_step(
tag_t step,                     /* <I> The tag of the given step
                            */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_cost_of_sequence(
tag_t sequence,                 /* <I> The tag of the given sequence
                            */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_steps(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_move_step(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_step_number(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_step_type(
tag_t step,                     /* <I> The tag of the step
                                */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_delete_step(
tag_t step              /* <I> The tag of the given step
                */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_delete_sequence(
tag_t sequence              /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_sequence_name(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_set_sequence_name(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
char *name                      /* <I> The name of the sequence
                                */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_sequence_description(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_set_sequence_description(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_set_step_increment(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_step_increment(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_preassemble_partocc(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_remove_preassembled(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_is_preassembled(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ignore_part_occ(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_remove_ignored(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_is_ignored(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
tag_t part_occ,                 /* <I> Tag of the part occurrence
                                */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_steps_of_part_occ(
tag_t sequence,             /* <I> The tag of the given sequence
                    */
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_part_occurrence_of_step(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_playback_sequence(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_activate_sequence(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_active_sequence(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_make_current_step(
...
History: Initially released in V18.0
*******************************************************************************/
extern int UFUNEXPORT UF_ASSEM_ask_current_step(
...
*******************************************************************************/
extern int  UFUNEXPORT UF_ASSEM_create_deformable_part( UF_ASSEM_deform_data_p_t data,  /* <I> */
...
History: Initially released in NX2
*******************************************************************************/
extern int  UFUNEXPORT UF_ASSEM_deform_part(
...
History: Initially released in NX2
*******************************************************************************/
extern int  UFUNEXPORT UF_ASSEM_init_deform_part_data(
...
/*******************************************************************************
 ...
 History: Initially released in NX2
 *******************************************************************************/
extern int  UFUNEXPORT UF_ASSEM_free_deform_warnings_data(
...
History: Initially released in NX2
*******************************************************************************/
extern int  UFUNEXPORT UF_ASSEM_ask_displayed_deformation_of_part_occ( tag_t part_occ, /* <I> */
...
History: Initially released in NX2
*******************************************************************************/
extern logical UFUNEXPORT UF_ASSEM_is_part_deformable( tag_t part /* <I> */ );/* NEC */
...
History: Initially released in NX2
*******************************************************************************/
extern int  UFUNEXPORT UF_ASSEM_ask_deformable_definition( tag_t part,  /* <I> */
                                                            tag_t *deformable_feature /* <O> */ );
...
History: Initially released in NX2
*******************************************************************************/
extern int   UFUNEXPORT  UF_ASSEM_ask_deformed_definition_data
(
...
History: Initially released in NX2
*******************************************************************************/
extern int   UFUNEXPORT UF_ASSEM_ask_deformable_definition_data
(
...
Please reference ufd_xxx.c to review a sample
...
History:
    Initially released in Unigraphics NX2.
...
History:
    Initially released in Unigraphics NX3.
...
( tag_t part_occ,                 /* <I> The tag of the part occurrence
  ...
  double xform[4][4],             /* <O> A 4x4 delta transform matrix
