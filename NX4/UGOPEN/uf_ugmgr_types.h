...
*/
#define    UF_UGMGR_PARTNO_SIZE         32    /* part number length    -> to be increased to 88 once TCE supports this */
#define    UF_UGMGR_PARTREV_SIZE        32    /* part revision length     */
#define    UF_UGMGR_NAME_SIZE           32    /* name length              */
#define    UF_UGMGR_TYPE_SIZE           32    /* part (item) type length  */
#define    UF_UGMGR_DESC_SIZE          240    /* part description length  */
#define    UF_UGMGR_FTYPE_SIZE          13    /* file type length         */
#define    UF_UGMGR_FNAME_SIZE          32    /* file name length         */
#define    UF_UGMGR_ROLE_SIZE           32    /* role length              */

/*
Typedefs for registered methods and their arguments.
*/
/*******************************************************************************
