...
const tag_t xform ,/* <I>
                   ...
                   (apply no transformation) or an assy_ctxt_xform in the
...
const tag_t xform ,/* <I>
                   ...
                   point.  It must be NULL_TAG (apply no
                   transformation) or an assy_ctxt_xform in
                   the same part as object_in_part whose
...
*/
typedef enum UF_WAVE_delay_status_e
{
    UF_WAVE_not_delayed = 0,         /* The part is not delayed. */
    UF_WAVE_session_delayed,         /* The part is delayed because the session
                                        is delayed. */
    UF_WAVE_partial_load_delayed,    /* The part is delayed because it's
                                        partially loaded. */
    UF_WAVE_session_frozen,          /* The part is frozen in this session. */
    UF_WAVE_persistent_frozen,       /* The part is frozen for all sessions. */
    UF_WAVE_not_in_assembly_delayed  /* The part is delayed because it's not in
...
This routine gets the part file name for the broken links source part.
