 ...
 * File description:
 *
 * This file contains the UG/Open interface to cut levels in CAM.
 *
...
typedef struct UF_CUT_LEVEL_single_s
{
...
typedef struct UF_CUT_LEVELS_s
{
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_free
(
    UF_CUT_LEVELS_t **cut_levels_ptr_addr
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_set_range_type
(
    tag_t operation_tag,        /*<I>  The tag of the operation for which the
                                       cut levels are defined. */
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_add_levels_using_geom
(
    tag_t operation_tag,         /*<I>  The tag of the operation for which the
                                        cut levels are defined. */
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_add_levels_using_z
(
    tag_t operation_tag,         /*<I>  The tag of the operation for which the
                                        cut levels are defined. */
    ...
    double *z_levels,            /*<I>  Array of z distances, along the tool axis,
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_edit_level_using_geom
(
    tag_t operation_tag,         /*<I>  The tag of the operation for which the
                                        cut levels are defined. */
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_edit_level_using_z
(
    tag_t operation_tag,         /*<I>  The tag of the operation for which the
                                        cut levels are defined. */
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_delete_level
(
    tag_t operation_tag,         /*<I>  The tag of the operation for which the
                                        cut levels are defined. */
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_ask_level
(
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_ask_top_off_level
(
   UF_CUT_LEVELS_t *cut_levels,   /*<I> The loaded cut levels data structure. */
...
History: Released in NX3
*************************************************************************/
extern UFUNEXPORT int UF_CUT_LEVELS_reset_to_default
(
