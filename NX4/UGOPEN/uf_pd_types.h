...
/*  The following structure defines the business modiier required 
...
{ 
    ...
    char *symbolic_display;    /* Symbol in the format of <library>:<name> used to render the
                                  display of this attribute.  This information is extracted verbatum
...
} UF_PD_product_definition_leader_assoc_pnt_t, *UF_PD_product_definition_leader_assoc_pnt_p_t;
