...
/*  custom point types  */
typedef enum UF_CAMGEOM_custom_point_type_e
{
    UF_CAMGEOM_predrill_engage_type,
    UF_CAMGEOM_cut_region_start_type
}UF_CAMGEOM_custom_point_type_t;
...
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_append_items
(
 ...
 * History: Released in V18.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_ask_items
(
    tag_t                 object_tag,       /* <I>  the parent object of the
                                                    geometry */
    UF_CAM_geom_type_t    geometry_type,    /* <I>  the type of the geometry */
...
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_ask_geom_provider
(
 ...
 * History: Released in V18.0
 ***************************************************************************/
extern UFUNEXPORT int UF_CAMGEOM_delete_geometry
(
    tag_t              object_tag,          /* <I> the parent object of the
                                                   geometry */
    UF_CAM_geom_type_t geometry_type        /* <I> the type of the geometry */
 ...
 * History: Released in V18.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_ask_item_entity
(
 ...
 * History: Released in V18.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_ask_item_app_data
(
    UF_CAMGEOM_item_t     item,             /* <I> the geometry item */
 ...
 * History: Released in V18.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_set_item_app_data
(
    tag_t                     object_tag,       /* <I> the parent object of the
                                                       geometry */
    UF_CAM_geom_type_t        geometry_type,    /* <I> the type of the geometry */
 ...
 * History: Released in V18.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_delete_item
(
    tag_t                 object_tag,       /* <I> the parent object of the
                                                   geometry */
    UF_CAM_geom_type_t    geometry_type,    /* <I> the type of the geometry */
 ...
 * History: Released in NX3.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_eval_surface
(
    ...
    double                *uv,              /* <I,len:2> u,v parameter position */
 ...
 * History: Released in NX3.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_ask_item_maxmin
(
    tag_t                 object_tag,       /* <I> the parent object */
    UF_CAM_geom_type_t    geometry_type,    /* <I> Part, drive, check, etc.  */
    tag_t                 entity,           /* <I> entity to be evaluated */
 ...
 * History: Released in V18.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_append_custom_points
(
 ...
 * History: Released in NX3.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_ask_custom_points
(
    tag_t                   object_tag,           /* <I> the target operation */
    UF_CAMGEOM_custom_point_type_t   point_type,  /* <I> the type of the point */
 ...
 * History: Released in NX3.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMGEOM_delete_custom_points
(
    tag_t                   object_tag,            /* <I> the target operation */
    UF_CAMGEOM_custom_point_type_t   point_type    /* <I> the type of the point */
);
