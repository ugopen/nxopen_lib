...
File description: 
    UG/Open modeling routines to create, edit and inquire about NX Sheet Metal features.
*****************************************************************************/
...
If user has send sketch_tag during create or edit of base tab, he will get skecth_tag after calling this method.
If user has send section_tag during create or edit of base tab, he will get section_tag after calling this method.
...
If user has send sketch_tag during create or edit of secondary tab, he will get skecth_tag after calling this method.
If user has send section_tag during create or edit of secondary tab, he will get section_tag after calling this method.
...
If user has send sketch_tag during create or edit of bend, he will get skecth_tag after calling this method.
If user has send section_tag during create or edit of bend, he will get section_tag after calling this method.
...
extern UFUNEXPORT int UF_NXSM_ask_flat_solid(
            tag_t feature, /* <I> 
                            ...
                            */       
            UF_NXSM_flat_solid_data_p_t flat_solid_data     /* <O/F>
...
If user has send sketch_tag during create or edit of jog, he will get skecth_tag after calling this method.
If user has send section_tag during create or edit of jog, he will get section_tag after calling this method.
...
tag_t feature,          /* <I> 
                         ...
                         */
UF_NXSM_jog_data_p_t jog_data /* <O/F>
