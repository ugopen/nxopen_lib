...
File description:
This include file contains the NX/Open API of the VDA Checker.
...
typedef enum /* NX/Open versions of comply error interface */
{
...
}                                 UF_VDAC_ce_vers_e_t  , *UF_VDAC_ce_vers_e_p_t;
typedef const UF_VDAC_ce_vers_e_t UF_VDAC_ce_vers_e_c_t, *UF_VDAC_ce_vers_e_pc_t;

typedef enum /* Version 2 comply error object classes */
{
...
}                               UF_VDAC_class_e_t  , *UF_VDAC_class_e_p_t;
...
typedef enum /* Version 2 Modeler Error object classes */
{
...
}                                  UF_VDAC_me_class_e_t  , *UF_VDAC_me_class_e_p_t;
typedef const UF_VDAC_me_class_e_t UF_VDAC_me_class_e_c_t, *UF_VDAC_me_class_e_pc_t;

typedef union UF_VDAC_item_u /* union of item value types */
{
...
typedef struct UF_VDAC_ce_point_s /* Comply error parametric point info */
{
    ...
    tag_t           ug_eid;     /* UG object identifier */
}                                       UF_VDAC_ce_point_t  , *UF_VDAC_ce_point_p_t;
typedef const struct UF_VDAC_ce_point_s UF_VDAC_ce_point_c_t, *UF_VDAC_ce_point_pc_t;

typedef struct UF_VDAC_ce_gc_par_s /* Comply error Geometric Continuity Parameters */
{
    UF_VDAC_ce_point_t  ce_point[2];
}                                        UF_VDAC_ce_gc_par_t  , *UF_VDAC_ce_gc_par_p_t;
typedef const struct UF_VDAC_ce_gc_par_s UF_VDAC_ce_gc_par_c_t, *UF_VDAC_ce_gc_par_pc_t;

typedef struct UF_VDAC_ce_me_par_s /* Modeler Error comply error info */
{
...
}                                        UF_VDAC_ce_me_par_t  , *UF_VDAC_ce_me_par_p_t;
typedef const struct UF_VDAC_ce_me_par_s UF_VDAC_ce_me_par_c_t, *UF_VDAC_ce_me_par_pc_t;

typedef union UF_VDAC_ce_par_u /* Union of comply error parameters */
{
...
}                                    UF_VDAC_ce_par_u_t  , *UF_VDAC_ce_par_u_p_t;
typedef const union UF_VDAC_ce_par_u UF_VDAC_ce_par_u_c_t, *UF_VDAC_ce_par_u_pc_t;


typedef struct UF_VDAC_item_options_s /* toggles that describe an VDAC_item_t item */
{
    /* item dialog options */
    unsigned int    log_violations:1;   /* generate detailed criteria report */

    /* check value attributes & UOM */
    ...
    unsigned int    has_two_object_ids:1;   /* log two UG tags */
    unsigned int    is_object_edge_eid:1;   /* to distinguish an edge curve from a UG curve tag */
    ...
    /* UF_VDAC_ce_item_t.par representations */
...
}                                           UF_VDAC_item_options_t  , *UF_VDAC_item_options_p_t;
typedef const struct UF_VDAC_item_options_s UF_VDAC_item_options_c_t, *UF_VDAC_item_options_pc_t;

typedef struct UF_VDAC_ce_item_s /* Comply Error Item */
{
...
}                                      UF_VDAC_ce_item_t  , *UF_VDAC_ce_item_p_t;
typedef const struct UF_VDAC_ce_item_s UF_VDAC_ce_item_c_t, *UF_VDAC_ce_item_pc_t;

typedef struct UF_VDAC_cckey_s /* comply error check criterion key info */
{
...
}                                    UF_VDAC_cckey_t  , *UF_VDAC_cckey_p_t;
typedef const struct UF_VDAC_cckey_s UF_VDAC_cckey_c_t, *UF_VDAC_cckey_pc_t;

typedef struct UF_VDAC_class_info_s /* comply error object class check criterion key info */
{
    UF_VDAC_class_e_t   comply_class;   /* comply error object class */
...
}                                         UF_VDAC_class_info_t  , *UF_VDAC_class_info_p_t;
typedef const struct UF_VDAC_class_info_s UF_VDAC_class_info_c_t, *UF_VDAC_class_info_pc_t;

typedef struct UF_VDAC_ce_s /* comply errors of a check criterion key */
{
...
typedef struct UF_VDAC_list_head_s /* Object Identifier list head */
{
...
}                                        UF_VDAC_list_head_t  , *UF_VDAC_list_head_p_t;
typedef const struct UF_VDAC_list_head_s UF_VDAC_list_head_c_t, *UF_VDAC_list_head_pc_t;

typedef struct UF_VDAC_cckey_fo_s /* Faulty Objects of comply error items of a check criterion key */
{
    UF_VDAC_cckey_t     key_info;   /* comply error check criterion key info */
    UF_VDAC_list_head_t list_head;  /* Object Identifier list head */

}                                       UF_VDAC_cckey_fo_t  , *UF_VDAC_cckey_fo_p_t;
typedef const struct UF_VDAC_cckey_fo_s UF_VDAC_cckey_fo_c_t, *UF_VDAC_cckey_fo_pc_t;

typedef struct UF_VDAC_cckey_ce_item_s /* Check Criterion Key Comply Error Item */
{
    UF_VDAC_cckey_t     key_info;   /* comply error check criterion key info */
    UF_VDAC_ce_item_t   ce_item;    /* Comply Error Item */
    char                crit_name[UF_OBJ_NAME_LEN+1];   /* criterion name */

}                                            UF_VDAC_cckey_ce_item_t  , *UF_VDAC_cckey_ce_item_p_t;
typedef const struct UF_VDAC_cckey_ce_item_s UF_VDAC_cckey_ce_item_c_t, *UF_VDAC_cckey_ce_item_pc_t;

typedef struct UF_VDAC_fo_ce_s /* Faulty Object Check Criterion Key Comply Errors */
{
...
}                                 UF_VDAC_fo_type_e_t  , *UF_VDAC_fo_type_e_p_t;
...
typedef struct UF_VDAC_fo_neighbors_s /* Faulty Object Neighbors Info */
{
...
}                                           UF_VDAC_fo_neighbors_t  , *UF_VDAC_fo_neighbors_p_t;
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_load_ceo
(
    const char*         ceo_file_name,  /* <I>  Compliance Error Objects file name, optional
                                                ...
                                                is derived from the UG part file name
    ...
    UF_VDAC_ceos_p_t*   ceos            /* <OF> Address of Comply Errors Evaluator structure pointer.
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_free_ceo
(
    UF_VDAC_ceos_p_t*   ceos    /* <IO> address of comply errors evaluator structure pointer
                                        *ceos is set to NULL. */
);
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_ask_log_text_list
(
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_ask_cckey_comply_errors
(
    UF_VDAC_ceos_pc_t       ceop,           /* <I> comply errors evaluator structure pointer */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_ask_class_info
(
    UF_VDAC_ceos_pc_t               ceop,           /* <I> comply errors evaluator structure pointer */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_ask_fo_comply_errors
(
    UF_VDAC_ceos_pc_t       ceop,   /* <I> comply errors evaluator structure pointer */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_ask_cckey_fo_list
(
    UF_VDAC_ceos_pc_t           ceop,       /* <I> comply errors evaluator structure pointer */
    UF_VDAC_class_info_pc_t     class_info, /* <I> address of comply error class info */
    int                         info_index, /* <I> class info index
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_ask_fo_list
(
    UF_VDAC_ceos_pc_t           ceop,   /* <I> comply errors evaluator structure pointer */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_ask_fo_neighbors
(
    UF_VDAC_ceos_pc_t               ceop,           /* <I> comply errors evaluator structure pointer */
    tag_t                           faulty,         /* <I> faulty object identifier */
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_VDAC_delete_list_members
(
    UF_VDAC_ceos_pc_t           ceop,   /* <I > comply errors evaluator structure pointer */
    UF_VDAC_list_head_p_t const lh      /* <IO> address of UG Object Identifier list head */
);
