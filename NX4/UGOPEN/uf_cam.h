 ...
 *    This module allows the UG CAM User Function programmer to interface
...
/******************************** Defines *************************************/
#define UF_CAM_MAX_TEMPLATE_SET_NAME_LEN   256
 ...
 * please see the UG Libraries documentation in the UG Users Manual.
 */
...
typedef enum UF_CAM_blank_geom_type_e
{
 ...
 *      Preferences chapter of the UG Users Manual.
 */
struct UF_CAM_preferences_s
{
   ...
   char      template_set_used[UF_CAM_MAX_TEMPLATE_SET_NAME_LEN + 1];
 ...
 * call any other UG CAM User Function except init_session.
 *
 * Environment : Internal  and  External
 * See Also:
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_is_session_initialized
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_init_session
(
   void
);
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_reinit_session
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_cam_preferences
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_set_cam_preferences
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_cutter_db_object
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_tool_matl_db_object
(
   UF_CAM_db_object_t   *db_obj /* <O> - see function description */
);
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_blank_matl_db_object
(
   UF_CAM_db_object_t   *db_obj /* <O> - see function description */
);
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_f_s_db_object
(
   UF_CAM_db_object_t   *db_obj /* <O> - see function description */
);
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_opt_template_object
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_opt_ask_post_names
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_opt_ask_clsf_names
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_opt_ask_doc_names
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_reinit_opt
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_opt_ask_types
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_opt_ask_subtypes
(
 ...
 * Object Parameter Templates. All the subtyes contained in the specified
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_opt_add_type
(
...
/*****************************************************************************
 * This function provides the tag of the UG object which corresponds to the
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_opt_ask_object
(
   UF_CAM_opt_stype_cls_t  subtype_class, /* <I> - the desired subtype class */
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_post_template_name
(
 ...
 * History : Released in V16.0
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_doc_template_name
(
 ...
 ****************************************************************************/
extern UFUNEXPORT int UF_CAM_ask_config_file
(
 ...
 * History: Released in V19.0
 ************************************************************************/
extern UFUNEXPORT int UF_CAM_set_auto_blank
(
    tag_t                      object_tag,      /* <I> the operation or geometry group containing blank definition  */
 ...
 ************************************************************************/
 extern UFUNEXPORT int UF_CAM_update_single_object_customization
 (
 ...
 * History: Relaeased in NX3
 ************************************************************************/
 extern UFUNEXPORT int UF_CAM_update_list_object_customization
 (
