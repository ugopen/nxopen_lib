...
/*   when adding/removing to/from this enum, make corresponding entries in
     the four tables in file sfom.h */
 ...
 ****************************************************************************/
typedef struct UF_SF_mesh_visuals_s
{
...
} UF_SF_mesh_visuals_t, *UF_SF_mesh_visuals_p_t;
...
******************************************************************************/
typedef struct  UF_SF_defeature_parms_s
{
    ...
    UF_SF_idealize_region_p_t region_parms_p; /* Pointer to an instance of
                                                 ...
                                                 body or NULL.
                                              */
} UF_SF_defeature_parms_t, * UF_SF_defeature_parms_p_t;
...
typedef struct UF_SFAS_solver_data_s
{
/*  */
    int algolChoice;
    int typeChoice;
...
} UF_SFAS_solver_data_t, *UF_SFAS_solver_data_p_t;
...
******************************************************************************/
typedef struct UF_SF_midsrf_user_parms_s
{
...
} UF_SF_midsrf_user_parms_t, *UF_SF_midsrf_user_parms_p_t;
