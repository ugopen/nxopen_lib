 ...
 * File description:
 *
 * This file contains the UG/Open interface to Special planes in CAM
 ...
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_clear_plane_data
(
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_clear_plane_data
(
    tag_t      object_tag,        /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_clear_plane_status
(
    tag_t                       object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_clear_plane_status
(
    tag_t                       object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_clear_plane_usage
(
    tag_t                      object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_clear_plane_usage
(
    tag_t                      object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_clear_plane_tag
(
    tag_t      object_tag,        /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_clear_plane_tag
(
    tag_t      object_tag,        /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_lower_limit_plane_data
(
    tag_t      object_tag,        /* <I> the parent object of the plane */ 
    double     origin[3],         /* <O> the 3D origin of the plane */
    double     normal[3]          /* <O> the 3D normal of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_lower_limit_plane_data
(
    tag_t      object_tag,        /* <I> the parent object of the plane */ 
    double     origin[3],         /* <I> the 3D origin of the plane */
    double     normal[3]          /* <I> the 3D normal of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_lower_limit_plane_status
(
    tag_t                      object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_lower_limit_plane_status
(
    tag_t                      object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_lower_limit_plane_usage
(
    tag_t                     object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_lower_limit_plane_usage
(
    tag_t                     object_tag, /* <I> the parent object of the plane */ 
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_ask_lower_limit_plane_tag
(
    tag_t      object_tag,        /* <I> the parent object of the plane */ 
    tag_t      *target_tag        /* <O> the tag of an UF_xform_type entity
 ...
 * History: Released in V19.0
 ********************************************************************** */
extern UFUNEXPORT int UF_CAM_set_lower_limit_plane_tag
(
    tag_t      object_tag,        /* <I> the parent object of the plane */ 
    tag_t      target_tag         /* <I> the tag of an UF_xform_type entity
                                         representing the lower limit plane */
