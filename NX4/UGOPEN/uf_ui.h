/*******************************************************************************
          Copyright (c) 1998-2005 Electronic Data Systems Corporation
...
be made in the work view on a drawing lyaout only or any view, and this
...
/******************************************************************************
Display the user message (cp1) and returns a screen
position point in parameter rr2 (X,Y,Z) on the WCS plane in
...
See Also:  UF_UI_ugmgr_ask_create_part_name
...
/****************************************************************************
   ...
   Beginning with Unigraphics Version 12.0, a new feature, Quick Access
   Menus, provides for enabling global functions and special functions in
   many instances where they were previously greyed out.  This is done by
...
History:
 ****************************************************************************/
extern UGOPENINTEXPORT int UF_UI_ask_lock_status (void);
...
char *cp1, /* <I> Menu title (displayed on the cue line, maximum of 80
                  characters.
           */
char *ca2, /* <I/O> On input the default value of the string, on output
                    the string typed in.  This should be declared as
                    char ca2[133] in the calling program.
           */
int *ir3   /* <O>  The length of the returned string in ca2.
           */
);
...
char *cp1, /* <I> The message to display. */
int ip2    /* <I> The display option:
...
char *cp1, /* <I>
              Menu title (displayed on the cue line, 80 characters maximum
           */
int ip2,   /* <I>
...
char cp3[][38], /* <I>
                ...
                */
int ip4 /* <I>
           The number of items in the cp3 array.  This must be <= 14.
        */
);
...
char *cp1, /* <I>
              Menu title to display on the cue line.  This is 80 characters
              maximum.
           */
int ip2, /* <I>
            Unused.
...
char cp3[][38], /* <I>
                ...
                */
int ip4, /* <I>
            Number of strings in the cp3 array.  This may not exceed
            14 menu items.
         */
int *ir6 /* <O>
            Selection Array, which should be dimensioned to 14.
...
char *cp1,      /* <I> The message to display on the cue line, a maximum of
                       80 characters.
                */
char cp2[][16], /* <I>
                   The menu list.
...
char *cp1,      /* <I>
                   Menu title to display on the cue line.  This may be a
...
char *cp1,      /* <I>
                   Menu title displayed on the cue line.  This may be a
                   maximum of 80 characters.
                */
char cp2[][16], /* <I>
                   This is the array of menu items to display.
...
extern UGOPENINTEXPORT int uc1617(char *cp1, int ip2, tag_t *nr3, int *ir4, double *rr5);

/* uc1618 simple object select.  Use UF_UI_select_with_single_dialog instead. */
extern UGOPENINTEXPORT int uc1618(char *cp1, int ip2, tag_t *nr3, int *ir4, double *rr5);
...
Creates a smart point, unless an existing point or cursor location is selected
to define the point.  If you do not wish to create smart point, use uc1616.
