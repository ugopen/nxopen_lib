...
typedef enum UF_SKET_reference_status_e
{
    UF_SKET_reference,
    UF_SKET_active
} UF_SKET_reference_status_t;
...
enum UF_SKET_con_type_e
{
    ...
    UF_SKET_last_con_type /* The last constraint type indicator; 
                             NOT to be used. */
} ;
...
typedef enum UF_SKET_con_class_e
{
    UF_SKET_no_cons,
    UF_SKET_all_cons,
    UF_SKET_geo_cons,
...
} UF_SKET_con_class_t, *UF_SKET_con_class_p_t;
...
int    subtype;          /* UF_v9_sketch_subtype, UF_v13_sketch_subtype or
                         ...
                         */
char   name[UF_OBJ_NAME_LEN + 1];    /* sketch's name  */
...
tag_t object_tag;            /* Tag of the object - sketch curves, edge,
                                datum plane, datum axis, ug curves */
