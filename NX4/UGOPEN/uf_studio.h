...
File description:
    ...
    User Function declaration (UG/Open API) for Shape Studio Freeform.
    Including:
        Styled Blend
...
*/
typedef enum UF_STUDIO_stybld_method_e
{
...
*/
typedef enum UF_STUDIO_stybld_trans_e
{
...
*/
typedef enum UF_STUDIO_stybld_cont_e
{
...
*/
typedef enum  UF_STUDIO_stybld_direct_e
{
...
*/
typedef enum UF_STUDIO_stybld_stiff_e
{
...
*/
typedef enum UF_STUDIO_stybld_trim_e
{
...
*/
typedef enum UF_STUDIO_stybld_minrad_e
{
...
*/
typedef enum UF_STUDIO_stybld_v_degree_e
{
...
typedef struct UF_STUDIO_stybld_shape_trans_s
{
    /* Transition type. */
    UF_STUDIO_stybld_trans_t  trans_type;
...
} UF_STUDIO_stybld_shape_trans_t, *UF_STUDIO_stybld_shape_trans_p_t;

/* Data structure of curve transition controlling the shape of tangent holding
   curves.
*/
typedef struct UF_STUDIO_stybld_curve_trans_s
{
    /* Transition type. */
    UF_STUDIO_stybld_trans_t  trans_type;
...
} UF_STUDIO_stybld_curve_trans_t, *UF_STUDIO_stybld_curve_trans_p_t;

/* Data structure for styled blend creation and editing. */
typedef struct UF_STUDIO_stybld_data_s
{ 
    /* Method choice for tangent holding curve creation. */
    UF_STUDIO_stybld_method_t method;
    ...
    */
    ...
    UF_STUDIO_stybld_cont_t continuity_blend_1;
    
    /* continuity zu 2nd blend */
    UF_STUDIO_stybld_cont_t continuity_blend_2;
    
    /* Pointer to spine string (optional). If set to NULL, no spine is used. */
    UF_STRING_p_t spine;           

    /* Pointer to profile curve string */
    UF_STRING_p_t profile_curve;

    /* Depth transition. */
    UF_STUDIO_stybld_shape_trans_t depth;

    /* Skew transition. */
    UF_STUDIO_stybld_shape_trans_t skew;
   ...
   UF_STUDIO_stybld_curve_trans_t curve_trans2;
    ...
    /* Minimum Radius mode.
       ...
       UF_STUDIO_stybld_minrad_peak:  Midpoint of sections assumes min_radius 
                                      value. */
    UF_STUDIO_stybld_minrad_t min_radius_mode;
    ...
    /* Lofting degree choice. Degree of blend surface in v-direction can be
       cubic or quintic. */
    UF_STUDIO_stybld_v_degree_t v_degree;
    
} UF_STUDIO_stybld_data_t, *UF_STUDIO_stybld_data_p_t;

/* Functions for styled blend feature.*/

/******************************************************************************
Allocates and initializes the styled blend UG/Open API data structure. It is to 
...
UF_STUDIO_stybld_data_p_t *styled_blend_data /* <O> Styled blend UG/Open API 
                                                data structure. */
);

/******************************************************************************
Frees memory of the styled blend UG/Open API data structure that was previously
...
UF_STUDIO_stybld_data_p_t *styled_blend_data /* <I/O> Styled blend UG/Open API 
                                                data structure. */
);

/******************************************************************************
Creates a styled blend feature from the styled blend UG/Open API data 
structure.
...
UF_STUDIO_stybld_data_p_t styled_blend_data, /* <I> Styled blend UG/Open API 
                                                data structure. */
tag_p_t styled_blend  /* <O> Styled blend feature object identifier. */
);

/******************************************************************************
Edits an existing styled blend feature based on a UG/Open API data structure.
...
/******************************************************************************
Populates a styled blend UG/Open API data structure of a styled blend feature.
...
/******************************************************************************
Populates a collector enabled styled blend UG/Open API data structure of a 
...
History: Original release in UG NX2.0
******************************************************************************/
