...
typedef struct
{
   ...
   /* Tolerance to be used to determine if two geometries can be considered
      coincident */
   double                                   tolerance;
   ...
   /* Whether to compare features and expressions. Applicable only if
   ...
   /* If any body fails in examine geometry, continue with comparison, results may
      not be meaningful */   
   logical                                  continue_if_examine_geom_fails; 

   /* generate HTML report for the compared parts */
