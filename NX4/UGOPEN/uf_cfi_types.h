...
Contains UG/Open typedefs and macros that are specific to the CFI module.
...
/* 
   Number of bytes allowed in a Unigraphics filename.  The plans are to
...
/* 
   Number of bytes allowed in a Unigraphics file specification.  The plans are
