...
enum UF_UI_dialog_filter_id_e{
    ...
    UF_UI_PART_OPEN_XT_FLTR,     /* Specifies *.prt */
...
enum UF_UI_dialog_dir_id_e{
    ...
    UF_UI_CAE_CSV_DIR,                  /* Used by *.dac File */
...
#define UF_UI_SEL_FEATURE_MAX_SPECIAL_FEATURE   94 /* This should be last of special feature types */
...
typedef struct UF_UI_attachment_s
{
    short center;
...
} UF_UI_attachment_t, *UF_UI_attachment_p_t;
...
/* Option Toggle Data */
typedef struct UF_UI_option_toggle_s
{
    int choice;         /* active option */
    logical is_checked; /* check box state */ 
} UF_UI_option_toggle_t, *UF_UI_option_toggle_p_t;
