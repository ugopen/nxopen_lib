...
typedef enum UF_CURVE_join_types 
{
...
{
    UF_STRING_p_t        input_curves;   /* Pointer to curves list structure
                                            {
                                              int num:
                                                 Total number of primary string
                                                 (min=1,max=1)
                                              int string[]:
                                                 Total number of segment curves
                                                 sketch id of each primary
                                                 string
                                                 (min=1,max=402)
                                              int dir[]:
                                                  Direction of each primary
                                                  string
                                                       1 = Start to End
                                                      -1 = End to Start
                                              tag_t id[]:
                                                  Identifier of primary curves
                                             }
 ...
 ***************************************************************************/
typedef enum UF_CURVE_ocf_method_e
{
 ...
 ***************************************************************************/
typedef enum UF_CURVE_ocf_trim_method_e
{
...
/***************************************************************************
  ...
  boundary.
 ***************************************************************************/
typedef enum UF_CURVE_ocf_span_method_e
{
 ...
 ***************************************************************************/
typedef enum UF_CURVE_ocf_cross_boundaries_e
{
...
{
    char   string[UF_CFI_MAX_PATH_NAME_SIZE];   /* A character string used to
...
/***************************************************************************
 ...
 This structure also holds a UF_CURVE-ocf_face_data_t pointer that has the
...
typedef enum UF_CURVE_principal_axis_e
{
    UF_CURVE_X_AXIS = 0,
    UF_CURVE_Y_AXIS,
    UF_CURVE_Z_AXIS
...
curve using the UF_CURVE_create_line_arc() interface.
****************************************************************************/
...
History:
*****************************************************************************/
extern UFUNEXPORT int UF_CURVE_ask_proj_curve_parents1(
tag_t proj_curve ,/* <I>
                  The curve identifier whose projected curve feature,
                  defining sheet_body/face/plane/datum_plane, and defining
                  curve are to be found.
...
tag_t * defining_feature ,/* <O>
                          ...
                          produced the input curve.
                          */
int      n_defining_target, /* <O>
                           Number of targets where the input curve was projected
                           onto.
                           */
tag_t ** defining_target ,/* <O>
                         The sheet_body/face/plane/datum_plane identifier of the
                         ...
                         onto.
                         */
int      n_defining_curve, /* <O>
                          Number of defining curves that generated this projected curve
                          */
tag_t ** defining_curve  /* <O>
                        The defining curve identifier of the projected curve
                        feature that generated this projected curve.
...
int trim_opts[3] ,/* <I>
                  ...
                  [0] = TRUE -> trim first curve FALSE -> do not trim first
                        curve
                  [1] = TRUE -> delete second curve FALSE -> do not delete
                        second curve
                  [2] = TRUE -> trim third curve FALSE -> do not trim third
                        curve
                  */
...
See Also: UF_CURVE_ask_parmeterization
...
/*******************************************************************************
  int UF_CURVE_section_general
******************************************************************************/
extern int UF_CURVE_section_general
(
...
/******************************************************************************
Create a associtive line/arc feature. You input a UF_CURVE_line_arc_t data structure,
...
(
    ...
    tag_t * line_arc_feat_id  /* <O> Object identifier of new associtive line/arc feature. */
                              /* <O> if is_asso == TRUE - object identifier of new associtive line/arc feature. */
                            /* <O> if is_asso == FALSE - object identifier of new line/arc  */
);

/******************************************************************************
Populates the supplied pointer to line_arc_data struct for the given
associtive line/arc feature.
...
(
    tag_t  line_arc_feat_id,  /* <I> Object identifier of associtive line/arc feature. */
    UF_CURVE_line_arc_t  *line_arc_data /* <0> Pointer to line/arc data structure to be filled up. */
);
...
/******************************************************************************
Create a associtive line feature through two points.
...
(
    ...
    tag_p_t line_feature_id /* <O> if is_asso == TRUE - object identifier of new associtive line feature */
                            /* <O> if is_asso == FALSE - object identifier of new associtive line */
);

/******************************************************************************
Create a associtive line feature through point and tangent to curve.
...
/******************************************************************************
Create a associtive line feature tangent to a curve and through a point.
...
/******************************************************************************
Create a associtive line feature through a point and at an angle to a linear curve/edge.
...
/******************************************************************************
Create a associtive line feature through a point and along any one principal axis.
...
/******************************************************************************
Create a associtive arc feature through three points.
...
/******************************************************************************
Create a associtive arc feature through two points and of specific radius.
...
/******************************************************************************
Create a associtive arc feature through one point, tangent to a curve and of specific radius.
...
/******************************************************************************
Create a associtive arc feature tangent to two curves and of specific radius.
...
/******************************************************************************
Create a associtive arc feature through two points and tangent to a curve.
...
/******************************************************************************
Create a associtive arc feature through a point and tangent to two curves.
...
/******************************************************************************
Create a associtive arc feature through tangent to three curves.
...
/******************************************************************************
Create a associtive arc feature through a start point and specific center.
...
/******************************************************************************
Create a associtive arc feature tangent to a curve and specific center.
...
/******************************************************************************
Create a associtive arc feature of given radius and specific center
