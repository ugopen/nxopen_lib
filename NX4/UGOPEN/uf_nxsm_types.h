...
File description: 
    UG/Open enum types & data structures for NX SheetMetal features.
*****************************************************************************/
 ...
 ***Linda, Hope you agree with this approach.***
 */
...
/* Main Data structure for closed corner */
	...
	tag_t bend_faces[2];				/*for creating closed corner first time send in two valid bend faces from here.
										 *subsequently, send additional valid bend faces while editing so as to add more corners to be closed.
										 */

    int n_edges;                        /* Actual number of edges in the array "parent_edges".*/

    tag_t* parent_edges;                /* <len:n_edges> <OF> array of parent edges
...
/* Main Data structure for Unbend */
    ...
    tag_t *bend_list;       /* <len:nbend> <OF> array of bend faces unbent*/
};
...
/* Main Data structure for Rebend */
    ...
    tag_t *unbend_list;     /* <len:nbend> <OF> array of bend faces unbent*/
};
