...
(
    ...
    UF_SC_input_data_p_t rule       /* <I/0> pointer to UF_SC_input_data_t structure */
);
...
(
    ...
    int                  * n_rules ,            /*<0> The number of face container rules. */
    int                 ** rule_types ,         /*<0F,len:n_rules> An array of the types for the face container rules.
                                                      The valid types are defined in uf_sc_types.h. */
    UF_SC_input_data_t  ** rules ,              /*<0F,len:n_rules> An array of face container rules. 
                                                      The face container rule data are
                                                      defined in uf_sc_types.h. */
    int                  * n_face_eids ,        /*<0> The number of resulting faces */
    tag_t               ** face_eids            /*<0F,len:n_face_eids> An array of resulting faces */
);
...
(
    ...
    int                  * n_rules ,                 /*<0> The number of wireframe container rules. */
    int                 ** rule_types ,              /*<0F,len:n_rules> An array of the types for the wireframe 
                                                           container rules. The valid types are
                                                           defined in uf_sc_types.h. */
    UF_SC_input_data_t  ** rules ,                   /*<0F,len:n_rules> An array of wireframe container rules. 
                                                           The wireframe container rule data are
                                                           defined in uf_sc_types.h. */
    int                  * n_wireframe_eids ,        /*<0> The number of resulting wireframes */
    tag_t               ** wireframe_eids            /*<0F,len:n_wireframe_eids> An array of resulting wireframes */
);
...
(
    ...
    int                   * n_rules ,               /*<0> The number of section builder rules. */
    UF_SC_section_data_t ** rules ,                 /*<0> An array of section builder rules.
...
(
    ...
    int                        ** indices ,  /* <I/OF> If NULL is passed in, then nothing is
                                                       ...
                                                       to be free. */
    UF_CURVE_struct_p_t        ** curves     /* <I/OF> If NULL is passed in, then nothing is
                                                       returned.  If a pointer is passed in,
