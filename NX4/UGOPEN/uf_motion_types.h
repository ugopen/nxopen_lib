...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the link.  If NULL,
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the joint.  If NULL,
                                            a default name will be created. */
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the joint coupler.  If
    ...
    tag_t origin_tag;                    /* The smart point that defines the
                                            ...
                                            if the ratio is defined.  See uf_so.h
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the point curve
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the curve curve
                                            constraint.  If NULL, a default
                                            name will be created. */
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the spring damper.
    ...
    tag_t point_1;                       /* The point of the spring/damper
                                            ...
                                            This point is NOT saved with the
                                            spring or damper object.  It is
                                            included for future enhancement,
                                            but is currently only used for 
    ...
    double pt1_coord[3];                 /* The coordinates of the attachment
                                            ...
                                            first link.  The user may input
                                            the coordinates instead of a
                                            point object.  When querying
                                            a spring/damper object of type
                                            UF_MOTION_link_spring_damper, 
                                            only these coordinates will be 
                                            returned, not the point object. */
    ...
    double pt2_coord[3];                 /* The coordinates of the attachment
                                            ...
                                            second link, or to ground.  The user
                                            may input the coordinates instead
                                            of a point object.  When querying
                                            a spring/damper object of type
                                            UF_MOTION_link_spring_damper, only
                                            these coordinates will be returned,
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the force or torque.
                                            If NULL, a default name will be
                                            created. */
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the bushing.  If NULL,
                                            a default name will be created. */
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];       /* The name of the 3D contact.
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];       /* The name of the 2D contact.
...
{
    char name[MAX_ENTITY_NAME_SIZE+1];   /* The name of the marker.  If NULL,
                                            a default name will be created. */
    ...
    tag_t orientation_tag;               /* Orientation matrix that defines the
                                            orientation of the marker.  See uf_so.h
                                            for creation methods. */
...
typedef struct UF_MOTION_point_on_surface_data_s 
{
    ...
    char entity_name[MAX_ENTITY_NAME_SIZE +1];          /* <len:MAX_ENTITY_NAME_SIZE +1> 
