 ...
 * File description:
 *
 * This file contains the UG/Open interface to text geometry in CAM.  
...
********************************************************************** */
extern UFUNEXPORT int UF_CAMTEXT_append_items
(
 ...
 * History: Released in NX2.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMTEXT_ask_items
(
    tag_t                 object_tag,       /* <I>  the parent object of the 
                                                    geometry */
 ...
 * History: Released in NX2.0
 ***************************************************************************/
extern UFUNEXPORT int UF_CAMTEXT_delete_geometry
(
    tag_t              object_tag           /* <I> the parent object of the 
                                                   geometry */
);
 ...
 * History: Released in NX2.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMTEXT_ask_item_entity
(
 ...
 * History: Released in NX2.0
********************************************************************** */
extern UFUNEXPORT int UF_CAMTEXT_delete_item
(
    tag_t                 object_tag,       /* <I> the parent object of the 
                                                   geometry */
