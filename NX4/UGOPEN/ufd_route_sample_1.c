...
void ufusr(char *param, int *retcod, int parm_len)
{
    ...
    char   *app_view_symb       = "UGII_ROUTE_MECH_APP_VIEW";
    char   *part_search_symb    = "UGII_ROUTE_MECH_PART_PATH";
    ...
    UF_CALL( UF_ROUTE_match_charx_in_plib( "ELBOWS", n_std_part_charx,
