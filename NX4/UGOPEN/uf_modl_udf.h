...
tag_t * target_faces ,/* <I,len:num_target_faces>
                      array of trimiing faces on the target body
                      */
int num_tool_faces ,/* <I> 
...
(
   ...
   UF_MODL_udfs_def_data_p_t udfs_data /* <0/F> - Data for redefinition */
);
/*******************************************************************************
 ...
 * UF_MODL_udf_ref_data_t.
 *
 * See Also: UF_MODL_init_udf_insert_data_from_def
 * History: This function was originally released in NX3.
 ***********************************************************************/
 ...
 * a routine into the UG/Open API environment so that you can select some
 ...
 *
 * Calling this function will prevent an internal UG/Open shared library from 
