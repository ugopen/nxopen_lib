 ...
 * File description:
 *
 * This file contains the UG/Open interface to MFM in CAM.  
 *
...
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_feature_type
(
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_set_feature_name
(
    UF_NCFEAT_t  machining_feature,  /* <I> The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_feature_name
(
    UF_NCFEAT_t  machining_feature,  /* <I>  The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_geometry_groups
(
    UF_NCFEAT_t   machining_feature,          /*<I>  The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
******************************************************************************/
extern UFUNEXPORT int  UF_MFM_ask_machined_status
(
    UF_NCFEAT_t               machining_feature,        /*<I> The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int  UF_MFM_ask_source_type
(
    UF_NCFEAT_t            machining_feature,   /*<I> The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_overridden_status
(
    UF_NCFEAT_t   machining_feature,        /*<I> The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_machining_features_of_part
(
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_machining_feature_types
(
    tag_t        part_tag,                /*<I>  The part tag */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_machining_features_of_type
(
    tag_t        part_tag,               /*<I>  The part tag */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_candidate_machining_feature_types
(
...
/*******************************************************************************
    ...
    Create machining features from UG modeling features of the machining 
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_features_from_modeling_features
(
    int           body_count,                   /*<I>  The number of bodies */
    tag_t         *body_list,                   /*<I,len:body_count>  The list of bodies*/
...
/*******************************************************************************
    ...
    Create machining features from UG user defined features (UDF) of the machining 
    feature types in the bodies.
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_features_from_user_defined_features
(
    int           body_count,                   /*<I>  The number of bodies */
    tag_t         *body_list,                   /*<I,len:body_count>  The list of bodies*/
    int           type_count,                   /*<I>  The number of feature types */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_features_from_tagged_points
(
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_features_from_tagged_arcs
(
    int           *count,                       /*<O>  The of machining feature */
    UF_NCFEAT_t   **machining_features          /*<OF,len:count> The array of machining fetures 
                                                       The memory is allocated by this function 
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_features_from_tagged_edges
(
    int           body_count,                   /*<I>  The number of bodies */
    tag_t         *body_list,                   /*<I,len:body_count>  The list of bodies*/
    int           *count,                       /*<O>  The of machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_features_from_tagged_faces
(
    int           body_count,                   /*<I>  The number of bodies */
    tag_t         *body_list,                   /*<I,len:body_count>  The list of bodies*/
    int           *count,                       /*<O>  The of machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_features_from_recognized_features
(
    int           body_count,                   /*<I>  The number of bodies */
    tag_t         *body_list,                   /*<I,len:body_count>  The list of bodies*/
    int           *count,                       /*<O>  The of machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_delete_machining_features
(
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_attributes
(
    UF_NCFEAT_t     machining_feature,   /*<I>  The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_attribute_type
(
    UF_NCFEAT_t                   machining_feature,  /*<I> The pointer of the machining feature */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_logical_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I> The pointer of the machining feature */
    char          *attribute,            /*<I> The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_set_logical_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I> The pointer of the machining feature */
    char          *attribute,            /*<I> The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_double_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I> The pointer of the machining feature */
    char          *attribute,            /*<I> The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_set_double_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I> The pointer of the machining feature */
    char          *attribute,            /*<I> The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_integer_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I> The pointer of the machining feature */
    char          *attribute,            /*<I> The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_set_integer_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I> The pointer of the machining feature */
    char          *attribute,            /*<I> The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_string_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I>  The pointer of the machining feature */
    char          *attribute,            /*<I>  The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_set_string_value_of_attribute
(
    UF_NCFEAT_t   machining_feature,     /*<I> The pointer of the machining feature */
    char          *attribute,            /*<I> The attribute name */
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_has_selected_fea_list
(
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_clean_selected_fea_list
(
);
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_set_selected_fea_list
(
...
/*******************************************************************************
    ...
    History: Released in NX3.0
*******************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_selected_fea_list
(
...
/********************************************************************************
    ...
    Set UG integer attribute in the specified machining feature, if the attribute 
    ...
    History:  Released in NX3.0 
**********************************************************************************/
extern UFUNEXPORT int UF_MFM_set_int_ug_attribute
(  
...
/********************************************************************************
    ...
    Set UG double attribute in the specified machining feature, if the attribute 
    already exists, then reset the attribute value; otherwise add attribute. 
    ...
    History:  Released in NX3.0 
**********************************************************************************/
extern UFUNEXPORT int UF_MFM_set_double_ug_attribute
(  
    UF_NCFEAT_t    machining_feature,                /* <I> Machining feature */
    char           *attribute,                       /* <I> attribute name */ 
...
/********************************************************************************
    ...
    Set UG string attribute in the specified machining feature, if the attribute 
    already exists, then reset the attribute value; otherwise add attribute. 
    ...
    History:  Released in NX3.0 
**********************************************************************************/
extern UFUNEXPORT int UF_MFM_set_string_ug_attribute
(  
    UF_NCFEAT_t    machining_feature,                /* <I> Machining feature */
    char           *attribute,                       /* <I> attribute name */ 
...
/********************************************************************************
    ...
    History:  Released in NX3.0 
**********************************************************************************/
extern UFUNEXPORT int UF_MFM_ask_list_of_faces
(  
    UF_NCFEAT_t    machining_feature,                /* <I> Machining feature */
...
**********************************************************************************/
extern UFUNEXPORT int UF_MFM_recognize_holes
(  
...
/********************************************************************************
    ...
    History:  Released in NX4.0 
**********************************************************************************/
extern UFUNEXPORT int UF_MFM_create_machining_feature
(  
