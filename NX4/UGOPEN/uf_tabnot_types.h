...
typedef struct UF_TABNOT_section_prefs_s
{
    ...
    double border_width;                               /* Width of border if use_double_width_border 
                                                          is TRUE */
} UF_TABNOT_section_prefs_t, *UF_TABNOT_section_prefs_p_t;

typedef struct UF_TABNOT_cell_prefs_s
{
    ...
    char* url;
} UF_TABNOT_cell_prefs_t, *UF_TABNOT_cell_prefs_p_t;

typedef struct UF_TABNOT_sort_data_s
{
...
} UF_TABNOT_sort_data_t, *UF_TABNOT_sort_data_p_t;
