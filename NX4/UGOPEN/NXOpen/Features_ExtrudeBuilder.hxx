    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT ExtrudeBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the extrude draft operation
                 <br> License requirements : None */
            public: NXOpen::GeometricUtilities::SimpleDraft * Draft
            (
            );
            ...
            (
                bool offset_enabled /** If true then offset will be enabled on this extrude, else it will be disabled. */
            );
            ...
            (
                bool draft_enabled /** If true then draft will be enabled on this extrude, else draft is disabled. */
            );
