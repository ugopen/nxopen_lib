...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /**   <br> To obtain an instance of this class, refer to @link RoutingPart RoutingPart@endlink  <br> */
        class NXOPENCPPEXPORT RoutingPartLibrary
        {
            ...
            struct Column
            {
                ...
                public: Column(NXString INIT_name /** Column name.  PART_NUMBER is the index column for
                                                                    all part tables.  */, NXOpen::Preferences::RoutingPartLibrary::ColumnStatus INIT_hidden /** Whether or not the column is used for selection
                                                                    in the specify item dialog. */, NXOpen::Preferences::RoutingPartLibrary::ColumnType INIT_type /** The value type the column stores. */) :
                    Name(INIT_name),
                    Hidden(INIT_hidden),
                    Type(INIT_type)
                {
            ...
            (
                NXOpen::Preferences::RoutingPartLibrary::RootType root_type /** Which root node to find. */
            );
            ...
            /** Returns the table information for a given 
                        @link Preferences::RoutingPartLibrary::NodeType::Table Preferences::RoutingPartLibrary::NodeType::Table@endlink  node.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: std::vector<NXOpen::Preferences::RoutingPartLibrary::Column> GetTableDefinition
            (
                const NXString & node /** Must be a @link Preferences::RoutingPartLibrary::NodeType::Table Preferences::RoutingPartLibrary::NodeType::Table@endlink  
            ...
            /** Returns the part information for a given 
                        @link Preferences::RoutingPartLibrary::NodeType::Part Preferences::RoutingPartLibrary::NodeType::Part@endlink  node.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::CharacteristicList * GetPartDefinition
            (
                const NXString & node /** Must be a @link Preferences::RoutingPartLibrary::NodeType::Part Preferences::RoutingPartLibrary::NodeType::Part@endlink  
                                                    type node, any other node type causes an exception.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                const NXString & start_node /** Must not be a @link Preferences::RoutingPartLibrary::NodeType::Part Preferences::RoutingPartLibrary::NodeType::Part@endlink  
