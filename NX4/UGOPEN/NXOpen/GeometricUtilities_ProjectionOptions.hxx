...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT ProjectionOptions : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            (
                NXOpen::Direction * project_direction /** Direction */
            );
            ...
            (
                NXOpen::GeometricUtilities::ProjectionOptions::DirectionType project_direction_method /** 0: Face normal; 1: Vector constructor */
            );
