    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT Extrude : public Features::BodyFeature
        {
            ...
            */
            ...
            /**Returns  the planar tolerance <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            */
            ...
            /** Returns section of the extrude @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Section * GetSection
            (
            );
            /** Returns direction of the extrude @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Direction * GetDirection
            (
            );
            /** Returns @link ExtrudeLimitData ExtrudeLimitData@endlink  of extrude feature  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ExtrudeLimitData * GetLimitData
            (
            );
            /** Returns @link ExtrudeOffsetData ExtrudeOffsetData@endlink  of extrude feature  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ExtrudeOffsetData * GetOffsetData
            (
            );
            /** Returns @link ExtrudeTaperData ExtrudeTaperData@endlink  of extrude feature  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ExtrudeTaperData * GetTaperData
            (
            );
            /** Get the boolean operation for creating the extrude and the boolean operation target body   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
