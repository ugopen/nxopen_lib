    ...
    namespace Positioning
    {
        ...
        class NXOPENCPPEXPORT Constraint : public NXObject
        {
            ...
            public: enum Type
            {
                ...
                TypeCoaxial/** Two geometries share an axis. */,
                TypePlanarAngle/** Two geometries have a specified angle between them about an axis */
            };
            ...
            (
                NXOpen::Positioning::Constraint::Type constraint_type /** */
            );
            /**Sets  
