...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /**  Contains the preferences related to placing/finding/adding parts and generating
                the Routing bill of materials.   <br> To obtain an instance of this class, refer to @link RoutingApplicationView RoutingApplicationView@endlink  <br> */
        class NXOPENCPPEXPORT RoutingPart
        {
            ...
            (
                NXOpen::Preferences::RoutingPart::UsePreferredPort use_flag /** */
            );
            ...
            /** Sets the method for determining the preferred port to 
                        @link Preferences::RoutingPart::PreferredPortMethod::Name Preferences::RoutingPart::PreferredPortMethod::Name@endlink  and
            ...
            /** Gets the desired port name for method type
                        @link Preferences::RoutingPart::PreferredPortMethod::Name Preferences::RoutingPart::PreferredPortMethod::Name@endlink   @return  NULL if method is not
                                @link Preferences::RoutingPart::PreferredPortMethod::Name Preferences::RoutingPart::PreferredPortMethod::Name@endlink   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXString GetPreferredPortName
            (
            );
            /** Sets the method for determining the preferred port to 
                        @link Preferences::RoutingPart::PreferredPortMethod::Attribute Preferences::RoutingPart::PreferredPortMethod::Attribute@endlink  and
            ...
            /** Gets the attribute and it's value for determining the preferred port for method type 
                        @link Preferences::RoutingPart::PreferredPortMethod::Attribute Preferences::RoutingPart::PreferredPortMethod::Attribute@endlink   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: void GetPreferredPortAttribute
            (
                NXString* attribute_name /** NULL if method is not 
                                        @link Preferences::RoutingPart::PreferredPortMethod::Attribute Preferences::RoutingPart::PreferredPortMethod::Attribute@endlink  */,
            ...
            (
                NXOpen::Preferences::RoutingPart::DetailLevel detail /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPart::FabricationNumbering numbering /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPart::StockLengthDisplay display /** */
            );
            ...
            /**Returns  the node in the part library to use for searching for the default
                        ...
                        have a type of @link Preferences::RoutingPartLibrary::NodeType::Table Preferences::RoutingPartLibrary::NodeType::Table@endlink . A
