...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /** Represents the set of object preferences applicable to entire part. All the preferences available at 
            ...
            @link Layer::LayerManager Layer::LayerManager@endlink  class which holds a work layer property.  <br> To obtain an instance of this class, refer to @link PartPreferences PartPreferences@endlink  <br> */
        class NXOPENCPPEXPORT PartObject
        {
            ...
            public: int GetColor
            (
                NXOpen::Preferences::PartObject::ObjectType type /**  */
            );
            ...
            (
                NXOpen::Preferences::PartObject::ObjectType type /**  */,
                NXOpen::Preferences::PartObject::LineFontType line_font /**  */
            );
