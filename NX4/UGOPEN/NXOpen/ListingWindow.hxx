...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT ListingWindow
    {
        ...
        /** Closes the listing window.  If the listing window is a file,
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link IsOpen() IsOpen@endlink instead.
        @deprecated
        */
        ...
        (
            NXOpen::ListingWindow::DeviceType device_type /** The type of device (file, Information window, or both) */,
            const NXString & file_name /** Name of the file.  Used only if the device type is file.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        ...
        /** <b>Deprecated</b>:<br>
        &nbsp;&nbsp;&nbsp;Use @link Device() Device@endlink instead.
        @deprecated
        */
        public: NXOpen::ListingWindow::DeviceType GetDevice
        (
        ) { return this->Device(); }
