...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT RPODimension : public TransientObject
        {
            ...
            (
                const NXOpen::Point3d & reference_point1 /** target point of dimension */
            );
            ...
            (
                const NXOpen::Point3d & reference_point2 /** tool point of dimension */
            );
            ...
            (
                NXOpen::Features::AssociativityType target_associativity /** target associativity */
            );
            ...
            (
                NXOpen::Features::AssociativityType tool_associativity /** tool associativity */
            );
