...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT PartReopenStatus : public TransientObject
    {
        ...
        */
        ...
        /**Returns  load status value returned from part load. This will be 0 if the load was
        ...
        */
        ...
        /**Returns  description of the load status value returned from part load. This will
