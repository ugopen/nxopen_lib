...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        /** Represents an object that manages annotation and PMI (Product and Manufacturing Information) objects.
                This class contains the collection objects for creating and iterating over annotations and PMIs.  <br> To obtain an instance of this class, refer to @link Part Part@endlink  <br> */
