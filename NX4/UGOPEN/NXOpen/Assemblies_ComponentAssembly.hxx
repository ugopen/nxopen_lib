...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        /**
          Represents the set of @link Component Component@endlink s that make up an
          assembly. Components are arranged in a tree structure, with a single component at the
          root. (See @link ComponentAssembly::RootComponent ComponentAssembly::RootComponent@endlink .) The
          components directly below the root are added to this assembly by calling
          @link ComponentAssembly::AddComponent ComponentAssembly::AddComponent@endlink . These "Top Level" components are
          ...
          @link ComponentAssembly::MoveComponent ComponentAssembly::MoveComponent@endlink  will throw an exception if the
          ...
          assembly. See @link ComponentAssembly::MapComponentFromParent ComponentAssembly::MapComponentFromParent@endlink .
           <br> 

         <br> To obtain an instance of this class, use @link BasePart::GetComponentAssembly BasePart::GetComponentAssembly@endlink  <br> */
        class NXOPENCPPEXPORT ComponentAssembly : public NXObject
        {
            ...
            /** 
                    Creates a new @link Component Component@endlink  in this assembly, based on an existing part file.
            ...
            (
                ...
                const NXOpen::Matrix3x3 & orientation /** Orientation matrix for the new component */,
            ...
            /** 
                    Creates a new @link Component Component@endlink  in this assembly as master part.
                 @return  The new Component  <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /**Returns  the top-level component, i.e. the component at the root of the component
                    ...
                    @link ComponentAssembly ComponentAssembly@endlink . The components below this will correspond to
                    parts added by calling @link ComponentAssembly::AddComponent ComponentAssembly::AddComponent@endlink .
                     <br> 
            ...
            */
            ...
            /** Maps a component in a parent assembly onto a corresponding component in this
                 ...
                 Front Left  Front Right    Rear Left   Rear Right 
                   Wheel       Wheel         Wheel       Wheel     
                    ...
                    Left Wheel will not work. See @link ComponentAssembly::MapComponentsFromSubassembly ComponentAssembly::MapComponentsFromSubassembly@endlink .
            ...
            /** Maps a component in a subassembly onto the corresponding components in this
                 ...
                 Front Left  Front Right    Rear Left   Rear Right 
                   Wheel       Wheel         Wheel       Wheel     
                    ...
                    See also @link ComponentAssembly::MapComponentFromParent ComponentAssembly::MapComponentFromParent@endlink .
            ...
            /**Returns 
                    the currently active @link Arrangement Arrangement@endlink  for this ComponentAssembly
            ...
            */
            ...
            (
                NXOpen::Assemblies::Arrangement * new_arrangement /** The new active @link Arrangement Arrangement@endlink . This Arrangement
            ...
            (
                const std::vector<NXOpen::Assemblies::Component *> & components /** @link Component Component@endlink s to be suppressed */,
            ...
            /**
                    Suppresses an array of components in all @link Arrangements Arrangements@endlink  in this ComponentAssembly
                 @return  list of errors encountered during the suppress  <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::ErrorList * SuppressComponents
            (
                const std::vector<NXOpen::Assemblies::Component *> & components /** @link Component Component@endlink s to be suppressed */
            ...
            (
                const std::vector<NXOpen::Assemblies::Component *> & components /** @link Component Component@endlink s to be unsuppressed */,
                const std::vector<NXOpen::Assemblies::Arrangement *> & arrangements /** Arrangements in which components should be unsuppressed.
                                                                                                          These arrangements must be defined in this ComponentAssembly
                                                                                                       */
            );
            /**
                    Unsuppresses an array of components in all @link Arrangements Arrangements@endlink  in this ComponentAssembly
                 @return  list of errors encountered during the unsuppress  <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::ErrorList * UnsuppressComponents
            (
                const std::vector<NXOpen::Assemblies::Component *> & components /** @link Component Component@endlink s to be unsuppressed */
            ...
            (
                const std::vector<NXOpen::Assemblies::Component *> & components /** @link Component Component@endlink s to be released */,
            ...
            /** 
                    ...
                    Component.DirectOwner
                     @endcode 
                     @code 
                    ComponentAssembly.ReplaceReferenceSet
                     @endcode 
                     <br> 
            ...
            /** The collection of @link Arrangement Arrangement@endlink s defined in the ComponentAssembly */
            ...
            */
            ...
            /** The collection of @link Explosion Explosion@endlink s defined in the ComponentAssembly */
