...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** 
            ...
            */
        class NXOPENCPPEXPORT Gdt : public Annotations::SimpleDraftingAid
        {
            ...
            (
                const NXOpen::Annotations::LineCfw & cfw /** */
            );
            ...
            */
            ...
            /**Returns  a parameter which indicates where the leader end point is located on
                    ...
                    @link Gdt::HasLeaderPositionParameter Gdt::HasLeaderPositionParameter@endlink  is true. 
                    You should not attempt to
                    change this parameter unless
                    @link Gdt::CanChangeLeaderPositionParameter Gdt::CanChangeLeaderPositionParameter@endlink 
                    returns true. 
            ...
            */
            ...
            /**Returns  a flag indicating whether the @link Gdt::LeaderPositionParameter Gdt::LeaderPositionParameter@endlink  can be changed  <br> License requirements : None */
