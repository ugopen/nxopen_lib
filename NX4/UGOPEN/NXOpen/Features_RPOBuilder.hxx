    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT RPOBuilder : public Features::FeatureBuilder
        {
            ...
            (
                ...
                NXOpen::Features::RPOBuilder::AssociativityType target_associativity /** Associativity for target entity */,
                const NXOpen::Point3d & target_help_point /** Help point for taregt entity */,
                NXOpen::NXObject * tool /** Tool entity */,
                NXOpen::Features::RPOBuilder::AssociativityType tool_associativity /** Associativity for tool entity */,
                const NXOpen::Point3d & tool_help_point /** Help point for tool entity */
            );
            /** Sets the expression value in order to constrain the target and tool entities 
                    which are set using @link RPOBuilder::SetTargetAndTool RPOBuilder::SetTargetAndTool@endlink . 
                    ...
                    and @link PositioningDimension::SubtypeLineOntoLine PositioningDimension::SubtypeLineOntoLine@endlink   <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            ...
            /** Creates a positioning dimension. 
                    This is third and the last step in creating a positioning dimension.  <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            public: void CreatePositioningDimension
            (
            );
            /** Displays all the positioning dimensions  <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            public: void ShowPositioningDimensions
            (
            );
            /** Hides display of all the positioning dimensions  <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            ...
            /** Query/Set a horizontal or vertical reference for the feature. A reference is required to be set
                    before creating a Horizontal or Vertical positioning dimension.   <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            ...
            /** Sets a horizontal or vertical reference for the feature. A reference is required to be set
                    ...
                    @link PositioningDimension::SubtypeVertical PositioningDimension::SubtypeVertical@endlink  subtype of positioning dimension.  <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            public: void SetReferenceDirection
            (
                NXOpen::IReferenceAxis * reference /** Reference entity */,
                NXOpen::AxisOrientation orientation /** Orientation of reference */
            );
            /** Undo the last positioning dimension  <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            public: void UndoLastDimension
            (
            );
            /** Transforms the feature by applying the positioning dimensions  <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
            public: void ApplyDimensions
            (
            );
            /** 
                    Gets the list of RPO dimemsions
                 @return  The RPO dimensions  <br> License requirements : solid_modeling ("SOLIDS MODELING"), features_modeling ("FEATURES MODELING") */
