...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        /** Represents a collection of @link Annotations::Weld Annotations::Weld@endlink  objects  <br> To obtain an instance of this class, refer to @link AnnotationManager AnnotationManager@endlink  <br> */
        class NXOPENCPPEXPORT WeldCollection : public TaggedObjectCollection
        {
            ...
            (
                NXOpen::Annotations::LineWeldData * line_weld_data /** */,
