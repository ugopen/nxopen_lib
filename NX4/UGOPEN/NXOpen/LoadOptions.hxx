...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT LoadOptions
    {
        ...
        public: enum LoadComponents
        {
            ...
            LoadComponentsSpecifyFilter/** display list of pre-defined filters to select from */
        };
        ...
        (
            NXOpen::LoadOptions::LoadMethod option /** */
        );
        ...
        */
        ...
        /**Sets  the option indicating what component parts to load during part open.
            ...
            <enum>LoadOptions.LoadComponents.LastFilter</enum> or
            <enum>LoadOptions.LoadComponents.SpecifyFilter</enum> without an
        ...
        (
            NXOpen::LoadOptions::LoadComponents option /** */
        );
        ...
        */
        ...
        (
            bool* interpart_option /** */,
            NXOpen::LoadOptions::Parent* parent_option /** */
        );
        ...
        */
        ...
        (
            ...
            const std::vector<bool> & search_sub_dirs /** */
        );
        ...
        (
            ...
            std::vector<bool> & search_sub_dirs /** */
        );
