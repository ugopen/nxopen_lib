...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /** The RoutingMechanical object stores a set of route mechanical preferences.  <br> To obtain an instance of this class, refer to @link RoutingApplicationView RoutingApplicationView@endlink  <br> */
        class NXOPENCPPEXPORT RoutingMechanical
        {
            /** Describes the Line color string definition types.  */
            public: enum LineColorType
            {
                LineColorTypeUnknown = -1/** */,
                LineColorTypeName/** */,
                LineColorTypeIndex/** */,
                LineColorTypeRgb/** */,
                LineColorTypeHex/** */,
            ...
            public: explicit RoutingMechanical(NXOpen::Preferences::RoutingApplicationView *owner): m_owner(owner)
            {
            }
            ...
            /** Returns types of string in line_color field.  Valid values are
                        specified in the JA_ROUTE_MECH_PREFS_line_color_type enum.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
