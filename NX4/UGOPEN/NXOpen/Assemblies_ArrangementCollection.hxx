...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        /** a collection of arrangements  <br> To obtain an instance of this class, refer to @link ComponentAssembly ComponentAssembly@endlink  <br> */
        class NXOPENCPPEXPORT ArrangementCollection : public TaggedObjectCollection
        {
            ...
            public: explicit ArrangementCollection(NXOpen::Assemblies::ComponentAssembly *owner): m_owner(owner)
            {
            }
            ...
            /** Creates an arrangement, based on an existing arrangement. Note that any @link ComponentAssembly ComponentAssembly@endlink  
                    that contains components will have at least one arrangement. See @link ComponentAssembly::ActiveArrangement ComponentAssembly::ActiveArrangement@endlink .
            ...
            (
                NXOpen::Assemblies::Arrangement * template_arrangement /** The original arranegment. The new arrangement will be copied from this. */,
            ...
            (
                const NXString & journal_identifier /** Name of the arrangement to be found   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
