...
namespace NXOpen
{
    ...
    namespace Routing
    {
        /** Represents a collection of @link ControlPoint ControlPoint@endlink  objects.  <br> To obtain an instance of this class, refer to @link RouteManager RouteManager@endlink  <br> */
        class NXOPENCPPEXPORT ControlPointCollection : public TaggedObjectCollection
        {
            ...
            (
                const NXOpen::Point3d & position /** ABS coordinates*/,
                NXOpen::Routing::ControlPointCollection::CheckExisting check_existing /** Return an existing @link Routing::ControlPoint Routing::ControlPoint@endlink 
                                                                        object if one exists at the same location as the
                                                                        position. */,
                NXOpen::Routing::ControlPointCollection::FoundExisting* found_existing /** Returned @link Routing::ControlPoint Routing::ControlPoint@endlink  is
            ...
            /** Creates a smart @link Routing::ControlPoint Routing::ControlPoint@endlink  object.  The @link Routing::ControlPoint Routing::ControlPoint@endlink 's 
                        ...
                        of a @link Conic Conic@endlink  object.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::ControlPoint * CreateControlPoint
            (
                NXOpen::Conic * conic /** */,
                NXOpen::Routing::ControlPointCollection::CheckExisting check_existing /** Return an existing @link Routing::ControlPoint Routing::ControlPoint@endlink 
            ...
            /** Creates a smart @link Routing::ControlPoint Routing::ControlPoint@endlink  object.  The @link Routing::ControlPoint Routing::ControlPoint@endlink 's 
                        position is associative to a parameter on a @link ICurve ICurve@endlink .  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::ControlPoint * CreateControlPoint
            (
                NXOpen::ICurve * curve /** */,
                double parameter /** Normalized parameter along the curve (0.0 -> 1.0). */,
                NXOpen::Routing::ControlPointCollection::CheckExisting check_existing /** Return an existing @link Routing::ControlPoint Routing::ControlPoint@endlink 
                                                                        object if one exists at the same location as the
                                                                        position. */,
                NXOpen::Routing::ControlPointCollection::FoundExisting* found_existing /** Returned @link Routing::ControlPoint Routing::ControlPoint@endlink  is
            ...
            public: NXOpen::Routing::ControlPoint * CreateControlPoint
            (
                NXOpen::Routing::IRoutePosition * start_object /** Starting position. */,
            ...
            public: NXOpen::Routing::ControlPoint * CreateControlPoint
            (
                NXOpen::Routing::ControlPoint * cp_occ /** Occurrence of a 
