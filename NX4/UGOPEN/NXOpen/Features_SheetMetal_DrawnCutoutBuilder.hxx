    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT DrawnCutoutBuilder : public Features::FeatureBuilder
            {
                ...
                (
                    NXOpen::Features::SheetMetal::DrawnCutoutBuilder::SectionSideOptions section_side /** */
                );
                /** Depth of the Drawn Cutout @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the Direction in which the Drawn Cutout is punched.
                             <br> 
                                ...
                                direction of the Section Normal (specified using the @link DrawnCutoutBuilder::SectionDrawnCutoutBuilder::Section @endlink and @link DrawnCutoutBuilder::SetSectionDrawnCutoutBuilder::SetSection @endlink ) then
                                pass the value of @link Features::SheetMetal::DrawnCutoutBuilder::DepthTypeOptions::SectionNormalSide Features::SheetMetal::DrawnCutoutBuilder::DepthTypeOptions::SectionNormalSide@endlink 
                                If punching must happen in the opposite direction to that of Section Normal, set the value to be
                                @link Features::SheetMetal::DrawnCutoutBuilder::DepthTypeOptions::SectionReverseNormalSide Features::SheetMetal::DrawnCutoutBuilder::DepthTypeOptions::SectionReverseNormalSide@endlink 
                             <br> 
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::DrawnCutoutBuilder::DepthTypeOptions depth_type /** */
                );
                ...
                /**Returns  the side where the material must be added to the Drawn Cutout. Done with Respect to the section
                             <br> 
                                If @link Features::SheetMetal::DrawnCutoutBuilder::SidewallTypeOptions::Inside Features::SheetMetal::DrawnCutoutBuilder::SidewallTypeOptions::Inside@endlink  is specified, the material of the drawn cutout sidewalls will be added to the interior of the section.
                                If @link Features::SheetMetal::DrawnCutoutBuilder::SidewallTypeOptions::Outside Features::SheetMetal::DrawnCutoutBuilder::SidewallTypeOptions::Outside@endlink  is specified,the material will be added from the lifted section such that the volume of the drawn cutout cavity is increased.
                             <br> 
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::DrawnCutoutBuilder::SidewallTypeOptions sidewall_type /** */
                );
