...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /** The RoutingPath object stores a set of path preferences.  <br> To obtain an instance of this class, refer to @link RoutingApplicationView RoutingApplicationView@endlink  <br> */
        class NXOPENCPPEXPORT RoutingPath
        {
            ...
            (
                const std::vector<NXOpen::Preferences::RoutingPath::CurveType> & allowed_curves /** */
            );
            ...
            (
                const std::vector<NXOpen::Preferences::RoutingPath::AllowedCornerType> & allowed_corners /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::DefaultCornerType default_corner /** */
            );
            /** Query the default corner should use bend ratio  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            (
                NXOpen::Preferences::RoutingPath::RadiusUnits radius_units /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::CreateSmartRcps create_smart /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::MergeDupRcps merge_duplicates /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::ConfirmBranchSel confirm_branch_sel /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::ContinueUpdOnError update /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::CreateSlopeConstraints create_slope_constraints /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::ChainMethod chain_method /** */
            );
            ...
            (
                const std::vector<NXOpen::Preferences::RoutingPath::CurveType> & chainable_curve_types /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::OccChainable occ_chainable /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::DisplayObject display_rcps /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::DisplayObject display_ports /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::DisplayObject display_constraints /** */
            );
            ...
            (
                NXOpen::Preferences::RoutingPath::DisplayObject display_anchors /** */
            );
