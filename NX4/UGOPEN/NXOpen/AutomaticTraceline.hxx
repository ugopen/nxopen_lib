...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT AutomaticTraceline : public Traceline
    {
        ...
        (
            double start_offset /** New start offset */
        );
        ...
        (
            double end_offset /** New end offset */
        );
        ...
        (
            std::vector<int> & segment_indices /** Segment indices */,
            std::vector<double> & segment_lengths /** Segment lengths */
        );
