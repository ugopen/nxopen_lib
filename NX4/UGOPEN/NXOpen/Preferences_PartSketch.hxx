...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        and with @link Preferences::SketchPreferences Preferences::SketchPreferences@endlink  for Sketch specific Preferences  <br> To obtain an instance of this class, refer to @link PartPreferences PartPreferences@endlink  <br> */
        class NXOPENCPPEXPORT PartSketch
        {
            ...
            (
                int sketch_overconstrained_color /**  */
            );
            ...
            (
                int sketch_reference_curve_color /**  */
            );
            ...
            (
                int sketch_reference_dimension_color /**  */
            );
            ...
            (
                int sketch_participating_datum_color /**  */
            );
