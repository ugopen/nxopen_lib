...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /** Provides methods for manipulating the Knowledge Fusion preferences in a session.  <br> To obtain an instance of this class, refer to @link SessionPreferences SessionPreferences@endlink  <br> */
        class NXOPENCPPEXPORT RulePreferences
        {
            ...
            /** Get the search libraries for user classes.  @return  search libraries  <br> License requirements : ug_kf_execute ("UG/Knowledge Fusion - Execute") OR ug_kf_author ("UG/Knowledge Fusion - Author") */
            public: std::vector<NXString> GetSearchLibraries
            (
            );
            /** Set the search libraries for user classes.  <br> License requirements : ug_kf_execute ("UG/Knowledge Fusion - Execute") OR ug_kf_author ("UG/Knowledge Fusion - Author") */
