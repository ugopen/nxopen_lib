    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT LoftedFlangeBuilder : public Features::FeatureBuilder
            {
                ...
                /** The thickness  of base lofted flange.Applicable only for Base lofted flange. Ignored for a Secondary Lofted Flange. @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Expression * GetThickness
                (
                );
                /** The thickness  of base lofted flange.Applicable only for Base lofted flange. Ignored for a Secondary Lofted Flange. <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::LoftedFlangeBuilder::SectionSideOptions thick_side /** */
                );
                ...
                (
                    NXOpen::Features::SketchFeature * slave_start_sketch /** */
                );
                ...
                (
                    NXOpen::Features::SketchFeature * slave_end_sketch /** */
                );
