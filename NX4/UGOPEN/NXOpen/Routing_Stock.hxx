...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /**
                 ...
                 <br> 
                    ...
                    Legacy Stocks (even in parts containing Stock as Component stocks).  Any @link Routing::StockData
                     Routing::StockData
                    @endlink  object that defines a bundled stock has a type of @link Routing::StockDataType::Bundled
                 ...
                 <br> 
                    ...
                    stock types.  Stock as Components Stock always uses the @link Routing::StockStyle::Detailed Routing::StockStyle::Detailed@endlink 
                    style (if availble, otherwise it uses the @link Routing::StockStyle::Detailed Routing::StockStyle::Detailed@endlink  style) and
        ...
        class NXOPENCPPEXPORT Stock : public NXObject, public virtual Routing::ICharacteristic
        {
            ...
            (
                NXOpen::Routing::StockData * stock_data /** */
            );
            /** Gets the @link Routing::CrossSection Routing::CrossSection@endlink  that currently defines the profile for the stock.   @return  Returns NULL if this object is using stock style @link 
                                                         ...
                                                         Routing::StockStyle::None@endlink   <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
            ...
            (
                NXOpen::Routing::CrossSection * cross_section /** Must be referenced by the @link Routing::StockData Routing::StockData@endlink 
            ...
            /** Sets the @link Routing::StockStyle Routing::StockStyle@endlink  of the @link Routing::Stock Routing::Stock@endlink . This may
                        ...
                        new sweep feature.  When style is set to @link Routing::StockStyle::None Routing::StockStyle::None@endlink  this routine
            ...
            (
                double rotation_angle /** The angle in radians. Valid values are 0.0 to ( 2 * Pi ). */
            );
            ...
            (
                double twist_angle /** The angle in radians. Valid values are 0.0 to ( 2 * Pi ). */
            );
            ...
            (
                NXOpen::Routing::ProfileFrom profile_end /**  */
            );
            ...
            (
                NXOpen::Routing::StockPort ** start_port /** Port at the start of the first segment. */,
                NXOpen::Routing::StockPort ** end_port /** Port at the end of the last segment. */
            );
            ...
            /** Returns the @link Assemblies::Component Assemblies::Component@endlink  created and controlled by the stock for a
                       ...
                       @link Routing::StockUse::StockAsComponent Routing::StockUse::StockAsComponent@endlink .  @return   <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
            ...
            /** Returns the original length for a stock that has been deformed (it's use is 
                      @link Routing::StockUse::Deformed Routing::StockUse::Deformed@endlink ).  This is the length of the original stock
