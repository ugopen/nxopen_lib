...
namespace NXOpen
{
    ...
    namespace Routing
    {
        /** Represents a collection of @link SBendCorner SBendCorner@endlink  objects.  <br> To obtain an instance of this class, refer to @link RouteManager RouteManager@endlink  <br> */
        class NXOPENCPPEXPORT SBendCornerCollection : public TaggedObjectCollection
        {
            ...
            (
                NXOpen::Routing::ControlPoint * start_rcp /** Start rcp must not be NULL. */,
                NXOpen::Routing::ControlPoint * end_rcp /** End rcp must not be NULL. */,
                NXOpen::Routing::SplineSegment * segment /** Segment representing the path of the S-Bend. */,
                int sbend_type /** Valid values: ROUTE_SBEND_TYPE__[1-5]. */,
                double bend_radius /** S-Bend radius. */
            );
            /** Creates a S-Bend corner between the start rcp and end rcp using a 
            ...
            (
                ...
                NXOpen::Routing::SplineSegment * segment /** Segment representing the path of the S-Bend. */,
                int sbend_type /** Valid values: ROUTE_SBEND_TYPE__[1-5]. */,
                double bend_ratio /** S-Bend ratio. */
            );
            /** Creates a S-Bend corner between the start rcp and end rcp using a 
            ...
            (
                ...
                int sbend_type /** Valid values: ROUTE_SBEND_TYPE_[1-5]. */
            );
            ...
            (
                const NXOpen::Point3d & start_pnt /** Start point of a S-Bend. */,
                const NXOpen::Point3d & end_pnt /** end point of a S-Bend. */,
                const NXOpen::Vector3d & line_vec1 /** First S-Bend defining vector. */,
                const NXOpen::Vector3d & line_vec2 /** Second S-Bend defining vector. */,
                double radius /** Radius to use for a S-Bend */,
                int sbend_type /** Valid values: ROUTE_SBEND_TYPE_[1-5]. */,
                NXOpen::Spline ** bend_curve /** S-Bend spline when a valid solution exists;  
                                                                       NULL otherwise. */
            );
            ...
            (
                ...
                double radius /** Radius to use for a S-Bend */,
                int sbend_type /** Valid values: ROUTE_SBEND_TYPE_[1-5]. */,
                NXOpen::Point3d* extension_pt1 /** Location of 1st extension point where
                                                                   bend fillets could be assigned. Value is
                                                                   not valid when no S-Bend is possible.*/,
                NXOpen::Point3d* extension_pt2 /** Location of 2nd extension point where
                                                                   bend fillets could be assigned.*/,
                NXOpen::Point3d* arc1_start_pt /** Point where the first bend arc starts. 
                                                                   Only computed if not NULL. */,
                NXOpen::Point3d* arc1_end_pt /** Point where the first bend arc ends. 
                                                                   Only computed if not NULL. */,
                NXOpen::Point3d* arc2_start_pt /** Point where the second bend arc starts. 
                                                                               Only computed if not NULL. */,
                NXOpen::Point3d* arc2_end_pt /** Point where the second bend arc ends. 
                                                                   Only computed if not NULL. */
            );
