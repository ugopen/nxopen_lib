...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT NormalCutoutBuilder : public Features::FeatureBuilder
            {
                ...
                public: enum DepthSideOptions
                {
                    ...
                    DepthSideOptionsSymmetric/** Material removed in both directions equally. Only applies when the depth type is @link DepthTypeOptions::Finite DepthTypeOptions::Finite@endlink . */
                };
                ...
                /**Returns  the section used by the normal cutout. It can be open or closed. <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Section * Section
                (
                );
                /**Sets  the section used by the normal cutout. It can be open or closed. <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::NormalCutoutBuilder::DepthSideOptions depth_side /** */
                );
                ...
                (
                    NXOpen::Features::SheetMetal::NormalCutoutBuilder::SectionSideOptions section_side /** */
                );
                ...
                (
                    NXOpen::Features::SheetMetal::NormalCutoutBuilder::DepthTypeOptions type /** */
                );
                ...
                (
                    NXOpen::Features::SheetMetal::NormalCutoutBuilder::CutTypeOptions cut_type /** */
                );
                /**Returns  the depth of the cutout. Only applies when the depth type is @link DepthTypeOptions::Finite DepthTypeOptions::Finite@endlink . <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the face or datum plane from which the cutout begins. This is only applicable if the depth type
                            is @link DepthTypeOptions::FromTo DepthTypeOptions::FromTo@endlink   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                public: void SetFrom
                (
                    NXOpen::ISurface * from /** From face or datum plane */
                );
                ...
                /** Verify that the builder data is valid for creating a normal cutout. 
                             ...
                             <br> 
                         @return  data validity flag (zero is valid, non-zero is invalid). <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
