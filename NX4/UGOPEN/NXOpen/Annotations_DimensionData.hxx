...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT DimensionData : public TransientObject
        {
            ...
            (
                NXOpen::Annotations::LetteringPreferences * lettering_prefs /** New lettering preferences */
            );
            ...
            (
                NXOpen::Annotations::UserSymbolPreferences * user_symbol_prefs /** New user symbol preferences */
            );
            ...
            (
                NXOpen::Annotations::LeaderOrientation leader_orientation /** New leader orientation */
            );
            ...
            (
                NXOpen::Annotations::AppendedText * appended_text /** New appended text */
            );
            /** Get inferred annotation plane.

                        Before calling this method, you must fill in the associativities for the
                        Dimension by calling @link DimensionData::SetAssociativity DimensionData::SetAssociativity@endlink  for
            ...
            (
                ...
                NXOpen::Annotations::DimensionType dim_type /** */
            );
