...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT TrimTaskBuilder : public Features::FeatureBuilder
        {
            ...
            (
                const std::vector<NXOpen::ISurface *> & planes /** */
            );
            ...
            (
                NXOpen::Die::TrimTaskBuilder::MatchCutTypes match_cut_type /** */
            );
            ...
            (
                NXOpen::Die::TrimTaskBuilder::CamTypes cam_type /** */
            );
