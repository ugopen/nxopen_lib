...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT Sketch : public DisplayableObject, public virtual IProfile
    {
        ...
        struct ConstraintGeometry
        {
            ...
            public: /** */NXOpen::Sketch::ConstraintPointType PointType;
            ...
            public: ConstraintGeometry(NXOpen::NXObject * INIT_geometry /** */, NXOpen::Sketch::ConstraintPointType INIT_point_type /** */, int INIT_spline_defining_point_index /** Ignored unless PointType is SplineDefiningPoint.
        ...
        /** Used in @link DimensionGeometry DimensionGeometry@endlink  to indicate what type of 
            geometry to use */
        ...
        {
            public: /** */NXOpen::NXObject * Geometry;
            public: /** */NXOpen::Sketch::AssocType AssocType;
            ...
            public: DimensionGeometry(NXOpen::NXObject * INIT_geometry /** */, NXOpen::Sketch::AssocType INIT_assoc_type /** */, int INIT_assoc_value /** See table for meaning. 
             @code 
            The AssocValue has the following meanings:
            AssocType           AssocValue meaning
            ----------          -------------------
        ...
        (
            NXOpen::ISurface * attachment_plane /** */,
            NXOpen::IReferenceAxis * reference_axis /**  */,
            const NXOpen::Vector3d & reference_direction /**  */,
            NXOpen::AxisOrientation reference_axis_orientation /**  */,
            NXOpen::Sense reference_axis_sense /** */,
            NXOpen::PlaneNormalOrientation normal_orientation /** */,
        ...
        */
        ...
        (
            NXOpen::Sketch::ConstraintVisibility visibility /** */
        );
        ...
        (
            NXOpen::Sketch::CreateInferConstraintSetting create_infer_con /** */
        );
        ...
        (
            ...
            const NXOpen::Sketch::ConstraintGeometryHelp & geom1_help /** */,
            const NXOpen::Sketch::ConstraintGeometry & geom2 /** A curve, edge, or datum axis */,
            const NXOpen::Sketch::ConstraintGeometryHelp & geom2_help /** */
        );
        ...
        (
            const NXOpen::Sketch::ConstraintGeometry & con_geom1 /** */,
            const NXOpen::Sketch::ConstraintGeometry & con_geom2 /** */
        );
        ...
        (
            ...
            const NXOpen::Sketch::ConstraintGeometryHelp & help_data /** */,
        ...
        (
            ...
            NXOpen::Sketch::AddEllipseOption ellipse_option /** If you are adding an ellipse to the sketch, this parameter
                                                                    ...
                                                                    option is ignored.
                                                                    See the documentation for @link AddEllipseOption AddEllipseOption@endlink  for more details. 
                                                                    The default value is
                                                                    @link AddEllipseOptionTreatAsEllipse AddEllipseOptionTreatAsEllipse@endlink .
        ...
        (
            NXOpen::Sketch::ConstraintClass con_class /** Optional filter.  Use @link ConstraintClassAny ConstraintClassAny@endlink  if you
                                                          do not want to filter by constraint class */,
            NXOpen::Sketch::ConstraintType con_type /** Optional filter.  Use @link ConstraintTypeNoCon ConstraintTypeNoCon@endlink  if you
        ...
        */
        ...
        /** Creates a reflection of the input geometry.  @return  The mirrored geometry that was created  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
