            ...
            class NXOPENCPPEXPORT DimpleBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the section Side for the Dimple section.
                             <br> 
                                ...
                                @link Features::SheetMetal::DimpleBuilder::SectionSideOptions::Right Features::SheetMetal::DimpleBuilder::SectionSideOptions::Right@endlink  If you want the
                                other side to be punched, then you have to send @link Features::SheetMetal::DimpleBuilder::SectionSideOptions::Left Features::SheetMetal::DimpleBuilder::SectionSideOptions::Left@endlink .
                             <br> 
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::DimpleBuilder::SectionSideOptions section_side /** */
                );
                ...
                /**Returns  the Direction in which the Dimple is punched.
                             <br> 
                                ...
                                direction of the Section Normal (specified using the @link DimpleBuilder::SectionDimpleBuilder::Section @endlink and @link DimpleBuilder::SetSectionDimpleBuilder::SetSection @endlink ) then
                                pass the value of @link Features::SheetMetal::DimpleBuilder::DepthTypeOptions::SectionNormalSide Features::SheetMetal::DimpleBuilder::DepthTypeOptions::SectionNormalSide@endlink 
                                If punching must happen in the opposite direction to that of Section Normal, set the value to be
                                @link Features::SheetMetal::DimpleBuilder::DepthTypeOptions::SectionReverseNormalSide Features::SheetMetal::DimpleBuilder::DepthTypeOptions::SectionReverseNormalSide@endlink 
                             <br> 
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::DimpleBuilder::DepthTypeOptions depth_type /** */
                );
                ...
                (
                    const NXString & punch_radius /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    const NXString & fillet_radius /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                /**Returns  the Offset Dimension
                             <br> 
                                The actual extent distance of the Dimple will be determined by the active dimension option.
                                In case of @link Features::SheetMetal::DimpleBuilder::DimensionTypeOptions::Offset Features::SheetMetal::DimpleBuilder::DimensionTypeOptions::Offset@endlink  the actual extent distance will be offset dimension distance plus the thickness of sheet.
                                In case of @link Features::SheetMetal::DimpleBuilder::DimensionTypeOptions::Full Features::SheetMetal::DimpleBuilder::DimensionTypeOptions::Full@endlink  the actual extent distance will be the Full dimension distance.
                             <br> 
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::DimpleBuilder::DimensionTypeOptions dimension_type /** */
                );
                /**Returns  the side where the material must be added to the dimple. Done with Respect to the section
                             <br> 
                                If @link Features::SheetMetal::DimpleBuilder::SidewallTypeOptions::Inside Features::SheetMetal::DimpleBuilder::SidewallTypeOptions::Inside@endlink  is specified, the material of the dimple sidewalls will be added to the interior of the section.
                                If @link Features::SheetMetal::DimpleBuilder::SidewallTypeOptions::Outside Features::SheetMetal::DimpleBuilder::SidewallTypeOptions::Outside@endlink  is specified,the material will be added from the lifted section such that the volume of the dimple cavity is increased.
                             <br> 
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::SheetMetal::DimpleBuilder::SidewallTypeOptions sidewall_type /** */
                );
