...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        class NXOPENCPPEXPORT DatabaseAttributeManager : public TransientObject
        {
            ...
            (
                const NXString & attribute_title /** the title of the attribute to be set */,
                const NXString & attribute_value /** the new value the attribute is to be set to */
            );
            ...
            (
                const NXString & attribute_title /** the title of the attribute */
            );
