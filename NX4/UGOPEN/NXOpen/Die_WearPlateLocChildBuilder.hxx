...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT WearPlateLocChildBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the orientation plane of die wear plate and locators  <br> License requirements : ug_die_design ("Die Design") */
            public: void SetOrientation
            (
                NXOpen::ISurface * orientation /** */
            );
            /**Returns  the orientation plane of die wear plate and locators  <br> License requirements : ug_die_design ("Die Design") */
            ...
            (
                const NXString & point_location /** Length along centerline expression value   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /**Returns  the point location along the centerline of die wear plate and locators  <br> License requirements : ug_die_design ("Die Design") */
            ...
            (
                NXOpen::Die::WearPlateLocChildBuilder::PositionType position /** */
            );
