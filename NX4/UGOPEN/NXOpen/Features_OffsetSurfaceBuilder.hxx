...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** This class represents a offset surface builder. It has the necessary Journamation APIs for
             *  getting and setting the data used for creating or editing an offset surface feature. The 
             *  offset surface feature allows different face sets to be offset by different distances. 
        ...
        class NXOPENCPPEXPORT OffsetSurfaceBuilder : public Features::FeatureBuilder
        {
            ...
            /** Gets the list of face sets. This list is a simple variable length array of any JA object.
                  @return  Face set list <br> License requirements : None */
            ...
            /** Finds and returns a face set at the specified index from the face set list
                  @return  Face set returned <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            (
                const std::vector<NXOpen::GeometricUtilities::FaceSetOffset *> & face_sets /** Face set list*/
            );
            ...
            (
                NXOpen::Features::OffsetSurfaceBuilder::OutputOptionType output_option /** Output option */
            );
            ...
            (
                bool approx_option /** Approximate offset option */
            );
            ...
            (
                bool step_option /** Allow step boundaries option */
            );
            ...
            /** Sets the offset surface orientation method based on the enum JA_OFFSET_SURFACE_BUILDER_orientation_method_type
                  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetOrientationMethod
            (
                NXOpen::Features::OffsetSurfaceBuilder::OrientationMethodType orientation_method /** Orientation method */
            );
            /** Gets the offset surface orientation method based on the enum JA_OFFSET_SURFACE_BUILDER_orientation_method_type
