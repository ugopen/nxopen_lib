...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        /** The RoutingLogical object stores a set of route logical preferences.  <br> To obtain an instance of this class, refer to @link RoutingApplicationView RoutingApplicationView@endlink  <br> */
        class NXOPENCPPEXPORT RoutingLogical
        {
            ...
            (
                NXOpen::Preferences::RoutingLogical::FlowArrowEnumType flow_arrow_type /** */
            );
