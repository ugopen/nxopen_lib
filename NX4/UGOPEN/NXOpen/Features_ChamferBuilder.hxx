...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents the chamfer builder data. 
            <br> Use  @link Features::FeatureCollection::CreateChamferBuilder Features::FeatureCollection::CreateChamferBuilder@endlink  method to create or edit a Chamfer. <br> */
        class NXOPENCPPEXPORT ChamferBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the smart collector tag  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetSmartCollector
            (
                NXOpen::ScCollector * sc /** */
            );
            ...
            /**Sets  the chamfer parameter option.
                     <br> 
                       @link ChamferBuilder::ChamferOption::SymmetricOffsets ChamferBuilder::ChamferOption::SymmetricOffsets@endlink 
                       @link ChamferBuilder::ChamferOption::TwoOffsets ChamferBuilder::ChamferOption::TwoOffsets@endlink 
                       @link ChamferBuilder::ChamferOption::OffsetAndAngle ChamferBuilder::ChamferOption::OffsetAndAngle@endlink 
                     <br> 
            ...
            (
                NXOpen::Features::ChamferBuilder::ChamferOption opt /** */
            );
            /**Sets   the offset method. <br> 
                       @link ChamferBuilder::OffsetMethod::EdgesAlongFaces ChamferBuilder::OffsetMethod::EdgesAlongFaces@endlink 
                       @link ChamferBuilder::OffsetMethod::FacesAndTrim ChamferBuilder::OffsetMethod::FacesAndTrim@endlink 
                        <br> 
            ...
            (
                const NXString & offset_expression /** */
            );
            ...
            (
                const NXString & angle_expression /** */
            );
            /**Returns  the smart collector tag  <br> License requirements : None */
