...
namespace NXOpen
{
    ...
    namespace Routing
    {
        /** Represents a collection of @link PortConnection PortConnection@endlink  objects.  <br> To obtain an instance of this class, refer to @link RouteManager RouteManager@endlink  <br> */
