    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT LouverBuilder : public Features::FeatureBuilder
            {
                ...
                (
                    NXOpen::Features::SheetMetal::LouverBuilder::DepthSideOptions depth_side /** */
                );
                ...
                (
                    NXOpen::Features::SheetMetal::LouverBuilder::SectionSideOptions section_side /** */
                );
                /**Returns  the option to round the edges of the louver using the die radius. If this is false, then the value 
                            of @link LouverBuilder::DieRadiusLouverBuilder::DieRadius @endlink and @link LouverBuilder::SetDieRadiusLouverBuilder::SetDieRadius @endlink  is not used.
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the die radius. Not used if @link LouverBuilder::IncludeRoundingLouverBuilder::IncludeRounding @endlink and @link LouverBuilder::SetIncludeRoundingLouverBuilder::SetIncludeRounding @endlink  is false.  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the end type for the louver. Select lanced end or formed end from @link LouverBuilder::EndTypeOptions LouverBuilder::EndTypeOptions@endlink .
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::LouverBuilder::EndTypeOptions EndType
                (
                );
                /**Sets  the end type for the louver. Select lanced end or formed end from @link LouverBuilder::EndTypeOptions LouverBuilder::EndTypeOptions@endlink .
                         <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: void SetEndType
                (
                    NXOpen::Features::SheetMetal::LouverBuilder::EndTypeOptions end_type /** */
                );
