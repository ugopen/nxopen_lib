...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT SimpleDraftingAid : public Annotations::DraftingAid
        {
            ...
            (
                NXOpen::Annotations::UserSymbolPreferences * usym_prefs /** */
            );
            /** Sets the symbol preferences  <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: void SetSymbolPreferences
            (
                NXOpen::Annotations::SymbolPreferences * symbol_prefs /** */
            );
            ...
            /** Gets the symbol preferences  @return   <br> License requirements : None */
