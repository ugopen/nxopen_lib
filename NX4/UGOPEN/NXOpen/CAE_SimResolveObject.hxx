...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT SimResolveObject : public NXObject
        {
            ...
            (
                int conflict_bc_index /** index of the conflict bc asked for */
            );
            ...
            (
                std::vector<NXOpen::CAE::SimBC *> & conflict_bcs /** array of conflicting bcs */
            );
            ...
            (
                bool user_edit_flag /** user edit flag */
            );
