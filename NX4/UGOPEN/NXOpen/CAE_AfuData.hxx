...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT AfuData : public TransientObject
        {
            ...
            /** Get the Afu Data Record ID information  <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            ...
            /** AFU Data Record ID information  <br> License requirements : nx_ftk ("NX Advanced Graphing") */
