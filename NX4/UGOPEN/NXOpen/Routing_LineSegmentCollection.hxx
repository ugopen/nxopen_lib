...
namespace NXOpen
{
    ...
    namespace Routing
    {
        /** Represents a collection of @link Routing::LineSegment Routing::LineSegment@endlink  objects.  <br> To obtain an instance of this class, refer to @link SegmentManager SegmentManager@endlink  <br> */
        class NXOPENCPPEXPORT LineSegmentCollection : public TaggedObjectCollection
        {
            private: NXOpen::Routing::SegmentManager* m_owner;
            public: explicit LineSegmentCollection(NXOpen::Routing::SegmentManager *owner): m_owner(owner)
            {
            }
