...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT RibChildBuilder : public Features::FeatureBuilder
        {
            ...
            (
                NXOpen::IOrientation * bottom_end /** */
            );
            ...
            (
                double bottom_horizontal_offset /** */
            );
            ...
            (
                double lightening_core_clearance /** */
            );
