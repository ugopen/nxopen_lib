...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        /** Represents a drawing sheet.   <br> To obtain an instance of this class, see 
                @link Drawings::DrawingSheetCollection::ToArray Drawings::DrawingSheetCollection::ToArray@endlink  <br> */
        class NXOPENCPPEXPORT DrawingSheet : public NXObject
        {
            ...
            {
                ProjectionAngleTypeFirstAngle = 1/** */,
            ...
            /** Returns the @link DraftingView DraftingView@endlink s on a sheet.  @return   <br> License requirements : None */
            ...
            /** <b>Deprecated</b>:<br>
            &nbsp;&nbsp;&nbsp;Use @link View() View@endlink instead.
            @deprecated
            */
            public: NXOpen::View * GetView
            (
            ) { return this->View(); }
            /**Returns  the status on whether this @link DrawingSheet DrawingSheet@endlink  is out of date.  <br> License requirements : None */
            ...
            */
            ...
            /** <b>Deprecated</b>:<br>
            &nbsp;&nbsp;&nbsp;Use @link ProjectionAngle() ProjectionAngle@endlink instead.
            @deprecated
            */
            public: NXOpen::Drawings::DrawingSheet::ProjectionAngleType GetProjectionAngle
            (
            ) { return this->ProjectionAngle(); }
            /**Returns  the units of the drawing sheet. To change the units of drawing sheet, use 
                        @link DrawingSheet::SetParameters DrawingSheet::SetParameters@endlink   <br> License requirements : None */
            public: NXOpen::Drawings::DrawingSheet::Unit Units
            (
            );
            /** <b>Deprecated</b>:<br>
            &nbsp;&nbsp;&nbsp;Use @link Units() Units@endlink instead.
            @deprecated
            */
            public: NXOpen::Drawings::DrawingSheet::Unit GetUnits
            (
            ) { return this->Units(); }
            ...
            /** <b>Deprecated</b>:<br>
            &nbsp;&nbsp;&nbsp;Use @link Height() Height@endlink instead.
            @deprecated
            */
            ...
            */
            ...
            /** Sets the parameters of the drawing sheet.  The scale of those @link DraftingView DraftingView@endlink s that are
            ...
            (
                ...
                NXOpen::Drawings::DrawingSheet::ProjectionAngleType projection_angle /** */,
                std::vector<NXOpen::Drawings::DraftingView *> & associated_views /** List of  Drafting Views that did not have their scale modified
