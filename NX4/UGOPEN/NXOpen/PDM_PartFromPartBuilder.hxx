...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        class NXOPENCPPEXPORT PartFromPartBuilder : public PDM::PartBuilder
        {
            ...
            /**Sets  which non-master parts to save during the save as operation  <br> License requirements : None */
            public: void SetNonmasterSaveAsOption
            (
                NXOpen::PDM::PartFromPartBuilder::FileSaveAs save_option /** */
            );
            /**Returns  which non-master parts to save during the save as operation  <br> License requirements : None */
            public: NXOpen::PDM::PartFromPartBuilder::FileSaveAs NonmasterSaveAsOption
            (
            );
            /**Sets  which dependent files to save during the save as operation  <br> License requirements : None */
            public: void SetDependentFileSaveAsOption
            (
                NXOpen::PDM::PartFromPartBuilder::FileSaveAs save_option /** */
            );
            /**Returns  which dependent files to save during the save as operation  <br> License requirements : None */
