...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a Routing Multi Port Object@link MultiPort MultiPort@endlink .
        ...
        class NXOPENCPPEXPORT MultiPort : public Routing::Port, public virtual Routing::IAxisPort
        {
            ...
            (
                std::vector<NXString> & virtual_ports /** Virtual Ports names associated with this Multi Port   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                std::vector<NXString> & virtual_ports /**  List of virtual port names to remove.  
                                                                     Ignores any virtuals that are not already referenced 
                                                                     by this object.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            (
                std::vector<NXString> & virtual_ports /**  List of virtual port names to add.  An error will occur if any
                                                                     of these names are already in use as a virtual or terminal
                                                                     port name on this multi port.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
