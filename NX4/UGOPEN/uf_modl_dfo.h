...
typedef enum UF_MODL_dfo_constraint_type_e
{
...
All belends adjacent to the extracted region will be automatically recognized. If users want to, in purpose, treat some of them as not blends, 
...
typedef struct UF_MODL_dfo_constraint_s
{
   ...
   char                          value [UF_MAX_EXP_LENGTH];    /* <len:UF_MAX_EXP_LENGTH> distance or angle value. Any expression string. */
...
typedef struct UF_MODL_reblend_face_data_s
{
    ...
    char radius[UF_MAX_EXP_LENGTH];      /* <len:UF_MAX_EXP_LENGTH> reblend radius */
...
(
    ...
    char factors[3][UF_MAX_EXP_LENGTH], /* <I,len:UF_MAX_EXP_LENGTH> scale factors */
...
(
    ...
    void                    *transf_data,    /* <I> transformation data, can be of following types:
                                                ...
                                                UF_MODL_transf_dist_p_t - translatiion along direction
