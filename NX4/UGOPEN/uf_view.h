...
typedef enum UF_VIEW_vde_type_e
{
    UF_VIEW_VDE_NON_EDIT = -1,
    UF_VIEW_VDE_ALL,
    UF_VIEW_VDE_USER,
    UF_VIEW_VDE_SYSTEM
} UF_VIEW_vde_type_t, *UF_VIEW_vde_type_p_t;
...
typedef enum UF_VIEW_cycle_objects_e UF_VIEW_cycle_objects_t;
typedef UF_VIEW_cycle_objects_t *UF_VIEW_cycle_objects_p_t;


typedef enum UF_VIEW_standard_orientation_e {
...
}UF_VIEW_standard_orientation_t, *UF_VIEW_standard_orientation_p_t;
...
/****************************************************************************
Sets the lighting attributes of a single specified view. Each view can
have different lights assigned to it. The lights are now shared between
the NX hardware shading and Photo shading.
...
A cycle type of UF_VIEW_VISISBLE_OBJECTS returns all objects which are
visible in the view; when using a cycle type of UF_VIEW_VISIBLE_OBJECTS,
objects which are outside of the view bounds are not returned.
...
See Also: UF_VIEW_cycle_objects
...
NOTE: "Clipping Enabled by System" means Unigraphics
