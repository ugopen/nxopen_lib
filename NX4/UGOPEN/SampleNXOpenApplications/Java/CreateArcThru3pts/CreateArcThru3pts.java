...
01-Mar-2005  Abhishek Mishra         Intial Creation
28-Apr-2005  Abhishek Mishra         Update List problem
...
public class CreateArcThru3pts 
{
    public static void main(String[] args) throws Exception
    {
		...
		try
        {
            ...
            theUFSession = (UFSession)SessionFactory.get("UFSession");            theUFSession.ui().openListingWindow();
