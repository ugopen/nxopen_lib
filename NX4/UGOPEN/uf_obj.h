...
current status or displayability. It does not return expressions.
...
return condemned objects, expressions, or sleepy objects. An object
that is asleep is one that has been removed from the model. For
example, if you blend an edge, then the edge is asleep.  The WCS will not
...
determine if the color, layer, blank status, font, or line width of an
object can be set.
