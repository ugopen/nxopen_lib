...
enum UF_DPUD_taxis_option_e
    {
    UF_DPUD_TAXIS_CONSTANT,     /* Tool axis is constant and UG-specified */
    UF_DPUD_TAXIS_VARIABLE,     /* Tool axis is variable and UG-specified */
...
that was passed to the User Exit from UG.

Environment: Internal  and  External
See Also:
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_dpud(
UF_CAM_exit_id_t exit_id ,/* <I>
                          Identifier passed to User Exit from UG
                          */
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_oper(
UF_DPUD_id_t dpud ,/* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_purpose(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
...
/**************************************************************************
Determine the tool axis option chosen by the user in the UG dialog.

Environment: Internal  and  External
See Also:
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_taxis_option(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
...
/**************************************************************************
Determine the tool axis chosen by the user in the UG dialog, if the
...
the UG processor, there is no need to do it in the UG/Open API
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_tool_axis(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
...
/**************************************************************************
Determine the projection vector option chosen by the user in the UG
dialog.
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_proj_option(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
...
/**************************************************************************
Determine the projection vector chosen by the user in the UG dialog,
...
set by the UG processor, there is no need to do it in the UG/Open
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_proj_vec(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
double proj_vec[3]  /* <O>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_set_user_data_size(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
int size  /* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_drpos0(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_drpos1(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
UF_DRPOS_id_t * drpos  /* <O>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_drpos2(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
UF_DRPOS_id_t * drpos  /* <O>
...
0.0, the UG/Open API program must return a copy of drpos2. Note:
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DPUD_ask_ratio(
UF_DPUD_id_t dpud ,/* <I>
                   Identifier for a DPUD object
                   */
double* ratio  /* <O>
