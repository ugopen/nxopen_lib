...
extern UFUNEXPORT int UF_TABNOT_ask_relative_row(
    tag_t row,                          /* <I> Row */
    int position,                       /* <I> Relative position.  If position < 0,
                                           the row retrieved will be above the
                                           given row; if position > 0, the row
                                           retrieved will be below the given row. */
...
extern UFUNEXPORT int UF_TABNOT_ask_relative_column(
    tag_t column,                       /* <I> Column */
    int position,                       /* <I> Relative position.  If position < 0,
                                           the column retrieved will be to the left
                                           of given column; if position > 0, the
                                           column retrieved will be to the right of
                                           the given column.                       */
...
UFUNEXPORT int UF_TABNOT_ask_row_head_cfw(
    tag_t row,                          /* <I> Row */
...
UFUNEXPORT int UF_TABNOT_set_row_head_cfw(
    tag_t row,                          /* <I> Row */
...
UFUNEXPORT int UF_TABNOT_ask_column_head_cfw(
    tag_t column,                       /* <I> Column */
    tag_t section,                      /* <I> Section */
...
UFUNEXPORT int UF_TABNOT_set_column_head_cfw(
    tag_t column,                       /* <I> Column */
    tag_t section,                      /* <I> Section */
 ...
 *
 ********************************************************************************/
UFUNEXPORT int UF_TABNOT_enable_automatic_update(
 ...
 *
 ********************************************************************************/
UFUNEXPORT int UF_TABNOT_update(
