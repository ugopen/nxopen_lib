...
/******************************************************************************
Returns if the given UG object has a bounding box recorded for it.
...
/******************************************************************************
Updates the assembly structure of the given part, and is equivalent to
the interactive option:
Assemblies->Component Filters->Define Script->Update Structure
