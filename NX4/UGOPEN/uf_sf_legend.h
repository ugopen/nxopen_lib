...
extern "C" {
  ...
  /************************************************************************/
    ...
    char  displ_str[256];
    char  real_str[LEGEND_REAL_STR_SZ+1];
...
/***************************************************************************
  ...
  LEGEND_format_real_to_str function.                                       
***************************************************************************/  
#define UF_SF_LEGEND_REAL_STR_SZ   20
...
***************************************************************************/ 
typedef struct UF_SF_LEGEND_title_s
{
    int num_strs;   /* Number of strings in the title */
    char **strs;    /* <len:num_strs>
						Array of strings               */
} UF_SF_LEGEND_title_t, *UF_SF_LEGEND_title_p_t;
...
typedef struct UF_SF_LEGEND_index_text_attr_s
{
...
} UF_SF_LEGEND_index_text_attr_t, *UF_SF_LEGEND_index_text_attr_p_t;
...
typedef struct UF_SF_LEGEND_index_color_attr_s
{
    unsigned int attr_mask;     /* This field is set to one or more of the following
                                   symbols OR'd together to indicate which of the
                                   remaining fields of the structure are set.
    ...
    double     *values;        /* <len:num_values>
                                  ...
                                  Mandatory if color index is specified. */
}UF_SF_LEGEND_index_color_attr_t, *UF_SF_LEGEND_index_color_attr_p_t;
...
typedef struct UF_SF_LEGEND_index_attr_s
{
    unsigned int attr_mask;       /* This field is set to one or more of the following
                                     symbols OR'd together to indicate which of the
                                     remaining fields of the structure are set.
...
} UF_SF_LEGEND_index_attr_t, *UF_SF_LEGEND_index_attr_p_t;
...
****************************************************************************/ 
typedef struct UF_SF_COLOR_attr_s
{
...
} UF_SF_COLOR_attr_t, *UF_SF_COLOR_attr_p_t;
...
typedef struct UF_SF_LEGEND_attr_s
{
    unsigned int attr_mask;    /* This field is set to one or more of the following
                                  symbols OR'd together to indicate which of the
                                  remaining fields of the structure are set.
    ...
    UF_SF_LEGEND_title_t      footer;        
                               /* The footer text of the legend area 
                                  default: none defined. */   
} UF_SF_LEGEND_attr_t, *UF_SF_LEGEND_attr_p_t;
