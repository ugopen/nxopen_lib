...
Contains UG/Open typedefs and macros that are specific to the DRAW module.
...
struct UF_DRAW_view_prfs_s
{
   ...
   int                           visible_line_width; /* Please use either
                                                     ...
                                                     UF_OBJ_WIDTH_ORIGINAL
                                                     */
   logical     interfering_solids; /* When TRUE, renders hidden line correctly 
                                      for interfering solids 
                                   */ 
...
/*************************************************************************
 Projection Angles                                                      
**************************************************************************/
typedef enum UF_DRAW_projection_angle_e {
...
struct UF_DRAW_view_info_s{
    ...
    logical                inherit_pmi;      /* If TRUE, then PMI are copied
                                                ...
                                                imported drawing view */
   char model_name[UF_DRAW_MAX_LABEL_LEN];   /* Part name for the view, filespec with path, may be '\0'.
...
typedef enum UF_DRAW_comp_section_in_view_e
{
    UF_DRAW_NON_SECTIONED = 0,
    UF_DRAW_SECTIONED,
    UF_DRAW_NOT_VIEW_SPECIFIED
} UF_DRAW_comp_section_in_view_t;
...
typedef enum UF_DRAW_break_position_type_e
{
...
typedef enum { 
        UF_DRAW_view_label_below = 1, 
        UF_DRAW_view_label_above 
...
#define UF_DRAW_MAX_LETTER_LEN (30)
typedef struct UF_DRAW_view_label_parms_s { 
    ...
    char       view_letter[UF_DRAW_MAX_LETTER_LEN];          
                                         /* View letter string */ 
