...
UG/Open interface to functions that evaluate curves.  These functions are
...
See Also: See UF_EVAL_evaluate_*, 
              UF_EVAL_ask_*, 
              UF_EVAL_is_* and
 UF_EVAL_free
...
parabolic edges in Unigraphics.
Environment: Internal  and  External
...
hyperbolic edges in Unigraphics.
Environment: Internal  and  External
...
There are no parabolic edges in Unigraphics.
...
There are no hyperbolic edges in Unigraphics.
