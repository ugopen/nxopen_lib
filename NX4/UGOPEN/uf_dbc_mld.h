 ...
 *    UG MOLD to interface with the external database that stores the
 ...
 *    UF_CAM_exit_id_t passed to the User Exit from UG.
 *
 ...
 ******************************************************************************/
extern UFUNEXPORT int UF_DBC_MLD_ask_dbc_mld
(
   UF_CAM_exit_id_t   exit_id,     /* <I> - exit_id passed to exit from UG */
 ...
 * History: Originally released in V16.0
 ******************************************************************************/
extern UFUNEXPORT int UF_DBC_MLD_create
(
 ...
 * History: Originally released in V16.0
 ******************************************************************************/
extern UFUNEXPORT int UF_DBC_MLD_exec_command
(
 ...
 * History: Originally released in V16.0
 ******************************************************************************/
extern UFUNEXPORT int UF_DBC_MLD_ask_sheet
(
 ...
 * History: Originally released in V16.0
 ******************************************************************************/
extern UFUNEXPORT int UF_DBC_MLD_set_sheet
(
   UF_DBC_MLD_id_t      object,  /* <I> - see above description */
 ...
 * History: Originally released in V16.0
 ******************************************************************************/
extern UFUNEXPORT int UF_DBC_MLD_set_interp_result
(
   UF_DBC_MLD_id_t   object, /* <I> - see above description */
 ...
 * History: Originally released in V16.0
 ******************************************************************************/
extern UFUNEXPORT int UF_DBC_MLD_delete
(
