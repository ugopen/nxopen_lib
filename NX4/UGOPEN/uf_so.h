...
int options ,/* <I>
             ...
             UF_SO_ASK_CHILDREN - Ask referencing smart objects.
...
/****************************************************************************
Creates a direction via two directions.
...
extern UFUNEXPORT int UF_SO_create_xform_offset_xform(
 ...
 const tag_t                                         csys,                            /* <I> RM xform */
 const tag_t                                         point0,                         /* <I> from RM point */
 const tag_t                                         point1,                         /* <I> to RM point */
 const tag_t                                         rot_scalar_tags[3], /* <I> Rotation offset expressions tags */
 const tag_t                                         scale,                          /* <I> RM scalar ( NULL_TAG => IDENTITY ) */
 const tag_p_t                                    xform                           /* <O> Smart xform*/

);

/*****************************************************************************
Creates a smart transform given a three points and the scale.
...
(
 const tag_t                                        object_in_part,       /* <I> determines the context */
 const UF_SO_update_option_t                        update_option,        /* <I> update option */                   
 const tag_t                                        point0,               /* <I> RM point */
 const tag_t                                        point1,               /* <I> RM point */
 const tag_t                                        point2,               /* <I> RM point */
 const tag_t                                        scale,                /* <I> RM scalar ( NULL_TAG => IDENTITY ) */
 const tag_p_t                                      xform                 /* <O> Smart xform*/
);
...
(
 const tag_t              object_in_part, /* <I> determines the context */
 const UF_SO_update_option_t  update_option,        /* <I> update option */                   
 const tag_t              plane0,         /* <I> RM plane */
 const tag_t              plane1,         /* <I> RM plane */
 const tag_t              plane2,         /* <I> RM plane */
 const tag_t              scale,           /* <I> RM scalar ( NULL_TAG => IDENTITY ) */
 const tag_p_t            xform           /* <O> Smart xform*/
);
...
/*****************************************************************************
Creates a smart point via three scalars.
