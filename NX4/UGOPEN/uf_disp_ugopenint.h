...
extern UGOPENINTEXPORT int UF_DISP_create_framed_image(
    ...
    int upper_left_corner[2] ,          /* <I>
                                        The Image's upper left conrer in the 
...
extern UGOPENINTEXPORT void UF_DISP_conehead(
       int display_flag ,     /* <I>
                  ...
                  */
       double coord[] ,       /* <I,len:3>
                              3D absolute coordinates of anchor.
                              */
       double vector[] ,      /* <I,len:3>
 ...
 * Unigraphics. There must be a part loaded before calling this function.
 * Environment: Internal
 * See Also: 
 * History:
*****************************************************************************/
 ...
 * such, it neither creates, nor is directly associated with, a Unigraphics
 ...
 * neither creates, nor is directly associated with, a Unigraphics object.
