/*******************************************************************************
          ...
          Copyright (c) 1995-2004 UGS Corp.
...
(
 ...
 char   *pt_name ,    /* <O> Point name variable.             */
 int    auto_flag[2], /* <O>
...
(
 ...
 char     name_prefix[UF_OBJ_NAME_LEN],   /* <O> Prefix for new sketch names */
 char     vertex_prefix[UF_OBJ_NAME_LEN], /* <O> Prefix for vertex names */
 char     line_prefix[UF_OBJ_NAME_LEN],   /* <O> Prefix for line names */
 char     arc_prefix[UF_OBJ_NAME_LEN],    /* <O> Prefix for arc names */ 
 char     conic_prefix[UF_OBJ_NAME_LEN],  /* <O> Prefix for conic names */
 char     spline_prefix[UF_OBJ_NAME_LEN], /* <O> Prefix for spline names */ 
 double   *char_size,                     /* <O> Default character size 
                                             for sketch dimension */
 int      *dec_places,                    /* <O> Number of decimal places 
                                             for dimensions */
 int      *dim_label                      /* <O> Dimension Label:
                                                 1 = value
                                                 2 = expression
...
(
 char   name[30], /* <I/O> Input sketch name, returns updated sketch name. */
...
(
 int    values[9] ,     /* <I> Array of flags to indicate which settings should be
 ...
 char   *pt_name,     /* <I>  Point name variable.           */
 int    auto_flag[2], /* <I> Auto inferencing/constraint flag (1= Off; 2= On):
                             [0] = Auto inferencing
                             [1] = Auto constraint
                      */
 int    show_flag[3], /* <I>  Show csys / datum / arrows flag (1= Off; 2= On)
                             [0] = CSYS
                             [1] = Datum
                             [2] = Arrows
                      */
...
(
 tag_t     sketch_tag,       /* <I> Sketch tag.
                                ...
                                associated with The preferences will then 
 ...
 double     snap_angle,                       /* <I> Snap angle            */
 char       name_prefix[UF_OBJ_NAME_LEN],     /* <I,len:UF_OBJ_NAME_LEN>  
												 Sketch name prefix   */
           
 char       vertex_prefix[UF_OBJ_NAME_LEN],   /* <I,len:UF_OBJ_NAME_LEN>  
												 Vertex name prefix   */
           
 char       line_prefix[UF_OBJ_NAME_LEN],     /* <I,len:UF_OBJ_NAME_LEN>  
												 Line Iname prefix    */
           
 char       arc_prefix[UF_OBJ_NAME_LEN],      /* <I,len:UF_OBJ_NAME_LEN>  
												 Arc name prefix      */
           
 char       conic_prefix[UF_OBJ_NAME_LEN],    /* <I,len:UF_OBJ_NAME_LEN>  
												 Conic name prefix    */
           
 char       spline_prefix[UF_OBJ_NAME_LEN],   /* <I,len:UF_OBJ_NAME_LEN>  
											     Spline name prefix   */
