...
File description:
       ...
       to define your own surfaces for use inside Unigraphics. You can use this
       ...
       using Unigraphics modeling techniques.
       ...
       Unigraphics startup this library will be loaded and ufsta will be
       ...
       functions you register will be called when Unigraphics needs to process
