...
The following CGM functions will be removed in Unigraphics NX5.
...
double matrix[12] ,/* <I>
                   ...
                   */
tag_t * ug_tag  /* <O>
                Unigraphics tag of reference set
                */
);
...
extern UFUNEXPORT int uc5595(char *cp1, double *rp2, tag_t *nr3, char *cr4);
/* uc5596 export ug objects to an icad binary report */
extern UFUNEXPORT int uc5596(char *cp1, tag_t *np2, int ip3, char *cr4);
