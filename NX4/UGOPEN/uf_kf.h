/***************************************************************************************************
                   ...
                   Copyright (c) 2000-2005 Unigraphics Solutions Inc. 
...
(
    UF_KF_value_p_t   value, /* <I> Knowledge Fusion value */ 
    char            **string /* <O> Data of value. Do not free. */  
);
...
(
    UF_KF_value_p_t  value, /* <I>  Knowledge Fusion value */ 
    UF_KF_list_p_t  *list   /* <OF> Knowledge Fusion list
...
(
    ...
    tag_t            *ug_object /* <O> Ug object */ 
);

/****************************************************************************
Get a fusion object from a ug object. Returns a NULL_TAG when the ug object
...
( 
    const char *name_chain,     /* <I> Reference chain of instance where rule will
...
( 
    const char           *name_chain, /* <I> Reference chain to instance */
    const char           *rule_name,  /* <I> Name of rule */
    UF_KF_rule_p_t *rule        /* <O> Found rule object */
);
...
(
    const char *name_chain,      /* <I> reference chain of instance */
...
/****************************************************************************
Adopt ug objects into the Knowledge Fusion world
...
(
    tag_t               *ug_objects,        /* <I,len:number_of_objects> number_of_objects
                                                   array of tags of ug objects
                                                   to be adopted into Fusion */
    int                  number_of_objects, /* <I>  number of objects in the 
                                                    above array */
    UF_KF_instance_p_t **instances          /* <OF> array of adopted instances. 
                                                    Free with UF_free. */
);
...
(
    ...
    const char         **name_chain /* <O> Name chain of instance. Do not free. */
);
...
( 
    UF_KF_value_p_t    *values,    /* <I> Argument values of Defun */ 
    int                 n_values,  /* <I> Number of argument values */
    UF_KF_instance_p_t *instance   /* <O> Instance calling Defun */ 
);
...
(
    const char  *measure,  /* <I> Measure of value */   
    const char **base_unit /* <O> Base unit of measure */
);
/****************************************************************************
