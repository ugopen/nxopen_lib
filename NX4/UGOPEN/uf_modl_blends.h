...
{
    char radius[UF_MAX_EXP_LENGTH];     /* <len:UF_MAX_EXP_LENGTH> variable radius at a point */
...
struct UF_MODL_blend_edge_s
{
    ...
    char start_setback_dis[UF_MAX_EXP_LENGTH];  /* <len:UF_MAX_EXP_LENGTH> setback distance of an edge-start point */
    char end_setback_dis[UF_MAX_EXP_LENGTH];    /* <len:UF_MAX_EXP_LENGTH> setback distance of an edge-end point */
...
struct UF_MODL_edge_blend_data_s
{
    ...
    char blend_radius[UF_MAX_EXP_LENGTH]; /* <len:UF_MAX_EXP_LENGTH> radius of a regular blend */
...
struct UF_MODL_edge_blend_setback_data_s
{
    ...
    char     distance[UF_MAX_EXP_LENGTH];
                                   /* Setback distance */
