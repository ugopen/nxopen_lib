...
struct MB_activated_button_s {
    ...
    char                    **ancestors;   /* names of ancestors             */
...
UF_MB_action_p_t action_table  /* <I>
...
History:
 *********************************************************************/
extern int UF_MB_load_resource_file(
...
History:
 *********************************************************************/
extern int UF_MB_ask_logical_resource(
char * name ,/* <I>
...
History:
 *********************************************************************/
extern int UF_MB_ask_double_resource(
char * name ,/* <I>
             The name of the resource to be located.
             */
double defvalue ,/* <I>
...
History:
 *********************************************************************/
extern int UF_MB_ask_int_resource(
char * name ,/* <I>
             The name of the resource to be located.
             */
int defvalue ,/* <I>
...
History:
 *********************************************************************/
extern int UF_MB_ask_string_resource(
char * name ,/* <I>
             The name of the resource to be located.
             */
char * defvalue ,/* <I>
