...
/*
 * UF_CSYS_ROOT_COORDS is coordinate space of the root part which is
 *                     the whole part being displayed
 * UF_CSYS_WORK_COORDS is coordinate space of the work part
 * UF_CSYS_ROOT_WCS_COORDS is work coordinate space of the root part
*/
