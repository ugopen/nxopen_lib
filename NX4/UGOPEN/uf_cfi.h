...
File Description:
      A set of UG/Open API subroutines is available for accessing files. These
      routines provide a "C" interface to Unigraphics UG/Open API routines and
      native files.
   ...
   NOTE
      ...
      UG/Manager and IMAN. Use routines from 
      for this purpose.
      ...
      Many of the UG/Open API CFI routines request a file type (ftype) as 
      ...
      Many of the UG/Open API CFI routines return negative error numbers.
...
read. This is provided so the UG/Open API program need not be
...
data. Unnamed ftypes will return a format of "UG  ".
...
/*******************************************************************************
Convert Unigraphics computational time to display form. Two forms are available
...
/*******************************************************************************
Convert a character date and time to Unigraphics computational date and time.
...
be used on a part file that has already been opened in UG. If this
...
const char *file_spec , /* <I>
                   ...
                   */
int  *status       /* <O>
                     File or directory existence status.  
                     0 - file exists
                     1 - file does not exist
                    */
);
...
logical  is_concur,   /* <I>
                         ...
                         as the UG/Open program, if FALSE, then UF_CFI_spawn
