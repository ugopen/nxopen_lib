...
/*****************************************************************
 * Creates a shaded image using the capabilities of UG/Photo and saves
 ...
 * setup using interactive UG. If the current layout is a drawing then
...
/*****************************************************************
 * Allows batch creation of an MPEG movie. See the Unigraphics
 ...
 * UG/Open API programs that directly invoke Windows, MFC, or Motif 
 * functions to display dialogs. This function is unneeded when 
 * UG/Open dialogs are used.
 *
 * When UG/Open functions perform display operations, the display 
 * operations can be buffered. UG/Open dialog logic ensures that 
 * the buffered operations are completed at appropriate times. If 
 * a UG/Open API program bypasses UG/Open dialog logic, the program 
 ...
 * History: Originally released in Unigraphics NX3.
*****************************************************************************/
...
extern UFUNEXPORT int UF_DISP_display_temporary_line(
     ...
     double start_line[3] ,                /* <I>
                                           ...
                                           */
     double end_line[3] ,                  /* <I>
                                           The absolute coordinates of the end
                                           point of the line.
                                           */
 ...
 * NOT accurate, as UG does not usually update the model bounds as
 * objects are created, modified, and deleted. This function is intended
 * for use by certain UG applications such as translators which know that
 ...
 * smaller of X and Y.
 * NOTE: This function is of limited value for most UG/Open API
 * application developers. It is intended to be used by certain UG
 ...
 * context argument passed into this routine will be passed from Unigraphics 
 ...
 * passed from Unigraphics to the UDO callback routine.
 *
 * Environment: Internal  and  External
 * See Also: 
 *  UF_UDOBJ_register_display_cb
 ...
 * routine will be passed from Unigraphics to the UDO callback routine.
 *
 * Environment: Internal  and  External
 * See Also: 
 *  UF_DISP_poly_marker_t
 ...
 * Unigraphics to the UDO callback routine.
 ...
 *****************************************************************************/
/*******************************************************************************
 * Queries the current work plane emphasis setting. When work plane
 * emphasis is on, the displayed color of all objects that do not lie on the
 * work plane are changed to the dim color. Any object that is so
 * dimmed is unselectable unless the work plane emphasis selection
 * filter is overridden. Work plane emphasis is a session dependent
 ...
 * the displayed color of all objects that do not lie on the work plane
 * change to the dim color. Any object that is so dimmed is unselectable
 * unless the work plane emphasis selection filter is overridden. Work
 * plane emphasis is a session dependent value; it is not saved with any
 * part.
 * Environment: Internal  and  External
 * See Also: 
...
/*******************************************************************************
 * Queries the work plane emphasis dim color.
 * When work plane emphasis is enabled, the dim color is the color that
 * all objects  display in which are off the work plane.
 * When work plane emphasis is disabled, the dim color has no
 * noticeable affect, although it can be changed. The dim color setting
 * takes effect once work plane emphasis is enabled.
 * The work plane emphasis dim color is a session dependent value; it is
...
/*******************************************************************************
 * Sets the work plane emphasis dim color.
 * When work plane emphasis is enabled, the dim color is the color that
 * all objects which are off the work plane display in.
 * When work plane emphasis is disabled, the dim color has no
 * noticeable affect, although it can be changed. The dim color setting
 * takes effect once work plane emphasis is enabled.
 * The work plane emphasis dim color is a session dependent value; it is
 ...
 * Unigraphics  graphics window.  This function is available only
...
/****************************************************************************
  ...
  The routine UF_DISP_set_drawing_display MUST be called to
