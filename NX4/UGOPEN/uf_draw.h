...
This is the UG/Open API interface to drawing control.  This allows the
...
when running interactive UG/Open API.

When drafting objects are created on a drawing in V10 UG/Open API, the objects 
...
In Unigraphics, when the drawing view is the work view, the layout which 
...
The following plotting-related functions may be removed in Unigraphics NX3.
...
The planned deployment of a new plotting system in Unigraphics NX3 will 
require definition of new functions to take advantage of features in the 
new system. New functions will provide ready access to Unigraphics plotting 
 ...
 * Environment: Internal  and  External
 * See Also:  UF_DRAW_sxline_status_t
 *           See  UF_DRAW_create_unfolded_sxline 
 ...
 * ensure that future code changes will not be required by UG/Open
 * API developers.
 *
 * Environment: Internal  and  External
 * See Also: 
 ...
 * future code changes will not be required by Unigraphics or by
 * UG/Open API developers.
 *
 * Environment: Internal  and  External
 * See Also: 
...
extern UFUNEXPORT int UF_DRAW_ask_drawing_ref_pt(
    const tag_t view_tag,             /* <I>  Tag of the view.
                                         ...
                                         member view. */
    double *reference_pt              /* <O>  Reference point
                                         (Drawing Coordinates).
                                         [0] - X-coordinate
                                         [1] - Y-coordinate  */
);
...
extern UFUNEXPORT int UF_DRAW_set_drawing_ref_pt(
    ...
    const double *reference_pt   /* <I,len:2>  Reference point
                                    (Drawing Coordinates).
                                    [0] - X-coordinate
                                    [1] - Y-coordinate  */
);
...
extern UFUNEXPORT int uc6485(char *cp1, double *rr2);
...
extern UFUNEXPORT int UF_DRAW_ask_view_borders(
    const tag_t view_tag,      /* <I>  Tag of the view.
                                  If NULL_TAG, use Work view. */
    double *view_borders       /* <O>  View Borders (Drawing Coordinates).
                                  [0] - X min
                                  [1] - Y min
                                  [2] - X max
                                  [3] - Y max  */
...
extern UFUNEXPORT int uc6486(char *cp1, double *rp2);
...
/* Use UF_DRAW_ask_current_drawing and
       UF_OBJ_ask_name. */
/* uc6492 read current drawing name */
extern UFUNEXPORT int uc6492(
   char *cr1 /* <O> This parameter must be a character buffer large enough to 
...
extern UFUNEXPORT int uc6494(const char *dwg_name);  
...
extern UFUNEXPORT int uc6495(const char *dwg_name);         /* <I> */
...
extern UFUNEXPORT int uc6497(
    char *ca1                  /* <I/O> Drawing name - 30 characters max.
...
extern UFUNEXPORT int uc6498(char *cp1, int *ir2);

/* uc6499 cycle views in drawing */
extern UFUNEXPORT int uc6499(char *cp1, char *ca2);
...
extern UFUNEXPORT int UF_DRAW_ask_view_label_parms ( 
    ...
    UF_DRAW_view_label_parms_p_t view_label_parms    /* <O> Structure that will 
