...
******************************************************************************/ 
typedef struct UF_SF_disp_mesh_s
{
...
} UF_SF_disp_mesh_t, *UF_SF_disp_mesh_p_t;

/*****************************************************************************
  Structure defining element node results associated with a mesh.      
******************************************************************************/ 
typedef struct UF_SF_mesh_elem_node_result_s
{
...
} UF_SF_mesh_elem_node_result_t, *UF_SF_mesh_elem_node_result_p_t;
