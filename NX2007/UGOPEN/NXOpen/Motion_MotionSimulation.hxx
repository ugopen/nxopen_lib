        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSimulation
        {
            ...
            /** Creates a new @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink  in this motion simulation assembly as master part 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Motion::MotionSimulation::AddCADSourcePart NXOpen::Motion::MotionSimulation::AddCADSourcePart@endlink  <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Motion::MotionSimulation::AddCADSourcePart") void AddMaster
            (
            ...
            /** Removes existing master part in this motion simulation assembly 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Motion::MotionSimulation::RemoveCADSourcePart NXOpen::Motion::MotionSimulation::RemoveCADSourcePart@endlink  <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Motion::MotionSimulation::RemoveCADSourcePart") void RemoveMaster
            (
            ...
            /** Gets the loaded master part in this motion simulation assembly.  @return  the loaded master part 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Motion::MotionSimulation::GetCADSourcePart NXOpen::Motion::MotionSimulation::GetCADSourcePart@endlink  <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Motion::MotionSimulation::GetCADSourcePart") NXOpen::Part * GetMasterCadPart
            (
                NXOpen::Part * motionPart /** the motion part to remove master part from it */
            );
