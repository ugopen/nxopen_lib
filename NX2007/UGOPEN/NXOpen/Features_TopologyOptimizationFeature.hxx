    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  TopologyOptimizationFeature : public NXOpen::Features::Feature
        {
            ...
            /// \cond NX_NO_DOC 
            /** Exports the entire data from a @link NXOpen::Features::TopologyOptimization::Study NXOpen::Features::TopologyOptimization::Study@endlink  to a JSON file. 
            ...
            /// \cond NX_NO_DOC 
            /** Imports a JSON file to create a @link NXOpen::Features::TopologyOptimization::Study NXOpen::Features::TopologyOptimization::Study@endlink  and all its data.
                        Returns the newly created @link NXOpen::Features::TopologyOptimization::Study NXOpen::Features::TopologyOptimization::Study@endlink  if import is successful.
                        The newly created @link NXOpen::Features::TopologyOptimization::Study NXOpen::Features::TopologyOptimization::Study@endlink  is also made active. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") */
            public: NXOpen::Features::TopologyOptimization::Study * CreateStudyFromJsonFile
            (
            ...
            /** Imports a JSON file to create a @link NXOpen::Features::TopologyOptimization::Study NXOpen::Features::TopologyOptimization::Study@endlink  and all its data.
             ...
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") */
            NXOpen::Features::TopologyOptimization::Study * CreateStudyFromJsonFile
            (
