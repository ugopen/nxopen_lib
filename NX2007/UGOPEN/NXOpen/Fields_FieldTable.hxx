        ...
        */
        class NXOPENCPP_FIELDSEXPORT  FieldTable : public NXOpen::Fields::Field
        {
            ...
            /** Get the inverse distance weighting (IDW) interpolation options 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use the overloaded @link NXOpen::Fields::FieldTable::GetIdwOptions NXOpen::Fields::FieldTable::GetIdwOptions@endlink  call <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use the overloaded NXOpen::Fields::FieldTable::GetIdwOptions call") void GetIdwOptions
            (
            ...
            /** Set the inverse distance weighting (IDW) interpolation options 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use the overloaded @link NXOpen::Fields::FieldTable::SetIdwOptions NXOpen::Fields::FieldTable::SetIdwOptions@endlink  call <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use the overloaded NXOpen::Fields::FieldTable::SetIdwOptions call") void SetIdwOptions
            (
                NXOpen::Fields::FieldEvaluator::InverseDistanceWeightingEnum nearestOption /** nearest option   */,
                double nearestFraction /** fraction         */
            );
            ...
            /** Set the conservative interpolation options 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void SetConservativeOptions
            (
                double annTolerance /** approximate nearest neighbor (ANN) interpolation tolerance */,
                double maximumRadius /** maximum radius   */,
                int numberOfPoints /** number of points */
