    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultToSCD5Converter : public NXOpen::TransientObject
        {
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the value indicates whether mid node result will be exported for element-nodal result 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool ExportMidNodeResult
            (
            );
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the value indicates whether mid node result will be exported for element-nodal result 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetExportMidNodeResult
            (
                bool exportMidNodeResult /** exportmidnoderesult */ 
            );
