        ...
        */
        class NXOPENCPP_CAEEXPORT  Post
        {
            ...
            */
            ...
            /// \cond NX_NO_DOC 
            /** Export the display of the input postview id in Direct Model display mode(if true) to the ASCII format. 
            ...
            */
            ...
            /** Returns the @link NXOpen::CAE::PostDisplayManager NXOpen::CAE::PostDisplayManager@endlink  belonging to this session 
             <br>  Created in NX1980.0.0.  <br>  
            */
