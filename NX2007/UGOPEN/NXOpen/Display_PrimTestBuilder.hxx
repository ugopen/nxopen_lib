    ...
    namespace Display
    {
        ...
        */
        class NXOPENDEBUGSESSIONCPPEXPORT  PrimTestBuilder : public NXOpen::Builder
        {
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the underline text Markup flag. 
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the underline text Markup flag. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the strikeout text Markup flag. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the strikeout text Markup flag. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the vertical text Markup flag. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the vertical text Markup flag. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the markup text string 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the markup text string 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTextStringMarkup
            (
                const NXString & verticalTextMarkup /** verticaltextmarkup */ 
            );
            /**Sets  the markup text string 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                const char * verticalTextMarkup /** verticaltextmarkup */ 
            );
