    ...
    */
    class NXOPENUICPPEXPORT  Selection
    {
        ...
        (
            ...
            const std::vector<NXOpen::Select::FilterMember> & filterMembers /** Modifies the list of object types that can be selected.
                                               How it modifies the list of object types is determined by the Selection Action parameter. */,
            std::vector<NXOpen::TaggedObject *> & objectArray /** The selected objects */
        );
        /** Launch the Class Selection dialog to select tagged objects using a filter defined by Filter Members.
        ...
        (
            ...
            NXOpen::Selection::SelectionScope scope /** Selection scope */,
            NXOpen::Selection::SelectionAction action /** Indicates how the mask array will modify the selection filter */,
            const std::vector<NXOpen::Select::FilterMember> & supportedFilterMembers /** Modifies the list of object types that can be selected.
                                               How it modifies the list of object types is determined by the Selection Action parameter. */,
            const std::vector<NXOpen::Select::FilterMember> & initialFilterMembers /** Defines the list of supported object types enabled when the dialog is launched. 
