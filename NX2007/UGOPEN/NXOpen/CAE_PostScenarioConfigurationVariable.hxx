        ...
        */
        class NXOPENCPP_CAEEXPORT  PostScenarioConfigurationVariable : public NXOpen::TaggedObject
        {
            ...
            /** Retrieve the list of available values.
             ...
             <br>  @deprecated Deprecated in NX1872.0.0.  Use @link CAE::PostScenarioConfigurationVariable::GetValues2 CAE::PostScenarioConfigurationVariable::GetValues2@endlink  with a corrected signature instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use CAE::PostScenarioConfigurationVariable::GetValues2 with a corrected signature instead.") void GetValues
            (
