    ...
    namespace CAM
    {
        ...
        */
        class NXOPENDEBUGSESSIONCPPEXPORT  Debug
        {
            ...
            /// \cond NX_NO_DOC 
            /** Prepare test system for MTB debug 
            ...
            /// \cond NX_NO_DOC 
            /** Debug to dump the information from the given dump name 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void Dump
            (
            ...
            /// \cond NX_NO_DOC 
            /** Print XML diagnostic of the explorer style dialog used to edit the param object
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Master template object edit and okay
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Master template object edit and cancel
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get tool path length from the object
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get tool path length comparison criteria from the object
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get tool path cutting length from the object
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get tool path noncutting length from the object
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get CI all list for the object
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /// \cond NX_NO_DOC 
            /** Get not journalled CI list for the object
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
