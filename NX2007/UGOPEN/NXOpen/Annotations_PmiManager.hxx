    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiManager
        {
            ...
            /// \cond NX_NO_DOC 
            /**Position the selected PMIs present in given view 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            ...
            /// \cond NX_NO_DOC 
            /** Loads PMI for the current work part or assembly. 
            ...
            /// \cond NX_NO_DOC 
            /** Set the display for all PMIs inside the selected components of an assembly part 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            ...
            /// \cond NX_NO_DOC 
            /** Get the display status for the PMIs inside the selected component of an assembly part 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            ...
            /// \cond NX_NO_DOC 
            /** Reset the display for all PMIs inside the selected components of an assembly part 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
