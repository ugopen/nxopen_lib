        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultsCombinationBuilder : public NXOpen::CAE::ResultsManipulationBuilder
        {
            ...
            /** Set Independent Domain Name
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::ResultsCombinationBuilder::SetIndependentDomain NXOpen::CAE::ResultsCombinationBuilder::SetIndependentDomain@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::ResultsCombinationBuilder::SetIndependentDomain instead.") void SetIndependentDomainName
            (
            ...
            /** Set Dependent Domain Name
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::ResultsCombinationBuilder::SetDependentDomain NXOpen::CAE::ResultsCombinationBuilder::SetDependentDomain@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::ResultsCombinationBuilder::SetDependentDomain instead.") void SetDependentDomainName
            (
                const NXString & domainName /** domain name */ 
            );
            /** Set Dependent Domain Name
            ...
            /** Set Independent Domain
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::CAE::ResultsCombinationBuilder::SetIndependentEnum NXOpen::CAE::ResultsCombinationBuilder::SetIndependentEnum@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::CAE::ResultsCombinationBuilder::SetIndependentEnum instead.") void SetIndependentDomain
            (
                NXOpen::Fields::FieldDomain * domain /** Independent Domain*/
            );
            /** Set Dependent Domain
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::CAE::ResultsCombinationBuilder::SetDependentEnum NXOpen::CAE::ResultsCombinationBuilder::SetDependentEnum@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::CAE::ResultsCombinationBuilder::SetDependentEnum instead.") void SetDependentDomain
            (
