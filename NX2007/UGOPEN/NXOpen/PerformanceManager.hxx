...
namespace NXOpen
{
    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  PerformanceManager : public NXOpen::TransientObject
    {
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the working set memory for particular process/application is returned and is measured either
            from the start or the last time performance statistics were gathered 
        ...
        /// \cond NX_NO_DOC 
        /**Sets  the working set memory for particular process/application is returned and is measured either
            from the start or the last time performance statistics were gathered 
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the working set memory validation tolerance is returned which is getting used for validating the
            autotest XML.The working set memory validation tolerance is set through @link PerformanceManager::SetSetWorkingSetMemoryTol PerformanceManager::SetSetWorkingSetMemoryTol@endlink 
            which is getting used for validating the autotest XML. User need to be very careful while seletcing
            the tolerance values. Choose larger tolerances for smaller values 
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /**Sets  the working set memory validation tolerance is returned which is getting used for validating the
            autotest XML.The working set memory validation tolerance is set through @link PerformanceManager::SetSetWorkingSetMemoryTol PerformanceManager::SetSetWorkingSetMemoryTol@endlink 
            which is getting used for validating the autotest XML. User need to be very careful while seletcing
            the tolerance values. Choose larger tolerances for smaller values 
         <br>  Created in NX12.0.0.  <br>  
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the NX working set memory obtaied during performance monitoring  
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the delta NX working set memory obtaied during performance monitoring  
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /** Start the performance monitor with label at any point of time typically before any
            application/process 
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the min. absolute time validation tolerance which would get used
                for validating the autotest XML. This is available only in autotest mode. 
        ...
        /// \cond NX_NO_DOC 
        /**Sets  the min. absolute time validation tolerance which would get used
                for validating the autotest XML. This is available only in autotest mode. 
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the min. absolute memory validation tolerance which would get used
                for validating the autotest XML. This is available only in autotest mode. 
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        ...
        /// \cond NX_NO_DOC 
        /**Sets  the min. absolute memory validation tolerance which would get used
                for validating the autotest XML. This is available only in autotest mode. 
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
