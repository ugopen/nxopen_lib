        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FreeformSurfaceCollection
        {
            ...
            /** Creates a @link NXOpen::Features::FlatteningAndFormingBuilder NXOpen::Features::FlatteningAndFormingBuilder@endlink   @return  FlatteningAndFormingBuilder object 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Features::FreeformSurfaceCollection::CreateFlatteningAndFormingBuilderEx NXOpen::Features::FreeformSurfaceCollection::CreateFlatteningAndFormingBuilderEx@endlink  instead <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Features::FreeformSurfaceCollection::CreateFlatteningAndFormingBuilderEx instead") NXOpen::Features::FlatteningAndFormingBuilder * CreateFlatteningAndFormingBuilder
            (
