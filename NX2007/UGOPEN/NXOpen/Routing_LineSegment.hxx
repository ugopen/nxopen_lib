        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  LineSegment : public NXOpen::Line, public virtual NXOpen::Routing::ISegment
        {
            ...
            /** Returns the Globally Unique Identifier (GUID) for this segment.  @return  The GUID for this segment. 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Routing::ISegment::Guid NXOpen::Routing::ISegment::Guid@endlink  instead. <br>  

             <br>  Created in NX8.0.3.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Routing::ISegment::Guid instead.") NXString GetGuid
            (
            );
            /** Generates a new Globally Unique Identifier (GUID) on this segment. 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Routing::ISegment::GenerateNewGuid NXOpen::Routing::ISegment::GenerateNewGuid@endlink  instead. <br>  

             <br>  Created in NX1984.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Routing::ISegment::GenerateNewGuid instead.") void GenerateNewSegmentGuid
            (
            );
