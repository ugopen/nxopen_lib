    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  OperationCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /// \cond NX_NO_DOC 
            /** Creates a planar roughing builder  @return  operation builder created 
            ...
            /// \cond NX_NO_DOC 
            /** Creates a facing builder  @return  operation builder created 
            ...
            /// \cond NX_NO_DOC 
            /** Creates a facing zigzag operation builder  @return  operation builder created 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /** Creates a planar additive builder with spiral pattern  @return  operation builder created 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarAdditiveBuilder * CreatePlanarAdditiveSpiralBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /// \cond NX_NO_DOC 
            /** Creates a rotary conical buildup additive builder  @return  operation builder created 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /** Creates a scanner builder  @return  operation builder created 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /** Creates a multi axis deburring builder  @return  operation builder created 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /** Creates a wall profiling builder  @return  operation builder created 
            ...
            /// \cond NX_NO_DOC 
            /** Creates a multi axis wall_finishing builder  @return  operation builder created 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /** Creates a multi axis turn milling builder  @return  operation builder created 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
