...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX1847.0.0.  This function is no longer required.") NXOPENCPP_CAEEXPORT  ComacViewerBuilder : public NXOpen::Builder
        {
            ...
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  This function is no longer required.") void Init
            (
