...
--------------
    ...
    1. SelectionSubscriberExample.cpp

The above listed files are located at
$UGII_BASE_DIR/ugopen/SampleNXOpenApplications/CPP/SelectionSubscriberExample.
...
-----------
   ...
   3. Add the SelectionSubscriberExample.cpp to Source Files
   ...
   3. Compile and link using uflink:
      ...
      ufcomp SelectionSubscriberExample.cpp
      uflink UFDLL=SelectionSubscriberExample.dll

   This will create SelectionSubscriber.dll in the current directory.
   ...
   6. Provide the name of the program to link => SelectionSubscriberExample.
...
-----------------------
    ...
    4. Invoke the SelectionSubscriberExample.dll (SelectionSubscriberExample.so on Linux) 
       file using the File->Execute->NX Open... menu command.

    5. Observe the output to the Listing Window.

    6. Perform any normal NX interaction involving entering and exiting commands, and 
       selecting and deselecting objects. Observe that all such activity is reported 
       to the SelectionSubscriber, as indicated by the output to the Listing Window.
