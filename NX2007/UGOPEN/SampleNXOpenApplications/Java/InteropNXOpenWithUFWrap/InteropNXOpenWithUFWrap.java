...
public class InteropNXOpenWithUFWrap
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
            ...
            Part part1 = theSession.parts().newDisplay("InteropNXOpenWithUFWrap", Part.Units.MILLIMETERS);
            ...
            Line line1 = theSession.parts().work().curves().createLine(arcStartPoint, arcEndPoint);
