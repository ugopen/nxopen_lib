...
def defineImageSettings(theSession, iRayPlusStudioPreferencesBuilder):
    ...
    iRayPlusStudioPreferencesBuilder.IRayPlusStudioStaticImagePixelWidth = pixel_width_720p
    iRayPlusStudioPreferencesBuilder.IRayPlusStudioStaticImagePixelHeight = pixel_height_720p
    ...
    nXObject6 = iRayPlusStudioPreferencesBuilder.Commit()
