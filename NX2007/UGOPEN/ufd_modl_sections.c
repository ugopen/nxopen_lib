...
/* Create a section that contains the first 4 edges of the first loop */
  ...
  UF_MODL_init_sc_input_data (sc_rule_types[0], (UF_SC_input_data_t *)&sc_rules[0]);
  ...
  UF_MODL_init_sc_input_data(sc_rule_types[1], (UF_SC_input_data_t *)&sc_rules[1]);
...
/* Add two more rules to the section */
  ...
  UF_MODL_init_sc_input_data(sc_rule_types[2], (UF_SC_input_data_t *)&sc_rules[2]);
  ...
  UF_MODL_init_sc_input_data(sc_rule_types[3], (UF_SC_input_data_t *)&sc_rules[3]);
