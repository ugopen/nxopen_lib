...
extern UFUNEXPORT int UF_DRAW_ask_group_of_curve(
            ...
            int * group_subtype       /* <O>
                                      ...
                                      either UF_dropped_edge_group_subtype,
                                      UF_dropped_curve_group_subtype, 
                                      UF_simplified_group_subtype, or
                                      UF_InterferenceCurveGroupSubtype
                                      Else = 0
                                      */
);
 ...
 *
 *  DESCRIPTION -
 *      This routine returns the parents and count of parents for input drafting curves and
 *      points
 *      
 *      Notes:
 *         Starting in NX12, modeling points extracted in drawing member views
 *         are supported.
 *
 *  Returns -
 *     0 = OK
 ...
 *    NX12 - Added support for extracted drafting points.
 *
 ******************************************************************************/
 ...
 *
 *  DESCRIPTION -
 *      This routine returns the type of input drafting curves and
 *      points
 *
 *      Notes:
 *         Starting in NX12, modeling points extracted in drawing member views
