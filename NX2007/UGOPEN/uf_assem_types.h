...
#define UF_ASSEM_do_not_add_components  0   /*This option is no longer used since NX 2.0. */
#define UF_ASSEM_add_single_level       1   /*This option is no longer used since NX 2.0. */
#define UF_ASSEM_add_all_levels         2   /*This option is no longer used since NX 2.0. */
...
#define UF_ASSEM_dont_maintain_work_part 0  /*This option is no longer used since NX 12.0. */
#define UF_ASSEM_do_maintain_work_part  1   /*This option is no longer used since NX 12.0. */
...
/*
Variant rules for load options
UF_ASSEM_no_variant_rule         - No variant rule
UF_ASSEM_variant_rules_set       - Variant rules added when TC Classic/Product configurator variants set

New option for setting variant rules in the load of the assembly. 
The default behaviour is 0  i.e. variant rules not set.
*/
#define UF_ASSEM_no_variant_rules         0
#define UF_ASSEM_variant_rules_set        1

/***************************************************************
 *  History:
 *     NX2: parts_list is no longer used.
 *     NX8.5: managed_mode_load_options introduced.
 *     NX12.0 maintain_work_part is no longer used
 ***************************************************************/
struct UF_ASSEM_options_s
{
    ...
    int failure_action;        /* failure Option value -  
                               ...
                               */
    int maintain_work_part;    /* NOTE: maintain_work_part is no longer used */
    ...
    int managed_mode_load_options;  /* Load Options - for managed mode only
                                    ...
                                    */
    int managed_mode_variant_rule_option;  /* Load options - for managed mode only
                                           UF_ASSEM_no_variant_rules
                                           UF_ASSEM_variant_rules_set
                                           */
};
...
/********************************************************************
*  UF_ASSEM_part_load_option_t is used to control the part load option
*  when using UF_ASSEM_load_options_t / UF_ASSEM_set_assem_load_options.
*  This provides access to all five load options available in the NX UI.
*
*  (Note - the older UF_ASSEM_options_t / UF_ASSEM_set_assem_options only
*  provides access to the first four options, which are equivalent to
*  the four possible combinations of load_fully and
*  use_lightweight_representations from that struct.)
*
********************************************************************/
enum UF_ASSEM_part_load_option_e
{
    UF_ASSEM_part_load_option_fully_load = 0,
    UF_ASSEM_part_load_option_partially_load = 1,
    UF_ASSEM_part_load_option_fully_load_lightweight_display = 2,
    UF_ASSEM_part_load_option_partially_load_lightweight_display = 3,
    UF_ASSEM_part_load_option_minimally_load_lightweight_display = 4
};

typedef enum UF_ASSEM_part_load_option_e UF_ASSEM_part_load_option_t;
...
***************************************************************/
struct UF_ASSEM_load_options_s
{
    int load_options;          /* Load Options - for native mode only
                               UF_ASSEM_load_from_directory
                               UF_ASSEM_load_from_search_dirs
    ...
    int load_components;       /* Load components option
                               ...
                               UF_ASSEM_specify_filter
                               */
    int part_load_option;      /* Part load option
                               ...
                               UF_ASSEM_part_load_option_minimally_load_lightweight_display
                               */
    int load_substitution;     /* Allow Substitution switch
                               UF_ASSEM_dont_allow_substitution
                               UF_ASSEM_do_allow_substitution
...
typedef struct UF_ASSEM_load_options_s UF_ASSEM_load_options_t, *UF_ASSEM_load_options_p_t;
