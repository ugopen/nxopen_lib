...
typedef char ufd_msg[ 2 * UF_CFI_MAX_PATH_NAME_LEN + 1 ];
...
static tag_t UFXLM_create_category
(
    const char* category_name,  /* I: .. maximum of MAX_ENTITY_NAME_SIZE characters */
    const char* description,    /* I: optional description string */
    const int*  layer_members,  /* I: array of layer member numbers */
    int         member_count    /* I: number of layer members */
)
{
    ...
    do
    {
        ...
        snprintf( category_info.name, MAX_ENTITY_NAME_SIZE, (char *)category_name );

        if ( (description != NULL) && (*description) )
            snprintf( category_info.descr, UF_LAYER_CAT_DESC_LEN, (char *)description );
