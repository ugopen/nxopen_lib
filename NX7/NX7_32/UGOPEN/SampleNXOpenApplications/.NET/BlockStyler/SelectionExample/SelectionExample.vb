...
#End Region
    ...
    Sub addChamfer(ByVal selectedEdge As Edge, ByVal angle As Double)
        ...
        Catch ex As Exception
            theUI.NXMessageBox.Show("Error Adding Chamfer", NXMessageBox.DialogType.Error, ex.ToString)
        End Try
    End Sub
    ...
    Private Sub deleteObject(ByVal selectedObject As NXObject)
        Try
            ...
            End If
        Catch ex As Exception
            theUI.NXMessageBox.Show("Error Removing Chamfer", NXMessageBox.DialogType.Error, ex.ToString)
        End Try
    End Sub
