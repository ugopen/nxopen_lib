...
#define UF_CAM_ERROR_INSPECTION_SETUP             (ERROR_UF_CAM_base + 67)
#define UF_CAM_ERROR_MANUFACTURING_SETUP          (ERROR_UF_CAM_base + 68)
#define UF_CAM_ERROR_INSPECTION_TEMPLATE          (ERROR_UF_CAM_base + 69)
#define UF_CAM_ERROR_MANUFACTURING_TEMPLATE       (ERROR_UF_CAM_base + 70)
#ifdef __cplusplus
}
#endif
