...
enum UF_UI_dialog_filter_id_e{
    ...
    UF_UI_CAE_RST_FLTR,             /* Specifies *.op2 *.vdm *.rst *.rth and *.fil */
    UF_UI_CAE_RST_ODB_FLTR,              /* Specifies *.op2 *.vdm *.rst *.rth *.fil and *.odb */
...
/* All new constants should be added here. */
...
#define   UF_UI_MAX_STRING_LEN     1000
...
#define UF_UI_SEL_FEATURE_WELD_EDGE             107
#define UF_UI_SEL_FEATURE_WELD_RESIS_SEAM       108
#define UF_UI_SEL_FEATURE_WELD_BEAD             109
#define UF_UI_SEL_FEATURE_WELD_PLUG_SLOT        110
#define UF_UI_SEL_FEATURE_WELD_DATUM_SURFACE    111
#define UF_UI_SEL_FEATURE_WELD_DATUM_PIN        112
#define UF_UI_SEL_FEATURE_WELD_DATUM_CUSTOM1    113
#define UF_UI_SEL_FEATURE_WELD_DATUM_CUSTOM2    114
#define UF_UI_SEL_FEATURE_WELD_DATUM_CUSTOM3    115
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_SURFACE      116
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_HOLE         117
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_STUD         118
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_SLOT         119
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_TRIM         120
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_HEMMED_EDGE  121
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_CUSTOM1      122
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_CUSTOM2      123
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_CUSTOM3      124
#define UF_UI_SEL_FEATURE_MAX_SPECIAL_FEATURE   125 /* This should be last of special feature types */

struct UF_UI_mask_s
{
    int object_type; /* This can be one of the object types that are listed in
                        uf_object_types.h */
    int object_subtype; /* This can either be UF_all_subtype, or a proper
