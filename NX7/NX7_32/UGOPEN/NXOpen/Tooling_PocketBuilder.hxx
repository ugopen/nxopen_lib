...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        {
            /** The JA_POCKET_BUILDER_mode_type refers to the pocket operation method */
            ...
            /** The JA_POCKET_BUILDER_tool_type is an index to the select type of tool */
            ...
            /** The JA_POCKET_BUILDER_rset_type is an index to the pocket refset types*/
