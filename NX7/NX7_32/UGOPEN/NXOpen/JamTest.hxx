...
namespace NXOpen
{
    ...
    class NXOPENJAMTESTCPPEXPORT JamTest : public TransientObject
    {
        ...
        struct Struct2
        {
            ...
            public: Struct2(double INIT_x /** x */ , 
                    double INIT_y /** y */ ) :
                X(INIT_x),
                Y(INIT_y)
            {
        ...
        struct Struct3
        {
            ...
            public: Struct3(bool INIT_flag /** flag */ , 
                    int INIT_i /** i */ , 
                    NXOpen::JamTest::Struct1 INIT_s1 /** s1 */ , 
                    NXOpen::JamTest::Struct2 INIT_s /** s */ , 
                    NXOpen::JamTest::Enum3 INIT_e /** e */ ) :
                Flag(INIT_flag),
                I(INIT_i),
                S1(INIT_s1),
                S(INIT_s),
        ...
        struct Struct4
        {
            ...
            public: Struct4(NXString INIT_status_string /** status string */ , 
                    NXOpen::JamTest::Struct3 INIT_third_struct /** third struct */ , 
                    NXOpen::JamTest::Struct1 INIT_first_struct /** first struct */ ) :
        ...
        struct StructWithTypesFromNestedNamespace
        {
            ...
            public: StructWithTypesFromNestedNamespace(NXOpen::JamTestNamespace::Subspace::Tagged2::ObjType INIT_type /** type */ , 
                    NXOpen::JamTestNamespace::Subspace::Tagged2::Struct1 INIT_data /** data */ , 
                    NXOpen::JamTestNamespace::Subspace::Tagged2 * INIT_obj /** obj */ ) :
                Type(INIT_type),
                Data(INIT_data),
                Obj(INIT_obj)
            {
        ...
        struct StructWithTypesFromNestedNamespaceOmpp
        {
            ...
            public: StructWithTypesFromNestedNamespaceOmpp(NXOpen::JamTestNamespace::Subspace::OMPPTagged2::ObjType INIT_type /** type */ , 
                    NXOpen::JamTestNamespace::Subspace::OMPPTagged2::Struct1 INIT_data /** data */ , 
                    NXOpen::JamTestNamespace::Subspace::OMPPTagged2 * INIT_obj /** obj */ ) :
                Type(INIT_type),
                Data(INIT_data),
                Obj(INIT_obj)
            {
