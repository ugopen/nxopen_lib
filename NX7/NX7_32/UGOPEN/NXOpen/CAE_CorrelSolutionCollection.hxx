...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT CorrelSolutionCollection : public TaggedObjectCollection
        {
            ...
            /** Creates the builder object of correl mac matrix viewer  @return    <br> License requirements : nx_correl_base ("FE Correlation") */
            public: NXOpen::CAE::MacViewerBuilder * CreateMacViewerBuilder
            (
            );
