...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT RoutingElectrical
        {
            ...
            (
                bool overrideHarnessName /** override harness name */ 
            );
            ...
            (
                const NXString & componentAttributeTitle /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            ...
            /**Returns the option to record import and export activity in the Connection and Component Lists.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: bool RecordNetlistHistory
            (
            );
            /**Sets the option to record import and export activity in the Connection and Component Lists.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: void SetRecordNetlistHistory
            (
                bool recordNetlistHistory /** Should Routing record the netlist history? */
            );
            /**Returns the option to Auto Route using centerline stock style (i.e. none) or simple stock style. <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::StockStyle AutoRouteStockStyle
            (
            );
            /**Sets the option to Auto Route using centerline stock style (i.e. none) or simple stock style. <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
