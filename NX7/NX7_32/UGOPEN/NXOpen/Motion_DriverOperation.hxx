...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT DriverOperation : public TaggedObject
        {
            ...
            /**Returns  the motor   <br> License requirements : nx_motion_motor ("NX Motion Motor") */
            public: NXOpen::Motion::PMDCMotor * Motor
            (
            );
            /**Sets  the motor   <br> License requirements : nx_motion_motor ("NX Motion Motor") */
            public: void SetMotor
            (
                NXOpen::Motion::PMDCMotor * motor /** motor */ 
            );
            /**Returns  the signal chart   <br> License requirements : nx_motion_motor ("NX Motion Motor") */
            public: NXOpen::Motion::SignalChart * SignalChart
            (
            );
            /**Sets  the signal chart   <br> License requirements : nx_motion_motor ("NX Motion Motor") */
