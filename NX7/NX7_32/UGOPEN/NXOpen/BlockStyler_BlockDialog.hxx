...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        ...
        class NXOPENUICPPEXPORT BlockDialog : public TransientObject
        {
            ...
            public: /**Focus notify callback. This is invoked when any selection block on the dialog receives focus <br> License requirements : None */
            ...
            /** Performs an Apply and restarts the dialog.  Invokes the apply handler.
                ...
                in a block that has the AutoCommit property set to true.  <br> License requirements : None */
