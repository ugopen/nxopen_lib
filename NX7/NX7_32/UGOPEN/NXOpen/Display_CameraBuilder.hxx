    ...
    namespace Display
    {
        ...
        class NXOPENCPPEXPORT CameraBuilder : public Builder
        {
            ...
            /**Returns  the camera name as a TEXT string.  Note that internally the camera name
                    ...
                    mapped to 8-bit characters will be replaced by # characters.  <br> License requirements : None */
            ...
            /**Returns  the camera name as a char string  <br> License requirements : None */
            public: NXString CameraNameChar
            (
            );
            /**Sets  the camera name as a char string  <br> License requirements : None */
