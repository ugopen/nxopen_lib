    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT PartPreferences
        {
            ...
            public: explicit PartPreferences(NXOpen::BasePart *owner): m_owner(owner)
                 ,modeling(NULL)
                 ,drafting(NULL)
                 ,objectPreferences(NULL)
                 ,userInterface(NULL)
                 ,visualVisualization(NULL)
                 ,lineVisualization(NULL)
                 ,namesBorderVisualization(NULL)
                 ,colorSettingVisualization(NULL)
                 ,shadeVisualization(NULL)
                 ,partSheetmetal(NULL)
                 ,partFlexiblePrintedCircuitDesign(NULL)
                 ,partAeroSheetmetal(NULL)
                 ,partSketch(NULL)
                 ,draftingPreference(NULL)
            {
            }
            public: 
