...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /**
            ...
            */
        class NXOPENCPPEXPORT ReplAsstBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /** Entry and re-entry to the Replacement Assistant mapping environment. 
                        ...
                        replacement entity.  <br> License requirements : None */
            public: void Enter
            (
            );
            ...
            /**Returns  the list of all Parent Equivalency Map objects  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::ParentEquivalencyMapList * MatchList
            (
            );
            /** This is the default creator for a parent equivalency map.  @return   <br> License requirements : None */
            public: NXOpen::GeometricUtilities::ParentEquivalencyMap * CreateEmptyMatch
            (
            );
            /**Returns  the list of all Entity Usage Info objects  <br> License requirements : None */
            ...
            /** Query the downstream usage of the current feature's output entities and populate the usageInfoList.
                        This API need be called only ONCE per feature being reparented.  @return   <br> License requirements : None */
            public: int QueryFeatureOutputUsage
            (
            );
            /** Perform automatic matching based on user-defined object names.  <br> License requirements : None */
            ...
            /** Infer more matches from matches already 'Accepted'. Add [array_order_guaranteed] annotation for output array when API wrap allows the same. <br> License requirements : None */
            ...
            /** Perform geometric matching.  <br> License requirements : None */
            ...
            /**Returns  the deviation allowance for geometric matching  <br> License requirements : None */
            public: double Allowance
            (
            );
            /**Sets  the deviation allowance for geometric matching  <br> License requirements : None */
            public: void SetAllowance
            (
                double allowance /** allowance */ 
            );
            /**Returns  the one to one auto matching preference  <br> License requirements : None */
            public: bool OneToOne
            (
            );
            /**Sets  the one to one auto matching preference  <br> License requirements : None */
            public: void SetOneToOne
            (
                bool oneToOne /** onetoone */ 
            );
            /**Returns  the automatic matching preference to match sheet boundaries only  <br> License requirements : None */
            public: bool MatchSheetBoundariesOnly
            (
            );
            /**Sets  the automatic matching preference to match sheet boundaries only  <br> License requirements : None */
            ...
            /** Set the source entities for the Replacement Assistant. If there are matches already
                    created and the body is changed, the matches will be deleted.  <br> License requirements : None */
