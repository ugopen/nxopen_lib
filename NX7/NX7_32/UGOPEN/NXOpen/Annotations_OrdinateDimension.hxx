    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT OrdinateDimension : public Annotations::Dimension, public virtual Annotations::ILinearTolerance
        {
            ...
            struct DoglegPreferences
            {
                ...
                public: DoglegPreferences(NXOpen::Annotations::OrdinateDoglegDefinition INIT_dogleg_setting /** dogleg setting */ , 
                        double INIT_angle /** angle */ , 
                        double INIT_start_offset /** start offset */ , 
                        double INIT_end_offset /** end offset */ , 
                        NXOpen::Annotations::OrdinateDoglegCreationOption INIT_dogleg_option /** dogleg option */ ) :
