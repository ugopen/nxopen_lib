...
namespace NXOpen
{
    ...
    /**
        ...
        This class is created using @link DexManager DexManager@endlink .  <br> To create a new instance of this class, use @link DexManager::CreateStep203Creator DexManager::CreateStep203Creator@endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT Step203Creator : public Builder
    {
        /** Create the builder */
        ...
        /**Returns  the color and layers - if set to true then NX color and layers will be preserverd <br> License requirements : None */
        public: bool ColorAndLayers
        (
        );
        /**Sets  the color and layers - if set to true then NX color and layers will be preserverd <br> License requirements : None */
