...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT Plane : public SmartObject, public virtual IPlane, public virtual ISurface, public virtual IOrientation
    {
        ...
        /** Destroy the plane object  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: void DestroyPlane
        (
        );
        /** Set PLANE_parms to plane to make it smart plane   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
