    ...
    namespace UserDefinedObjects
    {
        ...
        class NXOPENCPPEXPORT UserDefinedObjectManager
        {
            ...
            struct LinkedUdoDefinition
            {
                ...
                public: LinkedUdoDefinition(NXOpen::UserDefinedObjects::UserDefinedObject::LinkType INIT_link_type /** link type */ , 
                        NXOpen::UserDefinedObjects::UserDefinedObject * INIT_associated_udo /** associated udo */ , 
                        NXOpen::UserDefinedObjects::UserDefinedObject::LinkStatus INIT_status /** status */ ) :
