#ifndef NXOpen_ANNOTATIONS_SELECTLINEWELD_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTLINEWELD_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Annotations_SelectLineWeld.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectLineWeldBuilder;
        /** Represents a single object selection.
        */
        class NXOPENCPPEXPORT SelectLineWeld : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            private: friend class  _SelectLineWeldBuilder;
            protected: SelectLineWeld();
            /**Sets  the object being selected
                 <br> License requirements : None */
            public: void SetValue
            (
                NXOpen::Annotations::LineWeld * selection /** selected object */
            );
            /**Returns  the object being selected
                 <br> License requirements : None */
            public: NXOpen::Annotations::LineWeld * Value
            (
            );
            ...
            (
                ...
                NXOpen::Annotations::LineWeld * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Annotations::LineWeld * selection2 /** second selected object */,
            ...
            public: NXOpen::Annotations::LineWeld * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
