    ...
    class NXOPENCPPEXPORT Part : public BasePart
    {
        ...
        */
        ...
        struct PartFamilyAttributeData
        {
            ...
            public: PartFamilyAttributeData(NXOpen::Part::PartFamilyAttrType INIT_attribute_type /** the attribute type */, 
                    NXString INIT_attribute_name /** the attribute name */) :
                AttributeType(INIT_attribute_type),
                AttributeName(INIT_attribute_name)
            {
            }
        };
        ...
        */
        ...
        /**Returns  the CMM Inspection setup of the work part  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
        public: NXOpen::CAM::InspectionSetup * InspectionSetup
        (
        );
        /** Creates CMM Inspection setup  @return  the created CMM Inspection setup  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
        public: NXOpen::CAM::InspectionSetup * CreateInspectionSetup
        (
            const NXString & templateName /** the name of the template type   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        /** Delete CMM Inspection setup  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
