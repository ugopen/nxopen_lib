    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT GraphBuilder : public Builder
        {
            ...
            struct CurveData
            {
                ...
                public: CurveData(NXOpen::NXObject * INIT_motion_object /** Attribute object */, 
                        int INIT_request_index /** Attribute request choice */, 
                        int INIT_component_index /** Attribute component choice */, 
                        int INIT_request_csys_index /** Attribute csys choice */) :
