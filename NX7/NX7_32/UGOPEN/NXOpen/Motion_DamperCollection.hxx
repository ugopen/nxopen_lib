...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT DamperCollection : public TaggedObjectCollection
        {
            private: NXOpen::Motion::MotionManager* m_owner;
            public: explicit DamperCollection(NXOpen::Motion::MotionManager *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /**   Return  @link  Motion::DamperBuilder   Motion::DamperBuilder @endlink  object   @return  DamperBuilder object  <br> License requirements : mechanisms ("MECHANISMS") */
