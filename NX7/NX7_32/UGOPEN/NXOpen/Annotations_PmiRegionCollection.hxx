...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT PmiRegionCollection : public TaggedObjectCollection
        {
            private: NXOpen::Annotations::PmiManager* m_owner;
            public: explicit PmiRegionCollection(NXOpen::Annotations::PmiManager *owner): m_owner(owner)
            {
            }
            public: 
