    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPPEXPORT FillerStockBuilder : public Builder
        {
            ...
            /**Returns  the route selection which allows selection of routing objects <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
