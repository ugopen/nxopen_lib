...
public:
    ...
    int  Get_quad_only_option      (int *iQuad_only_option);
    ...
    int  Get_Warp (double *dWarp);
    int  Get_Skew (double *dSkew);
    int  Get_Taper (double *dTaper);
    int  Get_2D_MinAngle (double *dMinAngle);
    int  Get_2D_MaxAngle (double *dMaxAngle);
    int  Get_Jacobian_Ratio (double *dJacobian_Ratio);
