...
namespace NXOpen
{
    ...
    namespace Display
    {
        /** Represents a collection of plane grid objects  <br> To obtain an instance of this class, refer to @link BasePart BasePart@endlink  <br> */
        class NXOPENCPPEXPORT GridCollection : public TaggedObjectCollection
        {
            private: NXOpen::BasePart* m_owner;
            public: explicit GridCollection(NXOpen::BasePart *owner): m_owner(owner)
            {
            }
            public: 
            ...
            {
            public:
                typedef Display::Grid * value_type;
                /** Default constructor */
            ...
            /** Creates a @link Display::PlaneGridBuilder Display::PlaneGridBuilder@endlink  object
                        used to build a bounded grid on a plane.
                        
                        If the grid is not NULL, the planar grid object will be edited.
                      @return  plane grid builder  <br> License requirements : None */
            ...
            /** Creates a @link Display::DatumPlaneGridBuilder Display::DatumPlaneGridBuilder@endlink  object
                        used to edit the supplied datum plane grid.
                      @return  datum plane grid builder  <br> License requirements : None */
            ...
            /** Finds the @link Display::Grid Display::Grid@endlink  with the given identifier  
                        ...
                        journal identifier. 
                         <br> 
                     @return  Grid found  <br> License requirements : None */
            ...
            /** Finds the datum grid associated with the specified datum plane.
                      @return  Datum plane grid. NULL indicates no grid is associated
                                with the datum plane.  <br> License requirements : None */
