...
namespace NXOpen
{
    ...
    class NXOPENDEBUGSESSIONCPPEXPORT CallbackTest : public TransientObject
    {
        ...
        struct Struct1
        {
            ...
            public: Struct1(int INIT_int_value /** int value */ , 
                    double INIT_double_value /** double value */ , 
                    NXString INIT_string_value /** string value */ , 
                    NXString INIT_text_value /** text value */ ) :
        ...
        struct Struct2
        {
            ...
            public: Struct2(double INIT_x_value /** x value */ , 
                    double INIT_y_value /** y value */ ) :
                XValue(INIT_x_value),
                YValue(INIT_y_value)
            {
            }
        ...
        struct Struct3
        {
            ...
            public: Struct3(bool INIT_boolean_flag /** boolean flag */ , 
                    int INIT_int_value /** int value */ , 
                    NXOpen::CallbackTest::Struct1 INIT_first_struct /** first struct */ , 
                    NXOpen::CallbackTest::Struct2 INIT_second_struct /** second struct */ , 
                    NXOpen::CallbackTest::Enum3 INIT_enum_value /** enum value */ ) :
        ...
        struct Struct4
        {
            ...
            public: Struct4(NXString INIT_status_string /** status string */ , 
                    NXOpen::CallbackTest::Struct3 INIT_third_struct /** third struct */ , 
                    NXOpen::CallbackTest::Struct1 INIT_first_struct /** first struct */ ) :
