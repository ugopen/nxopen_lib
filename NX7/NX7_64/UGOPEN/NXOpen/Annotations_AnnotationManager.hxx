    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT AnnotationManager
        {
            ...
            public: explicit AnnotationManager(NXOpen::Part *owner): m_owner(owner)
                 ...
                 ,customSymbols(NULL)
                 ,idSymbols(NULL)
                 ,businessModifiers(NULL)
                 ,ordinateMargins(NULL)
                 ,dimensionSets(NULL)
                 ,centerlines(NULL)
                 ,intersectionSymbols(NULL)
                 ,targetPoints(NULL)
                 ,offsetCenterPoints(NULL)
                 ,hatches(NULL)
            {
            }
            public: 
            ...
            /** Save a new master Custom Symbol file.  <br> License requirements : None */
            public: void SaveUserSymbolPart
            (
            ...
            private: NXOpen::Annotations::CenterlineCollection *centerlines;
            /** Centerlines collection */
            public: NXOpen::Annotations::CenterlineCollection *Centerlines()
            {
                return centerlines;
            }
            private: NXOpen::Annotations::IntersectionSymbolCollection *intersectionSymbols;
            /** IntersectionSymbol collection */
            public: NXOpen::Annotations::IntersectionSymbolCollection *IntersectionSymbols()
            {
                return intersectionSymbols;
            }
            private: NXOpen::Annotations::TargetPointCollection *targetPoints;
            /** TargetPoint collection */
            public: NXOpen::Annotations::TargetPointCollection *TargetPoints()
            {
                return targetPoints;
            }
            private: NXOpen::Annotations::OffsetCenterPointCollection *offsetCenterPoints;
            /** OffsetCenterPoint collection */
            public: NXOpen::Annotations::OffsetCenterPointCollection *OffsetCenterPoints()
            {
                return offsetCenterPoints;
            }
            private: NXOpen::Annotations::HatchCollection *hatches;
            /** Hatch collection */
