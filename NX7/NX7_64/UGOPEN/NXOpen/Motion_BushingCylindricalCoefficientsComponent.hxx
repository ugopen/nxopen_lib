    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT BushingCylindricalCoefficientsComponent : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the radial, it is available only when 
                    @link BushingCylindricalCoefficientsComponent::RadialType BushingCylindricalCoefficientsComponent::RadialType @endlink and @link BushingCylindricalCoefficientsComponent::SetRadialType BushingCylindricalCoefficientsComponent::SetRadialType @endlink  set to @link Motion::ConnectorCoefficientTypesConstant Motion::ConnectorCoefficientTypesConstant@endlink  case  <br> License requirements : None */
            public: double Radial
            (
            );
            /**Sets  the radial, it is available only when 
                    @link BushingCylindricalCoefficientsComponent::RadialType BushingCylindricalCoefficientsComponent::RadialType @endlink and @link BushingCylindricalCoefficientsComponent::SetRadialType BushingCylindricalCoefficientsComponent::SetRadialType @endlink  set to @link Motion::ConnectorCoefficientTypesConstant Motion::ConnectorCoefficientTypesConstant@endlink  case  <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the radial function tag, it is available only when 
                    @link BushingCylindricalCoefficientsComponent::RadialType BushingCylindricalCoefficientsComponent::RadialType @endlink and @link BushingCylindricalCoefficientsComponent::SetRadialType BushingCylindricalCoefficientsComponent::SetRadialType @endlink  set to @link Motion::ConnectorCoefficientTypesSpline Motion::ConnectorCoefficientTypesSpline@endlink  case  <br> License requirements : None */
            ...
            /**Returns  the conical coefficient, it is available only when 
                    @link BushingCylindricalCoefficientsComponent::ConicalType BushingCylindricalCoefficientsComponent::ConicalType @endlink and @link BushingCylindricalCoefficientsComponent::SetConicalType BushingCylindricalCoefficientsComponent::SetConicalType @endlink  set to @link Motion::ConnectorCoefficientTypesConstant Motion::ConnectorCoefficientTypesConstant@endlink  case  <br> License requirements : None */
