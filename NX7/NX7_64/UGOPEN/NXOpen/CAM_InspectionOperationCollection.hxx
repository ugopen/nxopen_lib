...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT InspectionOperationCollection : public TaggedObjectCollection
        {
            ...
            public: explicit InspectionOperationCollection(NXOpen::CAM::InspectionSetup *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Finds the InspectionOperation object with the given identifier as recorded in a journal. @return  the found object  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Create an operation of the specified type and subtype under the parent groups. If the value of 
                    ...
                    specified name will be used. @return  the created operation  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates an Inspection Output Operation Builder  @return  operation builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates an Inspection Point Feature Builder  @return  Inspection Point Feature builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates an Inspection Plane Feature Builder  @return  Inspection Plane Feature builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a CMM Inspection Path Operation builder  @return  Path operation builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates an Inspection Cylinder Feature Builder  @return  Inspection Cylinder Feature builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates an Inspection Curve Feature Builder  @return  Inspection Curve Feature builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates an Inspection Surface Feature Builder  @return  Inspection Surface Feature builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates an Inspection Pattern Feature Builder  @return  Inspection Pattern Feature builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a cmm tolerance operation builder  @return  operation builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionToleranceOperationBuilder * CreateInspectionToleranceOperationBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );
            /** Creates an Inspection Alignment Builder  @return  Inspection alignment builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a CMM Inspection Cmm Command Builder  @return  Inspection Cmm command builder created  <br> License requirements : inspection_programming ("INSPECTION PROGRAMMING") */
