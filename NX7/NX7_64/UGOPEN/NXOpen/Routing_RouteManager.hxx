    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT RouteManager
        {
            ...
            public: explicit RouteManager(NXOpen::Part *owner): m_owner(owner)
                 ...
                 ,runs(NULL)
                 ,routingSystems(NULL)
                 ,routeLogicalAssociations(NULL)
                 ,corners(NULL)
                 ,bendCorners(NULL)
                 ,copeCorners(NULL)
                 ,discontinuityCorners(NULL)
                 ,miterCorners(NULL)
                 ,sBendCorners(NULL)
                 ,routePartDescriptors(NULL)
                 ,anchors(NULL)
                 ,stocks(NULL)
                 ,stockDatas(NULL)
                 ,crossSections(NULL)
                 ,wires(NULL)
                 ,overstockApplications(NULL)
                 ,fillers(NULL)
                 ,formboardFrames(NULL)
                 ,cableConnections(NULL)
                 ,nonPathConnections(NULL)
                 ,connectorDevices(NULL)
                 ,harnessDevices(NULL)
                 ,systemDevices(NULL)
                 ,electricalStockDevice(NULL)
                 ,pathConnections(NULL)
                 ,interfaceTerminalRelationships(NULL)
                 ,jumperConnections(NULL)
                 ,electricalDeviceRelationships(NULL)
                 ,designRules(NULL)
                 ,designRulesViolation(NULL)
                 ,designRuleViolationLocation(NULL)
                 ,electricalConnections(NULL)
                 ,electricalFormats(NULL)
                 ,electricalNavigatorFilters(NULL)
            {
            }
            public: 
            ...
            /** Finds the duplicate Routing Control Points (RCPs) within given tolerance and
                        ...
                        the duplicates are deleted. <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            (
                ...
                NXOpen::Routing::RouteManager::BomBlankLines blankLines /**  Is show blank lines option on/off? */,
            ...
            /** Creates a twist points on the route swept  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            private: NXOpen::Routing::Electrical::SystemDeviceCollection *systemDevices;
            ...
            private: NXOpen::Routing::DesignRuleViolationLocationCollection *designRuleViolationLocation;
            ...
            {
                return designRuleViolationLocation;
            }
            ...
            private: NXOpen::Routing::Electrical::ElectricalFormatCollection *electricalFormats;
            /** Routing Electrical Format collection */
            public: NXOpen::Routing::Electrical::ElectricalFormatCollection *ElectricalFormats()
            {
                return electricalFormats;
            }
            private: NXOpen::Routing::Electrical::ElectricalNavigatorFilterCollection *electricalNavigatorFilters;
            ...
            {
                return electricalNavigatorFilters;
            }
