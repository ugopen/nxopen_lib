...
namespace NXOpen
{
    ...
    /**
        Represents a @link PrintBuilder PrintBuilder@endlink .  This class is for use on Windows only and 
        contains all information relating to printing.  It is created using @link PlotManager PlotManager@endlink .
        
        The user must specify the sheets to be printed by setting the appropriate fields 
        through the @link PlotSourceBuilder PlotSourceBuilder@endlink .  The printer text and copies fields must be
        ...
        scale factors.
         <br> To create a new instance of this class, use @link PlotManager::CreatePrintBuilder PlotManager::CreatePrintBuilder@endlink  <br> 
    Default values.
    <table border="1"> 
    ...
    */
    class NXOPENCPPEXPORT PrintBuilder : public Builder
    {
        ...
        /**Returns  the number of copies.  This option specifies the number of copies to 
                    be printed.  <br> License requirements : None */
        public: int Copies
        (
        );
        ...
        /**Returns  the thin width scale factor.  This number is used as a scale factor
                    for thin width lines.  It cannot be less than 0.0.   <br> License requirements : None */
        ...
        /**Returns  the normal width scale factor.  This number is used as a scale factor
                    for normal width lines.  It cannot be less than 0.0.  <br> License requirements : None */
        ...
        /**Returns  the thick width scale factor.  This number is used as a scale factor
                    for thick width lines.  It cannot be less than 0.0.  <br> License requirements : None */
        ...
        /**Returns  the shaded image option.  The Current Display will be printed using 
                    the correct current shading if this option is set.  <br> License requirements : None */
        ...
        /**Returns  the white background option.  When printing a shaded view, this option allows
                    ...
                    and "Shaded Image" is also set to true.  <br> License requirements : None */
        ...
        /**Returns  the Source builder.  The Source builder contains all data involving the sheets to
                    to be printed.  <br> License requirements : None */
        ...
        /**Returns  the printer text.  The printer field represents the full path name of the 
                    printer the user wishes to print to.  <br> License requirements : None */
        ...
        /**Returns  the raster images option.  This option determines whether or not raster images will
                    be used when printing.  <br> License requirements : None */
        ...
        /**Returns  the resolution of images created for printing shaded views.  <br> License requirements : None */
        public: NXOpen::PrintBuilder::ImageResolutionOption ImageResolution
        (
        );
        /**Sets  the resolution of images created for printing shaded views.  <br> License requirements : None */
        ...
        /**Returns  the orientation.  This options determines the orientation of the
                    printed page.  <br> License requirements : None */
        ...
        /**Returns  the paper.  This options determines the paper size used for printing.  Note
                    that all options may not available on all printers.  <br> License requirements : None */
        ...
        /**Returns  the custom paper.  This will be used if the paper size is set to Custom.  <br> License requirements : None */
        public: int CustomPaper
        (
        );
        /**Sets  the custom paper.  This will be used if the paper size is set to Custom.  <br> License requirements : None */
