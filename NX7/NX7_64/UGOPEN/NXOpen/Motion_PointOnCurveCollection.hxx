...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT PointOnCurveCollection : public TaggedObjectCollection
        {
            private: NXOpen::Motion::MotionManager* m_owner;
            public: explicit PointOnCurveCollection(NXOpen::Motion::MotionManager *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates a @link Motion::PointOnCurveBuilder Motion::PointOnCurveBuilder@endlink   @return   <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /** Finds the @link  Motion::PointOnCurve   Motion::PointOnCurve @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  Motion::PointOnCurve   Motion::PointOnCurve @endlink  with this name.  <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::PointOnCurve * FindObject
            (
                const NXString & name /** The name of the @link  Motion::PointOnCurve   Motion::PointOnCurve @endlink .   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
