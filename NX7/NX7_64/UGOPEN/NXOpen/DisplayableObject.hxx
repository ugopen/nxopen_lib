...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT DisplayableObject : public NXObject, public virtual IFitTo
    {
        ...
        /**Returns  the color of the object. After setting the color, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
        public: int Color
        (
        );
        /**Returns  the layer that the object is in.  After setting the layer, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
        public: int Layer
        (
        );
        /**Returns  the line font of the object. After setting the line font, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
        public: NXOpen::DisplayableObject::ObjectFont LineFont
        (
        );
        /**Returns  the line width of the object.  After setting the line width, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
        ...
        /**Sets  the color of the object. After setting the color, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
        public: void SetColor
        (
            int color /** color */ 
        );
        /**Sets  the layer that the object is in.  After setting the layer, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
        public: void SetLayer
        (
            int layer /** layer */ 
        );
        /**Sets  the line font of the object. After setting the line font, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
        public: void SetLineFont
        (
            NXOpen::DisplayableObject::ObjectFont font /** font */ 
        );
        /**Sets  the line width of the object.  After setting the line width, @link RedisplayObject RedisplayObject@endlink 
                must be called in order for the change to take effect.   <br> License requirements : None */
