    ...
    namespace Assemblies
    {
        namespace ProductInterface
        {
            ...
            class NXOPENCPPEXPORT Collection
            {
                ...
                (
                    const NXString & journalIdentifier /** Identifier of the product interface object you want   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
