...
namespace NXOpen
{
    ...
    namespace Optimization
    {
        ...
        class NXOPENCPPEXPORT OptimizationBuilder : public Builder
        {
            ...
            /**Returns  the maximum number of updates allowed without converging to a solutionthe maximum iterations time <br> License requirements : None */
            public: int MaxNumberIteration
            (
            );
            /**Sets  the maximum number of updates allowed without converging to a solutionthe maximum iterations time <br> License requirements : None */
            public: void SetMaxNumberIteration
            (
                int maxNumberIteration /** maxnumberiteration */ 
            );
            /**Returns  the maximum time allowed for this run in seconds  <br> License requirements : None */
            public: int MaxTime
            (
            );
            /**Sets  the maximum time allowed for this run in seconds  <br> License requirements : None */
            ...
            /**Returns  the absolute criteria for optimizer to determine convergence. This value is
                        ...
                        objective results is less than this, then it is converged  <br> License requirements : None */
            ...
            /**Returns  the relative criteria for optimizer
                        ...
                        less than this value, the solution is converged  <br> License requirements : None */
