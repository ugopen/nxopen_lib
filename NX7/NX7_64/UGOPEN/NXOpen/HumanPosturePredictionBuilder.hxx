...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT HumanPosturePredictionBuilder : public Builder
    {
        ...
        (
            const NXString & pointX /** the length coordinates L31 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & pointY /** the width  coordinates W20 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & pointZ /** the height coordinates H70 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        ...
        (
            const NXString & pointX /** the length coordinates L8 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & pointY /** the width  coordinates W8 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & pointZ /** the height coordinates H8 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
        ...
        (
            NXOpen::HumanData::SideType side /** Indicates Human left or right                       */,
            const NXString & pedalAngle /** Left Foot Angle or Pedal Plane Angle A47 expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
        );
