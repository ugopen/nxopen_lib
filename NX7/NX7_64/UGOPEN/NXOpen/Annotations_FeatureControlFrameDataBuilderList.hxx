...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT FeatureControlFrameDataBuilderList : public TaggedObject
        {
            ...
            /** Returns the list of entities stored.  This list may contain NULL entities.
             ...
             <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::FeatureControlFrameDataBuilder *> Vector
            (
            );
