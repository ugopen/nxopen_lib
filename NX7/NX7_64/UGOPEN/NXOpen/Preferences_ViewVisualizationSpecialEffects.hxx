    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT ViewVisualizationSpecialEffects
        {
            ...
            struct ColorRGB
            {
                ...
                public: ColorRGB(double INIT_red_color /** Red in RGB pattern */, 
                        double INIT_green_color /** Green in RGB pattern */, 
                        double INIT_blue_color /** Blue in RGB pattern */) :
            ...
            struct FogData
            {
                ...
                public: FogData(int INIT_fog_mode /** Fog mode  */, 
                        bool INIT_fog_color_flag /** If true fog color is applied to the view */, 
                        NXOpen::Preferences::ViewVisualizationSpecialEffects::ColorRGB INIT_fog_color /** Fog Color  */, 
                        double INIT_fog_start /** Start of fog  */, 
                        double INIT_fog_end /** End of fog  */, 
                        double INIT_fog_density /** Density of fog  */) :
            ...
            struct ColorHSV
            {
                ...
                public: ColorHSV(double INIT_hue /** Hue in HSV pattern is the color  type (such as red, blue, or yellow) Ranges from 0-360  */, 
                        double INIT_saturation /** Saturation in HSV pattern is the "vibrancy" of the color Ranges from 0-255 */, 
                        double INIT_value /** Value in HSV pattern is the brightness of the color Ranges from 0-255 */) :
                    Hue(INIT_hue),
            ...
            struct ColorHLS
            {
                ...
                public: ColorHLS(double INIT_hue /** Hue in HSV pattern is the color type (such as red, blue, or yellow) Ranges from 0-360 */, 
                        double INIT_lightness /** Lightness in HLS pattern Ranges from 0-255 */, 
                        double INIT_saturation /** Saturation in HSV pattern is the "vibrancy" of the color Ranges from 0-255 */) :
                    Hue(INIT_hue),
