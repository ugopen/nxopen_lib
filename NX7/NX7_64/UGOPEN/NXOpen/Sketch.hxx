...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT Sketch : public DisplayableObject, public virtual IProfile
    {
        ...
        struct ConstraintGeometry
        {
            ...
            public: ConstraintGeometry(NXOpen::NXObject * INIT_geometry /** geometry */ , 
                    NXOpen::Sketch::ConstraintPointType INIT_point_type /** point type */ , 
                    int INIT_spline_defining_point_index /** Ignored unless PointType is SplineDefiningPoint.
        ...
        struct DimensionGeometry
        {
            ...
            public: DimensionGeometry(NXOpen::NXObject * INIT_geometry /** geometry */ , 
                    NXOpen::Sketch::AssocType INIT_assoc_type /** assoc type */ , 
                    int INIT_assoc_value /** See table for meaning.
                     @code 
                    The AssocValue has the following meanings:
                    AssocType           AssocValue meaning
                    ----------          -------------------
                    ...
                    all else            not used
                     @endcode 
                                             */, 
                    NXOpen::Point3d INIT_help_point /** help point */, 
                    NXOpen::NXObject * INIT_view /** The view the geometry is dependent on, if any */) :
                Geometry(INIT_geometry),
        ...
        struct ConstraintGeometryHelp
        {
            ...
            public: ConstraintGeometryHelp(NXOpen::Sketch::ConstraintGeometryHelpType INIT_type /** Point or Parameter */, 
                    NXOpen::Point3d INIT_point /** Ignored unless type is Point */, 
                    double INIT_parameter /** Ignored unless type is Parameter.
        ...
        /** Creates copies of input objects and constraints between these objects. This function is same as
                JA_SKETCH_copy_objects except that it returns an array of newly created dimensions  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
