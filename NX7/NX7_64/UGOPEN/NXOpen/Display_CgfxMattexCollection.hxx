...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        class NXOPENCPPEXPORT CgfxMattexCollection : public TaggedObjectCollection
        {
            private: NXOpen::BasePart* m_owner;
            public: explicit CgfxMattexCollection(NXOpen::BasePart *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates a @link Display::CgfxMattexBuilder Display::CgfxMattexBuilder@endlink   @return   <br> License requirements : None */
            ...
            /** Finds the @link  CgfxMattex   CgfxMattex @endlink  with the given identifier as recorded in a journal. 
                ...
                the software. However newer versions of the software should find the same object when 
                    ...
                    An exception will be thrown if no object can be found with the given journal identifier.  @return  CgfxMattex object found  <br> License requirements : None */
