...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT ScalarTorqueCollection : public TaggedObjectCollection
        {
            private: NXOpen::Motion::MotionManager* m_owner;
            public: explicit ScalarTorqueCollection(NXOpen::Motion::MotionManager *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /**   Return  @link  Motion::ScalarTorqueBuilder   Motion::ScalarTorqueBuilder @endlink  object   @return  ScalarTorqueBuilder object  <br> License requirements : mechanisms ("MECHANISMS") */
