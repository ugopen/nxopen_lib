...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT DieDirectionBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the type of source that defined the direction  <br> License requirements : None */
            public: NXOpen::Die::DieDirectionBuilder::DirectionType SourceDataType
            (
            );
            /**Sets  the type of source that defined the direction  <br> License requirements : ug_die_design ("Die Design") */
