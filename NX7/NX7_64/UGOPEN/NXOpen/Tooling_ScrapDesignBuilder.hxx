    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT ScrapDesignBuilder : public Builder
        {
            ...
            /** the overcut position, it determines where the overcut sketch will be constrained  @return  Indicates the position to constrain overcut sketch  <br> License requirements : None */
