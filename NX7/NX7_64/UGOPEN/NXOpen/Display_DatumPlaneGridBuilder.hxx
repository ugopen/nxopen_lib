...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents the builder for adding a datum plane grid @link Display::DatumPlaneGrid Display::DatumPlaneGrid@endlink  
                to a datum plane.
        ...
        */
        class NXOPENCPPEXPORT DatumPlaneGridBuilder : public Display::BoundedGridBuilder
        {
            ...
            /** Get the list of datum planes.  @return  datum plane list  <br> License requirements : None */
            ...
            /** Set the list of datum planes.  When editing an existing datum plane grid, 
                        ...
                        - one that matches @link Display::DatumPlaneGridBuilder::GetDatumPlanes Display::DatumPlaneGridBuilder::GetDatumPlanes@endlink 
                     <br> License requirements : None */
            public: void SetDatumPlanes
            (
                const std::vector<NXOpen::DatumPlane *> & datumPlanes /** datum plane list */
            );
            /**Returns  the grid orientation  <br> License requirements : None */
            public: NXOpen::Display::DatumPlaneGridBuilder::GridOrientationType GridOrientation
            (
            );
            /**Sets  the grid orientation  <br> License requirements : None */
