...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        class NXOPENCPPEXPORT AnalysisObjectCollection : public TaggedObjectCollection
        {
            ...
            public: explicit AnalysisObjectCollection(NXOpen::GeometricAnalysis::AnalysisManager *owner): m_owner(owner)
                 ,curveAnalysisDisplayObject(NULL)
                 ,surfaceAnalysisDisplayObject(NULL)
            {
            }
            public: 
            ...
            private: NXOpen::GeometricAnalysis::CurveAnalysisDisplay *curveAnalysisDisplayObject;
            ...
            {
                return curveAnalysisDisplayObject;
            }
            private: NXOpen::GeometricAnalysis::SurfaceAnalysisDisplay *surfaceAnalysisDisplayObject;
            ...
            {
                return surfaceAnalysisDisplayObject;
            }
