...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT DesignRuleViolationLocationCollection : public TaggedObjectCollection
        {
            ...
            public: explicit DesignRuleViolationLocationCollection(NXOpen::Routing::RouteManager *owner): m_owner(owner)
            {
            }
            public: 
            ...
            /** Creates a @link Routing::DesignRuleViolationLocation Routing::DesignRuleViolationLocation@endlink  object.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
