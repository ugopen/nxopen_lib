    ...
    namespace SheetMetal
    {
        ...
        class NXOPENCPPEXPORT FlatPatternSettings : public TaggedObject
        {
            ...
            struct FlatPatternObjectTypeDisplay
            {
                ...
                public: FlatPatternObjectTypeDisplay(NXOpen::SheetMetal::FlatPatternSettings::FlatPatternObjectType INIT_type /** Object type */, 
                        int INIT_is_enabled /** Enabled status for the object type */, 
                        NXColor* INIT_color /** Object color */, 
                        NXOpen::ViewDependentDisplayManager::Font INIT_font /** Object font */, 
                        NXOpen::ViewDependentDisplayManager::Width INIT_width /** Object width */) :
                    Type(INIT_type),
            ...
            /** Returns the display data for a callout type. The name member of the
                        @link SheetMetal::FlatPatternSettings::FlatPatternCalloutTypeDisplay SheetMetal::FlatPatternSettings::FlatPatternCalloutTypeDisplay@endlink 
                        ...
                        be used for subsequent calls, without modification.  @return  The display data for the callout type.  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
