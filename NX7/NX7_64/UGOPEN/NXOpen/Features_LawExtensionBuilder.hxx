    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT LawExtensionBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the faces. Faces are used only when @link LawExtensionBuilder::Types LawExtensionBuilder::Types@endlink  is  
                        @link LawExtensionBuilder::TypesFaces LawExtensionBuilder::TypesFaces@endlink . The faces must be
            ...
            /**Returns  a value indicating whether to reverse the reference face normal. When @link LawExtensionBuilder::Types LawExtensionBuilder::Types@endlink  is  
                        @link LawExtensionBuilder::TypesFaces LawExtensionBuilder::TypesFaces@endlink , the input faces are sewed to
            ...
            /**Sets  a value indicating whether to reverse the reference face normal. When @link LawExtensionBuilder::Types LawExtensionBuilder::Types@endlink  is  
                        @link LawExtensionBuilder::TypesFaces LawExtensionBuilder::TypesFaces@endlink , the input faces are sewed to
                        form a single sheet body. The normal of the sheet body is decided based on the face which
                        is nearest to the parametric mid point of the base profile and acts as the reference face normal.  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") */
            ...
            /**Returns  the vector. Vector is used only when @link LawExtensionBuilder::Types LawExtensionBuilder::Types@endlink  is  
                        @link LawExtensionBuilder::TypesVector LawExtensionBuilder::TypesVector@endlink   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") */
            public: NXOpen::Direction * Vector
            (
            );
            /**Sets  the vector. Vector is used only when @link LawExtensionBuilder::Types LawExtensionBuilder::Types@endlink  is  
                        @link LawExtensionBuilder::TypesVector LawExtensionBuilder::TypesVector@endlink   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") */
            ...
            /**Returns  the opposite side length law. Opposite side extension law is required only when
                        @link LawExtensionBuilder::OppositeSideExtensionOptions LawExtensionBuilder::OppositeSideExtensionOptions@endlink  is  
                        @link LawExtensionBuilder::OppositeSideExtensionOptionsAsymmetric LawExtensionBuilder::OppositeSideExtensionOptionsAsymmetric@endlink   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR free_form_modeling ("FREE-FORM MODELING") */
