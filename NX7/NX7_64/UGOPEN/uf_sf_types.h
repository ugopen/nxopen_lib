...
/******************************************************************
*  These two are obsolete as of NX70, do not reuse these values
...
/* this gap is left intentionally,  value=40 is used for region values in NX750*/
...
typedef struct UF_SF_geom_options_s
{
    logical     fSyncPoints;
    logical     fSyncCsys;
    logical     fSyncLines;
...
} UF_SF_geom_options_t, *UF_SF_geom_options_p_t;
