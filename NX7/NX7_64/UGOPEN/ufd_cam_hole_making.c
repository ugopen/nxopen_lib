...
)
{
   ...
   char *env_trans; 
   char opt_name[UF_CFI_MAX_PATH_NAME_LEN+UF_CFI_MAX_FILE_NAME_SIZE];
   char part_name[UF_CFI_MAX_PATH_NAME_LEN+UF_CFI_MAX_FILE_NAME_SIZE];
   char open_part_name[UF_CFI_MAX_PATH_NAME_LEN+UF_CFI_MAX_FILE_NAME_SIZE];
   char  **feature_names;
