    ...
    Function cycle_cb(ByVal camObjectTag As Tag, ByVal ptr As IntPtr) As Boolean
        ...
        If answer = True Then
            ...
            If objectType = 106 And objectSubtype = 2 Then
                ...
                pocketBuilder.AdjustRegisterType = CAM.MachinePocketGroupBuilder.RegisterType.SameAsPocketId
                pocketBuilder.CutcomRegisterType = CAM.MachinePocketGroupBuilder.RegisterType.SameAsPocketId
