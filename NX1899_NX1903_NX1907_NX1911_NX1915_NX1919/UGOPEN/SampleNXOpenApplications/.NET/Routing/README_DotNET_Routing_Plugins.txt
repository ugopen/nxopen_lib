...
FILES REQUIRED
    ...
    C#
    1. Routing_Example_CallBacks.cs
    2. Routing_Example_DesignRules.cs
    3. Routing_Example_Plugins.cs

    Visual Basic
    1. Routing_Example_Callbacks.vb
    2. Routing_Example_DesignRules.vb
    3. Routing_Example_Plugins.vb
	
The above listed files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/.NET/Routing.

----------------------------------------------------------------------------------------------------
BUILD STEPS

The build steps vary depending on the language in which you write your Callbacks, Plugins, and
Design Rules. However you build the examples, you need to end up with a .DLL file.
