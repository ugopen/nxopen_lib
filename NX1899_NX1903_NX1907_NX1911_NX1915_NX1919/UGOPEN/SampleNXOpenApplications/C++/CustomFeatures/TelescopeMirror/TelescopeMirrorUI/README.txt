...
-------------------------------------------------------------------------------
        Demonstration example for custom feature Telescope Mirror UI code.
-------------------------------------------------------------------------------
...
Files required
--------------
    1. TelescopeMirrorUI.hpp
	2. TelescopeMirrorUI.cpp
	3. TelescopeMirrorUI.dlx	
    4. TelescopeMirrorUI_CPP_ReadMe.txt
	
 The above files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/CustomFeatures/TelescopeMirror/TelescopeMirrorUI.
...
------------
  ...
  Windows
  -------
   1. Using Visual Studio - create a new project with name "TelescopeMirrorUI" using the NX Open C++ Wizard.
   ...
   3. Add the TelescopeMirrorUI.cpp and TelescopeMirrorUI.hpp to Source Files by selecting the Project pull down and select "Add Existing Item...". Select the file 
      using the popup window.

   4. Build the internal image by going to the Build menu and selecting either 
      "Build Solution" or "Rebuild Solution".
 
   This will create an executable called TelescopeMirrorUI.dll in the Debug directory.
   ...
   The uflink tool can also be used to create the executable by following these steps:
    ...
    ufcomp TelescopeMirrorUI.cpp
      uflink UFDLL=TelescopeMirrorUI.dll TelescopeMirrorUI.obj

   This will create TelescopeMirrorUI.dll in the current directory.
  ...
  -----
   ...
   This will create TelescopeMirrorUI.so in the current directory.
   
----------------------------
Settings before Launching NX
---------------------------- 
The executable (TelescopeMirrorUI.dll for Windows or TelescopeMirrorUI.so for Linux) and TelescopeMirrorUI.dlx must be placed in any one of the following locations mentioned below:
...
-----------------------
    ...
    4. This will launch the “Telescope Mirror” dialog.

    5. Provide inputs as indicated in dialog.

    6. Dialog OK/Apply creates the Telescope Mirror.
	
	7. Newly created Telescope Mirror feature can be edited by RMB on Part Navigator feature node and choosing Edit with Rollback
