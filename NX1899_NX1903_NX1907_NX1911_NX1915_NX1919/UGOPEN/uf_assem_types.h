...
*  The first four settings are equivalent to the four possible
*  combinations of the partial loading and lightweight representations.
*  The final setting is reserved for future use.
*
********************************************************************/
enum UF_ASSEM_part_load_option_e
{
    UF_ASSEM_part_load_option_fully_load = 0,                             /* partial load : off, use lightweight : off */
    UF_ASSEM_part_load_option_partially_load = 1,                         /* partial load : on, use lightweight : off */
    UF_ASSEM_part_load_option_fully_load_lightweight_display = 2,         /* partial load : off, use lightweight : on */
    UF_ASSEM_part_load_option_partially_load_lightweight_display = 3,     /* partial load : on, use lightweight : on */
    UF_ASSEM_part_load_option_minimally_load_lightweight_display = 4      /* reserved for future use */
};
