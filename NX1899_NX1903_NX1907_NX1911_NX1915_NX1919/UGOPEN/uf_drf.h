...
UF_DRF_initialize_custom_symbol_data                NXOpen.Annotations.MasterCustomSymbolData
UF_DRF_create_custom_symbol_instance                NXOpen.Annotations.MasterSymbolBuilder and NXOpen.Annotations.CustomSymbolBuilder
*******************************************************************************/
...
extern UFUNEXPORT void uf5547(int *ip1, int *ip2, tag_t *np3, tag_t *nr4, int *ir5);
