    ...
    */
    class NXOPENCPPEXPORT  DisplayModification : public NXOpen::TransientObject
    {
        ...
        /**Returns  the flag to show name for selected objects. It only takes effects when
                @link NXOpen::Preferences::PartVisualizationNamesBorders::ObjectNameDisplay NXOpen::Preferences::PartVisualizationNamesBorders::ObjectNameDisplay @endlink and @link NXOpen::Preferences::PartVisualizationNamesBorders::SetObjectNameDisplay NXOpen::Preferences::PartVisualizationNamesBorders::SetObjectNameDisplay @endlink  is
