...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            AnalysisMethod </td> <td> 
             
            APillarGeometry </td> </tr> 

            <tr><td> 
             
            Configuration.UseStandardLoading </td> <td> 
             
            0 </td> </tr> 

            <tr><td> 
             
            EyeDefinition.EyeDefinitionType </td> <td> 
             
            EyeFeature </td> </tr> 

            <tr><td> 
             
            EyeRotationAngle </td> <td> 
            ...
            OuterPointofAPillarSection </td> </tr> 

            <tr><td> 
             
            TargetObstructionAngle </td> <td> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  APillarObstructionBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /**Returns  the additional geometry specified by the user in the A-pillar obstruction analysis. 
                 <br>  Created in NX1899.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::ScCollector * AdditionalGeometry
                (
                );
                /**Sets  the additional geometry specified by the user in the A-pillar obstruction analysis. 
                 <br>  Created in NX1899.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetAdditionalGeometry
                (
                    NXOpen::ScCollector * additionalGeometry /** additionalgeometry */ 
                );
