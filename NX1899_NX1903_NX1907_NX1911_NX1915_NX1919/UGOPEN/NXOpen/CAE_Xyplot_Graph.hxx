            ...
            */
            class NXOPENCPP_CAEEXPORT  Graph : public NXOpen::CAE::Xyplot::BaseModel
            {
                ...
                /** Gets the abscissa axis. 
                 <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::CAE::Xyplot::Graph::GetAbscissaAxes NXOpen::CAE::Xyplot::Graph::GetAbscissaAxes@endlink  <br>  

                 <br>  Created in NX11.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::CAE::Xyplot::Graph::GetAbscissaAxes") NXOpen::CAE::Xyplot::BasicModel * GetAbscissaAxis
                (
                );
                ...
                /**  @brief  Gets the display style index for a given record index in given graph. 
                                     ...
                                     The record index must be greater than and equal to 0 and less than @link CAE::Xyplot::Graph::RecordCount CAE::Xyplot::Graph::RecordCount @endlink and @link CAE::Xyplot::Graph::SetRecordCount CAE::Xyplot::Graph::SetRecordCount @endlink .
