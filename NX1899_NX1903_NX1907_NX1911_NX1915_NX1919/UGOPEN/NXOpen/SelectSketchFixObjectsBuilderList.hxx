#ifndef NXOpen_SELECTSKETCHFIXOBJECTSBUILDERLIST_HXX_INCLUDED
#define NXOpen_SELECTSKETCHFIXOBJECTSBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     SelectSketchFixObjectsBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    class View;
    class _SelectSketchFixObjectsBuilderListBuilder;
    class SelectSketchFixObjectsBuilderListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectSketchFixObjectsBuilderList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectSketchFixObjectsBuilderListImpl * m_selectsketchfixobjectsbuilderlist_impl;
        private: friend class  _SelectSketchFixObjectsBuilderListBuilder;
        protected: SelectSketchFixObjectsBuilderList();
        public: ~SelectSketchFixObjectsBuilderList();
        ...
        public: bool Add
        (
            NXOpen::SketchFixObjectsBuilder * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::SketchFixObjectsBuilder *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::SketchFixObjectsBuilder * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::SketchFixObjectsBuilder * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if succesully removed from list;
        ...
        (
            ...
            NXOpen::SketchFixObjectsBuilder * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::SketchFixObjectsBuilder * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::SketchFixObjectsBuilder *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::SketchFixObjectsBuilder * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::SketchFixObjectsBuilder *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::SketchFixObjectsBuilder *> GetArray
        (
        );
