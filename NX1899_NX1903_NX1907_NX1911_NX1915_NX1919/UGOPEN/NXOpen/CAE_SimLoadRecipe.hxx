        ...
        */
        class NXOPENCPP_CAEEXPORT  SimLoadRecipe : public NXOpen::TaggedObject, public virtual NXOpen::CAE::IPostScenarioDataSource
        {
            ...
            /** Fills the mapping tables of the Load Recipe based on available data in the data sources. 
                        ...
                        <ol>
                            <li>
                                If the @link NXOpen::CAE::SimLoadRecipe::MappingType NXOpen::CAE::SimLoadRecipe::MappingType @endlink and @link NXOpen::CAE::SimLoadRecipe::SetMappingType NXOpen::CAE::SimLoadRecipe::SetMappingType @endlink  is
            ...
            /** Overload that also sets the Assembly Component to be used by Autofill. 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::SimLoadRecipe::SetAutofillAssemblyComponent NXOpen::CAE::SimLoadRecipe::SetAutofillAssemblyComponent@endlink  and @link NXOpen::CAE::SimLoadRecipe::Autofill NXOpen::CAE::SimLoadRecipe::Autofill@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::SimLoadRecipe::SetAutofillAssemblyComponent and NXOpen::CAE::SimLoadRecipe::Autofill instead.") void Autofill
            (
