    ...
    namespace Display
    {
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  Background : public NXOpen::Builder
        {
            ...
            {
                BackgroundImageTypeImage1/** Predefined image 1 background */,
                BackgroundImageTypeImage2/** Predefined image 2 background */,
                BackgroundImageTypeImage3/** Predefined image 3 background */,
                BackgroundImageTypeImage4/** Predefined image 4 background */,
