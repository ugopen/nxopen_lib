...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        ModelDefineOption </td> <td> 
         
        SelectGeometry </td> </tr> 
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  AutoFlexPropertyBuilder : public NXOpen::Builder
        {
            ...
            public: enum SolverType
            {
                ...
                SolverTypeAnsys/** ansys */ ,
                SolverTypeAbaqus/** abaqus */ 
            };
            ...
            /**Returns  the toggle ERFEM 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool EnableErfem
            (
            );
            /**Sets  the toggle ERFEM 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the input mesh file 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXString InputMeshFile
            (
            );
            /**Sets  the input mesh file 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetInputMeshFile
            (
            ...
            (
                NXOpen::DisplayableObject * connection /** connection */ ,
