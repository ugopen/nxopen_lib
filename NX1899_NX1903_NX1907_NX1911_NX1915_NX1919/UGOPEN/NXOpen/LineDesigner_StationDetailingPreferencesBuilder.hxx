#ifndef NXOpen_LINEDESIGNER_STATIONDETAILINGPREFERENCESBUILDER_HXX_INCLUDED
#define NXOpen_LINEDESIGNER_STATIONDETAILINGPREFERENCESBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     LineDesigner_StationDetailingPreferencesBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace LineDesigner
    {
        ...
        /// \cond NX_NO_DOC 
        /**  <br> To create a new instance of this class, use @link NXOpen::LineDesigner::LineDesignerManager::CreateStationDetailingPreferencesBuilder  NXOpen::LineDesigner::LineDesignerManager::CreateStationDetailingPreferencesBuilder @endlink  <br> 
         <br>  Created in NX1876.0.0.  <br>  
        */
        class LINEDESIGNEROPENCPPEXPORT  StationDetailingPreferencesBuilder : public NXOpen::Builder
        {
