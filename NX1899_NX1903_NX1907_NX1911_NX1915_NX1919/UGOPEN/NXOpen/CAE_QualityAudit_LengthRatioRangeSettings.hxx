    ...
    namespace CAE
    {
        namespace QualityAudit
        {
            ...
            /**  @brief  This class contains the length ratio range settings available for the following actions: 
               ...
               <br> To obtain an instance of this class get the @link NXOpen::CAE::QualityAudit::Action::Settings NXOpen::CAE::QualityAudit::Action::Settings @endlink and @link NXOpen::CAE::QualityAudit::Action::SetSettings NXOpen::CAE::QualityAudit::Action::SetSettings @endlink  of classes using it.  <br> 
