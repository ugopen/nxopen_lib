...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        AngularSleepingThresholdExpression.Value </td> <td> 
         
        0.000014 (millimeters part), 0.000014 (inches part) </td> </tr> 
        ...
        EnableParallel </td> <td> 
         
        false </td> </tr> 

        <tr><td> 
         
        EnablePlcSimAdvTimeSyn </td> <td> 
        ...
        LinearSleepingThresholdExpression.Value </td> <td> 
         
        0.00025 (millimeters part), 0.00000975 (inches part) </td> </tr> 
        ...
        RatioLimitExpression.Value </td> <td> 
        ...
        SleepTimeThresholdExpression.Value </td> <td> 
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  PreferencesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the plcsim adv time synchronization option 
             ...
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: bool EnablePlcSimAdvTimeSyn
            (
            );
            /**Sets  the plcsim adv time synchronization option 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: void SetEnablePlcSimAdvTimeSyn
            (
