...
namespace NXOpen
{
    ...
    namespace Markup
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link NXOpen::Markup::ElementCollection::CreateFreehand  NXOpen::Markup::ElementCollection::CreateFreehand @endlink  <br> 
