        ...
        */
        class NXOPENCPP_FIELDSEXPORT  FieldManager : public NXOpen::NXObject
        {
            ...
            /** Creates a @link NXOpen::Fields::FieldProfileTable NXOpen::Fields::FieldProfileTable@endlink  object with dependent and independent variables 
             ...
             <br>  @deprecated Deprecated in NX1847.0.0.  Profile Fields are created in the commit method of @link NXOpen::Motion::ProfileBuilder NXOpen::Motion::ProfileBuilder@endlink  <br>  

             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Profile Fields are created in the commit method of NXOpen::Motion::ProfileBuilder") NXOpen::Fields::FieldProfileTable * CreateProfileField
            (
                const NXString & fieldName /** field name */,
            ...
            /** Creates an External Data Table Profile
                      @return  profile external data table ref field 
             <br>  @deprecated Deprecated in NX1847.0.0.  Profile Fields are created in the commit method of @link NXOpen::Motion::ProfileBuilder NXOpen::Motion::ProfileBuilder@endlink  <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Profile Fields are created in the commit method of NXOpen::Motion::ProfileBuilder") NXOpen::Fields::FieldReference * CreateProfileExternalTable
            (
                const NXString & fieldName /** field name */,
                const NXString & filePath /** filepath */ ,
                int nbAbscisae /** 1 or 2 */,
                int xColumn /** xcolumn */ ,
                int yColumn /** ycolumn */ ,
                int ordinateColumn /** ordinatecolumn */ ,
                NXOpen::Expression * xOffset /** xoffset */ ,
                NXOpen::Expression * yOffset /** yoffset */ ,
                NXOpen::Expression * ordinateOffset /** ordinateoffset */ ,
                NXOpen::Expression * xScale /** xscale */ ,
                NXOpen::Expression * yScale /** yscale */ ,
                NXOpen::Expression * ordinateScale /** ordinatescale */ ,
                bool xCyclic /** xcyclic */ ,
                bool yCyclic /** ycyclic */ ,
                NXOpen::Fields::FieldEvaluator::InterpolationEnum interpolation /** interpolation */ ,
                NXOpen::Fields::FieldEvaluator::ValuesOutsideTableInterpolationEnum xExtrapolation /** xextrapolation */ ,
                NXOpen::Fields::FieldEvaluator::ValuesOutsideTableInterpolationEnum yExtrapolation /** yextrapolation */ ,
                NXOpen::Expression * slopeLeft /** slopeleft */ ,
                NXOpen::Expression * slopeRight /** sloperight */ 
            );
            /** Creates an External Data Table Profile
                      @return  profile external data table ref field 
             <br>  @deprecated Deprecated in NX1847.0.0.  Profile Fields are created in the commit method of @link NXOpen::Motion::ProfileBuilder NXOpen::Motion::ProfileBuilder@endlink  <br>  
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::Fields::FieldReference * CreateProfileExternalTable
            (
                const char * fieldName /** field name */,
            ...
            /** Modifies an External Data Table Profile
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Profile Fields are created in the commit method of NXOpen::Motion::ProfileBuilder") void EditProfileExternalTable
            (
                NXOpen::Fields::FieldReference * externalFileRefField /** externalfilereffield */ ,
                const NXString & fieldName /** field name */,
                const NXString & filePath /** filepath */ ,
                int nbAbscisae /** 1 or 2 */,
                int xColumn /** xcolumn */ ,
