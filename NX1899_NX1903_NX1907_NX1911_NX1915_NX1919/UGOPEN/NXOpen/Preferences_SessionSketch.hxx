        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionSketch
        {
            ...
            */
            ...
            /**Returns  the setting that controls whether or not to show movable objects in the active sketch. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool ShowMovableObjects
            (
            );
            /**Sets  the setting that controls whether or not to show movable objects in the active sketch. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: void SetShowMovableObjects
            (
                bool showMovableObjects /** showmovableobjects */ 
            );
