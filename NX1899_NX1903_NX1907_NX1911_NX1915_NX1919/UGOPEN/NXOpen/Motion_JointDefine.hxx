        ...
        */
        class NXOPENCPP_MOTIONEXPORT  JointDefine : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the override state of the axis type, which should only be used for occurrence 
             <br>  @deprecated Deprecated in NX1872.0.0.  Use @link Motion::JointDefine::ActionSpinVectorOvrCtrl Motion::JointDefine::ActionSpinVectorOvrCtrl@endlink /@link Motion::JointDefine::ActionCrossPinVectorOvrCtrl Motion::JointDefine::ActionCrossPinVectorOvrCtrl@endlink or@link Motion::JointDefine::BaseSpinVectorOvrCtrl Motion::JointDefine::BaseSpinVectorOvrCtrl@endlink /@link Motion::JointDefine::BaseCrossPinVectorOvrCtrl Motion::JointDefine::BaseCrossPinVectorOvrCtrl@endlink  instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use Motion::JointDefine::ActionSpinVectorOvrCtrl/Motion::JointDefine::ActionCrossPinVectorOvrCtrlorMotion::JointDefine::BaseSpinVectorOvrCtrl/Motion::JointDefine::BaseCrossPinVectorOvrCtrl instead.") NXOpen::Motion::ParamOverrideState AxisTypeOvrCtrl
            (
            );
            /**Sets  the override state of the axis type, which should only be used for occurrence 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use Motion::JointDefine::ActionSpinVectorOvrCtrl/Motion::JointDefine::ActionCrossPinVectorOvrCtrl or Motion::JointDefine::BaseSpinVectorOvrCtrl/Motion::JointDefine::BaseCrossPinVectorOvrCtrl instead.") void SetAxisTypeOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            /**Returns  the axis type. Used only when joint subtype is 
             ...
             <br>  @deprecated Deprecated in NX1872.0.0.  Use @link Motion::JointDefine::ActionSpinVector Motion::JointDefine::ActionSpinVector@endlink /@link Motion::JointDefine::ActionCrossPinVector Motion::JointDefine::ActionCrossPinVector@endlink  or @link Motion::JointDefine::BaseSpinVector Motion::JointDefine::BaseSpinVector@endlink /@link Motion::JointDefine::BaseCrossPinVector Motion::JointDefine::BaseCrossPinVector@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use Motion::JointDefine::ActionSpinVector/Motion::JointDefine::ActionCrossPinVector or Motion::JointDefine::BaseSpinVector/Motion::JointDefine::BaseCrossPinVector instead.") NXOpen::Motion::JointDefine::UniversalJointAxisType AxisType
            (
            );
            /**Sets  the axis type. Used only when joint subtype is 
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use Motion::JointDefine::ActionSpinVector/Motion::JointDefine::ActionCrossPinVector or Motion::JointDefine::BaseSpinVector/Motion::JointDefine::BaseCrossPinVector instead.") void SetAxisType
            (
