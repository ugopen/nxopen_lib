    ...
    namespace Fields
    {
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  FieldTable : public NXOpen::Fields::Field
        {
            ...
            /** Edit the table field with objects.  Specifies the new array of @link NXOpen::Fields::FieldVariable NXOpen::Fields::FieldVariable@endlink s for 
                    independent and dependent variables, as well as the new double values and new smart 
