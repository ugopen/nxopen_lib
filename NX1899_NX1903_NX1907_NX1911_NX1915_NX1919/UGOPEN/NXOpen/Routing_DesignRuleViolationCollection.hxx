    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  DesignRuleViolationCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Design Rule reason 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link Routing::CustomManager::DesignRuleReason Routing::CustomManager::DesignRuleReason@endlink  instead. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX12.0.0.  Use Routing::CustomManager::DesignRuleReason instead.") Reason
            {
