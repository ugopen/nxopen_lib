        ...
        */
        class NXOPENCPP_CAEEXPORT  SingleLabelSelectionRecipe : public NXOpen::CAE::SelectionRecipe
        {
            ...
            /**Returns  the Node Label. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipeSingleLabelStrategy::Label CAE::SelRecipeSingleLabelStrategy::Label @endlink and @link CAE::SelRecipeSingleLabelStrategy::SetLabel CAE::SelRecipeSingleLabelStrategy::SetLabel @endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipeSingleLabelStrategy::Label CAE::SelRecipeSingleLabelStrategy::Label @endlink and @link CAE::SelRecipeSingleLabelStrategy::SetLabel CAE::SelRecipeSingleLabelStrategy::SetLabel @endlink  instead.") int Label
            (
            );
            /** Set the Node Label. 
