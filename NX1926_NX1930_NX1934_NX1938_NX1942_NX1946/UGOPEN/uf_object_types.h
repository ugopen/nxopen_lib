...
#define    UF_machining_master_template_manager_subtype      100 
#define    UF_machining_master_template_object_subtype       101
...
#define    UF_mach_dpm_planar_5xadditive_subtype         1100   /* Planar 5-axis additive */
