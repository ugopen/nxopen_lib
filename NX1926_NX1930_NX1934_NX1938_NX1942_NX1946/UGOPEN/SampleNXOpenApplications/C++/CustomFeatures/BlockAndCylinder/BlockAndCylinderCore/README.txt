...
-------------------------------------------------------------------------------
        Demonstration example for custom feature Block And Cylinder Core code.
-------------------------------------------------------------------------------
...
This example demonstrates how a Custom feature "Block And Cylinder" can be implemented.

---------------
Important Note
---------------
This example requires parasolid library and header files which are compatible with the NX version on which custom feature will be used
 and is to be obtained by users from Parasolid.

--------------
Files required
--------------
    1. BlockAndCylinderCore.cpp
	2. CustomFeatureConfiguration.xml
    3. BlockAndCylinderCore_CPP_ReadMe.txt
	
 The above files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/CustomFeatures/BlockAndCylinder/BlockAndCylinderCore
...
------------
  ...
  Windows
  -------
   1. Using Visual Studio - create a new project with name "BlockAndCylinderCore" using the NX Open C++ Wizard.
   ...
   3. Add the BlockAndCylinderCore.cpp to Source Files by selecting the Project pull down and select "Add Existing Item...". Select the file 
      using the popup window.

   4. Build the internal image by going to the Build menu and selecting either 
      "Build Solution" or "Rebuild Solution".
 
   This will create an executable called BlockAndCylinderCore.dll in the Debug directory.
   ...
   The uflink tool can also be used to create the executable by following these steps:
    ...
    ufcomp BlockAndCylinderCore.cpp
      uflink UFDLL=BlockAndCylinderCore.dll BlockAndCylinderCore.obj

   This will create BlockAndCylinderCore.dll in the current directory.
  ...
  -----
   ...
   This will create BlockAndCylinderCore.so in the current directory.

----------------------------
Settings before Launching NX
---------------------------- 
The executable (BlockAndCylinderCore.dll for Windows or BlockAndCylinderCore.so for Linux) and CustomFeatureConfiguration.xml must be placed in any one of the following locations mentioned below:
...
-----------------------
    ...
    To execute above created executable please follow steps in BlockAndCylinderUI example which is loacted at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/CustomFeatures/BlockAndCylinder/BlockAndCylinderUI
