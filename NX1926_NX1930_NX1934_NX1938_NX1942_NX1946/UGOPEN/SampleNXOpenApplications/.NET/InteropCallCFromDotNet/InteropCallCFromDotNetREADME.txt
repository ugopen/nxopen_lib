...
------------
  ...
  -----------------------------------------
   ...
   6. This will create an executable called UFLegacyApp.dll in the Release or Debug  directory as per selected configuration.
  ...
  ----------------------------
   ...
   5. This will create an executable called InteropCallCFromDotNet.exe in the Release or Debug  directory as per selected configuration.
