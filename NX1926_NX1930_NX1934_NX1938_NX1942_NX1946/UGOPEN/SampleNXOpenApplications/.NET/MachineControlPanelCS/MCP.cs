...
namespace MCP_CSharp
{
    public partial class MCP : Form
    {
        ...
        {
            // Use a try-catch block here because MachineControlStartNc() may
            // return an exception with an error code if the NCStart can't be
            // executed. In this case NX has already signaled this with an
            // error dialog and the MCP should just skip the PlayForward() to
            // prevent a repeated display of the error dialog.
            try
            {
