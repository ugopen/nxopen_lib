...
{  
    ...
    UF_MODL_MSWP_LIMIT_OFFSET_FROM_SELECTED /*OFFSET_FROM_SELECTED limit*/
...
{ 
    ...
    int end_limit_from_start;/* For value from start limit only */
};
