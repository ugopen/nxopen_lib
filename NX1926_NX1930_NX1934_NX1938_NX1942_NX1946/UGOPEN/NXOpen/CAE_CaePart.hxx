    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaePart : public NXOpen::BasePart
        {
            ...
            {
                FieldApplicationTypeSignalProcessing/** Application which allows to specify additional attributes (e.g. acoustical weighting) on a field */,
                FieldApplicationTypeAbaqus/** Application which allows to specify additional Abaqus-specific attributes on a field */
            };
