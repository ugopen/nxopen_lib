    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  HolePackageBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the type 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_get_hole_size instead. <br>  

             <br>  Created in NX5.0.2.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_get_hole_size instead.") NXOpen::Features::HolePackageBuilder::Types Type
            (
            );
            /**Sets  the type 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_set_hole_size instead. <br>  

             <br>  Created in NX5.0.2.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_set_hole_size instead.") void SetType
            (
            ...
            /**Returns  the hole form - this is applicable for general hole 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_get_hole_type instead. <br>  

             <br>  Created in NX5.0.2.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_get_hole_type instead.") NXOpen::Features::HolePackageBuilder::HoleForms GeneralHoleForm
            (
            );
            /**Sets  the hole form - this is applicable for general hole 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_set_hole_type instead. <br>  

             <br>  Created in NX5.0.2.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_set_hole_type instead.") void SetGeneralHoleForm
            (
            ...
            /**Returns  the hole form - this is applicable for screw clearance hole 
             ...
             <br>  Created in NX5.0.2.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_get_hole_type instead.") NXOpen::Features::HolePackageBuilder::HoleForms ScrewClearanceHoleForm
            (
            );
            /**Sets  the hole form - this is applicable for screw clearance hole 
             ...
             <br>  Created in NX5.0.2.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use JA_HOLE_PACKAGE_BUILDER_set_hole_type instead.") void SetScrewClearanceHoleForm
            (
                NXOpen::Features::HolePackageBuilder::HoleForms holeForm /** holeform */ 
            );
            ...
            /**Returns  the hole type 
             ...
             <br> License requirements : None */
            public: NXOpen::Features::HolePackageBuilder::Holetype HoleType
            (
            );
            /**Sets  the hole type 
             <br>  Created in NX1926.0.0.  <br>  
            ...
            /**Returns  the hole size 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::HolePackageBuilder::Holesize HoleSize
            (
            );
            /**Sets  the hole size 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetHoleSize
            (
