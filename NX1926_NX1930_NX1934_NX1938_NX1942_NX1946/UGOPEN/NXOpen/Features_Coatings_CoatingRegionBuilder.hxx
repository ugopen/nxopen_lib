...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Coatings
        {
            ...
            /**
                     * Defines a builder for creating @link Features::Coatings::CoatingRegion Features::Coatings::CoatingRegion@endlink  objects,
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  CoatingRegionBuilder : public NXOpen::Features::FeatureBuilder
            {
