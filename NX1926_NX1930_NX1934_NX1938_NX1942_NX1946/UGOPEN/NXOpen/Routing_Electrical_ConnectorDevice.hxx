            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ConnectorDevice : public NXOpen::Routing::SingleDevice
            {
                ...
                /** Searches for a placement port for the connector device. The placement
                 ...
                 <br>  @deprecated Deprecated in NX1926.0.0.  Use @link Routing::Electrical::ConnectorDevice::FindPlacementPort Routing::Electrical::ConnectorDevice::FindPlacementPort@endlink  instead. <br>  

                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use Routing::Electrical::ConnectorDevice::FindPlacementPort instead.") NXOpen::Routing::Port * FindPlacer
                (
