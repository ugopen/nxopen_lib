        ...
        */
        class NXOPENCPP_CAEEXPORT  AutoPairsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the geometry selection 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link DisplayableobjectSelection DisplayableobjectSelection@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use DisplayableobjectSelection instead.") NXOpen::CAE::SelectCAEFaceList * GeometrySelection
            (
            );
