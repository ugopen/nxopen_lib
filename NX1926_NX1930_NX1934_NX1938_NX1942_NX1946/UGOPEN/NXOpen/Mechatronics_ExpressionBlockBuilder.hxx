...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /**  @brief  Represents a @link NXOpen::Mechatronics::ExpressionBlockBuilder NXOpen::Mechatronics::ExpressionBlockBuilder@endlink  builder.  
                 ...
                 ExpressionBlockBuilder is used to maintain the @link NXOpen::Mechatronics::ExpressionBlockObject NXOpen::Mechatronics::ExpressionBlockObject@endlink  
                          which is used store related expressions that work for same task. 
                
             <br> To create a new instance of this class, use @link NXOpen::Mechatronics::ExpressionBlockCollection::CreateExpressionBlockBuilder  NXOpen::Mechatronics::ExpressionBlockCollection::CreateExpressionBlockBuilder @endlink  <br> 
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ExpressionBlockBuilder : public NXOpen::Builder
        {
            ...
            /**  @brief  Gets all Slots.  
             ...
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link Mechatronics::ExpressionBlockBuilder::GetSlotsV2 Mechatronics::ExpressionBlockBuilder::GetSlotsV2@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use Mechatronics::ExpressionBlockBuilder::GetSlotsV2 instead.") std::vector<NXOpen::Mechatronics::ExpressionBlockBuilder::Slot> GetSlots
            (
            );
            /**  @brief  Sets all Slots.  

              
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link Mechatronics::ExpressionBlockBuilder::SetSlotsV2 Mechatronics::ExpressionBlockBuilder::SetSlotsV2@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use Mechatronics::ExpressionBlockBuilder::SetSlotsV2 instead.") void SetSlots
            (
            ...
            /**  @brief  Gets all Slots.  
             ...
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: std::vector<NXOpen::Mechatronics::ExpressionBlockBuilder::SlotV2> GetSlotsV2
            (
            );
            /**  @brief  Sets all Slots.  
