            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ClosedCornerBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                */
                ...
                /**Sets  the closure type. This is only for legacy feature support, for new features use @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType   NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType  @endlink and @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::SetOverlapType   NXOpen::Features::SheetMetal::ClosedCornerBuilder::SetOverlapType  @endlink  
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the closure type. This is only for legacy feature support, for new features use @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType   NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType  @endlink and @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::SetOverlapType   NXOpen::Features::SheetMetal::ClosedCornerBuilder::SetOverlapType  @endlink  
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
