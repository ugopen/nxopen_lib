...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX1899.0.0.  Please use NXOpen::Mechatronics::SignalMappingConnectionBuilder instead.") NXOPENCPP_MECHATRONICSEXPORT  SHMSignalConnectionBuilderList : public NXOpen::TaggedObject
        {
            ...
            /** Returns the object at the input index.  May be NULL.
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Please use NXOpen::Mechatronics::SignalMappingConnectionBuilder instead.") NXOpen::Mechatronics::SHMSignalConnectionBuilder * FindItem
            (
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Please use NXOpen::Mechatronics::SignalMappingConnectionBuilder instead.") std::vector<NXOpen::Mechatronics::SHMSignalConnectionBuilder *> GetContents
            (
            );
