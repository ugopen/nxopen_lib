        ...
        */
        class NXOPENCPP_CAEEXPORT  FEModelOccurrence : public NXOpen::CAE::IFEModel, public virtual NXOpen::CAE::IHierarchicalFEModel, public virtual NXOpen::CAE::IPostScenarioDataSource
        {
            ...
            /** Returns node, element, csys, physical, group, and ply offset of the femodel occurrence 
             ...
             <br>  @deprecated Deprecated in NX1899.0.0.  Use @link NXOpen::CAE::FEModelOccurrence::GetCaeOccEntityLabelOffsets NXOpen::CAE::FEModelOccurrence::GetCaeOccEntityLabelOffsets@endlink instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::CAE::FEModelOccurrence::GetCaeOccEntityLabelOffsetsinstead.") void GetOccEntityLabelOffsets
            (
            ...
            /** Sets node, element, csys, physical, group, and ply offset of the femodel occurrence 
             ...
             <br>  @deprecated Deprecated in NX1899.0.0.  Use @link NXOpen::CAE::FEModelOccurrence::SetCaeOccEntityLabelOffsets NXOpen::CAE::FEModelOccurrence::SetCaeOccEntityLabelOffsets@endlink instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::CAE::FEModelOccurrence::SetCaeOccEntityLabelOffsetsinstead.") void SetOccEntityLabelOffsets
            (
                int nodeOffset /** node offset */,
                int elemOffset /** element offset */,
                int csysOffset /** csys offset */,
