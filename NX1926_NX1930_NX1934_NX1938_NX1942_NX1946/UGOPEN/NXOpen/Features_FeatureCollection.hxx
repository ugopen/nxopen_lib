    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Creates a new empty design group after a specified referece feature  @return  The new created design group 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : usr_defined_features ("USER DEFINED FEATURES") */
            ...
            */
            ...
            /** Returns the CoatingsCollection instance belonging to this part 
             <br>  Created in NX1926.0.0.  <br>  
            */
