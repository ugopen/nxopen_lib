...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        DampingValue.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        FirstCustomizedMaterial.Density.Value </term> <description> 
         
        7.8e-6 (millimeters part), 7.3e-4 (inches part) </description> </item> 

        <item><term> 
         
        FirstCustomizedMaterial.PoissonRatio.Value </term> <description> 
         
        0.3 </description> </item> 

        <item><term> 
         
        FirstCustomizedMaterial.YoungModulus.Value </term> <description> 
         
        2e+8 (millimeters part), 2.9e+7 (inches part) </description> </item> 

        <item><term> 
         
        FrictionCoefficientOption </term> <description> 
         
        Expression </description> </item> 

        <item><term> 
         
        FrictionCoefficientValue.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        RestitutionCoefficient.Value </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        StiffnessValue.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        TransitionVelocity.Value </term> <description> 
