...
namespace NXOpen
{
    ...
    namespace Coatings
    {
        ...
        /**
             * Defines a builder for creating @link Coatings::CoatingStack Coatings::CoatingStack@endlink  objects, which are
        ...
        */
        class NXOPENCPP_COATINGSEXPORT  CoatingStackBuilder : public NXOpen::Builder
        {
