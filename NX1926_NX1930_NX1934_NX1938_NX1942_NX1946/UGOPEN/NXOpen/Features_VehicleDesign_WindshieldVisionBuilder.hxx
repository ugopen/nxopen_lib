        ...
        namespace VehicleDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  WindshieldVisionBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /** Represents options of the VehicleOverall type belong to the FMVSS Standard */
                public: enum EnumWsVehicleOverall
                {
                    EnumWsVehicleOverallOW1520Mm/** Represents calculating the eye_point by vehicleOverall less than 1520mm */,
                    EnumWsVehicleOverallOW1520Mm1630Mm/** Represents calculating the eye_point by vehicleOverall between 1520mm and 1630mm */,
                    EnumWsVehicleOverallOW1630Mm1730Mm/** Represents calculating the eye_point by vehicleOverall between 1630mm and 1730mm */,
                    EnumWsVehicleOverallOW1730Mm/** Represents calculating the eye_point by vehicleOverall more than 1730mm */
                };
                ...
                public: enum EnumWsPatternType
                {
                    ...
                    EnumWsPatternTypeSingleArm/** Represents the Wipe Method is SingleArm*/
                };
                ...
                /**Returns  the @link NXOpen::Features::VehicleDesign::WindshieldVisionBuilder::EnumWsVehicleClassification NXOpen::Features::VehicleDesign::WindshieldVisionBuilder::EnumWsVehicleClassification@endlink  for the
                                VehicleClassification indicates the method to calculate the eye_point. 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the @link NXOpen::Features::VehicleDesign::WindshieldVisionBuilder::EnumWsVehicleOverall NXOpen::Features::VehicleDesign::WindshieldVisionBuilder::EnumWsVehicleOverall@endlink  for the
                                VehicleOverall indicates the method to calculate the eye_point. 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the select Seating Refering Point 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Point * Sgrp
                (
                );
                /**Sets  the select Seating Refering Point 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetSgrp
                (
