        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  PartFlexiblePrintedCircuitDesign
        {
            ...
            */
            ...
            /// \cond NX_NO_DOC 
            /** Sets the toggle for multi height 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
            public: void SetMultiHeightToggle
            (
                bool multiHeightToggleValue /** toggle value */
            );

            /// \endcond 

            /// \cond NX_NO_DOC 
            /** Gets the toggle for multi height  @return  toggle value 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
            public: bool GetMultiHeightToggle
            (
            );
            ...
            /// \cond NX_NO_DOC 
            /** Sets the layer scheme for multi height 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
            public: void SetMultiHeightLayerScheme
            (
            ...
            /** Sets the layer scheme for multi height 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
            void SetMultiHeightLayerScheme
            (
                bool updateModel /** Whether to update the model or not */,
            ...
            /// \cond NX_NO_DOC 
            /** Gets the layer scheme for multi height  @return  Name of layer scheme 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
            public: NXString GetMultiHeightLayerScheme
            (
            );
            ...
            /// \cond NX_NO_DOC 
            /** Reloads the layer scheme table 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
            public: void ReloadLayerSchemeFile
            (
            );
