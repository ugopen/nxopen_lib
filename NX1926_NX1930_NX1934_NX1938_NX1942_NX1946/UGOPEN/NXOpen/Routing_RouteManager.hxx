    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RouteManager
        {
            ...
            /** Creates a  @link NXOpen::Routing::SimplifyPathBuilder NXOpen::Routing::SimplifyPathBuilder@endlink  that combines the
                        collinear segments by merging RCPs in NextGen and NextGenRouting for Assemblies environment.  @return  
             <br>  @deprecated Deprecated in NX1899.0.0.  Use @link NXOpen::RoutingCommon::BuilderFactory::CreateSimplifyCurvesBuilder NXOpen::RoutingCommon::BuilderFactory::CreateSimplifyCurvesBuilder@endlink  instead <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::RoutingCommon::BuilderFactory::CreateSimplifyCurvesBuilder instead") NXOpen::Routing::SimplifyPathBuilder * CreateNextGenSimplifyPathBuilder
            (
            ...
            /** Creates a Adoption builder.  See the documentation in the
                        @link NXOpen::Routing::AdoptionBuilder NXOpen::Routing::AdoptionBuilder@endlink  class for a description of the builder.  
            ...
            /** Creates a @link NXOpen::Routing::PortArrayListItemBuilder NXOpen::Routing::PortArrayListItemBuilder@endlink  
                    This class allows to specify the pattern feature, select the inital position and select the starting pattern instance for creating 
            ...
            /** Creates a AdoptionToNGBVR builder.  See the documentation in the
                        @link NXOpen::Routing::AdoptionToNGBVRBuilder NXOpen::Routing::AdoptionToNGBVRBuilder@endlink  class for a description of the builder.  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::AdoptionToNGBVRBuilder * CreateAdoptionToNGBVRBuilder
            (
            );
            /**
