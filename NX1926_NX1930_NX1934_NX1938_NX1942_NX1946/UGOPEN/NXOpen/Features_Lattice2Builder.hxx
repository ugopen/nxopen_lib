        ...
        */
        class NXOPENCPP_FEATURESEXPORT  Lattice2Builder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns   @brief whether to exclude nodes near boundary or base faces from randomization.  
                        ...
                        Determines whether to fix the graph vertices on the boundary bodies or base faces and gradually increase the randomization to @link Features::Lattice2Builder::MaxDeviation Features::Lattice2Builder::MaxDeviation @endlink and @link Features::Lattice2Builder::SetMaxDeviation Features::Lattice2Builder::SetMaxDeviation @endlink 
                        and when property @link Features::Lattice2Builder::IsRandom Features::Lattice2Builder::IsRandom @endlink and @link Features::Lattice2Builder::SetRandom Features::Lattice2Builder::SetRandom @endlink  is set.
            ...
            /**Returns  the diameter of the spheres created for the vertices of each graph edge
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns   @brief the tessellation factor of the lattice creation. 
                        ...
                        will determined by 
                        (@link Features::Lattice2Builder::TessellationFactor Features::Lattice2Builder::TessellationFactor @endlink and @link Features::Lattice2Builder::SetTessellationFactor Features::Lattice2Builder::SetTessellationFactor @endlink ) X (@link Features::Lattice2Builder::RodDiameter Features::Lattice2Builder::RodDiameter@endlink )  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
