...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        ...
        {
            /** Clone property options */
            public: enum CloneOption
            {
                CloneOptionClone/** Copy parameters and attachments */,
                CloneOptionMirror/** Copy parameters only */
            };
            ...
            /// \cond NX_NO_DOC 
            /** Clones definition of the source into the builder 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void CloneDefinition
            (
                NXOpen::Motion::MotionObject * tagSource /** tagsource */ ,
                NXOpen::Motion::EntityPropTableBuilder::CloneOption cloneOption /** cloneoption */ 
            );
