        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  CustomManager
        {
            ...
            public: /** This defines the prototype for a plugin that will 
                        ...
                        for creating new stock part during Adoption. 
            ...
            (
                const NXOpen::Routing::CustomManager::ComponentNamePlugin&  wiringComponentNamePlugin /** The method you want Routing to call to get the wiring component name. */
            );
            ...
            /** Sets the plugin Routing will call to get the name for stock 
                         while creating new stock part during adoption process.
                         Will throw an error if one is already registered.
