        ...
        */
        class NXOPENCPP_CAEEXPORT  AttributeSelectionRecipe : public NXOpen::CAE::SelectionRecipe
        {
            ...
            /**Returns  the presence of the name attribute. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipeAttributeStrategy::HasNameAttribute CAE::SelRecipeAttributeStrategy::HasNameAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetHasNameAttribute CAE::SelRecipeAttributeStrategy::SetHasNameAttribute @endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipeAttributeStrategy::HasNameAttribute CAE::SelRecipeAttributeStrategy::HasNameAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetHasNameAttribute CAE::SelRecipeAttributeStrategy::SetHasNameAttribute @endlink  instead.") bool HasNameAttribute
            (
            );
            /**Returns  the name attribute. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipeAttributeStrategy::NameAttribute CAE::SelRecipeAttributeStrategy::NameAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetNameAttribute CAE::SelRecipeAttributeStrategy::SetNameAttribute @endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipeAttributeStrategy::NameAttribute CAE::SelRecipeAttributeStrategy::NameAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetNameAttribute CAE::SelRecipeAttributeStrategy::SetNameAttribute @endlink  instead.") NXString NameAttribute
            (
            );
            ...
            /**Returns  the presence of the color attribute. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipeAttributeStrategy::HasColorAttribute CAE::SelRecipeAttributeStrategy::HasColorAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetHasColorAttribute CAE::SelRecipeAttributeStrategy::SetHasColorAttribute @endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipeAttributeStrategy::HasColorAttribute CAE::SelRecipeAttributeStrategy::HasColorAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetHasColorAttribute CAE::SelRecipeAttributeStrategy::SetHasColorAttribute @endlink  instead.") bool HasColorAttribute
            (
            );
            /**Returns  the color attribute. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipeAttributeStrategy::ColorAttribute CAE::SelRecipeAttributeStrategy::ColorAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetColorAttribute CAE::SelRecipeAttributeStrategy::SetColorAttribute @endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipeAttributeStrategy::ColorAttribute CAE::SelRecipeAttributeStrategy::ColorAttribute @endlink and @link CAE::SelRecipeAttributeStrategy::SetColorAttribute CAE::SelRecipeAttributeStrategy::SetColorAttribute @endlink  instead.") int ColorAttribute
            (
            );
