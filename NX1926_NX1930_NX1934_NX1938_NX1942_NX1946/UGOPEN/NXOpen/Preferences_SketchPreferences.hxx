        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SketchPreferences
        {
            ...
            /**Returns  the setting that controls whether or not the dimension text size should be fixed. 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Preferences::SketchPreferences::TextSizeMode NXOpen::Preferences::SketchPreferences::TextSizeMode @endlink and @link NXOpen::Preferences::SketchPreferences::SetTextSizeMode NXOpen::Preferences::SketchPreferences::SetTextSizeMode @endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Preferences::SketchPreferences::TextSizeMode NXOpen::Preferences::SketchPreferences::TextSizeMode @endlink and @link NXOpen::Preferences::SketchPreferences::SetTextSizeMode NXOpen::Preferences::SketchPreferences::SetTextSizeMode @endlink  instead.") bool TextSizeFixed
            (
            );
