    ...
    */
    class NXOPENCPPEXPORT  Sketch : public NXOpen::DisplayableObject, public virtual NXOpen::IProfile
    {
        ...
        /** Sets the text height of all dimensions in the given sketch.
                 ...
                 Note that the height can only be changed when @link NXOpen::Preferences::SketchPreferences::TextSizeMode NXOpen::Preferences::SketchPreferences::TextSizeMode @endlink and @link NXOpen::Preferences::SketchPreferences::SetTextSizeMode NXOpen::Preferences::SketchPreferences::SetTextSizeMode @endlink 
