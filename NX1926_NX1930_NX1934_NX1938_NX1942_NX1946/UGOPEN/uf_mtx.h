...
Contrary to most conventions, arrays in NX are represented
as columns rather than rows. So a 4X4 matrix looks like:

            (Xx      Yx      Zx      0)
            (Xy      Yy      Zy      0)
            (Xz      Yz      Zz      0)
            (TRANSx  TRANSy  TRANSz  scale)

The first three values in the fourth row are the translations.
The fourth column is the perspective data and is not used in NX.
