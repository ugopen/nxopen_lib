...
-------------------------------------------------------------------------------
        Demonstration example for custom feature Composite Curve UI.
-------------------------------------------------------------------------------
...
-----------------------
    ...
    3. Launch the dialog by executing CompositeCurveUI.py through Tools->Journal->Play Menu.
	...
	8. Editing feature will launch the same dialog populated by using edited feature.
