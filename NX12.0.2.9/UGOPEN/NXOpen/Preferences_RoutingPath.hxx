        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  RoutingPath
        {
            ...
            /** Query default bend table. Used when default corner uses bend table method  @return  
             <br>  @deprecated Deprecated in NX12.0.1.  Use @link RoutingPath::GetBendRadiusTable RoutingPath::GetBendRadiusTable@endlink  instead.  <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Use RoutingPath::GetBendRadiusTable instead. ") NXString GetBendTable
            (
            );
            /** 
             <br>  @deprecated Deprecated in NX12.0.1.  Use @link RoutingPath::SetBendRadiusTable RoutingPath::SetBendRadiusTable@endlink  instead.  <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Use RoutingPath::SetBendRadiusTable instead. ") void SetBendTable
            (
                const NXString & bendTableName /** bend table name */ 
            );
            /** 
             <br>  @deprecated Deprecated in NX12.0.1.  Use @link RoutingPath::SetBendRadiusTable RoutingPath::SetBendRadiusTable@endlink  instead.  <br>  
            ...
            void SetBendTable
            (
                const char * bendTableName /** bend table name */ 
            );
            /** Query loaded bend table names. A bend table maps a stock outer diameter to a
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Use RoutingPath::GetBendRadiusTable instead. ") std::vector<NXString> GetBendTables
            (
            );
            /** Query loaded bend table filenames. A bend table file can contain one or more named
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Use RoutingPath::GetBendRadiusTable instead. ") std::vector<NXString> GetBendTableFilenames
            (
            );
            /** Load a specified bend table file.  @return  Descriptive error text, when appropriate 
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Use RoutingPath::SetBendRadiusTable instead. ") NXString LoadBendTableFile
            (
                const NXString & bendTableFilename /** bend table filename */ 
            );
            /** Load a specified bend table file.  @return  Descriptive error text, when appropriate 
             <br>  @deprecated Deprecated in NX12.0.1.  Use @link RoutingPath::SetBendRadiusTable RoutingPath::SetBendRadiusTable@endlink  instead.  <br>  
            ...
            (
                const char * bendTableFilename /** bend table filename */ 
            );
            /** Query bend radius from a loaded bend table. Returns a radius of -1 if input table is not
                        loaded  @return  
             <br>  @deprecated Deprecated in NX12.0.1.  Use @link RoutingPath::GetBendRadiusTableDataForStock RoutingPath::GetBendRadiusTableDataForStock@endlink  instead.  <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Use RoutingPath::GetBendRadiusTableDataForStock instead. ") double GetBendTableRadius
            (
                const NXString & bendTableName /** bend table name */ ,
