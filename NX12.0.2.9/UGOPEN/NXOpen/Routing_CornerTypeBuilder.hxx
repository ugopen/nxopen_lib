        ...
        class NXOPENCPP_ROUTINGEXPORT  CornerTypeBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            */
            ...
            /** Import bend radius table 
             <br>  @deprecated Deprecated in NX12.0.2.  The bend radius table is now controlled by a customer default. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.2.  The bend radius table is now controlled by a customer default.") void RouteCornerImportBendRadiusTable
            (
            );
            /** Bend corner info 
             <br>  Created in NX6.0.0.  <br>  
            ...
            /**Returns  the name of bend radius table
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.2.  The bend radius table is now controlled by a customer default.") NXString RouteCornerBendTable
            (
            );
            /**Sets  the name of bend radius table
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.2.  The bend radius table is now controlled by a customer default.") void SetRouteCornerBendTable
            (
            ...
            /** Imports bend radius table 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX12.0.2.  The bend radius table is now controlled by a customer default.") void ImportBendRadiusTable
            (
