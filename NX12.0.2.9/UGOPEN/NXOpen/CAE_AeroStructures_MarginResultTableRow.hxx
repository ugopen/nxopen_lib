        ...
        namespace AeroStructures
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  MarginResultTableRow : public NXOpen::TransientObject
            {
                ...
                /** Get the value of an integer input parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the value of a scalar input parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the value of a string input parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the value of a boolean input parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the value of an integer output parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the value of a scalar output parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the unit of a scalar output parameter for this row  @return  the unit of the value returned by @link CAE::AeroStructures::MarginResultTableRow::GetOutputScalarValue CAE::AeroStructures::MarginResultTableRow::GetOutputScalarValue@endlink 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the value of a string output parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
                ...
                /** Get the value of a boolean output parameter for this row  @return  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
