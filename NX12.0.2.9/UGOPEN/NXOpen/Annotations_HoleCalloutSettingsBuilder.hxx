    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  HoleCalloutSettingsBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /** Reorder the parameters based on the input. This function only works if all input parameters exist in the builder and all builder parameters exist in the input. @return  
             <br>  Created in NX9.0.0.  <br>  
            ...
            /** Gets the parameter string representation of the nth hole feature parameter of feature type.
                    ...
                    a string representation. This API will return that string representation instead of an empty string. @return  
            ...
            /** Get Through Hole Text String. @return  
