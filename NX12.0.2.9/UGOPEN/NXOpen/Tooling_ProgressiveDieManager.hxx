    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ProgressiveDieManager
        {
            ...
            /** Creates a @link NXOpen::Tooling::SplitInsertBuilder NXOpen::Tooling::SplitInsertBuilder@endlink   @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Tooling::SplitInsertBuilder * CreateSplitInsertBuilder
            (
            );
            /** Creates a @link NXOpen::Tooling::ConceptDieBaseBuilder NXOpen::Tooling::ConceptDieBaseBuilder@endlink   @return  
