        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PaintParametersBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the target components that contain the target features. 
                        If @link NXOpen::Features::PaintParametersBuilder::TargetComponentSelection NXOpen::Features::PaintParametersBuilder::TargetComponentSelection @endlink and @link NXOpen::Features::PaintParametersBuilder::SetTargetComponentSelection NXOpen::Features::PaintParametersBuilder::SetTargetComponentSelection @endlink 
