    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  SmartSaveObject : public NXOpen::NXObject
        {
            ...
            /** Returns the modification reason for this smart save object. This reason is used to calculate valid and current operation/s to be performed.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXString GetModificationReason
            (
            );
            /** Returns the state of object in Teamcenter. An object state is considered frozen if the released status on this object marks it to be final.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsFrozenByStatus
            (
            );
            /** Returns if this object is modifiable by the current user.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsModifiable
            (
            );
            /** This is applicable only for 4G components. Returns if the current user can add new components to the Product.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool HasAddContentPrivilege
            (
            );
            /** This is applicable only for 4G components. Returns if the current user can remove components to the Product.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool HasRemoveContentPrivilege
            (
            );
            /** Returns if this part is a non-master. For non-part objects this will return false.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsNonMaster
            (
            );
            /** Returns if the object is major revisable in Teamcenter.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsMajorRevisable
            (
            );
            /** Returns if the object being saved has status applied in Teamcenter.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsReleased
            (
            );
            /** Returns if the object is currently checkedout by another user.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsCheckedOutByAnotherUser
            (
            );
            /** Returns if the object being saved need to be explicitly checked out.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsExplicitCheckOutNeeded
            (
            );
            /** Returns if this object is currently being shown on the save dialog.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            ...
            /** Returns the current operation type @link NXOpen::PDM::SmartSaveObject::OperationType NXOpen::PDM::SmartSaveObject::OperationType@endlink  for this smart save object.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            ...
            /** Returns the valid operation types (array of @link NXOpen::PDM::SmartSaveObject::OperationType NXOpen::PDM::SmartSaveObject::OperationType@endlink ) for this object.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::PDM::SmartSaveObject::OperationType> GetValidOperationTypes
            (
            );
            /** Returns the Teamcenter object type for this object.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            ...
            /** Returns the current effectivity formula for this object.  @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
