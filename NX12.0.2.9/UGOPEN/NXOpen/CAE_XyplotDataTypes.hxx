    ...
    namespace CAE
    {
        namespace Xyplot
        {
            ...
            enum GraphStyle
            {
                ...
                GraphStylePlate/** Deprecated in NX12.0 */,
            ...
            /** Represents the unit system 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::XyFunctionUnitSystem NXOpen::CAE::XyFunctionUnitSystem@endlink  <br>  
            */
            enum NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::XyFunctionUnitSystem") UnitSystem
            {
            ...
            enum ModelType
            {
                ...
                ModelTypeUnknownResult/** the label and color block to represent result value beyond color range on @link CAE::Xyplot::PlotTypePlotColorBar CAE::Xyplot::PlotTypePlotColorBar@endlink  and @link CAE::Xyplot::PlotTypePlotColorMap CAE::Xyplot::PlotTypePlotColorMap@endlink  */,
