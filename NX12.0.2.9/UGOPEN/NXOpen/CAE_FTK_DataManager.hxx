            ...
            */
            class NXOPENCPP_CAEEXPORT  DataManager
            {
                ...
                /** Creates array unit by xy function unit  @return  Array unit 
                 <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::CAE::FTK::DataManager::CreateArrayUnit NXOpen::CAE::FTK::DataManager::CreateArrayUnit@endlink  instead. <br>  

                 <br>  Created in NX7.5.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::CAE::FTK::DataManager::CreateArrayUnit instead.") NXOpen::CAE::FTK::BaseUnit * CreateArrayUnit
                (
                ...
                public: NXOpen::CAE::FTK::BaseUnit * CreateArrayUnit
                (
                    NXOpen::Unit * nxUnit /** NX unit */,
                    const NXString & aliasMeasureName /** alias measure name */
                );
                /**  @brief  Creates array unit by NX unit with new alias measure type name. 
                ...
                (
                    NXOpen::Unit * nxUnit /** NX unit */,
                    const char * aliasMeasureName /** alias measure name */
                );
                /** Creates unitless unit @return  Array unit 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
