...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        namespace ProductInterface
        {
            ...
            /** Represents a Product Interface Object Builder. It creates a set of product interface objects  <br> To create a new instance of this class, use @link NXOpen::Assemblies::ProductInterface::Collection::CreateObjectBuilderWithVersion  NXOpen::Assemblies::ProductInterface::Collection::CreateObjectBuilderWithVersion @endlink  <br> 
            Default values.
            <table border="1"> 
