    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  OpticalConnectionSettingsBuilder : public NXOpen::Builder
        {
            ...
            /** Fiber core diameter property of a given optical connection sub-type.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Fiber cladding diameter property of a given optical connection sub-type.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Style color code property of a given optical connection sub-type.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Style font property of a given optical connection sub-type.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Style width property of a given optical connection sub-type.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
