    ...
    namespace PID
    {
        ...
        */
        class PIDOPENCPPEXPORT  NativePipeBuilder
        {
            ...
            /** Gets the line type of the pipe.  @return  
             <br>  Created in NX12.0.1.  <br>  
            ...
            /** Gets the owning sheet of this pipe.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Gets new connection after inserting the start Tee in native.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Gets new connection after inserting the end Tee in native.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Gets the start Tee in native.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Gets the end Tee in native.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
