        ...
        */
        class ANIMATIONDESIGNEROPENCPPEXPORT  AnimationDesignerManager
        {
            ...
            */
            ...
            /** Creates the preferences builder for Animation Designer.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            ...
            /** Creates the solution for Animation Designer.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            ...
            /** Gets the active solution for Animation Designer.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            ...
            /// \endcond 
            /** Creates a @link AnimationDesigner::ConstraintConversionBuilder AnimationDesigner::ConstraintConversionBuilder@endlink   @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
