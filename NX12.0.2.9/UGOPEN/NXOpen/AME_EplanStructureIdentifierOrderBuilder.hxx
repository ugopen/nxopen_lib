    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  EplanStructureIdentifierOrderBuilder : public NXOpen::Builder
        {
            ...
            /** The structure order index for function  @return  
             <br>  Created in NX12.0.0.  <br>  
            ...
            /** The structure order index for location  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** The structure order index for functional assignment  @return  
            ...
            /** The structure order index for installation site  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
