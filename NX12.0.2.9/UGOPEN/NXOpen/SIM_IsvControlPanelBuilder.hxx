    ...
    namespace SIM
    {
        ...
        */
        class NXOPENCPP_SIMEXPORT  IsvControlPanelBuilder : public NXOpen::Builder
        {
            ...
            /** Gets the single step in Tool Path Based Simulation @return  
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Gets the single step mode in Machine Code Simulation @return  
            ...
            /** Return the Machining Time Analysis Clock for the specified channel.  @return  
            ...
            /** Return the number of Details of the specified type  @return  
            ...
            /** Return the Details Information to a specified type  @return  
            ...
            /**  @brief 
                        ...
                        To shut down the vnck-machine manually, @link NXOpen::SIM::IsvControlPanelBuilder::MachineControlShutdownVnck() NXOpen::SIM::IsvControlPanelBuilder::MachineControlShutdownVnck()@endlink  can be invoked.
            ...
            /** Returns a program currently used in the simulation  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
