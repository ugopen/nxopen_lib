        ...
        */
        class NXOPENCPP_MECHANICALROUTINGEXPORT  RoutingManager
        {
            ...
            */
            ...
            /**  Returns a @link NXOpen::MechanicalRouting::InsulationService NXOpen::MechanicalRouting::InsulationService@endlink  object.  Use this object
                         for specific Routing Mechanical Insulation service
                    
             <br>  Created in NX11.0.0.  <br>  
            */
            public: NXOpen::MechanicalRouting::InsulationService *InsulationService();
