    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  SymbolAuthoringBuilder : public NXOpen::Builder
        {
            ...
            /** Creates a new connection point  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::NXObject * CreateConnectionPoint
            (
                NXOpen::NXObject * portToBeMapped /** porttobemapped */ 
            );
            /** Gets the connection point location  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::Point2d GetConnectionPointLocation
            (
                NXOpen::NXObject * libPort /** libport */ 
            );
            /** Sets the connection point location  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::Point2d SetConnectionPointLocation
            (
                NXOpen::NXObject * libPort /** libport */ 
            );
            /** Gets the connection direction  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Sets the connection direction  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::Point2d SetConnectionDirection
            (
                NXOpen::NXObject * libPort /** libport */ 
            );
