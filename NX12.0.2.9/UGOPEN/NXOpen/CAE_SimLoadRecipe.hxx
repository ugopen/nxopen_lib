        ...
        */
        class NXOPENCPP_CAEEXPORT  SimLoadRecipe : public NXOpen::TaggedObject, public virtual NXOpen::CAE::IPostScenarioDataSource
        {
            ...
            /** Overload to specify a component of the FEM assembly for which to autofill the mapping tables. 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::SimLoadRecipe::Autofill NXOpen::CAE::SimLoadRecipe::Autofill@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::SimLoadRecipe::Autofill instead.") void Autofill
            (
