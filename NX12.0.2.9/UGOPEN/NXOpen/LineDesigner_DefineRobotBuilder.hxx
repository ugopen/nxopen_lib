...
namespace NXOpen
{
    ...
    namespace LineDesigner
    {
        ...
        BaseFrameReversePropagation </td> <td> 
        ...
        */
        class LINEDESIGNEROPENCPPEXPORT  DefineRobotBuilder : public NXOpen::Builder
        {
            ...
            /** The tool frame connector propagated expressions  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            ...
            /**  The base frame compatible connector types are returns  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            ...
            /** The base frame connector propagated expressions  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
