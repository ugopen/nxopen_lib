...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Connections
        {
            ...
            class SeamWeldImpl;
            /**  Seam Weld connection. Use this interface to set/get properties and parameters of the spot weld connection.   <br> To obtain an instance of this object use the connection creators on the @link CAE::Connections::Folder CAE::Connections::Folder@endlink   <br> 
             <br>  Created in NX12.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  SeamWeld : public NXOpen::CAE::Connections::IConnection, public virtual NXOpen::CAE::Connections::IMaterial, public virtual NXOpen::CAE::Connections::ITolerance, public virtual NXOpen::CAE::Connections::IHeight, public virtual NXOpen::CAE::Connections::IFlangesContainer, public virtual NXOpen::CAE::Connections::ILocationsContainer, public virtual NXOpen::CAE::Connections::ILineOffset, public virtual NXOpen::CAE::Connections::ILineDiscretization, public virtual NXOpen::CAE::Connections::IWidth, public virtual NXOpen::CAE::Connections::ILocationsWithDiscretizationContainer
            {
