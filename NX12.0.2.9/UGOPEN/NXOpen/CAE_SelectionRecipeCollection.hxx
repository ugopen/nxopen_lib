    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SelectionRecipeCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            public: NXOpen::CAE::BoundingVolumeSelectionRecipe * CreateBoxBoundingVolumeRecipe
            (
            ...
            /** Create a Bounding Volume Selection Recipe @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::BoundingVolumeSelectionRecipe * CreateCylinderBoundingVolumeRecipe
            (
                const NXString & name /** Name of the selection recipe. If NULL, then a valid unique name will be generated. */,
                NXOpen::CoordinateSystem * centerCsys /** centercsys */ ,
            ...
            /** Create a Bounding Volume Selection Recipe @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::BoundingVolumeSelectionRecipe * CreateSphereBoundingVolumeRecipe
            (
                const NXString & name /** Name of the selection recipe. If NULL, then a valid unique name will be generated. */,
                NXOpen::Point * centerPoint /** centerpoint */ ,
                NXOpen::Expression * diameter /** diameter */ ,
            ...
            /** Creates a Single Node Label Selection Recipe  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SingleLabelSelectionRecipe * CreateSingleLabelRecipe
            (
                const NXString & name /** Name of the selection recipe. If NULL, then a valid unique name will be generated. */,
            ...
            /** Creates a Label Range Selection Recipe  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::LabelRangeSelectionRecipe * CreateLabelRangeRecipe
            (
                const NXString & name /** Name of the selection recipe. If NULL, then a valid unique name will be generated. */,
            ...
            /** Creates a Coordinate based Single Node Selection Recipe  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::CoordinateSelectionRecipe * CreateCoordinateRecipe
            (
                const NXString & name /** Name of the selection recipe. If NULL, then a valid unique name will be generated. */,
            ...
            /** Creates a Point based Single Node Selection Recipe  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::PointSelectionRecipe * CreatePointRecipe
            (
                const NXString & name /** Name of the selection recipe. If NULL, then a valid unique name will be generated. */,
            ...
            /** Creates an Attribute based Selection Recipe  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::AttributeSelectionRecipe * CreateAttributeRecipe
            (
                const NXString & name /** Name of the selection recipe. If NULL, then a valid unique name will be generated. */,
            ...
            /** Copies a Selection Recipe with all attributes and add it to the collection.
                        This method gives proper unique name to the created Selection Recipe.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
