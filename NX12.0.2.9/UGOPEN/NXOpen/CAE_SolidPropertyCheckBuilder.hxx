    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SolidPropertyCheckBuilder : public NXOpen::Builder
        {
            ...
            /** The center of gravity moment of inertia  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** The global moment of inertia  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** The reference csys moment of inertia  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** The principal moment of inertia  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
