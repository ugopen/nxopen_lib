    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  AddComponentBuilder : public NXOpen::Builder, public virtual NXOpen::IAttributeSourceObjectBuilder
        {
            ...
            /** Gets the number of components to be added. @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: int GetCount
            (
            ...
            /** Get the initial location type during add component. @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Gets the scatter option for added components. @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Gets the keep constraints option for added components. @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Returns the component anchor used for adding component @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Returns add component operation failures  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Get the CAM component type during add component. @return  
