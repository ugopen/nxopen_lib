        ...
        namespace FTK
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  AfuFileManager
            {
                ...
                /** Gets all loaded AFU files  @return  
                 <br>  Created in NX12.0.1.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXString> GetLoadedFiles
                (
                );
                /** Gets all record names in an AFU file which must be loaded  @return  
                 <br>  Created in NX12.0.1.  <br>  
                 <br> License requirements : None */
                ...
                /** Gets an AFU record in an AFU file which must be loaded  @return  
                 <br>  Created in NX12.0.1.  <br>  
                 <br> License requirements : None */
