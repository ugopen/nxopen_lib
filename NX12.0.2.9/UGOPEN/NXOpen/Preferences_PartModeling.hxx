        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  PartModeling
        {
            ...
            /** Returns whether the part is in History or History-Free mode.
             ...
             <br>  @deprecated Deprecated in NX11.0.0.  History-free mode will be retired in NX11. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  History-free mode will be retired in NX11.") bool GetHistoryMode
            (
            );
            ...
            /** Changes the modeling mode to History-Free Modeling. This will remove parameters from features in the model. Feature edit will not be available and the model will not update.
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  History-free mode will be retired in NX11.") void SetHistoryFreeMode
            (
            );
