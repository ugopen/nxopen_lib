...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  UnitCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        /** Get the choice of default set of units for data entry in the given part  @return  
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Get the choice of default set of units for object information in the given part  @return  
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
