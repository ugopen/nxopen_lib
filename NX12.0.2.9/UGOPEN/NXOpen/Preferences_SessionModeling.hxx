        ...
        class NXOPENCPP_PREFERENCESEXPORT  SessionModeling
        {
            ...
            */
            ...
            /**Returns  the features/mark. Controls how often, during feature creation and editing, the system sets internal marks 
             ...
             <br>  @deprecated Deprecated in NX12.0.0.  No replacement. One pmark will be set after each feature. <br>  

             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  No replacement. One pmark will be set after each feature.") int PmarkFrequency
            (
            );
            /**Sets  the features/mark. Controls how often, during feature creation and editing, the system sets internal marks 
             ...
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  No replacement. One pmark will be set after each feature.") void SetPmarkFrequency
            (
