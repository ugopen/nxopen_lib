...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::CAE::ConflictResolutionBuilder instead.") NXOPENCPP_CAEEXPORT  ConstraintResolutionBuilder : public NXOpen::Builder
        {
