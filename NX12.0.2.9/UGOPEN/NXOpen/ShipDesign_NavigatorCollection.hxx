    ...
    namespace ShipDesign
    {
        ...
        */
        class NXOPENCPP_SHIPDESIGNEXPORT  NavigatorCollection
        {
            ...
            /** Checks if ship navigator is registered.  @return  
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : nx_ship_basic ("Ship Basic Design") */
            ...
            /** Creates a @link NXOpen::ShipDesign::ShipNavigatorNodeBuilder NXOpen::ShipDesign::ShipNavigatorNodeBuilder@endlink .  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_ship_basic ("Ship Basic Design") */
            ...
            /** Gets all referencing navigator nodes.  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_ship_basic ("Ship Basic Design") */
