    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RouteManager
        {
            ...
            /** Creates a @link NXOpen::Routing::StockDataRefreshBuilder NXOpen::Routing::StockDataRefreshBuilder@endlink  for refreshing Routing Stock Data definitions.  @return  
            ...
            /** Creates a @link NXOpen::Routing::AlignStockBuilder NXOpen::Routing::AlignStockBuilder@endlink  for aligning Routing Stocks.
                    Provide a tool to align non-circular stocks to routing objects. @return  
            ...
            /** Creates a @link Routing::Electrical::PathArrangementBuilder Routing::Electrical::PathArrangementBuilder@endlink   @return  
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Identifies if input component is Stock as Component or not.
                        ...
                        false = The input component Fitting Component. @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            /** Returns the Routing object, if any, that matches the given search criteria.  @return  
            ...
            /** Returns the @link Routing::ISegment Routing::ISegment@endlink s, if any, that match the given globally unique identifier (GUID).  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            /** Returns the @link Routing::ControlPoint Routing::ControlPoint@endlink , if any, that matches the given globally unique identifier (GUID).  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            /** Returns the @link Routing::Stock Routing::Stock@endlink , if any, that was used to create the given solid body.  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            /** Is the Connection Navigator open?  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            /** Is the Component Navigator open?  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            /** Creates a @link NXOpen::Routing::PlaceElbowsBuilder NXOpen::Routing::PlaceElbowsBuilder@endlink  that is used to place multiple elbows.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : routing_pipetube ("Routing Piping and Tubing") */
            public: NXOpen::Routing::PlaceElbowsBuilder * CreateRoutingPlaceElbowsBuilder
            (
            );
            /** Creates a Adoption builder.  See the documentation in the
                        @link NXOpen::Routing::AdoptionBuilder NXOpen::Routing::AdoptionBuilder@endlink  class for a description of the builder.   @return  
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: NXOpen::Routing::AdoptionBuilder * CreateAdoptionBuilder
            (
            );
