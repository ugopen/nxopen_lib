    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  NodeElementManager
        {
            ...
            /** Creates a builder for the Damper EAD block.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::DamperEADBuilder * CreateDamperEadBuilder
            (
            );
            /** Creates a builder for the Damper EAD block and initializes it with the input element if defined.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::DamperEADBuilder * CreateDamperEadBuilder
            (
            ...
            /** Creates a builder for the Rigid EAD block.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::RigidEADBuilder * CreateRigidEadBuilder
            (
            );
            /** Creates a builder for the Rigid EAD block and initializes it with the input element if defined.  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::RigidEADBuilder * CreateRigidEadBuilder
            (
            ...
            /** Creates a builder for swap diagonal command @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Creates a @link NXOpen::CAE::OpenDuctMeshBuilder NXOpen::CAE::OpenDuctMeshBuilder@endlink   @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : sc_acou_meshing (" SC Acoustic Meshing") */
