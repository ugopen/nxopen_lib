#ifndef NXOpen_AME_SELECTAMEEXTENDEDOBJECT_HXX_INCLUDED
#define NXOpen_AME_SELECTAMEEXTENDEDOBJECT_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     AME_SelectAMEExtendedObject.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _SelectAMEExtendedObjectBuilder;
        class SelectAMEExtendedObjectImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class AMEOPENCPPEXPORT  SelectAMEExtendedObject : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectAMEExtendedObjectImpl * m_selectameextendedobject_impl;
            private: friend class  _SelectAMEExtendedObjectBuilder;
            protected: SelectAMEExtendedObject();
            public: ~SelectAMEExtendedObject();
            ...
            (
                NXOpen::AME::AMEExtendedObject * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::AME::AMEExtendedObject * Value
            (
            );
            ...
            (
                ...
                NXOpen::AME::AMEExtendedObject * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::AME::AMEExtendedObject * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::AME::AMEExtendedObject * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
