        ...
        class NXOPENCPP_MECHANICALROUTINGEXPORT  PartPlacementBuilder : public NXOpen::Builder
        {
            ...
            */
            ...
            /** Process the post placement parts (ex. placement of flange after the valve and do geoemtry operations like split stock, etc).
                        This method will also prepare data needed to build connectivity (connectivity will be built in final commit). @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Get the port from cut side of cut elbow  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
