        ...
        */
        class NXOPENCPP_MOTIONEXPORT  SpringBuilder : public NXOpen::Motion::ConnectorBuilder
        {
            ...
            /**Returns  the free length expression 
             <br>  @deprecated Deprecated in NX11.0.0.  Obtain the expression using @link Motion::SpringBuilder::PreloadedLengthExpression Motion::SpringBuilder::PreloadedLengthExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Obtain the expression using Motion::SpringBuilder::PreloadedLengthExpression to query or edit it.") NXOpen::Expression * FreeLengthExpression
            (
            );
            /**Returns  the free angle expression 
             <br>  @deprecated Deprecated in NX11.0.0.  Obtain the expression using @link Motion::SpringBuilder::PreloadedAngleExpression Motion::SpringBuilder::PreloadedAngleExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Obtain the expression using Motion::SpringBuilder::PreloadedAngleExpression to query or edit it.") NXOpen::Expression * FreeAngleExpression
            (
            );
            ...
            /**Returns  the preload expression 
             <br>  @deprecated Deprecated in NX11.0.0.  Obtain the expression using @link Motion::SpringBuilder::ActuatorForceExpression Motion::SpringBuilder::ActuatorForceExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Obtain the expression using Motion::SpringBuilder::ActuatorForceExpression to query or edit it.") NXOpen::Expression * PreloadExpression
            (
            );
            /**Returns  the preload expression 
             <br>  @deprecated Deprecated in NX11.0.0.  Obtain the expression using @link Motion::SpringBuilder::ActuatorMomentExpression Motion::SpringBuilder::ActuatorMomentExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Obtain the expression using Motion::SpringBuilder::ActuatorMomentExpression to query or edit it.") NXOpen::Expression * PreloadAngleExpression
            (
            );
            ...
            /**Returns  the preload force expression 
             <br>  @deprecated Deprecated in NX12.0.0.  Obtain the expression using @link Motion::SpringBuilder::ActuatorForceExpression Motion::SpringBuilder::ActuatorForceExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Obtain the expression using Motion::SpringBuilder::ActuatorForceExpression to query or edit it.") NXOpen::Expression * PreloadForceExpression
            (
            );
            /**Returns  the preload moment expression 
             <br>  @deprecated Deprecated in NX12.0.0.  Obtain the expression using @link Motion::SpringBuilder::ActuatorMomentExpression Motion::SpringBuilder::ActuatorMomentExpression@endlink  to query or edit it. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Obtain the expression using Motion::SpringBuilder::ActuatorMomentExpression to query or edit it.") NXOpen::Expression * PreloadMomentExpression
            (
            );
