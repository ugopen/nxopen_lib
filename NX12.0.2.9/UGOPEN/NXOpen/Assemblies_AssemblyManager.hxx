    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  AssemblyManager
        {
            ...
            /** Creates a @link Assemblies::AddComponentBuilder Assemblies::AddComponentBuilder@endlink   @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::Assemblies::AddComponentBuilder * CreateAddComponentBuilder
            (
            );
            /** Creates a @link Assemblies::CreateComponentBuilder Assemblies::CreateComponentBuilder@endlink   @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
