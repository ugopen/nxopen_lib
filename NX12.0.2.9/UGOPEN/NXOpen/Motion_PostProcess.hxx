        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PostProcess
        {
            ...
            /** Update design position 
             <br>  @deprecated Deprecated in NX12.0.0.  This functionality is no longer supported. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  This functionality is no longer supported.") void UpdateDesignPosition
            (
            );
