    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ElectrodeEDMOutputBuilder : public NXOpen::Builder
        {
            ...
            {
                FileTypeTxt/** txt file */,
                FileTypeXml/** xlm file */
            };
            ...
            public: NXString TemplatePathBrowser
            (
            );
            /**Sets  the template path browser. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetTemplatePathBrowser
            (
            ...
            /**Returns  the output file path browser. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: NXString OutputFilePathBrowser
            (
            );
            /**Sets  the output file path browser. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetOutputFilePathBrowser
            (
                const NXString & foldername /** foldername */ 
            );
            /**Sets  the output file path browser. 
            ...
            /** Update blank attribtes. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void UpdateEwBlankAttributes
            (
            );
            /** Get the attribute template name.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: NXString GetAttributeTemplateName
            (
            );
            /** Get the title name of attribute template pull-down list. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            ...
            /** Set the attribute template name. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            ...
            /** Get the attribute template file type.  @return  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
