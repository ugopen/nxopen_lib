    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseCustomSymbolBuilder : public NXOpen::Builder
        {
            ...
            /** Returns the arbitrary note value in an array.  This should be used only after @link NXOpen::Annotations::BaseCustomSymbolBuilder::SelectText NXOpen::Annotations::BaseCustomSymbolBuilder::SelectText@endlink  is used  @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
