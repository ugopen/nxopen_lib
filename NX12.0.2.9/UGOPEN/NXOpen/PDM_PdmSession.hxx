    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  PdmSession
        {
            ...
            /** Returns a new @link NXOpen::PDM::FileManagement NXOpen::PDM::FileManagement@endlink  object  @return  
             <br>  Created in NX7.5.4.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::FileManagement * NewFileManagement
            (
            );
            /** Returns a new @link NXOpen::PDM::CAEFileContainer NXOpen::PDM::CAEFileContainer@endlink  object  @return  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::CAEFileContainer * NewCaeFileContainer
            (
            );
            /**Returns a new @link NXOpen::PDM::PartOperationCopyBuilder NXOpen::PDM::PartOperationCopyBuilder@endlink  object @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns a new @link NXOpen::PDM::PartOperationCreateBuilder NXOpen::PDM::PartOperationCreateBuilder@endlink  object @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns a new @link NXOpen::PDM::PartOperationBuilder NXOpen::PDM::PartOperationBuilder@endlink  object @return  
            ...
            /**Returns a new @link NXOpen::PDM::ObjectCreateBuilder NXOpen::PDM::ObjectCreateBuilder@endlink  object @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns a new @link NXOpen::PDM::PartOperationMakeUniqueBuilder NXOpen::PDM::PartOperationMakeUniqueBuilder@endlink  object @return  
             <br>  Created in NX10.0.0.  <br>  
            ...
            /**Returns a new @link NXOpen::PDM::PartOperationImportBuilder NXOpen::PDM::PartOperationImportBuilder@endlink  object @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::PartOperationImportBuilder * CreateImportOperationBuilder
            (
            );
            /** Creates a new @link NXOpen::PDM::PartOperationAttributePropertiesBuilder NXOpen::PDM::PartOperationAttributePropertiesBuilder@endlink  object.  @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /** Creates a new @link AttributePropertiesBuilder AttributePropertiesBuilder@endlink  object.  @return  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /** Gets the @link NXOpen::PDM::DatabaseObjectManager NXOpen::PDM::DatabaseObjectManager@endlink  object.  @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::DatabaseObjectManager * GetDatabaseObjectManager
            (
            );
            /** Creates a new @link SmartSaveBuilder SmartSaveBuilder@endlink  object.  @return  
            ...
            /** Creates a new @link SmartSaveContext SmartSaveContext@endlink  object.  @return  
            ...
            /** Creates a new @link NXOpen::PDM::ExportWorksetForReferenceBuilder NXOpen::PDM::ExportWorksetForReferenceBuilder@endlink  object used for
                        exporting workset outside Teamcenter for reference.  @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /** Sets active ECN for the session.
                        The input will be in the format of ECN MFK ID and the ECN Revision ID.
                    
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetActiveEngineeringChangeNotice
            (
                NXOpen::NXObject * part /** tag of the displayed part */,
                const NXString & ecnMFKId /** ECN MFKID to be set */,
                const NXString & ecnRevsionId /** ECN ItemRevID to be set */
            );
            /** Sets active ECN for the session.
                        The input will be in the format of ECN MFK ID and the ECN Revision ID.
            ...
            (
                NXOpen::NXObject * part /** tag of the displayed part */,
                const char * ecnMFKId /** ECN MFKID to be set */,
                const char * ecnRevsionId /** ECN ItemRevID to be set */
            );
