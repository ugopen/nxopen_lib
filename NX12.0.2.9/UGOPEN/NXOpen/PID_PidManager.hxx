        ...
        */
        class PIDOPENCPPEXPORT  PidManager
        {
            ...
            */
            ...
            public: ~PidManager();
            /** Creates a @link NXOpen::PID::EquipmentBuilder NXOpen::PID::EquipmentBuilder@endlink .  @return  
             <br>  Created in NX11.0.1.  <br>  
            ...
            /** Creates a @link NXOpen::PID::PortEquipmentBuilder NXOpen::PID::PortEquipmentBuilder@endlink .  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::PipeBuilder NXOpen::PID::PipeBuilder@endlink .  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::FlowDirectionArrowBuilder NXOpen::PID::FlowDirectionArrowBuilder@endlink .  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::PreferencesBuilder NXOpen::PID::PreferencesBuilder@endlink .  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::BulkEditBuilder NXOpen::PID::BulkEditBuilder@endlink   @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::SheetTemplateBuilder NXOpen::PID::SheetTemplateBuilder@endlink   @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::LibraryAuthoringBuilder NXOpen::PID::LibraryAuthoringBuilder@endlink .  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
