    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Creates a new empty design group after a specified referece design group  @return  The new created design group 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::Feature * InsertNewDesignGroup
            (
                NXOpen::Features::Feature * referenceDesignGroup /**Reference design group to create new feature after */
            );
