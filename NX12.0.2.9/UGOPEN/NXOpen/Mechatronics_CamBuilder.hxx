...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        LayerSettings.LayerOption </td> <td> 
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  CamBuilder : public NXOpen::Mechatronics::CouplingBuilder
        {
            ...
            /** Returns the curve feature  @return  
            ...
            /** Returns the extrude feature  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            ...
            /** Add cam disk to master axis by ja  @return  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: bool AddCamDiskToMasterAxis
            (
                bool update /** update */ 
            );
        };
