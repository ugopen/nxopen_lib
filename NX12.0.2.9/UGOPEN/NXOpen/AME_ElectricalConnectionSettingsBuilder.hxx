    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  ElectricalConnectionSettingsBuilder : public NXOpen::Builder
        {
            ...
            /** Wire cross section property of a given electrical connection sub-type.  @return  
             <br>  Created in NX11.0.0.  <br>  
            ...
            /** Style color code property of a given electrical connection sub-type.  @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Style font property of a given electrical connection sub-type.  @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Style width property of a given electrical connection sub-type.  @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
