            ...
            namespace Author
            {
                ...
                */
                class NXOPENCPP_CAEEXPORT  InputLoad : public NXOpen::CAE::AeroStructures::Author::InputParameter
                {
                    ...
                    {
                        LoadSupportTypeNone/** not available (the aggregation has been done at the calculation level, GetValues() will return a vector of aggregated values) */,
                        LoadSupportTypeNode/** Node (the method has to aggregated values that have been extracted per node, GetValues() will return a table of values)*/,
                        LoadSupportTypeElement/** Element (the method has to aggregated values that have been extracted per element, GetValues() will return a table of values) */
                    };
                    ...
                    (
                        std::vector<NXOpen::CAE::FEElement *> & elementArray /** the list of support element if available*/
                    );
                    ...
                    /** Get value using a specific unit type.  @return  either a one dimentional two dimensional array of doubles
                     <br>  Created in NX12.0.0.  <br>  
                     <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment"), sc_margin_safety ("Simcenter Margin Of Safety") */
