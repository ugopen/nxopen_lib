                     ...
                     int *type_list, int *num_types)
{
    ...
    while(argc_pnt<argc)
    {
        ...
        else if(!strcmp(argv[argc_pnt],"-t"))   /* if -t switch */
        {
            ...
            type_flag=TRUE;
            argc_pnt++;
            while( (argc_pnt<argc) && (argv[argc_pnt][0]!='-') )
...
static void show_display_atts(tag_t object_tag)
{
    ...
    switch(disp_props.line_width)
    {
        ...
        //Support new width
        case UF_OBJ_WIDTH_1      : line_width="Width 1"; break;
        case UF_OBJ_WIDTH_2      : line_width="Width 2"; break;
        case UF_OBJ_WIDTH_3      : line_width="Width 3"; break;
        case UF_OBJ_WIDTH_4      : line_width="Width 4"; break;
        case UF_OBJ_WIDTH_5      : line_width="Width 5"; break;
        case UF_OBJ_WIDTH_6      : line_width="Width 6"; break;
        case UF_OBJ_WIDTH_7      : line_width="Width 7"; break;
        case UF_OBJ_WIDTH_8      : line_width="Width 8"; break;
        case UF_OBJ_WIDTH_9      : line_width="Width 9"; break;
