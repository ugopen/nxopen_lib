...
File description:
     ...
     the invocation of UF_GEXP_create_distance().  It is placed
...
static void do_ugopen_api(void)
{
    ...
    tag_t part=NULL_TAG, feat_tag=NULL_TAG, exp_tag=NULL_TAG, solid=NULL_TAG, solid_body[2] = {NULL_TAG, NULL_TAG}; 
    int type, subtype;
