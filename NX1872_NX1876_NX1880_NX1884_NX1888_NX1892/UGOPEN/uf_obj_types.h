...
#define SUPPORT_MORE_LINE_FONTS   (0)
...
#define UF_MIN_NEW_LINE_FONT       11
#define UF_OBJ_LINE_FONT_8  (UF_MIN_NEW_LINE_FONT + 0) 
#define UF_OBJ_LINE_FONT_9  (UF_MIN_NEW_LINE_FONT + 1) 
#define UF_OBJ_LINE_FONT_10  (UF_MIN_NEW_LINE_FONT + 2) 
#define UF_OBJ_LINE_FONT_11  (UF_MIN_NEW_LINE_FONT + 3) 

#define UF_OBJ_MAX_LINE_FONT (UF_MIN_NEW_LINE_FONT + 3)

#define UF_OBJ_is_valid_line_font( lineFont ) \
    ( (((lineFont) >= (int) UF_OBJ_FONT_SOLID) && \
       ((lineFont) <= (int) UF_OBJ_FONT_DOTTED_DASHED)) || \
      (((lineFont) >= (int) UF_MIN_NEW_LINE_FONT) && \
       ((lineFont) <=  (int) UF_OBJ_MAX_LINE_FONT)) )
#else
#define UF_OBJ_MAX_LINE_FONT (UF_OBJ_FONT_DOTTED_DASHED)
#define UF_OBJ_is_valid_line_font( lineFont )               \
    ( (((lineFont) >= (int) UF_OBJ_FONT_SOLID) &&           \
        ((lineFont) <=  (int) UF_OBJ_MAX_LINE_FONT)) )
