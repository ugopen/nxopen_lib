...
FILES REQUIRED
    ...
    1. Routing_Example_Callbacks.cpp
    2. Routing_Example_Callbacks.hpp
    3. Routing_Example_DesignRules.cpp
    4. Routing_Example_DesignRules.hpp
    5. Routing_Example_Plugins.cpp
    6. Routing_Example_Plugins.hpp
	
The above listed files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/Routing.

----------------------------------------------------------------------------------------------------
BUILD STEPS

The build steps vary depending on the language in which you write your Callbacks, Plugins, and
Design Rules and on the platform on which you write them. However you build the examples, you need 
to end up with a .DLL file on Windows or a .so file on Linux, or a .dylib file on MacOS.
