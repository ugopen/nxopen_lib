'=============================================================================
'
'                   Copyright  2010 Siemens PLM Solutions
...
------------------------------------------------------------------------------
        		           Drawing Sheets Cycle
------------------------------------------------------------------------------

-------------------
Example Description
-------------------
This example demonstrates on how to cycle through drawing sheets in a part and getting sheet
data and printing sheet data. The example also creates and deletes notes in the drawing sheet.
...
--------------
    ...
    1. DrawingCycle.cpp
    2. DrawingCycle_sheets.prt
The above listed files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/C++/DrawingCycle
...
-----------
   ...
   3. Add the DrawingCycle.cpp to Source Files
   ...
   This will create an executable called DrawingCycle.dll in the Debug directory.
   ...
   3. Compile and link using uflink:
      ...
      ufcomp DrawingCycle.cpp
      uflink UFDLL=DrawingCycle.dll

   This will create DrawingCycle.dll in the current directory.
   ...
   This will create DrawingCycle.so in the current directory.
...
-----------------------
    ...
    2. Open the part DrawingCycle_sheets.prt
       
    3. Invoke DrawingCycle.dll (DrawingCycle.so on Linux) file using  File->Execute->NX Open... menu command.

    4. Then for each sheet in part, the following operations will be performed:

   	   4.1 Updates all the views on the sheet.
   	   4.2 Places a note with the date on it, in the lower right corner of the sheet.
       4.3 Pops up a message box for each sheet
       4.4 Delete the note placed on the sheet that was created in the step 4.2.
...
Note: This example could be easily modified to cycle through multiple parts.  
