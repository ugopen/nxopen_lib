...
Module BeamSection
    ...
    Function CreateStandardBeamSection(ByVal sectionType As String, ByVal sectionName As String, ByVal sectionProps() As SectionProp)
        ...
        standardBeamSectionBuilder = workFemPart.BeamSections.CreateStandardBeamSectionBuilder(nullCAE_StandardBeamSection)
    ...
    Function CreateFaceOfSoildBeamSection() As Tag
        ...
        userDefinedSolidBeamSectionBuilder = workFemPart.BeamSections.CreateUserDefinedSolidBeamSectionBuilder(nullCAE_UserDefinedSolidBeamSection)
    ...
    Function CreateGeneralGeometryBeamSection()
        ...
        generalGeometryBeamSectionBuilder = workFemPart.BeamSections.CreateGeneralGeometryBeamSectionBuilder(nullCAE_GeneralGeometryBeamSection)
    ...
    Function LocateSectionByName(ByVal SectionName As String)
        ...
        Dim namedSection As CAE.BeamSection
        namedSection = CType(workFemPart.BeamSections.FindObject("BeamSection[" + SectionName + "]"), CAE.BeamSection)     'the replacement of UF_SF_locate_named_section
    ...
    Sub CreateFemPart()
        ...
        Dim datumPlane2 As DatumPlane = CType(workPart.Datums.FindObject("DATUM_CSYS(1) XY plane"), DatumPlane)
        ...
        Dim objects3(0) As TaggedObject
        objects3(0) = plane4
        ...
        Dim objects4(0) As TaggedObject
        objects4(0) = plane5
        ...
        Dim objects5(0) As TaggedObject
        objects5(0) = plane6
        ...
        Dim objects6(0) As TaggedObject
        objects6(0) = plane7
        ...
        Dim objects7(0) As TaggedObject
        objects7(0) = plane8
        Dim nErrs7 As Integer
        nErrs7 = theSession.UpdateManager.AddObjectsToDeleteList(objects7)
        ...
        Dim objects8(0) As TaggedObject
        objects8(0) = plane9
        Dim nErrs8 As Integer
        nErrs8 = theSession.UpdateManager.AddObjectsToDeleteList(objects8)
        ...
        physicalPropertyTable1 = caePart1.PhysicalPropertyTables.CreatePhysicalPropertyTable("PBEAML", "NX NASTRAN - Structural", "NX NASTRAN", "PBEAML5", 5)
