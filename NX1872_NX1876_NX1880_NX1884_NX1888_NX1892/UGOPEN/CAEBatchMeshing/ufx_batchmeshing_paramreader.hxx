...
public:
    ...
    int  Get_mesh_collector(char *scMesh_Collector) const;
    ...
    int  Get_internal_mesh_gradation(double *dInternal_Mesh_Gradation) const;
    int  Get_internal_max_edge_length_toggle(int *fInternal_Max_Edge_Length_Toggle) const;
    int  Get_internal_max_edge_length_value(double *dInternal_Max_Edge_Length)  const;
    ...
    int  Get_aspect_ratio_toggle(int *fAspect_ratio_toggle) const;
    int  Get_aspect_ratio_value(double *dAspect_ratio) const;
    ...
    int  Get_target_max_elem_length_toggle(int *ftarget_max_elem_length_toggle) const;
    int  Get_target_max_elem_length_value(double *dtarget_max_elem_length) const;

    int  Get_max_skew_toggle(int *fmax_skew_toggle) const;
    int  Get_max_skew_value(double *dmax_skew) const;
...
private:
    ...
    int    fSET__mesh_collector;
    char   mesh_collector[ MEDIUM_STRING_BUFSIZE ];
    ...
    int    fSET__internal_mesh_gradation;
    double internal_mesh_gradation;

    int    fSET__internal_max_edge_length_toggle;
    int    internal_max_edge_length_toggle;

    int    fSET__internal_max_edge_length_value;
    double internal_max_edge_length_value;
    ...
    int    fSET__2D_target_max_elem_len_toggle;
    int    target_max_elem_len_toggle_2D;

    int    fSET__2D_target_max_elem_len;
    double    target_max_elem_len_2D;

    int    fSET__2D_max_skew_toggle;
    int    max_skew_toggle_2D;

    int    fSET__2D_max_skew;
    double    max_skew_2D;
    ...
    int    fSET__2D_aspect_ratio_toggle;
    int    aspect_ratio_2D_toggle;

    int    fSET__2D_aspect_ratio;
    double aspect_ratio_2D;
    ...
    void Set_mesh_collector(const char scMesh_Collector[MEDIUM_STRING_BUFSIZE] );
    ...
    void Set_internal_mesh_gradation(double dInternal_Mesh_Gradation);
    void Set_internal_max_edge_length_toggle(int fInternal_Max_Edge_Length_Toggle);
    void Set_internal_max_edge_length_value(double dInternal_Max_Edge_Length_Value);
    ...
    void Set_target_max_elem_length_toggle(int ftarget_max_elem_length_toggle);
    void Set_target_max_elem_length_value(double dtarget_max_elem_length);
    void Set_max_skew_toggle(int fmax_skew_toggle);
    void Set_max_skew_value(double dmax_skew);
    ...
    void Set_aspect_ratio_toggle(int fAspect_ratio_toggle);
    void Set_aspect_ratio_value(double dAspect_ratio);
