...
#define      MESH_PARAM_mesh__mesh_collector                         "mesh_collector"
...
#define      MESH_PARAM_mesh__internal_mesh_gradation                 "internal_mesh_gradation"
#define      MESH_PARAM_mesh__internal_max_edge_length_toggle         "internal_max_edge_length_toggle"
#define      MESH_PARAM_mesh__internal_max_edge_length_value          "internal_max_edge_length_value"
...
#define      MESH_PARAM_mesh__aspect_ratio_toggle                     "aspect_ratio_toggle"
#define      MESH_PARAM_mesh__aspect_ratio                            "aspect_ratio"
...
#define      MESH_PARAM_mesh__target_max_elem_length_toggle                  "target_maximum_element_length_toggle"  
#define      MESH_PARAM_mesh__target_max_elem_length                         "target_maximum_element_length"

#define      MESH_PARAM_mesh__max_skew_toggle                                    "max_skew_toggle"  
#define      MESH_PARAM_mesh__max_skew                                           "max_skew"
...
#define  IsValid_MeshParam(scParam) \
        (strcmp((scParam), MESH_PARAM_mesh) ||      \
         ...
         strcmp((scParam), MESH_PARAM_mesh__mesh_collector) ||     \
         ...
         strcmp((scParam), MESH_PARAM_mesh__internal_mesh_gradation) || \
         strcmp((scParam), MESH_PARAM_mesh__internal_max_edge_length_value) || \
         strcmp((scParam), MESH_PARAM_mesh__internal_max_edge_length_toggle) || \
         strcmp((scParam), MESH_PARAM_mesh__target_max_elem_length_toggle) || \
         strcmp((scParam), MESH_PARAM_mesh__target_max_elem_length) || \
         strcmp((scParam), MESH_PARAM_mesh__max_skew_toggle) || \
         strcmp((scParam), MESH_PARAM_mesh__max_skew) || \
         strcmp((scParam), MESH_PARAM_mesh__aspect_ratio_toggle) || \
         strcmp((scParam), MESH_PARAM_mesh__aspect_ratio) || \
...
paramReader::paramReader( void ): m_nextLine(), m_fp_xml(0),
                                 ...
                                 fSET__mesh_collector(0), mesh_collector(),
                                 ...
                                 fSET__internal_mesh_gradation(0), internal_mesh_gradation(0.0),
                                 fSET__internal_max_edge_length_toggle(0), internal_max_edge_length_toggle(0),
                                 fSET__internal_max_edge_length_value(0), internal_max_edge_length_value(0.0),
                                 ...
                                 fSET__2D_aspect_ratio_toggle(0), aspect_ratio_2D_toggle(0),
                                 fSET__2D_aspect_ratio(0), aspect_ratio_2D(0.0),
                                 ...
                                 fSET__2D_target_max_elem_len_toggle(0), target_max_elem_len_toggle_2D(0),
                                 fSET__2D_target_max_elem_len(0), target_max_elem_len_2D(0.0),
                                 fSET__2D_max_skew_toggle(0), max_skew_toggle_2D(0),
                                 fSET__2D_max_skew(0),max_skew_2D(0.0),
...
int  paramReader::Get_mesh_collector(char *scMesh_Collector) const
{
    if (fSET__mesh_collector)
        strcpy(scMesh_Collector, mesh_collector);
    return fSET__mesh_collector;
}
void paramReader::Set_mesh_collector(const char   scMesh_Collector[MEDIUM_STRING_BUFSIZE])
{
    fSET__mesh_collector = true;
    strcpy(mesh_collector, scMesh_Collector);
}
...
int  paramReader::Get_internal_mesh_gradation(double *dInternal_Mesh_Gradation) const
{
    if (fSET__internal_mesh_gradation)
        *dInternal_Mesh_Gradation = internal_mesh_gradation;
    return fSET__internal_mesh_gradation;
}
void paramReader::Set_internal_mesh_gradation(double dInternal_Mesh_Gradation)
{
    fSET__internal_mesh_gradation = true;
    internal_mesh_gradation = dInternal_Mesh_Gradation;
}

int  paramReader::Get_internal_max_edge_length_toggle(int *fInternal_Max_Edge_Length_Toggle) const
{
    if (fSET__internal_max_edge_length_toggle == (int)true)
        *fInternal_Max_Edge_Length_Toggle = internal_max_edge_length_toggle;
    return fSET__internal_max_edge_length_toggle;
}
void paramReader::Set_internal_max_edge_length_toggle(int fInternal_Max_Edge_Length_Toggle)
{
    fSET__internal_max_edge_length_toggle = true;
    internal_max_edge_length_toggle = fInternal_Max_Edge_Length_Toggle;
}

int  paramReader::Get_internal_max_edge_length_value(double *dInternal_Max_Edge_Length) const
{
    if (fSET__internal_max_edge_length_value)
        *dInternal_Max_Edge_Length = internal_max_edge_length_value;
    return fSET__internal_max_edge_length_value;
}
void paramReader::Set_internal_max_edge_length_value(double dInternal_Max_Edge_Length)
{
    fSET__internal_max_edge_length_value = true;
    internal_max_edge_length_value = dInternal_Max_Edge_Length;
}
...
int paramReader::Get_aspect_ratio_toggle(int *faspect_ratio_toggle) const
{
    if (fSET__2D_aspect_ratio_toggle)
        *faspect_ratio_toggle = aspect_ratio_2D_toggle;
    return fSET__2D_aspect_ratio_toggle;
}
void paramReader::Set_aspect_ratio_toggle(int faspect_ratio_toggle)
{
    fSET__2D_aspect_ratio_toggle = true;
    aspect_ratio_2D_toggle = faspect_ratio_toggle;
}

int   paramReader::Get_aspect_ratio_value(double *dAspectRatio) const
{
    if (fSET__aspect_ratio)
        *dAspectRatio = aspect_ratio;
    return fSET__aspect_ratio;
}
void   paramReader::Set_aspect_ratio_value(double dAspectRatio)
{
    fSET__aspect_ratio = true;
    aspect_ratio = dAspectRatio;
}
...
int paramReader::Get_target_max_elem_length_toggle(int *ftarget_max_elem_length_toggle) const
{
    if (fSET__2D_target_max_elem_len_toggle)
        *ftarget_max_elem_length_toggle = target_max_elem_len_toggle_2D;
    return fSET__2D_target_max_elem_len_toggle;
}
void paramReader::Set_target_max_elem_length_toggle(int ftarget_max_elem_length_toggle)
{
    fSET__2D_target_max_elem_len_toggle = true;
    target_max_elem_len_toggle_2D = ftarget_max_elem_length_toggle;
}

void   paramReader::Set_target_max_elem_length_value(double dtarget_max_elem_length)
{
    fSET__2D_target_max_elem_len = true;
    target_max_elem_len_2D = dtarget_max_elem_length;
}
int   paramReader::Get_target_max_elem_length_value(double *dtarget_max_elem_length) const
{
    if (fSET__2D_target_max_elem_len)
        *dtarget_max_elem_length = target_max_elem_len_2D;
    return fSET__2D_target_max_elem_len;
}

int paramReader::Get_max_skew_toggle(int *fmax_skew_toggle) const
{
    if (fSET__2D_max_skew_toggle)
        *fmax_skew_toggle = max_skew_toggle_2D;
    return fSET__2D_max_skew_toggle;
}
void paramReader::Set_max_skew_toggle(int fmax_skew_toggle)
{
    fSET__2D_max_skew_toggle = true;
    max_skew_toggle_2D = fmax_skew_toggle;
}

void   paramReader::Set_max_skew_value(double dmax_skew)
{
    fSET__2D_max_skew = true;
    max_skew_2D = dmax_skew;
}
int   paramReader::Get_max_skew_value(double *dmax_skew) const
{
    if (fSET__2D_max_skew)
        *dmax_skew = max_skew_2D;
    return fSET__2D_max_skew;
}
...
bool paramReader::fStringHasPreFix(char *psInputString,const char *psPreFixString) const
{
    ...
    // Use a temporary array for the prefix and input string as it is a constant string.
    */
    bool fHasPrefix = false;
    int i, ichar, nchar;
    int nPreFixLength = 0;
    char psPreFixStringTemp[MEDIUM_STRING_BUFSIZE];
    char psInputStringTemp[MEDIUM_STRING_BUFSIZE];
    ...
    */
    for (i=0;i<nchar;i++)
    {
        ...
        psInputStringTemp[i] = tolower(ichar);
    }
    /* Null terminated string */
    psInputStringTemp[i] = '\0';
    ...
    */
    ...
    i = 0;
    while (psInputStringTemp[i] == ' ' && i < MEDIUM_STRING_BUFSIZE)
          {
           i++;
          }

    /* Check for start of vertices of tri. */
    if (0 == strncmp(psPreFixStringTemp, &(psInputStringTemp[i]),nPreFixLength)  )
    {
        fHasPrefix = true;
    }
    else
...
{
    int iChar = 0;
    while ( (scString[iChar] == ' ' || scString[iChar] == '\0')&&
            iChar < MEDIUM_STRING_BUFSIZE)
    {
        iChar++;
    }
  ...
  while (fgetsSkipComments(m_nextLine, MEDIUM_STRING_BUFSIZE, m_fp_xml)) 
  {
      ...
      else 
      {
          ...
          if ( !fSkipParamLines )
          {
              ...
              else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__mesh_collector))
              {
                  iValueLoc = LocateStartOfValue(m_nextLine);
                  strcpy(scSTR_value,"");
                  iCnt = sscanf(&m_nextLine[iValueLoc], "%[^\t\n]", scSTR_value);
                  if ((EOF == iCnt) || (1 != iCnt))
                      iRet = -1;
                  Set_mesh_collector(scSTR_value);
              }
                ...
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__target_max_elem_length_toggle))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%s", scSTR_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                    ...
                    if (fStringHasPreFix(scSTR_value, "ON"))
                        ...
                        iINT_value = (int)false;
                    Set_target_max_elem_length_toggle(iINT_value);
                }
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__target_max_elem_length))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%g", &fREAL_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                        iRet = -1;
                    Set_target_max_elem_length_value((double)fREAL_value);
                }
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__max_skew_toggle))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%s", scSTR_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                    ...
                    if (fStringHasPreFix(scSTR_value, "ON"))
                        ...
                        iINT_value = (int)false;
                    Set_max_skew_toggle(iINT_value);
                }
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__max_skew))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%g", &fREAL_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                        iRet = -1;
                    Set_max_skew_value((double)fREAL_value);
                }
                ...
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__internal_mesh_gradation))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%g", &fREAL_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                        iRet = -1;
                    Set_internal_mesh_gradation((double)fREAL_value);
                }
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__internal_max_edge_length_toggle))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%s", scSTR_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                    ...
                    if (fStringHasPreFix(scSTR_value, "ON"))
                        ...
                        iINT_value = (int)false;
                    Set_internal_max_edge_length_toggle(iINT_value);
                }
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__internal_max_edge_length_value))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%g", &fREAL_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                        iRet = -1;
                    Set_internal_max_edge_length_value((double)fREAL_value);
                }
                ...
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__aspect_ratio_toggle))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%s", scSTR_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                    ...
                    if (fStringHasPreFix(scSTR_value, "ON"))
                        ...
                        iINT_value = (int)false;
                    Set_aspect_ratio_toggle(iINT_value);
                }
                else if (fStringHasPreFix(m_nextLine, MESH_PARAM_mesh__aspect_ratio))
                {
                    iValueLoc = LocateStartOfValue(m_nextLine);
                    iCnt = sscanf(&m_nextLine[iValueLoc], "%g", &fREAL_value);
                    if ((EOF == iCnt) || (1 != iCnt))
                        iRet = -1;
                    Set_aspect_ratio_value((double)fREAL_value);
                }
...
int paramReader::read_criteria()
{
  ...
  while (fgetsSkipComments(m_nextLine, MEDIUM_STRING_BUFSIZE, m_fp_xml)) 
  {
      ...
      if ( m_nextLine[iValueLoc]>='1' && m_nextLine[iValueLoc]<='9' )
      {
