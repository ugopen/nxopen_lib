...
File description:
    ...
    <BJS> 03-Apr-2018
    These values are all expected to be unique - so code merges may need to adjust them.
    In order to avoid vast numbers of recompiles when this header is changed it is suggested
    that it is not nested in other headers. Instead the same ERROR_XYZ_base symbol should
    be defined here and also in the module specific header. The definitions should of course
    be the same and this can be verified by having just one source file that includes both of them.
    It is defined that if the compiler sees two definitions of the same macro but the definitions
    are identical that no error is generated. But if the definitions are different you will get
    a compile failure. So it is recommended that the source file that declares the lookup table
    for error number to string includes both headers and if an edit causes those to become
    different you will get a build failure and know.
...
//  <AdrianB> 04-Apr-2017 PR#8005769
//  ERROR_IMAN_base is the minimum used error base. So any error code less than
//  1000 cannot be a valid ifail (except for ERROR_OK of course).
//
//  Note that just because an error code is above ERROR_min_error_code doesn't mean
//  it is a valid ifail. There are many gaps in the set of valid ifails. And not all
//  the error bases below are registered in all applications - eg the Tc error bases
//  aren't registered in NX.
//
//  See also ERROR_max_error_code near the bottom of this file.
//
#define ERROR_min_error_code   1000
...
#define ERROR_NXK_base               4305000 // <Marc Detavernier> 14-Mar-2016 Added for nxk module (kinematic common data model)
#define ERROR_IMW_base               4310000 // <Nancy O'Brien-Bodo> 29-Apr-2016 added for Imageware integration
#define ERROR_INTERPOL_base          4315000 // <Andrey Chernolutskiy> 11-May-2016
#define ERROR_DURSPECIALIST_base     4320000 // <Sebastien Moreau> 27-Jun-2016
#define ERROR_EXPEVALUATOR_base      4325000 // <Neelakantan Mani> 19-Aug-2016
#define ERROR_CAM_SERVICES_base      4330000 // <Arto Saari> 12-Jul-2016 CAM11036 Added for CAM services module
#define ERROR_PROPTABLEENTITY_base   4335000 // <Shinan Wang> 19-Sep-2016
#define ERROR_SNAPSHOT_base          4340000 // <Sudhir Kumar> 10-Nov-2016 ASM120003: Added for snapshots
#define ERROR_CAEAPITEST_base        4345000 // <Jay Campbell> 04-Oct-2016
#define ERROR_STRUCTURE_DESCRIPTION_base   4350000 // <Pat Connors> 21-Nov-2016 ASM120001: Added for Structure_Description
#define ERROR_DPM_base               4355000 // <Mukund Rajamony/MAYA> 17-Jan-2017 LMS0067: DPM Errors.
#define ERROR_MATH_base              4360000 // <AdrianB> 17-Jan-2017 Error codes for the Math namespace in libugmath
#define ERROR_DPMC_base              4365000 // <Istvan Lorentz> 02-Feb-2017 LMS0067: DPMC Errors.
#define ERROR_MOTION_DESIGNER_base   4370000 // <Haifeng Xu> 09-Feb-2017 Added for Motion Designer
#define ERROR_SDPD_BASE              4375000 // <Amit Joshi> 27-Jan-2017 DES15010: Added for SDPD workflows
#define ERROR_UNV_base               4380000 // <Zachary Guo 02-Mar-2017> LMS0067: UNV Errors.
#define ERROR_AEROSTRUCT_base        4385000 // <Scott Coonce> 06-Mar-2017: LMS0800, LMS0801
#define ERROR_NASTRANPOST_base       4390000 // <Costin Nila> 20-Mar-2017 Added ERROR_NASTRANPOST_base*/
#define ERROR_CAM_TEMP_DIAG_base     4395000 // <Chunsik Yi> 08-Feb-2017 PR8261089 Added for CAM temporary diagnostics
#define ERROR_GFXBUILDER_base        4400000 // <Dirk Brennecke> Added for Graphics Builder
#define ERROR_EXPORT_FILE_base       4405000 // <Venkitesan Gopalan> Added for Export File Base class
#define ERROR_IMPORT_FILE_base       4410000 // <Venkitesan Gopalan> Added for Import File Base class
#define ERROR_PARAMLIB_base          4420000 // <Shu Liu/Maya> Added for Parameter library (SDM1321)
#define ERROR_CURVEOPERATION_base    4425000 // <Richard Yuan> 21-Dec-2017 Added for Curve Operation: CAE1669
#define ERROR_LATTICE_base           4430000 // <James Hillman> Added for Lattice Error Code Usage
#define ERROR_NXSAAS_base            4435000 // <Chris Fronk> 08-Aug-2017 Added for SaaS
#define ERROR_TOGGLE_SYSTEM_base     4440000 // <Sachin Mahalle> 15-Jan-2018 ARCH1201201
#define ERROR_RULE_base              4445000 // <Janardan Gaikwad > 28-Feb-2018 Added for Rule Based PMI
#define ERROR_SCALAR_base            4450000 // <Suzanne Keating> 27-Mar-2018 Add ERROR_SCALAR_base
#define ERROR_ROUTING_JA_base        4455000 // <W. Shawn Niblack> 06-Apr-2018 ROU1069
#define ERROR_ROUTING_ELEC_base      4460000 // <W. Shawn Niblack> 06-Apr-2018 ROU1069
#define ERROR_ROUTINGJA_ELEC_base    4465000 // <W. Shawn Niblack> 06-Apr-2018 ROU1069
#define ERROR_PRIMITIVE_base         4470000 // <Suzanne Keating> 23-Apr-2018 Add Primitive module errors
#define ERROR_NXVR_base              4475000 // <Sunil Pillala> Added for NX virtual reality
#define ERROR_PMICADNEUTRAL_base     4480000 // <Suzanne Keating> 23-Apr-2018 Add PMI CAD Neutral module errors
#define ERROR_DESIGN_GROUP_base      4485000 // <deshpanv> Added for Design Group
#define ERROR_ACOUSTICS_base         4490000 // <Mukund Rajamony/MAYA> 25-May-2018
#define ERROR_MLPP_base              4495000 // <Mukund Rajamony/MAYA> 25-May-2018
#define ERROR_TDP_base               4500000 // <Dave Hollinden> 23-Apr-2018 Add ERROR_TDP_base
#define ERROR_CONNDETECT_base        4505000 // <Mouloud Bourbel/MAYA> 22-Jun-2018
#define ERROR_PUBSUBMESSAGE_base     4510000 // <Leslie Aririguzo> 25-Oct-2018
#define ERROR_MASS_base              4515000 // <Hungting Pan> 05-Sep-2018
#define ERROR_CLOUDDM_base           4520000 // <Aakash Sheth> 29-Nov-2018
#define ERROR_COLLABORATION_base     4525000 // <Prabath Vemulapalli> 26-Nov-2018 
#define ERROR_NX_CAPITAL_base        4530000 // <Karan Kakade> 03-Dec-2018
#define ERROR_DRAWINGCOMPARECORE_base 4535000 // Kirk Banta 06-Nov-2018
#define ERROR_PLLINK_base            4540000 // <Amy Cui> 19-Feb-2019 Added for PLLink

//  <BJS> 03-Apr-2018
//  ************** On code merges please declash duplicates ************
//  Also please read the comment at the top of this file on how to reduce compile dependencies
//  on this file yet also ensure the uniqueness requirement isn't broken.

// The next code is the largest expected error code ( = largest base + 4999 ),
// so PLEASE UPDATE IT IF YOU ADD ANOTHER ERROR BASE !
//
// <AdrianB> 04-Apr-2017
// See also ERROR_min_error_code which is defined prior to all the above error base values.
//
#define ERROR_max_error_code   4544999
...
#define ERROR_TOOL_DESIGNER_base      70060000
#define ERROR_MFG_VIEWMAKER_base      70065000
#define ERROR_CLD_Kinematics_base     70070000
#define ERROR_JOIN_base               70075000
