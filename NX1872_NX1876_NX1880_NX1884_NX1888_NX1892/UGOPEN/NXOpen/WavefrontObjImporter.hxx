...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  WavefrontObjImporter : public NXOpen::DexBuilder
    {
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the option to create subdivision geometry on import 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: bool Subdivgeom
        (
        );
        ...
        /// \cond NX_NO_DOC 
        /**Sets  the option to create subdivision geometry on import 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: void SetSubdivgeom
        (
            bool subdivgeom /** subdivgeom */ 
        );
