        ...
        */
        class NXOPENCPP_CAEEXPORT  PostScenarioManager
        {
            ...
            /** Checks if the scenario and the data source set in the
                        @link  NXOpen::CAE::PostScenarioParameters   NXOpen::CAE::PostScenarioParameters @endlink  are compatible. 
            ...
            /** Aligns axes of all plots. 
             ...
             <br>  @deprecated Deprecated in NX1872.0.0.  Use@link NXOpen::CAE::Xyplot::XYPlotManager::AlignAxesOfPlots NXOpen::CAE::Xyplot::XYPlotManager::AlignAxesOfPlots@endlink  instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  UseNXOpen::CAE::Xyplot::XYPlotManager::AlignAxesOfPlots instead.") void AlignAxesOfPlots
            (
            );
