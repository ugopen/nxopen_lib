        ...
        */
        class NXOPENDEBUGSESSIONCPPEXPORT  Debug
        {
            ...
            /** Master template update API 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<bool> UpdateMasterTemplate
            (
                const NXString & fileLocation /** filelocation */ ,
                const NXString & masterTemplateName /** mastertemplatename */ ,
                std::vector<NXString> & templateFileNames /** templatefilenames */ ,
                std::vector<NXString> & templateTypes /** templatetypes */ 
            );
            /** Master template update API 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            std::vector<bool> UpdateMasterTemplate
            (
