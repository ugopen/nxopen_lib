        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PointOnCurveBuilder : public NXOpen::Motion::MotionBuilder
        {
            ...
            /** Returns the curves  @return  curve or edge
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Motion::PointOnCurveBuilder::Curves Motion::PointOnCurveBuilder::Curves@endlink instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Motion::PointOnCurveBuilder::Curvesinstead.") std::vector<NXOpen::NXObject *> GetCurves
            (
            );
            /** Sets the curves 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Motion::PointOnCurveBuilder::Curves Motion::PointOnCurveBuilder::Curves@endlink instead. <br>  
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Motion::PointOnCurveBuilder::Curvesinstead.") void SetCurves
            (
