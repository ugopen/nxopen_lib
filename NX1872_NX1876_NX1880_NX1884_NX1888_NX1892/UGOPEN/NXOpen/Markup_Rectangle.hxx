...
namespace NXOpen
{
    ...
    namespace Markup
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link NXOpen::Markup::AnnotationCollection::CreateRectangle  NXOpen::Markup::AnnotationCollection::CreateRectangle @endlink  <br> 
         <br>  Created in NX10.0.0.  <br>  
        */
        class NXOPENCPP_MARKUPEXPORT  Rectangle : public NXOpen::Markup::Annotation
        {
