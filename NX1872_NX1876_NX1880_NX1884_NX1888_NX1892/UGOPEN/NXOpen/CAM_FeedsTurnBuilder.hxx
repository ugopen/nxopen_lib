    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  FeedsTurnBuilder : public NXOpen::TaggedObject
        {
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the automatic feed rate computation 
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the automatic feed rate computation 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the chip thickness builder 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the maximum feed rate from chip thickness builder 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the corner feed rates state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /**Sets  the corner feed rates state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the feed rate convex corner builder 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /// \cond NX_NO_DOC 
            /**Returns  the feed rate concave corner builder 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
