...
namespace NXOpen
{
    ...
    */
    ...
    {
        /** Represents the states of object name display*/

        /// \cond NX_NO_DOC 
        public: enum JaDisplayableObjectObjectShowName
        {
            JaDisplayableObjectObjectShowNameInherited/** inherited */ ,
            JaDisplayableObjectObjectShowNameShow/** show */ ,
            JaDisplayableObjectObjectShowNameDontshow/** dontshow */ 
        };
        ...
        /// \cond NX_NO_DOC 
        /**Returns  the display state of object name,it has three states:Inherited,Show and Don't Show 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::DisplayModification::JaDisplayableObjectObjectShowName ShowObjectName
        (
        );
        ...
        /// \cond NX_NO_DOC 
        /**Sets  the display state of object name,it has three states:Inherited,Show and Don't Show 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: void SetShowObjectName
        (
            NXOpen::DisplayModification::JaDisplayableObjectObjectShowName showObjectName /** showobjectname */ 
        );
