...
namespace NXOpen
{
    ...
    namespace Markup
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link NXOpen::Markup::AnnotationCollection::CreatePolyline  NXOpen::Markup::AnnotationCollection::CreatePolyline @endlink  <br> 
         <br>  Created in NX10.0.0.  <br>  
        */
        class NXOPENCPP_MARKUPEXPORT  Polyline : public NXOpen::Markup::Annotation
        {
