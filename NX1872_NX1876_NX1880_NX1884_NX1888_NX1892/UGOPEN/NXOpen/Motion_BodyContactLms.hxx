        ...
        */
        class NXOPENCPP_MOTIONEXPORT  BodyContactLms : public NXOpen::NXObject, public virtual NXOpen::IExternalFileReferencer
        {
            ...
            /**Returns  the action tessellation  file
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") NXString ActionTessellationFile
            (
            );
            /**Sets  the action tessellation  file
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::ExternalFileReferenceAdapter::EstablishReference") void SetActionTessellationFile
            (
            ...
            /**Returns  the base tessellation  file
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") NXString BaseTessellationFile
            (
            );
            /**Sets  the base tessellation  file
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::ExternalFileReferenceAdapter::EstablishReference") void SetBaseTessellationFile
            (
                const NXString & fileName /** filename */ 
            );
            /**Sets  the base tessellation  file
