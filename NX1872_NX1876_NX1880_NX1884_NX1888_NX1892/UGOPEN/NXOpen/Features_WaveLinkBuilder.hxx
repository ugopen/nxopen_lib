...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        CompositeCurveBuilder.CurveFitData.CurveJoinMethod </td> <td> 
         
        No </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.Degree </td> <td> 
         
        7 </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.FitMethod </td> <td> 
         
        DegreeAndSegments </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.IsAdvancedFit </td> <td> 
         
        0 </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.IsAlignShape </td> <td> 
         
        0 </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.MaximumDegree </td> <td> 
         
        7 </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.MaximumSegments </td> <td> 
         
        1 </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.MinimumDegree </td> <td> 
         
        5 </td> </tr> 

        <tr><td> 
         
        CompositeCurveBuilder.CurveFitData.Segments </td> <td> 
        ...
        ExtractFaceBuilder.IsPsmOutputBody </td> <td> 
        ...
        WaveSketchBuilder.DisplayReferenceGeometry </td> <td> 
        ...
        WaveSketchBuilder.ParentPart </td> <td> 
