...
#include <NXOpen/Mfg_AM_ProfileSupport.hxx>
...
namespace NXOpen
{
    ...
    namespace Mfg
    {
        namespace AM
        {
            ...
            */
            class MFGAMOPENCPPEXPORT  SupportLibrary : public NXOpen::Mfg::AM::Library
            {
                ...
                public: NXOpen::Mfg::AM::ProfileSupport * AddSupportProfile
                (
                );
            };
        }
