        ...
        */
        class NXOPENCPP_MOTIONEXPORT  BushingDefine : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the matrix of bushing 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link Motion::BushingDefine::Direction Motion::BushingDefine::Direction@endlink  or @link Motion::BushingDefine::Csys Motion::BushingDefine::Csys@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Motion::BushingDefine::Direction or Motion::BushingDefine::Csys instead.") NXOpen::NXMatrix * Orientation
            (
            );
            /**Sets  the matrix of bushing 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use Motion::BushingDefine::Direction or Motion::BushingDefine::Csys instead.") void SetOrientation
            (
