...
namespace NXOpen
{
    ...
    namespace Fields
    {
        ...
        ShowDefaultVal </td> <td> 
         
        0 </td> </tr> 

        <tr><td> 
         
        ShowDescription </td> <td> 
        ...
        ShowOverflowValues </td> <td> 
         
        0 </td> </tr> 

        <tr><td> 
         
        ShowSrcTblVals </td> <td> 
         
        1 </td> </tr> 

        <tr><td> 
         
        ShowUndefValues </td> <td> 
         
        0 </td> </tr> 

        <tr><td> 
         
        ShowUnderflowValues </td> <td> 
        ...
        TblDepPtType (deprecated) </td> <td> 
         
        Hide </td> </tr> 

        <tr><td> 
         
        TblIndepPtType (deprecated) </td> <td> 
        ...
        0 (millimeters part), 1 (inches part) </td> </tr> 
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  DisplayPropertiesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the show undefined values 
             <br>  @deprecated Deprecated in NX12.0.0.  This method is deprecated. Use @link NXOpen::Fields::DisplayPropertiesBuilder::ShowUndefValues NXOpen::Fields::DisplayPropertiesBuilder::ShowUndefValues@endlink  Undefined values are no longer displayed with various symbols, but are only on or off. <br>  

             <br>  Created in NX6.0.1.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  This method is deprecated. Use NXOpen::Fields::DisplayPropertiesBuilder::ShowUndefValues Undefined values are no longer displayed with various symbols, but are only on or off.") NXOpen::Fields::DisplayPropertiesBuilder::ValuesEnum ShowUndefinedValues
            (
            );
            /**Sets  the show undefined values 
             <br>  @deprecated Deprecated in NX12.0.0.  This method is deprecated. Use @link NXOpen::Fields::DisplayPropertiesBuilder::ShowUndefValues NXOpen::Fields::DisplayPropertiesBuilder::ShowUndefValues@endlink  Undefined values are no longer displayed with various symbols, but are only on or off. For backward compatibility, calling this method with hide is the same as calling the new method with false; any other value is the same as calling the new method with true.  <br>  

             <br>  Created in NX6.0.1.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  This method is deprecated. Use NXOpen::Fields::DisplayPropertiesBuilder::ShowUndefValues Undefined values are no longer displayed with various symbols, but are only on or off. For backward compatibility, calling this method with hide is the same as calling the new method with false; any other value is the same as calling the new method with true. ") void SetShowUndefinedValues
            (
            ...
            (
                bool showUndefinedValues /** showundefinedvalues */ 
            );
        };
    }
}
