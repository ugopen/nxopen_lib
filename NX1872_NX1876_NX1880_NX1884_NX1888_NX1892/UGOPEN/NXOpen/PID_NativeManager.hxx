        ...
        */
        class PIDOPENCPPEXPORT  NativeManager
        {
            ...
            */
            ...
            /** Creates a @link NXOpen::PID::EquipmentBuilder NXOpen::PID::EquipmentBuilder@endlink  in native mode. 
             <br>  Created in NX12.0.1.  <br>  
            ...
            /** Creates a @link NXOpen::PID::PortEquipmentBuilder NXOpen::PID::PortEquipmentBuilder@endlink  in native mode. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::PipeBuilder NXOpen::PID::PipeBuilder@endlink  in native mode. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /** Creates a @link NXOpen::PID::NativeSheet NXOpen::PID::NativeSheet@endlink . 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
