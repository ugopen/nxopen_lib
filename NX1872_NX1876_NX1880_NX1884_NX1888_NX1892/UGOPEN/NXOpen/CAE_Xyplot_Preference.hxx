            ...
            */
            class NXOPENCPP_CAEEXPORT  Preference : public NXOpen::TaggedObject
            {
                ...
                /**Returns  the status whether to update the axis limits automatically when overlaying records at next time 
                 ...
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX1847.0.0.  This functionality is no longer supported.") bool UpdateOverlayingAxisLimitsAutomatically
                (
                );
                /**Sets  the status whether to update the axis limits automatically when overlaying records at next time 
                 ...
                 <br>  Created in NX10.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX1847.0.0.  This functionality is no longer supported.") void SetUpdateOverlayingAxisLimitsAutomatically
                (
                ...
                /**Returns  the maximum legend count on a graph. If the record count on a graph
                 ...
                 <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::Xyplot::LegendTableStyle::MaximumLegendItemCount NXOpen::CAE::Xyplot::LegendTableStyle::MaximumLegendItemCount@endlink  <br>  

                 <br>  Created in NX10.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::Xyplot::LegendTableStyle::MaximumLegendItemCount") int MaximumLegendsInGraph
                (
                );
                /**Sets  the maximum legend count on a graph. If the record count on a graph
                                exceeds this maximum number, legends will not be displayed and
                                synchronized probing will be disabled. 
                 <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::CAE::Xyplot::LegendTableStyle::SetMaximumLegendItemCount NXOpen::CAE::Xyplot::LegendTableStyle::SetMaximumLegendItemCount@endlink  <br>  

                 <br>  Created in NX10.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::CAE::Xyplot::LegendTableStyle::SetMaximumLegendItemCount") void SetMaximumLegendsInGraph
                (
