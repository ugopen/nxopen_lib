    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  CallMethodRuleBuilder : public NXOpen::Builder
        {
            ...
            public: NXOpen::AME::SelectAMEExtendedObject * SelectionPort
            (
            );
            ...
            /**Returns  the eo any port selection 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::SelectAMEPort * IterativeSelectedPort
            (
            );
            ...
            /**Returns  the parameter port selection 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::SelectAMEExtendedObject * ParameterSelectionPort
            (
            );
        };
    }
