...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FilterLatticeBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  @brief  the filter dangling rods - whether to remove the dangling rods by the specified criteria or not.
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::FilterLatticeBuilder::FilterDanglingRodsType FilterDanglingRods
            (
            );
