#ifndef NXOpen_ROUTING_ASSIGNCOMPONENTNAMEBUILDER_HXX_INCLUDED
#define NXOpen_ROUTING_ASSIGNCOMPONENTNAMEBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Routing_AssignComponentNameBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /// \cond NX_NO_DOC 
        /** Represents @link NXOpen::Routing::AssignComponentNameBuilder NXOpen::Routing::AssignComponentNameBuilder@endlink .  <br> To create a new instance of this class, use @link NXOpen::Routing::BuilderFactory::CreateAssignComponentNameBuilder  NXOpen::Routing::BuilderFactory::CreateAssignComponentNameBuilder @endlink  <br> 
         <br>  Created in NX1872.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  AssignComponentNameBuilder : public NXOpen::Builder
        {
