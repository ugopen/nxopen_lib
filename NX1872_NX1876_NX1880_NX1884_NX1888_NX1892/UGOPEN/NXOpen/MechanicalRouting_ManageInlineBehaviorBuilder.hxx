        ...
        */
        class NXOPENCPP_MECHANICALROUTINGEXPORT  ManageInlineBehaviorBuilder : public NXOpen::Builder
        {
            ...
            /** Sets @link NXOpen::PDM::ModelElementRevision NXOpen::PDM::ModelElementRevision@endlink  of Routing Reuse type. Raises an error if passed
             ...
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link MechanicalRouting::ManageInlineBehaviorBuilder::SetComponent MechanicalRouting::ManageInlineBehaviorBuilder::SetComponent@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use MechanicalRouting::ManageInlineBehaviorBuilder::SetComponent instead.") void SetModelElementRevision
            (
