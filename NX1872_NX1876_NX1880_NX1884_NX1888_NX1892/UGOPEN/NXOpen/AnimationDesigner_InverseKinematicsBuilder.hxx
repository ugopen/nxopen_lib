...
namespace NXOpen
{
    ...
    namespace AnimationDesigner
    {
        ...
        /** Represents a @link AnimationDesigner::InverseKinematicsBuilder AnimationDesigner::InverseKinematicsBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::AnimationDesigner::AnimationDesignerManager::CreateInverseKinematicsBuilder  NXOpen::AnimationDesigner::AnimationDesignerManager::CreateInverseKinematicsBuilder @endlink  <br> 
