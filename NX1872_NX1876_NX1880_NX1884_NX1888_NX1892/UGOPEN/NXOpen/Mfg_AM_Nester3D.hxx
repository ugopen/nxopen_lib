...
namespace NXOpen
{
    ...
    namespace Mfg
    {
        namespace AM
        {
            ...
            2.5 (millimeters part), 2.5 (inches part) </td> </tr> 

            <tr><td> 
             
            BottomDistance </td> <td> 
            ...
            InterlockingType </td> <td> 
             
            AllowInterlocks </td> </tr> 
            ...
            */
            class MFGAMOPENCPPEXPORT  Nester3D : public NXOpen::Builder
            {
                ...
                /**Returns  the parts to nest 
                 <br>  Created in NX1872.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::SelectNXObjectList * PartsToNest
                (
                );
            };
        }
