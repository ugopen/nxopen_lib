...
namespace NXOpen
{
    ...
    namespace Markup
    {
        ...
        /**
             ...
             <br> To create a new instance of this class, use @link NXOpen::Markup::AnnotationCollection::CreateEllipse  NXOpen::Markup::AnnotationCollection::CreateEllipse @endlink  <br> 
         <br>  Created in NX10.0.0.  <br>  
        */
        class NXOPENCPP_MARKUPEXPORT  Ellipse : public NXOpen::Markup::Annotation
        {
