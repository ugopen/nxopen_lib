...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        BaseCurveFitData.CurveJoinMethod </td> <td> 
         
        No </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.Degree </td> <td> 
         
        7 </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.FitMethod </td> <td> 
         
        KeepParameterization </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.IsAdvancedFit </td> <td> 
         
        0 </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.IsAlignShape </td> <td> 
         
        0 </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.MaximumDegree </td> <td> 
         
        7 </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.MaximumSegments </td> <td> 
         
        1 </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.MinimumDegree </td> <td> 
         
        5 </td> </tr> 

        <tr><td> 
         
        BaseCurveFitData.Segments </td> <td> 
        ...
        TrimCurveFitData.FitMethod </td> <td> 
