...
namespace NXOpen
{
    ...
    public:
        ...
        **/
        ...
        NXStringMode NX_DEPRECATED("Deprecated in NX12.0.0. Use GetMode() instead") getMode() const
        {
            return GetMode();
        }        
        ...
        const NX_DEPRECATED("Deprecated in NX12.0.0. Use GetText() instead") char *getText() const
        {
            return GetText();
        }        
        ...
        const NX_DEPRECATED("Deprecated in NX12.0.0. Use GetLocaleText() instead") char *getLocaleText() const
        {
        ...
        const NX_DEPRECATED("Deprecated in NX12.0.0. Use GetUTF8Text() instead") char *getUTF8Text() const
        {
            return GetUTF8Text();
        }
