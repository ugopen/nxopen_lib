            ...
            */
            class NXOPENCPP_CAEEXPORT  Folder : public NXOpen::NXObject
            {
                ...
                /** Create @link CAE::Connections::SpotWeld CAE::Connections::SpotWeld@endlink  connections in the current @link CAE::Connections::Folder CAE::Connections::Folder@endlink  
                 ...
                 <br>  @deprecated Deprecated in NX1872.0.0.  @link NXOpen::CAE::Connections::Folder::ImportSpotWeldFromWcdWithHeight NXOpen::CAE::Connections::Folder::ImportSpotWeldFromWcdWithHeight@endlink  instead. <br>  

                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: NX_DEPRECATED("Deprecated in NX1872.0.0.  NXOpen::CAE::Connections::Folder::ImportSpotWeldFromWcdWithHeight instead.") std::vector<NXOpen::CAE::Connections::SpotWeld *> ImportSpotWeldFromWcd
                (
