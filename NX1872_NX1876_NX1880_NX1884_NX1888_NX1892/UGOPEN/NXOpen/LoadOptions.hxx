    ...
    class NXOPENCPPEXPORT  LoadOptions
    {
        ...
        */
        ...
        /** Option to control how much data is loaded from parts.  The first four settings are equivalent
                ...
                The following property can only be used in combination with minimal loading when NX is connected to a Teamcenter database.
                @link NXOpen::LoadOptions::SetGenerateMissingPartFamilyMembers NXOpen::LoadOptions::SetGenerateMissingPartFamilyMembers@endlink 
