    ...
    */
    class NXOPENCPPEXPORT  Expression : public NXOpen::NXObject
    {
        ...
        /**Returns  the expression as a string in the form: "name = formula".
                Replaces @link Equation Equation @endlink and @link SetEquation SetEquation @endlink  for new applications code.
        ...
        /** Get the formula part of the expression string: "name = formula".
                Replaces @link RightHandSide RightHandSide @endlink and @link SetRightHandSide SetRightHandSide @endlink  for new application code.
             @return  
