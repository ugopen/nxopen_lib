        ...
        */
        class NXOPENCPP_CAEEXPORT  AfuData : public NXOpen::TransientObject
        {
            ...
            public: enum AbscissaType
            {
                ...
                AbscissaTypeSequence/** The abscissa value is a sequence and input by user. Deprecated in NX13.0; This enum type has no replacement. It is no longer supported. */
            };
