        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MechatronicsBuilder : public NXOpen::Motion::MotionBuilder, public virtual NXOpen::IExternalFileReferencer
        {
            ...
            /**Returns  the model file - a file path to a MATLAB generated DLL or to an Amesim ame file 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") NXString ModelFile
            (
            );
            /**Sets  the model file - a file path to a MATLAB generated DLL or to an Amesim ame file 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") void SetModelFile
            (
            ...
            /**Returns  the header file - matlab speciffic header file, that contains the definition of the interface (inputs, outputs) 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") NXString HeaderFile
            (
            );
            /**Sets  the header file - matlab speciffic header file, that contains the definition of the interface (inputs, outputs) 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::IExternalFileReferencer::GetExternalFileReferenceAdapter") void SetHeaderFile
            (
                const NXString & filename /** filename */ 
            );
            /**Sets  the header file - matlab speciffic header file, that contains the definition of the interface (inputs, outputs) 
            ...
            /**Returns  the input ports list 
             <br>  @deprecated Deprecated in NX1872.0.0.  Use @link NXOpen::Motion::MechatronicsBuilder::InputPortsListAmesimAndSimulink NXOpen::Motion::MechatronicsBuilder::InputPortsListAmesimAndSimulink@endlink  <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use NXOpen::Motion::MechatronicsBuilder::InputPortsListAmesimAndSimulink") NXOpen::Motion::InputPortAssociationList * InputPortsList
            (
            );
