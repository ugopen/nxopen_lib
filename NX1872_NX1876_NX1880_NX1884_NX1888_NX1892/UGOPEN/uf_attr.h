 ...
 *
 * NOTE: The UF_ATTR_iterator_t structure must be initialized using 
 *       UF_ATTR_init_user_attribute_iterator before use.
 *
 * Replaces: UF_ATTR_ask_lock
 *
 * Environment: Internal and External
 * See Also:  UF_ATTR_init_user_attribute_iterator
 * History: NX11.0
*****************************************************************************/
...
(
    tag_t object,                   /* <I>  The object holding the attribute */
    UF_ATTR_iterator_t *iter,       /* <I/O>  Iterator describing the attribute being queried.
 ...
 * freed (applicable for C/C++ only) after use with UF_ATTR_free_user_attribute_info_array()
 *
...
(
    ...
    UF_ATTR_info_t **info           /* <OF,len:num_attributes,free:UF_ATTR_free_user_attribute_info_array> 
                                            ...
                                            Free (applicable for C/C++ only) using UF_ATTR_free_user_attribute_info_array() after use */
);
