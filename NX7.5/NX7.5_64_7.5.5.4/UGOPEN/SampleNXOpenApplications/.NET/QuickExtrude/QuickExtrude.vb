...
Module NXJournal
    Sub Main()
        ...
        extend1.SetValue(NXInputBox.GetInputString("Set the Start Limit: ", _
                                                      "Extrude Limit", _
                                                      "0"))
        extend2.SetValue(NXInputBox.GetInputString("Set the End Limit: ", _
                                                    "Extrude Limit", _
                                                    "1"))
        '^^^^^^^^^^^^^^^^^^^^^
        ...
        featureOffset1.SetEndOffset("0.25")
