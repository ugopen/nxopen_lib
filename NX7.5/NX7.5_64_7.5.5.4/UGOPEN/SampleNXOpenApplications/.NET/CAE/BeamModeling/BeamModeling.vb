...
Module BeamSection
    ...
    Sub CreateFemPart()
        ...
        Dim point1 As Point = CType(datumCsys1.FindObject("HANDLE R-850"), Point)
        ...
        Dim selectISurface1 As SelectISurface
        ...
        selectISurface1.Value = datumPlane2

        Dim selectIReferenceAxis1 As SelectIReferenceAxis
        ...
        selectIReferenceAxis1.Value = datumAxis2

        Dim datumCsys2 As Features.DatumCsys = CType(feature1, Features.DatumCsys)

        Dim point2 As Point = CType(datumCsys2.FindObject("ENTITY 2 1 1"), Point)

        sketchInPlaceBuilder1.SketchOrigin = point2

        sketchInPlaceBuilder1.PlaneOption = Sketch.PlaneOption.Inferred
        ...
        fileNew2.Application = FileNewApplication.CaeFem
        ...
        Dim body1 As Body = CType(part1.Bodies.FindObject("CONE(2)"), Body)

        bodies1(0) = body1
        Dim description1(-1) As String
        femPart2.FinalizeCreation(part1, "fem_i.prt", CAE.FemPart.UseBodiesOption.VisibleBodies, bodies1, femSynchronizeOptions1, "NX NASTRAN", "Structural", description1)
        ...
        Dim plane1 As Plane
        plane1 = workFemPart.Planes.CreatePlane(origin1, normal1, SmartObject.UpdateOption.WithinModeling)
        ...
        Dim xform2 As Xform
        xform2 = workFemPart.Xforms.CreateXform(origin2, xDirection1, yDirection1, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim xform3 As Xform
        xform3 = workFemPart.Xforms.CreateXform(origin3, xDirection2, yDirection2, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim plane2 As Plane
        plane2 = workFemPart.Planes.CreatePlane(origin4, normal2, SmartObject.UpdateOption.WithinModeling)
        ...
        associativeLineBuilder2.Angle.RightHandSide = "0"
        ...
        associativeLineBuilder3.Angle.RightHandSide = "0"
        ...
        Dim xform4 As Xform
        xform4 = workFemPart.Xforms.CreateXform(origin6, xDirection3, yDirection3, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim xform5 As Xform
        xform5 = workFemPart.Xforms.CreateXform(origin7, xDirection4, yDirection4, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim plane4 As Plane
        plane4 = workFemPart.Planes.CreatePlane(origin8, normal4, SmartObject.UpdateOption.WithinModeling)
        ...
        associativeLineBuilder4.Angle.RightHandSide = "0"
        ...
        associativeLineBuilder5.Angle.RightHandSide = "0"
        ...
        Dim xform6 As Xform
        xform6 = workFemPart.Xforms.CreateXform(origin10, xDirection5, yDirection5, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim xform7 As Xform
        xform7 = workFemPart.Xforms.CreateXform(origin11, xDirection6, yDirection6, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim plane6 As Plane
        plane6 = workFemPart.Planes.CreatePlane(origin12, normal6, SmartObject.UpdateOption.WithinModeling)
        ...
        associativeLineBuilder6.Angle.RightHandSide = "0"
        ...
        associativeLineBuilder7.Angle.RightHandSide = "0"
        ...
        Dim xform8 As Xform
        xform8 = workFemPart.Xforms.CreateXform(origin14, xDirection7, yDirection7, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim xform9 As Xform
        xform9 = workFemPart.Xforms.CreateXform(origin15, xDirection8, yDirection8, SmartObject.UpdateOption.AfterModeling, 1.0)
        ...
        Dim plane8 As Plane
        plane8 = workFemPart.Planes.CreatePlane(origin16, normal8, SmartObject.UpdateOption.WithinModeling)
        ...
        associativeLineBuilder8.Angle.RightHandSide = "0"
