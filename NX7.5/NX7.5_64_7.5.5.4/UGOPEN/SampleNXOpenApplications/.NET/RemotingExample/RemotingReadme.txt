...
sleep state) should should only peform the following operations:
     - Setting up Remoting 
...
- In the Client C# project, run the Client.exe.  This will create a new part with some simple curves.  
You may need to zoom out to see the curves created.
