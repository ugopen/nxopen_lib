...
'     This program will cycle through all the face milling operations in the part and
'     set the tool axis normal to first face, the new default in NX 6.
'
'     This can be used as a boiler plate to set other Face Milling Operation parameters.
' ============================================================================
...
Module FaceMilling
    ...
    Function cycle_cb(ByVal camObjectTag As Tag, ByVal ptr As IntPtr) As Boolean
        ...
        If TypeOf camObject Is CAM.Operation Then
            ...
            Dim operationBuilder As CAM.PlanarOperationBuilder

            If operationSubtype = 261 Then         ' This is a Face Milling Operation so create a Face Milling Builder
            ...
            If operationBuilder IsNot Nothing Then
                ...
                ' Set the tool axis
                operationBuilder.ToolAxis.ToolAxis = CAM.PmopToolAxisCiBuilder.ToolAxisTypes.NormalToFirstFace
