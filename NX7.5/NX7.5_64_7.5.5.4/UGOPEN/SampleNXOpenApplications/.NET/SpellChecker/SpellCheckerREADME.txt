...
- Add a reference to:
  ...
  To do this,
   ...
   -The Microsoft Word Object Library is under the .Net tab on the Add Reference form.  
    Find and highlight the Microsoft.Office.Interop.Word library, click Select and then OK on the Add Reference form.
    For Windows 64, the library is under the COM tab, and is called Microsoft Word Object Library.
   
   NOTE: For Visual Studio 2005, change the Imports statement for Word in  WordSpellChecker.vb.
   Comment the "Imports Word" and uncomment the "Imports" lines below it.
