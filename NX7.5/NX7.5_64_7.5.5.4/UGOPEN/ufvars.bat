...
rem        e.g.  
rem             ufvar.bat                        -- Setup build environment considering current directory as NX installation directory
rem             ufvar.bat %UGII_BASE_DIR%        -- Setup build environment considering %UGII_BASE_DIR% as NX installation directory for OS platform
rem             ufvar.bat %UGII_BASE_DIR% 32    -- Setup build environment considering %UGII_BASE_DIR% as NX installation directory for 32-bit platform
rem             ufvar.bat %UGII_BASE_DIR% 64  -- Setup build environment considering %UGII_BASE_DIR% as NX installation directory for 64-bit platform
rem             ufvar.bat 64                -- Setup build environment considering current directory as NX installation directory for 64-bit platform
set force32=
set force64=
set base=
for %%i in (%*) do (
