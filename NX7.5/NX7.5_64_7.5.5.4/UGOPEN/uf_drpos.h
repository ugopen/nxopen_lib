...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_create_local_lift(
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_create_final_lift(
UF_DRPOS_id_t drpos  /* <I>
                     Identifier for a DRPOS object
                     */
);
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_create_cut(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double pos[3] ,/* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_create_first_cut(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double pos[3] ,/* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_create_stepover(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double pos[3] ,/* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_type(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_set_position(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double pos[3]  /* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_position(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double pos[3]  /* <O>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_set_tool_axis(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
...
History:
 *************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_tool_axis(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
...
History:
 *************************************************************************/
extern UFUNEXPORT int UF_DRPOS_set_proj_vec(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double proj_vec[3]  /* <I>
...
History:
 *************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_proj_vec(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double proj_vec[3]  /* <O>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_set_drive_direction(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double dir[3]  /* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_drive_direction(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
double dir[3]  /* <O>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_set_zig_zag_dir(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_zig_zag_dir(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_set_custom_feed(
UF_DRPOS_id_t drpos ,/* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_custom_feed(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
UF_DRPOS_feed_use_t * feed_use ,/* <I>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_user_data(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
void * user_data  /* <O>
...
History:
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_set_user_data(
UF_DRPOS_id_t drpos ,/* <I>
                     Identifier for a DRPOS object
                     */
void * user_data  /* <I>
 ...
 *************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_grid_params(
...
History:  Released in NX3
 *************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_surface_params(
UF_DRPOS_id_t drpos ,   /* <I> Identifier for a DRPOS object  */
double        uv[2]     /* <O>  U,V parameters at the input drive position  */
);
...
History:  Released in NX3
 **************************************************************************/
extern UFUNEXPORT int UF_DRPOS_ask_surface_identifier (
    UF_DRPOS_id_t drpos,   /*  <I> Identifier for a DRPOS object  */
 ...
 ****************************************************************************/
extern UFUNEXPORT int UF_DRPOS_delete
(
    UF_DRPOS_id_t  drpos /* <I> */
);
