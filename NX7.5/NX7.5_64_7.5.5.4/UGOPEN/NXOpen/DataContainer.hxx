...
namespace NXOpen
{
    ...
    /**Represents a list of data. The data is associated with the unique string using which data can
            be accessed and modified. In addition, new data can be added to the existing container\list.*/
    class NXOPENCPPEXPORT  DataContainer : public PropertyContainer
    {
        ...
        /**Adds the integer value in the container. The value is associated with the unique property name. <br> License requirements : None */
        ...
        /**Adds the logical value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddLogical
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            bool value /**Value to add for given property name.*/
        );
        /**Adds the double value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddDouble
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            double value /**Value to add for given property name.*/
        );
        /**Adds the string value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddString
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXString & value /**Value to add for given property name.*/
        );
        /**Adds the enum members in the container. The enum is associated with the unique property name. <br> License requirements : None */
        public: void AddEnum
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            std::vector<NXString> & stringArray /**Value to add for given property name.*/
        );
        /**Adds the strings value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddStrings
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            std::vector<NXString> & stringArray /**Value to add for given property name.*/
        );
        /**Adds the point value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddPoint
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXOpen::Point3d & pointSc /**Value to add for given property name.*/
        );
        /**Adds the vector value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddVector
        (
            const NXString & propertyName /**Name of the property  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const NXOpen::Vector3d & vector /**Value to add for given property name.*/
        );
        /**Adds the bits value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddBits
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            int bitsSc /**Value to add for given property name.*/
        );
        /**Adds the tagged object in the container. The added object is associated with the unique property name. <br> License requirements : None */
        public: void AddTaggedObject
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            NXOpen::TaggedObject * taggedSc /**Value to add for given property name.*/
        );
        /**Adds the integer vector in the container. The value is associated with the unique property name. <br> License requirements : None */
        ...
        public:  NX_DEPRECATED("Deprecated in NX7.5.3") void AddDoubleVector
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const std::vector<int> & doubleVector /**Value to add for given property name.*/
        );
        /**Adds the double vector in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddDoubleVector
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            const std::vector<double> & doubleVector /**Value to add for given property name.*/
        );
        /**Adds the tagged object vector in the container. The value is associated with the unique property name. <br> License requirements : None */
        ...
        /**Adds the value in the container. The value is associated with the unique property name. <br> License requirements : None */
        public: void AddFile
        (
            const NXString & propertyName /**Name of the property.  <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
