    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT  PierceTaskBuilder : public Features::FeatureBuilder
        {
            ...
            /** Sets the pierce bounds of the pierce task. 
                    Note - @link Die::PierceTaskBuilder::SetTippedProduct Die::PierceTaskBuilder::SetTippedProduct@endlink  needs to be called before this function.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
