...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        class NXOPENCPPEXPORT  CgfxMattexBuilder : public Builder
        {
            ...
            */
            public:  NX_DEPRECATED("Deprecated in NX7.5.2") enum TextureSpace
            {
            ...
            /**Returns  the texture space type.
                     <br> NOTE: These APIs are deprecated. Please use get and setTextureSpaceShaderType.   <br> 
            ...
            /** This is used to update the materials in part palette entry  <br> License requirements : None */
