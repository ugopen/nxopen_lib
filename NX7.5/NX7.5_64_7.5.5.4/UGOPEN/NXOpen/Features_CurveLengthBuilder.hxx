        ...
        */
        class NXOPENCPPEXPORT  CurveLengthBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the original curve option
             ...
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0") void SetOriginalCurveOption
            (
            ...
            /**Returns  the original curve option
             ...
             @deprecated Deprecated in NX5.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0") NXOpen::Features::OriginalCurve OriginalCurveOption
            (
            );
            /**Sets  the associativity
             ...
             @deprecated Deprecated in NX5.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0") void SetAssociativity
            (
            ...
            /**Returns  the associativity
             ...
             @deprecated Deprecated in NX5.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0") bool Associativity
            (
            );
