    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT  PiercingInsertBuilder : public Builder
        {
            ...
            /**Returns  the type of piercing insert.  <br> License requirements : None */
            public: NXOpen::Tooling::PiercingInsertBuilder::Types Type
            (
            );
            /**Sets  the type of piercing insert.  <br> License requirements : None */
            public: void SetType
            (
            ...
            /**Returns  the select die insert for cavity.  <br> License requirements : None */
            public: NXOpen::SelectBodyList * SelectDieInsertForCavity
            (
            );
            /**Returns  the die insert type.  <br> License requirements : None */
            public: NXOpen::Tooling::PiercingInsertBuilder::DieInsertTypeItems DieInsertType
            (
            );
            /**Sets  the die insert type.  <br> License requirements : None */
            ...
            /**  Load standard die insert for normal pierce design.  <br> License requirements : None */
            public: void NormalLoadDie
            (
            );
            /** Create datum plane for user defined die or backing insert outline.  <br> License requirements : None */
            public: void CreateUserDefinedInsertDatumPlane
            (
            );
            /**Returns  the select die insert outline.  <br> License requirements : None */
            public: NXOpen::Section * SelectDieInsertOutline
            (
            );
            /**Returns  the user defined die insert height.  <br> License requirements : None */
            public: NXOpen::Expression * UserDefinedDieInsertHeight
            (
            );
            /**Returns  the user defined die insert clearance.  <br> License requirements : None */
            public: double UserDefinedDieInsertClearance
            (
            );
            /**Sets  the user defined die insert clearance.  <br> License requirements : None */
            ...
            /**Returns  the selected user defined die insert to edit.  <br> License requirements : None */
            public: NXOpen::SelectBodyList * SelectUserDefinedDieInsertForEdit
            (
            );
            /** Create user defined die insert or backing insert for selected scraps.  <br> License requirements : None */
            ...
            /**Returns  the user defined punch penetration.  <br> License requirements : None */
            public: double UserDefinedPunchPenetration
            (
            );
            /**Sets  the user defined punch penetration.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket toggle for punch plate.  <br> License requirements : None */
            public: bool PunchPocketToggleForPP
            (
            );
            /**Sets  the punch pocket toggle for punch plate.  <br> License requirements : None */
            public: void SetPunchPocketToggleForPP
            (
                bool punchPocketToggleForPP /** Indicates whether to create punch pocket in punch plate */
            );
            /**Returns  the punch pocket type in punch plate.  <br> License requirements : None */
            public: NXOpen::Tooling::PiercingInsertBuilder::PunchPocketTypeItemsPP PunchPocketTypeInPP
            (
            );
            /**Sets  the punch pocket type in punch plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket clearance for punch plate.  <br> License requirements : None */
            public: double PunchPocketClearanceForPP
            (
            );
            /**Sets  the punch pocket clearance for punch plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket toggle for backing plate.  <br> License requirements : None */
            public: bool PunchPocketToggleForBP
            (
            );
            /**Sets  the punch pocket toggle for backing plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket type in backing plate.  <br> License requirements : None */
            public: NXOpen::Tooling::PiercingInsertBuilder::PunchPocketTypeItemsBP PunchPocketTypeInBP
            (
            );
            /**Sets  the punch pocket type in backing plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket clearance for backing plate.  <br> License requirements : None */
            public: double PunchPocketClearanceForBP
            (
            );
            /**Sets  the punch pocket clearance for backing plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket toggle for stripper plate.  <br> License requirements : None */
            public: bool PunchPocketToggleForSP
            (
            );
            /**Sets  the punch pocket toggle for stripper plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket type in stripper plate.  <br> License requirements : None */
            public: NXOpen::Tooling::PiercingInsertBuilder::PunchPocketTypeItemsSP PunchPocketTypeInSP
            (
            );
            /**Sets  the punch pocket type in stripper plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket clearance for stripper plate.  <br> License requirements : None */
            public: double PunchPocketClearanceForSP
            (
            );
            /**Sets  the punch pocket clearance for stripper plate.  <br> License requirements : None */
            ...
            /**Returns  the punch pocket height in the stripper plate.  <br> License requirements : None */
            public: double PunchPocketHeightInSP
            (
            );
            /**Sets  the punch pocket height in the stripper plate.  <br> License requirements : None */
            ...
            /** Add standard stripper insert.  <br> License requirements : None */
            ...
            /**Returns  the value indicating if the design is for a concept. True indicates it is a concept design.  <br> License requirements : None */
            public: bool ConceptDesign
            (
            );
            /**Sets  the value indicating if the design is for a concept. True indicates it is a concept design.  <br> License requirements : None */
            public: void SetConceptDesign
            (
                bool conceptDesign /** Indicates whether it is a concept design */
            );
            /**Returns  the option of whether to create false body for die\backing insert.  <br> License requirements : None */
            public: bool SettingWithoutFalseBody
            (
            );
            /**Sets  the option of whether to create false body for die\backing insert.  <br> License requirements : None */
            ...
            /**Returns  the selection of the scrap to create association.  <br> License requirements : None */
            public: NXOpen::SelectBodyList * SelectAssociationScrap
            (
            );
            /**Returns  the selection of the inserts to create association.  <br> License requirements : None */
            public: NXOpen::SelectBodyList * SelectAssociationInsert
            (
            );
            /**Returns  the select scrap or insert for association update.  <br> License requirements : None */
            ...
            /** Link the selected insert with the selected scrap.  <br> License requirements : None */
            public: void LinkButton
            (
            );
            /**Returns  the parent part name to create insert.  <br> License requirements : None */
            public: NXString ParentPartName
            (
            );
            /**Sets  the parent part name to create insert.  <br> License requirements : None */
            public: void SetParentPartName
            (
                const NXString & parentPart /** Specifies the parent part name */
            );
            /**Returns  the new component names.  <br> License requirements : None */
            public: NXString NewPartNames
            (
            );
            /**Sets  the new component names.  <br> License requirements : None */
