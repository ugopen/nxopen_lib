    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  MoveFaceBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the copy option for move face, don't use it until nx502  <br> License requirements : None */
            public: bool Copy
            (
            );
            /**Sets  the copy option for move face, don't use it until nx502  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCopy
            (
