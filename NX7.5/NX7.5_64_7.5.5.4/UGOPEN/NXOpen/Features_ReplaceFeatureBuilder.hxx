    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  ReplaceFeatureBuilder : public Builder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.2") bool KeepFeatureToReplace
            (
            );
            /**Sets  the indication on whether to keep the original feature or not. True indicates the feature should be kept. 
             @deprecated Deprecated in NX7.5.2 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.2") void SetKeepFeatureToReplace
            (
                bool keepFeatureToReplace /** keepfeaturetoreplace */ 
            );
            /**Returns  the indication on whether to delete the original feature or not. True indicates the feature should be deleted.  <br> License requirements : None */
            public: bool DeleteOriginalFeature
            (
            );
            /**Sets  the indication on whether to delete the original feature or not. True indicates the feature should be deleted.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
