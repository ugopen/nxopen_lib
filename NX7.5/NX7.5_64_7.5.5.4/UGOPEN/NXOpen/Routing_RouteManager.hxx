...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT  RouteManager
        {
            ...
            /** Prints the Netlist content history to the Listing Window  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: void ViewNetlistHistory
            (
            );
            /** Erases the Netlist content history from the work part  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Finds the duplicate Routing Control Points (RCPs) within given tolerance and
                        merges them. Call @link Update::DoUpdate Update::DoUpdate@endlink  afterwards to ensure that
                        the duplicates are deleted.
             @deprecated Deprecated in NX7.5.1 <br> 
             <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.1") void MergeDuplicateRcps
            (
            ...
            /** Finds the duplicate Routing Control Points (RCPs) within given tolerance and
                        merges them. Call @link Update::DoUpdate Update::DoUpdate@endlink  afterwards to ensure that
                        the duplicates are deleted. @return  If RCPs are merged returns TRUE else FALSE  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a Quick Path builder.  See the documentation in the
                        @link Routing::QuickPathBuilder Routing::QuickPathBuilder@endlink  class for a description of
                        the builder.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::QuickPathBuilder * CreateQuickPathBuilder
            (
            );
            /** Creates a @link Routing::DesignRuleViolationViewer Routing::DesignRuleViolationViewer@endlink .
                     @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a  @link Routing::DeleteObjectsBuilder Routing::DeleteObjectsBuilder@endlink  for deleting routing objects.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a  @link Routing::InfoObjectsBuilder Routing::InfoObjectsBuilder@endlink  for deleting routing objects.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::InfoObjectsBuilder * CreateInfoObjectsBuilder
            (
                const std::vector<NXOpen::NXObject *> & objects /** Routing objects to delete */
            );
            /** Creates a  @link Routing::ConnectedCurvesBuilder Routing::ConnectedCurvesBuilder@endlink  for building segments
                      on end-to-end connected curves.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::ConnectedCurvesBuilder * CreateConnectedCurvesBuilder
            (
            );
            /** Creates a  @link Routing::SimplifyPathBuilder Routing::SimplifyPathBuilder@endlink  that combines the
                        collinear segments by merging RCPs.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a  @link Routing::EditLineSegmentBuilder Routing::EditLineSegmentBuilder@endlink  for editing and locking
                        the length of line segments.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::EditLineSegmentBuilder * CreateEditLineSegmentBuilder
            (
                NXOpen::Routing::LineSegment * line /** The segment
                                                                                                    to edit. */
            );
            /** Creates a @link Routing::SubdivideSegmentBuilder Routing::SubdivideSegmentBuilder@endlink  that can
            ...
            /** Creates a @link Routing::SplinePathBuilder Routing::SplinePathBuilder@endlink  which creates
                        D-Cubed constrainted splines.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a builder than can create or edit stock offset points.  This builder
                        ...
                        a stock offset point to a normal point.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** FIXME  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::AssignCornerBuilder Routing::AssignCornerBuilder@endlink  which creates corner @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a Space Reservation builder.  See the documentation in the
                        @link Routing::SpaceReservationBuilder Routing::SpaceReservationBuilder@endlink  class for a description of
                        the builder.   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::OverstockBuilder Routing::OverstockBuilder@endlink  that can
                        create or edit overstock. @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::OverstockBuilder * CreateOverstockBuilder
            (
                NXOpen::Routing::Overstock * overstock /** Overstock to edit */
            );
            /** Creates a @link Routing::FillerStockBuilder Routing::FillerStockBuilder@endlink   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::StockStyleBuilder Routing::StockStyleBuilder@endlink  which assigns style to stock @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::StockBuilder Routing::StockBuilder@endlink  that can create or edit stock. @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::StockBrowserBuilder Routing::StockBrowserBuilder@endlink  which finds and filters stock @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Copy the overstock from subassembly to parent assembly.
                        ...
                        and recreate them over wavelinked segment at the parent assembly level.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXString CopyOverstock
            (
            );
            /** Creates a @link Routing::RouteSweptTwistBuilder Routing::RouteSweptTwistBuilder@endlink   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::RouteSweptFoldBuilder Routing::RouteSweptFoldBuilder@endlink .    @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::StockColorBuilder Routing::StockColorBuilder@endlink  which assigns color to the face of stocks
                        having rectangular cross sections
                     @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::StockColorBuilder * CreateStockColorBuilder
            (
            );
            /** Creates a @link Routing::CopeCornerBuilder Routing::CopeCornerBuilder@endlink .  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::CopeCornerBuilder * CreateCopeCornerBuilder
            (
                NXOpen::NXObject * selectedPoint /** Routing Control Point */
            );
            /** Creates a @link Routing::RemoveDiscontinuityBuilder Routing::RemoveDiscontinuityBuilder@endlink  which removes
                        selected discontinuity corners  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::UnifyPathBuilder Routing::UnifyPathBuilder@endlink  which replaces given stocks
                        and fittings based on the new @link Routing::CharacteristicList Routing::CharacteristicList@endlink .
                        Useful for unifying all of the stocks and components (e.g. elbows and tees) in
                        a path to the same characteristics.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::ClockPartBuilder Routing::ClockPartBuilder@endlink . for the rotation of
                        component.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::ClockPartBuilder * CreateClockPartBuilder
            (
                NXOpen::NXObject * selectedPort /** Routing Port */
            );
            /** Creates a @link Routing::ConnectPathBuilder Routing::ConnectPathBuilder@endlink  which connects path @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::ConnectPathBuilder * CreateConnectPathBuilder
            (
            );
            /** Creates a @link Routing::OverstockFacesBuilder Routing::OverstockFacesBuilder@endlink  to qualify faces
                        of fittings for overstock application @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::OverstockFacesBuilder * CreateOverstockFacesBuilder
            (
            );
            /** Creates @link Routing::Electrical::CablewaysBuilder Routing::Electrical::CablewaysBuilder@endlink .  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::EditCharacteristicsBuilder Routing::EditCharacteristicsBuilder@endlink  that edits
                        the Required and Optional @link Routing::CharacteristicList Routing::CharacteristicList@endlink 
                        (UG attribute values) of @link Routing::Stock Routing::Stock@endlink  or
                        @link Assemblies::Component Assemblies::Component@endlink .  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::PlacePartBuilder Routing::PlacePartBuilder@endlink  that is used to place
                        a routing part into an assembly.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a placement solutions builder used to position a part that has been placed in the assembly.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::PlacementSolutionsBuilder * CreatePlacementSolutionsBuilder
            (
            );
            /** Creates a @link Routing::StockTransitionBuilder Routing::StockTransitionBuilder@endlink  that can create or edit stockTransition. @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::FittingOverstockBuilder Routing::FittingOverstockBuilder@endlink  that applies
                        or edits overstock on fittings. @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a @link Routing::ModelTerminalsBuilder Routing::ModelTerminalsBuilder@endlink  which Models Terminal @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::ModelTerminalsBuilder * ModelTerminalsBuilder
            (
            );
            /** Creates a @link Routing::TerminalPortBuilder Routing::TerminalPortBuilder@endlink   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::TerminalPortBuilder * TerminalPortBuilder
            (
            );
            /** Creates a @link Routing::AssignDiscontinuityBuilder Routing::AssignDiscontinuityBuilder@endlink   @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::AssignDiscontinuityBuilder * CreateAssignDiscontinuityBuilder
            (
                NXOpen::NXObject * selectedPoint /** Routing Control Point */
            );
            /** Creates a @link Routing::ManualRouteBuilder Routing::ManualRouteBuilder@endlink  that can create or edit stockTransition. @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates a Split Duct builder.  See the documentation in the
                        @link Routing::SplitDuctBuilder Routing::SplitDuctBuilder@endlink  class for a description of
                        the builder.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Routing::SplitDuctBuilder * CreateSplitDuctBuilder
            (
            );
            /** Creates a Divisions builder.  See the documentation in the
                        @link Routing::DivisionsBuilder Routing::DivisionsBuilder@endlink  class for a description of
                        the builder.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Creates an Edit Bend Angle builder.  See the documentation in the
                        @link Routing::EditBendAngleBuilder Routing::EditBendAngleBuilder@endlink  class for a description of
                        the builder.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Generates the cableways layout data (cable center points) using the
                        default bin-packing algorithm.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") */
            ...
            /** Returns all of the Built-in path components in the current part  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: void GetAllBIPComponents
            (
                std::vector<NXOpen::Assemblies::Component *> & components /** components */ 
            );
            /** Determines whether or not a built-in path component has proper work part geometry. @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Finds all bip components which do not have referencing built-in path updaters and creates them.
                        This may also involve creating the workpart geometry for the Built-in path if needed.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: void PromoteBIPGeometry
            (
                NXOpen::Assemblies::Component * bipComponent /** bipcomponent */ 
            );
            /** Creates a new @link Routing::RunItem Routing::RunItem@endlink .
                        Use @link Routing::RunCollection::CreateRun Routing::RunCollection::CreateRun@endlink  to create a new run with this new item.
                        Use @link Routing::Run::Edit Routing::Run::Edit@endlink  to add this new item to an existing run.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Returns the @link Routing::ReuseLibrary Routing::ReuseLibrary@endlink  object*/
