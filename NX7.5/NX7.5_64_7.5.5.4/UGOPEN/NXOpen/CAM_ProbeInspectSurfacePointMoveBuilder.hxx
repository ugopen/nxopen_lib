...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  ProbeInspectSurfacePointMoveBuilder : public CAM::MoveBuilder
        {
            ...
            /**Returns  the probe axis type  <br> License requirements : None */
            public: NXOpen::CAM::ProbeInspectSurfacePointMoveBuilder::ToolAxis ToolAxisType
            (
            );
            /**Sets  the probe axis type  <br> License requirements : None */
            ...
            /**Sets  the point to probe  <br> License requirements : None */
            public: void SetPoint
            (
                NXOpen::Point * point /** point */ 
            );
            /**Returns  the vector to define probing direction  <br> License requirements : None */
            public: NXOpen::NXObject * Vector
            (
            );
            /**Sets  the vector to define probing direction  <br> License requirements : None */
            public: void SetVector
            (
                NXOpen::NXObject * vector /** vector */ 
            );
            /**Returns  the measurement (axis) type  <br> License requirements : None */
            public: NXOpen::CAM::ProbeInspectSurfacePointMoveBuilder::Measurement MeasurementType
            (
            );
            /**Sets  the measurement (axis) type  <br> License requirements : None */
