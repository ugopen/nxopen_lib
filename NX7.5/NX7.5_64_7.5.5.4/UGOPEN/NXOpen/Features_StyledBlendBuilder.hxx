    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  StyledBlendBuilder : public Features::FeatureBuilder
        {
            ...
            /** Set necessary builder data. This API is used for recording reset all action <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
