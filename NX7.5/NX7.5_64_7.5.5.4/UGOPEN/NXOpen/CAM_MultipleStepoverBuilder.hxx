...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  MultipleStepoverBuilder : public Builder
        {
            ...
            /** Get number of stepovers  @return  the number of stepover  <br> License requirements : cam_base ("CAM BASE") */
            public: int GetNumberOfStepovers
            (
            );
            /** Get item for the specified stepover index <br> License requirements : cam_base ("CAM BASE") */
            public: void GetData
            (
                int index /** the index of item to be modified */,
                int* numOfPasses /** the new value of num of passes */,
