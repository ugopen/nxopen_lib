...
namespace NXOpen
{
    ...
    namespace SIM
    {
        ...
        class NXOPENCPPEXPORT  KinematicComponentBuilder : public Builder
        {
            ...
            /**Returns  the holder id in string  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: NXString HolderIdString
            (
            );
            /**Sets  the holder id in string  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
