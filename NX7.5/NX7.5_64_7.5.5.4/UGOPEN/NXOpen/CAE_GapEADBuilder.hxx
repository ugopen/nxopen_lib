...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** This class provides Gap Associated Data Support  <br> To create a new instance of this class, use @link CAE::NodeElementManager::CreateGapEadBuilder CAE::NodeElementManager::CreateGapEadBuilder@endlink  <br> */
        class NXOPENCPPEXPORT  GapEADBuilder : public Builder
        {
