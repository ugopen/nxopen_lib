...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  CorrelSolutionBuilder : public CAE::CorrelBaseBuilder
        {
            ...
            */
            public:  NX_DEPRECATED("Deprecated in NX7.5.2") enum EnumMatchingOptionType
            {
            ...
            /**Returns  the option determining how node-matching occurs 
             @deprecated Deprecated in NX7.5.2 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.2") NXOpen::CAE::CorrelSolutionBuilder::EnumMatchingOptionType NodeMatchingOption
            (
            );
            /**Sets  the option determining how node-matching occurs 
             @deprecated Deprecated in NX7.5.2 <br> 
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.2") void SetNodeMatchingOption
            (
            ...
            /**Returns  the node map size limit  <br> License requirements : None */
            public: int NodeMapSizeLimit
            (
            );
            /**Sets  the node map size limit  <br> License requirements : nx_correl_base ("FE Correlation") */
            ...
            /**Returns  the rigid-body filtering option for work modes - deprecated, use low-frequency filtering option instead 
             ...
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") bool RigidBodyFilteringMode
            (
            );
            /**Sets  the rigid-body filtering option for work modes - deprecated, use low-frequency filtering option instead 
             @deprecated Deprecated in NX6.0.2 <br> 
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") void SetRigidBodyFilteringMode
            (
            ...
            /**Returns  the rigid-body cutoff frequency for work modes - deprecated, use low-frequency cutoff instead 
             @deprecated Deprecated in NX6.0.2 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") double RigidBodyCutoffFrequency
            (
            );
            /**Sets  the rigid-body cutoff frequency for work modes - deprecated, use low-frequency cutoff instead 
             @deprecated Deprecated in NX6.0.2 <br> 
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") void SetRigidBodyCutoffFrequency
            (
