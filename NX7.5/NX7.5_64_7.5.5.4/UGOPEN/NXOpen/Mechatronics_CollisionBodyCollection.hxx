...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        class NXOPENCPPEXPORT  CollisionBodyCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Mechatronics::CollisionBodyBuilder Mechatronics::CollisionBodyBuilder@endlink .  @return   <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            /** Finds the @link  Mechatronics::CollisionBody   Mechatronics::CollisionBody @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  Mechatronics::CollisionBody   Mechatronics::CollisionBody @endlink  with this name.  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
