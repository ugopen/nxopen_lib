...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT  Feature : public NXObject, public virtual IProfile, public virtual IFitTo
        {
            ...
            /** Queries a feature for list of its sections  @return  Array of sections  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: std::vector<NXOpen::Section *> GetSections
            (
            );
            /** Set a feature group as active group. If input is ja_NULL, set no feature group active  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
