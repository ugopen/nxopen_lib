...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  Session : public BaseSession
    {
        ...
        /** Undo to last visible mark. This will not delete the undo mark. Use 
                @link UndoLastNVisibleMarks UndoLastNVisibleMarks@endlink  to delete the undo mark also.  <br> License requirements : None */
        ...
        /** Create the Inspection session  <br> License requirements : None */
        public: void CreateInspectionSession
        (
        );
        /** Check if the Inspection session is initialized  @return   <br> License requirements : None */
        ...
        /** Returns the value of a NX enviroment variable   @return  the value assigned to this environment variable  <br> License requirements : None */
        ...
        /** sets the value of a NX enviroment variable   <br> License requirements : None */
        ...
        /**  Enable redo for NXOpen programs. As default redo is enabled in NX.
             ...
             @return  Returns previous redo state <br> License requirements : None */
        public: bool EnableRedo
        (
            bool enableRedo /**True will enable redo for NXOpen programs. False should disable the redo for NXOpen programs*/
        );
