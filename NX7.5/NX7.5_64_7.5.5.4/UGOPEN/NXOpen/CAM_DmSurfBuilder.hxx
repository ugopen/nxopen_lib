...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  DmSurfBuilder : public TaggedObject
        {
            ...
            /** Set the cut direction  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCutDirection
            (
                NXOpen::CAM::DmSurfBuilder::CutDirection cutDirection /** the value of cut direction */
            );
            /** Get the cut direction  @return  the value of cut direction  <br> License requirements : None */
            public: NXOpen::CAM::DmSurfBuilder::CutDirection GetCutDirection
            (
            );
            /** Set the start first  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSurfacePercentageStartFirst
            (
                double dValue /** the value of start first */
            );
            /** Get the start first  @return  the value of start first  <br> License requirements : None */
            public: double GetSurfacePercentageStartFirst
            (
            );
            /** Set the end first  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSurfacePercentageEndFirst
            (
                double dValue /** the value of end first */
            );
            /** Get the end first  @return  the value of end first  <br> License requirements : None */
            public: double GetSurfacePercentageEndFirst
            (
            );
            /** Set the start step  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSurfacePercentageStartStep
            (
                double dValue /** the value of start step */
            );
            /** Get the start step  @return  the value of start step  <br> License requirements : None */
            public: double GetSurfacePercentageStartStep
            (
            );
            /** Set the end step  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSurfacePercentageEndStep
            (
                double dValue /** the value of end step */
            );
            /** Get the end step  @return  the value of end step  <br> License requirements : None */
            public: double GetSurfacePercentageEndStep
            (
            );
            /** Set the start last  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSurfacePercentageStartLast
            (
                double dValue /** the value of start last */
            );
            /** Get the start last  @return  the value of start last  <br> License requirements : None */
            public: double GetSurfacePercentageStartLast
            (
            );
            /** Set the end last  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSurfacePercentageEndLast
            (
                double dValue /** the value of end last */
            );
            /** Get the end last  @return  the value of end last  <br> License requirements : None */
            public: double GetSurfacePercentageEndLast
            (
            );
            /** The method to flip material side  <br> License requirements : cam_base ("CAM BASE") */
