...
namespace NXOpen
{
    ...
    namespace Facet
    {
        ...
        class NXOPENCPPEXPORT  FacetedBodyCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Facet::BestFitAlignBuilder Facet::BestFitAlignBuilder@endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Facet::BestFitAlignBuilder * CreateBestFitAlignBuilder
            (
            );
            /** Creates a @link Facet::FillHoleBuilder Facet::FillHoleBuilder@endlink   @return   <br> License requirements : None */
            public: NXOpen::Facet::FillHoleBuilder * CreateFillHoleBuilder
            (
            );
            /** Creates a @link Facet::STLImportBuilder Facet::STLImportBuilder@endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Facet::STLImportBuilder * CreateSTLImportBuilder
            (
            );
            /** Creates a @link Facet::DecimateFacetBodyBuilder Facet::DecimateFacetBodyBuilder@endlink   @return   <br> License requirements : nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Facet::DecimateFacetBodyBuilder * CreateDecimateFacetBodyBuilder
            (
            );
            /** Creates a @link Facet::MultiPatchAlignmentBuilder Facet::MultiPatchAlignmentBuilder@endlink   @return   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Facet::MultiPatchAlignmentBuilder * CreateMultiPatchAlignmentBuilder
            (
            );
            /** Creates a @link Facet::SubdivideFacetBodyBuilder Facet::SubdivideFacetBodyBuilder@endlink   @return   <br> License requirements : nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Facet::SubdivideFacetBodyBuilder * CreateSubdivideFacetBodyBuilder
            (
            );
            /** Creates a @link Facet::SmoothFacetBodyBuilder Facet::SmoothFacetBodyBuilder@endlink   @return   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Facet::SmoothFacetBodyBuilder * CreateSmoothFacetBodyBuilder
            (
            );
            /** Creates a @link Facet::SnipFacetBodyBuilder Facet::SnipFacetBodyBuilder@endlink   @return   <br> License requirements : None */
            public: NXOpen::Facet::SnipFacetBodyBuilder * CreateSnipFacetBodyBuilder
            (
            );
            /** Creates a JT @link Facet::FacetedBody Facet::FacetedBody@endlink  using the faceting tolerances specified for the NX session. 
