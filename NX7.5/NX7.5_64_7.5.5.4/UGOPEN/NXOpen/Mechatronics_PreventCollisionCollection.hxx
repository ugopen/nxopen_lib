...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        class NXOPENCPPEXPORT  PreventCollisionCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Mechatronics::PreventCollisionBuilder Mechatronics::PreventCollisionBuilder@endlink .  @return   <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            /** Finds the @link  Mechatronics::PreventCollision   Mechatronics::PreventCollision @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  Mechatronics::PreventCollision   Mechatronics::PreventCollision @endlink  with this name.  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
