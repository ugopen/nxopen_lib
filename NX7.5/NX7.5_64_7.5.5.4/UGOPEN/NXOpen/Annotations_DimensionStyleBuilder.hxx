...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  DimensionStyleBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the dimension limit fit deviation  <br> License requirements : None */
            public: NXString LimitFitDeviation
            (
            );
            /**Sets  the dimension limit fit deviation  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLimitFitDeviation
            (
                const NXString & fitDeviation /** fitdeviation */ 
            );
            /**Returns  the dimension limit fit grade  <br> License requirements : None */
            public: int LimitFitGrade
            (
            );
            /**Sets  the dimension limit fit grade  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLimitFitGrade
            (
                int fitGrade /** fitgrade */ 
            );
            /**Returns  the dimension limit fit display style  <br> License requirements : None */
            public: NXOpen::Annotations::FitDisplayStyle LimitFitDisplayStyle
            (
            );
            /**Sets  the dimension limit fit display style  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLimitFitDisplayStyle
            (
                NXOpen::Annotations::FitDisplayStyle fitDisplayStyle /** fitdisplaystyle */ 
            );
            /**Returns  the dimension limit fit ansi hole type  <br> License requirements : None */
            public: NXOpen::Annotations::FitAnsiHoleType LimitFitAnsiHoleType
            (
            );
            /**Sets  the dimension limit fit ansi hole type  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
