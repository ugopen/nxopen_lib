...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  PhysicalMaterialCollection : public TaggedObjectCollection
    {
        ...
        /** Writes out materials to a material library file.   These materials can be local material definitions or material definitions from other material libraries.  The combination of the material name and library name identify a material definition.  If the material definition is for a local material, the name is specified and the library name is specified as "".  Write access is needed for the Exported library.  <br> License requirements : None */
        ...
        /** Returns the bodies that don't have a material assigned.   <br> License requirements : None */
        public: void FindBodiesWithoutMaterial
        (
            std::vector<NXOpen::TaggedObject *> & objects /** the array of bodies without a material */
        );
        /** Returns true if there are bodies in the specified part that do not have a material assigned to them; false if all bodies in the part have a material assigned.   @return   <br> License requirements : None */
        public: bool AnyBodiesWithoutMaterial
        (
        );
        /** Returns the bodies that are not using the preferred material (either no material assigned or the non-preferred a different material assigned).   <br> License requirements : None */
        ...
        /** Returns true if there are bodies that do not have the preferred material assigned to them and false if all bodies are assigned the preferred material. If there is not a preferred material specified, the return value is true.    @return   <br> License requirements : None */
