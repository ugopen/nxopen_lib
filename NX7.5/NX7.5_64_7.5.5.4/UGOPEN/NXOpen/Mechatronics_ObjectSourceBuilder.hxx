...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        class NXOPENCPPEXPORT  ObjectSourceBuilder : public Builder
        {
            ...
            /**Returns  the object select. This can be a @link RigidBody RigidBody@endlink  or @link Assemblies::ComponentAssembly Assemblies::ComponentAssembly@endlink . <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            public: NXOpen::SelectNXObjectList * ObjectToCopy
            (
            );
            /**Returns  the event option.  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            public: NXOpen::Mechatronics::ObjectSourceBuilder::CopyEventTriggerOption CopyEventTrigger
            (
            );
            /**Sets  the event option.  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            /**Returns  the time interval.  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            public: NXOpen::Expression * TimeInterval
            (
            );
            /**Returns  the start offset.  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
