...
namespace NXOpen
{
    ...
    namespace Facet
    {
        ...
        */
        class NXOPENCPPEXPORT  SubdivideFacetBodyBuilder : public Builder
        {
            /** Subdivision methods */
            ...
            /**Returns  the facet bodies to be subdivided <br> License requirements : None */
            public: NXOpen::Facet::SelectFacetedBodyList * FacetBodies
            (
            );
            /**Returns  an optional list of regions on the facet bodies to be subdivided.  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::BoundaryDefinitionBuilderList * RegionList
            (
            );
            /**Returns  the subdivision method  <br> License requirements : None */
            public: NXOpen::Facet::SubdivideFacetBodyBuilder::SubdivisionMethodType SubdivisionMethod
            (
            );
            /**Sets  the subdivision method  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the interpolation method  <br> License requirements : None */
            public: NXOpen::Facet::SubdivideFacetBodyBuilder::InterpolationMethodType InterpolationMethod
            (
            );
            /**Sets  the interpolation method  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the angular tolerance to detect sharp edges to be kept. Cubic interpolation can not interpolate over an edge of two triangles whose normals differ more than the specified value. Same applies to re-meshing.  <br> License requirements : None */
            public: double AngleThreshold
            (
            );
            /**Sets  the angular tolerance to detect sharp edges to be kept. Cubic interpolation can not interpolate over an edge of two triangles whose normals differ more than the specified value. Same applies to re-meshing.  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetAngleThreshold
            (
                double angleThreshold /** anglethreshold */ 
            );
            /**Returns  the value indicating length of the edge of the polygons to be subdivided. <br> License requirements : None */
            public: double EdgeLength
            (
            );
            /**Sets  the value indicating length of the edge of the polygons to be subdivided. <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetEdgeLength
            (
                double edgeLength /** edgelength */ 
            );
            /**Returns  the value indicating whether to perform a decimation step after the subdivision. <br> License requirements : None */
            public: bool IsOptimize
            (
            );
            /**Sets  the value indicating whether to perform a decimation step after the subdivision. <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetOptimize
            (
                bool isOptimize /** isoptimize */ 
            );
            /**Returns  the value indicating if a copy of the facet body to be subdivided without altering the original.  <br> License requirements : None */
            public: bool IsEditCopy
            (
            );
            /**Sets  the value indicating if a copy of the facet body to be subdivided without altering the original.  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
