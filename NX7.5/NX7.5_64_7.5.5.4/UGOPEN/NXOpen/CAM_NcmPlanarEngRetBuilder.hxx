...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  NcmPlanarEngRetBuilder : public TaggedObject
        {
            ...
            /**Returns  the height from which engage helical/ramp/plunge is measured  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder::MeasureHeightFrom HeightFrom
            (
            );
            /**Sets  the height from which engage helical/ramp/plunge is measured  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the engage/retract plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            public: NXOpen::SmartObject * Plane
            (
            );
            /**Sets  the engage/retract plane,plane entity type covers Xform and Plane  <br> License requirements : cam_base ("CAM BASE") */
