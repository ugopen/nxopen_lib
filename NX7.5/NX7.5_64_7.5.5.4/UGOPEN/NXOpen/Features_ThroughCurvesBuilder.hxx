        ...
        */
        class NXOPENCPPEXPORT  ThroughCurvesBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the sections list which is required. See @link ObjectList ObjectList@endlink  for details.
                    ...
                    multiple objects, and each object can be one of the following: a curve or a solid edge. <br> License requirements : features_modeling ("FEATURES MODELING") OR nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the position tolerance.
                    Control the distance accuracy of the rebuild surface in relation to the input curves. <br> License requirements : features_modeling ("FEATURES MODELING") OR nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the tangent tolerance.
                    Control the angular accuracy of the rebuild surface in relation to the input curves.It is expressed in degree. <br> License requirements : features_modeling ("FEATURES MODELING") OR nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the curvature tolerance.
                    Control the curvature tolerance of the rebuild surface in relation to the input curves. <br> License requirements : features_modeling ("FEATURES MODELING") OR nx_freeform_1 ("basic freeform modeling") */
