...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  BlendFinish : public CAM::Blade
        {
            ...
            /**Returns  the Drive Mode  <br> License requirements : None */
            public: NXOpen::CAM::DriveMode * DriveMode
            (
            );
            /**Returns  the Cut Band  <br> License requirements : None */
