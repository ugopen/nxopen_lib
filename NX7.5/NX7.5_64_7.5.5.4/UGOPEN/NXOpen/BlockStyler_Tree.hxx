...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        ...
        class NXOPENUICPPEXPORT  Tree : public BlockStyler::UIBlock
        {
            ...
            public: /**Represents the callback which gets called when the node is expanded. This is called only once. <br> License requirements : None */
            ...
            public: /** @brief 
                   ...
                   In this callback it is expected to provide column text for individual node. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when the node state is set 
                   ...
                   called only once for any given node state. <br> License requirements : None */
            typedef NXOpen::Callback3<NXString, NXOpen::BlockStyler::Tree *, NXOpen::BlockStyler::Node *, int> StateIconNameCallback;
            public: /**Represents the callback which gets called when the node is inserted. <br> License requirements : None */
            typedef NXOpen::Callback2<void, NXOpen::BlockStyler::Tree *, NXOpen::BlockStyler::Node *> OnInsertNodeCallback;
            public: /**Represents the callback which gets called when pre selection is attempted on node. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when the node is selected. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when the state icon is clicked. 
                   ...
                   e.g., node can be changed from checked state to unchecked state and vice-versa. <br> License requirements : None */
            typedef NXOpen::Callback3<void, NXOpen::BlockStyler::Tree *, NXOpen::BlockStyler::Node *, int> OnStateChangeCallback;
            public: /**Represents the callback which gets called when tree seeks the tooltip. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when label edit is attempted on any column. The label edit is allowed/disallowed 
                   based on return value of this callback. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when label edit is completed on any column. 
                   The edited label is accepted/rejected based on return value of this callback. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when node is dragged. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when nodes are dropped on any target node. This callback is invoked irrespective of case 
                   ...
                   prior to the invocation of this callback. <br> License requirements : None */
            ...
            public: /**Represents the callback which gets called when double clicked is performed on the node. <br> License requirements : None */
            ...
            /**Creates the node but does not insert it. Use @link BlockStyler::Tree::InsertNode BlockStyler::Tree::InsertNode@endlink  to insert 
                    the node. @return Node <br> License requirements : None */
            ...
            /**Inserts the node. Subsequently BlockStyler.Tree.OnInsertNodeCallback is called. 
                   Reinserting the node in same or different tree is not allowed. <br> License requirements : None */
            ...
            /**Deletes the node from tree. Further usage of deleted node is illegal. The last place where node can be used is in 
                  BlockStyler.Tree.OnDeleteNodeCallaback callback which gets called when node is deleted. <br> License requirements : None */
            public: void DeleteNode
            (
                NXOpen::BlockStyler::Node * node /**Node to delete*/
            );
            /**Selects the provided node. <br> License requirements : None */
            ...
            /**Selects the provided nodes. <br> License requirements : None */
            ...
            /**Inserts column with following defaults: <br/> 
                 ...
                 @return Absolute column position. <br> License requirements : None */
            ...
            /**Gets the column title. @return Column header title. <br> License requirements : None */
            public: NXString GetColumnTitle
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Sets the column title. <br> License requirements : None */
            public: void SetColumnTitle
            (
                int columnID /**Unique column Id associated with the column.*/,
                const NXString & columnHeaderTitle /**Column header title.*/
            );
            /**Gets the column Id for the provided column position. @return Unique column Id associated with the column. <br> License requirements : None */
            public: int GetColumnId
            (
                int columnPosition /**Column position.*/
            );
            /**Gets column position. Returns -1 if no column is associated with the provided column Id. @return Column position. <br> License requirements : None */
            public: int GetColumnPosition
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Gets column width @return Column width. <br> License requirements : None */
            public: int GetColumnWidth
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Sets the column width <br> License requirements : None */
            public: void SetColumnWidth
            (
                int columnID /**Unique column Id associated with the column.*/,
                int columnWidth /**Column width.*/
            );
            /**Gets the column sort option. @return Column sort option. <br> License requirements : None */
            public: NXOpen::BlockStyler::Tree::ColumnSortOption GetColumnSortOption
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Sets the column sort option. <br> License requirements : None */
            public: void SetColumnSortOption
            (
                int columnID /**Unique column Id associated with the column.*/,
                NXOpen::BlockStyler::Tree::ColumnSortOption sortOption /**Column sort option.*/
            );
            /**Gets the flag indicating whether the column is sortable. @return Flag indicating whether the column is sortable. <br> License requirements : None */
            public: bool GetColumnSortable
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Sets the flag indicating whether the column is sortable. <br> License requirements : None */
            public: void SetColumnSortable
            (
                int columnID /**Unique column Id associated with the column.*/,
                bool isSortable /**Flag indicating whether the column is sortable.*/
            );
            /**Gets the flag indicating whether the column is visible. @return Flag indicating whether the column is visible. <br> License requirements : None */
            public: bool GetColumnVisible
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Sets the flag indicating whether the column is visible <br> License requirements : None */
            public: void SetColumnVisible
            (
                int columnID /**Unique column Id associated with the column*/,
                bool isVisible /**Flag indicating whether the column is visible*/
            );
            /**Gets the display type of the column. @return Display type. <br> License requirements : None */
            public: NXOpen::BlockStyler::Tree::ColumnDisplay GetColumnDisplayType
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Sets the display type of the column. <br> License requirements : None */
            public: void SetColumnDisplayType
            (
                int columnID /**Unique column Id associated with the column.*/,
                NXOpen::BlockStyler::Tree::ColumnDisplay displayType /**Display type.*/
            );
            /**Gets the column resize policy. @return Resize policy. <br> License requirements : None */
            public: NXOpen::BlockStyler::Tree::ColumnResizePolicy GetColumnResizePolicy
            (
                int columnID /**Unique column Id associated with the column.*/
            );
            /**Sets the column resize policy. <br> License requirements : None */
            ...
            /**Returns  the root node. If more than one root node is available in top hierarchy 
                  then the first root node is returned. <br> License requirements : None */
            public: NXOpen::BlockStyler::Node * RootNode
            (
            );
            /**Returns  the first selected node among the available selected nodes. 
                   Returns NULL if no node is selected. <br> License requirements : None */
            public: NXOpen::BlockStyler::Node * FirstSelectedNode
            (
            );
            /**Sets the pre selection time out. BlockStyler.Tree.OnPreSelectCallback is called based on this value. <br> License requirements : None */
            public: void SetPreSelectionTimeOut
            (
                double timeOut /**Time in millisecond*/
            );
            /**Gets the selected nodes. @return Selected nodes. <br> License requirements : None */
            ...
            /**Sets the callback handler for on drop menu. <br> License requirements : None */
            ...
            /** Creates the menu. Use @link BlockStyler::Tree::SetMenu BlockStyler::Tree::SetMenu@endlink  to set the created menu. @return   <br> License requirements : None */
            ...
            /** Sets the menu, resulting the menu to appear on the screen. This method must be used in callback which is intended to create
                    menu, such as BlockStyler.Tree.OnMenuCallback <br> License requirements : None */
            public: void SetMenu
            (
            ...
            /**Copies the existing @link BlockStyler::Node BlockStyler::Node@endlink . The tree can copy either its own node or the node of another tree. 
                 ...
                 @return Copied node. <br> License requirements : None */
