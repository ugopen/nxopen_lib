    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT  Stock : public NXObject, public virtual Routing::ICharacteristic
        {
            ...
            /** Renames the component associated with a Stock as Components Stock.  Executes the STOCK_COMPONENT_NAME 
                        plugin to determine the new name of the component.  Only call on Stock as Components Stock
                        This method is deprecated. Use @link  Routing::Stock::RenameStockComponent  Routing::Stock::RenameStockComponent@endlink  instead.
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.4") void RenameComponent
            (
            );
            ...
            /** Renames the stock component part with given name <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
