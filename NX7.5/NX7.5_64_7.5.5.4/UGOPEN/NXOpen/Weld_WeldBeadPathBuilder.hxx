...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        class NXOPENCPPEXPORT  WeldBeadPathBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the section defining the path.  <br> License requirements : None */
            public: NXOpen::Section * PathSection
            (
            );
            /**Returns  the location at which to start the sweep of the bead shape.  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::OnPathDimensionBuilder * StartPath
            (
            );
            /**Returns  the location at which to end the sweep of the bead shape.  <br> License requirements : None */
            ...
            /**Returns  the indication if the sweep should be created from the edge location to the start location. True
                        ...
                        only used if the path section is closed.   <br> License requirements : None */
            ...
            /**Sets  the indication if the sweep should be created from the edge location to the start location. True
                        indicates the sweep will be created from the end to the start location of the path, false
                        indicates the sweep will be from the start to the end location of the path. This option is
                        only used if the path section is closed.   <br> License requirements : ugweld ("UG WELD") */
            public: void SetCreateEndToStart
            (
                bool createEndToStart /** createendtostart */ 
            );
            /**Returns  the desired path offset method.  <br> License requirements : None */
            public: NXOpen::Weld::WeldBeadPathBuilder::OffsetMethodType OffsetMethod
            (
            );
            /**Sets  the desired path offset method.  <br> License requirements : ugweld ("UG WELD") */
            public: void SetOffsetMethod
            (
                NXOpen::Weld::WeldBeadPathBuilder::OffsetMethodType offsetMethod /** offsetmethod */ 
            );
            /**Returns  the expression containing the distance to offset the path normal to the face.  <br> License requirements : None */
            public: NXOpen::Expression * OffsetInFace
            (
            );
            /**Returns  the reverse the direction to offset the path section. The update path method 
                        provides the information for the default directions.  <br> License requirements : None */
            public: bool ReverseOffsetDirection
            (
            );
            /**Sets  the reverse the direction to offset the path section. The update path method 
                        provides the information for the default directions.  <br> License requirements : ugweld ("UG WELD") */
            public: void SetReverseOffsetDirection
            (
                bool reverseOffsetDirection /** reverseoffsetdirection */ 
            );
            /**Returns  the offset along normal  <br> License requirements : None */
            public: NXOpen::Expression * OffsetAlongNormal
            (
            );
            /** Computes the preview path, and evaluation information for indicating desired face side of the preview path.  <br> License requirements : None */
