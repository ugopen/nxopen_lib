...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /**
            ...
            */
        class NXOPENCPPEXPORT  ScalingMethodBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the scaling method option. Except for Uniform and Lateral scaling methods, additional parameters and/or inputs are required.  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::ScalingMethodBuilder::ScalingOptions ScalingOption
            (
            );
            /**Sets  the scaling method option. Except for Uniform and Lateral scaling methods, additional parameters and/or inputs are required.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetScalingOption
            (
                NXOpen::GeometricUtilities::ScalingMethodBuilder::ScalingOptions scalingOption /** scalingoption */ 
            );
            /**Returns  the scale factor. For Constant scaling method, the scale factor will be applied to all sections along the guide.  <br> License requirements : None */
            public: double ScaleFactor
            (
            );
            /**Sets  the scale factor. For Constant scaling method, the scale factor will be applied to all sections along the guide.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the blending function. Allows linear or cubic scaling between specified starting and ending scale factors, which 
                        correspond to the start and end of the guide string.  <br> License requirements : None */
            ...
            /**Sets  the blending function. Allows linear or cubic scaling between specified starting and ending scale factors, which 
                        correspond to the start and end of the guide string.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the start blend scale factor. For scaling by Blending Function, the start scale factor will be applied at the
                        starting of the guide curve.  <br> License requirements : None */
            ...
            /**Sets  the start blend scale factor. For scaling by Blending Function, the start scale factor will be applied at the
                        starting of the guide curve.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the end blend scale factor. For scaling by Blending Function, the end scale factor will be applied at the
                        end point of the guide curve.  <br> License requirements : None */
            ...
            /**Sets  the end blend scale factor. For scaling by Blending Function, the end scale factor will be applied at the
                        end point of the guide curve.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the scaling curve. For scaling by Another Curve, the scale at any given point is based on the length of the 
                        ruling between the guide string and the input scaling curve.  <br> License requirements : None */
            ...
            /**Returns  the scaling point. For scaling by a Point, the scale at any given point is based on the length of the 
                        ruling between the guide string and the input point.  <br> License requirements : None */
            ...
            /**Sets  the scaling point. For scaling by a Point, the scale at any given point is based on the length of the 
                        ruling between the guide string and the input point.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetScalingPoint
            (
                NXOpen::Point * scalingPoint /** scalingpoint */ 
            );
            /**Returns  the area law. For scaling by Area Law, the input law governs the cross sectional area at the start and end of the guide curve.  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::LawBuilder * AreaLaw
            (
            );
            /**Returns  the perimeter law. For scaling by Perimeter Law, the input law governs the perimeter of the sections at the start and end of the guide curve.  <br> License requirements : None */
