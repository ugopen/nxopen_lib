...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT  RulePreferences
        {
            ...
            /** Get the search libraries for user classes.  @return  search libraries  <br> License requirements : ug_kf_author ("UG/Knowledge Fusion - Author") OR pts_author ("Product Template Studio (Author)") */
            public: std::vector<NXString> GetSearchLibraries
            (
            );
            /** Set the search libraries for user classes.  <br> License requirements : ug_kf_author ("UG/Knowledge Fusion - Author") OR pts_author ("Product Template Studio (Author)") */
