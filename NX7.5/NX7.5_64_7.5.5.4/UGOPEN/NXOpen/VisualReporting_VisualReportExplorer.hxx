...
namespace NXOpen
{
    ...
    namespace VisualReporting
    {
        ...
        class NXOPENCPPEXPORT  VisualReportExplorer
        {
            ...
            /** Status reported by @link ReportDown ReportDown@endlink .
                    */
            ...
            /** Set the group to explore.
                        The group to explore can be set to NULL.
                        If there is no active visual report, then nothing will happen.
                        Note that the groupLabel should belong to the active visual report
            ...
            /** Report down the assembly, starting from the @link Assemblies::ComponentAssembly::RootComponent Assemblies::ComponentAssembly::RootComponent@endlink .
                     ...
                     @return  Status from the report down operation  <br> License requirements : nx_visual_reporting ("Visual Reporting") */
