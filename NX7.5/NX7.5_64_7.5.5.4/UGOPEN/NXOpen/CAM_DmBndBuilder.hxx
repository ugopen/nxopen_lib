...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  DmBndBuilder : public TaggedObject
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::CAM::BndCutAngleCiBuilder * CutAngleCiBuilder
            (
            );
            ...
            /**Returns  the stepover ci builder which is obsolete
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::CAM::BndStepoverCiBuilder * StepoverCiBuilder
            (
            );
