    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT  SheetmetalManager
            {
                ...
                /** Create a NXSM Bend taper feature Builder @return  Bend Taper object  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /** Create hem flange feature builder  @return  Hem Flange Builder object <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                (
                    NXOpen::Features::Feature * solidPunch /** @link Features::Feature Features::Feature@endlink  to be edited */
                );
                /** Creates a @link Features::SheetMetal::BridgeTransitionBuilder Features::SheetMetal::BridgeTransitionBuilder@endlink   @return Bridge Transition Builder <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                ...
                /** Is a sheet metal body. This function will return True if the body has at least one NX Sheet Metal feature or
                        a Flexible Printed Circuit Design feature.  @return True = Body has NX Sheet Metal features or Flexible Printed Circuit Design features <br> License requirements : None */
                public: bool IsSheetmetalBody
                (
                    NXOpen::Body * inputBody /**The body to check*/
                );
                /** Thickness of sheet metal body. Value is returned in part units.  @return Thickness Value <br> License requirements : None */
                public: double GetBodyThickness
                (
                    NXOpen::Body * sheetmetalBody /**The face to check*/
                );
                /** Get inner bend faces. For every bend the inner face is the face with smaller radius. <br> License requirements : None */
                ...
                /** Sheet metal face type  @return Sheet Metal Face Type <br> License requirements : None */
                public: NXOpen::Features::SheetMetal::SheetmetalFaceType GetFaceType
                (
                    NXOpen::Face * inputFace /**The face to check*/
                );
                /** Sheet metal face layer  @return Sheet Metal Face Layer <br> License requirements : None */
                public: NXOpen::Features::SheetMetal::SheetmetalFaceLayer GetFaceLayer
                (
                    NXOpen::Face * inputFace /**The face to check*/
                );
                /** Opposite face to bend, web or deform face. Will raise an exception if the input face is not a valid face. @return Opposite Layer Face <br> License requirements : None */
                public: NXOpen::Face * GetOppositeFace
                (
                    NXOpen::Face * inputFace /**The face to check*/
                );
                /** Bend region parameters. The values are calculated from the inner face of bend region. The radius and angle values are returned in part units. This function will raise an exception of the face is not a valid bend face. @return   <br> License requirements : None */
                ...
                /** Check if this edge is a thickness edge  @return True = Thickness Edge <br> License requirements : None */
                public: bool IsThicknessEdge
                (
                    NXOpen::Edge * inputEdge /**The edge to check*/
                );
                /** Creates a @link Features::SheetMetal::SheetMetalFromSolidBuilder Features::SheetMetal::SheetMetalFromSolidBuilder@endlink   @return  Sheet Metal from Solid Builder object <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::SheetMetalFromSolidBuilder * CreateSheetMetalFromSolidBuilder
                (
                    NXOpen::Features::Feature * sheetMetalFromSolid /** @link Features::SheetMetalFromSolid Features::SheetMetalFromSolid@endlink  to be edited */
                );
                /** Creates a @link Features::SheetMetal::FlexibleCableBuilder Features::SheetMetal::FlexibleCableBuilder@endlink   @return Flexible Cable Builder object <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /** Creates a @link Features::SheetMetal::GussetBuilder Features::SheetMetal::GussetBuilder@endlink   @return  Gusset Builder object <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::GussetBuilder * CreateGussetBuilder
                (
                    NXOpen::Features::Feature * gusset /** @link Features::Gusset Features::Gusset@endlink  to be edited */
                );
                /** Creates a @link Features::SheetMetal::EditBendBuilder Features::SheetMetal::EditBendBuilder@endlink   @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::EditBendBuilder * CreateEditBendBuilder
                (
                    NXOpen::Features::Feature * editBend /** @link Features::EditBend Features::EditBend@endlink  to be edited */
                );
                /** Creates a @link Features::SheetMetal::ExportTrumpfBuilder Features::SheetMetal::ExportTrumpfBuilder@endlink   @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::ExportTrumpfBuilder * CreateExportTrumpfBuilder
                (
                );
                /** Creates a @link Features::SheetMetal::CleanUpUtilityBuilder Features::SheetMetal::CleanUpUtilityBuilder@endlink   @return  Clean-Up Utility Builder object <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::CleanUpUtilityBuilder * CreateCleanUpUtilityBuilder
                (
                );
                /** Creates a @link Features::SheetMetal::MetaformBuilder Features::SheetMetal::MetaformBuilder@endlink   @return   <br> License requirements : adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                public: NXOpen::Features::SheetMetal::MetaformBuilder * CreateMetaformBuilder
                (
                    NXOpen::Features::Feature * metaform /** @link Features::Metaform Features::Metaform@endlink  to be edited */
                );
                /** Creates a @link Features::SheetMetal::EditCornerBuilder Features::SheetMetal::EditCornerBuilder@endlink   @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
