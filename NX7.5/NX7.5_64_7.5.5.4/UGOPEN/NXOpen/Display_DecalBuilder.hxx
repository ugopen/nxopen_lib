...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a @link Display::DecalBuilder Display::DecalBuilder@endlink   <br>  <br> */
        class NXOPENCPPEXPORT  DecalBuilder : public Builder
        {
            /** image size type */
            ...
            public: ~DecalBuilder();
            /**Returns  the decal name  <br> License requirements : None */
            public: NXString DecalName
            (
            );
            /**Sets  the decal name  <br> License requirements : None */
            public: void SetDecalName
            (
                const NXString & decalName /** decalname */ 
            );
            /**Returns  the anchor type  <br> License requirements : None */
            public: NXOpen::Display::DecalBuilder::Anchor AnchorType
            (
            );
            /**Sets  the anchor type  <br> License requirements : None */
            ...
            /**Sets  the scaling type  <br> License requirements : None */
            public: void SetScalingType
            (
                NXOpen::Display::DecalBuilder::Scaling scalingType /** scalingtype */ 
            );
            /**Returns  the image size type  <br> License requirements : None */
            public: NXOpen::Display::DecalBuilder::ImageSize ImageSizeType
            (
            );
            /**Sets  the image size type  <br> License requirements : None */
            public: void SetImageSizeType
            (
                NXOpen::Display::DecalBuilder::ImageSize imageSizeType /** imagesizetype */ 
            );
            /**Returns  the image builder  <br> License requirements : None */
            public: NXOpen::Display::Image * Image
            (
            );
            /**Sets  the image builder  <br> License requirements : None */
            public: void SetImage
            (
                NXOpen::Display::Image * imageBuilder /** image builder */ 
            );
            /**Returns  the decal image file name  <br> License requirements : None */
            public: NXString ImageFilename
            (
            );
            /**Sets  the decal image file name  <br> License requirements : None */
            ...
            /**Returns  the object(face, body and facetted body) to apply the decal to  <br> License requirements : None */
            ...
            /**Sets  the origin  <br> License requirements : None */
            public: void SetOrigin
            (
                NXOpen::Point * origin /** origin */ 
            );
            /**Returns  the decal up vector  <br> License requirements : None */
            public: NXOpen::Direction * UpVector
            (
            );
            /**Sets  the decal up vector  <br> License requirements : None */
            public: void SetUpVector
            (
                NXOpen::Direction * upVector /** upvector */ 
            );
            /**Returns  the decal normal vector  <br> License requirements : None */
            public: NXOpen::Direction * NormalVector
            (
            );
            /**Sets  the decal normal vector  <br> License requirements : None */
            public: void SetNormalVector
            (
                NXOpen::Direction * normalVector /** normalvector */ 
            );
            /**Returns  the decal image aspect ratio  <br> License requirements : None */
            public: double AspectRatio
            (
            );
            /**Sets  the decal image aspect ratio  <br> License requirements : None */
            public: void SetAspectRatio
            (
                double aspectRatio /** aspectratio */ 
            );
            /**Returns  the decal scale  <br> License requirements : None */
            public: double Scale
            (
            );
            /**Sets  the decal scale  <br> License requirements : None */
            public: void SetScale
            (
                double scale /** scale */ 
            );
            /**Returns  the decal width scale  <br> License requirements : None */
            public: double WidthScale
            (
            );
            /**Sets  the decal width scale  <br> License requirements : None */
            public: void SetWidthScale
            (
                double widthScale /** width scale */ 
            );
            /**Returns  the decal height scale  <br> License requirements : None */
            public: double HeightScale
            (
            );
            /**Sets  the decal height scale  <br> License requirements : None */
            public: void SetHeightScale
            (
                double heightScale /** height scale */ 
            );
            /**Returns  the decal rotation  <br> License requirements : None */
            public: double Rotation
            (
            );
            /**Sets  the decal rotation  <br> License requirements : None */
            public: void SetRotation
            (
                double rotation /** rotation */ 
            );
            /** Returns the transparency color  @return   <br> License requirements : None */
            public: std::vector<double> GetTransparencyColor
            (
            );
            /** Sets the transparency color  <br> License requirements : None */
            public: void SetTransparencyColor
            (
                const std::vector<double> & transparencyColor /** transparencycolor */ 
            );
            /**Returns  the transparency tolerance  <br> License requirements : None */
            public: int TransparencyTolerance
            (
            );
            /**Sets  the transparency tolerance  <br> License requirements : None */
            public: void SetTransparencyTolerance
            (
                int transparencyTolerance /** transparencytolerance */ 
            );
            /**Returns  the stencil preview toggle  <br> License requirements : None */
            public: bool StencilPreview
            (
            );
            /**Sets  the stencil preview toggle  <br> License requirements : None */
            public: void SetStencilPreview
            (
                bool stencilPreview /** stencilpreview */ 
            );
            /**Returns  the illumination type  <br> License requirements : None */
            public: NXOpen::Display::DecalBuilder::DecalIllumination IlluminationType
            (
            );
            /**Sets  the illumination type  <br> License requirements : None */
            public: void SetIlluminationType
            (
                NXOpen::Display::DecalBuilder::DecalIllumination illuminationType /** illuminationtype */ 
            );
            /**Returns  the decal reflectivity  <br> License requirements : None */
            public: double DecalReflectivity
            (
            );
            /**Sets  the decal reflectivity  <br> License requirements : None */
            public: void SetDecalReflectivity
            (
                double decalReflectivity /** decalreflectivity */ 
            );
            /**Returns  the engraving enable toggle  <br> License requirements : None */
            public: bool EnableEngraving
            (
            );
            /**Sets  the engraving enable toggle  <br> License requirements : None */
            public: void SetEnableEngraving
            (
                bool enableEngraving /** enableengraving */ 
            );
            /**Returns  the decal engraving amplitude  <br> License requirements : None */
            public: double EngravingAmplitude
            (
            );
            /**Sets  the decal engraving amplitude  <br> License requirements : None */
            public: void SetEngravingAmplitude
            (
                double engravingAmplitude /** engravingamplitude */ 
            );
            /**Returns  the engraving softness  <br> License requirements : None */
            public: double EngravingSoftness
            (
            );
            /**Sets  the engraving softness  <br> License requirements : None */
            public: void SetEngravingSoftness
            (
                double engravingSoftness /** engravingsoftness */ 
            );
            /**Returns  the origin_pos  <br> License requirements : None */
            public: NXOpen::Point3d OriginPosition
            (
            );
            /**Sets  the origin_pos  <br> License requirements : None */
            public: void SetOriginPosition
            (
                const NXOpen::Point3d & originPosition /** originposition */ 
            );
            /**Returns  the decal up vector value  <br> License requirements : None */
            public: NXOpen::Vector3d UpVectorValue
            (
            );
            /**Sets  the decal up vector value  <br> License requirements : None */
            public: void SetUpVectorValue
            (
                const NXOpen::Vector3d & upVectorValue /** upvectorvalue */ 
            );
            /**Returns  the decal normal vector value  <br> License requirements : None */
            public: NXOpen::Vector3d NormalVectorValue
            (
            );
            /**Sets  the decal normal vector value  <br> License requirements : None */
