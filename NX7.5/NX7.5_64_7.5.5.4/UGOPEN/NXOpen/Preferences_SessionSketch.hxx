    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT  SessionSketch
        {
            ...
            /**Returns  the display section mapping warning flag. If this is true, when user exits
                sketcher, would get a warning that some dependent feature section may require mapping  <br> License requirements : None */
            ...
            /**Returns  the decimal places
                    ...
                    The annotation preference can be asked or set by @link Preferences::AnnotationPreferences::SetDimensionPreferences Preferences::AnnotationPreferences::SetDimensionPreferences@endlink  and
                       @link Preferences::AnnotationPreferences::SetDimensionPreferences Preferences::AnnotationPreferences::SetDimensionPreferences@endlink  
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") int DecimalPlaces
            (
            );
            ...
            /**Returns  the continuous auto dimensioning state in sketch preferences. Newly created sketch
                gets continuous auto dimensioning state from sketch preference.  <br> License requirements : None */
            ...
            /**Sets  the continuous auto dimensioning state in sketch preferences. Newly created sketch
                gets continuous auto dimensioning state from sketch preference.  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
            ...
            /**Returns  the flag of auto-dimensions to arc centre. If it is set to true, then we will infer auto-dimensions to 
                arc centre when running auto-dimension  <br> License requirements : None */
            ...
            /**Sets  the flag of auto-dimensions to arc centre. If it is set to true, then we will infer auto-dimensions to 
                arc centre when running auto-dimension  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
