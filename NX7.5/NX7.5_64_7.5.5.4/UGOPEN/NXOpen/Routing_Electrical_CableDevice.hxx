        ...
        namespace Electrical
        {
            ...
            class NXOPENCPPEXPORT  CableDevice : public Routing::Electrical::ElectricalStockDevice
            {
                ...
                /** Returns the part number of the conduit applied over this @link Routing::Electrical::CableDevice Routing::Electrical::CableDevice@endlink 
                                object.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") */
                ...
                /** Sets the part number of the conduit to be applied over this @link Routing::Electrical::CableDevice Routing::Electrical::CableDevice@endlink 
                                object.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") */
