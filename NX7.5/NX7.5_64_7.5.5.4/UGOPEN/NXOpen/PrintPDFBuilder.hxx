...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PrintPDFBuilder : public Builder
    {
        ...
        /**Returns  the relation to be used when exporting a PDF to Teamcenter  <br> License requirements : None */
        public: NXOpen::PrintPDFBuilder::RelationOption Relation
        (
        );
        /**Sets  the relation to be used when exporting a PDF to Teamcenter  <br> License requirements : None */
        public: void SetRelation
        (
            NXOpen::PrintPDFBuilder::RelationOption relation /** relation */ 
        );
        /**Returns  the dataset type to be used when exporting a PDF to Teamcenter  <br> License requirements : None */
        public: NXString DatasetType
        (
        );
        /**Sets  the dataset type to be used when exporting a PDF to Teamcenter  <br> License requirements : None */
        public: void SetDatasetType
        (
            const NXString & datasetType /** datasettype */ 
        );
        /**Returns  the named reference type to be used when exporting a PDF to Teamcenter  <br> License requirements : None */
        public: NXString NamedReferenceType
        (
        );
        /**Sets  the named reference type to be used when exporting a PDF to Teamcenter  <br> License requirements : None */
