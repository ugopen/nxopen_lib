...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT  DriverOperation : public TaggedObject
        {
            ...
            /**Returns  the motor   <br> License requirements : None */
            public: NXOpen::Motion::PMDCMotor * Motor
            (
            );
            /**Sets  the motor   <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMotor
            (
                NXOpen::Motion::PMDCMotor * motor /** motor */ 
            );
            /**Returns  the signal chart   <br> License requirements : None */
            public: NXOpen::Motion::SignalChart * SignalChart
            (
            );
            /**Sets  the signal chart   <br> License requirements : mechanisms ("MECHANISMS") */
