    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  NCGroupCollection : public TaggedObjectCollection
        {
            ...
            /** Create geometry groups of the specified type and subtype under the parent group for the specified
                    ...
                    the created geometry group; otherwise, the specified name will be used. @return  one of the created geometry groups  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::NCGroup * CreateGeometry
            (
                NXOpen::CAM::NCGroup * parentGroup /** the parent group */,
            ...
            /** Creates a wire edm geometry builder  @return  builder created  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /** Creates a blade geometry builder  @return  builder created  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::MultiBladeGeomBuilder * CreateMultiBladeGeometryBuilder
            (
                NXOpen::CAM::CAMObject * param /** the object to be edited */
            );
            /** Create Hole or Boss Geometry builder  @return  Hole or Boss Geometry builder created  <br> License requirements : cam_base ("CAM BASE") */
