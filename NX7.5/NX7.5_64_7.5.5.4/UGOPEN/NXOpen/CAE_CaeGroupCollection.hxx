    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  CaeGroupCollection : public TaggedObjectCollection
        {
            ...
            struct  AutoGroupErrorCodes
            {
                ...
                public: /** by meshsubtype */ int ByMeshsubtype;
                ...
                public: AutoGroupErrorCodes(int byMaterialInitial /** returns error code for meshes by material */, 
                        ...
                        int byMeshsubtypeInitial /** by meshsubtype */ ) :
                    ByMaterial(byMaterialInitial),
                    ByPpt(byPptInitial),
                    ByColor(byColorInitial),
                    BySection(bySectionInitial),
            ...
            /** Copies the input group, which must come from the same part as the collection. @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::CaeGroup * CopyGroup
            (
                const NXString & setName /**  New group name, if no name is input 
                                                             or the input name cannot be used, a 
                                                             name will be generated.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
            ...
            /** Auto group CAE entities based on attributes
                        ...
                        the JA_CAE_GROUP_COLLECTION_auto_group_types structure. The number of auto created groups
                        and the array of auto created groups will be returned. Errors if any are returned by auto
                        group type through the JA_CAE_GROUP_COLLECTION_auto_group_error_codes structure.  @return  list of generated error codes for each auto group type  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
