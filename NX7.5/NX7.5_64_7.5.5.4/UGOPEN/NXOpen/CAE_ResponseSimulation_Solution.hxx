    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT  Solution : public NXObject
            {
                ...
                /** Returns the evaluation parameters of Response Analysis Meta solution @return   <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                ...
                /** Clones a sensor to the solution  @return    <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: NXOpen::CAE::ResponseSimulation::Sensor * CloneSensor
                (
                    NXOpen::CAE::ResponseSimulation::Sensor * sourceSensor /** source sensor */ ,
                    const NXString & suggestedName /**   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                /** Clones a strain gage to the solution  @return    <br> License requirements : nx_response_anlys ("NX Response Analysis") */
