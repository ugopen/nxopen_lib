...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT  DividefaceBuilder : public Features::FeatureBuilder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.1") void SetDividingObjects
            (
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.1") NXOpen::ScCollector * DividingObjects
            (
            );
            ...
            /**Sets  the Dividing Objects section. This is pre NX6 do not use it, instead use dividing_objects_list API.
             @deprecated Deprecated in NX6.0.1 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.1") void SetDividingObjectsSection
            (
                NXOpen::Section * dividingObjectsSection /** section for dividing objects */
            );
            /**Returns  the Dividing Objects section. This is pre NX6 do not use it, instead use dividing_objects_list API.
             @deprecated Deprecated in NX6.0.1 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.1") NXOpen::Section * DividingObjectsSection
            (
            );
