...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT  LineupBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the press direction of the lineup  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Vector3d PressDirection
            (
            );
            /**Sets  the press direction of the lineup  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetPressDirection
            (
                const NXOpen::Vector3d & pressDirection /** pressdirection */ 
            );
            /**Returns  the flow direction of the lineup  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Vector3d FlowDirection
            (
            );
            /**Sets  the flow direction of the lineup  <br> License requirements : die_engineering ("DIE ENGINEERING") */
