        ...
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPPEXPORT  FlexibleCableBuilder : public Features::FeatureBuilder
            {
                ...
                /**Returns  the type list.  <br> Do not use this method. Instead use 
                            @link Features::SheetMetal::FlexibleCableBuilder::SegmentList Features::SheetMetal::FlexibleCableBuilder::SegmentList@endlink 
                             <br> 
                            
                 @deprecated Deprecated in NX7.5.0 <br> 
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public:  NX_DEPRECATED("Deprecated in NX7.5.0") NXOpen::TaggedObjectList * TypeList
                (
                );
                /**Returns  the cable segment list.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::TaggedObjectList * SegmentList
                (
                );
                /**Returns  the start point.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Point * StartPoint
                (
                );
                /**Sets  the start point.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetStartPoint
                (
                    NXOpen::Point * startPoint /** startpoint */ 
                );
                /**Returns  the cable direction.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Direction * CableDirection
                (
                );
                /**Sets  the cable direction.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetCableDirection
                (
                    NXOpen::Direction * cableDirection /** cabledirection */ 
                );
                /**Returns  the thickness direction.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Direction * ThicknessDirection
                (
                );
                /**Sets  the thickness direction.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /**Returns  the number of conductors.  <br> Do not use this method. Instead use 
                            @link Features::SheetMetal::FlexibleCableBuilder::ConductorCount Features::SheetMetal::FlexibleCableBuilder::ConductorCount@endlink 
                             <br>  
                 @deprecated Deprecated in NX7.5.0 <br> 
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public:  NX_DEPRECATED("Deprecated in NX7.5.0") int NoOfConductors
                (
                );
                /**Returns  the count of conductors.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: int ConductorCount
                (
                );
                /**Sets  the number of conductors.  <br> Do not use this method. Instead use 
                            @link Features::SheetMetal::FlexibleCableBuilder::ConductorCount Features::SheetMetal::FlexibleCableBuilder::ConductorCount@endlink 
                             <br>  
                 @deprecated Deprecated in NX7.5.0 <br> 
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public:  NX_DEPRECATED("Deprecated in NX7.5.0") void SetNoOfConductors
                (
                    int noOfConductors /** Number of conductors of cable. */
                );
                /**Sets  the count of conductors.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetConductorCount
                (
                    int noOfConductors /** Number of conductors of cable. */
                );
                /** Returns the index of cable segment.  @return   <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /** Returns the cable segment at given index.  @return   <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /** Deletes a cable segment at given index.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /** Deletes all cable segments.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                ...
                /** Creates a new @link Features::SheetMetal::FlexibleCableSegment Features::SheetMetal::FlexibleCableSegment@endlink  planar segment. This
                               ...
                               the input index.  @return   <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Features::SheetMetal::FlexibleCableSegment * CreatePlanarSegment
                (
                    const NXString & length /** Length.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                ...
                (
                    const NXString & bendAngle /** Bend angle.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    const NXString & bendRadius /** Bend radius.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                    const NXString & pathAdjustmentAngle /** Path adjustment angle.   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                ...
                /** Get the count of @link Features::SheetMetal::FlexibleCableSegment Features::SheetMetal::FlexibleCableSegment@endlink .  @return  Segment count.  <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
