...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  LicenseManager
    {
        ...
        /** Reserve a license against the default license context. 
         @deprecated Deprecated in NX6.0.0 <br> 
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX6.0.0") void Reserve
        (
        ...
        /** Reserve a license against the specified license context.  If the specified user-defined 
            context does not already exist it will be created. <br> License requirements : None */
        public: void Reserve
        (
            const NXString & license /** License feature name to be reserved   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
        ...
        /** Release a license from the default context. 
         @deprecated Deprecated in NX6.0.0 <br> 
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX6.0.0") void Release
        (
        ...
        /** Release a license against the specified license context.  <br> License requirements : None */
        public: void Release
        (
            const NXString & license /** License feature name to be released   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
        ...
        /** Release all licenses against the specified license context.  If the context specified is a user-defined context it will be deleted.  <br> License requirements : None */
        ...
        /** Returns the licenses that are currently reserved against a context.  This method will
            also output the licenses reserved against the default context in the syslog.   @return   <br> License requirements : None */
