...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        RangeControl.Value (deprecated) </td> <td> 
        ...
        */
        class NXOPENCPPEXPORT  MatchEdgeBuilder : public Features::FeatureBuilder
        {
            ...
            */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") enum PoleMovementType
            {
            ...
            /** boundary edge constraint types 
             @deprecated Deprecated in NX7.0.0 <br> 
            */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") enum BoundaryEdgeConstraintType
            {
            ...
            /**Returns  the face recognition  <br> License requirements : None */
            public: NXOpen::Features::FaceRecognitionBuilder * FaceRecognizer
            (
            );
            /**Returns  the synchronous mode  <br> License requirements : None */
            public: bool CanUseFaceFinder
            (
            );
            /**Sets  the synchronous mode  <br> License requirements : features_modeling ("FEATURES MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") bool IsMatchExact
            (
            );
            /**Sets  the match exact state 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : features_modeling ("FEATURES MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") void SetMatchExact
            (
            ...
            /**Returns  the constraint pole movement 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::Features::MatchEdgeBuilder::PoleMovementType PoleMovementConstraint
            (
            );
            /**Sets  the constraint pole movement 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : features_modeling ("FEATURES MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") void SetPoleMovementConstraint
            (
            ...
            /**Returns  the start edge constraint. The "Linked" options is not available for start edge. 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::Features::MatchEdgeBuilder::BoundaryEdgeConstraintType StartEdgeConstraintType
            (
            );
            /**Sets  the start edge constraint. The "Linked" options is not available for start edge. 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : features_modeling ("FEATURES MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") void SetStartEdgeConstraintType
            (
            ...
            /**Returns  the end edge constraint  
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::Features::MatchEdgeBuilder::BoundaryEdgeConstraintType EndEdgeConstraintType
            (
            );
            /**Sets  the end edge constraint  
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : features_modeling ("FEATURES MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") void SetEndEdgeConstraintType
            (
            ...
            /**Returns  the shape control 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::GeometricUtilities::DepthSkewBuilder * ShapeControl
            (
            );
            /**Returns  the range control 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::Expression * RangeControl
            (
            );
            /**Returns  the constraint match direction 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::Direction * MatchDirectionConstraint
            (
            );
            /**Sets  the constraint match direction 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : features_modeling ("FEATURES MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") void SetMatchDirectionConstraint
            (
            ...
            /**Returns  the move pole direction 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::Direction * MovePoleDirection
            (
            );
            /**Sets  the move pole direction 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : features_modeling ("FEATURES MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") void SetMovePoleDirection
            (
            ...
            /**Returns  the tolerance for extracting BSurface from a face  <br> License requirements : features_modeling ("FEATURES MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public: double DistanceTolerance
            (
            );
            /**Sets  the tolerance for extracting BSurface from a face  <br> License requirements : features_modeling ("FEATURES MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public: void SetDistanceTolerance
            (
                double tolerance /** tolerance */ 
            );
            /** Sets edge and face  <br> License requirements : features_modeling ("FEATURES MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public: void SetSelectedEditEdgeAndFace
            (
                NXOpen::Edge * edge /** edge */,
                NXOpen::Face * face /** face */
            );
            /** Update original match surface geometry  <br> License requirements : features_modeling ("FEATURES MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public: void UpdateOriginalMatchSurface
            (
            );
            /**Sets  the target curve projection orientation  <br> License requirements : features_modeling ("FEATURES MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public: void SetFlipTargetCurveOrientation
            (
                bool flip /** flip */ 
            );
            /**Returns  the target curve projection orientation  <br> License requirements : features_modeling ("FEATURES MODELING") OR studio_free_form ("STUDIO FREE FORM") */
