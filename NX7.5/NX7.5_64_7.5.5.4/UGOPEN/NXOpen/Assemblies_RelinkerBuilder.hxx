...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        class NXOPENCPPEXPORT  RelinkerBuilder : public Builder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX5.0.2") NXOpen::Assemblies::RelinkerBuilder::LinkScope RelinkScope
            (
            );
            ...
            public:  NX_DEPRECATED("Deprecated in NX5.0.2") void SetRelinkScope
            (
            ...
            /** Gets the total count of multiple candidate sources to re-parent the inter part expression.  @return   <br> License requirements : wave ("WAVE FUNCTIONALITY") */
            ...
            /** Relinks the inter part expression using the specific expression from the specific part in case of multiple expression sources.  <br> License requirements : wave ("WAVE FUNCTIONALITY") */
            ...
            /** Relinks the wave feature using the specific geometry source from the specific part in case of multiple geometry sources.  <br> License requirements : wave ("WAVE FUNCTIONALITY") */
