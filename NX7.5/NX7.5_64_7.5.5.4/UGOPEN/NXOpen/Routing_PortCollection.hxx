    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT  PortCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Routing::StockOffsetPort Routing::StockOffsetPort@endlink  in the work part from the 
                        ...
                        port in the work part if one already exists.  @return  The stock offset port in the work part.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
