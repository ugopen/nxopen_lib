...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  InspectionPathBuilder : public CAM::OperationBuilder
        {
            ...
            /** Edit first or last point in safe plane  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void EditStartEndPoints
            (
                bool regenerate /** regenerate */ 
            );
            /** Edit entry or exit point  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
