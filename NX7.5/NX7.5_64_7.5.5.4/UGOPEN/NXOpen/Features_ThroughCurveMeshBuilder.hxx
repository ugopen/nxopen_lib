...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /**
            Represents a @link Features::ThroughCurveMesh Features::ThroughCurveMesh@endlink  builder.
            Let you create a body from a collection of existing curve outlines (known as strings) running in two different directions.
             <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateThroughCurveMeshBuilder Features::FeatureCollection::CreateThroughCurveMeshBuilder@endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPPEXPORT  ThroughCurveMeshBuilder : public Features::FeatureBuilder
        {
            /** 
            ...
            /**Returns  the primary curves list which is required.
                     ...
                     A point could be selected as the first and/or last primary string. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the first primary continuity, @link GeometricUtilities::Continuity GeometricUtilities::Continuity@endlink .
                     Define continuity constraint at the first primary sections side.
                     It contains the continuity type and the constraint face. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::GeometricUtilities::Continuity * FirstPrimaryContinuity
            (
            );
            /**Returns  the last primary continuity, @link GeometricUtilities::Continuity GeometricUtilities::Continuity@endlink .
            ...
            /**Returns  the first cross continuity, @link GeometricUtilities::Continuity GeometricUtilities::Continuity@endlink .
            ...
            /**Returns  the last cross continuity, @link GeometricUtilities::Continuity GeometricUtilities::Continuity@endlink .
                     Define continuity constraint at the first cross sections side.
                     It contains the continuity type and the constraint face. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the spine.
                     ...
                     It is valid only if both the first and last primary strings are planar and this spine string is perpendicular to the first and last primary strings <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Section * Spine
            (
            );
            /**Returns  the emphasis options.
                    Allow you to tell the system which set of strings will have the most effect on the created surface in both location and shape. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the construction options.
                    Use one of three construction options when you create a Through Curve Mesh feature: Normal, Use Spline Points, and Simple. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the primary template curve.
                     ...
                     If you leave it empty, the system will automatically choose the most complicated one for fitting. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the primary surface rebuild data, @link GeometricUtilities::Rebuild GeometricUtilities::Rebuild@endlink .
                     ...
                     It is only available for the Normal Construction option. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::GeometricUtilities::Rebuild * PrimarySurfaceRebuildData
            (
            );
            /**Returns  the cross surface rebuild data, @link GeometricUtilities::Rebuild GeometricUtilities::Rebuild@endlink .
            ...
            /**Returns  the intersection tolerance.
                    Define how far the primary strings and cross strings can deviate from each other. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the tangent tolerance.
                    Control the angle accuracy of the rebuild surface in relation to the input curves.It is expressed in degree. <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
            ...
            /**Returns  the body type options  <br> License requirements : None */
            public: NXOpen::Features::ThroughCurveMeshBuilder::BodyPreferenceTypes BodyPreference
            (
            );
            /**Sets  the body type options  <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
