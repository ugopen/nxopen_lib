...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents the group collection for CMM Inspection  <br> To obtain an instance of this class, refer to @link CAM::InspectionSetup CAM::InspectionSetup@endlink  <br> */
        class NXOPENCPPEXPORT  InspectionGroupCollection : public TaggedObjectCollection
        {
            ...
            {
            public:
                typedef CAM::InspectionGroup * value_type;
                /** Default constructor */
            ...
            /** Finds the CAMInspectionGroup object with the given identifier as recorded in a journal. @return  the found object  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Create a program group of the specified type and subtype under the parent group. If the value of
                    ...
                    specified name will be used. @return  the created program group  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Create a method group of the specified type and subtype under the parent group. If the value of
                    ...
                    specified name will be used. @return  the created method group  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Create a tool group of the specified type and subtype under the parent group. If the value of
                    ...
                    specified name will be used. @return  the created tool group  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a program order group builder for Inspection  @return  program order group builder created  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a CMM Inspection method builder  @return  CMM Inspection method builder created  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a probe tool builder for Inspection  @return  probe tool builder created  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::ProbeToolBuilder * CreateProbeToolBuilder
            (
                NXOpen::CAM::CAMObject * param /** probe tool group to be edited */
            );
            /** Creates a machine group builder for Inspection  @return  builder created  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::MachineGroupBuilder * CreateMachineGroupBuilder
            (
                NXOpen::CAM::CAMObject * param /** the object to be edited */
            );
            /** Creates a machine turret group builder  @return  builder created  <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
