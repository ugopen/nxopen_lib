...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  OperationCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a WEDM operation builder  @return  builder created  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::WedmOperationBuilder * CreateWedmOperationBuilder
            (
                NXOpen::CAM::CAMObject * param /** the object to be edited */
            );
            /** Creates a teachmode turning operation builder  @return  operation builder created  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::TeachmodeTurningBuilder * CreateTeachmodeTurningBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );
            /** Creates a Thread Milling operation builder  @return  operation builder created  <br> License requirements : cam_base ("CAM BASE") */
