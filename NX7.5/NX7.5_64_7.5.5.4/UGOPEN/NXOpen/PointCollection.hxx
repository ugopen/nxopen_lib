...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  PointCollection : public TaggedObjectCollection
    {
        ...
        /** Finds the @link  Point   Point @endlink  with the given identifier as recorded in a journal. 
                ...
                An exception will be thrown if no object can be found with the given journal identifier.  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        ...
        /** Creates a quadrant point  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        ...
        /**
          ...
          @return  Point  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
