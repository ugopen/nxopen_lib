...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT  FaceRecognitionBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  a value that indicates whether thickness chain relation recognition is enabled  <br> License requirements : None */
            public: bool ThicknessChainEnabled
            (
            );
            /**Sets  a value that indicates whether thickness chain relation recognition is enabled  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            ...
            /** Recognizes thickness chain relations to last faces added to face collector  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public: void RecognizeThicknessChain
            (
                bool isNear /** true for near relations, false for far relations*/
            );
            /** Removes thickness chain relations to last faces added to face collector  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            ...
            /** Recognizes offset relations to last faces added to face collector  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void RecognizeOffset
            (
                bool isNear /** true for near relations, false for far relations*/
            );
            /** Removes offset relations to last faces added to face collector  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  a value that indicates what kind of relations are needed to recognize  <br> License requirements : None */
            public: int RelationScope
            (
            );
            /**Sets  a value that indicates what kind of relations are needed to recognize  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
