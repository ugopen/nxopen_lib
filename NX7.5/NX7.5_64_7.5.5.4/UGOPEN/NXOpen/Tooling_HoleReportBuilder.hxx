    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT  HoleReportBuilder : public Builder
        {
            ...
            /**Returns  the type of hole table <br> License requirements : None */
            public: NXOpen::Tooling::HoleReportBuilder::Types Type
            (
            );
            /**Sets  the type of hole table <br> License requirements : None */
            public: void SetType
            (
            ...
            /** Create Ordinate Origin  @return  the new ordinate  <br> License requirements : None */
            ...
            /**Returns  the created ordinate origin  <br> License requirements : None */
            public: NXOpen::TaggedObject * CreatedOrdinateOrigin
            (
            );
            /**Sets  the created ordinate origin  <br> License requirements : None */
