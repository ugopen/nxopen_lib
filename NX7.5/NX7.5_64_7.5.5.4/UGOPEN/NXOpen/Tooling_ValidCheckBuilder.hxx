    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT  ValidCheckBuilder : public Builder
        {
            ...
            /**Returns  the box list selected sets name  <br> License requirements : None */
            public: NXString SelectDatasetsName
            (
            );
            /**Sets  the box list selected sets name  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
