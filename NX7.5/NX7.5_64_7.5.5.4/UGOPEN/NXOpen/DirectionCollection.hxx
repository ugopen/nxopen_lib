...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  DirectionCollection : public TaggedObjectCollection
    {
        ...
        /** Creates a @link Direction Direction@endlink  without parameters.  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        ...
        /** Creates a @link Direction Direction@endlink  using a @link Line Line@endlink .  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  using a linear @link Edge Edge@endlink  or
               the axis of a conical @link Edge Edge@endlink .  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  using two @link Routing::ControlPoint Routing::ControlPoint@endlink s.  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  using two @link Point Point@endlink s.  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  using the normal of a @link Face Face@endlink  or
               the axis of a cylindrical @link Face Face@endlink .  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  using the normal of an @link IBasePlane IBasePlane@endlink .  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  on a @link ICurve ICurve@endlink  using a
               @link Scalar Scalar@endlink  representing the t parameter.  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  on a @link ICurve ICurve@endlink  
               at a @link Point Point@endlink .  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
            NXOpen::IBaseCurve * icurve /** icurve */ ,
        ...
        /** Creates a @link Direction Direction@endlink  using an extract
               @link Direction Direction@endlink  with optional @link Xform Xform@endlink .  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  based upon the parameters used
               ...
               point then the vector parameter is ignored.  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
            NXOpen::Point * point /** point */ ,
            const NXOpen::Vector3d & vector /** vector */ 
        ...
        /** Creates a @link Direction Direction@endlink  reverse to that of given
               @link Direction Direction@endlink .  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  using two @link Direction Direction@endlink s.  @return    <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link Direction Direction@endlink  using an @link Expression Expression@endlink .
            @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") */
        public: NXOpen::Direction * CreateDirection
        (
            NXOpen::Point * point /** point */ ,
