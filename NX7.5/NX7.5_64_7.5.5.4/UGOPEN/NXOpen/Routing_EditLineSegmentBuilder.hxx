...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT  EditLineSegmentBuilder : public Builder
        {
            ...
            /**Returns  the line selection.  Stores the line segment selected by the user.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /**Returns  the length expression.  This data from this expression is copied to (or from)
                        the distance constraint applied to the ends of the line segment.   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Expression * Length
            (
            );
            /**Returns  the reverse direction flag.  Flips the direction that the extends towards (or
                        shirinks along).  This flips the origin of the line as well as the direction.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /**Returns  the lock length flag.  Forces the commit method to lock the length to the 
                        ...
                        is unconstrained after the commit method is invoked.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Determines the orienation information for the line selected by the user.  Returns
                        false if there is no line currently stored in the builder.   @return  True if there
                                                                                                is a line 
                                                                                                associated with
                                                                                                this builder.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /** Stop the drag operation if it has begun. This will commit the drag and update the assembly.
                        ...
                        @link Routing::EditLineSegmentBuilder::RestartDrag Routing::EditLineSegmentBuilder::RestartDrag@endlink .  <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
            public: void StopDrag
            (
            );
            /** Restart a line drag operation. This routine should only be called if 
                    @link Routing::EditLineSegmentBuilder::StopDrag Routing::EditLineSegmentBuilder::StopDrag@endlink . was previously
                    called to stop a line drag operation.  <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
