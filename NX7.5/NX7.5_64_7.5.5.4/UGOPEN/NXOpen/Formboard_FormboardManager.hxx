...
namespace NXOpen
{
    ...
    namespace Formboard
    {
        ...
        class NXOPENCPPEXPORT  FormboardManager
        {
            ...
            /** Shows all of the hidden formboard constraints.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") */
            public: void ShowFormboardConstraints
            (
            );
            /** Hides the formboard constraints.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") */
