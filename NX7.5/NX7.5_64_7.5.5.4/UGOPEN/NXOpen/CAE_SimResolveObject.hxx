    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  SimResolveObject : public NXObject
        {
            ...
            public: enum Rule
            {
                ...
                RuleIgnoreConflict/** Ignores conflicts between BCs as there is no DOF level conflict */,
                RuleMax/** Count of rules */
            };

            private: SimResolveObjectImpl * m_simresolveobject_impl;
            private: friend class  _SimResolveObjectBuilder;
            protected: SimResolveObject();
            public: ~SimResolveObject();
            ...
            /**Returns  the bc used when the rule is set to @link CAE::SimResolveObject::RuleParent CAE::SimResolveObject::RuleParent@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SimBC * ParentBc
            (
            );
            /**Sets  the bc used when the rule is set to @link CAE::SimResolveObject::RuleParent CAE::SimResolveObject::RuleParent@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetParentBc
            (
                NXOpen::CAE::SimBC * bc /** bc to be used when the rule is set to @link CAE::SimResolveObject::RuleParent CAE::SimResolveObject::RuleParent@endlink  */
            );
