...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  WCS
    {
        ...
        /** Changes the coordinate system of the WCS to a new
         ...
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX4.0.0") NXOpen::CoordinateSystem * SetCoordinateSystem
        (
            NXOpen::CoordinateSystem * newCs /** The new coordinate system for the WCS */
        );
        /** Changes the coordinate system of the WCS to a new
        ...
        /** Creates a WCS at a new coordinate system.  The return value
             is the old coordinate system of wcs.  @return  The old coordinate system for the WCS  <br> License requirements : None */
