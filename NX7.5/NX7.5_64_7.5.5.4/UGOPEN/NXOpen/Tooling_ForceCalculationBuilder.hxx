...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /**
             Represents a @link Tooling::ForceCalculationBuilder Tooling::ForceCalculationBuilder@endlink 
             Force Calculation Design is to calculate force of process
             <br> To create a new instance of this class, use @link Tooling::ForceCalculationCollection::CreateForceCalculationBuilder Tooling::ForceCalculationCollection::CreateForceCalculationBuilder@endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPPEXPORT  ForceCalculationBuilder : public Builder
        {
            /** The process type. */
            ...
            /**Returns  the face of the process.  <br> License requirements : None */
            public: NXOpen::ScCollector * ProcessFace
            (
            );
            /**Returns  the process name.  <br> License requirements : None */
            public: NXString ProcessName
            (
            );
            /**Sets  the process name.  <br> License requirements : None */
            ...
            /**Sets  the process type.  <br> License requirements : None */
            public: void SetProcessType
            (
                NXOpen::Tooling::ForceCalculationBuilder::ProcessTypes processType /** processtype */ 
            );
            /**Returns  the parameter expression to calculate the process force.  <br> License requirements : None */
            public: NXString Parameter
            (
            );
            /**Sets  the parameter expression to calculate the process force.  <br> License requirements : None */
            public: void SetParameter
            (
                const NXString & parameterExp /** parameterexp */ 
            );
            /**Returns  the process used to calculate force.  <br> License requirements : None */
            public: NXOpen::SelectFaceList * ForceProcess
            (
            );
            /**Returns  the process force of the calculated result.  <br> License requirements : None */
            public: NXString ProcessForce
            (
            );
            /**Sets  the process force of the calculated result.  <br> License requirements : None */
            public: void SetProcessForce
            (
                const NXString & processForce /** Indicates the string of process force */
            );
            /**Returns  the pressure-pad-force of the process.  <br> License requirements : None */
            public: NXString HoldingForce
            (
            );
            /**Sets  the pressure-pad-force of the process.  <br> License requirements : None */
            public: void SetHoldingForce
            (
                const NXString & holdingForce /** Indicates the string of holding force */
            );
            /**Returns  the cutting perimeter length for EDM of the process.  <br> License requirements : None */
            public: NXString CuttingPerimeter
            (
            );
            /**Sets  the cutting perimeter length for EDM of the process.  <br> License requirements : None */
            public: void SetCuttingPerimeter
            (
                const NXString & cuttingPerimeter /** Indicates the string of cutting perimeter length */
            );
            /**Returns  the gravity center of the process.  <br> License requirements : None */
            public: NXString GravityCenter
            (
            );
            /**Sets  the gravity center of the process.  <br> License requirements : None */
            public: void SetGravityCenter
            (
                const NXString & gravityCenter /** Indicates the string of process gravity center */
            );
            /**Returns  the total force of the calculated processes . <br> License requirements : None */
            public: NXString TotalForce
            (
            );
            /**Sets  the total force of the calculated processes . <br> License requirements : None */
            public: void SetTotalForce
            (
                const NXString & totalForce /** Indicates the string of total process force */
            );
            /**Returns  the total force center of the calculated processes .  <br> License requirements : None */
            public: NXString TotalForceCenter
            (
            );
            /**Sets  the total force center of the calculated processes .  <br> License requirements : None */
            ...
            /**Sets  the calculation method.  <br> License requirements : None */
            public: void SetCalculationType
            (
                NXOpen::Tooling::ForceCalculationBuilder::CalculationTypes calculationType /** calculationtype */ 
            );
            /**Returns  the decimal places of the calculated force result.  <br> License requirements : None */
            public: int DecimalPlaces
            (
            );
            /**Sets  the decimal places of the calculated force result.  <br> License requirements : None */
