...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  TurnToolBuilder : public CAM::TurningToolBuilder
        {
            ...
            /**Returns  the nose angle builder (inheritable double)  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * NoseAngleBuilder
            (
            );
            /**Returns  the size option  <br> License requirements : None */
            public: NXOpen::CAM::TurnToolBuilder::SizeOptions SizeOption
            (
            );
            /**Sets  the size option  <br> License requirements : None */
            public: void SetSizeOption
            (
                NXOpen::CAM::TurnToolBuilder::SizeOptions sizeOption /** sizeoption */ 
            );
            /**Returns  the size builder (inheritable double)  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * SizeBuilder
            (
            );
            /**Returns  the button diameter builder (inheritable double)  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * ButtonDiameterBuilder
            (
            );
            /**Returns  the holder control width (inheritable double)  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * HolderControlWidthBuilder
            (
            );
            /**Returns  the holder control angle (inheritable double)  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * HolderControlAngleBuilder
            (
            );
            /**Returns  the relief angle type  <br> License requirements : None */
            public: NXOpen::CAM::TurnToolBuilder::ReliefAngleTypes ReliefAngleType
            (
            );
            /**Sets  the relief angle type  <br> License requirements : None */
            public: void SetReliefAngleType
            (
                NXOpen::CAM::TurnToolBuilder::ReliefAngleTypes reliefAngleType /** reliefangletype */ 
            );
            /**Returns  the relief angle (inheritable double)  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * ReliefAngleBuilder
            (
            );
            /**Returns  the thickness type  <br> License requirements : None */
            public: NXOpen::CAM::TurnToolBuilder::ThicknessTypes ThicknessType
            (
            );
            /**Sets  the thickness type  <br> License requirements : None */
            public: void SetThicknessType
            (
                NXOpen::CAM::TurnToolBuilder::ThicknessTypes thicknessType /** thicknesstype */ 
            );
            /**Returns  the turn holder style  <br> License requirements : None */
            public: NXOpen::CAM::TurnToolBuilder::HolderStyles HolderStyle
            (
            );
            /**Sets  the turn holder style  <br> License requirements : None */
            public: void SetHolderStyle
            (
                NXOpen::CAM::TurnToolBuilder::HolderStyles holderStyle /** holderstyle */ 
            );
            /**Returns  the turn holder hand  <br> License requirements : None */
            public: NXOpen::CAM::TurnToolBuilder::HolderHands HolderHand
            (
            );
            /**Sets  the turn holder hand  <br> License requirements : None */
