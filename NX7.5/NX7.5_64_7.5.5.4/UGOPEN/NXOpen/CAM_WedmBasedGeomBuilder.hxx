...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  WedmBasedGeomBuilder : public CAM::ParamBuilder
        {
            ...
            /**Returns  the Cutoff Distance  <br> License requirements : cam_base ("CAM BASE") */
            public: double CutoffDistance
            (
            );
            /**Sets  the Cutoff Distance  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCutoffDistance
            (
                double cutoffDistance /** the Cutoff Distance  */
            );
            /**Returns  the Cutoff Stock  <br> License requirements : cam_base ("CAM BASE") */
            public: double CutoffStock
            (
            );
            /**Sets  the Cutoff Stock  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the Custom Boundary Data List  <br> License requirements : cam_base ("CAM BASE") */
