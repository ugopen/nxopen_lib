...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class DmSurfStepoverCiBuilderImpl;
        /** Represents a DmSurfStepoverCiBuilder */
        class NXOPENCPPEXPORT  DmSurfStepoverCiBuilder : public TaggedObject
        {
            ...
            private: DmSurfStepoverCiBuilderImpl * m_dmsurfstepovercibuilder_impl;
            private: friend class  _DmSurfStepoverCiBuilderBuilder;
            protected: DmSurfStepoverCiBuilder();
            public: ~DmSurfStepoverCiBuilder();
            ...
            (
                NXOpen::CAM::DmSurfStepoverCiBuilder::StepoverType dmSurfStepover /** the value of Stepover */
            );
            ...
            (
                int dmSurfStepoverNumStepover /** the Number of Steps value */
            );
            ...
            (
                int dmSurfStepoverFirstDir /** the First Direction value */
            );
            ...
            (
                int dmSurfStepoverSecondDir /** the Second Direction value */
            );
        };
    }
}
