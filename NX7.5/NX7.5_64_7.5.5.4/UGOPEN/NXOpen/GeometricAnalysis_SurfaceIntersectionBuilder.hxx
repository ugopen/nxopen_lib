...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPPEXPORT  SurfaceIntersectionBuilder : public Builder
        {
            /** Projection  types */
            ...
            /**Returns  the first selected face set  <br> License requirements : None */
            public: NXOpen::ScCollector * FirstFaceSet
            (
            );
            /**Returns  the second selected face set  <br> License requirements : None */
            public: NXOpen::ScCollector * SecondFaceSet
            (
            );
            /**Returns  the projection option <br> License requirements : None */
            public: NXOpen::GeometricAnalysis::SurfaceIntersectionBuilder::ProjectionTypes ProjectionOption
            (
            );
            /**Sets  the projection option <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            ...
            /**Sets  the dynamic projection  <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: void SetDynamicProjection
            (
                bool dynamicProjection /** dynamicprojection */ 
            );
            /** Update work view with a given view matrix  <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            ...
            /**Sets  the vector  <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
