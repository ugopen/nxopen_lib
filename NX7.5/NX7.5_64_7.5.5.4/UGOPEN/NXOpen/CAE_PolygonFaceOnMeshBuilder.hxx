    ...
    namespace CAE
    {
        ...
        /**
            Builder for creating Polygon Face On Mesh
             <br> To create a new instance of this class, use @link CAE::AbstractionManager::CreatePolygonFaceOnMeshBuilder CAE::AbstractionManager::CreatePolygonFaceOnMeshBuilder@endlink  <br> */
        class NXOPENCPPEXPORT  PolygonFaceOnMeshBuilder : public Builder
        {
            ...
            /**Returns  the selected element(s)  <br> License requirements : None */
            ...
            /**Returns  the select body option for different ways of body select method  <br> License requirements : None */
            public: NXOpen::CAE::PolygonFaceOnMeshBuilder::SelectBodyMethod SelectBodyOption
            (
            );
            /**Sets  the select body option for different ways of body select method  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetSelectBodyOption
            (
                NXOpen::CAE::PolygonFaceOnMeshBuilder::SelectBodyMethod selectBodyMethod /** selectbodymethod */ 
            );
            /**Returns  the selected body  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
