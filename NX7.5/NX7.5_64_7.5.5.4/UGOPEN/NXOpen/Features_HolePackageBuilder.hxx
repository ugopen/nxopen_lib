...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        GeneralHoleDepth.Value (deprecated) </td> <td> 
         
        50.0 (millimeters part), 2.0 (inches part) </td> </tr> 

        <tr><td> 
         
        GeneralHoleDiameter.Value (deprecated) </td> <td> 
        ...
        */
        class NXOPENCPPEXPORT  HolePackageBuilder : public Features::FeatureBuilder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Expression * GeneralHoleDiameter
            (
            );
            ...
            /**Returns  the hole depth - this is applicable for general hole 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Expression * GeneralHoleDepth
            (
            );
            ...
            /**Returns  the extend start enabled - this is applicable for start extension to all hole types  <br> License requirements : None */
            public: bool StartExtensionEnabled
            (
            );
            /**Sets  the extend start enabled - this is applicable for start extension to all hole types  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
