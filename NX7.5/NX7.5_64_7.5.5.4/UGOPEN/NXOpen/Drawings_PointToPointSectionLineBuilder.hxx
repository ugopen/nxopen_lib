...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT  PointToPointSectionLineBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the list of cut segments.
                        ...
                        determined by the hinge or arrow direction.  <br> License requirements : None */
