...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  MillCutParameters : public CAM::CutParameters
        {
            ...
            /**Returns  the shroud stock  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * ShroudStock
            (
            );
            /**Returns  the blade stock  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * BladeStock
            (
            );
            /**Returns  the blend stock  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * BlendStock
            (
            );
            /**Returns  the hub stock  <br> License requirements : None */
            ...
            /**Returns  the degree of tool path smoothing   <br> License requirements : None */
            public: int ToolpathSmoothing
            (
            );
            /**Sets  the degree of tool path smoothing   <br> License requirements : cam_base ("CAM BASE") */
            public: void SetToolpathSmoothing
            (
                int smoothing /** the Smoothing value */
            );
            /**Returns  the degree of tool axis smoothing   <br> License requirements : None */
            public: int ToolAxisSmoothing
            (
            );
            /**Sets  the degree of tool axis smoothing   <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the from leading edge  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * FromLeadingEdge
            (
            );
            /**Returns  the from trailing edge  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * FromTrailingEdge
            (
            );
            /**Returns  the max blade roll angle  <br> License requirements : None */
            public: double TlaxisBladeRollAngle
            (
            );
            /**Sets  the max blade roll angle  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the Z Axis Smoothing.  <br> License requirements : None */
            public: NXOpen::CAM::ZAxisSmoothing * ZAxisSmoothing
            (
            );
            /**Returns  the Corner Finding Options  <br> License requirements : None */
            public: NXOpen::CAM::CutParametersCornerFindingTypes CornerFindingOptions
            (
            );
            /**Sets  the Corner Finding Options  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCornerFindingOptions
            (
                NXOpen::CAM::CutParametersCornerFindingTypes cornerFinding /** the Finding Corner type */
            );
            /**Returns  the global optimzation status <br> License requirements : None */
            public: bool GlobalOptimization
            (
            );
            /**Sets  the global optimzation status <br> License requirements : cam_base ("CAM BASE") */
            public: void SetGlobalOptimization
            (
                bool globalOptStatus /** global optimization status */
            );
            /**Returns  the status for doing Blank Sensitive finish on the last cut level  <br> License requirements : None */
            public: bool ApplyToLastPass
            (
            );
            /**Sets  the status for doing Blank Sensitive finish on the last cut level  <br> License requirements : cam_base ("CAM BASE") */
