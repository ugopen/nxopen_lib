...
namespace NXOpen
{
    ...
    namespace Fields
    {
        ...
        class NXOPENCPPEXPORT  Field : public DisplayableObject
        {
            ...
            /** Returns a field evaluator which can be used to evaluate this field.
                     @return  Field Evaluator  <br> License requirements : None */
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.1") void CopyToPart
            (
                NXOpen::BasePart * targetPart /** target part */
            );
            /** Copy the field to the target part.
                     @return  newly created field  <br> License requirements : None */
            ...
            /** Create a new table field from this field (regardless of type).  Note
             ...
             @deprecated Deprecated in NX6.0.1 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.1") void CopyAsTableToPart
            (
                NXOpen::BasePart * targetPart /** target part */
            );
            /** Create a new table field from this field (regardless of type).  Note
                    ...
                    * resulting in a grid (or lattice).  The resulting field will be in the
                    * same part.
                     @return  newly created table  <br> License requirements : None */
            ...
            /** Returns the spatial map for the formula field if one exists.
                     @return  spatial map   <br> License requirements : None */
            ...
            /** Returns the description of the field.
                     @return  description  <br> License requirements : None */
            ...
            /** Returns the dependent variables for this @link Fields::Field Fields::Field@endlink   
                     @return  dependent variables for this @link Fields::FieldVariable Fields::FieldVariable@endlink    <br> License requirements : None */
            ...
            /** Returns the independent variables for this @link Fields::Field Fields::Field@endlink   
                     @return  independent variables for this @link Fields::FieldVariable Fields::FieldVariable@endlink    <br> License requirements : None */
