...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  OrientGeomBuilder : public CAM::NCGroupBuilder
        {
            ...
            /** Sets the CSYS purpose  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /** Sets the Special Output  <br> License requirements : cam_base ("CAM BASE") */
