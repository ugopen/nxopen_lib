...
namespace NXOpen
{
    namespace Weld
    {
        ...
        enum WeldFeatureSetType
        {
            ...
            WeldFeatureSetTypeBiwDatumSurface/** Datum Surface Type */,
            WeldFeatureSetTypeBiwDatumPin/** Datum Pin Type    */,
            WeldFeatureSetTypeBiwDatumCustomer1/** Datum Customer1 Type    */,
            WeldFeatureSetTypeBiwDatumCustomer2/** Datum Customer2 Type    */,
            WeldFeatureSetTypeBiwDatumCustomer3/** Datum Customer3 Type    */,
            WeldFeatureSetTypeBiwMeasurementSurface/** Surface Type */,
            WeldFeatureSetTypeBiwMeasurementHole/** Hole Type    */,
            WeldFeatureSetTypeBiwMeasurementSlot/** Slot Type    */,
            WeldFeatureSetTypeBiwMeasurementStud/** Stud Type    */,
            WeldFeatureSetTypeBiwMeasurementTrim/** Trim Type    */,
            WeldFeatureSetTypeBiwMeasurementHem/** Hem Type     */,
            WeldFeatureSetTypeBiwMeasurementCustomer1/** Customer1 Type */,
            WeldFeatureSetTypeBiwMeasurementCustomer2/** Customer2 Type */,
            WeldFeatureSetTypeBiwMeasurementCustomer3/** Customer3 Type */
        };
        ...
        enum WeldAdvisorCustomerDefault
        {
            ...
            WeldAdvisorCustomerDefaultCustom1Point/** Custom1    */,
            WeldAdvisorCustomerDefaultCustom2Point/** Custom2    */,
            WeldAdvisorCustomerDefaultCustom3Point/** Custom3    */,
            WeldAdvisorCustomerDefaultCustom4Point/** Custom4    */,
            WeldAdvisorCustomerDefaultCustom5Point/** Custom5    */,
