...
namespace NXOpen
{
    ...
    class NXOPENDEBUGSESSIONCPPEXPORT  ModelingAutotestPrint
    {
        ...
        /** Print G0/G1/G2/G3 continuities of a curve  <br> License requirements : None */
        ...
        /** Creates feature validator.  @return   <br> License requirements : None */
        public: NXOpen::FeatureCollectionValidator * CreateFeatureCollectionValidator
        (
            NXOpen::Part * part /** part */ 
        );
        /** Creates visible feature validator.  @return   <br> License requirements : None */
        public: NXOpen::FeatureCollectionValidator * CreateVisibleFeatureCollectionValidator
        (
            NXOpen::Part * part /** part */ 
        );
        /** Print deviation of curves to face and face to face  <br> License requirements : None */
        ...
        /** Creates curve validator.  @return   <br> License requirements : None */
