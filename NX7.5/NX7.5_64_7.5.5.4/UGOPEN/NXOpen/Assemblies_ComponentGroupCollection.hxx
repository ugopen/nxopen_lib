...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        class NXOPENCPPEXPORT  ComponentGroupCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Assemblies::ComponentGroup Assemblies::ComponentGroup@endlink  with the given name  @return  the ComponentGroup created  <br> License requirements : adv_assemblies ("ADVANCED ASSEMBLIES") */
