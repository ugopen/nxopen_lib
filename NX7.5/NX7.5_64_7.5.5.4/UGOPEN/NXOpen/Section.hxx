...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  Section : public DisplayableObject
    {
        ...
        /** Add smart point into section. 
         ...
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public:  NX_DEPRECATED("Deprecated in NX7.5.0") void AddSmartPoint
        (
        ...
        /** Removes multiple section elements that are either curves/edges. <br> License requirements : None */
        public: void RemoveMultipleCurves
        (
        ...
        /** Removes multiple section elements that are points. <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: void RemoveMultiplePoints
        (
        ...
        /** Clone section.  @return  the cloned section <br> License requirements : None */
        ...
        /**Prepares Mapping Data
            ...
            This method should be used to create mapping data if mapping is to be done
             <br>  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Get the Allowed Entity Types. 
            ...
            Works only for UF_SC_CURVE_dumb_data_s and UF_SC_CURVE_feature_data_s
             <br> 
             @return  allowed entity types <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Adds a chain between given two intersection points to the section. <br> License requirements : solid_modeling ("SOLIDS MODELING") */
