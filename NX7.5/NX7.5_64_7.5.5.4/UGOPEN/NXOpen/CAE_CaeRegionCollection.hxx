...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  CaeRegionCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link CAE::CaeRegion CAE::CaeRegion@endlink   @return  Region object created  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Copies a @link CAE::CaeRegion CAE::CaeRegion@endlink   @return  newly created region  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Finds the @link CAE::CaeRegion CAE::CaeRegion@endlink  with the given identifier as recorded in a journal.
                    An exception will be thrown if no object can be found with the given journal identifier.  @return  Region found  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
