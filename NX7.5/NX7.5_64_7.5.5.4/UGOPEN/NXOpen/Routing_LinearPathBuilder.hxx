    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPPEXPORT  LinearPathBuilder : public Builder
        {
            ...
            /** Returns the last control point in the path.  @return   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
