...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            ...
            */
        class NXOPENCPPEXPORT  LineArrowStyleBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the first arrowhead type  <br> License requirements : None */
            public: NXOpen::Annotations::ArrowheadType FirstArrowType
            (
            );
            /**Sets  the first arrowhead type  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstArrowType
            (
                NXOpen::Annotations::ArrowheadType firstArrowType /** firstarrowtype */ 
            );
            /**Returns  the second arrowhead type  <br> License requirements : None */
            public: NXOpen::Annotations::ArrowheadType SecondArrowType
            (
            );
            /**Sets  the second arrowhead type  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the leader location  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the arrowhead length  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the arrowhead included angle  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the dot arrowhead diameter  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDotArrowheadDiameter
            (
                double dotArrowheadDiameter /** dotarrowheaddiameter */ 
            );
            /**Returns  the stub length. This is the size of the dogleg on a label or dimension  <br> License requirements : None */
            public: double StubLength
            (
            );
            /**Sets  the stub length. This is the size of the dogleg on a label or dimension  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetStubLength
            (
                double stubLength /** stublength */ 
            );
            /**Returns  the distance from the text to the dimension line(stub) or arc  <br> License requirements : None */
            public: double TextToLineDistance
            (
            );
            /**Sets  the distance from the text to the dimension line(stub) or arc  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetTextToLineDistance
            (
                double textToLineDistance /** texttolinedistance */ 
            );
            /**Returns  the distance an extension line or arc extends past the dimension line or arc  <br> License requirements : None */
            public: double LinePastArrowDistance
            (
            );
            /**Sets  the distance an extension line or arc extends past the dimension line or arc  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLinePastArrowDistance
            (
                double linePastArrowDistance /** linepastarrowdistance */ 
            );
            /**Returns  the extension line angle. This angle only applies to vertical and horizontal dimensions  <br> License requirements : None */
            public: double ObliqueExtensionLineAngle
            (
            );
            /**Sets  the extension line angle. This angle only applies to vertical and horizontal dimensions  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the distance from the position on the object being dimensioned to
                        the end of the first extension line or arc  <br> License requirements : None */
            public: double FirstPosToExtensionLineDistance
            (
            );
            /**Sets  the distance from the position on the object being dimensioned to
                        the end of the first extension line or arc  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstPosToExtensionLineDistance
            (
                double firstPosToExtensionLineDistance /** firstpostoextensionlinedistance */ 
            );
            /**Returns  the  distance from the position on the object being dimensioned to
                        the end of the second extension line  <br> License requirements : None */
            public: double SecondPosToExtensionLineDistance
            (
            );
            /**Sets  the  distance from the position on the object being dimensioned to
                        the end of the second extension line  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the distance from the apex of the datum arrowhead to the
                        end of the extension line  <br> License requirements : None */
            public: double DatumLengthPastArrow
            (
            );
            /**Sets  the distance from the apex of the datum arrowhead to the
                        end of the extension line  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the character size factor which controls the distance between the stub and label text
                        when the text displays above the stub line  <br> License requirements : None */
            ...
            /**Sets  the character size factor which controls the distance between the stub and label text
                        when the text displays above the stub line  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetTextOverStubFactor
            (
                double textOverStubFactor /** textoverstubfactor */ 
            );
            /**Returns  the first extension line color  <br> License requirements : None */
            public: NXOpen::NXColor * FirstExtensionLineColor
            (
            );
            /**Sets  the first extension line color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstExtensionLineColor
            (
                NXOpen::NXColor * firstExtensionLineColor /** firstextensionlinecolor */ 
            );
            /**Returns  the first extension line font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont FirstExtensionLineFont
            (
            );
            /**Sets  the first extension line font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstExtensionLineFont
            (
                NXOpen::DisplayableObject::ObjectFont firstExtensionLineFont /** firstextensionlinefont */ 
            );
            /**Returns  the first extension line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth FirstExtensionLineWidth
            (
            );
            /**Sets  the first extension line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstExtensionLineWidth
            (
                NXOpen::Annotations::LineWidth firstExtensionLineWidth /** firstextensionlinewidth */ 
            );
            /**Returns  the first arrowhead color  <br> License requirements : None */
            public: NXOpen::NXColor * FirstArrowheadColor
            (
            );
            /**Sets  the first arrowhead color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstArrowheadColor
            (
                NXOpen::NXColor * firstArrowheadColor /** firstarrowheadcolor */ 
            );
            /**Returns  the first arrowhead font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont FirstArrowheadFont
            (
            );
            /**Sets  the first arrowhead font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstArrowheadFont
            (
                NXOpen::DisplayableObject::ObjectFont firstArrowheadFont /** firstarrowheadfont */ 
            );
            /**Returns  the first arrowhead width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth FirstArrowheadWidth
            (
            );
            /**Sets  the first arrowhead width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstArrowheadWidth
            (
                NXOpen::Annotations::LineWidth firstArrowheadWidth /** firstarrowheadwidth */ 
            );
            /**Returns  the first arrow line color  <br> License requirements : None */
            public: NXOpen::NXColor * FirstArrowLineColor
            (
            );
            /**Sets  the first arrow line color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstArrowLineColor
            (
                NXOpen::NXColor * firstArrowLineColor /** firstarrowlinecolor */ 
            );
            /**Returns  the first arrow line font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont FirstArrowLineFont
            (
            );
            /**Sets  the first arrow line font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstArrowLineFont
            (
                NXOpen::DisplayableObject::ObjectFont firstArrowLineFont /** firstarrowlinefont */ 
            );
            /**Returns  the first arrow line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth FirstArrowLineWidth
            (
            );
            /**Sets  the first arrow line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFirstArrowLineWidth
            (
                NXOpen::Annotations::LineWidth firstArrowLineWidth /** firstarrowlinewidth */ 
            );
            /**Returns  the second extension line color  <br> License requirements : None */
            public: NXOpen::NXColor * SecondExtensionLineColor
            (
            );
            /**Sets  the second extension line color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSecondExtensionLineColor
            (
                NXOpen::NXColor * secondExtensionLineColor /** secondextensionlinecolor */ 
            );
            /**Returns  the second extension line font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont SecondExtensionLineFont
            (
            );
            /**Sets  the second extension line font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the second extension line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth SecondExtensionLineWidth
            (
            );
            /**Sets  the second extension line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSecondExtensionLineWidth
            (
                NXOpen::Annotations::LineWidth secondExtensionLineWidth /** secondextensionlinewidth */ 
            );
            /**Returns  the second arrowhead color  <br> License requirements : None */
            public: NXOpen::NXColor * SecondArrowheadColor
            (
            );
            /**Sets  the second arrowhead color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSecondArrowheadColor
            (
                NXOpen::NXColor * secondArrowheadColor /** secondarrowheadcolor */ 
            );
            /**Returns  the second arrowhead font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont SecondArrowheadFont
            (
            );
            /**Sets  the second arrowhead font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSecondArrowheadFont
            (
                NXOpen::DisplayableObject::ObjectFont secondArrowheadFont /** secondarrowheadfont */ 
            );
            /**Returns  the second arrowhead width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth SecondArrowheadWidth
            (
            );
            /**Sets  the second arrowhead width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSecondArrowheadWidth
            (
                NXOpen::Annotations::LineWidth secondArrowheadWidth /** secondarrowheadwidth */ 
            );
            /**Returns  the second arrow line color  <br> License requirements : None */
            public: NXOpen::NXColor * SecondArrowLineColor
            (
            );
            /**Sets  the second arrow line color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSecondArrowLineColor
            (
                NXOpen::NXColor * secondArrowLineColor /** secondarrowlinecolor */ 
            );
            /**Returns  the second arrow line font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont SecondArrowLineFont
            (
            );
            /**Sets  the second arrow line font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSecondArrowLineFont
            (
                NXOpen::DisplayableObject::ObjectFont secondArrowLineFont /** secondarrowlinefont */ 
            );
            /**Returns  the second arrow line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth SecondArrowLineWidth
            (
            );
            /**Sets  the second arrow line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
