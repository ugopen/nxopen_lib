    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  SimSimulation : public NXObject
        {
            ...
            /** Creates a @link CAE::AutoBCBuilder CAE::AutoBCBuilder@endlink   @return  The AutoBCBuilder object 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::CAE::AutoBCBuilder * CreateAutoBcBuilder
            (
            ...
            /** Creates a @link CAE::LaminateMetaSolBuilder CAE::LaminateMetaSolBuilder@endlink   @return  the LaminateMetaSolBuilder object  <br> License requirements : nx_lam_composites ("Laminate Composites") */
            ...
            /** Creates a @link CAE::CaeRegionBuilder CAE::CaeRegionBuilder@endlink   @return  The RegionBuilder object  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Creates a @link CAE::LaminateQuickPostReportBuilder CAE::LaminateQuickPostReportBuilder@endlink   @return   <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateQuickPostReportBuilder * CreateLaminateQuickPostReportBuilder
            (
