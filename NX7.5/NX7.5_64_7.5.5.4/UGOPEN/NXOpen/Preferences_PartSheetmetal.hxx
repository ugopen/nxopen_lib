    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT  PartSheetmetal
        {
            ...
            /** Returns the flag indicating whether or not maintain holes in deformed flanges as part of the Flat Solid creation.
                    ...
                    Instead use @link Preferences::PartSheetmetal::GetMaintainCircularShapeForHolesInFlatSolid Preferences::PartSheetmetal::GetMaintainCircularShapeForHolesInFlatSolid@endlink 
                     <br>    
                    
                     @return  flag  
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") bool GetMaintainHolesInDeformedFlangesInFlatSolid
            (
            );
            /** Sets the flag indicating whether or not maintain holes in deformed flanges as part of the Flat Solid creation. 
                    
                     <br> This method is deprecated.
                    Instead use @link Preferences::PartSheetmetal::SetMaintainCircularShapeForHolesInFlatSolid Preferences::PartSheetmetal::SetMaintainCircularShapeForHolesInFlatSolid@endlink   
                     <br>       
                    
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetMaintainHolesInDeformedFlangesInFlatSolid
            (
                bool updateModel /** Specifies whether the solid model be recomputed immediately*/,
            ...
            /** RETURNS the top face color.  @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public: NXOpen::NXColor * GetFlexibleCableTopFaceColor
            (
            );
            /** THE top face color.  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public: void SetFlexibleCableTopFaceColor
            (
                NXOpen::NXColor * topFaceColor /** topfacecolor */ 
            );
            /** RETURNS the bottom face color.  @return   <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
            public: NXOpen::NXColor * GetFlexibleCableBottomFaceColor
            (
            );
            /** THE bottom face color.  <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
