...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  MappedMeshBuilder : public Builder
        {
            ...
            /**Returns  the edge match toggle  <br> License requirements : None */
            public: bool EdgeMatchOption
            (
            );
            /**Sets  the edge match toggle  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  the project vertices option  <br> License requirements : None */
            public: bool ProjectVertices
            (
            );
            /**Sets  the project vertices option  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetProjectVertices
            (
                bool projectVerticesOption /** project vertices option */ 
            );
            /**Returns  the flip diagonals option  <br> License requirements : None */
            public: bool FlipDiagonals
            (
            );
            /**Sets  the flip diagonals option  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
