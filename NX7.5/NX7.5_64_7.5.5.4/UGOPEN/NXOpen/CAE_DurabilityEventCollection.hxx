...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  DurabilityEventCollection : public TaggedObjectCollection
        {
            ...
            /** Finds a durability event with a specified name.  @return  The durability event  <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public: NXOpen::CAE::DurabilityEvent * FindObject
            (
                const NXString & name /** name of the durability event  */
            );
            /** Delete a durability event.  <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public: void DeleteEvent
            (
                NXOpen::CAE::DurabilityEvent * eventTag /** The durability event to be deleted */
            );
            /** Makes a clone of a durability event.  @return  Cloned event  <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public: NXOpen::CAE::DurabilityEvent * CloneEvent
            (
                NXOpen::CAE::DurabilityEvent * source /** Source event */
            );
            /** Creates the builder object of the durability static event.  @return    <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            ...
            /** Creates the builder object of the durability transient event.  @return    <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
