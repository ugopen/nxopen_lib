    ...
    namespace BlockStyler
    {
        ...
        class NXOPENUICPPEXPORT  Node : public TaggedObject
        {
            ...
            /**Scrolls horizontally and vertically to make the specific column of 
                    node appear on the tree window. <br> License requirements : None */
            ...
            /**Expands/collapses the node <br> License requirements : None */
            public: void Expand
            (
            ...
            /**Gets the node state associated with node state icon. Node state is an iconic 
                   ...
                   value 1 and 2 represents the standard checked and unchecked state respectively. @return Node state <br> License requirements : None */
            public: int GetState
            (
            );
            /**Sets the node state which is associated with node state icon. Node state is an iconic 
                   ...
                   the icon name. <br> License requirements : None */
            public: void SetState
            (
                int state /**Node state*/
            );
            /**Returns  the display text of node. This is same as 0th column text of this node. 
                   Use @link BlockStyler::Node::SetColumnDisplayText BlockStyler::Node::SetColumnDisplayText@endlink  to fetch the text of other column of the same node.  <br> License requirements : None */
            ...
            /**Gets the column text for the given columnId. 
                   ...
                   @link BlockStyler::Tree::ColumnDisplayIcon BlockStyler::Tree::ColumnDisplayIcon@endlink . @return Text associated with column. <br> License requirements : None */
            ...
            /**Sets the text in the column which corresponds to given columnId. 
                   The text is interpreted as icon if the column display type is  
                   @link BlockStyler::Tree::ColumnDisplayIcon BlockStyler::Tree::ColumnDisplayIcon@endlink . <br> License requirements : None */
            ...
            /**Returns the flag indicating whether cross section is allowed. 
                   ...
                   highlighted, else not. The default value is True <br> License requirements : None */
            ...
            /**Returns the text color of the node. The color is applicable for whole row. <br> License requirements : None */
            public: int ForegroundColor
            (
            );
            /**Sets the text color of the node. The color is applicable for whole row. <br> License requirements : None */
            public: void SetForegroundColor
            (
                int nodeForgroundColor /**Foreground color.*/
            );
            /**Returns the first child node. Returns NULL if child node is not present. <br> License requirements : None */
            ...
            /**Returns the next node which might not belong to the same hierarchy. 
                   ...
                   Returns NULL if next node is not present <br> License requirements : None */
            public: NXOpen::BlockStyler::Node * NextNode
            (
            );
            /**Returns  the next node which belongs to the same hierarchy. 
                   Returns NULL null if next sibling node is not present. <br> License requirements : None */
            public: NXOpen::BlockStyler::Node * NextSiblingNode
            (
            );
            /**Returns the parent node. Returns NULL if parent node is not present <br> License requirements : None */
            public: NXOpen::BlockStyler::Node * ParentNode
            (
            );
            /**Returns the previous node which might not belong to the same hierarchy. 
                   Returns NULL null if previous node is not present <br> License requirements : None */
            ...
            /**Returns the previous selected node in the whole tree hierarchy. The node on which this method is called does not have to be selected.
                   Returns NULL if none of the previous nodes are selected. <br> License requirements : None */
            public: NXOpen::BlockStyler::Node * PreviousSelectedNode
            (
            );
            /**Returns the next selected node in the whole tree hierarchy. The node on which this method is called does not have to be selected. Returns NULL if none of the next nodes are selected. <br> License requirements : None */
            public: NXOpen::BlockStyler::Node * NextSelectedNode
            (
            );
            /**Returns the previous node which belongs to the same hierarchy. 
                   Returns NULL if previous sibling node is not present. <br> License requirements : None */
            ...
            /**Returns the display icon. This is normal icon positioned before the node text and is 
                   displayed when the node is in unselected state. <br> License requirements : None */
            ...
            /**Returns the selected icon. This icon appears on node selection and is positioned before the node text
                   replacing the @link BlockStyler::Node::DisplayIcon BlockStyler::Node::DisplayIcon @endlink and @link BlockStyler::Node::SetDisplayIcon BlockStyler::Node::SetDisplayIcon @endlink . <br> License requirements : None */
            ...
            /**  @brief  Gets node data which contains the data in the form of unique name-value pairs. 
                    ...
                    to the container\list.
                     <br> 
                    @return Node data which is list of property name - value pair. New property name - value pair can be added to it and existing value can be fetched using corresponding property name. <br> License requirements : None */
            public: NXOpen::DataContainer * GetNodeData
            (
            );
            /**Returns  the flag indicating whether the node is inserted in @link BlockStyler::Tree BlockStyler::Tree@endlink  <br> License requirements : None */
            public: bool IsInserted
            (
            );
            /**Returns  the flag indicating whether the node is in expanded state <br> License requirements : None */
            public: bool IsExpanded
            (
            );
            /**Returns  the flag indicating whether the node is in selected state <br> License requirements : None */
