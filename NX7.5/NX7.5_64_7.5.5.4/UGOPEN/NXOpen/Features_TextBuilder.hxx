...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  TextBuilder : public Features::FeatureBuilder
        {
            /** Text placement type */
            public: enum Types
            {
            ...
            /** The placement options for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type */
            ...
            /** The orientation options for @link Features::TextBuilder::TypesOnCurve Features::TextBuilder::TypesOnCurve@endlink  type */
            ...
            public: ~TextBuilder();
            /**Returns  the placement profile for @link Features::TextBuilder::TypesOnCurve Features::TextBuilder::TypesOnCurve@endlink  type  <br> License requirements : None */
            public: NXOpen::Section * OnCurvePlacementProfile
            (
            );
            /**Returns  the placement faces for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type  <br> License requirements : None */
            public: NXOpen::ScCollector * PlacementFaces
            (
            );
            /**Returns  the placement method for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type  <br> License requirements : None */
            public: NXOpen::Features::TextBuilder::OnFacePlacementMethodOptions OnFacePlacementMethod
            (
            );
            /**Sets  the placement method for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the placement profile for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type  <br> License requirements : None */
            public: NXOpen::Section * OnFacePlacementProfile
            (
            );
            /**Returns  the section plane for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type  <br> License requirements : None */
            public: NXOpen::Plane * SectionPlane
            (
            );
            /**Sets  the section plane for @link Features::TextBuilder::TypesOnFace Features::TextBuilder::TypesOnFace@endlink  type  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetSectionPlane
            (
                NXOpen::Plane * sectionPlane /** sectionplane */ 
            );
            /**Returns  the flag indicating if intersection curve can be reversed  <br> License requirements : None */
            public: bool CanReverseIntersectionCurve
            (
            );
            /**Sets  the flag indicating if intersection curve can be reversed  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCanReverseIntersectionCurve
            (
                bool canReverse /** canreverse */ 
            );
            /**Returns  the orientation method for @link Features::TextBuilder::TypesOnCurve Features::TextBuilder::TypesOnCurve@endlink  type  <br> License requirements : None */
            public: NXOpen::Features::TextBuilder::OrientationMethodOptions OrientationMethod
            (
            );
            /**Sets  the orientation method for @link Features::TextBuilder::TypesOnCurve Features::TextBuilder::TypesOnCurve@endlink  type  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Sets  the orientation vector  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetOrientationVector
            (
                NXOpen::Direction * orientationVector /** orientationvector */ 
            );
            /**Returns  the string expression representing the text  <br> License requirements : None */
            public: NXOpen::Expression * Text
            (
            );
            /**Returns  the flag indicating if text feature can reference a string expression  <br> License requirements : None */
            public: bool CanReferenceText
            (
            );
            /**Sets  the flag indicating if text feature can reference a string expression  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCanReferenceText
            (
                bool canReferenceText /** canreferencetext */ 
            );
            /**Returns  the font  <br> License requirements : None */
            public: NXString Font
            (
            );
            /** Selects the font along with appropriate character set  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SelectFont
            (
                const NXString & fontName /** Font */,
                NXOpen::Features::TextBuilder::ScriptOptions script /** Character set */
            );
            /**Returns  the script  <br> License requirements : None */
            public: NXOpen::Features::TextBuilder::ScriptOptions Script
            (
            );
            /**Sets  the script  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetScript
            (
                NXOpen::Features::TextBuilder::ScriptOptions script /** script */ 
            );
            /**Returns  the font style  <br> License requirements : None */
            public: NXOpen::Features::TextBuilder::FontStyleOptions FontStyle
            (
            );
            /**Sets  the font style  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetFontStyle
            (
                NXOpen::Features::TextBuilder::FontStyleOptions fontStyle /** fontstyle */ 
            );
            /**Returns  the flag indicating if kerning spaces can be used  <br> License requirements : None */
            public: bool CanUseKerningSpaces
            (
            );
            /**Sets  the flag indicating if kerning spaces can be used  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCanUseKerningSpaces
            (
                bool canUseKerningSpaces /** canusekerningspaces */ 
            );
            /**Returns  the flag indicating if bounding box can be created  <br> License requirements : None */
            public: bool CanCreateBoundingBox
            (
            );
            /**Sets  the flag indicating if bounding box can be created  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCanCreateBoundingBox
            (
                bool canCreateBoundingBox /** cancreateboundingbox */ 
            );
            /**Returns  the planar frame  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::RectangularFrameBuilder * PlanarFrame
            (
            );
            /**Returns  the frame on path  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::FrameOnPathBuilder * FrameOnPath
            (
            );
            /**Returns  the flag indicating if operation is associative  <br> License requirements : None */
            public: bool IsAssociative
            (
            );
            /**Sets  the flag indicating if operation is associative  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetAssociative
            (
                bool isAssociative /** isassociative */ 
            );
            /**Returns  the flag indicating if curves can be joined  <br> License requirements : None */
            public: bool CanJoinCurves
            (
            );
            /**Sets  the flag indicating if curves can be joined  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetCanJoinCurves
            (
                bool canJoinCurves /** canjoincurves */ 
            );
            /**Returns  the flag indicating if curves can be projected  <br> License requirements : None */
            public: bool CanProjectCurves
            (
            );
            /**Sets  the flag indicating if curves can be projected  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** Updates the builder based on section plane  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void UpdateOnSectionPlane
            (
            );
            /** Updates the builder based on orientation vector sense  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void UpdateOnOrientationVectorReversal
            (
            );
            /**Returns  the string to be rendered  <br> License requirements : None */
            public: NXString TextString
            (
            );
            /**Sets  the string to be rendered  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
