    ...
    namespace Fields
    {
        ...
        */
        class NXOPENCPPEXPORT  DisplayPropertiesBuilder : public Builder
        {
            ...
            /**Returns  the table dependent symbol size  <br> License requirements : None */
            public: double TblDepSymbolSize
            (
            );
            /**Sets  the table dependent symbol size  <br> License requirements : None */
            public: void SetTblDepSymbolSize
            (
                double tblDepSymbolSize /** tbldepsymbolsize */ 
            );
            /**Returns  the table dependent domain color  <br> License requirements : None */
            public: NXOpen::Fields::DisplayPropertiesBuilder::DepDomColorEnum TblDepDomColor
            (
            );
            /**Sets  the table dependent domain color  <br> License requirements : None */
            public: void SetTblDepDomColor
            (
                NXOpen::Fields::DisplayPropertiesBuilder::DepDomColorEnum depDomColor /** depdomcolor */ 
            );
            /**Returns  the table dependent color  <br> License requirements : None */
            public: NXOpen::NXColor * TblDepColor
            (
            );
            /**Sets  the table dependent color  <br> License requirements : None */
            public: void SetTblDepColor
            (
                NXOpen::NXColor * tblDepColor /** tbldepcolor */ 
            );
            /**Returns  the table dependent label values  <br> License requirements : None */
            public: NXOpen::Fields::DisplayPropertiesBuilder::DepLabelValueEnum TblDepLabelValues
            (
            );
            /**Sets  the table dependent label values  <br> License requirements : None */
