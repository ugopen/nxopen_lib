    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT  ScrapDesignBuilder : public Builder
        {
            ...
            /** Returns the overcut position, it determines where the overcut sketch will be constrained  @return  Indicates the position to constrain overcut sketch  <br> License requirements : None */
            public: NXOpen::Point3d GetOvercutPosition
            (
            );
            /** Sets the overcut position, it determines where the overcut sketch will be constrained  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
