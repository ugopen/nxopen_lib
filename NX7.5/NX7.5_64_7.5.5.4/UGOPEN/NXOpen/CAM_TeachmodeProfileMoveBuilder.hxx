...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  TeachmodeProfileMoveBuilder : public CAM::MoveBuilder
        {
            ...
            /**Returns  the drive geometry type  <br> License requirements : None */
            public: NXOpen::CAM::TeachmodeProfileMoveBuilder::DriveGeometryTypes DriveGeometryType
            (
            );
            /**Sets  the drive geometry type  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the direction builder  <br> License requirements : None */
            public: NXOpen::CAM::TurnDirection * Direction
            (
            );
            /**Returns  the cutter clearance angles builder  <br> License requirements : None */
            public: NXOpen::CAM::TurnCutterClearance * CutterClearance
            (
            );
            /**Returns  the finish stock builder  <br> License requirements : None */
            public: NXOpen::CAM::TurnStock * FinishStock
            (
            );
            /**Returns  the Tolerances  <br> License requirements : None */
            public: NXOpen::CAM::Inheritable2dLength * Tolerances
            (
            );
            /**Returns  the corner control builder for normal corners  <br> License requirements : None */
            public: NXOpen::CAM::TurnCornerControl * CornerControlNormal
            (
            );
            /**Returns  the corner control builder for shallow corners  <br> License requirements : None */
            public: NXOpen::CAM::TurnCornerControl * CornerControlShallow
            (
            );
            /**Returns  the feeds builder  <br> License requirements : None */
            ...
            /**Returns  the start and stop before boundary offset status  <br> License requirements : None */
            public: bool StartStopBeforeBoundaryOffset
            (
            );
            /**Sets  the start and stop before boundary offset status  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStartStopBeforeBoundaryOffset
            (
                bool newValue /** the status value */
            );
            /**Returns  the start position method  <br> License requirements : None */
            public: NXOpen::CAM::TeachmodeProfileMoveBuilder::StartStopPositionMethods StartPositionMethod
            (
            );
            /**Sets  the start position method  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the constant stock for start check geometry  <br> License requirements : None */
            public: double StartCheckConstantStock
            (
            );
            /**Sets  the constant stock for start check geometry  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStartCheckConstantStock
            (
                double newValue /** the constant stock value */
            );
            /**Returns  the face stock for start check geometry  <br> License requirements : None */
            public: double StartCheckFaceStock
            (
            );
            /**Sets  the face stock for start check geometry  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStartCheckFaceStock
            (
                double newValue /** the face stock value */
            );
            /**Returns  the radial stock for start check geometry  <br> License requirements : None */
            public: double StartCheckRadialStock
            (
            );
            /**Sets  the radial stock for start check geometry  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStartCheckRadialStock
            (
                double newValue /** the radial stock value */
            );
            /**Returns  the apply engage settings status  <br> License requirements : None */
            public: bool ApplyEngageSettings
            (
            );
            /**Sets  the apply engage settings status  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetApplyEngageSettings
            (
                bool newValue /** the status value */
            );
            /**Returns  the stop position method  <br> License requirements : None */
            public: NXOpen::CAM::TeachmodeProfileMoveBuilder::StartStopPositionMethods StopPositionMethod
            (
            );
            /**Sets  the stop position method  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the stop point  <br> License requirements : None */
            public: NXOpen::Point * StopPoint
            (
            );
            /**Sets  the stop point  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStopPoint
            (
                NXOpen::Point * newValue /** the stop point */
            );
            /**Returns  the constant stock for stop check geometry  <br> License requirements : None */
            public: double StopCheckConstantStock
            (
            );
            /**Sets  the constant stock for stop check geometry  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStopCheckConstantStock
            (
                double newValue /** the constant stock value */
            );
            /**Returns  the face stop for start check geometry  <br> License requirements : None */
            public: double StopCheckFaceStock
            (
            );
            /**Sets  the face stop for start check geometry  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStopCheckFaceStock
            (
                double newValue /** the face stock value */
            );
            /**Returns  the radial stock for stop check geometry  <br> License requirements : None */
            public: double StopCheckRadialStock
            (
            );
            /**Sets  the radial stock for stop check geometry  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetStopCheckRadialStock
            (
                double newValue /** the radial stock value */
            );
            /**Returns  the apply retract settings status  <br> License requirements : None */
            public: bool ApplyRetractSettings
            (
            );
            /**Sets  the apply retract settings status  <br> License requirements : cam_base ("CAM BASE") */
