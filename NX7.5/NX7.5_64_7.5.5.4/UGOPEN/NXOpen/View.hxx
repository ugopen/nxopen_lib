...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  View : public NXObject
    {
        ...
        /**Returns  the view origin.  This is the position in "untranslated view space"
            which appears in the middle of the viewport.  <br> License requirements : None */
        ...
        /** Returns one of the view axes.  These are the components of the 3x3
            matrix which is the rotation of absolute space which results in view space.  @return  The X, Y or Z axis of the view  <br> License requirements : None */
        ...
        /** Returns an array of objects visible in a view  @return  The array of visible objects  <br> License requirements : None */
