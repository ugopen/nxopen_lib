...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  ArcOutputTypeCiBuilder : public TaggedObject
        {
            ...
            /**Returns  the nurb join segments  <br> License requirements : None */
            public: bool NurbJoinSegments
            (
            );
            /**Sets  the nurb join segments  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNurbJoinSegments
            (
                bool nurbsJoinSegments /** the nurb join segments */
            );
            /**Returns  the nurb angle tolerance  <br> License requirements : None */
            public: double NurbAngleTolerance
            (
            );
            /**Sets  the nurb angle tolerance  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNurbAngleTolerance
            (
                double nurbsAngleTolerance /** the nurb angle tolerance */
            );
            /**Returns  the nurb fit tolerance  <br> License requirements : None */
            public: double NurbFitTolerance
            (
            );
            /**Sets  the nurb fit tolerance  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNurbFitTolerance
            (
                double nurbsFitTolerance /** the nurb fit tolerance */
            );
            /**Returns  the spline fit tolerance type  <br> License requirements : None */
            public: NXOpen::CAM::ArcOutputTypeCiBuilder::SplineFitToleranceTypes SplineFitToleranceType
            (
            );
            /**Sets  the spline fit tolerance type  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the spline fit tolerance  <br> License requirements : None */
            public: double SplineFitTolerance
            (
            );
            /**Sets  the spline fit tolerance  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSplineFitTolerance
            (
                double splineFitTolerance /** the spline fit tolerance */
            );
            /**Returns  the spline line output type  <br> License requirements : None */
            public: NXOpen::CAM::ArcOutputTypeCiBuilder::SplineLineOutputTypes SplineLineOutputType
            (
            );
            /**Sets  the spline line output type  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the spline arc output type  <br> License requirements : None */
            public: NXOpen::CAM::ArcOutputTypeCiBuilder::SplineArcOutputTypes SplineArcOutputType
            (
            );
            /**Sets  the spline arc output type  <br> License requirements : cam_base ("CAM BASE") */
