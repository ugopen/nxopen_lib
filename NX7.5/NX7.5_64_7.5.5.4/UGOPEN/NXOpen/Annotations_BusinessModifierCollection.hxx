...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  BusinessModifierCollection : public TaggedObjectCollection
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Annotations::UrlBusinessModifier * CreateUrlBusinessModifier
            (
            ...
            /** Creates a customer value business modifier   @return  New customer value business modifier 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : geometric_tol ("GDT") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Annotations::CustomerValueBusinessModifier * CreateCustomerValueBusinessModifier
            (
                const NXString & modifierName /** Knowledge fusion name of modifier */
            );
            /** Creates a revision business modifier  @return  New revision business modifier 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : geometric_tol ("GDT") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Annotations::RevisionBusinessModifier * CreateRevisonBusinessModifier
            (
                const NXString & modifierName /** Knowledge fusion name of modifier */
            );
            /** Creates a safety class business modifier  @return  New safety class business modifier 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : geometric_tol ("GDT") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Annotations::SafetyClassBusinessModifier * CreateSafetyClassBusinessModifier
            (
                const NXString & modifierName /** Knowledge fusion name of modifier */
            );
