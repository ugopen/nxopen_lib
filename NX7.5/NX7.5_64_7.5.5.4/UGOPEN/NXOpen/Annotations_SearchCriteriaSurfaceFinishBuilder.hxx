...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents SearchCriteriaSurfaceFinishBuilder  <br> To create a new instance of this class, use @link Annotations::SearchModelViewCollection::CreateSearchCriteriaSurfaceFinishBuilder Annotations::SearchModelViewCollection::CreateSearchCriteriaSurfaceFinishBuilder@endlink  <br> */
        class NXOPENCPPEXPORT  SearchCriteriaSurfaceFinishBuilder : public Builder
        {
            ...
            /**Returns  the surface finish type toggle  <br> License requirements : None */
            public: bool BySurfaceFinishType
            (
            );
            /**Sets  the surface finish type toggle  <br> License requirements : None */
            public: void SetBySurfaceFinishType
            (
                bool surfaceFinishType /** surfacefinishtype */ 
            );
            /**Returns  the surface finish type  <br> License requirements : None */
            public: NXOpen::Annotations::SearchCriteriaSurfaceFinishBuilder::SurfaceFinishTypes SurfaceFinishType
            (
            );
            /**Sets  the surface finish type  <br> License requirements : None */
            ...
            /**Returns  the production process text  <br> License requirements : None */
            public: NXString ProductionProcessText
            (
            );
            /**Sets  the production process text  <br> License requirements : None */
            public: void SetProductionProcessText
            (
                const NXString & productionProcessText /** productionprocesstext */ 
            );
            /**Returns  the secondary roughness toggle  <br> License requirements : None */
            public: bool BySecondaryRoughness
            (
            );
            /**Sets  the secondary roughness toggle  <br> License requirements : None */
            public: void SetBySecondaryRoughness
            (
                bool secondaryRoughness /** secondaryroughness */ 
            );
            /**Returns  the secondary roughness enum  <br> License requirements : None */
            public: NXOpen::Annotations::SearchModelViewBuilder::TextComparisionOptions SecondaryRoughnessType
            (
            );
            /**Sets  the secondary roughness enum  <br> License requirements : None */
            ...
            /**Returns  the secondary roughness text  <br> License requirements : None */
            public: NXString SecondaryRoughnessText
            (
            );
            /**Sets  the secondary roughness text  <br> License requirements : None */
            public: void SetSecondaryRoughnessText
            (
                const NXString & secondaryRoughnessText /** secondaryroughnesstext */ 
            );
            /**Returns  the roughness toggle  <br> License requirements : None */
            public: bool ByRoughness
            (
            );
            /**Sets  the roughness toggle  <br> License requirements : None */
            public: void SetByRoughness
            (
                bool roughness /** roughness */ 
            );
            /**Returns  the roughness enum  <br> License requirements : None */
            public: NXOpen::Annotations::SearchModelViewBuilder::TextComparisionOptions RoughnessType
            (
            );
            /**Sets  the roughness enum  <br> License requirements : None */
            public: void SetRoughnessType
            (
                NXOpen::Annotations::SearchModelViewBuilder::TextComparisionOptions roughnessType /** roughnesstype */ 
            );
            /**Returns  the roughness text  <br> License requirements : None */
            public: NXString RoughnessText
            (
            );
            /**Sets  the roughness text  <br> License requirements : None */
            ...
            /**Returns  the tolerance type enum  <br> License requirements : None */
            public: NXOpen::Annotations::SearchCriteriaSurfaceFinishBuilder::ToleranceTypeOptions MachiningToleranceType
            (
            );
            /**Sets  the tolerance type enum  <br> License requirements : None */
            ...
            /**Returns  the tolerance enum  <br> License requirements : None */
            public: NXOpen::Annotations::SearchModelViewBuilder::ValueComparisionOptions ToleranceType
            (
            );
            /**Sets  the tolerance enum  <br> License requirements : None */
            ...
            /**Returns  the tolerance value  <br> License requirements : None */
            public: double ToleranceValue
            (
            );
            /**Sets  the tolerance value  <br> License requirements : None */
