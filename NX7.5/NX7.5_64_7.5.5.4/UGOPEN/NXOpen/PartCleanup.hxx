...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PartCleanup : public TransientObject
    {
        ...
        /**Sets  the option that specifies whether to cleanup assembly constraints.  <br> License requirements : None */
        public: void SetCleanupAssemblyConstraints
        (
            bool option /** option */ 
        );
        /**Returns  the option that specifies whether to cleanup assembly constraints.  <br> License requirements : None */
