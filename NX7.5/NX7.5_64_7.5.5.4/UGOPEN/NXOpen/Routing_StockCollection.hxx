    ...
    namespace Routing
    {
        ...
        class NXOPENCPPEXPORT  StockCollection : public TaggedObjectCollection
        {
            ...
            /**  Converts a part file from Legacy Stock into Stock as Components.  
                        ...
                        stocks by creating components for each stock.  After calling this routine, all new stocks in this part will have components associated with them.   <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
            public: void ConvertToStockAsComponents
            (
                bool convertSpaceReservartion /** whether convert Space Reservation as Components? */,
                NXOpen::Routing::ComponentName nameType /** Naming scheme to use for components.  Calls 
                                                                                            @link Routing::Stock::RenameComponent Routing::Stock::RenameComponent@endlink  on 
                                                                                            each new stock component if input is 
                                                                                            @link Routing::ComponentNamePermanent Routing::ComponentNamePermanent@endlink . */
            ...
            /** Creates normal or space reservation stock on the given segments. The segments do not need to be in order,
                     and don't necessarily have to form a single path. <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
            public: void AddStock
            (
                NXOpen::Routing::CharacteristicList * stockPart /** Characteristic list used to find the appropriate
                                                                                                                           @link Routing::StockData Routing::StockData@endlink  for building the stock.  
            ...
            /** Removes all filler stocks from the input set of segments.  <br> License requirements : routing_mechanical ("Routing Mechanical") OR routing_electrical ("Routing Electrical") OR routing_combined ("Routing Combined") */
