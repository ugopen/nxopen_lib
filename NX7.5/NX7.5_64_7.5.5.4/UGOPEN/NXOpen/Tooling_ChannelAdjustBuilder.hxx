...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT  ChannelAdjustBuilder : public Builder
        {
            /** the adjust method. */
            ...
            /**Returns  the method for adjusting the cooling channels.  <br> License requirements : None */
            public: NXOpen::Tooling::ChannelAdjustBuilder::AdjustType AdjustMethod
            (
            );
            /**Sets  the method for adjusting the cooling channels.  <br> License requirements : None */
            public: void SetAdjustMethod
            (
                NXOpen::Tooling::ChannelAdjustBuilder::AdjustType adjustMethod /** adjustmethod */ 
            );
            /**Returns  the cooling channel to be adjusted.  <br> License requirements : None */
            public: NXOpen::SelectBodyList * TargetChannel
            (
            );
            /**Returns  the reference faces for calculating the distance to the cooling channels.  <br> License requirements : None */
            public: NXOpen::ScCollector * ReferenceFace
            (
            );
            /**Returns  the method for moving the cooling channels.  <br> License requirements : None */
            public: NXOpen::Tooling::ChannelAdjustBuilder::VectorMethod RepositionMethod
            (
            );
            /**Sets  the method for moving the cooling channels.  <br> License requirements : None */
            public: void SetRepositionMethod
            (
                NXOpen::Tooling::ChannelAdjustBuilder::VectorMethod repositionMethod /** repositionmethod */ 
            );
            /**Returns  the vector specified for the adjust direction.  <br> License requirements : None */
            public: NXOpen::Direction * AdjustVector
            (
            );
            /**Sets  the vector specified for the adjust direction.  <br> License requirements : None */
            public: void SetAdjustVector
            (
                NXOpen::Direction * adjustVector /** adjustvector */ 
            );
            /**Returns  the distance between the channels and faces.  <br> License requirements : None */
