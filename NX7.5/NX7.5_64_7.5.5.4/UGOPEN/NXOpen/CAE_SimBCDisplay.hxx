...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  SimBCDisplay : public TaggedObject
        {
            ...
            /**Returns  the flag indicating whether or not highlighting of targets is required  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: bool HighlightTargets
            (
            );
            /**Sets  the flag indicating whether or not highlighting of targets is required  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetHighlightTargets
            (
                bool highlightTargetsFlag /** true when highlighting is required, false otherwise */
            );
            /**Returns  the neutral name of the property that will control the display  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXString DisplayMagnitudeProperty
            (
            );
            /**Sets  the neutral name of the property that will control the display  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
