...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  NcmPlanarBuilder : public CAM::NcmSubopBuilder
        {
            ...
            /**Returns  the default engage closed area builder  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder * EngageClosedAreaBuilder
            (
            );
            /**Returns  the default engage open area builder  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder * EngageOpenAreaBuilder
            (
            );
            /**Returns  the flag to control limitation of engage and retract motions to cut regions  <br> License requirements : None */
            ...
            /**Returns  the initial engage closed area builder  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder * EngageInitialClosedBuilder
            (
            );
            /**Returns  the initial engage open area builder  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder * EngageInitialOpenBuilder
            (
            );
            /**Returns  the retract area builder  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder * RetractAreaBuilder
            (
            );
            /**Returns  the final retract builder  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder * RetractFinalBuilder
            (
            );
            /**Returns  the start/drill points overlap distance builder (inheritable tool dep)  <br> License requirements : None */
            ...
            /** Returns region start points  <br> License requirements : None */
            ...
            /**Returns  the start points use effective distance  <br> License requirements : None */
            ...
            /**Returns  the region start points effective distance builder (inheritable tool dep)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * StartPointsEffectDistBuilder
            (
            );
            /**Returns  the pre-drill points output option  <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarBuilder::PredrillPointsOutputOptions PredrillPointsOutput
            (
            );
            /**Sets  the pre-drill points output option  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetPredrillPointsOutput
            (
                NXOpen::CAM::NcmPlanarBuilder::PredrillPointsOutputOptions newValue /** newvalue */ 
            );
            /** The pre-drill points  @return  Array of points  <br> License requirements : None */
            ...
            /**Returns  the pre-drill points use effective distance  <br> License requirements : None */
            ...
            /**Returns  the pre-drill points effective distance builder (inheritable tool dep)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * PredrillPointsEffectDistBuilder
            (
            );
            /**Returns  the transfer within levels strategy  <br> License requirements : None */
            ...
            /**Returns  the transfer within levels max follow distance builder (inheritable tool dep)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * TransferWithinLevelsMaxFollowDistanceBuilder
            (
            );
            /**Returns  the transfer within levels height builder (inheritable tool dep)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * TransferWithinLevelsHeightBuilder
            (
            );
            /**Returns  the transfer within levels type  <br> License requirements : None */
            ...
            /**Returns  the transfer within levels safe distance builder (inheritable tool dep)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * TransferWithinLevelsSafeDistanceBuilder
            (
            );
            /**Returns  the transfer between levels type  <br> License requirements : None */
            ...
            /**Returns  the transfer between levels safe distance builder (inheritable tool dep)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * TransferBetweenLevelsSafeDistanceBuilder
            (
            );
            /**Returns  the transfer between regions type  <br> License requirements : None */
            ...
            /**Returns  the transfer between regions safe distance builder (inheritable tool dep)  <br> License requirements : None */
