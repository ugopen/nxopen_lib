    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPPEXPORT  OverstockBuilder : public Builder
        {
            ...
            /**Returns  the rotation value. Determines the rotation angle of the overstock.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::Expression * RotationValue
            (
            );
            /**Returns  the @link Routing::Anchor Routing::Anchor@endlink  name associated with the overstock.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXString StockAnchor
            (
            );
            /**Sets  the @link Routing::Anchor Routing::Anchor@endlink  name associated with the overstock.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
