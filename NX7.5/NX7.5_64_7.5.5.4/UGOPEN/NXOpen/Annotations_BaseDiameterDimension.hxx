...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a diameter dimension  <br> This is an abstract class and cannot be directly instantiated <br> */
        class NXOPENCPPEXPORT  BaseDiameterDimension : public Annotations::Dimension, public virtual Annotations::ILinearTolerance, public virtual Annotations::IPmi
        {
            ...
            /**Sets  a value of diameter dimension line angle
             ...
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetDiamDimLineAng
            (
                double diamDimLineAngle /** diam dim line angle */ 
            );
            /**Returns  a value of diameter dimension line angle
             ...
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") double DiamDimLineAng
            (
            );
