...
namespace NXOpen
{
    ...
    namespace UIStyler
    {
        ...
        class NXOPENUICPPEXPORT  RealScale : public UIStyler::StylerItem
        {
            ...
            /**Registers dtag callback. This method should be called before calling @link  UIStyler::Dialog::Show   UIStyler::Dialog::Show @endlink  or @link  UIStyler::Dialog::RegisterWithUiMenu   UIStyler::Dialog::RegisterWithUiMenu @endlink   <br> License requirements : None */
