...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT  FormingInsertBuilder : public Builder
        {
            ...
            /**Returns  the seed face of forming region.  <br> License requirements : None */
            public: NXOpen::ScCollector * SeedFace
            (
            );
            /**Returns  the boundary faces of forming region.  <br> License requirements : None */
            public: NXOpen::ScCollector * BoundaryFaces
            (
            );
            /**Returns  the forming faces of forming region.  <br> License requirements : None */
            public: NXOpen::ScCollector * SelectFormingFaces
            (
            );
            /**Returns  the indication to traverse interior edges of forming region.  <br> License requirements : None */
            public: bool TraverseInteriorEdges
            (
            );
            /**Sets  the indication to traverse interior edges of forming region.  <br> License requirements : None */
            public: void SetTraverseInteriorEdges
            (
                bool traverseInteriorEdges /** traverseinterioredges */ 
            );
            /**Returns  the tangent edge angle of forming region.  <br> License requirements : None */
            public: bool TangentEdgeAngle
            (
            );
            /**Sets  the tangent edge angle of forming region.  <br> License requirements : None */
            public: void SetTangentEdgeAngle
            (
                bool tangentEdgeAngle /** tangentedgeangle */ 
            );
            /**Returns  the tangent edge angle tolerance value of forming region.  <br> License requirements : None */
            public: double AngleToleranceValue
            (
            );
            /**Sets  the tangent edge angle tolerance value of forming region.  <br> License requirements : None */
            public: void SetAngleToleranceValue
            (
                double angleToleranceValue /** angletolerancevalue */ 
            );
            /**Returns  the parent part to create blank.  <br> License requirements : None */
            public: NXOpen::Tooling::FormingInsertBuilder::ParentTypes ParentPart
            (
            );
            /**Sets  the parent part to create blank.  <br> License requirements : None */
            public: void SetParentPart
            (
                NXOpen::Tooling::FormingInsertBuilder::ParentTypes parentPart /** parentpart */ 
            );
            /**Returns  the blank type for punch or die.  <br> License requirements : None */
            public: NXOpen::Tooling::FormingInsertBuilder::BlankTypes BlankType
            (
            );
            /**Sets  the blank type for punch or die.  <br> License requirements : None */
            public: void SetBlankType
            (
                NXOpen::Tooling::FormingInsertBuilder::BlankTypes blankType /** blanktype */ 
            );
            /**Returns  the blank position in punch plate or stripper plate.  <br> License requirements : None */
            public: NXOpen::Tooling::FormingInsertBuilder::BlankPositions BlankPosition
            (
            );
            /**Sets  the blank position in punch plate or stripper plate.  <br> License requirements : None */
            public: void SetBlankPosition
            (
                NXOpen::Tooling::FormingInsertBuilder::BlankPositions blankPosition /** blankposition */ 
            );
            /**Returns  the punch same with plate  <br> License requirements : None */
            public: bool SameWithPlate
            (
            );
            /**Sets  the punch same with plate  <br> License requirements : None */
            public: void SetSameWithPlate
            (
                bool sameWithPlate /** samewithplate */ 
            );
            /**Returns  the blank profile to extrude the punch or die.  <br> License requirements : None */
            public: NXOpen::Section * BlankProfile
            (
            );
            /**Returns  the height value of blank.  <br> License requirements : None */
            public: NXOpen::Expression * HeightValue
            (
            );
            /**Returns  the lower value of blank.  <br> License requirements : None */
            ...
            /**Returns  the clearance value of punch plate .  <br> License requirements : None */
            public: double PunchPlateClearance
            (
            );
            /**Sets  the clearance value of punch plate .  <br> License requirements : None */
            public: void SetPunchPlateClearance
            (
                double punchPlateClr /** punchplateclr */ 
            );
            /**Returns  the option to use bottom backing plate clearance.  <br> License requirements : None */
            public: bool UseBottomPlateClearance
            (
            );
            /**Sets  the option to use bottom backing plate clearance.  <br> License requirements : None */
            public: void SetUseBottomPlateClearance
            (
                bool useBPClearance /** usebpclearance */ 
            );
            /**Returns  the clearance value of bottom backing plate .  <br> License requirements : None */
            public: double BottomPlateClearance
            (
            );
            /**Sets  the clearance value of bottom backing plate .  <br> License requirements : None */
            public: void SetBottomPlateClearance
            (
                double bottomPlateClr /** bottomplateclr */ 
            );
            /**Returns  the option to use stripper plate clearance.  <br> License requirements : None */
            public: bool UseStripperPlateClearance
            (
            );
            /**Sets  the option to use stripper plate clearance.  <br> License requirements : None */
            public: void SetUseStripperPlateClearance
            (
                bool useSPClearance /** usespclearance */ 
            );
            /**Returns  the option to use the stripper plate clearance.  <br> License requirements : None */
            public: double StripperPlateClearance
            (
            );
            /**Sets  the option to use the stripper plate clearance.  <br> License requirements : None */
            public: void SetStripperPlateClearance
            (
                double stripperPlateClr /** stripperplateclr */ 
            );
            /**Returns  the option to use die plate clearance.  <br> License requirements : None */
            public: bool UseDiePlateClearance
            (
            );
            /**Sets  the option to use die plate clearance.  <br> License requirements : None */
            public: void SetUseDiePlateClearance
            (
                bool useDPClearance /** usedpclearance */ 
            );
            /**Returns  the clearance value of die plate.  <br> License requirements : None */
            public: double DiePlateClearance
            (
            );
            /**Sets  the clearance value of die plate.  <br> License requirements : None */
            public: void SetDiePlateClearance
            (
                double diePlateClr /** dieplateclr */ 
            );
            /**Returns  the design option to design punch or die.  <br> License requirements : None */
            public: NXOpen::Tooling::FormingInsertBuilder::DesignOptions DesignOption
            (
            );
            /**Sets  the design option to design punch or die.  <br> License requirements : None */
            public: void SetDesignOption
            (
                NXOpen::Tooling::FormingInsertBuilder::DesignOptions designOption /** designoption */ 
            );
            /**Returns  the option to reverse trim direction.  <br> License requirements : None */
            public: bool ReverseDirection
            (
            );
            /**Sets  the option to reverse trim direction.  <br> License requirements : None */
            public: void SetReverseDirection
            (
                bool reverseDirection /** reversedirection */ 
            );
            /**Returns  the parent part name to create blank.  <br> License requirements : None */
            public: NXString ParentPartName
            (
            );
            /**Sets  the parent part name to create blank.  <br> License requirements : None */
            public: void SetParentPartName
            (
                const NXString & parentPart /** Specifies the parent part name */
            );
            /** Create new component.  @return  the new part instance  <br> License requirements : None */
            ...
            /** Reverse trim direction.  <br> License requirements : None */
            public: void ReverseTrimDirection
            (
            );
            /** Extract forming region.  <br> License requirements : None */
            public: void ExtractFormingRegion
            (
            );
            /**Returns  the punch or die to edit  <br> License requirements : None */
            public: NXOpen::SelectBody * PunchOrDieToEdit
            (
            );
            /** The action to delete the selected punch or die component  <br> License requirements : None */
