...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a WedmOperation Builder  <br> To create a new instance of this class, use @link CAM::OperationCollection::CreateWedmOperationBuilder CAM::OperationCollection::CreateWedmOperationBuilder@endlink  <br> */
        class NXOPENCPPEXPORT  WedmOperationBuilder : public CAM::OperationBuilder
        {
            ...
            /**Returns  the smooth_lead_in_distance builder  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * SmoothLeadInDistanceBuilder
            (
            );
            /**Returns  the retract_point Builder  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::WedmPointDefinitionBuilder * RetractPointBuilder
            (
            );
            /**Returns  the thread_hole_point Builder  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::WedmPointDefinitionBuilder * ThreadHolePointBuilder
            (
            );
            /**Returns  the lead_in_point Builder  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::WedmPointDefinitionBuilder * LeadInPointBuilder
            (
            );
            /**Returns  the lead_out_point Builder  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the cut pattern  <br> License requirements : None */
            public: NXOpen::CAM::CutPatternBuilder * CutPattern
            (
            );
            /** Returns the in path event data  @return  the InPathEventSetData builder <br> License requirements : None */
