    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT  ElementalFunctionEvaluationSettingBuilder : public CAE::ResponseSimulation::FunctionEvaluationSettingBuilder
            {
                ...
                /**Returns  the evaluation location of element.  <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: NXOpen::CAE::ResponseSimulation::ElementLocation ElementLocation
                (
                );
                /**Sets  the evaluation location of element.  <br> License requirements : nx_response_anlys ("NX Response Analysis") */
