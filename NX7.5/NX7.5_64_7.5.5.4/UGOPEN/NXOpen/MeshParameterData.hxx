...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  MeshParameterData : public TransientObject
    {
        ...
        public:  NX_DEPRECATED("Deprecated in NX5.0.0") void SetCapLabel1
        (
            NXOpen::MeshParameterData::Type capLabel1 /** cap label1 */ 
        );
        /**Returns  
         @deprecated Deprecated in NX5.0.0 <br> 
         <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.0") NXOpen::MeshParameterData::Type CapLabel1
        (
        );
        /**Sets  
         @deprecated Deprecated in NX5.0.0 <br> 
         <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.0") void SetCapLabel2
        (
            NXOpen::MeshParameterData::Type capLabel2 /** cap label2 */ 
        );
        /**Returns  
         @deprecated Deprecated in NX5.0.0 <br> 
         <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.0") NXOpen::MeshParameterData::Type CapLabel2
        (
        );
        /**Sets   <br> License requirements : features_modeling ("FEATURES MODELING"), nx_freeform_1 ("basic freeform modeling") */
