...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Catiav4Importer : public Builder
    {
        ...
        /**Returns  the simplify Geometry - if set to true then imported data will be simplified  <br> License requirements : None */
        public: bool SimplifyGeometry
        (
        );
        /**Sets  the simplify Geometry - if set to true then imported data will be simplified  <br> License requirements : None */
        public: void SetSimplifyGeometry
        (
            bool simplifyGeometry /** simplifygeometry */ 
        );
        /**Returns  the optimize - if set to true then toplogy will be optimized  <br> License requirements : None */
        public: bool Optimize
        (
        );
        /**Sets  the optimize - if set to true then toplogy will be optimized  <br> License requirements : None */
