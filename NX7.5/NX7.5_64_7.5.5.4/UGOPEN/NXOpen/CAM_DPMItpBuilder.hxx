...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  DPMItpBuilder : public CAM::ParamBuilder
        {
            ...
            /**Returns  the Cut Step <br> License requirements : None */
            public: NXOpen::CAM::DPMItpBuilder::StepMethodOption StepMethod
            (
            );
            /**Sets  the Cut Step <br> License requirements : None */
            public: void SetStepMethod
            (
                NXOpen::CAM::DPMItpBuilder::StepMethodOption stepMethod /** the value of Cut Step */
            );
            /**Returns  the First Cut <br> License requirements : None */
            public: int CutStepFirstCut
            (
            );
            /**Sets  the First Cut <br> License requirements : None */
            public: void SetCutStepFirstCut
            (
                int firstCut /** the first cut value */
            );
            /**Returns  the  Second Cut <br> License requirements : None */
            public: int CutStepSecondCut
            (
            );
            /**Sets  the  Second Cut <br> License requirements : None */
            public: void SetCutStepSecondCut
            (
                int secondCut /** the second cut value */
            );
            /**Returns  the Third Cut <br> License requirements : None */
            public: int CutStepThirdCut
            (
            );
            /**Sets  the Third Cut <br> License requirements : None */
            public: void SetCutStepThirdCut
            (
                int thirdCut /** the third cut value */
            );
            /**Returns  the  Cut Step Outol  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * StepOuttol
            (
            );
            /**Returns  the  Cut Step Intol  <br> License requirements : None */
