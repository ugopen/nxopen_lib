...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  DeformationParameters : public TaggedObject
        {
            ...
            /**Returns  the complexity criterion. If the result type is complex @link CAE::BaseResultType::Complex CAE::BaseResultType::Complex @endlink and @link CAE::BaseResultType::SetComplex CAE::BaseResultType::SetComplex @endlink  
                        the complexity criterion defines which value is used for deformation(like @link CAE::Result::ComplexReal CAE::Result::ComplexReal@endlink 
                         or @link CAE::Result::ComplexImaginary CAE::Result::ComplexImaginary@endlink )  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::Result::Complex ComplexCriterion
            (
            );
            /**Sets  the complexity criterion. If the result type is complex @link CAE::BaseResultType::Complex CAE::BaseResultType::Complex @endlink and @link CAE::BaseResultType::SetComplex CAE::BaseResultType::SetComplex @endlink  
                        the complexity criterion defines which value is used for deformation(like @link CAE::Result::ComplexReal CAE::Result::ComplexReal@endlink 
                         or @link CAE::Result::ComplexImaginary CAE::Result::ComplexImaginary@endlink )  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /**Returns  the phase angle at which result will be evaluated and used for deformation.  If the result type is complex
                     @link CAE::BaseResultType::Complex CAE::BaseResultType::Complex @endlink and @link CAE::BaseResultType::SetComplex CAE::BaseResultType::SetComplex @endlink  and the @link DeformationParameters::ComplexCriterion DeformationParameters::ComplexCriterion @endlink and @link DeformationParameters::SetComplexCriterion DeformationParameters::SetComplexCriterion @endlink  
                     is set to @link CAE::Result::ComplexPhaseAngle CAE::Result::ComplexPhaseAngle@endlink  , the Phaseangle will be used to evaluate the value of the complex result  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: double PhaseAngle
            (
            );
            /**Sets  the phase angle at which result will be evaluated and used for deformation.  If the result type is complex
                     @link CAE::BaseResultType::Complex CAE::BaseResultType::Complex @endlink and @link CAE::BaseResultType::SetComplex CAE::BaseResultType::SetComplex @endlink  and the @link DeformationParameters::ComplexCriterion DeformationParameters::ComplexCriterion @endlink and @link DeformationParameters::SetComplexCriterion DeformationParameters::SetComplexCriterion @endlink  
                     is set to @link CAE::Result::ComplexPhaseAngle CAE::Result::ComplexPhaseAngle@endlink  , the Phaseangle will be used to evaluate the value of the complex result  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
