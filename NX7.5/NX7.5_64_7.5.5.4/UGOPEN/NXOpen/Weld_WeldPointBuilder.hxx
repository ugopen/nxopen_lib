...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPPEXPORT  WeldPointBuilder : public Builder
        {
            ...
            /**Returns  the num connected panels.  <br> License requirements : ugweld ("UG WELD") */
            public: int NumberConnectedPanels
            (
            );
            /**Sets  the num connected panels.  <br> License requirements : ugweld ("UG WELD") */
            public: void SetNumberConnectedPanels
            (
                int numConnectedPanels /** num connected panels */ 
            );
            /**Returns  the start dist location  <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Weld::WeldParasetLocation StartDistanceLocation
            (
            );
            /**Sets  the start dist location  <br> License requirements : ugweld ("UG WELD") */
            public: void SetStartDistanceLocation
            (
                NXOpen::Weld::WeldParasetLocation startDistLocation /** start distance location */
            );
            /**Sets  the end dist location  <br> License requirements : ugweld ("UG WELD") */
            public: void SetEndDistanceLocation
            (
                NXOpen::Weld::WeldParasetLocation endDistLocation /** end dist location */ 
            );
            /**Returns  the end dist location  <br> License requirements : ugweld ("UG WELD") */
            ...
            /**Sets  the refsheet spacing method  <br> License requirements : ugweld ("UG WELD") */
            public: void SetReferenceSheetSpacingMethod
            (
                NXOpen::Weld::WeldPointSpacingMethod spacingMethod /** spacing method */ 
            );
            /**Returns  the refsheet spacing method  <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Weld::WeldPointSpacingMethod ReferenceSheetSpacingMethod
            (
            );
            /**Sets  the work coordinate systemstate  <br> License requirements : ugweld ("UG WELD") */
            public: void SetCsysWorkPartState
            (
                bool workCsysState /** workcsysstate */ 
            );
            /**Returns  the work coordinate systemstate  <br> License requirements : ugweld ("UG WELD") */
            public: bool CsysWorkPartState
            (
            );
            /**Sets  the assy coordinate system state  <br> License requirements : ugweld ("UG WELD") */
            public: void SetCsysAssemblyState
            (
                bool assyCsysState /** assy csys state */ 
            );
            /**Returns  the assy coordinate system state  <br> License requirements : ugweld ("UG WELD") */
            public: bool CsysAssemblyState
            (
            );
            /**Sets  the through work coordinate system state  <br> License requirements : ugweld ("UG WELD") */
            public: void SetShowThroughWorkPartState
            (
                bool thruWorkState /** thru work state */ 
            );
            /**Returns  the through work coordinate system state  <br> License requirements : ugweld ("UG WELD") */
            public: bool ShowThroughWorkPartState
            (
            );
            /**Sets  the through assy coordinate system state  <br> License requirements : ugweld ("UG WELD") */
            public: void SetShowThroughAssemblyState
            (
                bool thruAssyState /** thru assy state */ 
            );
            /**Returns  the through assy coordinate system state  <br> License requirements : ugweld ("UG WELD") */
            public: bool ShowThroughAssemblyState
            (
            );
            /**Sets  the mirror by type  <br> License requirements : ugweld ("UG WELD") */
            public: void SetMirrorByType
            (
                bool mirrorByType /** mirror by type */ 
            );
            /**Returns  the mirror by type  <br> License requirements : ugweld ("UG WELD") */
            ...
            /**Sets  the offset curve extend method.  <br> License requirements : ugweld ("UG WELD") */
            ...
            /**Returns  the start dist <br> License requirements : ugweld ("UG WELD") */
            public: NXString StartDistance
            (
            );
            /**Sets  the start dist <br> License requirements : ugweld ("UG WELD") */
            public: void SetStartDistance
            (
                const NXString & startDistStr /** expression string */
            );
            /**Returns  the end dist  <br> License requirements : ugweld ("UG WELD") */
            public: NXString EndDistance
            (
            );
            /**Sets  the end dist  <br> License requirements : ugweld ("UG WELD") */
            public: void SetEndDistance
            (
                const NXString & endDistStr /** expression string */
            );
            /**Returns  the spacing number  <br> License requirements : ugweld ("UG WELD") */
            public: NXString SpacingNumber
            (
            );
            /**Sets  the spacing number  <br> License requirements : ugweld ("UG WELD") */
            public: void SetSpacingNumber
            (
                const NXString & spacingOrNumberStr /** expression string */
            );
            /**Returns the tran x dist  <br> License requirements : ugweld ("UG WELD") */
            public: NXString TranslateXDistance
            (
            );
            /**Sets the tran x dist  <br> License requirements : ugweld ("UG WELD") */
            public: void SetTranslateXDistance
            (
                const NXString & transXDistStr /** expression string */
            );
            /**Returns the trans y dist  <br> License requirements : ugweld ("UG WELD") */
            public: NXString TranslateYDistance
            (
            );
            /**Sets the trans y dist  <br> License requirements : ugweld ("UG WELD") */
            ...
            /**Sets  the project direction NXOpen object  <br> License requirements : ugweld ("UG WELD") */
            public: void SetProjectDirectionObject
            (
                NXOpen::Direction * direction /** Project direction */
            );
            /**Returns  the project direction NXOpen object  <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Direction * ProjectDirectionObject
            (
            );
            /**Sets  the project direction  <br> License requirements : ugweld ("UG WELD") */
            public: void SetProjectDirection
            (
                const NXOpen::Vector3d & direction /** Project direction */
            );
            /**Returns  the project direction  <br> License requirements : ugweld ("UG WELD") */
            ...
            /** Gets the user selected faces for the indicated face set  <br> License requirements : ugweld ("UG WELD") */
            ...
            /** Sets the user selected faces for the indicated face set  <br> License requirements : ugweld ("UG WELD") */
            ...
            /** The commit for reference sheets  <br> License requirements : ugweld ("UG WELD") */
            public: void CommitReferenceSheets
            (
                NXOpen::Weld::WeldOverlapStatus createStatus /** create status*/
            );
            /** The clear for all existed facesets  <br> License requirements : ugweld ("UG WELD") */
            ...
            /** The current refsheet  @return   <br> License requirements : ugweld ("UG WELD") */
            public: int GetCurrentReferenceSheet
            (
            );
            /** Set current refsheet <br> License requirements : ugweld ("UG WELD") */
            public: void SetCurrentReferenceSheet
            (
                int currentRefSheet /** current refsheet*/
            );
            /**The creation for single weld point <br> License requirements : ugweld ("UG WELD") */
            public: void CreateSingleWeldPoint
            (
                const NXOpen::Point3d & pointCoord /** point coordinate*/
            );
            /**The commit for first section  <br> License requirements : ugweld ("UG WELD") */
            public: void SetFirstSection
            (
                NXOpen::Section * section /**the section from uicomp*/
            );
            /**Update first section  <br> License requirements : ugweld ("UG WELD") */
            public: void UpdateFirstSection
            (
                NXOpen::Section * totalSection /** the total section*/
            );
            /**Update second section  <br> License requirements : ugweld ("UG WELD") */
            public: void UpdateSecondSection
            (
                NXOpen::Section * totalSection /** the total section*/
            );
            /**Create second section  <br> License requirements : ugweld ("UG WELD") */
            public: void SetSecondSection
            (
                NXOpen::Section * section /**the section from uicomp*/
            );
            /**Create offset curve  @return   <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Section * CreateOffsetCurve
            (
            );
            /**To calculate all weld points <br> License requirements : ugweld ("UG WELD") */
            public: void CalculateWeldPoints
            (
                std::vector<NXOpen::Point3d> & points /** weld points */
            );
            /**Set the selected point  <br> License requirements : ugweld ("UG WELD") */
            public: void SetPoint
            (
                int index /** point index*/
            );
            /**Set or edit characteristics for selected points  <br> License requirements : ugweld ("UG WELD") */
            ...
            /**Update coordinate system for selected points <br> License requirements : ugweld ("UG WELD") */
            public: void UpdateCsys
            (
                const NXOpen::Point3d & origin /** origin point */,
                const NXOpen::Matrix3x3 & matrix /** rotate matrix */
            );
            /**Move selected points <br> License requirements : ugweld ("UG WELD") */
            public: void MovePoint
            (
                const NXOpen::Point3d & origin /** the new position to be located*/
            );
            /** To create center line @return   <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Section * CreateCenterLine
            (
            );
            /**Commit created section <br> License requirements : ugweld ("UG WELD") */
            public: void CommitSection
            (
                NXOpen::Section * path /** the created path*/
            );
            /**Set the selection type  <br> License requirements : ugweld ("UG WELD") */
            public: void SetSelectionType
            (
                NXOpen::Weld::WeldSelectionType selectionType /** selection type */
            );
            /** Flip the z axis  <br> License requirements : ugweld ("UG WELD") */
            public: void FlipZAxis
            (
            );
            /** Create section curve @return  section curve <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Section * CreateSectionPlaneCurves
            (
            );
            /**Returns  the creation direction type.  <br> License requirements : ugweld ("UG WELD") */
            public: NXOpen::Weld::WeldCreationDirection CreationDirection
            (
            );
            /**Sets  the creation direction type.  <br> License requirements : ugweld ("UG WELD") */
            public: void SetCreationDirection
            (
                NXOpen::Weld::WeldCreationDirection creationDirection /** creation direction type */
            );
            /** Add or remove mirror translate reference objects <br> License requirements : ugweld ("UG WELD") */
            ...
            /** Calculate location and default direction of datum and measurement, need to set the current point prior to calling this method  <br> License requirements : ugweld ("UG WELD") */
            public: void CalculateDatumMeasurementDefaultDirection
            (
            );
            /**Remove characteristics for selected points, need to set the current point prior to calling this method   <br> License requirements : ugweld ("UG WELD") */
            ...
            /**Remove the current selected point, need to set the current point prior to calling this method   <br> License requirements : ugweld ("UG WELD") */
