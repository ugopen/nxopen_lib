...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPPEXPORT  NX_DEPRECATED("Deprecated in NX6.0.0")  LabelCollection : public TaggedObjectCollection
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Annotations::LabelData * NewLabelData
            (
            );
            /** Creates a PMI label  @return  New PMI label 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : geometric_tol ("GDT") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Annotations::PmiLabel * CreatePmiLabel
            (
