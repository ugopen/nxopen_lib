...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPPEXPORT  HandlingCoreBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the target solid the handling core will be subtracted from.  <br> License requirements : None */
            public: NXOpen::SelectBody * Target
            (
            );
            /**Returns  the center location of the handling core.  <br> License requirements : None */
            public: NXOpen::Die::DieLocationsBuilder * Location
            (
            );
            /**Returns  the plane of the core for deriving the rectangle and the start of the core. Only valid when type is @link Die::HandlingCoreBuilder::TypesAtLocation Die::HandlingCoreBuilder::TypesAtLocation@endlink .  <br> License requirements : None */
            public: NXOpen::Die::DiePlaneBuilder * CoreOrientation
            (
            );
            /**Returns  the base plane of the target. Used for orienting the core and offset if needed.  <br> License requirements : None */
            public: NXOpen::Die::DiePlaneBuilder * BaseOrientation
            (
            );
            /**Returns  the expression containing the value to use for the height of the core.  <br> License requirements : None */
            public: NXOpen::Expression * Height
            (
            );
            /**Returns  the expression containing the value to use for the width of the core.  <br> License requirements : None */
            public: NXOpen::Expression * Width
            (
            );
            /**Returns  the expression containing the value to use for the clearance offset of the core from the base plane. Only valid when type is @link Die::HandlingCoreBuilder::TypesFromBase Die::HandlingCoreBuilder::TypesFromBase@endlink  or @link Die::HandlingCoreBuilder::TypesMapFromBase Die::HandlingCoreBuilder::TypesMapFromBase@endlink .  <br> License requirements : None */
            public: NXOpen::Expression * Clearance
            (
            );
            /**Returns  the expression containing the value to use for the extrusion depth when creating the core.  <br> License requirements : None */
            ...
            /**Returns  the indicator defining how the handling core is located in space.  <br> License requirements : None */
            public: NXOpen::Die::HandlingCoreBuilder::Types Type
            (
            );
            /**Sets  the indicator defining how the handling core is located in space.  <br> License requirements : ug_die_design ("Die Design") */
            public: void SetType
            (
