...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  FeatureControlFrameDataBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the primary compound datum reference  <br> License requirements : None */
            public: NXOpen::Annotations::CompoundDatumReferenceBuilder * PrimaryCompoundDatumReference
            (
            );
            /**Sets  the primary compound datum reference  <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
            ...
            /**Returns  the secondary compound datum reference  <br> License requirements : None */
            public: NXOpen::Annotations::CompoundDatumReferenceBuilder * SecondaryCompoundDatumReference
            (
            );
            /**Sets  the secondary compound datum reference  <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
            ...
            /**Returns  the tertiary compound datum reference  <br> License requirements : None */
            public: NXOpen::Annotations::CompoundDatumReferenceBuilder * TertiaryCompoundDatumReference
            (
            );
            /**Sets  the tertiary compound datum reference  <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
