    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  AssociativeArcBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the diameter of arc <br> License requirements : None */
            ...
            /**Returns  the plane direction for arc type center radius when lock status is @link GeometricUtilities::SupportPlaneData::LockPlaneStatusCenterPointDirection GeometricUtilities::SupportPlaneData::LockPlaneStatusCenterPointDirection@endlink   <br> License requirements : None */
            public: NXOpen::Vector3d CenterRadiusLockedPlaneDirection
            (
            );
            /**Sets  the plane direction for arc type center radius when lock status is @link GeometricUtilities::SupportPlaneData::LockPlaneStatusCenterPointDirection GeometricUtilities::SupportPlaneData::LockPlaneStatusCenterPointDirection@endlink   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
