    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  SnipSurfaceBuilder : public Features::FeatureBuilder
        {
            ...
            /** Returns the indicator for creating a new copy  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public: bool GetCreateNewCopy
            (
            );
            /** Sets the indicator for creating a new copy  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
