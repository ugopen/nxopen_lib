...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a spline segment.  <br> To obtain an instace of this class use @link Routing::SplineSegmentCollection Routing::SplineSegmentCollection@endlink  <br> */
        class NXOPENCPPEXPORT  SplineSegment : public Spline, public virtual Routing::ISegment
        {
