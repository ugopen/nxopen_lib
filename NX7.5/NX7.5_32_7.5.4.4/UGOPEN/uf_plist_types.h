...
/* array diminsion definitions */
#define MAX_FIELD_STR_LEN   (132+1)
...
struct UF_PLIST_field_format_s 
{
    int     justification;  /* Text justification for this field:
                               ...
                               3 - Right
                            */
    char    lead_str[MAX_FIELD_STR_LEN]; /* <len:MAX_FIELD_STR_LEN>
                                            A prefix string that will be
                                            added before every string in
                                            this field.
                                         */
    char    trailing_str[MAX_FIELD_STR_LEN]; /* <len:MAX_FIELD_STR_LEN>
