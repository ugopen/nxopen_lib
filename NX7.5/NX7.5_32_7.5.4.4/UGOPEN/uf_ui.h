/*******************************************************************************
          Copyright (c) 1998-2005,2009,2010,2011 Unigraphics Solutions Inc.
...
Note when using this function in Drafting in an unexpanded member view, the coordinates 
returned are always relative to the drawing coordinate system.
...
char * file_name ,/* <I/O,len:UF_CFI_MAX_PATH_NAME_LEN>
...
char * title_string ,/* <I>
                     The dialog title.
                     */
char * filter_string ,/* <I/O,len:UF_CFI_MAX_PATH_NAME_SIZE>
...
char *cue, /* <I> Menu title (displayed on the cue line, maximum of 80
                  characters.
           */
...
char *message, /* <I> The message to display. */
...
UF_UI_POINT_base_method_t *base_method, /* <I/O>
                                        ...
                                        */
tag_t *point_tag,  /* <O>
                   Constructed point.  If the Associative toggle is turned off during 
                   interaction or if interpart geometry is selected during point 
                   specification, a non-associative point will be created.  If the
                   Associative toggle is on and geometry selected is within the work
                   part, an SO (associative) point will be created and will be invisible
                   by default.  Use UF_SO_set_visibility_option to make it visible.
