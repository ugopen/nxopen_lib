...
/* <Zhengshu Shen 22-Oct-2008> 2103560 Although SC_section does not belong to
   smart collector, but we have been classified it under UF_smart_container_type,
   then why not return the subtype in UFX_OBJ_ask_type_and_subtype or
   UFX_MODL_ask_smart_container_subtype? */
