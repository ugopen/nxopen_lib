...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /**
            Represents a  @link GeometricUtilities::WaveLinkRepository GeometricUtilities::WaveLinkRepository@endlink .
            This object performs the task of embedding the link features created by 
            the command. It also cleans up unused links.
             <br> To create a new instance of this class, use @link Part::CreateWavelinkRepository Part::CreateWavelinkRepository@endlink  <br> */
        class NXOPENCPPEXPORT  WaveLinkRepository : public NXObject
        {
            ...
            /** Set the builder of the active command.If the builder is feat builder, 
                     ...
                     This master feature is needed to populate the repository with existing slave links on the feature. <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetBuilder
            (
                NXOpen::Builder * builder /** the builder of the command */
            );
            /** Set the link created by interpart selection  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetLink
            (
                NXOpen::Features::Feature * linkFeature /** the wavelink feature */
            );
            /** Destroy the link repository  <br> License requirements : None */
            public: void Destroy
            (
            );
            /** Specify if the client is non-feature based application or not. This flag
                     is used by the repository to properly clean up unused links.  <br> License requirements : None */
