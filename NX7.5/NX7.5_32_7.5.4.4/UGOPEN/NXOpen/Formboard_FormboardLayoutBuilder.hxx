...
namespace NXOpen
{
    ...
    namespace Formboard
    {
        ...
        class NXOPENCPPEXPORT  FormboardLayoutBuilder : public Builder
        {
            ...
            /**Returns  the main run method.  <br> License requirements : None */
            public: NXOpen::Formboard::FormboardLayoutBuilder::MainRunType MainRunMethod
            (
            );
            /**Sets  the main run method.  <br> License requirements : None */
            ...
            /**Returns  the start of the main run.  Contains the starting control point 
                        ...
                        @link Formboard::FormboardLayoutBuilder::MainRunType Formboard::FormboardLayoutBuilder::MainRunType @endlink and @link Formboard::FormboardLayoutBuilder::SetMainRunType Formboard::FormboardLayoutBuilder::SetMainRunType @endlink  is 
                        @link Formboard::FormboardLayoutBuilder::MainRunTypeUserSelection Formboard::FormboardLayoutBuilder::MainRunTypeUserSelection@endlink .  <br> License requirements : None */
            ...
            /**Returns  the flag that determines whether the main run is "reversed" or not. If true then
                        ...
                        when laying out the geometry.  <br> License requirements : None */
            ...
            /**Returns  the main run origin.  The location in modeling space of the start 
                        ...
                        that it start RCP is located at this location.  <br> License requirements : None */
            ...
            /**Returns  the length options for the layout operation.  The length options only have
                      ...
                      created in the drawing.  <br> License requirements : None */
            ...
            /**Returns  the branch angle type.  Specifies how the layout algorithm determines the angle
                        between each child branch and its parent branch.   <br> License requirements : None */
            ...
            /**Returns  the primary standard angle.   The layout algorithm snaps the angle of the
                     ...
                     Only used when the 
                     @link Formboard::FormboardLayoutBuilder::BranchAngle Formboard::FormboardLayoutBuilder::BranchAngle @endlink and @link Formboard::FormboardLayoutBuilder::SetBranchAngle Formboard::FormboardLayoutBuilder::SetBranchAngle @endlink  is
                     @link Formboard::FormboardLayoutBuilder::BranchAngleStandardAngles Formboard::FormboardLayoutBuilder::BranchAngleStandardAngles@endlink .  <br> License requirements : None */
            ...
            /**Returns  the branch shape type.  <br> License requirements : None */
            public: NXOpen::Formboard::FormboardLayoutBuilder::BranchShape BranchShapeType
            (
            );
            /**Sets  the branch shape type.  <br> License requirements : None */
            ...
            /** Creates the initial set of formboard geometry using the current 
                        ...
                        geometry.   <br> License requirements : None */
            public: void CreateDefaultGeometry
            (
            );
            /** Updates the orientation and placement of the formboard geometry to match
                        the current set of layout options stored within the builder.  <br> License requirements : None */
            ...
            /** Translates the formboard geometry so that it matches the new main run origin, this is a more
                        ...
                        is that the only change to the builder is with the main run origin.  <br> License requirements : None */
