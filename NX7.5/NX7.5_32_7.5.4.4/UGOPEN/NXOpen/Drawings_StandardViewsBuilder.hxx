    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPPEXPORT  StandardViewsBuilder : public Builder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") NXOpen::Drawings::StandardViewsBuilder::Placement PlacementType
            (
            );
            /**Sets  the Placement type 
             @deprecated Deprecated in NX6.0.2 <br> 
             <br> License requirements : nx_drafting_plus ("Drafting Plus") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") void SetPlacementType
            (
            ...
            /**Returns  the view placement 
             @deprecated Deprecated in NX6.0.2 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") NXOpen::Drawings::ViewPlacementBuilder * ViewPlacement
            (
            );
            /**Returns  the first corner view placement 
             @deprecated Deprecated in NX6.0.2 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") NXOpen::Drawings::ViewPlacementBuilder * FirstCorner
            (
            );
            /**Returns  the second corner view placement 
             @deprecated Deprecated in NX6.0.2 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.2") NXOpen::Drawings::ViewPlacementBuilder * SecondCorner
            (
            );
