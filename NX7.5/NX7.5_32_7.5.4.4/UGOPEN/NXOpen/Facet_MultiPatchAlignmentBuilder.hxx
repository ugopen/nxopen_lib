...
namespace NXOpen
{
    ...
    namespace Facet
    {
        ...
        /** Aligns multiple facet bodies to one another without using reference points.  <br> To create a new instance of this class, use @link Facet::FacetedBodyCollection::CreateMultiPatchAlignmentBuilder Facet::FacetedBodyCollection::CreateMultiPatchAlignmentBuilder@endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPPEXPORT  MultiPatchAlignmentBuilder : public Builder
        {
            ...
            /**Returns  the facet bodies to be aligned.  <br> License requirements : None */
            ...
            /**Returns  an optional reference facet body with a location and orientation that will 
                        ...
                        will align to each other, without a fixed location.  <br> License requirements : None */
            public: NXOpen::Facet::SelectFacetedBodyList * ReferencePatches
            (
            );
            /**Returns  the type indicating number of facets to be used  in the alignment.  <br> License requirements : None */
            public: NXOpen::Facet::MultiPatchAlignmentBuilder::ResolutionType Resolution
            (
            );
            /**Sets  the type indicating number of facets to be used  in the alignment.  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetResolution
            (
                NXOpen::Facet::MultiPatchAlignmentBuilder::ResolutionType resolution /** resolution */ 
            );
            /**Returns  the precision of the alignment.
                        Alignment will complete when tolerance is met or the number of iterations has been reached.  <br> License requirements : None */
            public: double Tolerance
            (
            );
            /**Sets  the precision of the alignment.
                        Alignment will complete when tolerance is met or the number of iterations has been reached.  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetTolerance
            (
                double tolerance /** tolerance */ 
            );
            /**Returns  the distance facets may be from one another in order to be used 
                        in the alignment. Larger numbers slow the alignment process.  <br> License requirements : None */
            public: double MaximumCheckingDistance
            (
            );
            /**Sets  the distance facets may be from one another in order to be used 
                        in the alignment. Larger numbers slow the alignment process.  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the value indicating the number of times the alignment algorithm is applied. 
                        Many iterations improve alignment accuracy but take longer.  <br> License requirements : None */
            public: int Iteration
            (
            );
            /**Sets  the value indicating the number of times the alignment algorithm is applied. 
                        Many iterations improve alignment accuracy but take longer.  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
