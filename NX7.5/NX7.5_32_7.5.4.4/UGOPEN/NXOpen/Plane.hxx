...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  Plane : public SmartObject, public virtual IPlane, public virtual ISurface, public virtual IOrientation
    {
        ...
        protected: Plane();
        public: ~Plane();
        /** Creates an @link Plane Plane@endlink  using a datum plane feature.  @return   <br> License requirements : None */
        public: NXOpen::Plane * CopySoPlane
        (
        );
        /** Destroy the plane object  <br> License requirements : None */
        public: void DestroyPlane
        (
        );
        /** Set PLANE_parms to plane to make it smart plane   <br> License requirements : None */
