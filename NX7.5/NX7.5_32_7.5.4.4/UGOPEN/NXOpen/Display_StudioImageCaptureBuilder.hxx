...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a @link Display::StudioImageCaptureBuilder Display::StudioImageCaptureBuilder@endlink    <br> To create a new instance of this class, use @link ViewCollection::CreateStudioImageCaptureBuilder ViewCollection::CreateStudioImageCaptureBuilder@endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPPEXPORT  StudioImageCaptureBuilder : public Builder
        {
            ...
            /**Returns  the dpi enum  <br> License requirements : None */
            public: NXOpen::Display::StudioImageCaptureBuilder::DPIEnumType DpiEnum
            (
            );
            /**Sets  the dpi enum  <br> License requirements : None */
            public: void SetDpiEnum
            (
                NXOpen::Display::StudioImageCaptureBuilder::DPIEnumType dpiEnum /** dpienum */ 
            );
            /**Returns  the antialiasing samples enum  <br> License requirements : None */
            public: NXOpen::Display::StudioImageCaptureBuilder::AASamplesEnumType AASamplesEnum
            (
            );
            /**Sets  the antialiasing samples enum  <br> License requirements : None */
            public: void SetAASamplesEnum
            (
                NXOpen::Display::StudioImageCaptureBuilder::AASamplesEnumType aASamplesEnum /** aasamplesenum */ 
            );
            /**Returns  the native file browser for image type to produce  <br> License requirements : None */
            public: NXString NativeFileBrowser
            (
            );
            /**Sets  the native file browser for image type to produce  <br> License requirements : None */
            public: void SetNativeFileBrowser
            (
                const NXString & filename /** filename */ 
            );
            /** Gets the double image dimensions, height and width  @return  array of 2 doubles  <br> License requirements : None */
            public: std::vector<double> GetImageDimensionsDouble
            (
            );
            /** Sets the double image dimensions, height and width  <br> License requirements : None */
            public: void SetImageDimensionsDouble
            (
                const std::vector<double> & imageDimensionsDouble /** array of 2 doubles */
            );
            /** Gets the integer image dimensions, height and width  @return  array of 2 integers  <br> License requirements : None */
            public: std::vector<int> GetImageDimensionsInteger
            (
            );
            /** Sets the integer image dimensions, height and width  <br> License requirements : None */
