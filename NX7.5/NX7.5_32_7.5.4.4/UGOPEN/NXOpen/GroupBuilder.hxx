    ...
    */
    class NXOPENCPPEXPORT  GroupBuilder : public Builder
    {
        ...
        public: enum Action
        {
            ...
            ActionNewSketchGroup/** new sketch group */ 
        };
        ...
        /**Returns  the group display option  <br> License requirements : None */
        public: bool GroupDisplayProperties
        (
        );
        /**Sets  the group display option  <br> License requirements : None */
