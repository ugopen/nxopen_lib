    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT  VarsweepBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the child feature option
             ...
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0") void SetSketchChildFeatureOption
            (
                bool childFeatureOption /** child feature option */ 
            );
            ...
            /**Returns  the child feature option
             ...
             @deprecated Deprecated in NX5.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX5.0.0") bool SketchChildFeatureOption
            (
            );
