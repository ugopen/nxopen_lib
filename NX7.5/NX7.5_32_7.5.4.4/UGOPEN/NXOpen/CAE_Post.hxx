...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  Post
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.1") int CreatePostviewForResult
            (
                int viewIndex /** 0 thru 8, viewport number to place postview in */,
                int resultId /** result id */ ,
                bool overlay /** overlay */ ,
            ...
            /** Create a new cross-section view with specified result on a loaded result id.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Rename a postview. 
                        The input postview id is what was returned from CreatePostview, CreatePostviewForResult, or CreateCrossSectionViewForResult  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Set the result for color display in the input postview id. Needs a PostviewUpdate call to take effect.
             ...
             @deprecated Deprecated in NX7.5.1 <br> 
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.1") void PostviewSetResult
            (
                int postviewId /** postview id */ ,
                const NXOpen::CAE::Result::ResultParameters & result /** result */ 
            );
            /** Set the result for color display in the input cross-section view id. Needs a CrossSectionViewUpdate call to take effect.
                        The input cross-section view id is what was returned from CreateCrossSectionViewForResult  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Set the result for deformed shape in the input postview id. Needs a PostviewUpdate call to take effect.
             ...
             @deprecated Deprecated in NX7.5.1 <br> 
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.1") void PostviewSetDeformation
            (
                int postviewId /** postview id */ ,
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.1") void PostviewSetStreamlineVelocity
            (
                int postviewId /** postview id */ ,
            ...
            /** Set color bar options along with custom overwrite options in the input postview id.  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void PostviewSetColorbar
            (
            ...
            /** Set edge and face styles and colors for primary display in the input 
                        postview id. Needs a PostviewUpdate call to take effect.
                        The input postview id is what was returned from CreateCrossSectionViewForResult  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void PostviewSetEdgeFace
            (
                int postviewId /** postview id */ ,
            ...
            /** Set cutting-plane options in the input postview id. Needs a PostviewUpdate call to take effect.
             ...
             @deprecated Deprecated in NX7.5.1 <br> 
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public:  NX_DEPRECATED("Deprecated in NX7.5.1") void PostviewSetClipping
            (
                int postviewId /** postview id */ ,
            ...
            /** Delete a Seed Set. 
                        The input seedset id is what was returned from @link CAE::Post::CreateStreamlineSeedSet CAE::Post::CreateStreamlineSeedSet@endlink   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
