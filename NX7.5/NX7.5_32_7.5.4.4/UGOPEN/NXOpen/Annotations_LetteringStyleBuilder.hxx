...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            ...
            */
        class NXOPENCPPEXPORT  LetteringStyleBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the alignment position  <br> License requirements : None */
            public: NXOpen::Annotations::AlignmentPosition AlignPosition
            (
            );
            /**Sets  the alignment position  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the horizontal text justification  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the GD and T frame height factor  <br> License requirements : None */
            public: double GdtFrameHeightFactor
            (
            );
            /**Sets  the GD and T frame height factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetGdtFrameHeightFactor
            (
                double gdtFrameHeightFactor /** gdtframeheightfactor */ 
            );
            /**Returns  the angle for general text  <br> License requirements : None */
            public: double Angle
            (
            );
            /**Sets  the angle for general text  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the dimension line space factor.
                        ...
                        multiplied by the space factor  <br> License requirements : None */
            ...
            /**Sets  the dimension line space factor.
                        ...
                        and the dimension line. This only applies when the text orientation is text over 
                        dimension line. The space is equal to the dimension text character size
                        multiplied by the space factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the appended text space factor.
                        ...
                        the space factor  <br> License requirements : None */
            ...
            /**Sets  the appended text space factor.
                        ...
                        the after appended text and the next piece of text to its left.
                        The space is equal to the appended text character size multiplied by
                        the space factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the tolerance text space factor.
                        ...
                        The space is equal to the tolerance text character size multiplied by the space factor  <br> License requirements : None */
            public: double ToleranceTextSpaceFactor
            (
            );
            /**Sets  the tolerance text space factor.
                        This contols the spacing between the dimension main text and the after tolerance text.
                        The space is equal to the tolerance text character size multiplied by the space factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetToleranceTextSpaceFactor
            (
                double toleranceTextSpaceFactor /** tolerancetextspacefactor */ 
            );
            /**Returns  the dimension text character size  <br> License requirements : None */
            public: double DimensionTextSize
            (
            );
            /**Sets  the dimension text character size  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the dimension text space factor.
                        ...
                        standard character spacing for the current font  <br> License requirements : None */
            public: double DimensionTextCharSpaceFactor
            (
            );
            /**Sets  the dimension text space factor.
                        This defines the spacing between characters in text as a multiple of the
                        standard character spacing for the current font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the dimension text aspect ratio.
                        This specifies a ratio of length to height which represents the size of character text  <br> License requirements : None */
            public: double DimensionTextAspectRatio
            (
            );
            /**Sets  the dimension text aspect ratio.
                        This specifies a ratio of length to height which represents the size of character text  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDimensionTextAspectRatio
            (
                double dimensionTextAspectRatio /** dimensiontextaspectratio */ 
            );
            /**Returns  the dimension text line space factor  <br> License requirements : None */
            public: double DimensionTextLineSpaceFactor
            (
            );
            /**Sets  the dimension text line space factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDimensionTextLineSpaceFactor
            (
                double dimensionTextLineSpaceFactor /** dimensiontextlinespacefactor */ 
            );
            /**Returns  the dimension text color  <br> License requirements : None */
            public: NXOpen::NXColor * DimensionTextColor
            (
            );
            /**Sets  the dimension text color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDimensionTextColor
            (
                NXOpen::NXColor * dimensionTextColor /** dimensiontextcolor */ 
            );
            /**Returns  the dimension text font  <br> License requirements : None */
            public: int DimensionTextFont
            (
            );
            /**Sets  the dimension text font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDimensionTextFont
            (
                int dimensionTextFont /** dimensiontextfont */ 
            );
            /**Returns  the dimension text line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth DimensionTextLineWidth
            (
            );
            /**Sets  the dimension text line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDimensionTextLineWidth
            (
                NXOpen::Annotations::LineWidth dimensionTextLineWidth /** dimensiontextlinewidth */ 
            );
            /**Returns  the appended text character size  <br> License requirements : None */
            public: double AppendedTextSize
            (
            );
            /**Sets  the appended text character size  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the appended text line space factor  <br> License requirements : None */
            public: double AppendedTextLineSpaceFactor
            (
            );
            /**Sets  the appended text line space factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetAppendedTextLineSpaceFactor
            (
                double appendedTextLineSpaceFactor /** appendedtextlinespacefactor */ 
            );
            /**Returns  the appended text color  <br> License requirements : None */
            public: NXOpen::NXColor * AppendedTextColor
            (
            );
            /**Sets  the appended text color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetAppendedTextColor
            (
                NXOpen::NXColor * appendedTextColor /** appendedtextcolor */ 
            );
            /**Returns  the appended text font  <br> License requirements : None */
            public: int AppendedTextFont
            (
            );
            /**Sets  the appended text font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetAppendedTextFont
            (
                int appendedTextFont /** appendedtextfont */ 
            );
            /**Returns  the appended text line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth AppendedTextLineWidth
            (
            );
            /**Sets  the appended text line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetAppendedTextLineWidth
            (
                NXOpen::Annotations::LineWidth appendedTextLineWidth /** appendedtextlinewidth */ 
            );
            /**Returns  the tolerance text character size  <br> License requirements : None */
            public: double ToleranceTextSize
            (
            );
            /**Sets  the tolerance text character size  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the tolerance text line space factor  <br> License requirements : None */
            public: double ToleranceTextLineSpaceFactor
            (
            );
            /**Sets  the tolerance text line space factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetToleranceTextLineSpaceFactor
            (
                double toleranceTextLineSpaceFactor /** tolerancetextlinespacefactor */ 
            );
            /**Returns  the tolerance text color  <br> License requirements : None */
            public: NXOpen::NXColor * ToleranceTextColor
            (
            );
            /**Sets  the tolerance text color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetToleranceTextColor
            (
                NXOpen::NXColor * toleranceTextColor /** tolerancetextcolor */ 
            );
            /**Returns  the tolerance text font  <br> License requirements : None */
            public: int ToleranceTextFont
            (
            );
            /**Sets  the tolerance text font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetToleranceTextFont
            (
                int toleranceTextFont /** tolerancetextfont */ 
            );
            /**Returns  the tolerance text line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth ToleranceTextLineWidth
            (
            );
            /**Sets  the tolerance text line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetToleranceTextLineWidth
            (
                NXOpen::Annotations::LineWidth toleranceTextLineWidth /** tolerancetextlinewidth */ 
            );
            /**Returns  the general text character size  <br> License requirements : None */
            public: double GeneralTextSize
            (
            );
            /**Sets  the general text character size  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the general text line space factor  <br> License requirements : None */
            public: double GeneralTextLineSpaceFactor
            (
            );
            /**Sets  the general text line space factor  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetGeneralTextLineSpaceFactor
            (
                double generalTextLineSpaceFactor /** generaltextlinespacefactor */ 
            );
            /**Returns  the general text color  <br> License requirements : None */
            public: NXOpen::NXColor * GeneralTextColor
            (
            );
            /**Sets  the general text color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetGeneralTextColor
            (
                NXOpen::NXColor * generalTextColor /** generaltextcolor */ 
            );
            /**Returns  the general text font  <br> License requirements : None */
            public: int GeneralTextFont
            (
            );
            /**Sets  the general text font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetGeneralTextFont
            (
                int generalTextFont /** generaltextfont */ 
            );
            /**Returns  the general text line width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth GeneralTextLineWidth
            (
            );
            /**Sets  the general text line width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetGeneralTextLineWidth
            (
                NXOpen::Annotations::LineWidth generalTextLineWidth /** generaltextlinewidth */ 
            );
            /**Returns  the stack vertical alignment  <br> License requirements : None */
            public: NXOpen::Annotations::StackVerticalAlignment StackVerticalAlignment
            (
            );
            /**Sets  the stack vertical alignment  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the stack horizontal alignment  <br> License requirements : None */
            public: NXOpen::Annotations::StackHorizontalAlignment StackHorizontalAlignment
            (
            );
            /**Sets  the stack horizontal alignment  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the stack above space factor.
                        ...
                        as a factor of a multiple of the character size  <br> License requirements : None */
            public: double StackAboveSpaceFactor
            (
            );
            /**Sets  the stack above space factor.
                        This specifies the space buffer above the annotation within a stack
                        as a factor of a multiple of the character size  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the stack inherit associated objects setting.
                        ...
                        automatically inherit the associated objects of the stack  <br> License requirements : None */
            public: bool StackInheritAssociatedObjects
            (
            );
            /**Sets  the stack inherit associated objects setting.
                        A value of True means that a PMI annotation when added to a stack will
                        automatically inherit the associated objects of the stack  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the stack autospace setting.
                        ...
                        when a symbol is inserted into a stack  <br> License requirements : None */
            public: bool StackAutospace
            (
            );
            /**Sets  the stack autospace setting.
                        A value of True means that system defined spacing values will be used
                        when a symbol is inserted into a stack  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
