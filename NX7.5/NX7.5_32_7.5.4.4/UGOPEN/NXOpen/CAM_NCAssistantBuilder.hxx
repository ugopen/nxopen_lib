...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPPEXPORT  NCAssistantBuilder : public Builder
        {
            /**Analysis Type*/
            ...
            /**Returns  the Faces to Analyze  <br> License requirements : None */
            ...
            /**Sets  the Analysis Type  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  the Reference Vector  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  the Reference Plane  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetReferencePlane
            (
                NXOpen::Plane * referencePlane /** the Reference Plane */
            );
            /**Returns  the Minimum Level <br> License requirements : None */
            public: double MinimumLevel
            (
            );
            /**Sets  the Minimum Level <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMinimumLevel
            (
                double minimum /** the Minimum Level*/
            );
            /**Returns  the Maximum Level <br> License requirements : None */
            public: double MaximumLevel
            (
            );
            /**Sets  the Maximum Level <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  the Minimum Radius <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMinimumRadius
            (
                double minimum /** the Minimum Radius*/
            );
            /**Returns  the Maximum Radius <br> License requirements : None */
            public: double MaximumRadius
            (
            );
            /**Sets  the Maximum Radius <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the Maximum Angle <br> License requirements : None */
            public: double MaximumAngle
            (
            );
            /**Sets  the Maximum Angle <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  the Distance Tolerance  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  the Angle Tolerance  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetAngleTolerance
            (
                double angleTolerance /** the Angle Tolerance */
            );
            /**Returns  the Radius Tolerance  <br> License requirements : None */
            public: double RadiusTolerance
            (
            );
            /**Sets  the Radius Tolerance  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetRadiusTolerance
            (
                double radiusTolerance /** the Radius Tolerance */
            );
            /**Returns  the Save Face Colors on Exit  <br> License requirements : None */
            public: bool SaveFaceColors
            (
            );
            /**Sets  the Save Face Colors on Exit  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSaveFaceColors
            (
                bool saveFaceColorsOnExit /** the Save Face Colors on Exit */
            );
            /** The action of Information button. It will bring out a text dialog <br> License requirements : cam_base ("CAM BASE") */
            public: void Information
            (
            );
            /** The action of Analyze Geometry button. <br> License requirements : cam_base ("CAM BASE") */
            ...
            /** The analyze result.
                     ...
                     @return  success or not <br> License requirements : None */
