...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  StyledCornerBuilder : public Features::FeatureBuilder
        {
            /** Trim curve types */
            ...
            /**Returns  the input blend1  <br> License requirements : None */
            public: NXOpen::ScCollector * InputBlend1
            (
            );
            /**Returns  the input blend2  <br> License requirements : None */
            public: NXOpen::ScCollector * InputBlend2
            (
            );
            /**Returns  the input blend3  <br> License requirements : None */
            public: NXOpen::ScCollector * InputBlend3
            (
            );
            /**Returns  the base faces  <br> License requirements : None */
            public: NXOpen::ScCollector * BaseFaces
            (
            );
            /**Returns  the trim curve1 type  <br> License requirements : None */
            public: NXOpen::Features::StyledCornerBuilder::TrimCurveTypes TrimCurve1Type
            (
            );
            /**Sets  the trim curve1 type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetTrimCurve1Type
            (
                NXOpen::Features::StyledCornerBuilder::TrimCurveTypes trimCurve1Type /** trimcurve1type */ 
            );
            /**Returns  the trim curve2 type  <br> License requirements : None */
            public: NXOpen::Features::StyledCornerBuilder::TrimCurveTypes TrimCurve2Type
            (
            );
            /**Sets  the trim curve2 type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetTrimCurve2Type
            (
                NXOpen::Features::StyledCornerBuilder::TrimCurveTypes trimCurve2Type /** trimcurve2type */ 
            );
            /**Returns  the interior curve type  <br> License requirements : None */
            public: NXOpen::Features::StyledCornerBuilder::InteriorCurveTypes InteriorCurveType
            (
            );
            /**Sets  the interior curve type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the bottom shape control methods  <br> License requirements : None */
            public: NXOpen::Features::StyledCornerBuilder::ShapeControlMethodsTypes BottomShapeControlMethods
            (
            );
            /**Sets  the bottom shape control methods  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the iso u shape control methods  <br> License requirements : None */
            public: NXOpen::Features::StyledCornerBuilder::ShapeControlMethodsTypes IsoUShapeControlMethods
            (
            );
            /**Sets  the iso u shape control methods  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the iso v shape control methods  <br> License requirements : None */
            public: NXOpen::Features::StyledCornerBuilder::ShapeControlMethodsTypes IsoVShapeControlMethods
            (
            );
            /**Sets  the iso v shape control methods  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the trim curve rebuild data  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::Rebuild * TrimCurveRebuildData
            (
            );
            /**Returns  the base curve rebuild data  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::Rebuild * BaseCurveRebuildData
            (
            );
            /**Returns  the g0 tolerance  <br> License requirements : None */
            public: double G0Tolerance
            (
            );
            /**Sets  the g0 tolerance  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetG0Tolerance
            (
                double g0Tolerance /** g0tolerance */ 
            );
            /**Returns  the g1 tolerance  <br> License requirements : None */
            public: double G1Tolerance
            (
            );
            /**Sets  the g1 tolerance  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetG1Tolerance
            (
                double g1Tolerance /** g1tolerance */ 
            );
            /**Returns  the g2 tolerance  <br> License requirements : None */
            public: double G2Tolerance
            (
            );
            /**Sets  the g2 tolerance  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetG2Tolerance
            (
                double g2Tolerance /** g2tolerance */ 
            );
            /** Gets the path in current position and sets it in builder. Call this before using the OnPathDimensionBuilder  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /** Reset to triangular corner  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void ResetToTriangularCorner
            (
            );
            /** Set number of sides of the corner  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /** Updates corner data. Various parameters are involved in the creation of corner surface. 
                        ...
                        this method needs to be called in order to update internal corner data that was preprocessed.  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the flag indicating to apply to all constraints  <br> License requirements : None */
            public: bool ChangeAllBoundaryConstraints
            (
            );
            /**Sets  the flag indicating to apply to all constraints  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
