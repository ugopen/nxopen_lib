...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPPEXPORT  FlexBodyBuilder : public Builder
        {
            ...
            /**Returns  the selection link  <br> License requirements : None */
            public: NXOpen::Motion::SelectLink * SelectionLink
            (
            );
            /**Returns  the file type  <br> License requirements : None */
            public: NXOpen::Motion::FlexBodyBuilder::SourceType SourceOption
            (
            );
            /**Sets  the file type  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetSourceOption
            (
                NXOpen::Motion::FlexBodyBuilder::SourceType sourceOption /** sourceoption */ 
            );
            /**Returns  the native RFI file name  <br> License requirements : None */
            public: NXString NativeRfiFileName
            (
            );
            /**Sets  the native RFI file name  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetNativeRfiFileName
            (
                const NXString & nativeRfiFileName /** nativerfifilename */ 
            );
            /**Returns  the TCE RFI file name  <br> License requirements : None */
            public: NXString FileTceName
            (
            );
            /**Sets  the TCE RFI file name  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetFileTceName
            (
                const NXString & fileTceName /** filetcename */ 
            );
            /**Returns  the positioning type  <br> License requirements : None */
            public: NXOpen::Motion::FlexBodyBuilder::Positioning PositioningType
            (
            );
            /**Sets  the positioning type  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetPositioningType
            (
                NXOpen::Motion::FlexBodyBuilder::Positioning positioningType /** positioningtype */ 
            );
            /**Returns  the flexible body object name  <br> License requirements : None */
            public: NXString Name
            (
            );
            /**Sets  the flexible body object name  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetName
            (
                const NXString & name /** name */ 
            );
            /** Gets the offset points   @return   <br> License requirements : mechanisms ("MECHANISMS") */
            public: std::vector<double> GetOffsetPoints
            (
            );
            /** Sets the offset points   <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetOffsetPoints
            (
                const std::vector<double> & offsetPoints /** offsetpoints */ 
            );
            /** Gets the offset orientations   @return   <br> License requirements : mechanisms ("MECHANISMS") */
            public: std::vector<double> GetOffsetOrientations
            (
            );
            /** Sets the offset orientations   <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetOffsetOrientations
            (
                const std::vector<double> & offsetOrientations /** offsetorientations */ 
            );
            /** Gets marker to node list Items  @return   <br> License requirements : mechanisms ("MECHANISMS") */
            public: std::vector<NXOpen::Motion::MarkerToNodeData *> GetMarkerItems
            (
            );
            /** Sets marker to node list Items  <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMarkerItems
            (
                const std::vector<NXOpen::Motion::MarkerToNodeData *> & markerToNodeListItem /** markertonodelistitem */ 
            );
            /** Creates a new list item  @return   <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /** Export rfi related results in manager mode @return  The local file specification  <br> License requirements : mechanisms ("MECHANISMS") */
