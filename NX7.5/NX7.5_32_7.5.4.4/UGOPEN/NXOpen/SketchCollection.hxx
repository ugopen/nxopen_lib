...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  SketchCollection : public TaggedObjectCollection
    {
        ...
        public:  NX_DEPRECATED("Deprecated in NX7.5.3") NXOpen::Sketch * CreateSketch
        (
        ...
        /** Creates a @link SketchAssociativeTrimBuilder SketchAssociativeTrimBuilder@endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        ...
        /** Creates a @link SketchInPlaceBuilder SketchInPlaceBuilder@endlink   @return  SketchInPlaceBuilder object
         @deprecated Deprecated in NX7.5.0 <br> 
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public:  NX_DEPRECATED("Deprecated in NX7.5.0") NXOpen::SketchInPlaceBuilder * CreateSketchInPlaceBuilder
        (
        ...
        /** Creates a @link SketchEllipseBuilder SketchEllipseBuilder@endlink   @return  SketchEllipseBuilder object <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::SketchEllipseBuilder * CreateSketchEllipseBuilder
        (
            NXOpen::NXObject * ellipse /** The ellipse to be edited. */
        );
        /** Creates a @link SketchConicBuilder SketchConicBuilder@endlink   @return  SketchConicBuilder object <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::SketchConicBuilder * CreateSketchConicBuilder
        (
            NXOpen::NXObject * conic /** The conic to be edited. */
        );
        /** Creates a @link SketchChamferBuilder SketchChamferBuilder@endlink   @return  Sketch Chamfer Builder object  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::SketchChamferBuilder * CreateSketchChamferBuilder
        (
        );
        /** Creates a @link SketchAutoDimensionBuilder SketchAutoDimensionBuilder@endlink   @return  Sketch Auto-Dimension Builder object <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::SketchAutoDimensionBuilder * CreateAutoDimensionBuilder
        (
        );
        /** Creates a @link SketchPatternBuilder SketchPatternBuilder@endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::SketchPatternBuilder * CreateSketchPatternBuilder
        (
            NXOpen::SketchPattern * con /** Pattern constraint */
        );
        /** Creates a @link SketchMirrorPatternBuilder SketchMirrorPatternBuilder@endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::SketchMirrorPatternBuilder * CreateSketchMirrorPatternBuilder
        (
            NXOpen::SketchPattern * con /** Pattern constraint */
        );
        /** Creates a @link SketchMakeSymmetricBuilder SketchMakeSymmetricBuilder@endlink   @return  MakeSymmetricBuilder object <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: NXOpen::SketchMakeSymmetricBuilder * CreateMakeSymmetricBuilder
        (
        );
        /** Creates a @link SketchPolygonBuilder SketchPolygonBuilder@endlink   @return  SketchPolygonBuilder object <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates a @link SketchPasteBuilder SketchPasteBuilder@endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        ...
        /** Creates a @link SketchEditDefiningSectionBuilder SketchEditDefiningSectionBuilder@endlink   @return  Edit Defining Section Builder object <br> License requirements : solid_modeling ("SOLIDS MODELING") */
