...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  NodeElementManager
        {
            ...
            /** Creates a builder for the creation of multiple elements.    @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Creates a builder for the creation of multiple nodes.    @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Creates a builder for repositioning nodes, Use this command when you need
                        to modify many  nodes at one time. @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Creates a builder for the Shell EAD block.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ShellEADBuilder * CreateShellEadBuilder
            (
            );
            /** Creates a builder for the Bushing EAD block.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::BushingEADBuilder * CreateBushingEadBuilder
            (
            );
            /** Creates a builder for the Gap EAD block.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::GapEADBuilder * CreateGapEadBuilder
            (
            );
            /** Creates a builder for element modify order command @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ElementModifyOrderBuilder * CreateElementModifyOrderBuilder
            (
            );
            /** Creates a builder for the Surface Coat.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::SurfaceCoatBuilder * CreateSurfaceCoatBuilder
            (
            );
            /** Creates a builder for Combine Tris.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::CombineTrisBuilder * CreateCombineTrisBuilder
            (
            );
            /** Creates a builder for Element Extract.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ElementExtractBuilder * CreateElementExtractBuilder
            (
            );
            /** Creates a builder for Manual Hex Mesh.  @return   <br> License requirements : nx_masterfem ("Finite Element Modeling") */
