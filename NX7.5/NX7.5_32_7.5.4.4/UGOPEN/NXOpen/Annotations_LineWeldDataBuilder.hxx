...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  LineWeldDataBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the compound weld size letter code  <br> License requirements : None */
            public: NXOpen::Annotations::LineWeldDataBuilder::WeldSizeCodeType CompoundWeldSizeCode
            (
            );
            /**Sets  the compound weld size letter code  <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
            ...
            /**Returns  the compound weld size  <br> License requirements : None */
            public: NXString CompoundWeldSize
            (
            );
            /**Sets  the compound weld size  <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
            ...
            /**Returns  compound weld  <br> License requirements : None */
            public: bool IsCompound
            (
            );
            /**Sets  compound weld  <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
