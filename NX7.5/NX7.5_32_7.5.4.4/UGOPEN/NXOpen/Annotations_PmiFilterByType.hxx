...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  PmiFilterByType : public Annotations::PmiFilter
        {
            ...
            /** Gets the array of PMI types defined by the PMI filter.  @return   <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::PmiFilterByType::Type> GetPmiTypes
            (
            );
            /** Sets the PMI types on the PMI filter  <br> License requirements : geometric_tol ("GDT") */
