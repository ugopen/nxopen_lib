...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ProeImporter : public Builder
    {
        ...
        /**Returns  the simplify geometry - if value set to true then imported data will be simplified  <br> License requirements : None */
        public: bool SimplifyGeometry
        (
        );
        /**Sets  the simplify geometry - if value set to true then imported data will be simplified  <br> License requirements : None */
        public: void SetSimplifyGeometry
        (
            bool simplifyGeometry /** simplifygeometry */ 
        );
        /**Returns  the Optimize - if value set to true then redundant geometries will be removed  <br> License requirements : None */
        public: bool Optimize
        (
        );
        /**Sets  the Optimize - if value set to true then redundant geometries will be removed  <br> License requirements : None */
