...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SketchMirrorPatternBuilder : public Builder
    {
        ...
        /**Returns  the direction object. This function gets direction object of the pattern constraint  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** This function removes end constraint from the given mirror pattern  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
