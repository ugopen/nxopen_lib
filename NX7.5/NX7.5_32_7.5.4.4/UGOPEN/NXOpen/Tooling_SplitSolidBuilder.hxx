...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPPEXPORT  SplitSolidBuilder : public Builder
        {
            ...
            /**Returns  the tool object selection option  <br> License requirements : None */
            public: NXOpen::Tooling::SplitSolidBuilder::ToolObjectOption ToolOption
            (
            );
            /**Sets  the tool object selection option  <br> License requirements : None */
            public: void SetToolOption
            (
                NXOpen::Tooling::SplitSolidBuilder::ToolObjectOption toolOption /** tooloption */ 
            );
            /**Returns  the target body to be split.  <br> License requirements : None */
            public: NXOpen::SelectBody * SplitTarget
            (
            );
            /**Returns  the tool object to split the target body.  <br> License requirements : None */
            public: NXOpen::SelectNXObject * SplitObject
            (
            );
            /**Returns  the plane to be a split tool.  <br> License requirements : None */
            public: NXOpen::Plane * SplitPlane
            (
            );
            /**Sets  the plane to be a split tool.  <br> License requirements : None */
            public: void SetSplitPlane
            (
                NXOpen::Plane * splitPlane /** splitplane */ 
            );
            /**Returns  the option to enlarge a split tool or not, the tool should be a face.  <br> License requirements : None */
            public: bool IsEnlarge
            (
            );
            /**Sets  the option to enlarge a split tool or not, the tool should be a face.  <br> License requirements : None */
            public: void SetEnlarge
            (
                bool isEnlarge /** isenlarge */ 
            );
            /**Returns  the option to reverse the trim direction or not.  <br> License requirements : None */
            public: bool ReverseTrimDirection
            (
            );
            /**Sets  the option to reverse the trim direction or not.  <br> License requirements : None */
            public: void SetReverseTrimDirection
            (
                bool reverseTrimDirection /** reversetrimdirection */ 
            );
            /**Returns  the utility to get enlarged parameters.  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::SurfaceRangeBuilder * SurfaceRange
            (
            );
            /**Returns  the operation type to do split body or trim body.  <br> License requirements : None */
            public: NXOpen::Tooling::SplitSolidBuilder::OperationType Type
            (
            );
            /**Sets  the operation type to do split body or trim body.  <br> License requirements : None */
            public: void SetType
            (
            ...
            /** Keep enlarged surface data to create enlarged surface. Four values passed in represent enlarged parameters 
                        in U+, U-, V+ and V-.  <br> License requirements : None */
