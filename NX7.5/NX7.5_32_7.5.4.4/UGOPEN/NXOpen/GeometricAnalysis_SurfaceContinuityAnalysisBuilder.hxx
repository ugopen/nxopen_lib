...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPPEXPORT  SurfaceContinuityAnalysisBuilder : public Builder
        {
            ...
            /**Returns  the first edges or faces  <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * FirstEdge
            (
            );
            /**Returns  the second edges or faces. Used only if the type is EdgeEdge  <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * SecondEdge
            (
            );
            /**Returns  the (second) faces. Used only if the type is EdgeFace  <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * Face
            (
            );
            /**Returns  the g0 toggle  <br> License requirements : None */
            public: bool G0
            (
            );
            /**Sets  the g0 toggle  <br> License requirements : gateway ("UG GATEWAY") */
            public: void SetG0
            (
                bool g0 /** g0 */ 
            );
            /**Returns  the g1 toggle  <br> License requirements : None */
            public: bool G1
            (
            );
            /**Sets  the g1 toggle  <br> License requirements : gateway ("UG GATEWAY") */
            public: void SetG1
            (
                bool g1 /** g1 */ 
            );
            /**Returns  the g2 toggle  <br> License requirements : None */
            public: bool G2
            (
            );
            /**Sets  the g2 toggle  <br> License requirements : gateway ("UG GATEWAY") */
            public: void SetG2
            (
                bool g2 /** g2 */ 
            );
            /**Returns  the g3 toggle  <br> License requirements : None */
            public: bool G3
            (
            );
            /**Sets  the g3 toggle  <br> License requirements : gateway ("UG GATEWAY") */
            public: void SetG3
            (
                bool g3 /** g3 */ 
            );
            /**Returns  the curvature check  <br> License requirements : None */
            public: NXOpen::GeometricAnalysis::SurfaceContinuityAnalysisBuilder::CurvatureType CurvatureCheck
            (
            );
            /**Sets  the curvature check  <br> License requirements : gateway ("UG GATEWAY") */
            ...
            /**Returns  the type of analysis to perform  <br> License requirements : None */
            public: NXOpen::GeometricAnalysis::SurfaceContinuityAnalysisBuilder::Types Type
            (
            );
            /**Sets  the type of analysis to perform  <br> License requirements : gateway ("UG GATEWAY") */
            public: void SetType
            (
                NXOpen::GeometricAnalysis::SurfaceContinuityAnalysisBuilder::Types type /** type */ 
            );
            /** The user selects or deselects first edge or face, update builder m_edge1, m_face1  <br> License requirements : gateway ("UG GATEWAY") */
            ...
            /** User selects or deselects second edge or face, update builder m_edge2, m_face2  <br> License requirements : gateway ("UG GATEWAY") */
            public: void UpdateSecondEdgeFace
            (
                NXOpen::DisplayableObject * edgeOrFace /** the parent of Face or Edge */,
                const NXOpen::Point3d & selectionPoint /** selection point */ 
            );
            /** User selects or deselects face, update builder m_edge2, m_face2  <br> License requirements : gateway ("UG GATEWAY") */
            public: void UpdateFace
            (
                NXOpen::Face * face /** face */ ,
                const NXOpen::Point3d & selectionPoint /** selection point */ 
            );
            /** Returns the edge1 array not used  @return   <br> License requirements : None */
