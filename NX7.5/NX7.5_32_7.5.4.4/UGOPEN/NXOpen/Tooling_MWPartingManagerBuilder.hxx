...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        class NXOPENCPPEXPORT  MWPartingManagerBuilder : public Builder
        {
            ...
            /** Perform the module initialization tasks when entering the Mold Wizard Parting environment.  @return  Return the error flag indicating the type of error  <br> License requirements : None */
            public: int InitModule
            (
            );
            /** Perform initialization of the settings for parting when entering the Mold Wizard Parting environment.  <br> License requirements : None */
            public: void InitPartingSettings
            (
            );
            /** Perform the syncronization tasks when entering the Parting Manager environment.  <br> License requirements : None */
            public: void PerformSyncTasks
            (
            );
            /** Perform the syncronization tasks when exiting the Parting Manager environment.  <br> License requirements : None */
            public: void PerformSyncTasksOnExit
            (
            );
            /** Set the update lock.  <br> License requirements : None */
            public: void SetUpdateLock
            (
            );
            /** Reset the update lock.  <br> License requirements : None */
            public: void ResetUpdateLock
            (
                int doUpdate /** indicates whether to perform update after resetting the update lock */
            );
            /** Get the status of the parting manager data.  @return  Return the status of the parting manager data   <br> License requirements : None */
            public: int GetPartingManagerDataStatus
            (
            );
            /** Set the status of the parting manager data.  <br> License requirements : None */
            public: void SetPartingManagerDataStatus
            (
                int pmDataStatus /** Set the status of the parting manager data */
            );
            /** Get if it is within a parting command.  @return  Return if it is within a parting command  <br> License requirements : None */
            public: int GetInPartingCommand
            (
            );
            /** Set if it is within a parting command.  <br> License requirements : None */
            public: void SetInPartingCommand
            (
                int inPartingCommand /** Set if it is within a parting command */
            );
            /** Update the Parting Navigator.  <br> License requirements : None */
            public: void UpdatePartingNavigator
            (
            );
            /** Register the UNDO identifiers.  <br> License requirements : None */
