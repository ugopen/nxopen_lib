...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /**
            ...
            */
        class NXOPENCPPEXPORT  PitchSetting : public TaggedObject
        {
            ...
            public: ~PitchSetting();
            /**Returns  the pitch option  <br> License requirements : None */
            public: NXOpen::CAM::PitchSetting::OptionTypes Option
            (
            );
            /**Sets  the pitch option  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetOption
            (
                NXOpen::CAM::PitchSetting::OptionTypes pitchOption /** the pitch option */
            );
            /**Returns  the pitch variance  <br> License requirements : None */
            public: NXOpen::CAM::PitchSetting::VarianceTypes Variance
            (
            );
            /**Sets  the pitch variance  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetVariance
            (
                NXOpen::CAM::PitchSetting::VarianceTypes pitchVariance /** the pitch variance */
            );
            /**Returns  the thread per mm  <br> License requirements : None */
            public: double ThreadPerUnit
            (
            );
            /**Sets  the thread per mm  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets  the increment  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the output unit  <br> License requirements : None */
            public: NXOpen::CAM::PitchSetting::OutputUnitTypes OutputUnit
            (
            );
            /**Sets  the output unit  <br> License requirements : cam_base ("CAM BASE") */
