...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  StudioXformBuilderEx : public Features::FeatureBuilder
        {
            ...
            /**Returns  the using face finder flag  <br> License requirements : None */
            public: bool CanUseFaceFinder
            (
            );
            /**Sets  the using face finder flag  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the face finder  <br> License requirements : None */
            ...
            /**Returns  the principal movement direction  <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::PrincipalMovementDirectionType PrincipalMovementDirection
            (
            );
            /**Sets  the principal movement direction  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the movement arbitrary vector  <br> License requirements : None */
            public: NXOpen::Direction * MovementArbitraryVector
            (
            );
            /**Sets  the movement arbitrary vector  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetMovementArbitraryVector
            (
                NXOpen::Direction * movementArbitraryVector /** movementarbitraryvector */ 
            );
            /**Returns  the movement arbitrary plane  <br> License requirements : None */
            public: NXOpen::Plane * MovementArbitraryPlane
            (
            );
            /**Sets  the movement arbitrary plane  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetMovementArbitraryPlane
            (
                NXOpen::Plane * movementArbitraryPlane /** movementarbitraryplane */ 
            );
            /**Returns  the rotating axis  <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::RotatingAxisType RotatingAxis
            (
            );
            /**Sets  the rotating axis  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetRotatingAxis
            (
                NXOpen::Features::StudioXformBuilderEx::RotatingAxisType rotatingAxis /** rotatingaxis */ 
            );
            /**Returns  the principal rotating axis  <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::PrincipalRotatingAxisType PrincipalRotatingAxis
            (
            );
            /**Sets  the principal rotating axis  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the rotating arbitrary vector  <br> License requirements : None */
            public: NXOpen::Direction * RotatingArbitraryVector
            (
            );
            /**Sets  the rotating arbitrary vector  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetRotatingArbitraryVector
            (
                NXOpen::Direction * rotatingArbitraryVector /** rotatingarbitraryvector */ 
            );
            /**Returns  the rotating arbitrary plane  <br> License requirements : None */
            public: NXOpen::Plane * RotatingArbitraryPlane
            (
            );
            /**Sets  the rotating arbitrary plane  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetRotatingArbitraryPlane
            (
                NXOpen::Plane * rotatingArbitraryPlane /** rotatingarbitraryplane */ 
            );
            /**Returns  the rotating pivot  <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::RotatingPivotType RotatingPivot
            (
            );
            /**Sets  the rotating pivot  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetRotatingPivot
            (
                NXOpen::Features::StudioXformBuilderEx::RotatingPivotType rotatingPivot /** rotatingpivot */ 
            );
            /**Returns  the rotating pivot point  <br> License requirements : None */
            public: NXOpen::Point * RotatingPivotPoint
            (
            );
            /**Sets  the rotating pivot point  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the principal scaling direction  <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::PrincipalScalingDirectionType PrincipalScalingDirection
            (
            );
            /**Sets  the principal scaling direction  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the scaling arbitrary vector  <br> License requirements : None */
            public: NXOpen::Direction * ScalingArbitraryVector
            (
            );
            /**Sets  the scaling arbitrary vector  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetScalingArbitraryVector
            (
                NXOpen::Direction * scalingArbitraryVector /** scalingarbitraryvector */ 
            );
            /**Returns  the scaling arbitrary plane  <br> License requirements : None */
            public: NXOpen::Plane * ScalingArbitraryPlane
            (
            );
            /**Sets  the scaling arbitrary plane  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the scaling center point  <br> License requirements : None */
            public: NXOpen::Point * ScalingCenterPoint
            (
            );
            /**Sets  the scaling center point  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the planarize projection plane  <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::PlanarizeProjectionPlaneType PlanarizeProjectionPlane
            (
            );
            /**Sets  the planarize projection plane  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            public: NXOpen::Features::StudioXformBuilderEx::AdvancedMethodType AdvancedMethod
            (
            );
            ...
            /**Returns  the value indicating a tolerance to be used to extract a b-surface from a selection face  <br> License requirements : None */
            public: double ExtractTolerance
            (
            );
            /**Sets  the value indicating a tolerance to be used to extract a b-surface from a selection face  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /** Restore the parent face of a selection face <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void RestoreParentFace
            (
            );
            /**Returns  the editing type  <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::Types Type
            (
            );
            /**Sets  the editing type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetType
            (
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.1") void UpdateXformObject
            (
            ...
            /** Update lock region geometry with current geometry  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void UpdateLockRegionGeometry
            (
                NXOpen::NXObject * xformObject /** the selected face or curve to change flexibility of */
            );
            /** Update pole status of the selected BSpine curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
