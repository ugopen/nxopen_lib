...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        ...
        class NXOPENUICPPEXPORT  SetList : public BlockStyler::UIBlock
        {
            ...
            public: /** Reorder callback  <br> License requirements : None */
            ...
            /** Sets the seed using a dlx file.  The seed must be set during initialization.
                ...
                so SetSeed should be called prior to calling SetAddHandler or SetDeleteHandler.  <br> License requirements : None */
            public: void SetSeed
            (
            ...
            /** Sets the Delete handler.  If you set this handler, the handler will be
                ...
                to delete the item.  The list will delete the item if and only if the handler returns 0.  <br> License requirements : None */
            ...
            /** Sets the Reorder observer.  If you set this observer, the observer will
                ...
                after the item has already been moved.  <br> License requirements : None */
            public: void SetReorderObserver
            (
                const NXOpen::BlockStyler::SetList::ReorderCallback&  cb /** cb */ 
            );
            /** Adds an item to the end of the list  @return  The added item  <br> License requirements : None */
            ...
            /** Deletes an item from the list  <br> License requirements : None */
            public: void Delete
            (
                NXOpen::BlockStyler::UIBlock * uicomp /** Item to delete */
            );
            /** Swaps the location of two items  <br> License requirements : None */
            public: void Swap
            (
                NXOpen::BlockStyler::UIBlock * uicomp1 /** Item to swap */,
                NXOpen::BlockStyler::UIBlock * uicomp2 /** Item to swap */
            );
            /** Inserts an item before or after a specified item  @return  The inserted item  <br> License requirements : None */
            ...
            /** Sets the text for the specified item.
                    If the list has a title column, the title column is not included in the item text.  <br> License requirements : None */
            ...
            /** Gets the text for the specified item.
                    If the list has a title column, the title column is not included in the item text.  @return  The text  <br> License requirements : None */
            public: std::vector<NXString> GetItemText
            (
                NXOpen::BlockStyler::UIBlock * item /** item */ 
            );
            /** When an update event occurs on the list, this method finds the
                item in the list that was updated  @return   <br> License requirements : None */
            public: NXOpen::BlockStyler::UIBlock * FindUpdated
            (
            );
            /** Gets the selected items  @return   <br> License requirements : None */
            public: std::vector<NXOpen::BlockStyler::UIBlock *> GetSelected
            (
            );
            /** Sets the selected items.  If the "Multiple Edit" property is false,
                no more than one item can be selected  <br> License requirements : None */
            public: void SetSelected
            (
                const std::vector<NXOpen::BlockStyler::UIBlock *> & items /** items */ 
            );
            /** Gets all the items in the list  @return   <br> License requirements : None */
