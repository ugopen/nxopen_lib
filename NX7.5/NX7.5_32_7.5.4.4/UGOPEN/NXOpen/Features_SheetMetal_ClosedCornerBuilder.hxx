    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT  ClosedCornerBuilder : public Features::FeatureBuilder
            {
                ...
                /** Sets the diameter
                             <br> 
                            This is deprecated. Please use @link Features::SheetMetal::ClosedCornerBuilder::Diameter Features::SheetMetal::ClosedCornerBuilder::Diameter @endlink and @link Features::SheetMetal::ClosedCornerBuilder::SetDiameter Features::SheetMetal::ClosedCornerBuilder::SetDiameter @endlink  instead.
                             <br> 
                 @deprecated Deprecated in NX6.0.0 <br> 
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetDiameter
                (
                ...
                /** Returns the diameter
                 ...
                 @deprecated Deprecated in NX6.0.0 <br> 
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Expression * GetDiameter
                (
                );
                ...
                /** Sets the gap.
                             <br> 
                            This is deprecated. Please use @link Features::SheetMetal::ClosedCornerBuilder::Gap Features::SheetMetal::ClosedCornerBuilder::Gap @endlink and @link Features::SheetMetal::ClosedCornerBuilder::SetGap Features::SheetMetal::ClosedCornerBuilder::SetGap @endlink  instead.
                             <br> 
                 @deprecated Deprecated in NX6.0.0 <br> 
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetGap
                (
                ...
                /** Returns the gap.
                 ...
                 @deprecated Deprecated in NX6.0.0 <br> 
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Expression * GetGap
                (
                );
                ...
                /** Sets the overlap.
                             <br> 
                            This is deprecated. Please use @link Features::SheetMetal::ClosedCornerBuilder::Overlap Features::SheetMetal::ClosedCornerBuilder::Overlap @endlink and @link Features::SheetMetal::ClosedCornerBuilder::SetOverlap Features::SheetMetal::ClosedCornerBuilder::SetOverlap @endlink  instead.
                             <br> 
                 @deprecated Deprecated in NX6.0.0 <br> 
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetOverlap
                (
                ...
                /** Returns the overlap.
                 ...
                 @deprecated Deprecated in NX6.0.0 <br> 
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Expression * GetOverlap
                (
                );
                ...
                /**Returns  the corner will be closed using the miter algorithm. <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: bool MiterCorner
                (
                );
                /**Sets  the corner will be closed using the miter algorithm. <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
