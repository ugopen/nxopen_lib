...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  LetteringPreferences : public TransientObject
        {
            ...
            /**Returns  the flag indicating whether to automatically set the stack spacing to system derived values  <br> License requirements : None */
            public: bool StackAutospace
            (
            );
            /**Sets  the flag indicating whether to automatically set the stack spacing to system derived values  <br> License requirements : None */
