...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SketchAlongPathBuilder : public Builder
    {
        ...
        /**Returns  the sketch orientation method as @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink  <br> License requirements : None */
        public: NXOpen::SketchAlongPathBuilder::SketchOrientationType SketchOrient
        (
        );
        /**Sets  the sketch orientation method as @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: void SetSketchOrient
        (
            NXOpen::SketchAlongPathBuilder::SketchOrientationType sketchOrientMethod /** sketch orient method */ 
        );
        /**Returns  the orienting faces to evaluate X and Y axis of sketch if @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink  is @link SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace@endlink .
             The datum axes are evaluated as tangent and normal of the orienting face. <br> License requirements : None */
        public: NXOpen::ScCollector * OrientingFace
        (
        );
        /**Returns  the flag to create all datum axes for path having shared edge. This option is applicable only when @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink  is @link SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace@endlink  <br> License requirements : None */
        public: bool ShowAllDatumAxes
        (
        );
        /**Sets  the flag to create all datum axes for path having shared edge. This option is applicable only when @link SketchAlongPathBuilder::SketchOrientationType SketchAlongPathBuilder::SketchOrientationType@endlink  is @link SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace SketchAlongPathBuilder::SketchOrientationTypeRelativeToFace@endlink  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
