...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT  ShapeFrameBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the anchor of the frame  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::AnchorLocatorBuilder * Anchor
            (
            );
            /**Returns  the anchor attachment  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::ShapeFrameBuilder::AnchorAttachmentType AnchorAttachment
            (
            );
            /**Sets  the anchor attachment  <br> License requirements : None */
            ...
            /**Returns  the number of vertices of the frame  <br> License requirements : None */
            public: int NumberVertices
            (
            );
            /** Gets the coordinates of the i-th vertex of the frame with respect to the plane  @return  coordinates of vertex relative with respect to plane  <br> License requirements : None */
            public: NXOpen::Point2d GetVertexCoords
            (
                int index /** index of vertex */
            );
            /** Sets the coordinates of the i-th vertex of the frame with respect to the plane  <br> License requirements : None */
            public: void SetVertexCoords
            (
                int index /** index of vertex */,
                const NXOpen::Point2d & coords /** coordinates of vertex relative with respect to plane */
            );
            /** Gets the coordinates of the i-th midpoint of the frame with respect to the plane  @return  coordinates of midpoint relative with respect to plane  <br> License requirements : None */
            public: NXOpen::Point2d GetMidpointCoords
            (
                int index /** index of midpoint */
            );
            /** Sets the coordinates of the i-th midpoint of the frame with respect to the plane  <br> License requirements : None */
