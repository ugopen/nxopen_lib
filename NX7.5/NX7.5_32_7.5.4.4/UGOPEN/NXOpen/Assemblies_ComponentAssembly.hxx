    ...
    namespace Assemblies
    {
        ...
        class NXOPENCPPEXPORT  ComponentAssembly : public NXObject
        {
            ...
            /** Changes the current @link Arrangement Arrangement@endlink  of the given @link Component Component@endlink s to the
                @link Arrangement Arrangement@endlink  with the given name. <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /** Set the default @link Arrangement Arrangement@endlink  for the given @link ComponentAssembly ComponentAssembly@endlink .  <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
