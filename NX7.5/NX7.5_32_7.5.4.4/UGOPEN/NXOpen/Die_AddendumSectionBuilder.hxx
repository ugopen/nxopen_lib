...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        /**
            Represents a @link Die::AddendumSectionBuilder Die::AddendumSectionBuilder@endlink  which is used to create or edit an addendum section.
        ...
        class NXOPENCPPEXPORT  AddendumSectionBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the location where the section will be created.  <br> License requirements : None */
            public: NXOpen::Die::AddendumSectionBuilder::SectionLocationType LocationType
            (
            );
            /**Sets  the location where the section will be created.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetLocationType
            (
                NXOpen::Die::AddendumSectionBuilder::SectionLocationType locationType /** locationtype */ 
            );
            /**Returns  the section shape.  <br> License requirements : None */
            public: NXOpen::Die::AddendumSectionBuilder::SectionShapeType SectionShape
            (
            );
            /**Sets  the section shape.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetSectionShape
            (
                NXOpen::Die::AddendumSectionBuilder::SectionShapeType sectionShape /** sectionshape */ 
            );
            /**Returns  the section orientation.  <br> License requirements : None */
            public: NXOpen::Die::AddendumSectionBuilder::SectionOrientationType SectionOrientation
            (
            );
            /**Sets  the section orientation.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /**Returns  the color and string attributes of the section.  <br> License requirements : None */
            public: NXOpen::Die::DieAttributesBuilder * Attributes
            (
            );
            /**Returns  the origin point where the section will be located.  <br> License requirements : None */
            public: NXOpen::Point * SectionPoint
            (
            );
            /**Sets  the origin point where the section will be located.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetSectionPoint
            (
                NXOpen::Point * sectionPoint /** sectionpoint */ 
            );
            /**Returns  the constraint curve to extend.  <br> License requirements : None */
            public: NXOpen::Curve * CurveToExtend
            (
            );
            /**Sets  the constraint curve to extend.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetCurveToExtend
            (
                NXOpen::Curve * curve /** curve */ 
            );
            /**Returns  the edited constraint curve.  <br> License requirements : None */
            public: NXOpen::Curve * EditedConstraintCurve
            (
            );
            /**Sets  the edited constraint curve.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetEditedConstraintCurve
            (
                NXOpen::Curve * curve /** curve */ 
            );
            /** Cuts section in order to be pasted at another location.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Trims or extends constraint curve.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void TrimExtendConstraintCurve
            (
                NXOpen::NXObject * constraintCurve /** Constraint curve to modify */
            );
            /** Deletes the @link Section Section@endlink  used for extended constraint curve.  @return  @link Section Section@endlink  to delete.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Section * DeleteExtendSection
            (
            );
            /** Copies addendum section in order to be pasted at another location.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void CopySection
            (
                NXOpen::Curve * section /** Section to copy. */,
                bool copyPlaneData /** Indicates whether to copy the orientation plane of the section. */
            );
            /** Initializes environment to start editing parameters of a section.   <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void InitializeEditParameters
            (
                NXOpen::Curve * section /** Section to edit. */
            );
            /** Updates length or angle value of a segment.  @return  Computed flange length value.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: double UpdateSegment
            (
                bool temporary /** Indicates that change to section is temporary in that @link Die::AddendumSectionBuilder::ResetSection Die::AddendumSectionBuilder::ResetSection@endlink  can be called to undo changes.  */,
            ...
            /** Lock a segment parameter value.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Unlock a segment parameter value.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Resets the section to the last saved state.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void ResetSection
            (
                NXOpen::Curve * section /** Section to reset. */
            );
            /** Edit radius value of blend section.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void EditBlendSection
            (
                NXOpen::Curve * section /** Blend section to edit. */,
                double radius /** New radius value. */
            );
            /** Replaces the current section with the edited one.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void ReplaceSectionCurve
            (
                NXOpen::Curve * section /** Section to edit. */
            );
            /** Cleans up environment after editing parameters of a section.   <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void TerminateEditParameters
            (
                NXOpen::Curve * section /** Edited section. */
            );
            /** Updates section after editing segments via @link Die::AddendumSectionBuilder::UpdateSegment Die::AddendumSectionBuilder::UpdateSegment@endlink . 
                        This makes permanent the temporary changes so that any future calls to @link Die::AddendumSectionBuilder::ResetSection Die::AddendumSectionBuilder::ResetSection@endlink 
            ...
            /**Returns  the constraint curve to edit.  This function will read the objects using @link Die::AddendumSectionBuilder::ConstraintCurve Die::AddendumSectionBuilder::ConstraintCurve@endlink .
            ...
            /**Returns  the object used to extend the constraint curve which is accessed via @link Die::AddendumSectionBuilder::ConstraintCurve Die::AddendumSectionBuilder::ConstraintCurve@endlink . 
            ...
            /**Returns  the distance to extend the start of the constraint curve.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Expression * ExtendStartDistance
            (
            );
            /**Returns  the distance to extend the end of the constraint curve.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Expression * ExtendEndDistance
            (
            );
            /** Creates a @link Section Section@endlink  object containing the extended constraint curve.  @return   <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Section * CreateExtendSection
            (
            );
            /** Replaces the constraint curve with an edited curve.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void ReplaceConstraintCurve
            (
                NXOpen::Curve * editedCurve /** New edited curve to replace existing constraint curve. */
            );
            /** Moves addendum section to a new location.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Changes the section orientation.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void ChangeSectionPlane
            (
                NXOpen::Curve * section /** Section to edit. */,
                NXOpen::Direction * plane /** New section orientation plane. */
            );
            /** Updates the section attributes. You must call @link Die::AddendumSectionBuilder::Attributes Die::AddendumSectionBuilder::Attributes@endlink  
            ...
            /** Creates a section by reading the section parameters from the input curve and pasting at 
                        the location specified by @link Die::AddendumSectionBuilder::SectionPoint Die::AddendumSectionBuilder::SectionPoint@endlink 
                     <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            (
                const NXString & fileName /** name of reuse library containing addendum section information   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
            );
            /** Called to update the section when constraint curve or constraint surface is changed.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void UpdateSectionsAfterConstraintChange
            (
            );
            /** Mirror sections using plane from @link Die::AddendumSectionBuilder::MirrorPlane Die::AddendumSectionBuilder::MirrorPlane@endlink .  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void MirrorSections
            (
            );
            /** Delete addendum sections from @link Die::AddendumSectionBuilder::Sections Die::AddendumSectionBuilder::Sections@endlink .  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void DeleteSections
            (
            );
            /** Create addendum section using previously supplied parameters.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void CreateSection
            (
            );
            /** Re-create all existing sections because of a change in the draw direction or product faces.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void RecreateSections
            (
            );
            /** Paste section.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void PasteSection
            (
            );
            /** Reinitialize the environment after changes to input data such as draw vector or product faces  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void Reinitialize
            (
            );
            /**Returns  the section plane.  <br> License requirements : None */
            public: NXOpen::Plane * SectionPlane
            (
            );
            /**Sets  the section plane.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetSectionPlane
            (
                NXOpen::Plane * sectionPlane /** sectionplane */ 
            );
            /**Returns  the curves used to approximate an addendum section.  <br> License requirements : None */
            public: NXOpen::Section * ByCurves
            (
            );
            /**Returns  the addendum sections to edit.  <br> License requirements : None */
            ...
            /**Sets  the mirror plane.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /**Sets  the draw direction.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SetDrawDirection
            (
                NXOpen::Direction * punchDirection /** punchdirection */ 
            );
            /** Create default draw vector based upon the input product faces.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void DefaultDraw
            (
            );
            /**Returns  the constraint curve.  <br> License requirements : None */
            public: NXOpen::ScCollector * ConstraintCurve
            (
            );
            /**Returns  the product faces.  <br> License requirements : None */
            ...
            /**Returns  the smoothing radius for the constraint curve used by @link Die::AddendumSectionBuilder::SmoothCurve Die::AddendumSectionBuilder::SmoothCurve@endlink .  <br> License requirements : None */
            ...
            /** Translate the constraint curve in the direction of the last wall segment of the addendum section using the 
                        distance supplied by @link Die::AddendumSectionBuilder::TranslateDistance Die::AddendumSectionBuilder::TranslateDistance@endlink .
                      <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void TranslateWall
            (
            );
            /** Smooth the constraint curve using the radius supplied by @link Die::AddendumSectionBuilder::SmoothRadius Die::AddendumSectionBuilder::SmoothRadius@endlink .  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: void SmoothCurve
            (
            );
            /**Returns  the translate distance used by @link Die::AddendumSectionBuilder::TranslateWall Die::AddendumSectionBuilder::TranslateWall@endlink .  <br> License requirements : None */
            public: NXOpen::Expression * TranslateDistance
            (
            );
            /**Returns  the neutral curve.  <br> License requirements : None */
            public: NXOpen::Section * NeutralCurve
            (
            );
            /**Returns  the addendum surface build method.  <br> License requirements : None */
            public: NXOpen::Die::AddendumSectionBuilder::SurfaceBuildType SurfaceBuildMethod
            (
            );
            /**Sets  the addendum surface build method.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /**Returns  the minimum plus length.  <br> License requirements : None */
            public: NXOpen::Expression * PlusLength
            (
            );
            /**Returns  the minimum trim ledge.  <br> License requirements : None */
            public: NXOpen::Expression * MinimumTrimLedge
            (
            );
            /**Returns  the minimum radius.  <br> License requirements : None */
            public: NXOpen::Expression * MinimumRadius
            (
            );
            /**Returns  the minimum draft angle.  <br> License requirements : None */
            public: NXOpen::Expression * MinimumDraftAngle
            (
            );
            /**Returns  the maximum positive trim angle.  <br> License requirements : None */
            public: NXOpen::Expression * MaximumPositive
            (
            );
            /**Returns  the minimum negative trim angle.  <br> License requirements : None */
            public: NXOpen::Expression * MinimumNegative
            (
            );
            /**Returns  the facet density.  <br> License requirements : None */
            public: double FacetDensity
            (
            );
            /**Sets  the facet density.  <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /**Returns  the limits to control the span of the preview surface  <br> License requirements : None */
