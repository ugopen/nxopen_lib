...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT  RasterImage : public Features::Feature
        {
            ...
            public: ~RasterImage();
            /**Returns  the origin of the raster image  <br> License requirements : None */
            public: NXOpen::Point3d Origin
            (
            );
            /**Returns  the rotation matrix of the raster image  <br> License requirements : None */
            public: NXOpen::Matrix3x3 Matrix
            (
            );
            /**Returns  the length of the image, given in part units (mm or in).  This is 
                    sometimes considered as the width of the image.  <br> License requirements : None */
            public: double Length
            (
            );
            /**Returns  the height of the image, given in part units (mm or in)  <br> License requirements : None */
            public: double Height
            (
            );
            /**Returns  the name of the image file used for the raster image.  <br> License requirements : None */
            public: NXString ImageFileName
            (
            );
            /**Returns  the translucency of the raster image, in range [0.0, 1.0]  <br> License requirements : None */
            public: double Translucency
            (
            );
            /**Returns  the enum value for the maximum size of the image, in pixels  <br> License requirements : None */
            public: NXOpen::Features::RasterImage::MaxTextureSize MaximumTextureSize
            (
            );
            /** Updates a raster image feature  <br> License requirements : studio_visualize ("STUDIO VISUALIZE") */
            public: void Update
            (
