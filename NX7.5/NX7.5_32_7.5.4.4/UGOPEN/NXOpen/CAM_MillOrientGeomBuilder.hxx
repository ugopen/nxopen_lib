...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  MillOrientGeomBuilder : public CAM::OrientGeomBuilder
        {
            ...
            /** Returns the lower limit mode  @return  the lower limit mode  <br> License requirements : None */
            ...
            /**Returns  the lower limit plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            public: NXOpen::NXObject * LowerLimitPlane
            (
            );
            /**Sets  the lower limit plane,plane entity type covers Xform and Plane  <br> License requirements : cam_base ("CAM BASE") */
