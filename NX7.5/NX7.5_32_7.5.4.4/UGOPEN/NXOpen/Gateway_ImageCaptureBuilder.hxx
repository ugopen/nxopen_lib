...
namespace NXOpen
{
    ...
    namespace Gateway
    {
        ...
        */
        class NXOPENCPPEXPORT  ImageCaptureBuilder : public Builder
        {
            ...
            /**Returns  the file  <br> License requirements : None */
            public: NXString File
            (
            );
            /**Sets  the file  <br> License requirements : drafting ("DRAFTING") */
            public: void SetFile
            (
                const NXString & filename /** filename */ 
            );
            /**Returns  the format  <br> License requirements : None */
            public: NXOpen::Gateway::ImageCaptureBuilder::ImageFormat Format
            (
            );
            /**Sets  the format  <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Returns  the image file  <br> License requirements : None */
            public: NXString ImageFile
            (
            );
            /**Sets  the image file  <br> License requirements : drafting ("DRAFTING") */
