...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  TrimPoint : public TaggedObject
        {
            ...
            /**Returns  the trim point ramp angle option  <br> License requirements : None */
            public: NXOpen::CAM::TrimPoint::RampAngleOptions RampAngleOption
            (
            );
            /**Sets  the trim point ramp angle option  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetRampAngleOption
            (
                NXOpen::CAM::TrimPoint::RampAngleOptions rampAngleMode /** the trim point ramp angle option */
            );
            /**Returns  the trim point ramp angle vector  <br> License requirements : None */
            public: NXOpen::NXObject * RampAngleVector
            (
            );
            /**Sets  the trim point ramp angle vector  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetRampAngleVector
            (
                NXOpen::NXObject * rampVector /** the trim point ramp angle vector */
            );
            /**Returns  the trim point ramp angle  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * RampAngle
            (
            );
            /**Returns  the trim point ramp angle offset  <br> License requirements : None */
