...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        class NXOPENCPPEXPORT  TrueShadingBuilder : public Builder
        {
            ...
            /**Returns  the shadow plane with fixed offset toggle  <br> License requirements : None */
            public: bool PlaneOffsetFixedToggle
            (
            );
            /**Sets  the shadow plane with fixed offset toggle  <br> License requirements : None */
            ...
            /**Returns  the shadow plane grid to inherit Model grid attributes toggle  <br> License requirements : None */
            public: bool InheritModelTogggle
            (
            );
            /**Sets  the shadow plane grid to inherit Model grid attributes toggle  <br> License requirements : None */
            ...
            /** Protects update  <br> License requirements : None */
