...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        class ShadowsImpl;
        /**
            Represents a @link Display::Shadows Display::Shadows@endlink 
             <br> To create a new instance of this class, use @link ViewCollection::CreateShadows ViewCollection::CreateShadows@endlink  <br> */
        class NXOPENCPPEXPORT  Shadows : public Builder
        {
            ...
            protected: Shadows();
            public: ~Shadows();
            /**Returns  the Real Time Settings  <br> License requirements : None */
            public: NXOpen::Display::Shadows::RealTimeState RealTimeType
            (
            );
            /**Sets  the Real Time Settings  <br> License requirements : None */
            public: void SetRealTimeType
            (
                NXOpen::Display::Shadows::RealTimeState realTimeType /** realtimetype */ 
            );
            /**Returns  the Soft Shadows  <br> License requirements : None */
            public: bool SoftShadowsEnabled
            (
            );
            /**Sets  the Soft Shadows  <br> License requirements : None */
            public: void SetSoftShadowsEnabled
            (
                bool softShadowsEnabled /** softshadowsenabled */ 
            );
            /**Returns  the Soft Shadows edges (softness)  <br> License requirements : None */
            public: int SoftShadowsEdges
            (
            );
            /**Sets  the Soft Shadows edges (softness)  <br> License requirements : None */
            public: void SetSoftShadowsEdges
            (
                int softShadowsEdges /** softshadowsedges */ 
            );
            /**Returns  the Soft Shadows quality  <br> License requirements : None */
            public: int SoftShadowsQuality
            (
            );
            /**Sets  the Soft Shadows quality  <br> License requirements : None */
            public: void SetSoftShadowsQuality
            (
                int softShadowsQuality /** softshadowsquality */ 
            );
            /**Returns  the Soft Shadows bias offset  <br> License requirements : None */
            public: double SoftShadowsBiasOffset
            (
            );
            /**Sets  the Soft Shadows bias offset  <br> License requirements : None */
            public: void SetSoftShadowsBiasOffset
            (
                double softShadowsBiasOffset /** softshadowsbiasoffset */ 
            );
            /**Returns  the Soft Shadows gradient clamp  <br> License requirements : None */
            public: double SoftShadowsGradientClamp
            (
            );
            /**Sets  the Soft Shadows gradient clamp  <br> License requirements : None */
            public: void SetSoftShadowsGradientClamp
            (
                double softShadowsGradientClamp /** softshadowsgradientclamp */ 
            );
            /**Returns  the shadows SSAO quality  <br> License requirements : None */
            public: NXOpen::Display::Shadows::SsaoQualityType SsaoQuality
            (
            );
            /**Sets  the shadows SSAO quality  <br> License requirements : None */
            public: void SetSsaoQuality
            (
                NXOpen::Display::Shadows::SsaoQualityType shadowsSSAOQuality /** shadowsssaoquality */ 
            );
            /**Returns  the shadows SSAO radius  <br> License requirements : None */
            public: double SsaoRadius
            (
            );
            /**Sets  the shadows SSAO radius  <br> License requirements : None */
            public: void SetSsaoRadius
            (
                double radius /** radius */ 
            );
            /**Returns  the shadows SSAO contrast  <br> License requirements : None */
            public: NXOpen::Display::Shadows::SsaoContrastType SsaoContrast
            (
            );
            /**Sets  the shadows SSAO contrast  <br> License requirements : None */
            public: void SetSsaoContrast
            (
                NXOpen::Display::Shadows::SsaoContrastType contrast /** contrast */ 
            );
            /**Returns  the shadows SSAO Blur Radius  <br> License requirements : None */
            public: double SsaoBlurRadius
            (
            );
            /**Sets  the shadows SSAO Blur Radius  <br> License requirements : None */
            public: void SetSsaoBlurRadius
            (
                double blurRadius /** blurradius */ 
            );
            /**Returns  the shadows SSAO ambient occlusion  <br> License requirements : None */
            public: bool AmbientOcclusion
            (
            );
            /**Sets  the shadows SSAO ambient occlusion  <br> License requirements : None */
            public: void SetAmbientOcclusion
            (
                bool shadowsSSAODisplayEnabled /** shadowsssaodisplayenabled */ 
            );
            /**Returns  the High Quality Image settings  <br> License requirements : None */
            public: bool GenerateHqiShadows
            (
            );
            /**Sets  the High Quality Image settings  <br> License requirements : None */
            public: void SetGenerateHqiShadows
            (
                bool generateHQIShadows /** generatehqishadows */ 
            );
            /**Returns  the Shadow Catcher Selection  <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * ShadowCatcherSelection
            (
            );
            /**Returns  the Shadow Catcher  <br> License requirements : None */
            public: bool UseShadowCatcher
            (
            );
            /**Sets  the Shadow Catcher  <br> License requirements : None */
