...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT  LabelChamferBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the chamfer face  <br> License requirements : None */
            public: NXOpen::ScCollector * ChamferFace
            (
            );
            /**Returns  the construction face1 of chamfer face  <br> License requirements : None */
            public: NXOpen::ScCollector * ConstructionFace1
            (
            );
            /**Returns  the construction face2 of chamfer face  <br> License requirements : None */
