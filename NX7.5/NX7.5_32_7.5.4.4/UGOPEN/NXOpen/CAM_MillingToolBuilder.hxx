...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  MillingToolBuilder : public CAM::ToolBuilder
        {
            ...
            /**Returns  the Cutcom Register Builder  <br> License requirements : None */
            ...
            /**Returns  the mill trackpoint builder   <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::MillingTrackpointBuilder * MillingTrackpointBuilder
            (
            );
            /**Returns  the coolant through parameter  <br> License requirements : None */
            public: bool CoolantThrough
            (
            );
            /**Sets  the coolant through parameter  <br> License requirements : None */
