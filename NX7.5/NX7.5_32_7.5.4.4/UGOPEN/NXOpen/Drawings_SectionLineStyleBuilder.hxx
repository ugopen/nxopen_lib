...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT  SectionLineStyleBuilder : public Builder
        {
            ...
            /**Returns  the display label  <br> License requirements : None */
            public: bool DisplayLabel
            (
            );
            /**Sets  the display label  <br> License requirements : drafting ("DRAFTING") */
            public: void SetDisplayLabel
            (
                bool displayLabel /** displaylabel */ 
            );
            /**Returns  the letter  <br> License requirements : None */
            public: NXString Letter
            (
            );
            /**Sets  the letter  <br> License requirements : drafting ("DRAFTING") */
            public: void SetLetter
            (
                const NXString & letter /** letter */ 
            );
            /**Returns  the label location  <br> License requirements : None */
            public: NXOpen::Drawings::SectionLineStyleBuilder::LabelLocationStyle LabelLocation
            (
            );
            /**Sets  the label location  <br> License requirements : drafting ("DRAFTING") */
            public: void SetLabelLocation
            (
                NXOpen::Drawings::SectionLineStyleBuilder::LabelLocationStyle labelLocation /** label location */ 
            );
            /**Returns  the display jisrotation letter  <br> License requirements : None */
            public: bool DisplayJisrotationLetter
            (
            );
            /**Sets  the display jisrotation letter  <br> License requirements : drafting ("DRAFTING") */
            public: void SetDisplayJisrotationLetter
            (
                bool displayJISRotationLetter /** displayjisrotationletter */ 
            );
            /**Returns  the selected note for jisrotation letter  <br> License requirements : None */
            public: NXOpen::SelectTaggedObject * SelectLetter
            (
            );
            /**Returns  the arrowhead style  <br> License requirements : None */
            public: NXOpen::Drawings::SectionLineStyleBuilder::ArrowheadStyleType ArrowheadStyle
            (
            );
            /**Sets  the arrowhead style  <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Sets  the arrowhead length  <br> License requirements : drafting ("DRAFTING") */
            public: void SetArrowheadLength
            (
                double arrowheadLength /** arrowheadlength */ 
            );
            /**Returns  the arrow length  <br> License requirements : None */
            public: double ArrowLength
            (
            );
            /**Sets  the arrow length  <br> License requirements : drafting ("DRAFTING") */
            public: void SetArrowLength
            (
                double arrowLength /** arrowlength */ 
            );
            /**Returns  the arrowhead angle  <br> License requirements : None */
            public: double ArrowheadAngle
            (
            );
            /**Sets  the arrowhead angle  <br> License requirements : drafting ("DRAFTING") */
            public: void SetArrowheadAngle
            (
                double arrowheadAngle /** arrowheadangle */ 
            );
            /**Returns  the border to arrow distance  <br> License requirements : None */
            public: double BorderToArrowDistance
            (
            );
            /**Sets  the border to arrow distance  <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Sets  the stub length  <br> License requirements : drafting ("DRAFTING") */
            public: void SetStubLength
            (
                double stubLength /** stublength */ 
            );
            /**Returns  the line length  <br> License requirements : None */
            public: double LineLength
            (
            );
            /**Sets  the line length  <br> License requirements : drafting ("DRAFTING") */
            public: void SetLineLength
            (
                double lineLength /** linelength */ 
            );
            /**Returns  the use offset  <br> License requirements : None */
            public: bool UseOffset
            (
            );
            /**Sets  the use offset  <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Sets  the offset  <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Sets  the standard  <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Sets  the font  <br> License requirements : drafting ("DRAFTING") */
            public: void SetFont
            (
            ...
            /**Returns  a value that indicates whether or not to create a view for the section line  <br> License requirements : None */
            public: NXOpen::Drawings::SectionLineStyleBuilder::CreateSectionLineType CreateSectionLine
            (
            );
            /**Sets  a value that indicates whether or not to create a view for the section line  <br> License requirements : drafting ("DRAFTING") */
