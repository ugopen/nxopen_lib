...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Mold Wizard enlarge surface management builder, trims a enlarged surface to a boundary of edges,
                curves, datum planes or faces. Optionally creates output trimmed sheet body as a patch surface.  <br> To create a new instance of this class, use @link Tooling::EnlargeSurfaceCollection::CreateEnlargeSurfaceBuilder Tooling::EnlargeSurfaceCollection::CreateEnlargeSurfaceBuilder@endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPPEXPORT  EnlargeSurfaceBuilder : public Builder
        {
            ...
            /**Returns  the selection of target to create enlarge surface, body face only.  <br> License requirements : None */
            public: NXOpen::ScCollector * TargetSelection
            (
            );
            /**Returns  the selection of boundary to trim the target surface, it could be face, datum plane, edge and curve.  <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * BoundarySelection
            (
            );
            /**Returns  the selection of region, which will be kept or discarded as the result of enlarged surface.  <br> License requirements : None */
            ...
            /**Returns  the surface range data, which controls the enlarged parameters of surface.  <br> License requirements : None */
            public: NXOpen::GeometricUtilities::SurfaceRangeBuilder * SurfaceRange
            (
            );
            /**Returns  the value of option, which specifies when enlarging surface, whether to change all the sizes at the same time or not.  <br> License requirements : None */
            public: bool ChangeAllSizes
            (
            );
            /**Sets  the value of option, which specifies when enlarging surface, whether to change all the sizes at the same time or not.  <br> License requirements : None */
            public: void SetChangeAllSizes
            (
                bool changeAllSizes /** changeallsizes */ 
            );
            /**Returns  the value of option, which specifies whether to cut the target to boundary objects or not.  <br> License requirements : None */
            public: bool CutToBoundary
            (
            );
            /**Sets  the value of option, which specifies whether to cut the target to boundary objects or not.  <br> License requirements : None */
            ...
            /** Returns the value of patch surface color.  <br> License requirements : None */
            ...
            /** Sets the value of patch surface color.  <br> License requirements : None */
            ...
            /** Sets the target face to target surface data.  <br> License requirements : None */
            public: void SetTargetFace
            (
                NXOpen::Face * targetFace /** target face */
            );
            /** Sets the value of surface range to buider data according to range face.  <br> License requirements : None */
            public: void SetRangeValue
            (
                NXOpen::Face * rangeFace /** range face */,
                const std::vector<double> & rangeValue /** array of u and v range value */
            );
            /** Initializes the surface data with face, and adds the data to builder.  <br> License requirements : None */
            public: void AddSurfaceData
            (
                NXOpen::Face * addFace /** face to add to surface data */
            );
            /** Erases the surface data from builder according to face.  <br> License requirements : None */
            public: void EraseSurfaceData
            (
                NXOpen::Face * eraseFace /** face to get surface data */
            );
            /** Initializes the planar face data with face, and adds the data to builder.  <br> License requirements : None */
            public: void AddPlanarFaceData
            (
                NXOpen::Face * planarFace /** face to add to planar face data */
            );
            /** Erases the planar face data from builder according to face.  <br> License requirements : None */
