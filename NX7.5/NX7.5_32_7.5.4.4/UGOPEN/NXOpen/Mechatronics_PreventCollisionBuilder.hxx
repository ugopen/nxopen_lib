...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        class NXOPENCPPEXPORT  PreventCollisionBuilder : public Mechatronics::PhysicsConstraintBuilder
        {
            ...
            /**Returns  the first object. This can be a @link RigidBody RigidBody@endlink , @link CollisionBody CollisionBody@endlink  
                    or @link CollisionSensor CollisionSensor@endlink .  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
