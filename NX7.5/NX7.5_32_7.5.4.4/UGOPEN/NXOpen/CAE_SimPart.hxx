    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  SimPart : public CAE::CaePart
        {
            ...
            /** Imports selected entities from the source sim into the current (target) sim.
                    ...
                    to import the same source sim onto multiple FeModelOccurrences of the target sim.  @return  list of generated error codes during import  <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SimPart::ImportErrorCodes ImportSim
            (
                const NXString & fileName /** name of the source simulation file   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXString & prependString /** string to prepend imported simulation entity names, can be NULL or empty    <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */,
                const NXOpen::CAE::SimPart::ImportOptions & selOptions /** options indicating the types of entities to be imported */,
                const std::vector<NXOpen::CAE::FEModelOccurrence *> & selectedFemoccs /** Array of FeModelOccurrences to import onto @link CAE::FEModelOccurrence CAE::FEModelOccurrence@endlink  */
            );
        };
    }
}
