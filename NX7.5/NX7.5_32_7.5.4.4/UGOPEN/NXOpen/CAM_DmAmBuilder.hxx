...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  DmAmBuilder : public TaggedObject
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") NXOpen::CAM::DmAmBuilder::AmCutAngleTypes AmCutAngleType
            (
            );
            /**Sets  the Cut Angle Type 
             @deprecated Deprecated in NX7.5.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") void SetAmCutAngleType
            (
            ...
            /**Returns  the Cut Angle Value 
             @deprecated Deprecated in NX7.5.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") double AmCutAngleValue
            (
            );
            /**Sets  the Cut Angle Value 
             @deprecated Deprecated in NX7.5.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") void SetAmCutAngleValue
            (
            ...
            /**Returns  the stepover ci builder 
             ...
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::CAM::AmStepoverCiBuilder * StepoverCiBuilder
            (
            );
