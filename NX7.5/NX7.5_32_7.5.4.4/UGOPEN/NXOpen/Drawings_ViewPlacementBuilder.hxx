    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT  ViewPlacementBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the placement location.  The location may be specified by either
                        ...
                        position based on the alignment method and alignment point specified.  <br> License requirements : None */
            ...
            /**Returns  the point to align to.  This point is only required for the
                        ...
                        a @link Point3d Point3d@endlink  selected object point.    <br> License requirements : None */
