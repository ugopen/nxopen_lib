#ifndef NXOpen_FEATURES_SHIPCUTOUTBUILDER_HXX_INCLUDED
#define NXOpen_FEATURES_SHIPCUTOUTBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Features_ShipCutoutBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
#include <NXOpen/Features_ShipCutoutBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /**
            Represents a @link Features::ShipCutout Features::ShipCutout@endlink  builder
             <br> To create a new instance of this class, use @link Features::FeatureCollection::CreateShipCutoutBuilder Features::FeatureCollection::CreateShipCutoutBuilder@endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPPEXPORT  ShipCutoutBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the placement type.  
                    The creation method used to place the cutout object.  <br> License requirements : None */
            public: NXOpen::Features::ShipCutoutBuilder::CreationMethod PlacementType
            (
            );
            /**Sets  the placement type.  
                    The creation method used to place the cutout object.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            public: void SetPlacementType
            (
                NXOpen::Features::ShipCutoutBuilder::CreationMethod placementType /** placementtype */ 
            );
            /**Returns  the select Target Face.  
                    This target face is only used for the Face2Lines placement method.  <br> License requirements : None */
            ...
            /**Returns  the keep select target face
                    ...
                    The keep select target face is only used for the Face2Lines placement method.  <br> License requirements : None */
            public: bool KeepSelectTargetFace
            (
            );
            /**Sets  the keep select target face
                    A toggle used to remember the selected object on apply.
                    The keep select target face is only used for the Face2Lines placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            public: void SetKeepSelectTargetFace
            (
                bool keepSelectTargetFace /** keepselecttargetface */ 
            );
            /**Returns  the select Line1.
                    This line 1 is only used for the Face2Lines placement method. <br> License requirements : None */
            public: NXOpen::SelectNXObject * SelectLine1
            (
            );
            /**Returns  the keep select line1
                    A toggle used to remember the selected object on apply.
                    The keep select line1 is only used for the Face2Lines placement method.  <br> License requirements : None */
            public: bool KeepSelectLine1
            (
            );
            /**Sets  the keep select line1
                    A toggle used to remember the selected object on apply.
                    The keep select line1 is only used for the Face2Lines placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            public: void SetKeepSelectLine1
            (
                bool keepSelectLine1 /** keepselectline1 */ 
            );
            /**Returns  the select Line2 
                    This line 2 is only used for the Face2Lines placement method.  <br> License requirements : None */
            public: NXOpen::SelectNXObject * SelectLine2
            (
            );
            /**Returns  the keep select line2
                    A toggle used to remember the selected object on apply.
                    The keep select line2 is only used for the Face2Lines placement method.  <br> License requirements : None */
            public: bool KeepSelectLine2
            (
            );
            /**Sets  the keep select line2
                    A toggle used to remember the selected object on apply.
                    The keep select line2 is only used for the Face2Lines placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            ...
            /**Returns  the keep coordinate system
                    A toggle used to remember the selected object on apply.
                    The keep coordinate system is only used for the SpecifyCSYS placement method.  <br> License requirements : None */
            public: bool KeepCoordSystem
            (
            );
            /**Sets  the keep coordinate system
                    A toggle used to remember the selected object on apply.
                    The keep coordinate system is only used for the SpecifyCSYS placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            public: void SetKeepCoordSystem
            (
                bool keepCoordSystem /** keepcoordsystem */ 
            );
            /**Returns  the selection object for the target face. 
                    This target CSYS face is only used for the SpecifyCSYS placement method.  <br> License requirements : None */
            public: NXOpen::SelectFace * SelectCSYSFace
            (
            );
            /**Returns  the keep select csys face
                    A toggle used to remember the selected object on apply.
                    The keep select csys face is only used for the SpecifyCSYS placement method.  <br> License requirements : None */
            public: bool KeepSelectCSYSFace
            (
            );
            /**Sets  the keep select csys face
                    A toggle used to remember the selected object on apply.
                    The keep select csys face is only used for the SpecifyCSYS placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            public: void SetKeepSelectCSYSFace
            (
                bool keepSelectCSYSFace /** keepselectcsysface */ 
            );
            /**Returns  the linear offset distance from line1.
                    The linear offset 1 is only used for the Face2Lines placement method.  <br> License requirements : None */
            ...
            /**Returns  the reverse direction 1.
                    ...
                    The reverse direction 1 is only used for the Face2Lines placement method.  <br> License requirements : None */
            public: bool ReverseDirection1
            (
            );
            /**Sets  the reverse direction 1.
                    Allows you to reverse the direction used in the linear offset 1.
                    The reverse direction 1 is only used for the Face2Lines placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            ...
            /**Returns  the toggle which allows re-use of the previous reverse direction toggle.
                    This is only used for the Face2Lines placement method.  <br> License requirements : None */
            public: bool KeepReverseDirection1
            (
            );
            /**Sets  the toggle which allows re-use of the previous reverse direction toggle.
                    This is only used for the Face2Lines placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            ...
            /**Returns  the linear offset distance from line2.
                    The linear offset 2 is only used for the Face2Lines placement method.  <br> License requirements : None */
            ...
            /**Returns  the reverse direction 2.
                    ...
                    The reverse direction 2 is only used for the Face2Lines placement method.  <br> License requirements : None */
            public: bool ReverseDirection2
            (
            );
            /**Sets  the reverse direction 2.
                    Allows you to reverse the direction used in the linear offset 2.
                    The reverse direction 2 is only used for the Face2Lines placement method.  <br> License requirements : nx_ship_concept ("Ship Concept") */
            ...
            /**Returns  the angular dimension used to rotate the cutout's profile
                    The angular dimension is only used for the Face2Lines placement method. <br> License requirements : None */
            public: NXOpen::Expression * AngularDim
            (
            );
            /**Returns  he library sketch block that defines the Cutout outline  <br> License requirements : None */
