    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPPEXPORT  ToolPathEditorBuilder : public Builder
        {
            ...
            /** Move  <br> License requirements : cam_base ("CAM BASE") */
            public: void Move
            (
            );
            ...
            /** Extend  <br> License requirements : cam_base ("CAM BASE") */
            public: void Extend
            (
            );
            ...
            /**Returns  the clearance plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            public: NXOpen::NXObject * GougeCheckClearancePlane
            (
            );
            /**Sets  the clearance plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            ...
            /** Select all gouges  <br> License requirements : cam_base ("CAM BASE") */
            public: void SelectAllGouges
            (
            );
            /** Select previous gouge  <br> License requirements : cam_base ("CAM BASE") */
            public: void SelectPreviousGouge
            (
            );
            /** Select next gouge  <br> License requirements : cam_base ("CAM BASE") */
            public: void SelectNextGouge
            (
            );
            /** Move to clearance plane  <br> License requirements : cam_base ("CAM BASE") */
            public: void MoveToClearancePlane
            (
            );
            /** Get number of gouges   @return   <br> License requirements : cam_base ("CAM BASE") */
            public: int GetNumberOfGouges
            (
            );
            /** Reverse  <br> License requirements : cam_base ("CAM BASE") */
            public: void Reverse
            (
            );
            ...
            /**Returns  the trim plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            public: NXOpen::NXObject * TrimPlane
            (
            );
            /**Sets  the trim plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            ...
            /**Returns  the trimming clearance plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            public: NXOpen::NXObject * TrimClearancePlane
            (
            );
            /**Sets  the trimming clearance plane,plane entity type covers Xform and Plane  <br> License requirements : None */
            public: void SetTrimClearancePlane
            (
                NXOpen::NXObject * plane /** plane */ 
            );
            /** Trim  <br> License requirements : cam_base ("CAM BASE") */
            public: void Trim
            (
            );
        };
