...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  ToolPathDivideBuilder : public Builder
        {
            ...
            /**Returns  the Clearance Plane tag,plane entity type covers Xform and Plane  <br> License requirements : None */
            public: NXOpen::NXObject * ClearancePlane
            (
            );
            /**Sets  the Clearance Plane tag,plane entity type covers Xform and Plane  <br> License requirements : None */
