...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT  SessionNXGateway
        {
            ...
            /**Returns  the Assembly-level features flag for Solid Edge  <br> License requirements : None */
            public: bool LoadSolidEdgeAssemblyFeatures
            (
            );
            /**Sets  the Assembly-level features flag for Solid Edge  <br> License requirements : None */
