    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT  RSEventAttributes : public TaggedObject
            {
                ...
                /**Returns  the DDAM formulation type <br> License requirements : None */
                public: NXOpen::CAE::ResponseSimulation::RSEvent::DdamFormulationType Formulation
                (
                );
                /**Sets  the DDAM formulation type <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: void SetFormulation
                (
                    NXOpen::CAE::ResponseSimulation::RSEvent::DdamFormulationType formulation /** formulation */ 
                );
                /**Returns  the Minimum G value  <br> License requirements : None */
                public: double MinimumGValue
                (
                );
                /**Sets  the Minimum G value  <br> License requirements : nx_response_anlys ("NX Response Analysis") */
