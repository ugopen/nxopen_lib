    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  RapidSurfaceBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the operation type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Features::RapidSurfaceBuilder::OperationTypes OperationType
            (
            );
            /**Sets  the operation type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetOperationType
            (
                NXOpen::Features::RapidSurfaceBuilder::OperationTypes option /** option */ 
            );
            /**Returns  the attachment type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Features::RapidSurfaceBuilder::AttachmentTypes AttachmentType
            (
            );
            /**Sets  the attachment type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetAttachmentType
            (
                NXOpen::Features::RapidSurfaceBuilder::AttachmentTypes option /** option */ 
            );
            /**Returns  the subdivision loop type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Features::RapidSurfaceBuilder::LoopTypes LoopType
            (
            );
            /**Sets  the subdivision loop type  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the boundary point set manager  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Features::GeometricConstraintDataSetManager * BoundaryPointSetManager
            (
            );
            /**Returns  the loop curve(U)  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::SelectCurve * ULoopCurve
            (
            );
            /**Returns  the loop curve(V)  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::SelectCurve * VLoopCurve
            (
            );
            /**Returns  the patches(U)  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: int UPatches
            (
            );
            /**Sets  the patches(U)  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetUPatches
            (
                int patchesU /** patches u */ 
            );
            /**Returns  the patches(V)   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: int VPatches
            (
            );
            /**Sets  the patches(V)   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the drag curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::SelectCurve * DragCurve
            (
            );
            /**Returns  the curve used for drag curve point  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns  the node tolerance  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: double NodeTolerance
            (
            );
            /**Sets  the node tolerance  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetNodeTolerance
            (
                double nodeTolerance /** nodetolerance */ 
            );
            /** Accepts new facet body  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void AcceptNewFacetBody
            (
            );
            /** Imports curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void ImportCurve
            (
            );
            /** Accepts subdivision  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void AcceptSubdivision
            (
            );
            /** Sets number of defining points  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetNumberOfDefiningPoints
            (
                int number /** Number of Defined Points */
            );
            /** Sets a defining point  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetNumberOfDefinePoints
            (
                int number /** Number of Defined Points */
            );
            /** Set a define point (pre-NX6) 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetADefinePoint
            (
                int index /** Index of Defined Point */,
            ...
            /** Resets animation polyline  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void ResetAnimationPolyline
            (
            );
            /** Creates animation polyline  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void CreateAnimationPolyline
            (
            );
            /** Creates boundary curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void CreateBoundaryCurve
            (
            );
            /** Draws curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void DrawCurve
            (
            );
            /** Draws boundary curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void DrawBoundaryCurve
            (
            );
            /** Deletes curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void DeleteCurve
            (
            );
            /** Deletes node  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void DeleteNode
            (
                NXOpen::Point * point /** Point */
            );
            /** Drags curve point  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void DragCurvePoint
            (
            );
            /** Moves node  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void MoveNode
            (
                NXOpen::Point * point /** Point */,
                const NXOpen::Point3d & newPosition /** the new position the point move to */
            );
            /** Reprojects edges after move node  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void ReprojectEdgesAfterMoveNode
            (
            );
            /** Creates points to record every mesh node @return   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: std::vector<NXOpen::Point *> CreateNodePoints
            (
            );
            /** Asks edge count in the current curve network  @return   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: int AskEdgeCount
            (
            );
            /** Asks an edge in the current curve network  @return   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Spline * AskEdge
            (
                int edgeIndex /** Edge Index */
            );
            /** Gets node count in the current curve network  @return   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: int GetNodeCount
            (
            );
            /** Gets a node in the current curve network  @return   <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Point * GetNode
            (
                int nodeIndex /** Node Index */
            );
            /**Returns  the connect curves  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::SelectCurveList * ConnectCurves
            (
            );
            /** Accepts connect curve  <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
