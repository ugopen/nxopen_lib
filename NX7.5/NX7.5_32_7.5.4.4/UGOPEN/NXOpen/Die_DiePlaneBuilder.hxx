...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        class NXOPENCPPEXPORT  DiePlaneBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the type of input that defined the plane  <br> License requirements : None */
            public: NXOpen::Die::DiePlaneBuilder::PlaneType InputType
            (
            );
            /**Sets  the type of input that defined the plane  <br> License requirements : ug_die_design ("Die Design") */
            ...
            /**Returns  the type of source that defined the plane. Functions are obsolete, please use input_type. 
             @deprecated Deprecated in NX7.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.0.0") NXOpen::Die::DiePlaneBuilder::PlaneType SourceDataType
            (
            );
            /**Sets  the type of source that defined the plane. Functions are obsolete, please use input_type. 
             @deprecated Deprecated in NX7.0.0 <br> 
