...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  BasePart : public NXObject
    {
        ...
        /** Get the preview image
            ...
            green and blue color components with the final 8 bits set to zero.
        ...
        /** Creates a @link Display::DynamicSectionBuilder Display::DynamicSectionBuilder@endlink  
                ...
                will be thrown.    
                 <br>           
                 <br> This method has been deprecated. Use @link BasePart::DynamicSections BasePart::DynamicSections@endlink  
                to create a section builder.
                 <br> 
              @return  
         @deprecated Deprecated in NX6.0.0 <br> 
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::Display::DynamicSectionBuilder * CreateDynamicSectionBuilder
        (
        ...
        /** Get all the @link ReferenceSet ReferenceSet@endlink  objects in this part  @return   <br> License requirements : None */
        ...
        /**Returns  the unique identifier for this part used to determine whether parts can be quietly substituted during part open. When set
                if the input value is the empty string a new unqiue uid is allocated for the part otherwise the supplied uid is used.  <br> License requirements : None */
