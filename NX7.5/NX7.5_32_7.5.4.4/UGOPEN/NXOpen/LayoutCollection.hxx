...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  LayoutCollection : public TaggedObjectCollection
    {
        ...
        /** This method creates a layout with two modeling views. The views
             ** are created with names given. Layout and view tags are returned  <br> License requirements : None */
        ...
        /** This method destroys the split screen layout along with the views 
             * that are there in it  <br> License requirements : None */
        public: void DestroySplitScreenLayoutAndNamedViews
        (
            NXOpen::Layout * layout /** Layout */
        );
        /** Sets the given layout as current layout  <br> License requirements : None */
        public: void ChangeLayout
        (
            NXOpen::Layout * layout /** Layout */
        );
        /** Using given names renames the views in split screen layout.  <br> License requirements : None */
