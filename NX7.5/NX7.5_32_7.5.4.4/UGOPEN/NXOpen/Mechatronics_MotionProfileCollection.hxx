...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        class NXOPENCPPEXPORT  MotionProfileCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a @link Mechatronics::MotionProfileBuilder Mechatronics::MotionProfileBuilder@endlink .  @return   <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
            ...
            /** Finds the @link  Mechatronics::MotionProfile   Mechatronics::MotionProfile @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  Mechatronics::MotionProfile   Mechatronics::MotionProfile @endlink  with this name.  <br> License requirements : nx_mcd_core ("MECHATRONICS CONCEPT DESIGNER") */
