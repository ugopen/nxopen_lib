...
namespace NXOpen
{
    ...
    class NXOPENDEBUGSESSIONCPPEXPORT  AutotestPrint
    {
        ...
        /**Returns  an override that allows applications to ignore the custom option set
                ...
                the PrintTestData method will behave based on the @link Autotest::PrintLevelOption Autotest::PrintLevelOption @endlink and @link Autotest::SetPrintLevelOption Autotest::SetPrintLevelOption @endlink .  <br> License requirements : None */
        ...
        /**Returns  the level of output for the PrintTestData method when
                the @link Autotest::CustomOptionOverride Autotest::CustomOptionOverride @endlink and @link Autotest::SetCustomOptionOverride Autotest::SetCustomOptionOverride @endlink  is true  <br> License requirements : None */
        ...
        /** Write a comment in the autotest XML  <br> License requirements : None */
        ...
        /** Whether XML is printing  @return   <br> License requirements : None */
