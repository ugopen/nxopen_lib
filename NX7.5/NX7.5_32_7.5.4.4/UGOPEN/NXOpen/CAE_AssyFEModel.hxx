    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  AssyFEModel : public CAE::BaseFEModel, public virtual CAE::IHierarchicalFEModel
        {
            ...
            /** Map a fem part to an assembly component in an assembly fem
                      @return  fem occurrence  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Get reposition update option
                      @return  reposition option  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Get unmap update option
                      @return  removal option  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Get freeze option
                      @return  freeze option  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
