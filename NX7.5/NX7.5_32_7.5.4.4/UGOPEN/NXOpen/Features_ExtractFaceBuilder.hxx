    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  ExtractFaceBuilder : public Features::FeatureBuilder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") NXOpen::SelectFaceList * FacesToExtract
            (
            );
            /**Returns  new API can be used to extract objects of types face or body <br> License requirements : None */
            public: NXOpen::SelectDisplayableObjectList * ObjectToExtract
            (
            );
            /**Returns  the face chain to extract  <br> License requirements : None */
            public: NXOpen::ScCollector * FaceChain
            (
            );
            /** Returns the face chain direction sense  @return   <br> License requirements : None */
            ...
            /** the recreation of vector of help dir  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
