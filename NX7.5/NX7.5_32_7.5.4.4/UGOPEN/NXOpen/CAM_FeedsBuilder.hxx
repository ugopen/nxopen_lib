...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  FeedsBuilder : public TaggedObject
        {
            ...
            /** Set machining data  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMachiningData
            (
            );
            /**Returns  the optimize feed rate when generating  <br> License requirements : None */
            public: bool OptimizeFeedRateWhenGenerating
            (
            );
            /**Sets  the optimize feed rate when generating  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetOptimizeFeedRateWhenGenerating
            (
                bool isOptimize /** is optimize */ 
            );
            /**Returns  the feeds optimize data  <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::FeedsOptimizationData * FeedsOptimizationData
            (
            );
            /**Returns  the spindle_rpm_toggle  <br> License requirements : None */
            public: int SpindleRpmToggle
            (
            );
            /**Sets  the spindle_rpm_toggle  <br> License requirements : cam_base ("CAM BASE") */
