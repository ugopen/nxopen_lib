...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT  DrawingSheetBuilder : public Builder
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") bool AutoStartBaseView
            (
            );
            /**Sets  the setting that controls whether or not the Add Base View command is automatically 
             ...
             @deprecated Deprecated in NX7.5.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") void SetAutoStartBaseView
            (
            ...
            /**Returns  the option of base view or drawing view  <br> License requirements : None */
            public: NXOpen::Drawings::DrawingSheetBuilder::SheetBaseordrawingView BaseordrawingView
            (
            );
            /**Sets  the option of base view or drawing view  <br> License requirements : drafting ("DRAFTING") */
