    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  AssociativeLineBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the start at angle  <br> License requirements : None */
            ...
            /**Returns  the start normal  <br> License requirements : None */
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") NXOpen::SelectDisplayableObject * AtAngle
            (
            );
            /**Returns  the end at angle  <br> License requirements : None */
            ...
            /**Returns  the angle 
             @deprecated Deprecated in NX7.5.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX7.5.0") NXOpen::Expression * Angle
            (
            );
