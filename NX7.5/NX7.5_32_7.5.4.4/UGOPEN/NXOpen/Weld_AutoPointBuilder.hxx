    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPPEXPORT  AutoPointBuilder : public Builder
        {
            ...
            /**Returns  the type of creation.  <br> License requirements : None */
            public: NXOpen::Weld::AutoPointBuilder::Types Type
            (
            );
            /**Sets  the type of creation.  <br> License requirements : ugweld ("UG WELD") */
            public: void SetType
            (
            ...
            /**Returns  the feature to reuse intead of creating new.  These features will be updated instead of creating new.  <br> License requirements : None */
            ...
            public:  NX_DEPRECATED("Deprecated in NX7.5.4") NXOpen::Weld::AutoPointBuilder::InterferenceStatus GetInterferenceStatus
            (
                int interferenceIndex /**  Index to the desired interference */
            );
            /** The status indicating if the interference has existing weld points touching it. The
            ...
            /**Returns  the distance that maximum spacing can be exceeded to achieve uniform spacing  <br> License requirements : None */
            public: double UniformSpacingTolerance
            (
            );
            /**Sets  the distance that maximum spacing can be exceeded to achieve uniform spacing  <br> License requirements : ugweld ("UG WELD") */
            ...
            /**Returns  the distance used to determine if the location of an existing weld feature is coincident with the 
                        newly calculated location. If the locations are coincident, then the existing weld feature location will be reused. <br> License requirements : None */
            ...
            /**Sets  the distance used to determine if the location of an existing weld feature is coincident with the 
                        newly calculated location. If the locations are coincident, then the existing weld feature location will be reused. <br> License requirements : ugweld ("UG WELD") */
