...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Catiav5Importer : public Builder
    {
        ...
        /**Returns  the optimize - This option allows you to optimize the topology  <br> License requirements : None */
        public: bool Optimize
        (
        );
        /**Sets  the optimize - This option allows you to optimize the topology  <br> License requirements : None */
        public: void SetOptimize
        (
            bool optimize /** optimize */ 
        );
        /**Returns  the number of search directories - This option allows you to specify total number of serach directories  <br> License requirements : None */
        public: int TotalSearchDirectories
        (
        );
        /**Sets  the number of search directories - This option allows you to specify total number of serach directories  <br> License requirements : None */
