...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  CurveCollection : public TaggedObjectCollection
    {
        ...
        /** Creates a @link InfiniteLine InfiniteLine@endlink  that passes through the two specified points.  @return   <br> License requirements : drafting ("DRAFTING") */
        public: NXOpen::InfiniteLine * CreateInfiniteLine
        (
            const NXOpen::Point3d & startPoint /** Start point */,
            const NXOpen::Point3d & endPoint /** End point */
        );
        /** Creates a paired @link InfiniteLine InfiniteLine@endlink  that is paired to the specified line.  @return   <br> License requirements : drafting ("DRAFTING") */
        public: NXOpen::InfiniteLine * CreatePairedInfiniteLine
        (
            NXOpen::Line * line /** Paired @link Line Line@endlink  */
        );
        ...
        /** Creates a @link Curve Curve@endlink .  The virtual blend curve will be
                created for the input blend face. The virtual blend curve behaves similarly
                to the original edge that the blend face was applied on.  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates a @link Curve Curve@endlink .  The virtual centerline curve will be
                created for the input blend face.  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
