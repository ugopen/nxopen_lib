    ...
    namespace Features
    {
        ...
        class NXOPENCPPEXPORT  ChamferBuilder : public Features::FeatureBuilder
        {
            ...
            /**Sets  the first offset distance (expression). Please do not use this property to access/modify
                ...
                This might be removed from KF bindings in NX 9. <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the first offset distance (expression). Please do not use this property to access/modify
                the @link Features::ChamferBuilder::FirstOffsetExp Features::ChamferBuilder::FirstOffsetExp@endlink .
                This might be removed from KF bindings in NX 9. <br> License requirements : None */
            ...
            /**Sets  the tolerance used for creating chamfer <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetTolerance
            (
                double tolerance /** tolerance */ 
            );
            /**Returns  the tolerance used for creating chamfer <br> License requirements : None */
