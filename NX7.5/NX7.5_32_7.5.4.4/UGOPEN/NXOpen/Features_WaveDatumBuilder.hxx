    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPPEXPORT  WaveDatumBuilder : public Features::FeatureBuilder
        {
            ...
            /**Returns  the wave linked datum reverse direction  <br> License requirements : None */
            public: bool ReverseDirection
            (
            );
            /**Sets  the wave linked datum reverse direction  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetReverseDirection
            (
                bool reverseDirection /** reversedirection */ 
            );
            /** Sets Entry From SynchLink  <br> License requirements : wave ("WAVE FUNCTIONALITY") */
