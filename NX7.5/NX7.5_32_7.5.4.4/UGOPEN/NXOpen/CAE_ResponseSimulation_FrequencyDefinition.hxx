...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ResponseSimulation
        {
            ...
            class NXOPENCPPEXPORT  FrequencyDefinition : public TaggedObject
            {
                ...
                /**Returns  the interpolation method. Only available when the frequency is defined by
                        @link CAE::ResponseSimulation::FrequencyDefinition::DefinitionRange CAE::ResponseSimulation::FrequencyDefinition::DefinitionRange@endlink   <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                ...
                /**Returns  the frequency to perfor FRF evaluation. Only available when the frequency definition 
                ...
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") double Frequency
                (
                );
                /**Sets  the frequency to perfor FRF evaluation. Only available when the frequency definition 
                        method is @link CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution@endlink  
                 @deprecated Deprecated in NX6.0.0 <br> 
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetFrequency
                (
                    double frequency /** frequency */ 
                );
                /** Returns frequency values to perform FRF evaluation. Only available when the frequency definition 
                        method is @link CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution@endlink   @return   <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                ...
                /** Sets the frequency values to perform FRF evaluation. Only available when the frequency definition 
                        method is @link CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution@endlink   <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                ...
                /**Returns  the option for generating maximum contributors or not. Only available when
                        frequency definition metod is @link CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution CAE::ResponseSimulation::FrequencyDefinition::DefinitionModalContribution@endlink   <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                ...
                /**Returns  the number of contributors. Only available when maximu contributors
                         will be generated  <br> License requirements : nx_response_anlys ("NX Response Analysis") */
