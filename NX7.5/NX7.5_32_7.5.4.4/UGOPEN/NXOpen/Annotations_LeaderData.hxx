...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  LeaderData : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Sets  the terminator type  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the arrowhead  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the stub side  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Sets  the stub size  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetStubSize
            (
                double stubSize /** stubsize */ 
            );
            /**Returns  the perpendicular relationship between the first segment and stub  <br> License requirements : None */
            public: bool Perpendicular
            (
            );
            /**Sets  the perpendicular relationship between the first segment and stub  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
