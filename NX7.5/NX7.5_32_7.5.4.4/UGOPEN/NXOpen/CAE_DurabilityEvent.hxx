...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPPEXPORT  DurabilityEvent : public NXObject
        {
            ...
            /**Returns  the activity status of the event.  <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public: bool ActivityStatus
            (
            );
            /**Sets  the activity status of the event.  <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public: void SetActivityStatus
            (
                bool activityStatus /** activity status */ 
            );
            /** Rename the event.  <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public: void Rename
            (
