...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  Sketch : public DisplayableObject, public virtual IProfile
    {
        ...
        /** Type of Auto Dimensioning rules. It should match the rule types defined in Auto Dimensioning
            ...
            JA_SKETCH_auto_dimensioning_rule_symmetric: create symmetric dimensions if the curves are symmetric
            JA_SKETCH_auto_dimensioning_rule_adjacent_angle: create angles between adjacent lines 
            JA_SKETCH_auto_dimensioning_rule_length: create length dimension for lines
            JA_SKETCH_auto_dimensioning_rule_horizontal_vertical: create horizontal and vertical dimensions 
            JA_SKETCH_auto_dimensioning_rule_reference_axes: create dimensions between curves and reference axes 
            */
        ...
        public: enum InferConstraintsOption
        {
         ...
         /** This structure represents a map between the original object to be copied
            ...
            An array of these structures are returned from the API JA_SKETCH_copy_objects().
            */
        public:
        ...
        /** Run auto dimensioning.  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        ...
        /** Creates a normal constraint.
            ...
            linear objects, create a perpendicular constraint
             @return  The normal constraint  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        ...
        /** Update the sketch and not the sketch children.  If a different sketch is active the SKETCH_NOT_INITIALIZED error will return. The function works even if the sketch is not active. <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        ...
        /** Adds an array of curves (not points) to a sketch. Deprecated:  Instead use the version of AddGeometry that permits         an array of curves and points as input.
             
         @deprecated Deprecated in NX6.0.1 <br> 
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public:  NX_DEPRECATED("Deprecated in NX6.0.1") void AddGeometry
        (
            const std::vector<NXOpen::Curve *> & curves /** Must be a curve or point */,
            NXOpen::Sketch::InferConstraintsOption inferCoincidentConstraints /** Whether to automatically create coincident constraints
                                                         when adding the geometry.  If this flag is true and there exists
                                                         another curve or point in the sketch that has a vertex that
                                                         is at the same location (within system tolerance)
        ...
        /** Creates a reflection of the input geometry.
         ...
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.0") std::vector<NXOpen::SmartObject *> MirrorObjects
        (
        ...
        /**Returns  the view corresponding to sketch  <br> License requirements : None */
        public: NXOpen::View * View
        (
        );
        /**Returns  true if drafting sketch  <br> License requirements : None */
        ...
        /** Creates copies of input objects and constraints between these objects. This function is same as
                @link Sketch::CopyObjects Sketch::CopyObjects@endlink  except that it returns an array of newly created dimensions  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        ...
        /** Unblanks all the dimensions of input sketch  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: void ShowDimensions
        (
        );
        /** Blanks all the dimensions of input sketch  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: void HideDimensions
        (
        );
        ...
        /**Returns  true if the sketch is internal.  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates copies of input objects and constraints between these objects.
            Sketch dimensions are copied only if explicitly included in the input_objects array. 
             @return  Map between the original input object and the corresponding copied object  <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
