...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class NXOPENCPPEXPORT  FacePlaneSelectionBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Sets the data OK flag  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetOk
            (
                bool isOk /** isok */ 
            );
            /**Returns the data OK flag  <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: bool IsOk
            (
            );
