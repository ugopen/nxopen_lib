...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  SurfaceFinishBuilder : public Annotations::BaseSurfaceFinishBuilder
        {
            ...
            /**Returns  the tolerance type is applicable only where Material Removal is required <br> License requirements : None */
            public: NXOpen::Annotations::BaseSurfaceFinishBuilder::ToleranceOption ToleranceType
            (
            );
            /**Sets  the tolerance type is applicable only where Material Removal is required <br> License requirements : None */
            ...
            /**Sets  the tolerance in case of bilateral tolerance type otherwise upper tolerance  <br> License requirements : None */
            ...
            /**Sets  the lower tolerance applicable for all the tolerance types other than Bilateral <br> License requirements : None */
            ...
            /**Returns  the invert text flag <br> License requirements : None */
            public: bool InvertText
            (
            );
            /**Sets  the invert text flag <br> License requirements : None */
            ...
            /**Sets  the parantheses <br> License requirements : None */
            ...
            /**Sets  the invert symbol  <br> License requirements : None */
