...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  ToolAxisVariable : public CAM::ToolAxisBase
        {
            ...
            /**Returns  the Lead Angle <br> License requirements : None */
            public: double LeadAngle
            (
            );
            /**Sets  the Lead Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetLeadAngle
            (
                double leadAngle /** the Lead Angle*/
            );
            /**Returns the Minimum the Lead Angle <br> License requirements : None */
            public: double MinimumLeadAngle
            (
            );
            /**Sets the Minimum the Lead Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMinimumLeadAngle
            (
                double minimumLeadAngle /** the Minimum Lead Angle*/
            );
            /**Returns the Maximum the Lead Angle <br> License requirements : None */
            public: double MaximumLeadAngle
            (
            );
            /**Sets the Maximum the Lead Angle <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns the Minimum Tilt Angle <br> License requirements : None */
            public: double MinimumTiltAngle
            (
            );
            /**Sets the Minimum Tilt Angle <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets the Maximum Tilt Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMaximumTiltAngle
            (
                double maximumTiltAngle /** the Maximum Tilt Angle*/
            );
            /**Returns  the Rotation Axis  <br> License requirements : None */
            public: NXOpen::Direction * RotationAxis
            (
            );
            /**Sets  the Rotation Axis  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetRotationAxis
            (
                NXOpen::Direction * vector /** the Rotation Axis */
            );
            /**Returns  the Zag Rotation Axis  <br> License requirements : None */
            public: NXOpen::Direction * ZagRotationAxis
            (
            );
            /**Sets  the Zag Rotation Axis  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Sets the Rotation Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetRotationAngle
            (
                double rotationAngle /** the Rotation Angle*/
            );
            /**Returns the Minimum Heel Clearance Distance <br> License requirements : None */
            public: double MinimumHeelClearanceDistance
            (
            );
            /**Sets the Minimum Heel Clearance Distance <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMinimumHeelClearanceDistance
            (
                double minimumHeelClearanceDistance /** the Minimum Heel Clearance Distance*/
            );
            /**Returns  the Maximum Lead Angle type  <br> License requirements : None */
            public: NXOpen::CAM::ToolAxisVariable::MaximumLeadAngleTypes MaximumLeadAngleType
            (
            );
            /**Sets  the Maximum Lead Angle type  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns the Nominal Lead Angle type  <br> License requirements : None */
            public: NXOpen::CAM::ToolAxisVariable::NominalLeadAngleTypes NominalLeadAngleType
            (
            );
            /**Sets the Nominal Lead Angle type  <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns the Nominal Lead Angle <br> License requirements : None */
            public: double NominalLeadAngle
            (
            );
            /**Sets the Nominal Lead Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNominalLeadAngle
            (
                double nominalLeadAngle /** the Nominal Lead Angle*/
            );
            /**Returns the Swarf Tilt Angle <br> License requirements : None */
            public: double SwarfTiltAngle
            (
            );
            /**Sets the Swarf Tilt Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSwarfTiltAngle
            (
                double swarfTiltAngle /** the Swarf Tilt Angle*/
            );
            /**Returns  the Apply Smoothing  <br> License requirements : None */
            public: bool ApplySmoothing
            (
            );
            /**Sets  the Apply Smoothing  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetApplySmoothing
            (
                bool applySmoothing /**the Apply Smoothing */
            );
            /**Returns  the Ruling Type  <br> License requirements : None */
            public: NXOpen::CAM::ToolAxisVariable::RulingTypes RulingType
            (
            );
            /**Sets  the Ruling Type  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetRulingType
            (
                NXOpen::CAM::ToolAxisVariable::RulingTypes rulingType /**the Ruling Type */
            );
            /**Returns the Zag Rotation Angle <br> License requirements : None */
            public: double ZagRotationAngle
            (
            );
            /**Sets the Zag Rotation Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetZagRotationAngle
            (
                double zagAngle /** the Zag Angle*/
            );
            /**Returns the Zag Lead Angle <br> License requirements : None */
            public: double ZagLeadAngle
            (
            );
            /**Sets the Zag Lead Angle <br> License requirements : cam_base ("CAM BASE") */
            public: void SetZagLeadAngle
            (
                double zagLead /** the Zag Lead*/
            );
            /**Returns the Zag Tilt Angle <br> License requirements : None */
            public: double ZagTiltAngle
            (
            );
            /**Sets the Zag Tilt Angle <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  the Interpolate Angle to Part builder   <br> License requirements : None */
            public: NXOpen::CAM::InterpolateAngle * InterpolateAngleToPart
            (
            );
            /**Returns  the Interpolate Angle to Drive builder   <br> License requirements : None */
