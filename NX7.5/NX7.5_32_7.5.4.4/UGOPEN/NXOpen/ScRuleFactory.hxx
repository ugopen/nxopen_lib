...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  ScRuleFactory
    {
        ...
        /** Creates selection intent rule: @link  FeaturePointsRule   FeaturePointsRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates selection intent rule: @link  RegionBoundaryRule   RegionBoundaryRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates selection intent rule: @link  FaceMergedRibFacesRule   FaceMergedRibFacesRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates selection intent rule: @link  FaceRegionBoundaryRule   FaceRegionBoundaryRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates selection intent rule: @link  FaceAndAdjacentFacesRule   FaceAndAdjacentFacesRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: NXOpen::FaceAndAdjacentFacesRule * CreateRuleFaceAndAdjacentFaces
        (
            NXOpen::Face * seedFace /** Face to create this rule. */
        );
        /** Creates selection intent rule: @link  CurveGroupRule   CurveGroupRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates selection intent rule: @link  BodyDumbRule   BodyDumbRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: NXOpen::BodyDumbRule * CreateRuleBodyDumb
        (
            const std::vector<NXOpen::Body *> & bodies /** Bodies used to create this rule. */
        );
        /** Creates selection intent rule: @link   BodyFeatureRule    BodyFeatureRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates selection intent rule: @link   BodyGroupRule    BodyGroupRule @endlink   @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        ...
        /** Creates selection intent rule: @link  FollowFilletRule   FollowFilletRule @endlink  with stop at intersection option ON  @return   <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: NXOpen::FollowFilletRule * CreateRuleFollowFillet
        (
            const std::vector<NXOpen::Features::Feature *> & features /** Features whose curves are used to create this rule.*/,
            const std::vector<NXOpen::Body *> & bodies /** Bodies whose edges are used to create this rule.*/,
