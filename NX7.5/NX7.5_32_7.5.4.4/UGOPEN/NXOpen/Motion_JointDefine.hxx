    ...
    namespace Motion
    {
        ...
        class NXOPENCPPEXPORT  JointDefine : public TaggedObject
        {
            ...
            /**Returns  the screw ratio.  Used only when joint subtype is 
                @link  Motion::JointDefine::TypeScrew   Motion::JointDefine::TypeScrew @endlink , which is the pitch of a screw's thread  <br> License requirements : mechanisms ("MECHANISMS") */
