...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        ...
        class NXOPENUICPPEXPORT  BlockDialog : public TransientObject
        {
            ...
            public: /** Update callback <br> License requirements : None */
            ...
            public: /** Callback to enable OK and Apply buttons of the dialog. 
                    Return True or False to enable or disable the buttons respectively. <br> License requirements : None */
            typedef NXOpen::Callback0<bool> EnableOKButton;
            public: /**Filter callback  <br> License requirements : None */
            typedef NXOpen::Callback2<int, NXOpen::BlockStyler::UIBlock *, NXOpen::TaggedObject *> Filter;
            public: /** Ok callback <br> License requirements : None */
            typedef NXOpen::Callback0<int> Ok;
            public: /**Apply callback <br> License requirements : None */
            typedef NXOpen::Callback0<int> Apply;
            public: /** Cancel callback  <br> License requirements : None */
            typedef NXOpen::Callback0<int> Cancel;
            public: /** Initialize callback  <br> License requirements : None */
            typedef NXOpen::Callback0<void> Initialize;
            public: /** Dialog Shown callback  <br> License requirements : None */
            ...
            /** Adds Update callback handler to the dialog.  <br> License requirements : None */
            public: void AddUpdateHandler
            (
                const NXOpen::BlockStyler::BlockDialog::Update&  cb /** cb */ 
            );
            /** Adds enable-ok-button callback handler to the dialog.  <br> License requirements : None */
            public: void AddEnableOKButtonHandler
            (
                const NXOpen::BlockStyler::BlockDialog::EnableOKButton&  cb /** cb */ 
            );
            /** Adds Filter callback handler to the dialog.  <br> License requirements : None */
            public: void AddFilterHandler
            (
                const NXOpen::BlockStyler::BlockDialog::Filter&  cb /** cb */ 
            );
            /**Adds Ok callback handler to the dialog.  <br> License requirements : None */
            public: void AddOkHandler
            (
                const NXOpen::BlockStyler::BlockDialog::Ok&  okCb /** ok cb */ 
            );
            /**Adds Apply callback handler to the dialog.  <br> License requirements : None */
            public: void AddApplyHandler
            (
                const NXOpen::BlockStyler::BlockDialog::Apply&  applyCb /** apply cb */ 
            );
            /**Adds Cancel callback handler to the dialog. <br> License requirements : None */
            public: void AddCancelHandler
            (
                const NXOpen::BlockStyler::BlockDialog::Cancel&  cancelCb /** cancel cb */ 
            );
            /** Adds Initialize callback handler to the dialog. The callback function is called while the dialog is being initialized.  The callback is called before applying any user inputs saved in dialog memory. <br> License requirements : None */
            public: void AddInitializeHandler
            (
                const NXOpen::BlockStyler::BlockDialog::Initialize&  cb /** cb */ 
            );
            /** Adds Dialog Shown callback handler to the dialog. The callback function is called before the dialog is shown.  The callback can be used to overwrite changes that are made during dialog initialization when user inputs saved in dialog memory are applied to the dialog. <br> License requirements : None */
            public: void AddDialogShownHandler
            (
                const NXOpen::BlockStyler::BlockDialog::DialogShown&  cb /** cb */ 
            );
            /** Shows the dialog  @return   <br> License requirements : None */
            ...
            public: NXOpen::Selection::Response Show
            (
                NXOpen::BlockStyler::BlockDialog::DialogMode dialogMode /** dialogmode */ 
            );
            /**Returns  a composite block that contains all the blocks in the dialog  <br> License requirements : None */
            public: NXOpen::BlockStyler::CompositeBlock * TopBlock
            (
            );
            /** Performs an Apply and restarts the dialog. This invokes apply callback on the dialog. <br> License requirements : None */
            ...
            /** Adds focus notify callback handler to the dialog.  <br> License requirements : None */
            public: void AddFocusNotifyHandler
            (
                const NXOpen::BlockStyler::BlockDialog::FocusNotify&  cb /** cb */ 
            );
            /** Adds keyboard focus notify callback handler to the dialog.  <br> License requirements : None */
