    ...
    namespace CAE
    {
        namespace FTK
        {
            ...
            class NXOPENCPPEXPORT  OptionSetting
            {
                ...
                /** Get the adding header flag when export to CSV file  @return  If want to add header when export to CSV file  <br> License requirements : nx_ftk ("NX Advanced Graphing") */
                public: bool GetHeaderFlag
                (
                );
                /** Set the adding header flag when export to CSV file  <br> License requirements : nx_ftk ("NX Advanced Graphing") */
