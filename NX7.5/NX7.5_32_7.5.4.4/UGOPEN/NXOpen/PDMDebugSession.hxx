...
namespace NXOpen
{
    ...
    class NXOPENDEBUGSESSIONCPPEXPORT  PDMDebugSession
    {
        ...
        /** Add additional properties for CDM dump  <br> License requirements : None */
        ...
        /** Dumps query information   <br> License requirements : None */
        ...
        /** Performs the structure search depending upon input and dumps the results   <br> License requirements : None */
        ...
        /** Does structure compare between NX and TC  <br> License requirements : None */
