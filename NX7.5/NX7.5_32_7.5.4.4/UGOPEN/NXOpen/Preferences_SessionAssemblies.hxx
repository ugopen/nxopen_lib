...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        class NXOPENCPPEXPORT  SessionAssemblies
        {
            ...
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") NXOpen::NXColor * ProductInterfaceDimColor
            (
            );
            /**Sets  the dim color for product interface display emphasis 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetProductInterfaceDimColor
            (
            ...
            /**Returns  the color for non work part 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") int NonWorkPartColor
            (
            );
            /**Sets  the color for non work part 
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetNonWorkPartColor
            (
