...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        class NXOPENCPPEXPORT  MultipleViewPlacementBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Sets  the placement option  <br> License requirements : None */
            ...
            /**Returns  the view placement block for the first corner  <br> License requirements : nx_drafting_plus ("Drafting Plus") */
            public: NXOpen::Drawings::ViewPlacementBuilder * ViewPlacementFirstCorner
            (
            );
            /**Returns  the view placement block for the second corner  <br> License requirements : nx_drafting_plus ("Drafting Plus") */
