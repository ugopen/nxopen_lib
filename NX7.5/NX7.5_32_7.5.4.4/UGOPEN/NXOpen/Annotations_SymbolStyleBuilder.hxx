...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class NXOPENCPPEXPORT  SymbolStyleBuilder : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the Weld symbol color  <br> License requirements : None */
            public: NXOpen::NXColor * WeldSymbolColor
            (
            );
            /**Sets  the Weld symbol color  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetWeldSymbolColor
            (
                NXOpen::NXColor * weldSymbolColor /** weldsymbolcolor */ 
            );
            /**Returns  the Weld symbol font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont WeldSymbolFont
            (
            );
            /**Sets  the Weld symbol font  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetWeldSymbolFont
            (
                NXOpen::DisplayableObject::ObjectFont weldSymbolFont /** weldsymbolfont */ 
            );
            /**Returns  the Weld symbol width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth WeldSymbolWidth
            (
            );
            /**Sets  the Weld symbol width  <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the surface finish symbol color  <br> License requirements : None */
            public: NXOpen::NXColor * SurfaceFinishColor
            (
            );
            /**Sets  the surface finish symbol color  <br> License requirements : None */
            public: void SetSurfaceFinishColor
            (
                NXOpen::NXColor * surfaceFinishColor /** surfacefinishcolor */ 
            );
            /**Returns  the surface finish symbol font  <br> License requirements : None */
            public: NXOpen::DisplayableObject::ObjectFont SurfaceFinishFont
            (
            );
            /**Sets  the surface finish symbol font  <br> License requirements : None */
            public: void SetSurfaceFinishFont
            (
                NXOpen::DisplayableObject::ObjectFont surfaceFinishFont /** surfacefinishfont */ 
            );
            /**Returns  the surface finish symbol width  <br> License requirements : None */
            public: NXOpen::Annotations::LineWidth SurfaceFinishWidth
            (
            );
            /**Sets  the surface finish symbol width  <br> License requirements : None */
            ...
            /**Returns  the weld space factor  <br> License requirements : None */
            public: double WeldSpaceFactor
            (
            );
            /**Sets  the weld space factor  <br> License requirements : drafting ("DRAFTING") */
