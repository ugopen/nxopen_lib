...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        class NXOPENCPPEXPORT  AddReusableFeatureCollection : public TaggedObjectCollection
        {
            ...
            /** Creates a AddReusableFeature builder  @return  Add Reusable Feature Builder  <br> License requirements : None */
