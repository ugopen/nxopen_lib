    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPPEXPORT  ShellEADBuilder : public Builder
        {
            ...
            /**Returns  the select nodes operator selects nodes to limit thickness to  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::SelectFENodeList * Node
            (
            );
            /**Returns  the zoffset state drives the action upon commit  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ShellEADBuilder::State ZoffsetState
            (
            );
            /**Sets  the zoffset state drives the action upon commit  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetZoffsetState
            (
                NXOpen::CAE::ShellEADBuilder::State zoffsetState /** zoffsetstate */ 
            );
            /**Returns  the zoffset expression of the shell element  <br> License requirements : nx_masterfem ("Finite Element Modeling") */
