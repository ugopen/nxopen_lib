...
namespace NXOpen
{
    ...
    namespace SIM
    {
        ...
        class NXOPENCPPEXPORT  KinematicConfigurator : public NXObject
        {
            ...
            /** Creates a builder for a kinematic junction  @return  The new junction builder  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Creates a builder for a kinematic axis  @return  The new axis builder  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Sets the custom name of the kinematic model  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void SetName
            (
                const NXString & name /** The new kinematic model name */
            );
            /** Adds a new user class name to the list of user classes  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Deletes a user class name from the list of user classes  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Renames a user class name from the list  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Get a list of all user classes  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void GetUserClassifications
            (
                std::vector<NXString> & uClasses /** The list of user classes   */
            );
            /** Adds a new user holding system to the list of holding systems  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Delete a holding system from the list  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Delete all holding systems from the kinematic model  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void DeleteAllHoldingSystems
            (
            );
            /** Renames a holding system from the list  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Get a list of all holding systems  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void GetHoldingSystems
            (
                std::vector<NXString> & holdSys /** The holding systems           */
            );
            /** Adds a new user channel name to the list of channels  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Deletes a channel name from the list of channels  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Deletes all channels from the kinematic model  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void DeleteAllChannels
            (
            );
            /** Renames a channel name from the list  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Get a list of all channels  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Creates a copy of the given component and spins its assigned geometry around a spinning axis.
                        ...
                        The new component has the same parent as the source component.  @return  The new spinning component  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Finds component which are of the given system class  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void FindComponentsBySystemClass
            (
                int sysclass /** The system class to look for. */,
                std::vector<NXOpen::SIM::KinematicComponent *> & comps /** The found components */
            );
            /** Find the junction with the given name  @return  The junction, if found  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Finds a junction by its coordinate system  @return  The junction for the csys  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: NXOpen::SIM::KinematicJunction * FindJunction
            (
                NXOpen::NXObject * csys /** the csys of a junction */
            );
            /** Find the axis with the given name  @return  The axis, if found  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            /** Finds the @link SIM::KinematicComponent SIM::KinematicComponent@endlink  which is the parent of this component  @return  The parent Component. NULL if comp is root component  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: NXOpen::SIM::KinematicComponent * FindParentComponent
            (
                NXOpen::SIM::KinematicComponent * comp /** The component */
            );
            /** Finds the @link SIM::KinematicComponent SIM::KinematicComponent@endlink  which is the owner of this junction  @return  The owning component of the junction  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: NXOpen::SIM::KinematicComponent * FindOwnerOfJunction
            (
                NXOpen::SIM::KinematicJunction * jct /** The junction */
            );
            /** Deletes the entire kinematic model  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void DeleteModel
            (
            );
            /** Deletes the given component  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void DeleteComponent
            (
                NXOpen::SIM::KinematicComponent * comp /** the component to delete */
            );
            /** Deletes the given junction  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void DeleteJunction
            (
                NXOpen::SIM::KinematicJunction * jct /** the component to delete */
            );
            /** Deletes the given axis  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void DeleteAxis
            (
                NXOpen::SIM::KinematicAxis * axis /** the component to delete */
            );
            /** Adds a new root component to the @link SIM::KinematicConfigurator SIM::KinematicConfigurator@endlink  object  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void InsertRootComponent
            (
                NXOpen::SIM::KinematicComponent * newRoot /** The new root component */
            );
            /** Delete a root component from the @link SIM::KinematicConfigurator SIM::KinematicConfigurator@endlink  object  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void DeleteRootComponent
            (
                NXOpen::SIM::KinematicComponent * oldRoot /** The root component to remove */
            );
            /** Gets a list of all junctions in the kinematic  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void GetJunctions
            (
                std::vector<NXOpen::SIM::KinematicJunction *> & junctions /** The list of junctions */
            );
            /** Gets a list of all junction names in the kinematic  <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
