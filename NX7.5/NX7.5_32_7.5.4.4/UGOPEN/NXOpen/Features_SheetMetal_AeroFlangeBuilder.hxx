...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            class NXOPENCPPEXPORT  AeroFlangeBuilder : public Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                (
                    const NXString & angleExpression /** value of angle expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                ...
                (
                    ...
                    const NXString & valueExpression /** value of length expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                /** Get the type of length and the length expression. 
                             @return  length expression  <br> License requirements : aero_sheet_metal ("Aerospace Sheet Metal") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                ...
                /** Get flip direction. 
                             @return  flip_flag =\> false = do not flip, true = flip  <br> License requirements : aero_sheet_metal ("Aerospace Sheet Metal") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                ...
                (
                    ...
                    const NXString & valueExpression /** value of compensation expression   <br>  NOTE: The full Unicode character set is not supported for this parameter.  <br> */
                );
                /** Get end compensation.
                             @return  compensation expression  <br> License requirements : aero_sheet_metal ("Aerospace Sheet Metal") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                ...
                /** Get the end plane 
                             @return  smart plane entity  <br> License requirements : aero_sheet_metal ("Aerospace Sheet Metal") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                ...
                /** Get the flag that turns on/off the visibility of Contour Curve 
                             @return  false = Hide contour curve, true = Show contour curve  <br> License requirements : aero_sheet_metal ("Aerospace Sheet Metal") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                ...
                /** Get the material type of the flange 
                             @return  material inside/material outside/bend outside  <br> License requirements : aero_sheet_metal ("Aerospace Sheet Metal") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                ...
                /** Get the length dimension type of the flange 
                             @return  inside/outside  <br> License requirements : aero_sheet_metal ("Aerospace Sheet Metal") OR adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
