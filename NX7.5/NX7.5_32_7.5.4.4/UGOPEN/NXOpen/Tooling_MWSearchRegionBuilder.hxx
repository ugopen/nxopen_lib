...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** The Search Region builder is for defining a region by searching the region faces given a set of seed faces and boundary edges.  <br> To create a new instance of this class, use @link Tooling::MWSearchRegionCollection::CreateBuilder Tooling::MWSearchRegionCollection::CreateBuilder@endlink  <br> 
        Default values.
        <table border="1"> 
        ...
        */
        class NXOPENCPPEXPORT  MWSearchRegionBuilder : public Builder
        {
            ...
            /**Returns  the select boundary faces  <br> License requirements : None */
            ...
            /**Returns  the translucency as boundary faces toggle  <br> License requirements : None */
            public: bool TranslucencyAsBoundaryFacesToggle
            (
            );
            /**Sets  the translucency as boundary faces toggle  <br> License requirements : None */
            public: void SetTranslucencyAsBoundaryFacesToggle
            (
                bool translucencyAsBoundaryFacesToggle /** translucencyasboundaryfacestoggle */ 
            );
            /**Returns  the option to use different colors as boundary faces  <br> License requirements : None */
            public: bool DifferentColorsAsBoundaryFacesOption
            (
            );
            /**Sets  the option to use different colors as boundary faces  <br> License requirements : None */
            ...
            /**Returns  the maximum number of faces to be searched  <br> License requirements : None */
            public: int MaximumNumberOfFacesSearched
            (
            );
            /**Sets  the maximum number of faces to be searched  <br> License requirements : None */
            public: void SetMaximumNumberOfFacesSearched
            (
                int maximumNumberOfFacesSearched /** maximumnumberoffacessearched */ 
            );
            /**Returns  the color to be applied to the selected boundary faces  <br> License requirements : None */
            public: NXOpen::NXColor * BoundaryFacesColor
            (
            );
            /**Sets  the color to be applied to the selected boundary faces  <br> License requirements : None */
            public: void SetBoundaryFacesColor
            (
                NXOpen::NXColor * boundaryFacesColor /** boundaryfacescolor */ 
            );
            /** Change the color of the selected boundary using the specified color  <br> License requirements : None */
            public: void ChangeBoundaryFacesColor
            (
            );
            /** Initialize the data for the Search Region builder  <br> License requirements : None */
            ...
            /** Turn off all parting lines  <br> License requirements : None */
            public: void TurnOffAllPartingLines
            (
            );
            /** Update the region with the new region faces and seed faces  <br> License requirements : None */
