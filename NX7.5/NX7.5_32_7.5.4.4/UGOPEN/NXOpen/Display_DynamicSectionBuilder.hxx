    ...
    namespace Display
    {
        ...
        /** Represents a Dynamic Section Builder used for creating sections. 
                ...
                <b>Assembly and Modeling Operations</b>
                 ...
                 <br> 
                <ul>
                    <li>Create section curves by intersecting active section plane  
                        with all objects in the scene</li>
        ...
        */
        class NXOPENCPPEXPORT  DynamicSectionBuilder : public Builder
        {
            ...
            /** Creates a datum plane from the active section plane.  @return  Datum plane  <br> License requirements : None */
            ...
            /**Returns  the cap color option  <br> License requirements : None */
            public: NXOpen::Display::DynamicSectionTypes::CapColorOption CapColorOption
            (
            );
            /**Sets  the cap color option  <br> License requirements : None */
            public: void SetCapColorOption
            (
                NXOpen::Display::DynamicSectionTypes::CapColorOption capColorOption /** capcoloroption */ 
            );
            /**Returns  the cap on off flag  <br> License requirements : None */
            public: bool ShowCap
            (
            );
            /**Sets  the cap on off flag  <br> License requirements : None */
            public: void SetShowCap
            (
                bool showCap /** showcap */ 
            );
            /**Returns  the clip on off flag  <br> License requirements : None */
            public: bool ShowClip
            (
            );
            /**Sets  the clip on off flag  <br> License requirements : None */
            public: void SetShowClip
            (
                bool showClip /** showclip */ 
            );
            /**Returns  the clip type  <br> License requirements : None */
            public: NXOpen::Display::DynamicSectionTypes::Clip ClipType
            (
            );
            /**Sets  the clip type  <br> License requirements : None */
            ...
            /**Returns  the curve on off flag.
                         ...
                         <br> 
                        This method has been deprecated. To query/modify the dynamic 
                        section object visibility in a modeling view, see following APIs:
                        
                        @link ModelingView::IsDynamicSectionVisible ModelingView::IsDynamicSectionVisible@endlink 
                        @link ModelingView::SetDynamicSectionVisible ModelingView::SetDynamicSectionVisible@endlink 
             ...
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") bool ShowCurves
            (
            );
            /**Sets  the curve on off flag.
             ...
             @deprecated Deprecated in NX6.0.0 <br> 
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetShowCurves
            (
                bool showCurves /** showcurves */ 
            );
            /** Creates a grid settings builder from the active section plane.  @return   <br> License requirements : None */
            public: NXOpen::Display::PlaneGridBuilder * GetGridSettings
            (
            );
            /**Returns  the interference color.  <br> License requirements : None */
            public: NXOpen::NXColor * InterferenceColor
            (
            );
            /**Sets  the interference color.  <br> License requirements : None */
            ...
            /** Sets the section name. 
                      ...
                      @return  If specified name was modified to 
                                                         ensure uniqueness  <br> License requirements : None */
            public: bool SetName
            (
                const NXString & sectionName /** Section name */
            );
            /**Returns  the number of requested section planes in the current section series.  <br> License requirements : None */
            public: int NumberInSeries
            (
            );
            /**Sets  the number of requested section planes in the current section series.  <br> License requirements : None */
            public: void SetNumberInSeries
            (
                int numberSectionsRequested /** Number of section requested (\>= 1). */
            );
            /**Returns  the section plane spacing in the current section series.  <br> License requirements : None */
            public: double SeriesSpacing
            (
            );
            /**Sets  the section plane spacing in the current section series.  <br> License requirements : None */
            public: void SetSeriesSpacing
            (
                double sectionSpacing /** Distance between sections (\>= 0.02). */
            );
            /**Returns  the interference on off flag.  <br> License requirements : None */
            public: bool ShowInterference
            (
            );
            /**Sets  the interference on off flag.  <br> License requirements : None */
            ...
            /** Gets the normal of the section plane  @return  Section plane normal  <br> License requirements : None */
            ...
            /** Gets the the plane offset.  @return   <br> License requirements : None */
            ...
            /** Gets the section origin.  @return  Section origin  <br> License requirements : None */
            ...
            /**Returns  the reverse series flag  <br> License requirements : None */
            public: bool ReverseSeries
            (
            );
            /**Sets  the reverse series flag  <br> License requirements : None */
            public: void SetReverseSeries
            (
                bool reverseSeries /** reverseseries */ 
            );
            /** Gets rotation angle for specified axis.  @return  Rotation angle in degrees  <br> License requirements : None */
            ...
            /** Gets the section rotation matrix  @return  Rotation matrix  <br> License requirements : None */
            ...
            /**Sets  the section type  <br> License requirements : None */
            public: void SetType
            (
            ...
            /**Returns  the show grid display flag  <br> License requirements : None */
            public: bool ShowGrid
            (
            );
            /**Sets  the show grid display flag  <br> License requirements : None */
            public: void SetShowGrid
            (
                bool showGrid /** showgrid */ 
            );
            /**Returns  the 2D viewer display flag  <br> License requirements : None */
            public: bool ShowViewer
            (
            );
            /**Sets  the 2D viewer display flag  <br> License requirements : None */
            ...
            /** Loads all components that intersect the current section plane. Errors
                      ...
                      @return  New component loaded flag  <br> License requirements : adv_assemblies ("ADVANCED ASSEMBLIES") */
            ...
            /** Restores the section to the saved section in the view database.  <br> License requirements : None */
            ...
            /** Creates curves by intersecting section plane with all visible bodies
                        in the scene and them to the group created with the specified name.
                        The group is displayed in the part navigator. If the customer default 
                        "Load Solids/Sheets when Saving Section Curves" is enabled, the Save 
                        Copy of Section Curves command in the view section dialog will cause 
                        solid/sheet bodies to be loaded into memory for any visible lightweight 
                        bodies on the section plane. This may increase the time and memory used 
                        by the operation, but will ensure fully accurate section curves.
                      <br> License requirements : None */
