...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        class NXOPENCPPEXPORT  StepoverBuilder : public TaggedObject
        {
            /** stepover options */
            ...
            /**Returns  the distance (inheritable tool dependent)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * DistanceBuilder
            (
            );
            /**Returns  the distance (inheritable double)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * InheritableDistance
            (
            );
            /**Returns  the distance maximum(inheritable tool dependent)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * DistanceMaximumBuilder
            (
            );
            /**Returns  the distance minimum(inheritable tool dependent)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * DistanceMinimumBuilder
            (
            );
            /**Returns  the scallop height  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * ScallopBuilder
            (
            );
            /**Returns  the vertical limit (inheritable tool dependent)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * VerticalLimitBuilder
            (
            );
            /**Returns  the horizontal limit (inheritable tool dependent)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * HorizontalLimitBuilder
            (
            );
            /**Returns  the percent tool flat  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * PercentToolFlatBuilder
            (
            );
            /**Returns  the multiple builder  <br> License requirements : None */
            public: NXOpen::CAM::MultipleStepoverBuilder * MultipleBuilder
            (
            );
            /**Returns  the number of additional passes  <br> License requirements : None */
            public: int AdditionalPasses
            (
            );
            /**Sets  the number of additional passes  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetAdditionalPasses
            (
                int newValue /** the number of additional passes */
            );
            /**Returns  the number of stepovers  <br> License requirements : None */
            public: int NumberOfStepovers
            (
            );
            /**Sets  the number of stepovers  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNumberOfStepovers
            (
                int newValue /** the number of stepovers */
            );
            /**Returns  the number of stepovers at first direction <br> License requirements : None */
            public: int NumberAtFirstDirection
            (
            );
            /**Sets  the number of stepovers at first direction <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNumberAtFirstDirection
            (
                int newValue /** the number of stepovers */
            );
            /**Returns  the number of stepovers at second direction <br> License requirements : None */
            public: int NumberAtSecondDirection
            (
            );
            /**Sets  the number of stepovers at second direction <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNumberAtSecondDirection
            (
                int newValue /** the number of stepovers */
            );
            /**Returns  the maximum builder  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * MaximumBuilder
            (
            );
            /**Returns  the angular  <br> License requirements : None */
            public: double Angular
            (
            );
            /**Sets  the angular  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetAngular
            (
                double angular /** the angular */
            );
            /**Returns  the variable maximum builder  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * VariableMaximumBuilder
            (
            );
            /**Returns  the variable minimum builder  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * VariableMinimumBuilder
            (
            );
            /**Returns  the variable maximum only builder  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * VariableMaximumOnlyBuilder
            (
            );
            /**Returns  the variable average maximum value  <br> License requirements : None */
            public: double MaximumAverage
            (
            );
            /**Sets  the variable average maximum value  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMaximumAverage
            (
                double maxAverage /** the variable average maximum value */
            );
            /**Returns  the variable average minimum value  <br> License requirements : None */
            public: double MinimumAverage
            (
            );
            /**Sets  the variable average minimum value  <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMinimumAverage
            (
                double minAverage /** the variable average minimum value */
            );
            /**Returns  the variable average maximum builder  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * MaximumAverageBuilder
            (
            );
            /**Returns  the variable average minimum builder  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * MinimumAverageBuilder
            (
            );
            /**Returns  the variable average maximum only builder  <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * MaximumAverageOnlyBuilder
            (
            );
            /**Returns  the percent of remaining  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * PercentOfRemainingBuilder
            (
            );
            /**Returns  the maximum percent of remaining  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * MaximumPercentBuilder
            (
            );
            /**Returns  the minimum percent of remaining  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * MinimumPercentBuilder
            (
            );
            /**Returns  the % wire (inheritable tool dependent)  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * PercentWireBuilder
            (
            );
            /**Returns  the stock per pass  <br> License requirements : None */
            public: NXOpen::CAM::StockPerPassBuilder * StockPerPassBuilder
            (
            );
            /**Returns  the percent thread length  <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * PercentThreadLength
            (
            );
            /**Returns  the apply on part option  <br> License requirements : None */
            public: NXOpen::CAM::StepoverBuilder::ApplyTypes ApplyOn
            (
            );
            /**Sets  the apply on part option  <br> License requirements : cam_base ("CAM BASE") */
