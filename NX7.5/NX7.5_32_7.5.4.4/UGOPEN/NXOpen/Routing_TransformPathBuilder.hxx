    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPPEXPORT  TransformPathBuilder : public Builder
        {
            ...
            /**Returns  the path selection.  Stores the objects to be transformed or copied.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /**Returns  the motion or transform.  The transformation to apply to the selected or
                        copied objects.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            public: NXOpen::GeometricUtilities::ModlMotion * Transform
            (
            );
            /**Returns  the operation to perform during the commit method.   <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /**Returns  the number of copies to create in the commit method for the option
                        @link Routing::TransformPathBuilder::TransformOptionCopyOriginal Routing::TransformPathBuilder::TransformOptionCopyOriginal@endlink .  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
            ...
            /**Returns  the flag that indicates whether or not to check for duplicate objects after
                        the copy or transform.  <br> License requirements : routing_combined ("Routing Combined") OR routing_electrical ("Routing Electrical") OR routing_mechanical ("Routing Mechanical") */
