#ifndef NXOpen_CAE_SELECTFEELEMENTLIST_HXX_INCLUDED
#define NXOpen_CAE_SELECTFEELEMENTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     CAE_SelectFEElementList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SelectFEElementListBuilder;
        class SelectFEElementListImpl;
        /** Represents a list of objects on a selection list.
        */
        class NXOPENCPPEXPORT  SelectFEElementList : public TaggedObject, public virtual GeometricUtilities::IComponentBuilder
        {
            private: SelectFEElementListImpl * m_selectfeelementlist_impl;
            private: friend class  _SelectFEElementListBuilder;
            protected: SelectFEElementList();
            public: ~SelectFEElementList();
            ...
            public: bool Add
            (
                NXOpen::CAE::FEElement * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAE::FEElement *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::CAE::FEElement * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::CAE::FEElement * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if succesully removed from list;
            ...
            (
                ...
                NXOpen::CAE::FEElement * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::CAE::FEElement * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::CAE::FEElement *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAE::FEElement * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAE::FEElement *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list  <br> License requirements : None */
            public: std::vector<NXOpen::CAE::FEElement *> GetArray
            (
            );
