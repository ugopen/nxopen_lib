...
namespace NXOpen
{
    ...
    class NXOPENCPPEXPORT  InferredConstraintsBuilder : public Builder
    {
        ...
        public:  NX_DEPRECATED("Deprecated in NX6.0.0") bool ExternalReference
        (
        );
        /**Sets  the reference outside work part setting. If this constraint flag is switched ON, sketcher
         ...
         @deprecated Deprecated in NX6.0.0 <br> 
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX6.0.0") void SetExternalReference
        (
            bool externalReference /** externalreference */ 
        );
        /** Get the auto dimensioning rule list into an array @return   <br> License requirements : None */
        public: std::vector<NXOpen::Sketch::AutoDimensioningRule> GetRules
        (
        );
        /** Set the auto dimensioning rule list to builder <br> License requirements : None */
