...
--------------
    ...
    1. EditExpression.cpp
    2. EditExpression.hpp
    3. EditExpression.dlx 
    4. FeatureSeed.dlx
    5. EditExpression.prt.
    
        Above dlx file(s) must be placed in one of the following locations:
...
----------------------
    ...
    3. Launch the dialog by invoking the EditExpression shared library through the
        File->Execute->NX Open... menu command. 

    4. Select a feature. The selected feature will be listed in the List Box. (You can add more 
    ...
    5. Select the feature for which you want to edit an expression and click on the button “Get Expressions”
