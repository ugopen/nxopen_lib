...
**************************************************************************/
extern UFUNEXPORT int UF_SF_validate_meshes
                      (
                      tag_p_t                           mesh_ents_p,
                      int                               num_mesh_ents,
...
extern UFUNEXPORT void UF_SF_init_mshvld_error_container
                       (
...
extern UFUNEXPORT void UF_SF_clean_mshvld_error_container
                       (
                       UF_SF_mesh_error_container_p_t container
                       );
