...
The following functions have been retired and replaced with newer NX Open classes and methods:
    ...
    UF_ROUTE_is_port_fixture_port              Use the FixturePort class type to determine if this is a Terminal Port.
...
#define UF_ROUTE_err_max                                      ERROR_ROUTE_base + 223
...
#define UF_ROUTE_DR_REASON_EDIT_PLACE_PART      33
...
#define UF_ROUTE_CB_REASON_EDIT_REPLACE_PART      27
#define UF_ROUTE_CB_REASON_ATTR_DISCREPANCY       28
#define UF_ROUTE_CB_REASON_ATTRIBUTE_COPY_REPLACE_PART   29
...
** If the uf_retiring.h header has not already defined these structures, we need to define
