...
#define    UF_machining_path_data_subtype              1  /* Path Data */
...
#define    UF_machining_mach_sim_kim_ipw_grid_subtype 27  /* Compressed IPW grid that is stored with the KIM and used in ISV */
