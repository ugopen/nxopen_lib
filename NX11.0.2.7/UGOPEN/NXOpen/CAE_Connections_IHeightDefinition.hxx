#ifndef NXOpen_CAE_CONNECTIONS_IHEIGHTDEFINITION_HXX_INCLUDED
#define NXOpen_CAE_CONNECTIONS_IHEIGHTDEFINITION_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     CAE_Connections_IHeightDefinition.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Connections
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  IHeightDefinition : public virtual NXOpen::INXObject
            {
                public: virtual ~IHeightDefinition() {}
