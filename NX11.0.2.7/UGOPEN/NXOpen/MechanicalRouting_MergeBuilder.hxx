#ifndef NXOpen_MECHANICALROUTING_MERGEBUILDER_HXX_INCLUDED
#define NXOpen_MECHANICALROUTING_MERGEBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     MechanicalRouting_MergeBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
#include <NXOpen/MechanicalRouting_MergeBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace MechanicalRouting
    {
        ...
        /** the Builder to Merge Component  <br> To create a new instance of this class, use @link NXOpen::MechanicalRouting::BuilderFactory::CreateMergeBuilder  NXOpen::MechanicalRouting::BuilderFactory::CreateMergeBuilder @endlink  <br> 
         <br>  Created in NX11.0.1.  <br>  
        */
        class NXOPENCPP_MECHANICALROUTINGEXPORT  MergeBuilder : public NXOpen::Builder
        {
