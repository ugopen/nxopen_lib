    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  EdgePrepValuesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the indication that the modifications will be applied to a Manged Attribute Group, not the feature 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: bool EditingManagedAttributeGroup
            (
            );
            /**Sets  the indication that the modifications will be applied to a Manged Attribute Group, not the feature 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : structure_weld ("STRUCTURE WELD") */
