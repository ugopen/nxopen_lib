        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewStyleGeneralBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Sets  the snapshot toggle on the GENERAL tab of the View Style Dialog 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::ViewStyleGeneralBuilder::LockmethodView() instead(the value is NXOpen.Preferences.GeneralViewPreferences.GeneralViewLockmethodOptionSnapshot).") void SetSnapshotView
            (
            ...
            (
                NXOpen::Preferences::GeneralViewLockmethodOption lockMethodView /** Sets a lockmethod view option on the general sub-builder */
            );
            ...
            /**Returns  the angle value on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::Drawings::ViewStyleGeneralBuilder::SetAngleSetting NXOpen::Drawings::ViewStyleGeneralBuilder::SetAngleSetting@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Drawings::ViewStyleGeneralBuilder::SetAngleSetting instead.") double AngleValue
            (
            );
            /**Sets  the angle value on the GENERAL tab of the View Style Dialog 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Drawings::ViewStyleGeneralBuilder::SetAngleSetting instead.") void SetAngleValue
            (
