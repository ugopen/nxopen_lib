        ...
        */
        class NXOPENCPP_MECHANICALROUTINGEXPORT  PathStockPreferenceBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /** Determines how to choose which stock to assign. 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::MechanicalRouting::PathStockPreferenceBuilder::StockMethods NXOpen::MechanicalRouting::PathStockPreferenceBuilder::StockMethods@endlink  instead. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::MechanicalRouting::PathStockPreferenceBuilder::StockMethods instead.")  AssignMethod
            {
            ...
            /** Sets the identifier of the classification object associated with the part to place 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::MechanicalRouting::PathStockPreferenceBuilder::SetSetClassificationObjectIdentifierForStock NXOpen::MechanicalRouting::PathStockPreferenceBuilder::SetSetClassificationObjectIdentifierForStock@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public:  NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::MechanicalRouting::PathStockPreferenceBuilder::SetSetClassificationObjectIdentifierForStock instead.") void SetClassificationObjectIdentifier
            (
