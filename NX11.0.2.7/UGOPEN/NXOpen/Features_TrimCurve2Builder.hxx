...
#include <NXOpen/Features_TrimCurve2Builder.hxx>
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  TrimCurve2Builder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Creates an @link NXOpen::GeometricUtilities::TrimCurveBoundingObjectBuilder NXOpen::GeometricUtilities::TrimCurveBoundingObjectBuilder@endlink  object.  @return  
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
