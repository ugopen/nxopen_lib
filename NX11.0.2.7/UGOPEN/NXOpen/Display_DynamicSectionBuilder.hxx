        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  DynamicSectionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the coordinate system used for creating section plane along
                        ...
                        @link NXOpen::Display::DynamicSectionBuilder::DefaultPlaneAxis NXOpen::Display::DynamicSectionBuilder::DefaultPlaneAxis @endlink and @link NXOpen::Display::DynamicSectionBuilder::SetDefaultPlaneAxis NXOpen::Display::DynamicSectionBuilder::SetDefaultPlaneAxis @endlink 
            ...
            /**Returns  the axis indicating the default plane normal. 
                        @link Display::DynamicSectionTypes::Axis::None Display::DynamicSectionTypes::Axis::None@endlink  is 
                        invalid. For example; specify 
                        @link Display::DynamicSectionTypes::Axis::Z Display::DynamicSectionTypes::Axis::Z@endlink  to use 
                        XY plane as the default plane.
                        Specifying the default plane has no effect on the current 
                        section geometry.
                         <br> 
                        This is used in conjunction with
                        @link NXOpen::Display::DynamicSectionBuilder::CsysType NXOpen::Display::DynamicSectionBuilder::CsysType @endlink and @link NXOpen::Display::DynamicSectionBuilder::SetCsysType NXOpen::Display::DynamicSectionBuilder::SetCsysType @endlink 
                        to determine default plane constructed by following methods.
                        @link NXOpen::Display::DynamicSectionBuilder::SetDefaultPlane NXOpen::Display::DynamicSectionBuilder::SetDefaultPlane@endlink 
                        @link NXOpen::Display::DynamicSectionBuilder::SetDefaults NXOpen::Display::DynamicSectionBuilder::SetDefaults@endlink 
                         <br> 
            ...
            /** Gets geometry for all planes of the section.
                         <br> 
                        Numnber of planes depends on @link NXOpen::Display::DynamicSectionBuilder::Type NXOpen::Display::DynamicSectionBuilder::Type @endlink and @link NXOpen::Display::DynamicSectionBuilder::SetType NXOpen::Display::DynamicSectionBuilder::SetType @endlink . 
            ...
            /** Gets geometry of specified plane of the section.
                        ...
                        @link NXOpen::Display::DynamicSectionBuilder::Type NXOpen::Display::DynamicSectionBuilder::Type @endlink and @link NXOpen::Display::DynamicSectionBuilder::SetType NXOpen::Display::DynamicSectionBuilder::SetType @endlink . 
