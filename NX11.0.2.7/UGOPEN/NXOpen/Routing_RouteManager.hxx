...
#include <NXOpen/Routing_PathArrangementBuilder.hxx>
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RouteManager
        {
            ...
            /** Creates a @link Routing::PathArrangementBuilder Routing::PathArrangementBuilder@endlink   @return  
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::PathArrangementBuilder * CreatePathArrangementBuilder
            (
            );
