        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  GeneralViewStyle: public virtual NXOpen::Preferences::IGeneralViewPreferences
        {
            ...
            /**Sets  the snapshot toggle on the GENERAL tab of the View Style Dialog 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::GeneralViewStyle::LockmethodView instead.") void SetSnapshotView
            (
            ...
            (
                NXOpen::Preferences::GeneralViewLockmethodOption lockmethodView /** Sets a lockmethod view enum value on the general sub-builder */
            );
