        ...
        namespace ModelCheck
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  QualityTestValue : public NXOpen::NXObject, public virtual NXOpen::CAE::ModelCheck::ITestValue
            {
                ...
                /** Returns @link NXOpen::CAE::ModelCheck::ElementSpecificTestValue NXOpen::CAE::ModelCheck::ElementSpecificTestValue@endlink  of specified index in this test setting  @return  
                 <br>  Created in NX8.5.0.  <br>  
                 <br> License requirements : None */
