        ...
        class NXOPENCPP_WELDEXPORT  JointmarkBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**
                    Find the connected face information. 
                     <br> 
                    The data structure will be allocated and should be subsequently disposed of by
                    calling @link NXOpen::TransientObject::Dispose NXOpen::TransientObject::Dispose@endlink .
                     <br> 
                     <br> 
