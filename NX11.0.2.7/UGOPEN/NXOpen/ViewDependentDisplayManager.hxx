    ...
    class NXOPENCPPEXPORT  ViewDependentDisplayManager
    {
        ...
        */
        ...
        /** Removes erasures from specified objects in a view. 
         <br>  @deprecated Deprecated in NX11.0.0.  Use @link JA_VIEW_DEPENDENT_DISPLAY_remove_erasure_on_object_and_subobjects JA_VIEW_DEPENDENT_DISPLAY_remove_erasure_on_object_and_subobjects@endlink  instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public:  NX_DEPRECATED("Deprecated in NX11.0.0.  Use JA_VIEW_DEPENDENT_DISPLAY_remove_erasure_on_object_and_subobjects instead.") void RemoveErasure
        (
            const std::vector<NXOpen::DisplayableObject *> & objects /** objects */ 
        );
