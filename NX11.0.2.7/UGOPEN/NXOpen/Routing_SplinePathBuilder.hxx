        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  SplinePathBuilder : public NXOpen::Builder
        {
            ...
            /** Sets the splines method to points or poles. 
             <br>  @deprecated Deprecated in NX11.0.2.  Splines are always created by points. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public:  NX_DEPRECATED("Deprecated in NX11.0.2.  Splines are always created by points.") void SetSplineMethod
            (
            ...
            (
                ...
                NXOpen::Expression * forwardExtensionExpression /** Length of the forward extension. */,
                NXOpen::Expression * backwardExtensionExpression /** Length of the backward extension.*/
            );
            ...
            (
                ...
                NXOpen::Expression ** forwardExtensionExpression /** Forward Extension Length. */,
                NXOpen::Expression ** backwardExtensionExpression /** Backward Extension Length. */,
