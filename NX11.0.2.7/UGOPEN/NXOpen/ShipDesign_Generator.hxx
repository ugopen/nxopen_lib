    ...
    namespace ShipDesign
    {
        ...
        */
        class NXOPENCPP_SHIPDESIGNEXPORT  Generator
        {
            ...
            typedef NXOpen::Callback0<int> EnterApplication;
            public: /** Defines the callback function whenever an NX application is exited. 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            typedef NXOpen::Callback0<int> ExitApplication;
            ...
            /** Gets the tolerance of a cae body and underlying cad body.  @return  O: tolerance between cae body and underlying cad body 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
            public: double CaeBodyGetTolerance
            (
                NXOpen::CAE::CAEBody * caeBody /** cae body */ 
            );
            /** Gets the underlying ugfaces of a CAE face.  @return  
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
            public: std::vector<NXOpen::Face *> CaeFaceGetUgfaces
            (
                NXOpen::CAE::CAEFace * caeFace /** cae face */ 
            );
            /** Get the outline sheet body of input bodies. 
                    the default value of tolerence should be 1.0 @return  O: output outline sheet body 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
            ...
            (
                ...
                const NXOpen::ShipDesign::Generator::EnterApplication&  enterCallback /** The method called when entering the application */,
                const NXOpen::ShipDesign::Generator::ExitApplication&  exitCallback /** The method called when exiting the application */
            );
            /** Register application callback when application is entered or exited. 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
