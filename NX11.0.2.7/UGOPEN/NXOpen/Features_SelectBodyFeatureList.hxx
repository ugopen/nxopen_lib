#ifndef NXOpen_FEATURES_SELECTBODYFEATURELIST_HXX_INCLUDED
#define NXOpen_FEATURES_SELECTBODYFEATURELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
//  Header for C++ interface to JA API
//--------------------------------------------------------------------------
//
//  Source File:
//     Features_SelectBodyFeatureList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        class _SelectBodyFeatureListBuilder;
        class SelectBodyFeatureListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SelectBodyFeatureList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectBodyFeatureListImpl * m_selectbodyfeaturelist_impl;
            private: friend class  _SelectBodyFeatureListBuilder;
            protected: SelectBodyFeatureList();
            public: ~SelectBodyFeatureList();
            ...
            public: bool Add
            (
                NXOpen::Features::BodyFeature * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Features::BodyFeature *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Features::BodyFeature * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Features::BodyFeature * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if succesully removed from list;
            ...
            (
                ...
                NXOpen::Features::BodyFeature * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Features::BodyFeature * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Features::BodyFeature *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Features::BodyFeature * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Features::BodyFeature *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Features::BodyFeature *> GetArray
            (
            );
