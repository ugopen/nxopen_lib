...
namespace NXOpen
{
    ...
    /** Sc Collector  <br> To create a new instance of this class, use @link NXOpen::ScCollectorCollection::CreateCollector  NXOpen::ScCollectorCollection::CreateCollector @endlink  <br> 
    ...
    */
    class NXOPENCPPEXPORT  ScCollector : public NXOpen::DisplayableObject
    {
        ...
        /** Checks whether the evaluation filter is present on ScCollector  @return  
         <br>  Created in NX11.0.0.  <br>  
         <br> License requirements : None */
