        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewCreationWizardBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the snapshot option 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::Drawings::ViewCreationWizardBuilder::get_LockMethod NXOpen::Drawings::ViewCreationWizardBuilder::get_LockMethod@endlink  instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::ViewCreationWizardBuilder::get_LockMethod instead.") bool SnapShot
            (
            );
            /**Sets  the snapshot option 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::Drawings::ViewCreationWizardBuilder::set_LockMethod NXOpen::Drawings::ViewCreationWizardBuilder::set_LockMethod@endlink  instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::ViewCreationWizardBuilder::set_LockMethod instead.") void SetSnapShot
            (
                bool snapShot /** snapshot */ 
            );
            /**Returns  the lockmethod option 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Preferences::GeneralViewLockmethodOption LockMethod
            (
            );
            /**Sets  the lockmethod option 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
