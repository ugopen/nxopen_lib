        ...
        class NXOPENCPP_CAMEXPORT  MachinePocketGroupBuilder : public NXOpen::CAM::NCGroupBuilder
        {
            ...
            */
            ...
            /**Sets  the adjust register type 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAM::MachinePocketGroupBuilder::SetAdjustIdBuilder CAM::MachinePocketGroupBuilder::SetAdjustIdBuilder@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::MachinePocketGroupBuilder::SetAdjustIdBuilder instead.") void SetAdjustRegisterType
            (
            ...
            /**Sets  the cutcom register type 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAM::MachinePocketGroupBuilder::SetCutcomIdBuilder CAM::MachinePocketGroupBuilder::SetCutcomIdBuilder@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public:  NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::MachinePocketGroupBuilder::SetCutcomIdBuilder instead.") void SetCutcomRegisterType
            (
                NXOpen::CAM::MachinePocketGroupBuilder::RegisterType type /** type */ 
            );
