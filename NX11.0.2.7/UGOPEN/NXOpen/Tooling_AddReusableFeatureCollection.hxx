...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a collection of AddReusableFeature  <br> To obtain an instance of this class, refer to @link NXOpen::Tooling::ToolingManager  NXOpen::Tooling::ToolingManager @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  AddReusableFeatureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            class iterator : public std::iterator<std::forward_iterator_tag, NXOpen::Tooling::AddReusableFeatureBuilder *>
            {
            public:
                /** Default constructor */
