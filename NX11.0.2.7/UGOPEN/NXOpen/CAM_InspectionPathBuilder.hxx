    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  InspectionPathBuilder : public NXOpen::CAM::OperationBuilder
        {
            ...
            (
                NXOpen::NXObject * boundingBox /** Block or Bounding Body */
            );
            ...
            /** Get the reference feature mode  @return  
            ...
            /** Get the reference feature point count  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Get the reference feature offset distance  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Get the reference feature zone radius  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Generate the reference feature  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: int GenerateReferenceFeature
            (
            );
            /** Remove the reference feature  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
