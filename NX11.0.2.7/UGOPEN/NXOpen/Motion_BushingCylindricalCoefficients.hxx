...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  BushingCylindricalCoefficients : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the stiffness coefficients, it is used in @link Motion::BushingBuilder::BushingTypesCylindrical Motion::BushingBuilder::BushingTypesCylindrical@endlink  case 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::BushingCylindricalCoefficientsComponent * StiffnessCoefficients
            (
            );
            /**Returns  the damping coefficients, it is used in @link Motion::BushingBuilder::BushingTypesCylindrical Motion::BushingBuilder::BushingTypesCylindrical@endlink  case 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
