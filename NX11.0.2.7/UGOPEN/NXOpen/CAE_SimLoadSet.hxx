...
#include <NXOpen/CAE_SimLoadSet.hxx>
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimLoadSet : public NXOpen::CAE::NamedPropertyTable, public virtual NXOpen::CAE::IExportableFEEntity
        {
            ...
            public: enum Type
            {
                ...
                TypeAcoustic/** Acoustic Source Load Set. */,
                TypeTemperature/** Temperature Set. */,
                TypeBolt/** Bolt Load Set. */,
                TypeInitialStressStrain/** Initial Stress/Strain Load Set */
            };
            ...
            /** Get the load set memeber from load set  @return  member load set
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Remove load memebers from load set 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Get all load memebers from load set 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
