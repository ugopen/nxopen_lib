...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  BodyCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        /** Creates a SurfaceUVDirectionBuilder  @return  
        ...
        /** Creates a @link FlatteningBuilder FlatteningBuilder@endlink .  @return  FlatteningBuilder object 
         ...
         <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
        public:  NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Features::FlatteningAndFormingBuilder instead.") NXOpen::FlatteningBuilder * CreateFlatteningBuilder
        (
        );
