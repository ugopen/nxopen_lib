    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  Operation : public NXOpen::CAM::CAMObject
        {
            ...
            /** Get the in process feature type  @return  
            ...
            /** Get the other instances of the operation @return  
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /** Get the divided operations from tool path divide of this operation @return  
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
