    ...
    */
    class NXOPENCPPEXPORT  Sketch : public NXOpen::DisplayableObject, public virtual NXOpen::IProfile
    {
        ...
        /** Indicates the visibility of the constraints 
                ...
                The @link NXOpen::Sketch::ConstraintVisibilitySome NXOpen::Sketch::ConstraintVisibilitySome@endlink  option will behave the same as the 
                @link NXOpen::Sketch::ConstraintVisibilityAll NXOpen::Sketch::ConstraintVisibilityAll@endlink  option.  
        ...
        */
        public: enum NX_DEPRECATED("Deprecated in NX8.5.0.  Please use NXOpen::Preferences::SessionSketch::DisplayConstraintSymbols NXOpen::Preferences::SessionSketch::DisplayConstraintSymbols @endlink and @link NXOpen::Preferences::SessionSketch::SetDisplayConstraintSymbols NXOpen::Preferences::SessionSketch::SetDisplayConstraintSymbols @endlink ")  ConstraintVisibility
        {
        ...
        /**
            ...
            @link NXOpen::SketchCollection::CreateSketch NXOpen::SketchCollection::CreateSketch@endlink 
        ...
        /** Creates a reflection of the input geometry.
                ...
                Please use @link NXOpen::SketchMirrorBuilder NXOpen::SketchMirrorBuilder@endlink  instead.
                 <br> 
             @return  The mirrored geometry that was created 
         <br>  @deprecated Deprecated in NX5.0.0.  Please use @link NXOpen::SketchMirrorBuilder NXOpen::SketchMirrorBuilder@endlink  instead. <br>  

         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public:  NX_DEPRECATED("Deprecated in NX5.0.0.  Please use NXOpen::SketchMirrorBuilder instead.") std::vector<NXOpen::SmartObject *> MirrorObjects
        (
        ...
        public: void Scale
        (
            double scaleFactor /** the scaleFactor must be gerater than zero */
        );
