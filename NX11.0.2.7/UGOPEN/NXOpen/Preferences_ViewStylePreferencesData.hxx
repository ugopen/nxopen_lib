...
namespace NXOpen
{
    namespace Preferences
    {
        ...
        /** Represents the view lockmethod options */
        enum GeneralViewLockmethodOption
        {
            GeneralViewLockmethodOptionNone/** Normal view */,
            GeneralViewLockmethodOptionSnapshot/** Snapshot view */,
            GeneralViewLockmethodOptionComplete/** Locked view */
        };
