    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DieCavityAndSlugHoleBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the second die plate 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: double DiePlateTwo
            (
            );
            /**Sets  the second die plate 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the angle of the second die plate 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: double AngleDiePlateTwo
            (
            );
            /**Sets  the angle of the second die plate 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the third die plate 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: double DiePlateThree
            (
            );
            /**Sets  the third die plate 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the 'for each' scrap in die plate three 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: bool ForEachScrapDiePlateThree
            (
            );
            /**Sets  the 'for each' scrap in die plate three 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
