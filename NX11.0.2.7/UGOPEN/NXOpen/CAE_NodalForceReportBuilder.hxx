...
#include <NXOpen/CAE_NodalForceReportBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Nodal Force Report Builder <br> To create a new instance of this class, use @link NXOpen::CAE::SimSolution::CreateNodalForceReportBuilder  NXOpen::CAE::SimSolution::CreateNodalForceReportBuilder @endlink  <br> 
